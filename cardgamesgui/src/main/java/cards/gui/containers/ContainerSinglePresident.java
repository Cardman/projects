...
//        getActionsHistory().validate();
    ...
    public void finPartiePresident() {
        ...
        if(isChangerPileFin()) {
            GamePresident partie_=partiePresident();
            partie_.empiler().sauvegarder(LaunchingCards.getTempFolderSl()+FileConst.DECK_FOLDER+StreamTextFile.SEPARATEUR+GameEnum.PRESIDENT.name()+partie_.getRegles().getNbStacks()+FileConst.DECK_EXT);
        }
