...
public final class MockFileSetTest extends EquallableMockGuiUtil {
    @Test
    public void f1() {
        MockProgramInfosSample pr_ = new MockProgramInfosSample("","",dbs(0.75),0,wrapLongs(1,2),true,"/");
    ...
    @Test
    public void f12() {
        MockProgramInfosSample pr_ = new MockProgramInfosSample("","",dbs(0.75),0,wrapLongs(1,2),true,"c:/");
    ...
    @Test
    public void f18() {
        MockProgramInfosSample pr_ = new MockProgramInfosSample("","",dbs(0.75),0,wrapLongs(1,2),true,"c:/","d:/");
        pr_.getMockFileSet().getFiles().addEntry("c:/tmp",new FileStruct(null,0));
    ...
    @Test
    public void f28() {
        MockProgramInfosSample pr_ = new MockProgramInfosSample("","",dbs(0.75),5,wrapLongs(1,2),true,"/");
    ...
    @Test
    public void f29() {
        MockProgramInfosSample pr_ = new MockProgramInfosSample("","",dbs(0.75),7,wrapLongs(1,2),true,"/");
        assertTrue(pr_.getFileCoreStream().newFile("tmp").mkdirs());
        FileStruct val_ = pr_.getMockFileSet().getFiles().getVal("/tmp");
        assertNull(val_.getContent());
    ...
    @Test
    public void f35() {
        MockProgramInfosSample pr_ = new MockProgramInfosSample("","",dbs(0.75),5,wrapLongs(1,2,7),true,"/");
    ...
    @Test
    public void f36() {
        MockProgramInfosSample pr_ = new MockProgramInfosSample("","",dbs(0.25),5,wrapLongs(1,2,7),true,"/");
        pr_.getFileCoreStream().newFile("tmp").mkdirs();
        pr_.setCurrentPath("/tmp");
    ...
    @Test
    public void f38() {
        MockProgramInfosSample pr_ = new MockProgramInfosSample("","",dbs(0.75),5,wrapLongs(1,2,7,4),true,"/");
        pr_.getFileCoreStream().newFile("tmp").mkdirs();
        pr_.setCurrentPath("/tmp");
        assertTrue(pr_.getStreams().getTextFact().write("txt","content",false));
    ...
    @Test
    public void f42() {
        MockProgramInfosSample pr_ = new MockProgramInfosSample("","",dbs(0.75),5,wrapLongs(1,2,7,6),true,"/");
        pr_.getFileCoreStream().newFile("tmp").mkdirs();
        pr_.setCurrentPath("/tmp");
        assertTrue(pr_.getStreams().getTextFact().write("txt","content",false));
    ...
    @Test
    public void f52() {
        MockProgramInfosSample pr_ = new MockProgramInfosSample("","",dbs(0.75),5,wrapLongs(1,2,7,6),true,"c:/","d:/");
