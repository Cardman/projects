...
public final class MockThreadTest extends EquallableMockGuiUtil {
    @Test
    public void t1() {
        MockThread th_ = new MockThread(null, false, new ConcreteLong());
    ...
    @Test
    public void t5() {
        MockThread th_ = new MockThread(new MockRunnable(), false, new ConcreteLong());
        th_.start();
        assertFalse(th_.isInvoked());
    }
    @Test
    public void t6() {
        MockThread th_ = new MockThread(null, true, new ConcreteLong());
        th_.start();
        assertFalse(th_.isInvoked());
    }
    @Test
    public void t7() {
        MockThread th_ = new MockThread(new MockRunnable(), true, new ConcreteLong());
        th_.start();
    ...
    public void t14() {
        ...
        MockThread th_ = new MockThread(r_, false, new ConcreteLong());
        th_.getThread().run();
