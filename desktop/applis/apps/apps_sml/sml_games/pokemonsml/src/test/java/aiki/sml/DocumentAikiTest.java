...
public final class DocumentAikiTest extends EquallableAikiSerialUtil {
    ...
    public void t56() {
        ...
        f_.getData().getAnimStatus().addEntry("",instance(new int[1][1]));
        f_.getData().getAnimStatis().addEntry("",instance(new int[1][1]));
        f_.getData().getAnimStatus().addEntry("_",instance(new int[1][1]));
        f_.getData().getAnimStatis().addEntry("_",instance(new int[1][1]));
        ...
        f_.getData().getTypesImages().addEntry("",instance(new int[1][1]));
        f_.getData().getTypesImages().addEntry("_",instance(new int[1][1]));
        f_.getData().getMiniItems().addEntry("",instance(new int[1][1]));
        f_.getData().getMiniItems().addEntry("_",instance(new int[1][1]));
        f_.getData().getMiniPk().addEntry("",instance(new int[1][1]));
        f_.getData().getMiniPk().addEntry("_",instance(new int[1][1]));
        f_.getData().getMaxiPkFront().addEntry("",instance(new int[1][1]));
        f_.getData().getMaxiPkFront().addEntry("_",instance(new int[1][1]));
        f_.getData().getMaxiPkBack().addEntry("",instance(new int[1][1]));
        f_.getData().getMaxiPkBack().addEntry("_",instance(new int[1][1]));
        f_.getData().getTrainers().addEntry("_",instance(new int[1][1]));
        f_.getData().getPeople().addEntry("_",instance(new int[1][1]));
        f_.getData().getLinks().addEntry("_",instance(new int[1][1]));
        f_.getData().getMiniMap().addEntry("_",instance(new int[1][1]));
        f_.getData().getImages().addEntry("_",instance(new int[1][1]));
