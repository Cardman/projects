...
public final class ReadOnlyTabEditor extends AbsReadOnlyTabEditor implements AbsTabEditor {
    ...
    public ReadOnlyTabEditor(AbsDebuggerGui _dbg, AbstractProgramInfos _frame, String _rel, String _lr, Options _options, ResultContext _res) {
        ...
        fullPath = _rel;
        useFeed = _lr;
        getCenter().registerKeyboardAction(getCompoFactory().wrap(new ToggleBreakPointEvent(_dbg,this, _res)),GuiConstants.VK_F2,0);
        getCenter().registerKeyboardAction(getCompoFactory().wrap(new ToggleBreakPointEnabledEvent(_dbg,this,_res)),GuiConstants.VK_F3,0);
        getCenter().registerKeyboardAction(getCompoFactory().wrap(new BreakPointFormEvent(_dbg, this, _res)),GuiConstants.VK_F4,0);
        getCenter().registerKeyboardAction(getCompoFactory().wrap(new ToggleWatchPointEvent(_dbg,this,_res)),GuiConstants.VK_F2,GuiConstants.CTRL_DOWN_MASK);
        getCenter().registerKeyboardAction(getCompoFactory().wrap(new ToggleWatchPointEnabledEvent(_dbg,this,_res)),GuiConstants.VK_F3,GuiConstants.CTRL_DOWN_MASK);
