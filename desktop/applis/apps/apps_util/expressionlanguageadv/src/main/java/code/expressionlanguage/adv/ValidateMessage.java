...
public final class ValidateMessage implements AbsActionListener {
    private final CdmParameterSoftModel softModel;
    ...
    public ValidateMessage(CdmParameterSoftModel _params,AbsTextField _k, AbsTextArea _v, StringMap<String> _m, AbsPlainLabel _current, boolean _direct) {
        softModel = _params;
        key = _k;
        value = _v;
        messages = _m;
    ...
    @Override
    public void action() {
        if (softModel.isDirectMatchKeyValue() || always) {
