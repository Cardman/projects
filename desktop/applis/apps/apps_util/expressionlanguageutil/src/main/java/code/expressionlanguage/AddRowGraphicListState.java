...
public final class AddRowGraphicListState implements CallingState {
    private final GraphicListStruct instance;
    private final int index;
    private final Struct info;

    public AddRowGraphicListState(GraphicListStruct _g, int _i, Struct _f) {
        this.instance = _g;
        this.index = _i;
        this.info = _f;
    }
    ...
    public AbstractPageEl processAfterOperation(ContextEl _context, StackCall _stack) {
        return new AddRowGraphicListPageEl(instance,index,info);
    }
}
