...
//        methods_.add( method_);
        ...
        tableGui(_content, _cust, _guiEx, component_);
    ...
    public void tableGui(LgNamesContent _content, CustAliases _cust, GuiExecutingBlocks _guiEx, StandardClass _component) {
        ...
        StandardNamedFunction.addFct(methods_, method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(), _content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTableAddInterval, params_, _content.getCoreNames().getAliasVoid(), false, MethodModifier.FINAL,new StringList(guiAliasParameters.getAliasTableGui0TableAddInterval0(),guiAliasParameters.getAliasTableGui0TableAddInterval1()), new FctTableAddInterval(aliasTableGui+"."+new MethodId(MethodAccessKind.INSTANCE,aliasTableAddInterval,params_).getSignature(_content.getDisplayedStrings())));
        StandardNamedFunction.addFct(methods_, method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(), _content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTableRemoveInterval, params_, _content.getCoreNames().getAliasVoid(), false, MethodModifier.FINAL,new StringList(guiAliasParameters.getAliasTableGui0TableRemoveInterval0(),guiAliasParameters.getAliasTableGui0TableRemoveInterval1()), new FctTableRemoveInterval(aliasTableGui+"."+new MethodId(MethodAccessKind.INSTANCE,aliasTableRemoveInterval,params_).getSignature(_content.getDisplayedStrings())));
        StandardNamedFunction.addFct(methods_, method_);
    ...
    public void tree(LgNamesContent _content, CustAliases _cust, GuiExecutingBlocks _guiEx, StandardClass _compo) {
        ...
        method_ = new StandardMethod(aliasTreeGetSelected, params_, _content.getCoreNames().getAliasVoid(), false, MethodModifier.FINAL,new StringList(guiAliasParameters.getAliasTree0TreeGetSelected0()), new FctTreeGetSelected1(aliasTree+"."+new MethodId(MethodAccessKind.INSTANCE,aliasTreeGetSelected,params_).getSignature(_content.getDisplayedStrings())));
        StandardNamedFunction.addFct(methods_, method_);
        params_ = new StringList();
    ...
    private void buildInputs(LgNamesContent _content, CustAliases _cust, GuiExecutingBlocks _guiEx, StandardType _component, StandardType _input) {
        ...
        StandardNamedFunction.addFct(methods_, method_);
        params_ = new StringList(aliasActionListener);
        method_ = new StandardMethod(aliasAddListener, params_, _content.getCoreNames().getAliasVoid(), false, MethodModifier.FINAL,new StringList(guiAliasParameters.getAliasCheckBox0AddListener0()), new FctCheckBoxAddAction());
        StandardNamedFunction.addFct(methods_, method_);
        params_ = new StringList(aliasActionListener);
        method_ = new StandardMethod(aliasRemoveListener, params_, _content.getCoreNames().getAliasVoid(), false, MethodModifier.FINAL,new StringList(guiAliasParameters.getAliasCheckBox0RemoveListener0()), new FctCheckBoxRemoveAction());
        StandardNamedFunction.addFct(methods_, method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasGetActionListeners, params_, StringExpUtil.getPrettyArrayType(aliasActionListener), false, MethodModifier.FINAL,new StringList(), new FctCheckBoxGetActions());
        StandardNamedFunction.addFct(methods_, method_);
        params_ = new StringList();
