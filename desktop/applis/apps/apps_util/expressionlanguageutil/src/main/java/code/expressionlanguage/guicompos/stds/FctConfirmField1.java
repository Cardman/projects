...
public final class FctConfirmField1 implements StdCaller {
    ...
    public ArgumentWrapper call(AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        return new ArgumentWrapper(guiEx.showTextField(argumentWrappers_.get(0).getValue(), argumentWrappers_.get(1).getValue(), argumentWrappers_.get(2).getValue(), argumentWrappers_.get(3).getValue(), argumentWrappers_.get(4).getValue(), argumentWrappers_.get(5).getValue(), argumentWrappers_.get(6).getValue()));
    }
}
