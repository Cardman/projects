...
public final class FctFontStringHeight0 implements StdCaller {
    private final GuiExecutingBlocks guiEx;
    public FctFontStringHeight0(GuiExecutingBlocks _guiEx) {
        this.guiEx = _guiEx;
    }
    @Override
    public ArgumentWrapper call(AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        return new ArgumentWrapper(guiEx.stringHeight(font_));
    }
}
