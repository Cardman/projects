...
public final class FctGrListSet0 implements StdCaller {
    ...
    public FctGrListSet0(GuiAliases _aliases, GuiExecutingBlocks _guiEx) {
        aliases = _aliases;
        guiEx = _guiEx;
    }
    @Override
    public ArgumentWrapper call(AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        inst_.set(aliases, _cont, guiEx, _stackCall, ((NumberStruct)argumentWrappers_.get(0).getValue().getStruct()).intStruct(),argumentWrappers_.get(1).getValue().getStruct());
