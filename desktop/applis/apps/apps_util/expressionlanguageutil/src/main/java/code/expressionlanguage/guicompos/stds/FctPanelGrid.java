...
public final class FctPanelGrid implements StdCaller {
    ...
    public ArgumentWrapper call(AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        return new ArgumentWrapper(PanelStruct.newGrid(aliasPanel,((NumberStruct)argumentWrappers_.get(0).getValue()).intStruct(),((NumberStruct)argumentWrappers_.get(1).getValue()).intStruct(),guiExecutingBlocks.getCompoFactory()));
    }
}
