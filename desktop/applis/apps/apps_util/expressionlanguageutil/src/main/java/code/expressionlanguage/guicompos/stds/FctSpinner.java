...
public final class FctSpinner extends FctCompoCtor {
    ...
    public ArgumentWrapper inst(GuiExecutingBlocks _guiEx, AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        return new ArgumentWrapper(new SpinnerStruct(aliasSpinner,argumentWrappers_.get(0).getValue(),argumentWrappers_.get(1).getValue(),argumentWrappers_.get(2).getValue(),argumentWrappers_.get(3).getValue(),_guiEx.getCompoFactory()));
    }
}
