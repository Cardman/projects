...
public final class FctTreeNode1 extends FctCompoCtor {
    ...
    public ArgumentWrapper inst(GuiExecutingBlocks _guiEx, AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        return new ArgumentWrapper(new TreeNodeStruct(_guiEx.getCompoFactory().newMutableTreeNode(NumParsers.getString(_firstArgs.getArgumentWrappers().get(0).getValue()).getInstance())));
    }
}
