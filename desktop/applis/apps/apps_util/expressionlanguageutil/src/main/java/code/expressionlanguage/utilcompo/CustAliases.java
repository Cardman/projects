...
public final class CustAliases {
    ...
    public CustAliasParameters getCustAliasParameters(){
        return custAliasParameters;
    }
    ...
    public ResultErrorStd invoke(ContextEl _cont, ClassMethodId _method, Struct _struct, Argument... _args) {
        try {
    ...
    public ResultErrorStd getOtherResult(ContextEl _cont, Struct _instance,
        ...
        if (StringList.quickEq(className_,aliasFile)) {
            ...
            if (StringList.quickEq(name_,aliasFileReadBin)) {
                ...
                ArrayStruct bin_ = new ArrayStruct(new Struct[len_],StringExpUtil.getPrettyArrayType(_cont.getStandards().getAliasPrimByte()));
            ...
            if (StringList.quickEq(name_,aliasFileListFiles)) {
                ...
                ArrayStruct arr_ = new ArrayStruct(new Struct[len_],StringExpUtil.getPrettyArrayType(_cont.getStandards().getAliasString()));
                for (int i = 0; i < len_; i++) {
    ...
    void log(String _dtPart, RunnableContextEl _cont,
        ...
        if (_method.getConstraints().getParametersTypes().size() == 1) {
            ...
            String aliasObject_ = _cont.getStandards().getAliasObject();
