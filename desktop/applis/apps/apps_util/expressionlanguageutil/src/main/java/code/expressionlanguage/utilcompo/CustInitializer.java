    	...
    	if (exc_ instanceof Struct) {
            ...
            if (exception_ instanceof DisplayableStruct) {
                ...
                if (state_ instanceof CustomFoundMethod) {
                    ...
                    out_ = ProcessMethod.calculateArgument(method_.getGl(), method_.getClassName(),method_.getRootBlock(), method_.getId(), method_.getArguments(), _cont, method_.getRight());
                    convert_ = true;
                }
