...
public class LgNamesUtils extends LgNames {
    ...
    public void buildOther() {
        ...
        method_ = new StandardMethod(aliasSetPriority, params_, getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(getAliasPrimLong());
        method_ = new StandardMethod(aliasSleep, params_, getAliasPrimBoolean(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(aliasPrint, params_, getAliasVoid(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasPrint, params_, getAliasVoid(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString(),getAliasObject());
        method_ = new StandardMethod(aliasPrint, params_, getAliasVoid(), true, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(aliasThread);
        method_ = new StandardMethod(aliasThreadExitHook, params_, getAliasVoid(), false, MethodModifier.STATIC);
        methods_.add( method_);
        ...
        params_ = new StringList(aliasThread);
        method_ = new StandardMethod(aliasThreadSetAdd, params_, getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasThreadSetAll, params_, aliasThreadSet, false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(aliasThread);
        method_ = new StandardMethod(aliasThreadSetContains, params_, getAliasPrimBoolean(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasThread);
        method_ = new StandardMethod(aliasThreadSetRemove, params_, getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasRead, params_, getAliasString(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString(),getAliasString());
        method_ = new StandardMethod(aliasWrite, params_, getAliasPrimBoolean(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileReadBin, params_, StringExpUtil.getPrettyArrayType(getAliasPrimByte()), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString(),StringExpUtil.getPrettyArrayType(getAliasPrimByte()));
        method_ = new StandardMethod(aliasFileWriteBin, params_, getAliasPrimBoolean(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileDelete, params_, getAliasPrimBoolean(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString(),getAliasString());
        method_ = new StandardMethod(aliasFileRename, params_, getAliasPrimBoolean(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString(),getAliasString());
        method_ = new StandardMethod(aliasAppendToFile, params_, getAliasPrimBoolean(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileAbsolutePath, params_, getAliasString(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileGetName, params_, getAliasString(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileGetParentPath, params_, getAliasString(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileGetLength, params_, getAliasPrimLong(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileLastModif, params_, getAliasPrimLong(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileListDirectories, params_, StringExpUtil.getPrettyArrayType(getAliasString()), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileListFiles, params_, StringExpUtil.getPrettyArrayType(getAliasString()), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileIsDirectory, params_, getAliasPrimBoolean(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileIsFile, params_, getAliasPrimBoolean(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileIsAbsolute, params_, getAliasPrimBoolean(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString(),aliasEntryBinary);
        method_ = new StandardMethod(aliasFileZipBin, params_, getAliasPrimBoolean(), true, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(aliasEntryBinary);
        method_ = new StandardMethod(aliasFileZipBinArray, params_, StringExpUtil.getPrettyArrayType(getAliasPrimByte()), true, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString(),aliasEntryText);
        method_ = new StandardMethod(aliasFileZipText, params_, getAliasPrimBoolean(), true, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileZippedBin, params_, StringExpUtil.getPrettyArrayType(aliasEntryBinary), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(StringExpUtil.getPrettyArrayType(getAliasPrimByte()));
        method_ = new StandardMethod(aliasFileZippedBinArray, params_, StringExpUtil.getPrettyArrayType(aliasEntryBinary), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileZippedText, params_, StringExpUtil.getPrettyArrayType(aliasEntryText), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasFileMakeDirs, params_, getAliasPrimBoolean(), false, MethodModifier.STATIC);
        methods_.add( method_);
        std_ = stdcl_;
