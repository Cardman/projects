...
public final class MathAdvAliases {
    ...
    public void buildOther(LgNamesContent _content) {
        ...
        method_ = new StandardMethod(aliasLgIntParse, params_, aliasLgInt, false, MethodModifier.STATIC,new StringList(mathAliasParameters.getAliasLgInt0LgIntParse0()),new FctNbRateSafeAbs(new FctLgIntParse()));
        StandardNamedFunction.addFct(methods_, method_);
        ...
        StandardNamedFunction.addFct(methods_, method_);
        params_ = new StringList();
        StandardConstructor ctor_ = new StandardConstructor(params_,false,new FctRate0());
        StandardNamedFunction.addFct(constructors_, ctor_);
        params_ = new StringList(_content.getCharSeq().getAliasString());
        ctor_ = new StandardConstructor(params_,false,new StringList(mathAliasParameters.getAliasRate0Rate0()),new FctNbRateAbs(new FctRateParse()));
        StandardNamedFunction.addFct(constructors_, ctor_);
        StandardType.addType(_content.getStandards(),aliasRate, stdcl_);
        ...
        StandardNamedFunction.addFct(constructors_, ctor_);
        params_ = new StringList(_content.getCharSeq().getAliasString());
        ctor_ = new StandardConstructor(params_,false,new StringList(mathAliasParameters.getAliasLgInt0LgInt0()),new FctNbRateAbs(new FctLgIntParse()));
        StandardNamedFunction.addFct(constructors_, ctor_);
        StandardType.addType(_content.getStandards(),aliasLgInt, std_);
    }
