...
public final class CommonOperNbLeRate implements CommonOperSymbol {
    @Override
    public Struct calculateOperator(Struct _first, Struct _second) {
        return BooleanStruct.of(Rate.lowerEq(((RateStruct)_first).getRate(),((RateStruct)_second).getRate()));
    }

    @Override
    public String getSgn() {
        return Long.toString(SymbolConstants.SYMBOL_LE_PRIO)+"/2";
    }
