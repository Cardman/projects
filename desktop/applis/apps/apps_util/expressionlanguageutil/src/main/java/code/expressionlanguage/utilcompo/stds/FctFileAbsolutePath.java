...
public final class FctFileAbsolutePath extends FctFileAbs {
    public FctFileAbsolutePath(CustAliases _custAliases) {
        super(_custAliases);
    }
    ...
    public ArgumentWrapper file(FileInfos _infos, AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        return new ArgumentWrapper(new StringStruct(_infos.getFileSystem().absolutePath(file_, ((RunnableContextEl) _cont).getCurrentDir())));
    }
}
