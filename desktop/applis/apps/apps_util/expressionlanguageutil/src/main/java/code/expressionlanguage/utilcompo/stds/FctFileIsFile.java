...
public final class FctFileIsFile extends FctFileAbs {
    public FctFileIsFile(CustAliases _custAliases) {
        super(_custAliases);
    }
    ...
    public ArgumentWrapper file(FileInfos _infos, AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        return new ArgumentWrapper(BooleanStruct.of(_infos.getFileSystem().isFile(file_, ((RunnableContextEl) _cont).getCurrentDir())));
    }
}
