...
public final class FctFileListFiles extends FctFileAbs {
    public FctFileListFiles(CustAliases _custAliases) {
        super(_custAliases);
    }
    ...
    public ArgumentWrapper file(FileInfos _infos, AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        StringList files_ = _infos.getFileSystem().getFiles(file_, (RunnableContextEl) _cont);
        if (files_ == null) {
