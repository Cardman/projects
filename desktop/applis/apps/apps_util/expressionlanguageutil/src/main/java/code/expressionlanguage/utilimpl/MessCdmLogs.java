...
fr_.add(AnalysisMessages.UNDEFINED_SUPER_CTOR,"UndefinedSuperCtor=Aucun super constructeur à appel implicite n''est défini et accessible. Il doit y avoir au moins un constructeur pour le type {0}");
fr_.add(AnalysisMessages.UNDEFINED_SUPER_CTOR_CALL,"UndefinedSuperCtorCall=Aucun super constructeur à appel implicite n''est défini et accessible. L''appel explicite d''un super constructeur est obligatoir pour le constructeur {0}.");
