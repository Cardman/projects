...
public final class GraphicListStructTest extends EquallableElUtUtil {
    ...
    private Struct ctxStr(MockProgramInfos _pr, StringMap<String> _p) {
        ...
        return ArgumentListCall.toStr(RunnableStruct.invoke(new Argument(), form_, (RunnableContextEl) ctx_, new ExecTypeFunction(form_, ExecClassesUtil.getMethodBodiesById(ex_, id_).first()), resSt_, new ArgumentListCall()));
    }
