...
public final class PreparedLabelStructTest extends EquallableElUtUtil {
    ...
    public void modif() {
        ...
        call(new FctCompoFocusable1(),null,ctx_,i_,one(BooleanStruct.of(false)),st_);
        call(new FctCompoRequestFocus(),null,ctx_,i_,null,st_);
        call(new FctCompoFocused(),null,ctx_,i_,null,st_);
        call(new FctCompoFocusable1(),null,ctx_,i_,one(BooleanStruct.of(true)),st_);
        call(new FctCompoRequestFocus(),null,ctx_,i_,null,st_);
        call(new FctCompoFocused(),null,ctx_,i_,null,st_);
        assertFalse(st_.isFailInit());
    ...
    public void addFocus1() {
        ...
        StackCall st_ = stack(ctx_);
        Struct i_ = call(new FctImageLabel1(stds_.getExecContent().getCustAliases(), stds_.getGuiExecutingBlocks(), ""), null, ctx_, null, one(call(new FctImage(stds_.getGuiExecutingBlocks()), null, ctx_, null, three(new IntStruct(0), new IntStruct(0), BooleanStruct.of(true)), st_)), st_);
        call(new FctCompoAddFocusListener(),null,ctx_,i_,one(NullStruct.NULL_VALUE),st_);
        assertEq(0,((CustComponentStruct)i_).getComponent().getFocusListeners().size());
    }
    @Test
    public void addFocus2() {
        MockProgramInfos pr_ = newMockProgramInfos(new CustomSeedGene(), new MockFileSet(5, lgs(1), new String[]{"/"}));
        LgNamesGui stds_ = newLgNamesGuiSample(pr_, null);
        stds_.getGuiExecutingBlocks().initApplicationParts(new StringList(),pr_);
        Options opt_ = new Options();
    ...
    public void removeFocus1() {
        ...
        Struct i_ = call(new FctImageLabel1(stds_.getExecContent().getCustAliases(), stds_.getGuiExecutingBlocks(), ""), null, ctx_, null, one(call(new FctImage(stds_.getGuiExecutingBlocks()), null, ctx_, null, three(new IntStruct(0), new IntStruct(0), BooleanStruct.of(true)), st_)), st_);
        call(new FctCompoAddFocusListener(),null,ctx_,i_,one(ctx_.getInit().processInit(ctx_,NullStruct.NULL_VALUE,new ExecFormattedRootBlock(new ExecClassBlock(new ExecRootBlockContent(new AnaRootBlockContent()),AccessEnum.PUBLIC,new ExecClassContent(new AnaClassContent(true,false,true))),""),"",-1)),st_);
        call(new FctCompoRemoveFocusListener(),null,ctx_,i_,one(NullStruct.NULL_VALUE),st_);
        assertEq(1,((CustComponentStruct)i_).getComponent().getFocusListeners().size());
    }
    @Test
    public void removeFocus2() {
        MockProgramInfos pr_ = newMockProgramInfos(new CustomSeedGene(), new MockFileSet(5, lgs(1), new String[]{"/"}));
        LgNamesGui stds_ = newLgNamesGuiSample(pr_, null);
        stds_.getGuiExecutingBlocks().initApplicationParts(new StringList(),pr_);
        Options opt_ = new Options();
    ...
    public void focus1() {
        ...
        Struct list_ = ctx_.getInit().processInit(ctx_, NullStruct.NULL_VALUE, new ExecFormattedRootBlock(new ExecClassBlock(new ExecRootBlockContent(new AnaRootBlockContent()), AccessEnum.PUBLIC, new ExecClassContent(new AnaClassContent(true, false, true))), ""), "", -1);
        call(new FctCompoAddFocusListener(),null,ctx_,i_,one(list_),st_);
        ArrayStruct a_ = (ArrayStruct) call(new FctCompoGetFocusListeners(), null, ctx_, i_, null, st_);
        assertEq(1,a_.getLength());
        assertSame(list_,a_.get(0));
    }
    @Test
    public void focus2() {
        ...
        StackCall st_ = stack(ctx_);
        Struct i_ = call(new FctImageLabel1(stds_.getExecContent().getCustAliases(), stds_.getGuiExecutingBlocks(), ""), null, ctx_, null, one(call(new FctImage(stds_.getGuiExecutingBlocks()), null, ctx_, null, three(new IntStruct(0), new IntStruct(0), BooleanStruct.of(true)), st_)), st_);
        ((CustComponentStruct)i_).getComponent().addFocusListener(new MockFocusListener());
        ArrayStruct a_ = (ArrayStruct) call(new FctCompoGetFocusListeners(), null, ctx_, i_, null, st_);
        assertEq(0,a_.getLength());
    }
    @Test
    ...
    public void bind1() {
        ...
        Struct i_ = call(new FctImageLabel1(stds_.getExecContent().getCustAliases(), stds_.getGuiExecutingBlocks(), ""), null, ctx_, null, one(call(new FctImage(stds_.getGuiExecutingBlocks()), null, ctx_, null, three(new IntStruct(0), new IntStruct(0), BooleanStruct.of(true)), st_)), st_);
        Struct list_ = ctx_.getInit().processInit(ctx_, NullStruct.NULL_VALUE, new ExecFormattedRootBlock(new ExecClassBlock(new ExecRootBlockContent(new AnaRootBlockContent()), AccessEnum.PUBLIC, new ExecClassContent(new AnaClassContent(true, false, true))), ""), "", -1);
        call(new FctCompoBind(),null,ctx_,i_,three(call(new FctActionWrap("", pr_.getCompoFactory()),null,ctx_,null,one(list_),st_),new IntStruct(1),new IntStruct(2)),st_);
        assertEq(1,((CustComponentStruct)i_).getComponent().getActionsMap().size());
        assertEq(1,((CustComponentStruct)i_).getActions().size());
    }
    @Test
    public void bind2() {
        MockProgramInfos pr_ = newMockProgramInfos(new CustomSeedGene(), new MockFileSet(5, lgs(1), new String[]{"/"}));
        ...
        StackCall st_ = stack(ctx_);
        Struct i_ = call(new FctImageLabel1(stds_.getExecContent().getCustAliases(), stds_.getGuiExecutingBlocks(), ""), null, ctx_, null, one(call(new FctImage(stds_.getGuiExecutingBlocks()), null, ctx_, null, three(new IntStruct(0), new IntStruct(0), BooleanStruct.of(true)), st_)), st_);
        call(new FctCompoBind(),null,ctx_,i_,three(ctx_.getInit().processInit(ctx_,NullStruct.NULL_VALUE,new ExecFormattedRootBlock(new ExecClassBlock(new ExecRootBlockContent(new AnaRootBlockContent()),AccessEnum.PUBLIC,new ExecClassContent(new AnaClassContent(true,false,true))),""),"",-1),new IntStruct(1),new IntStruct(2)),st_);
        call(new FctCompoBind(),null,ctx_,i_,three(NullStruct.NULL_VALUE,new IntStruct(1),new IntStruct(2)),st_);
        assertEq(0,((CustComponentStruct)i_).getComponent().getActionsMap().size());
        assertEq(0,((CustComponentStruct)i_).getActions().size());
    }
    @Test
    public void bind3() {
        MockProgramInfos pr_ = newMockProgramInfos(new CustomSeedGene(), new MockFileSet(5, lgs(1), new String[]{"/"}));
    ...
    public void unbind1() {
        ...
        Struct i_ = call(new FctImageLabel1(stds_.getExecContent().getCustAliases(), stds_.getGuiExecutingBlocks(), ""), null, ctx_, null, one(call(new FctImage(stds_.getGuiExecutingBlocks()), null, ctx_, null, three(new IntStruct(0), new IntStruct(0), BooleanStruct.of(true)), st_)), st_);
        call(new FctCompoBind(),null,ctx_,i_,three(ctx_.getInit().processInit(ctx_,NullStruct.NULL_VALUE,new ExecFormattedRootBlock(new ExecClassBlock(new ExecRootBlockContent(new AnaRootBlockContent()),AccessEnum.PUBLIC,new ExecClassContent(new AnaClassContent(true,false,true))),""),"",-1),new IntStruct(1),new IntStruct(2)),st_);
        call(new FctCompoUnbind(),null,ctx_,i_,two(new IntStruct(1),new IntStruct(2)),st_);
        assertEq(0,((CustComponentStruct)i_).getComponent().getActionsMap().size());
        assertEq(0,((CustComponentStruct)i_).getActions().size());
    }
    @Test
    ...
    public void commands() {
        ...
        Struct i_ = call(new FctImageLabel1(stds_.getExecContent().getCustAliases(), stds_.getGuiExecutingBlocks(), ""), null, ctx_, null, one(call(new FctImage(stds_.getGuiExecutingBlocks()), null, ctx_, null, three(new IntStruct(0), new IntStruct(0), BooleanStruct.of(true)), st_)), st_);
        Struct list_ = ctx_.getInit().processInit(ctx_, NullStruct.NULL_VALUE, new ExecFormattedRootBlock(new ExecClassBlock(new ExecRootBlockContent(new AnaRootBlockContent()), AccessEnum.PUBLIC, new ExecClassContent(new AnaClassContent(true, false, true))), ""), "", -1);
        Struct action_ = call(new FctActionWrap("", pr_.getCompoFactory()), null, ctx_, null, one(list_), st_);
        call(new FctCompoBind(),null,ctx_,i_,three(action_,new IntStruct(1),new IntStruct(2)),st_);
        ArrayStruct a_ = (ArrayStruct) call(new FctCompoCommands(), null, ctx_, i_, null, st_);
        assertEq(1,a_.getLength());
        assertSame(action_,call(new FctCommandAction0(),null,ctx_,a_.get(0),null,st_));
    }
}
