...
public final class TableStructTest extends EquallableElUtUtil {
    ...
    public void init1() {
        ...
        Struct t_ = call(new FctTableGrid(stds_.getCustAliases(), stds_.getGuiExecutingBlocks(), ""), null, ctx_, null, one(NullStruct.NULL_VALUE), st_);
    ...
    public void init2() {
        ...
        call(new FctTableGrid(stds_.getCustAliases(),stds_.getGuiExecutingBlocks(),""),null,ctx_,null,one(arr_),st_);
        assertFalse(st_.isFailInit());
        assertTrue(st_.calls());
    }
    ...
    public void columnName() {
        ...
        ArrayStruct arr_ = new ArrayStruct(1,"");
        arr_.set(0,new StringStruct(""));
        Struct t_ = call(new FctTableGrid(stds_.getCustAliases(), stds_.getGuiExecutingBlocks(), ""), null, ctx_, null, one(arr_), st_);
