...
public final class RateStructTest extends EquallableElUtUtil {
    ...
    public void init1() {
        ...
        ExecOverrideInfo mId_ = ((LgNamesWithNewAliases) r_.getStandards()).getExecutingBlocks().getRunnableType().getRedirections().getVal(((LgNamesWithNewAliases) r_.getStandards()).getExecutingBlocks().getRunMethod(),base_);
    ...
    private void invoke(Struct _inst, RunnableContextEl _ctx, StackCall _stack) {
        ...
        ExecOverrideInfo mId_ = ((LgNamesWithNewAliases) _ctx.getStandards()).getExecutingBlocks().getRunnableType().getRedirections().getVal(((LgNamesWithNewAliases) _ctx.getStandards()).getExecutingBlocks().getRunMethod(),base_);
