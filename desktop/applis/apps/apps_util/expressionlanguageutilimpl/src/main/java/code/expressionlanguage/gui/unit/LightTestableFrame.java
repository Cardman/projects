...
public final class LightTestableFrame extends AbsTestableFrame {
    ...
    public LightTestableFrame(AbstractLightProgramInfos _frames, AbstractIssuer _issuer, AbstractInterceptor _inter, MemInputFiles _typed, ProgTestBarInt _b) {
        super(_frames, _issuer, _inter, _b);
        inputFiles = _typed;
    }
