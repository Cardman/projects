...
public final class RunningShowProgessTest extends EquallableElUtImplUtil {
    ...
    public void progress() {
        ...
        progTest_.init(stds_.getExecutingOptions());

        ResultContext res_ = CustContextFactory.buildDefKw("en", new Options(), stds_.getExecutingOptions(), stds_, files_);
        ContextEl rCont_ = res_.getContext();
        String infoTest_ = stds_.getCustAliases().getAliasInfoTest();
