...
public final class NatResultInput {
    ...
    public void build(Element _read, String _varValue, NatAnalyzingDoc _anaDoc, NatAnalyzedCode _page) {
    ...
    public void tryBuildInputResult(String _name, NatAnalyzingDoc _anaDoc, NatAnalyzedCode _page) {
