...
public final class NatAffectationOperation extends NatAbstractAffectOperation {
    ...
    @Override
    protected void calculateAffect(IdMap<RendDynOperationNode, ArgumentsPair> _nodes, NatRendStackCall _rendStack) {
    ...
    static Argument calculateChSetting(RendDynOperationNode _set,
                                       IdMap<RendDynOperationNode, ArgumentsPair> _nodes, Argument _right, NatRendStackCall _rendStackCall){
