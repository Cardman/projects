...
public final class NatSettableFieldOperation extends
    ...
    public Argument calculateSetting(IdMap<RendDynOperationNode, ArgumentsPair> _nodes, Argument _right, BeanLgNames _advStandards, NatRendStackCall _rendStack) {
        return processField(_nodes, _right,_advStandards, _rendStack);
    }

    private Argument processField(IdMap<RendDynOperationNode, ArgumentsPair> _nodes, Argument _right, BeanLgNames _advStandards, NatRendStackCall _rendStackCall) {
