...
import code.bean.nat.analyze.opers.NatStandardFieldOperation;
...
//        NatAnaSettableOperationContent co_ = new NatAnaSettableOperationContent();
//        co_.setField(new StandardField("","",false,false,new CstNatCaller(""),new CstNatCaller("")));
//        NatSettableFieldOperation e_ = new NatSettableFieldOperation(true, 0, new NatExecFieldOperationContent(new NatAnaFieldOperationContent()), new NatExecSettableOperationContent(co_));
//        exps_.add(e_);
//        NatRendStackCall re_ = new NatRendStackCall();
//        re_.addPage(new NatImportingPage());
//        BeanNatCommonLgNames.getAllArgs(exps_, re_);
//        IdMap<NatExecOperationNode, NatArgumentsPair> id_ = new IdMap<NatExecOperationNode, NatArgumentsPair>();
//        id_.addEntry(e_,new NatArgumentsPair());
//        e_.calculateSetting(id_,new Argument(),re_);
...
//        String html_ = "<html c:bean='bean_one'><body><ul><li><a c:command='$goToNullPage()'><c:message value='msg_example,one'><param value='composite.integer1'/></c:message></a></li><li><a c:command='$goToNullPage()'><c:message value='msg_example,two'><param value='composite.integer1'/></c:message></a></li></ul></body></html>";
//        StringMap<String> files_ = new StringMap<String>();
//        files_.put(EquallableBeanCoreUtil.formatFile(folder_,locale_,relative_), content_);
//        BeanOne bean_ = new BeanOne();
//        SampleBeanStruct v_ = init(bean_);
...
//        String relative_ = "sample/file";
//        String content_ = "one={0}\nok=OK";
//        String html_ = "<html c:bean='bean_one'><body><c:submit c:groupId=\"{composite.integer1}\" message='msg_example,ok'/></body></html>";
//        StringMap<String> files_ = new StringMap<String>();
//        files_.put(EquallableBeanCoreUtil.formatFile(folder_,locale_,relative_), content_);
//        BeanOne bean_ = new BeanOne();
//        SampleBeanStruct v_ = init(bean_);
...
//        String relative_ = "sample/file";
//        String content_ = "one={0}";
//        String html_ = "<html c:bean='bean_one'><body><ul><a c:command='$composite.sum({composite.integer1},{composite.integer1})'/></ul></body></html>";
//        StringMap<String> files_ = new StringMap<String>();
//        files_.put(EquallableBeanCoreUtil.formatFile(folder_,locale_,relative_), content_);
//        BeanOne bean_ = new BeanOne();
//        SampleBeanStruct v_ = init(bean_);
...
////        getStrings(v_).add("SECOND");
//        //setInteger(v_);
//        assertEq("<html><body><ul><a c:command=\"bean_one.composite.sum\" href=\"\" n-a=\"0\"/></ul></body></html>", getNatRes(folder_, relative_, html_, files_, v_));
//    }
//    @Test
...
//        String relative_ = "sample/file";
//        String content_ = "one={0}";
//        String html_ = "<html c:bean='bean_one'><body><input type='radio' name='composite.integer1' c:varValue='composite.integer1'/></body></html>";
//        StringMap<String> files_ = new StringMap<String>();
//        files_.put(EquallableBeanCoreUtil.formatFile(folder_,locale_,relative_), content_);
//        BeanOne bean_ = new BeanOne();
//        SampleBeanStruct v_ = init(bean_);
...
////        getStrings(v_).add("SECOND");
//        //setInteger(v_);
//        assertEq("<html><body><input type=\"radio\" name=\"composite.integer1\" value=\"5\" checked=\"checked\"/></body></html>", getNatRes(folder_, relative_, html_, files_, v_));
//    }
//    @Test
...
//        String relative_ = "sample/file";
//        String content_ = "one={0}";
//        String html_ = "<html c:bean='bean_one'><body><form c:command='$goToPage1'><input type='radio' name='composite.integer1' c:varValue='composite.integer1'/><input type='radio' name='composite.integer1' c:varValue='composite.integer0'/></form></body></html>";
//        StringMap<String> files_ = new StringMap<String>();
//        files_.put(EquallableBeanCoreUtil.formatFile(folder_,locale_,relative_), content_);
//        BeanOne bean_ = new BeanOne();
//        SampleBeanStruct v_ = init(bean_);
...
////        getStrings(v_).add("SECOND");
//        //setInteger(v_);
//        assertEq("<html><body><form c:command=\"bean_one.goToPage1\" action=\"\" n-f=\"0\"><input type=\"radio\" name=\"bean_one.composite.integer1\" n-i=\"0\" value=\"5\" checked=\"checked\"/><input type=\"radio\" name=\"bean_one.composite.integer1\" n-i=\"0\" value=\"1\"/></form></body></html>", getNatRes(folder_, relative_, html_, files_, v_));
//    }
//    @Test
//    public void process_3_Rd_Test() {
//        String locale_ = "en";
//        String folder_ = "messages";
//        String relative_ = "sample/file";
//        String content_ = "one={0}";
//        String html_ = "<html c:bean='bean_one'><body><form c:command='$goToPage1'><input type='radio' name='composite.integer1' c:varValue='composite.integer1'/><input type='radio' name='composite.integer1' c:varValue='composite.integer0'/><input type='radio' name='composite.integer2' c:varValue='composite.integer1'/><input type='radio' name='composite.integer2' c:varValue='composite.integer0'/></form></body></html>";
//        StringMap<String> files_ = new StringMap<String>();
//        files_.put(EquallableBeanCoreUtil.formatFile(folder_,locale_,relative_), content_);
//        BeanOne bean_ = new BeanOne();
//        SampleBeanStruct v_ = init(bean_);
...
//        getStrings(v_).add("SECOND");
//        //setInteger(v_);
//        assertEq("<html><body><form c:command=\"bean_one.goToPage1\" action=\"\" n-f=\"0\"><input type=\"radio\" name=\"bean_one.composite.integer1\" n-i=\"0\" value=\"5\" checked=\"checked\"/><input type=\"radio\" name=\"bean_one.composite.integer1\" n-i=\"0\" value=\"1\"/><input type=\"radio\" name=\"bean_one.composite.integer2\" n-i=\"1\" value=\"5\" checked=\"checked\"/><input type=\"radio\" name=\"bean_one.composite.integer2\" n-i=\"1\" value=\"1\"/></form></body></html>", getNatRes(folder_, relative_, html_, files_, v_));
//    }
//    @Test
...
//        String relative_ = "sample/file";
//        String content_ = "one=Click";
//        String html_ = "<html c:bean='bean_one'><body><a title='Click'/></body></html>";
//        StringMap<String> files_ = new StringMap<String>();
//        files_.put(EquallableBeanCoreUtil.formatFile(folder_,locale_,relative_), content_);
//        BeanOne bean_ = new BeanOne();
//        SampleBeanStruct v_ = init(bean_);
...
////        getStrings(v_).add("SECOND");
//        //setInteger(v_);
//        assertEq("<html><body><span title=\"Click\"/></body></html>", getNatRes(folder_, relative_, html_, files_, v_));
//    }
//    @Test
//    public void process2_Tit_Spec__Test() {
//        String locale_ = "en";
//        String folder_ = "messages";
//        String relative_ = "sample/file";
//        String content_ = "one=Click";
...
//        Navigation n_ = nav(locale_,docs_,files_,lgNames_,new SampleNativeInit());
...
//        init(lgNames_, n_);
//        assertEq("<html><body><form action=\"\" name=\"myform\" c:command=\"bean_two.go\" n-f=\"0\"><input type=\"text\" name=\"bean_two.typedString\" n-i=\"0\" value=\"TYPED_STRING\"/></form></body></html>", n_.getHtmlText());
//    }
...
//        lgNames_.execute(false,DocumentBuilder.getFirstElementByAttribute(n_.getDocument(), n_.getSession().getRendKeyWords().getAttrNa(), Long.toString(lgNames_.getNatPage().getUrl())), n_);
//        assertEq("<html><body>HEAD<a c:command=\"bean_one.goToPage1\" href=\"\" n-a=\"0\"/></body></html>", n_.getHtmlText());
//    }
...
////        lgNames_.setupAll(docs_,n_, n_.getSession(), new DefNatBlockBuilder(), d_);
//        init(lgNames_, n_);
//        assertEq("<html><body><form action=\"\" name=\"myform\" c:command=\"bean_two.go\" n-f=\"0\"><input type=\"text\" name=\"bean_two.composite.string\" n-i=\"0\" value=\"\"/></form></body></html>", n_.getHtmlText());
//    }
...
//        String html_ = "<html c:bean=\"bean_one\"><body><c:import page=\"goToPage2\" keepfields=\"y\"><c:package name=\"code.formathtml.classes\"><c:class name=\"BeanTwo\"><c:field prepare=\"$intern.typedString2=message\"></c:field></c:class></c:package></c:import></body></html>";
...
//        NatDualConfigurationContext dual_ = new NatDualConfigurationContext();
//        setupNative(folder_, relative_, dual_);
//        Configuration configuration_ = conf_("c:");
//        preinit(lgNames_, configuration_);
//        setFiles(files_, configuration_);
//
//        NatAnalyzingDoc analyzingDoc_ = new NatAnalyzingDoc();
//        NatDocumentBlock rendDocumentBlock_ = buildRendWithTwoNativeBean2(html_, htmlTwo_, v1_, v2_, configuration_, analyzingDoc_, lgNames_, init_, dual_);
//        String render_ = getSampleRes(rendDocumentBlock_, configuration_, lgNames_);
//        assertEq("<html><body><a href=\"\" c:command=\"bean_two.go\" n-a=\"0\">Test {0}2</a>Description &lt;a c:command=\"$go\"&gt;two&lt;/a&gt;</body></html>", render_);
////        assertEq(1, beanTwo_.getForms().size());
////        assertEq("key", beanTwo_.getForms().getKeys().first());
////        assertEq("sample_value", v2_.getForms().getValStr("key"));
//    }
...
//        String relative_ = "sample/file";
//        String content_ = "err=Err";
//        String html_ = "<html c:bean=\"bean_two\"><body><form c:command=\"$go\"><input id=\"txt\" type=\"number\" name=\"typedInt\" c:varValue=\"typedInt\" c:validator=\"rate_val\"/><span c:for=\"txt\" c:valueMessage='msg_example,err'/><c:import page='goToPage2'/></form></body></html>";
...
//        dual_.getRenderFiles().add("page2.html");
//        lgNames_.getValidators().addEntry("rate_val",new MyValidator());
//        initSessionNatTwoBeans(nav_, lgNames_, dual_);
//        NatHtmlPage htmlPage_ = (NatHtmlPage)lgNames_.getNatPage();
//        LongMap<LongTreeMap<NatNodeContainer>> containersMap_;
//        containersMap_ = htmlPage_.getContainers();
//        LongTreeMap< NatNodeContainer> containers_ = containersMap_.getVal(0L);
...
//        String relative_ = "sample/file";
//        String content_ = "one=Description one\ntwo=Description <a href=\"\">two</a>\nthree=desc &lt;{0}&gt;\nfour=''asp''";
//        String htmlTwo_ = "<html c:bean=\"bean_one\"><body><form action=\"DELETE\" name=\"myform\" c:command=\"$goToPage1\"><c:select id=\"combo\" default=\"\" name=\"selectedString\" varValue=\"selectedString\" map=\"map\"/></form></body></html>";
//        StringMap<String> files_ = new StringMap<String>();
//        files_.put(EquallableBeanCoreUtil.formatFile(folder_,locale_,relative_), content_);
//        files_.put("page2.html", htmlTwo_);
//        BeanOne bean_ = new BeanOne();
...
//        assertEq("page1.html", nav_.getCurrentUrl());
//        assertEq("bean_two", nav_.getCurrentBeanName());
//        assertEq("<html><body><a c:command=\"bean_two.go2\" href=\"\" n-a=\"0\">Lk</a></body></html>", nav_.getHtmlText());
////        beanTwo_ = getBeanTwo(conf_, "bean_two");
////        StringMapObjectSample map_ = beanTwo_.getForms();
////        assertEq(8, map_.size());
////        assertEq(8, getBeanTwo(conf_, "bean_two").getForms().size());
...
//        String relative_ = "sample/file";
//        String content_ = "one=Description one\ntwo=Description <a href=\"\">two</a>\nthree=desc &lt;{0}&gt;\nfour=''asp''";
//        String htmlTwo_ = "<html c:bean=\"bean_one\"><body><form action=\"DELETE\" name=\"myform\" c:command=\"$goToPage1\"><c:select id=\"combo\" default=\"\" name=\"chosenNumber\" varValue=\"chosenNumber\" map=\"map\"/></form></body></html>";
//        StringMap<String> files_ = new StringMap<String>();
//        files_.put(EquallableBeanCoreUtil.formatFile(folder_,locale_,relative_), content_);
//        files_.put("page2.html", htmlTwo_);
//        BeanOne bean_ = new BeanOne();
...
//        StringList rs_ = _dual.getRenderFiles();
//        d_.addEntry(rs_.first(),newRendDocumentBlock(_nav.getSession(), _adv, _nav.getFiles().getVal(rs_.first()), new DefNatBlockBuilder()));
//        NatAnalyzedCode init_ = initAna(_nav, _adv, analyzingDoc_);
//        oneAna(map_, analyzingDoc_, d_, init_);
//        afterAna(_nav, _adv, analyzingDoc_, d_);
//    }

    private static void oneAna(StringMap<BeanInfo> _map, NatAnalyzingDoc _analyzingDoc, StringMap<NatAnaRendDocumentBlock> _d, NatAnalyzedCode _init) {
...
//    private static StringMap<NatAnaRendDocumentBlock> twoFiles(Navigation _nav, CustBeanLgNames _adv, NatDualConfigurationContext _dual, StringMap<BeanInfo> _map, NatAnalyzingDoc _analyzingDoc) {
//        StringMap<NatAnaRendDocumentBlock> d_ = new StringMap<NatAnaRendDocumentBlock>();
//        StringList rs_ = _dual.getRenderFiles();
//        d_.addEntry(rs_.first(),newRendDocumentBlock(_nav.getSession(), _adv, _nav.getFiles().getVal(rs_.first()), new DefNatBlockBuilder()));
//        d_.addEntry(rs_.last(),newRendDocumentBlock(_nav.getSession(), _adv, _nav.getFiles().getVal(rs_.last()), new DefNatBlockBuilder()));
//        NatAnalyzedCode init_ = initAna(_nav, _adv, _analyzingDoc);
//        twoAna(_map, _analyzingDoc, d_, init_);
//        afterAna(_nav, _adv, _analyzingDoc, d_);
//        return d_;
//    }

    private static void twoAna(StringMap<BeanInfo> _map, NatAnalyzingDoc _analyzingDoc, StringMap<NatAnaRendDocumentBlock> _d, NatAnalyzedCode _init) {
        AnaRendBlockHelp.buildFctInstructions(_d.firstValue(), _analyzingDoc, _init, _map);
...
//    }
//
//    private static NatAnalyzedCode initAna(Navigation _nav, CustBeanLgNames _adv, NatAnalyzingDoc _analyzingDoc) {
//        lgs(_nav, _analyzingDoc);
//        return init(_adv);
//    }

//    private static void afterAna(Navigation _nav, CustBeanLgNames _adv, NatAnalyzingDoc _analyzingDoc, StringMap<NatAnaRendDocumentBlock> _d) {
//        NatRendForwardInfos.buildExec(_analyzingDoc, _d, _adv.getRenders());
//        preinit(_adv, _nav.getSession());
////        standards_.beansForTest().clear();
//        init(_adv, _nav);
//    }

//    private static NatAnalyzingDoc anaDoc(Navigation _nav, NatDualConfigurationContext _dual, StringMap<BeanInfo> _map) {
//        _nav.getSession().setBeansInfos(_map);
...
//
//        _map.addAllEntries(configuration_.getBeansInfos());
//        configuration_.getBeansInfos().addAllEntries(_map);
...
//    }
    ...
    private static void init(CustBeanLgNames _adv, Navigation _nav) {
    ...
    private String getNatRes(String _folder, String _relative, String _html, StringMap<String> _files, SampleBeanStruct _v) {
        ...
        StringMap<NatAnaRendDocumentBlock> d_ = analyze(config_, analyzingDoc_, beansInfos_, lgNames_, initNat_, config_, dual_, b_, _html);
        IdMap<NatOperationNode, ValidatorInfo> lateValidators_ = new IdMap<NatOperationNode, ValidatorInfo>();
    ...
    private String getNatRes(String _folder, String _relative, String _html, SampleBeanStruct _v) {
        ...
        DefNatBlockBuilder b_ = new DefNatBlockBuilder();
        StringMap<NatAnaRendDocumentBlock> d_ = analyze(con_, analyzingDo_, beansInfos_, lgNames_, init_, con_, dual_, b_, _html);
//        IdMap<NatOperationNode, ValidatorInfo> lateValidators_ = new IdMap<NatOperationNode, ValidatorInfo>();
    ...
    private Configuration conf_(String _prefix) {
...
//        StringMap<NatAnaRendDocumentBlock> d_ = analyze(_configuration, _analyzingDoc, beansInfos_, _adv, _analyzing, _configuration, _dual, _html, _htmlTwo);
//        IdMap<NatOperationNode, ValidatorInfo> lateValidators_ = new IdMap<NatOperationNode, ValidatorInfo>();
...
//    }
    ...
    private static NatDocumentBlock buildRendWithTwoNativeBean2(String _html, String _htmlTwo, SampleBeanStruct _v1, Struct _v2, Configuration _configuration, NatAnalyzingDoc _analyzingDoc, CustBeanLgNames _adv, NatAnalyzedCode _analyzing, NatDualConfigurationContext _dual) {
        StringMap<BeanInfo> beansInfos_ = _configuration.getBeansInfos();
        ...
        DefNatBlockBuilder b_ = new DefNatBlockBuilder();
        StringMap<NatAnaRendDocumentBlock> d_ = analyze2(_configuration, _analyzingDoc, beansInfos_, _adv, _analyzing, _configuration, _dual, b_, _html, _htmlTwo);
        IdMap<NatOperationNode, ValidatorInfo> lateValidators_ = new IdMap<NatOperationNode, ValidatorInfo>();
    ...
    private static void setLocalFiles(NatAnalyzingDoc _analyzingDoc, NatAnalyzedCode _analyzing, Configuration _configuration, NatDualConfigurationContext _dual) {
    ...
    private static StringMap<NatAnaRendDocumentBlock> analyze(Configuration _conf, NatAnalyzingDoc _analyzingDoc, StringMap<BeanInfo> _beansInfosBefore, CustBeanLgNames _adv, NatAnalyzedCode _analyzing, Configuration _configuration, NatDualConfigurationContext _dual, DefNatBlockBuilder _b, String... _html) {
        StringMap<NatAnaRendDocumentBlock> d_ = new StringMap<NatAnaRendDocumentBlock>();
    ...
    private static StringMap<NatAnaRendDocumentBlock> analyze2(Configuration _conf, NatAnalyzingDoc _analyzingDoc, StringMap<BeanInfo> _beansInfosBefore, CustBeanLgNames _adv, NatAnalyzedCode _analyzing, Configuration _configuration, NatDualConfigurationContext _dual, DefNatBlockBuilder _b, String... _html) {
        StringMap<NatAnaRendDocumentBlock> d_ = new StringMap<NatAnaRendDocumentBlock>();
        d_.addEntry("page1.html",newRendDocumentBlock(_conf, _adv, _html[0], _b));
    ...
    private static NatAnaRendDocumentBlock newRendDocumentBlock(Configuration _conf, CustBeanLgNames _adv, String _f, DefNatBlockBuilder _b) {
...
//        _stds.execute(true,elt_,_nav);
////        _stds.processRendFormRequest(_nav, elt_);
//    }
...
//                "\t<java.lang.String field='filesConfName' value='conf_'/>\n" +
//                "\t<sm field='beans'>\n" +
...
//    private StringList getStrings(SampleBeanStruct _v) {
//        return ((BeanThree)_v.getComposite()).getStrings();
//    }

//    private void setInteger(SampleBeanStruct _v) {
//        ((BeanThree)_v.getComposite()).setInteger(5);
//    }

    private Navigation nav(String _lg, StringMap<Document> _docs, StringMap<String> _files, CustBeanLgNames _stds, AbstractNativeInit _init) {
        StringList lgs_ = new StringList(_lg);
        lgs_.add(_lg);
        return _stds.nav(lgs_, _lg, _init, _docs, _files, _files, "");
    }
