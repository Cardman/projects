...
//        standards_.beansForTest().clear();
    ...
    private static void putBean(String _key, BeanNatCommonLgNames _stds, BeanStruct _v) {
...
//    }
    ...
    private static void putBean(String _key, BeanStruct _v, CustBeanLgNames _adv) {
