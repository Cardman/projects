...
public final class StrMapTest extends EquallableBeanCoreUtil {

    @Test
    public void putAllMap13Test() {
        StringMapObjectSample map_ = new StringMapObjectSample();
        map_.put("ONE", 1);
        map_.put("TWO", 2);
        StringMapObjectSample mapToPut_ = new StringMapObjectSample();
