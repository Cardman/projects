...
public final class BeloteStandards extends BeanNatLgNames {
    ...
    public void buildOther() {
        ...
        std_ = new SpecialNatClass(TYPE_BELOTE_BEAN, fields_, constructors_, methods_, TYPE_BEAN, MethodModifier.ABSTRACT);
        StringList params_;
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_DETAILS_RESULTS_BELOTE_BEAN, fields_, constructors_, methods_, TYPE_BELOTE_BEAN, MethodModifier.NORMAL);
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_DECLARING_PLAYER_VALUE, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_RESULTS_BELOTE_BEAN, fields_, constructors_, methods_, TYPE_BELOTE_BEAN, MethodModifier.NORMAL);
        params_ = new StringList();
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_RULES_BELOTE_BEAN, fields_, constructors_, methods_, TYPE_BELOTE_BEAN, MethodModifier.NORMAL);
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_BID_BELOTE, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        std_.getDirectInterfaces().add(TYPE_DISPLAYABLE);
        getStandards().addEntry(TYPE_BID_BELOTE, std_);
        fields_ = new CustList<StandardField>();
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_DECLARES_BELOTE, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        std_.getDirectInterfaces().add(TYPE_DISPLAYABLE);
        getStandards().addEntry(TYPE_DECLARES_BELOTE, std_);
        fields_ = new CustList<StandardField>();
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_RESULTS_BELOTE, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        getStandards().addEntry(TYPE_RESULTS_BELOTE, std_);
        fields_ = new CustList<StandardField>();
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_RULES_BELOTE, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
