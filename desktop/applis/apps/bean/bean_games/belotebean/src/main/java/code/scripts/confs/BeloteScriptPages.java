...
public final class BeloteScriptPages {
...
//    public static final String ADDED_FILES = "addedFiles";
    public static final String CSS = "resources_cards/css/belote.css";
...
//    public static final String KEY = "key";
    ...
    public static void initAna(NatDualConfigurationContext _d){
        _d.setMessagesFolder(RESOURCES_CARDS_MESSAGES);
        StringMap<String> properties_ = new StringMap<String>(new CollCapacity(1));
        properties_.addEntry(MSG,MESSAGES_BELOTE);
...
//        attrs1_.add(CoreDocument.createAttribute(VALUE,"resources_cards/classes/cards/belote/detailsresults.html"));
...
//        attrs8_.add(CoreDocument.createAttribute(VALUE,"cards.belote.beans.DetailsResultsBeloteBean"));
...
//        attrs11_.add(CoreDocument.createAttribute(VALUE,"ResultsBelote"));
...
//        attrs14_.add(CoreDocument.createAttribute(VALUE, MESSAGES_BELOTE));
...
//        CustList<Attr> attrs1_=new CustList<Attr>(new CollCapacity(3));
//        attrs1_.add(CoreDocument.createAttribute(CLASS, CFG));
//        attrs1_.add(CoreDocument.createAttribute(FIELD, PREFIX));
//        attrs1_.add(CoreDocument.createAttribute(VALUE, PRE_VALUE));
//        elt1_.setAttributes(new NamedNodeMap(attrs1_));
//        elt0_.appendChild(elt1_);
//        Element elt2_=doc_.createElement(STR);
//        CustList<Attr> attrs2_=new CustList<Attr>(new CollCapacity(3));
//        attrs2_.add(CoreDocument.createAttribute(CLASS, CFG));
//        attrs2_.add(CoreDocument.createAttribute(FIELD, FIRST_URL));
//        attrs2_.add(CoreDocument.createAttribute(VALUE,"resources_cards/classes/cards/belote/results.html"));
//        elt2_.setAttributes(new NamedNodeMap(attrs2_));
//        elt0_.appendChild(elt2_);
//        Element elt3_=doc_.createElement(SM);
//        CustList<Attr> attrs3_=new CustList<Attr>(new CollCapacity(2));
...
//        attrs8_.add(CoreDocument.createAttribute(CLASS, BEAN));
//        attrs8_.add(CoreDocument.createAttribute(FIELD, CLASS_NAME));
//        attrs8_.add(CoreDocument.createAttribute(VALUE,"cards.belote.beans.ResultsBeloteBean"));
//        elt8_.setAttributes(new NamedNodeMap(attrs8_));
//        elt5_.appendChild(elt8_);
//        elt3_.appendChild(elt5_);
//        elt0_.appendChild(elt3_);
...
//        attrs2_.add(CoreDocument.createAttribute(CLASS, CFG));
//        attrs2_.add(CoreDocument.createAttribute(FIELD, FIRST_URL));
//        attrs2_.add(CoreDocument.createAttribute(VALUE,"resources_cards/classes/cards/belote/rules.html"));
//        elt2_.setAttributes(new NamedNodeMap(attrs2_));
//        elt0_.appendChild(elt2_);
//        Element elt3_=doc_.createElement(SM);
//        CustList<Attr> attrs3_=new CustList<Attr>(new CollCapacity(2));
...
//        attrs8_.add(CoreDocument.createAttribute(CLASS, BEAN));
//        attrs8_.add(CoreDocument.createAttribute(FIELD, CLASS_NAME));
//        attrs8_.add(CoreDocument.createAttribute(VALUE,"cards.belote.beans.RulesBeloteBean"));
//        elt8_.setAttributes(new NamedNodeMap(attrs8_));
//        elt5_.appendChild(elt8_);
//        elt3_.appendChild(elt5_);
//        elt0_.appendChild(elt3_);
...
//        attrs11_.add(CoreDocument.createAttribute(CLASS, CFG));
//        attrs11_.add(CoreDocument.createAttribute(FIELD, DATA_BASE_CLASS_NAME));
//        attrs11_.add(CoreDocument.createAttribute(VALUE,"RulesBelote"));
//        elt11_.setAttributes(new NamedNodeMap(attrs11_));
//        elt0_.appendChild(elt11_);
//        Element elt12_=doc_.createElement(SM);
//        CustList<Attr> attrs12_=new CustList<Attr>(new CollCapacity(2));
...
//        map_.addEntry("resources_cards/conf/details_results_belote.xml",info0());
//        map_.addEntry("resources_cards/conf/results_belote.xml",info1());
//        map_.addEntry("resources_cards/conf/rules_belote.xml",info2());
//        return map_;
//    }
