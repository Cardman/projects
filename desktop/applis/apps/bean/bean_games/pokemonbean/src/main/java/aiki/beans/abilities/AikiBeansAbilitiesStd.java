...
public final class AikiBeansAbilitiesStd{
    ...
    private static void buildAbilitiesBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(SORTED_ABILITIES, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilitiesBeanSortedAbilitiesGet(),null));
    ...
    private static void buildAbilityBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(REASONS_END_ROUND, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanReasonsEndRoundGet(),null));
        fields_.add(new StandardField(MAP_VARS_FAIL_END_ROUND, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMapVarsFailEndRoundGet(),null));
        ...
        fields_.add(new StandardField(BREAK_PROTECTION_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanBreakProtectionMovesGet(),null));
        ...
        fields_.add(new StandardField(CHGT_TYPE_BY_WEATHER, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanChgtTypeByWeatherGet(),null));
        ...
        fields_.add(new StandardField(IMMU_RECHARGE_ROUND_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanImmuRechargeRoundMovesGet(),null));
        ...
        fields_.add(new StandardField(REVERSE_EFFECTS_POWER_MOVES_TYPES_GLOBAL_ABILITIES, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanReverseEffectsPowerMovesTypesGlobalAbilitiesGet(),null));
        ...
        fields_.add(new StandardField(HEAL_HP_WHILE_USING_BERRY,BeanNatCommonLgNames.TYPE_RATE,false,false,new AbilityBeanHealHpWhileUsingBerryGet(),null));
        fields_.add(new StandardField(MAX_HP_FOR_USING_BERRY,BeanNatCommonLgNames.TYPE_RATE,false,false,new AbilityBeanMaxHpForUsingBerryGet(),null));
        fields_.add(new StandardField(MULT_ALLY_DAMAGE,BeanNatCommonLgNames.TYPE_RATE,false,false,new AbilityBeanMultAllyDamageGet(),null));
        fields_.add(new StandardField(MULT_DAMAGE_CH,BeanNatCommonLgNames.TYPE_RATE,false,false,new AbilityBeanMultDamageChGet(),null));
        fields_.add(new StandardField(MULT_EVT_RATE_CH,BeanNatCommonLgNames.TYPE_RATE,false,false,new AbilityBeanMultEvtRateChGet(),null));
        fields_.add(new StandardField(MULT_EVT_RATE_SEC_EFFECT_OWNER,BeanNatCommonLgNames.TYPE_RATE,false,false,new AbilityBeanMultEvtRateSecEffectOwnerGet(),null));
        fields_.add(new StandardField(MULT_STAB,BeanNatCommonLgNames.TYPE_RATE,false,false,new AbilityBeanMultStabGet(),null));
        ...
        fields_.add(new StandardField(IMMU_ALLY_FROM_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanImmuAllyFromMovesGet(),null));
        fields_.add(new StandardField(IMMU_WEATHER, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanImmuWeatherGet(),null));
        fields_.add(new StandardField(IGN_ABILITY, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanIgnAbilityGet(),null));
        fields_.add(new StandardField(IGN_FOE_TEAM_MOVE, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanIgnFoeTeamMoveGet(),null));
        fields_.add(new StandardField(IMMU_ABILITY, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanImmuAbilityGet(),null));
        fields_.add(new StandardField(IMMU_STATUS_BEGIN_ROUND, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanImmuStatusBeginRoundGet(),null));
        fields_.add(new StandardField(TYPE_FOR_MOVES,BeanNatCommonLgNames.STRING,false,false,new AbilityBeanTypeForMovesGet(),null));
        fields_.add(new StandardField(CHANGING_BOOST_TYPES, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanChangingBoostTypesGet(),null));
        ...
        fields_.add(new StandardField(HEAL_HP_BY_WEATHER, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanHealHpByWeatherGet(),null));
        fields_.add(new StandardField(HEAL_HP_BY_TYPE_IF_WEATHER, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanHealHpByTypeIfWeatherGet(),null));
        fields_.add(new StandardField(IMMU_LOW_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanImmuLowStatGet(),null));
        fields_.add(new StandardField(IMMU_LOW_STAT_IF_STATUS, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanImmuLowStatIfStatusGet(),null));
        fields_.add(new StandardField(IMMU_LOW_STATIS_TYPES, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanImmuLowStatisTypesGet(),null));
        fields_.add(new StandardField(MAX_STATISTICS_IF_CH, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanMaxStatisticsIfChGet(),null));
        fields_.add(new StandardField(SINGLE_STATUS, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanSingleStatusGet(),null));
        fields_.add(new StandardField(IMMU_MOVE_TYPES_BY_WEATHER, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanImmuMoveTypesByWeatherGet(),null));
        fields_.add(new StandardField(IMMU_STATUS, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanImmuStatusGet(),null));
        fields_.add(new StandardField(IMMU_STATUS_TYPES, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanImmuStatusTypesGet(),null));
        fields_.add(new StandardField(DIVIDE_STATUS_ROUND, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanDivideStatusRoundGet(),null));
        fields_.add(new StandardField(FORWARD_STATUS, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanForwardStatusGet(),null));
        fields_.add(new StandardField(BREAK_FOE_IMMUNE, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanBreakFoeImmuneGet(),null));
        fields_.add(new StandardField(DEF_EFF,BeanNatCommonLgNames.TYPE_RATE,false,false,new AbilityBeanDefEffGet(),null));
        fields_.add(new StandardField(MULT_STAT, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMultStatGet(),null));
        fields_.add(new StandardField(MULT_STAT_IF_DAMAGE_CAT, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMultStatIfDamageCatGet(),null));
        fields_.add(new StandardField(MULT_STAT_IF_DAMGE_TYPE, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMultStatIfDamgeTypeGet(),null));
        fields_.add(new StandardField(MULT_STAT_IF_CAT, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMultStatIfCatGet(),null));
        fields_.add(new StandardField(MULT_STAT_IF_STATUT_RANK, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMultStatIfStatutRankGet(),null));
        fields_.add(new StandardField(BONUS_STAT_RANK, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanBonusStatRankGet(),null));
        fields_.add(new StandardField(BOOST_STAT_RANK_END_ROUND, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanBoostStatRankEndRoundGet(),null));
        fields_.add(new StandardField(BOOST_STAT_RANK_PROTECTED, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanBoostStatRankProtectedGet(),null));
        fields_.add(new StandardField(LOW_STAT_FOE_HIT, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanLowStatFoeHitGet(),null));
        fields_.add(new StandardField(MULT_STAT_IF_KO_FOE, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMultStatIfKoFoeGet(),null));
        fields_.add(new StandardField(MULT_STAT_IF_LOW_STAT, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMultStatIfLowStatGet(),null));
        fields_.add(new StandardField(MULT_STAT_ALLY, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMultStatAllyGet(),null));
        fields_.add(new StandardField(INCREASED_PRIO, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanIncreasedPrioGet(),null));
        fields_.add(new StandardField(INCREASED_PRIO_TYPES, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanIncreasedPrioTypesGet(),null));
        fields_.add(new StandardField(MULT_DAMAGE_FOE, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMultDamageFoeGet(),null));
        fields_.add(new StandardField(MULT_POWER_MOVES_TYPES_GLOBAL, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMultPowerMovesTypesGlobalGet(),null));
        fields_.add(new StandardField(FAIL_STATUS, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanFailStatusGet(),null));
        fields_.add(new StandardField(MAP_VARS, BeanNatCommonLgNames.TYPE_MAP,false,false,new AbilityBeanMapVarsGet(),null));
        fields_.add(new StandardField(HEALED_HP_RATE_BY_SWITCH,BeanNatCommonLgNames.TYPE_RATE,false,false,new AbilityBeanHealedHpRateBySwitchGet(),null));
        fields_.add(new StandardField(POKEMON, BeanNatCommonLgNames.TYPE_LIST,false,false,new AbilityBeanPokemonGet(),null));
        ...
        methods_.add( new SpecNatMethod(GA,BeanNatCommonLgNames.STRING, false, MethodModifier.NORMAL,new CstNatCaller(WEB_HTML_ABILITY_ABILITIES_HTML)));
