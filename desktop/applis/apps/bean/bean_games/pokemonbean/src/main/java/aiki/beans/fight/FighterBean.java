...
//        initPage();
        formatMessageAnc(new BeanAnchorCstEvent(CommonBean.WEB_FIGHT_HTML_FIGHT_HTML), MessagesPkBean.FIGHTER,MessagesFightFighter.M_P_91_FIGHT);
        formatMessageAnc(new BeanAnchorCstEvent(CommonBean.WEB_FIGHT_HTML_TEAM_HTML),MessagesPkBean.FIGHTER,MessagesFightFighter.M_P_91_TEAM);
        formatMessageAnc(new BeanAnchorCstEvent(CommonBean.WEB_FIGHT_HTML_FIGHTER_HTML),MessagesPkBean.FIGHTER,MessagesFightFighter.M_P_91_REFRESH);
