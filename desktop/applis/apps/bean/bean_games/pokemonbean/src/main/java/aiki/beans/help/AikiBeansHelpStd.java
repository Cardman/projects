...
//    private static final String IS_FIRST_ROW = "isFirstRow";
    ...
    private static void buildFightHelpBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(COPY_ABILITIES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanCopyAbilitiesGet(),null));
        fields_.add(new StandardField(ABILITIES_SENT_STATIS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesSentStatisGet(),null));
        fields_.add(new StandardField(SUBSTITUTING_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanSubstitutingMovesGet(),null));
        fields_.add(new StandardField(ABILITIES_PRIO, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesPrioGet(),null));
        fields_.add(new StandardField(SLOW_ABILITIES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanSlowAbilitiesGet(),null));
        fields_.add(new StandardField(SLOW_ITEMS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanSlowItemsGet(),null));
        fields_.add(new StandardField(REVERSE_SPEED_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanReverseSpeedMovesGet(),null));
        fields_.add(new StandardField(BERRY_SPEED, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanBerrySpeedGet(),null));
        fields_.add(new StandardField(ITEM_SPEED, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanItemSpeedGet(),null));
        fields_.add(new StandardField(ABILITIES_SWITCH, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesSwitchGet(),null));
        fields_.add(new StandardField(DELETED_STATUS_SWITCH, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanDeletedStatusSwitchGet(),null));
        fields_.add(new StandardField(ENTRY_HAZARD, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanEntryHazardGet(),null));
        fields_.add(new StandardField(BEGIN_ROUND_STATUS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanBeginRoundStatusGet(),null));
        fields_.add(new StandardField(DELETE_STATUS_MOVE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanDeleteStatusMoveGet(),null));
        fields_.add(new StandardField(IMMU_STATUS_ABILITY, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanImmuStatusAbilityGet(),null));
        fields_.add(new StandardField(AUTO_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAutoDamageGet(),null));
        fields_.add(new StandardField(MAP_AUTO_DAMAGE, BeanNatCommonLgNames.TYPE_MAP,false,false,new FightHelpBeanMapAutoDamageGet(),null));
        fields_.add(new StandardField(PREPA_ROUND_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanPrepaRoundMovesGet(),null));
        fields_.add(new StandardField(SPEED_PREPARING_ITEMS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanSpeedPreparingItemsGet(),null));
        fields_.add(new StandardField(DISAPPEARING_ROUND_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanDisappearingRoundMovesGet(),null));
        fields_.add(new StandardField(RECHARGE_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanRechargeMovesGet(),null));
        fields_.add(new StandardField(IMMU_RECHARGING, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanImmuRechargingGet(),null));
        fields_.add(new StandardField(MOVES_INVOKING, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesInvokingGet(),null));
        fields_.add(new StandardField(COPY_MOVE_TYPES_AB, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanCopyMoveTypesAbGet(),null));
        fields_.add(new StandardField(MOVES_THIEVING, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesThievingGet(),null));
        fields_.add(new StandardField(MOVES_SEC_EFF_ITEMS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesSecEffItemsGet(),null));
        fields_.add(new StandardField(MOVES_ATTRACTING, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesAttractingGet(),null));
        fields_.add(new StandardField(BEGIN_ROUND_STATUS_FOE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanBeginRoundStatusFoeGet(),null));
        fields_.add(new StandardField(PRESSURE_ABILITIES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanPressureAbilitiesGet(),null));
        fields_.add(new StandardField(PROTECT_ABILITIES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanProtectAbilitiesGet(),null));
        fields_.add(new StandardField(PROTECT_ITEMS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanProtectItemsGet(),null));
        fields_.add(new StandardField(PROTECT_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanProtectMovesGet(),null));
        fields_.add(new StandardField(EFF_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanEffMovesGet(),null));
        fields_.add(new StandardField(MOVES_MIRROR, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesMirrorGet(),null));
        fields_.add(new StandardField(ABILITIES_PART_STATIS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesPartStatisGet(),null));
        fields_.add(new StandardField(MOVES_TEAM, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesTeamGet(),null));
        fields_.add(new StandardField(ABILITIES_FIGHTER_STATIS_VAR, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesFighterStatisVarGet(),null));
        fields_.add(new StandardField(ABILITIES_RATE_STATIS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesRateStatisGet(),null));
        fields_.add(new StandardField(COMBO_EVT_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanComboEvtStatGet(),null));
        fields_.add(new StandardField(ABILITIES_FIGHTER_STATIS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesFighterStatisGet(),null));
        fields_.add(new StandardField(ITEMS_FIGHTER_STATIS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanItemsFighterStatisGet(),null));
        fields_.add(new StandardField(SUCCESSFUL_STATUS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanSuccessfulStatusGet(),null));
        fields_.add(new StandardField(GLOBAL_MOVES_STATUS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanGlobalMovesStatusGet(),null));
        fields_.add(new StandardField(ABILITIES_PART_STATUS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesPartStatusGet(),null));
        fields_.add(new StandardField(ABILITIES_FIGHTER_STATUS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesFighterStatusGet(),null));
        ...
        fields_.add(new StandardField(ABILITIES_REV_ABS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesRevAbsGet(),null));
        fields_.add(new StandardField(ABILITIES_DAMAGE_STATIS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesDamageStatisGet(),null));
        fields_.add(new StandardField(ABILITIES_CHANGING_TYPES_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesChangingTypesDamageGet(),null));
        fields_.add(new StandardField(ABILITIES_TAKING_ITEM, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesTakingItemGet(),null));
        fields_.add(new StandardField(ABILITIES_STATIS_VAR_USER, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesStatisVarUserGet(),null));
        fields_.add(new StandardField(ABILITIES_STATUS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesStatusGet(),null));
        fields_.add(new StandardField(ABILITIES_COPY_AB, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesCopyAbGet(),null));
        fields_.add(new StandardField(RECOIL_ITEMS, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanRecoilItemsGet(),null));
        fields_.add(new StandardField(RECOIL_ABILITIES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanRecoilAbilitiesGet(),null));
        fields_.add(new StandardField(ABILITIES_KO_TARGET, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesKoTargetGet(),null));
        fields_.add(new StandardField(MOVES_KO_TARGET, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesKoTargetGet(),null));
        fields_.add(new StandardField(BERRY_USER, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanBerryUserGet(),null));
        fields_.add(new StandardField(BERRY_TARGET, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanBerryTargetGet(),null));
        fields_.add(new StandardField(ABILITIES_END_ROUND, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesEndRoundGet(),null));
        fields_.add(new StandardField(BERRY_END_ROUND, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanBerryEndRoundGet(),null));
        ...
        fields_.add(new StandardField(MOVES_TARGET_POWER, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesTargetPowerGet(),null));
        fields_.add(new StandardField(ABILITIES_USER_POWER, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesUserPowerGet(),null));
        fields_.add(new StandardField(MOVES_USER_ALLY_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesUserAllyDamageGet(),null));
        fields_.add(new StandardField(ABILITIES_TARGET_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesTargetDamageGet(),null));
        fields_.add(new StandardField(MOVES_TARGET_TEAM_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesTargetTeamDamageGet(),null));
        fields_.add(new StandardField(ABILITIES_USER_IGN_TARGET_TEAM, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesUserIgnTargetTeamGet(),null));
        fields_.add(new StandardField(ABILITIES_GLOBAL, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesGlobalGet(),null));
        fields_.add(new StandardField(MOVES_GLOBAL, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesGlobalGet(),null));
        fields_.add(new StandardField(ITEMS_USER_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanItemsUserDamageGet(),null));
        fields_.add(new StandardField(ABILITIES_USER_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesUserDamageGet(),null));
        fields_.add(new StandardField(MOVES_INVOK_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesInvokDamageGet(),null));
        fields_.add(new StandardField(ITEMS_TARGET_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanItemsTargetDamageGet(),null));
        fields_.add(new StandardField(MOVES_GLOBAL_PREPA_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesGlobalPrepaDamageGet(),null));
        fields_.add(new StandardField(STATUS_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanStatusDamageGet(),null));
        fields_.add(new StandardField(ABILITIES_USER_TARGET_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesUserTargetDamageGet(),null));
        fields_.add(new StandardField(ABILITIES_USER_STAB_DAMAGE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesUserStabDamageGet(),null));
        fields_.add(new StandardField(MOVES_TYPES_DEF_ITEM, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesTypesDefItemGet(),null));
        fields_.add(new StandardField(ITEMS_TYPES_DEF, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanItemsTypesDefGet(),null));
        fields_.add(new StandardField(MOVES_TYPES_DEF_WEATHER, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesTypesDefWeatherGet(),null));
        fields_.add(new StandardField(ABILITIES_TYPE_DEF_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesTypeDefMovesGet(),null));
        fields_.add(new StandardField(MOVES_TYPE_DEF_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesTypeDefMovesGet(),null));
        fields_.add(new StandardField(MOVES_CHANGE_TYPE_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesChangeTypeMovesGet(),null));
        fields_.add(new StandardField(MOVES_GLOBAL_BREAK_IMMU, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesGlobalBreakImmuGet(),null));
        fields_.add(new StandardField(MOVES_UNPROTECTING_TYPES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesUnprotectingTypesGet(),null));
        fields_.add(new StandardField(ABILITIES_BREAK_IMMU, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesBreakImmuGet(),null));
        fields_.add(new StandardField(ITEMS_CANCEL_IMMU, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanItemsCancelImmuGet(),null));
        fields_.add(new StandardField(TYPES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanTypesGet(),null));
        fields_.add(new StandardField(EFFICIENCY, BeanNatCommonLgNames.TYPE_MAP,false,false,new FightHelpBeanEfficiencyGet(),null));
        fields_.add(new StandardField(MOVES_IGN_LOW_ATT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesIgnLowAttGet(),null));
        fields_.add(new StandardField(MOVES_IGN_INC_DEF, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesIgnIncDefGet(),null));
        fields_.add(new StandardField(ABILITIES_BOOSTING_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesBoostingStatGet(),null));
        fields_.add(new StandardField(ITEMS_BOOSTING_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanItemsBoostingStatGet(),null));
        fields_.add(new StandardField(ITEMS_MULT_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanItemsMultStatGet(),null));
        fields_.add(new StandardField(ABILITIES_MULT_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesMultStatGet(),null));
        fields_.add(new StandardField(MOVES_GLOBAL_MULT_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesGlobalMultStatGet(),null));
        fields_.add(new StandardField(MOVES_TEAM_MULT_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesTeamMultStatGet(),null));
        fields_.add(new StandardField(ABILITIES_ALLY_MULT_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesAllyMultStatGet(),null));
        fields_.add(new StandardField(MOVES_FOE_TEAM_MULT_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesFoeTeamMultStatGet(),null));
        fields_.add(new StandardField(STATUS_MULT_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanStatusMultStatGet(),null));
        fields_.add(new StandardField(ABILITIES_IMMU_MULT_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesImmuMultStatGet(),null));
        fields_.add(new StandardField(COMBO_MULT_STAT, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanComboMultStatGet(),null));
        fields_.add(new StandardField(ABILITIES_BREAK_PROTECT_MOVES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesBreakProtectMovesGet(),null));
        fields_.add(new StandardField(MOVES_IGN_ACC, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesIgnAccGet(),null));
        fields_.add(new StandardField(MOVES_IGN_EVA, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesIgnEvaGet(),null));
        fields_.add(new StandardField(MOVES_GLOBAL_ACC, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesGlobalAccGet(),null));
        fields_.add(new StandardField(ABILITIES_IMMU_CH, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesImmuChGet(),null));
        fields_.add(new StandardField(MOVES_BOOST_CH, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesBoostChGet(),null));
        fields_.add(new StandardField(ABILITES_MULT_EVT_CH, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitesMultEvtChGet(),null));
        fields_.add(new StandardField(ABILITES_MULT_RATE_CH, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitesMultRateChGet(),null));
        fields_.add(new StandardField(RATE_FORMULA,BeanNatCommonLgNames.STRING,false,false,new FightHelpBeanRateFormulaGet(),null));
        fields_.add(new StandardField(BOOSTS, BeanNatCommonLgNames.TYPE_MAP,false,false,new FightHelpBeanBoostsGet(),null));
        ...
        fields_.add(new StandardField(BOOSTS_CH, BeanNatCommonLgNames.TYPE_MAP,false,false,new FightHelpBeanBoostsChGet(),null));
        fields_.add(new StandardField(MOVES_PROTECTING_TYPES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesProtectingTypesGet(),null));
        fields_.add(new StandardField(MOVES_GLOBAL_BREAK_IMMU_AB, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesGlobalBreakImmuAbGet(),null));
        fields_.add(new StandardField(ABILITIES_BREAKABLE, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesBreakableGet(),null));
        fields_.add(new StandardField(ABILITIES_IMMU_TYPES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesImmuTypesGet(),null));
        fields_.add(new StandardField(ITEMS_IMMU_TYPES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanItemsImmuTypesGet(),null));
        fields_.add(new StandardField(ABILITIES_IMMU_ALLIES, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesImmuAlliesGet(),null));
        fields_.add(new StandardField(ABILITIES_IMMU_ALLIES_DAM, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesImmuAlliesDamGet(),null));
        fields_.add(new StandardField(ABILITIES_IMMU, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesImmuGet(),null));
        fields_.add(new StandardField(ITEMS_IMMU, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanItemsImmuGet(),null));
        fields_.add(new StandardField(ABILITIES_IMMU_SEC_EFF_OTHER, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesImmuSecEffOtherGet(),null));
        fields_.add(new StandardField(ABILITIES_IMMU_SEC_EFF_OWNER, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesImmuSecEffOwnerGet(),null));
        fields_.add(new StandardField(ABILITIES_ACHIEVE_TARGET, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanAbilitiesAchieveTargetGet(),null));
        fields_.add(new StandardField(MOVES_PROTECTING, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanMovesProtectingGet(),null));
        ...
        fields_.add(new StandardField(VAR_CATCHING_FORMULA, BeanNatCommonLgNames.TYPE_MAP,false,false,new FightHelpBeanVarCatchingFormulaGet(),null));
        ...
        fields_.add(new StandardField(VAR_FLEEING_FORMULA, BeanNatCommonLgNames.TYPE_MAP,false,false,new FightHelpBeanVarFleeingFormulaGet(),null));
        fields_.add(new StandardField(STATISTIC_ANIM, BeanNatCommonLgNames.TYPE_LIST,false,false,new FightHelpBeanStatisticAnimGet(),null));
        ...
        methods_.add( new SpecNatMethod(GO_TO_SEND_BEGIN_FIGHT, BeanNatCommonLgNames.STRING, false, MethodModifier.NORMAL,new CstNatCaller("web/html/round/helpround.html#sendbeginfight")));
        methods_.add( new SpecNatMethod(GO_TO_END_ROUND_USER, BeanNatCommonLgNames.STRING, false, MethodModifier.NORMAL,new CstNatCaller("web/html/round/helpround.html#endrounduser")));
        methods_.add( new SpecNatMethod(GO_TO_ADD_1, BeanNatCommonLgNames.STRING, false, MethodModifier.NORMAL,new CstNatCaller("web/html/round/helpround.html#addonformula")));
        methods_.add( new SpecNatMethod(GO_TO_ADD_2, BeanNatCommonLgNames.STRING, false, MethodModifier.NORMAL,new CstNatCaller("web/html/round/helpround.html#addonformula4")));
        methods_.add( new SpecNatMethod(GO_TO_SWITCH_ROUND, BeanNatCommonLgNames.STRING, false, MethodModifier.NORMAL,new CstNatCaller("web/html/round/helpround.html#switchround")));
        methods_.add( new SpecNatMethod(GO_TO_BEGIN, BeanNatCommonLgNames.STRING, false, MethodModifier.NORMAL,new CstNatCaller("web/html/round/helpround.html#begin")));
    ...
    private static void buildGeneralHelpBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(MINI_MAP, BeanNatCommonLgNames.TYPE_MAP,false,false,new GeneralHelpBeanMiniMapGet(),null));
...
//        methods_.add( new SpecNatMethod(IS_FIRST_ROW,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new GeneralHelpBeanIsFirstRow()));
        ...
        methods_.add( new SpecNatMethod(GET_MOVES_AT_LEVEL, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new GeneralHelpBeanGetMovesAtLevel()));
    ...
    private static void buildLangsBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(LANGUAGES, BeanNatCommonLgNames.TYPE_LIST,false,false,new LangsBeanLanguagesGet(),null));
        ...
        methods_.add( new SpecNatMethod(GET_KEYS_GENDERS, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysGenders()));
        methods_.add( new SpecNatMethod(GET_ROW_GENDER, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowGender()));
        methods_.add( new SpecNatMethod(GET_KEYS_BOOLEANS, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysBooleans()));
        methods_.add( new SpecNatMethod(GET_ROW_BOOLEAN, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowBoolean()));
        methods_.add( new SpecNatMethod(GET_KEYS_ENVIRONMENTS, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysEnvironments()));
        methods_.add( new SpecNatMethod(GET_ROW_ENVIRONMENT, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowEnvironment()));
        methods_.add( new SpecNatMethod(GET_KEYS_STATISTICS, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysStatistics()));
        methods_.add( new SpecNatMethod(GET_ROW_STATISTIC, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowStatistic()));
        methods_.add( new SpecNatMethod(GET_KEYS_TARGETS, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysTargets()));
        methods_.add( new SpecNatMethod(GET_ROW_TARGET, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowTarget()));
        methods_.add( new SpecNatMethod(GET_KEYS_CATEGORIES, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysCategories()));
        methods_.add( new SpecNatMethod(GET_ROW_CATEGORY, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowCategory()));
        methods_.add( new SpecNatMethod(GET_KEYS_TYPES, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysTypes()));
        methods_.add( new SpecNatMethod(GET_ROW_TYPE, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowType()));
        methods_.add( new SpecNatMethod(GET_KEYS_POKEMON, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysPokemon()));
        methods_.add( new SpecNatMethod(GET_ROW_POKEMON, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowPokemon()));
        methods_.add( new SpecNatMethod(GET_KEYS_MOVES, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysMoves()));
        methods_.add( new SpecNatMethod(GET_ROW_MOVE, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowMove()));
        methods_.add( new SpecNatMethod(GET_KEYS_ITEMS, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysItems()));
        methods_.add( new SpecNatMethod(GET_ROW_ITEM, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowItem()));
        methods_.add( new SpecNatMethod(GET_KEYS_ABILITIES, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysAbilities()));
        methods_.add( new SpecNatMethod(GET_ROW_ABILITY, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowAbility()));
        methods_.add( new SpecNatMethod(GET_KEYS_STATUS, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysStatus()));
        methods_.add( new SpecNatMethod(GET_ROW_STATUS, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowStatus()));
        methods_.add( new SpecNatMethod(GET_KEYS_MATH, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetKeysMath()));
        methods_.add( new SpecNatMethod(GET_ROW_MATH, BeanNatCommonLgNames.TYPE_LIST, false, MethodModifier.NORMAL,new LangsBeanGetRowMath()));
        ...
        methods_.add( new SpecNatMethod(GO_TO_BEGIN, BeanNatCommonLgNames.STRING, false, MethodModifier.NORMAL,new CstNatCaller("web/html/langs/langs.html#begin")));
