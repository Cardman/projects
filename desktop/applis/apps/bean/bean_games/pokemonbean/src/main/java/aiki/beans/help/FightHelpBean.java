...
//    private static final String VAR_BOOST ="b";
    ...
    public void build(FacadeGame _facade) {
        ...
        elementAnchor(MessagesDataRound.M_P_83_INDEX,new BeanAnchorCstEvent(CommonBean.REN_ADD_WEB_HTML_INDEX_HTML));
        ...
        ordered(0, MessagesDataRound.M_P_83_EVENTS_ROUND_5_4, slowAbilities);
        ordered(0, MessagesDataRound.M_P_83_EVENTS_ROUND_5_5, slowItems);
        ordered(0, MessagesDataRound.M_P_83_EVENTS_ROUND_5_6, reverseSpeedMoves);
        getBuilder().setIndent(0);
        if (reverseSpeedMoves.isEmpty()) {
            elementOrd(MessagesPkBean.ROUND,MessagesDataRound.M_P_83_EVENTS_ROUND_5_6_1);
        }
        ordered(0, MessagesDataRound.M_P_83_EVENTS_ROUND_5_7, berrySpeed);
        ordered(0, MessagesDataRound.M_P_83_EVENTS_ROUND_5_8, itemSpeed);
        getBuilder().setIndent(0);
        getBuilder().getOrderedLists().removeQuicklyLast();
        ...
        elementAnchor(MessagesDataRound.M_P_83_ROUND_PROCESS_SWITCH_3_2_0,new BeanAnchorCstEvent(CommonBean.REN_ADD_WEB_HTML_ROUND_HELPROUND_HTML+ ANCHOR +SENDBEGINFIGHT));
        ...
        if (!beginRoundStatus.isEmpty()){
            ...
            elementAnchor(MessagesDataRound.M_P_83_ROUND_PROCESS_END_LK,new BeanAnchorCstEvent(CommonBean.REN_ADD_WEB_HTML_ROUND_HELPROUND_HTML+ ANCHOR +ENDROUNDUSER));
        }
        ...
        elementAnchor(MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_10_1,new BeanAnchorCstEvent(CommonBean.REN_ADD_WEB_HTML_ROUND_HELPROUND_HTML+ ANCHOR +ADDONFORMULA4));
        ...
        getBuilder().getOrderedLists().add(0);
        ordered(1, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_1_1_1, abilitiesPartStatis);
        ordered(1, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_1_1_2, movesTeamStatis);
        ordered(1, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_1_1_3, abilitiesFighterStatisVar);
        getBuilder().setIndent(0);
        getBuilder().getOrderedLists().removeQuicklyLast();
        ...
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_1_3, abilitiesFighterStatis);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_1_4, itemsFighterStatis);
        getBuilder().setIndent(0);
        getBuilder().getOrderedLists().removeQuicklyLast();
        formatMessageIndent(MessagesPkBean.ROUND,MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_2);
        getBuilder().getOrderedLists().add(0);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_2_1, successfulStatus);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_2_2, globalMovesStatus);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_2_3, abilitiesPartStatus);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_2_4, movesTeamStatus);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_2_5, abilitiesFighterStatus);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_2_6, itemsFighterStatus);
        getBuilder().setIndent(0);
        elementOrd(MessagesPkBean.ROUND,MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_2_7);
        if (!comboEvtStat.isEmpty()) {
            getBuilder().setIndent(0);
            elementOrd(MessagesPkBean.ROUND, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_16_2_8);
            getBuilder().setIndent(1);
            new BeanDisplayList<CustList<TranslatedKey>>(new BeanDisplayTranslatedKeyList()).display(this, comboEvtStat);
        }
        getBuilder().setIndent(0);
        getBuilder().getOrderedLists().removeQuicklyLast();
        ...
        elementAnchor(MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_18_0,new BeanAnchorCstEvent(CommonBean.REN_ADD_WEB_HTML_ROUND_HELPROUND_HTML+ ANCHOR +ADDONFORMULA));
        ...
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_22, movesProtAgainstKo);
        possibleMessage(movesProtAgainstKo, minHpNotKo, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_22_1);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_23, itemsProtAgainstKo);
        possibleMessage(itemsProtAgainstKo, minHpNotKo, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_23_1);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_24, movesCannotKo);
        possibleMessage(movesCannotKo, minHpNotKo, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_24_1);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_25, itemsAbs);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_26, abilitiesRevAbs);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_27, abilitiesDamageStatis);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_28, abilitiesChangingTypesDamage);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_29, abilitiesTakingItem);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_30, abilitiesStatisVarUser);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_31, abilitiesStatus);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_32, abilitiesCopyAb);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_33, recoilItems);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_34, recoilAbilities);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_35, abilitiesKoTarget);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_36, movesKoTarget);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_37, berryUser);
        ordered(0, MessagesDataRound.M_P_83_ROUND_PROCESS_MOVE_FINAL_38, berryTarget);
        getBuilder().setIndent(0);
        getBuilder().getOrderedLists().removeQuicklyLast();
        ...
        elementAnchor(MessagesDataRound.M_P_83_END_ROUND_SEE_LK,new BeanAnchorCstEvent(CommonBean.REN_ADD_WEB_HTML_ENDROUND_ENDROUND_HTML));
        ...
        elementAnchor(MessagesDataRound.M_P_83_END_ROUND_SUBSTITUTING_5_0,new BeanAnchorCstEvent(CommonBean.REN_ADD_WEB_HTML_ROUND_HELPROUND_HTML+ ANCHOR +SWITCHROUND));
...
//        formatMessageIndent(MessagesPkBean.ROUND,MessagesDataRound.M_P_83_ROUND_PROCESS_ADD_ON_10_3);
    ...
    private void possibleMessage(CustList<TranslatedKey> _list, Rate _value, String _key) {
        if (!_list.isEmpty()) {
            formatMessageIndent(MessagesPkBean.ROUND, _key, _value.toNumberString());
        }
    }

    private void ordered(int _o, String _key, CustList<TranslatedKey> _list) {
        if (!_list.isEmpty()) {
            getBuilder().setIndent(_o);
            elementOrd(MessagesPkBean.ROUND, _key);
            getBuilder().setIndent(_o+1);
            new BeanDisplayList<TranslatedKey>(new BeanDisplayTranslatedKey()).display(this, _list);
        }
    }
...
//        }
    ...
    public String clickComboMultStat(int _index) {
        ...
        return CommonBean.REN_ADD_WEB_HTML_COMBO_COMBOS_HTML;
    }
