...
public final class AikiBeansMovesStd{
    ...
    private static void buildMoveBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(BOOSTED_TYPES, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanBoostedTypesGet(),null));
        ...
        fields_.add(new StandardField(TYPES, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanTypesGet(),null));
        fields_.add(new StandardField(TYPES_BY_OWNED_ITEMS, BeanNatLgNames.TYPE_MAP,false,false,new MoveBeanTypesByOwnedItemsGet(),null));
        fields_.add(new StandardField(TYPES_BY_WEATHERS, BeanNatLgNames.TYPE_MAP,false,false,new MoveBeanTypesByWeathersGet(),null));
        ...
        fields_.add(new StandardField(MAP_VARS_ACCURACY, BeanNatLgNames.TYPE_MAP,false,false,new MoveBeanMapVarsAccuracyGet(),null));
        ...
        fields_.add(new StandardField(DELETED_STATUS, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanDeletedStatusGet(),null));
        fields_.add(new StandardField(REQUIRED_STATUS, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanRequiredStatusGet(),null));
        fields_.add(new StandardField(ACHIEVE_DISAPPEARED_PK_USING_MOVE, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanAchieveDisappearedPkUsingMoveGet(),null));
        fields_.add(new StandardField(ABILITIES, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanAbilitiesGet(),null));
        fields_.add(new StandardField(ITEMS, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanItemsGet(),null));
        fields_.add(new StandardField(CANNOT_KO,BeanNatCommonLgNames.PRIM_BOOLEAN,false,false,new MoveBeanCannotKoGet(),null));
        fields_.add(new StandardField(AFFECTED_BY_MOVES, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanAffectedByMovesGet(),null));
        fields_.add(new StandardField(SEC_EFFECTS_BY_ITEM, BeanNatLgNames.TYPE_MAP,false,false,new MoveBeanSecEffectsByItemGet(),null));
        fields_.add(new StandardField(EFFECTS, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanEffectsGet(),null));
        ...
        fields_.add(new StandardField(REPEAT_ROUND_LAW, BeanNatLgNames.TYPE_MAP,false,false,new MoveBeanRepeatRoundLawGet(),null));
        fields_.add(new StandardField(MOVES_LEVEL_LEARNT_BY_POKEMON, BeanNatLgNames.TYPE_MAP,false,false,new MoveBeanMovesLevelLearntByPokemonGet(),null));
        fields_.add(new StandardField(MOVES_TM_LEARNT_BY_POKEMON, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanMovesTmLearntByPokemonGet(),null));
        fields_.add(new StandardField(MOVES_HM_LEARNT_BY_POKEMON, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanMovesHmLearntByPokemonGet(),null));
        fields_.add(new StandardField(MOVES_MT_LEARNT_BY_POKEMON, BeanNatLgNames.TYPE_LIST,false,false,new MoveBeanMovesMtLearntByPokemonGet(),null));
    ...
    private static void buildMoveLineBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(TYPES, BeanNatLgNames.TYPE_LIST,false,false,new MoveLineBeanTypesGet(),null));
        ...
        fields_.add(new StandardField(SORTED_MOVES, BeanNatLgNames.TYPE_LIST,false,false,null,new MoveLineBeanSortedMovesSet()));
    ...
    private static void buildMovesBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(CATEGORIES, BeanNatLgNames.TYPE_MAP,false,false,new MovesBeanCategoriesGet(),null));
        ...
        fields_.add(new StandardField(MOVES, BeanNatLgNames.TYPE_LIST,false,false,new MovesBeanMovesGet(),null));
        fields_.add(new StandardField(MOVES_BEAN,BeanNatCommonLgNames.STRING,false,false,new MovesBeanMovesBeanGet(),null));
        fields_.add(new StandardField(SORTED_MOVES, BeanNatLgNames.TYPE_LIST,false,false,new MovesBeanSortedMovesGet(),null));
