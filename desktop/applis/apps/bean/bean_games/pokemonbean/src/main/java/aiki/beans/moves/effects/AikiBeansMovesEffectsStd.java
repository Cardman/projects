...
public final class AikiBeansMovesEffectsStd{
    ...
    private static void buildEffectBatonPassBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(MOVES, BeanNatLgNames.TYPE_LIST,false,false,new EffectBatonPassBeanMovesGet(),null));
    ...
    private static void buildEffectBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(REASONS, BeanNatLgNames.TYPE_LIST,false,false,new EffectBeanReasonsGet(),null));
        fields_.add(new StandardField(MAP_VARS_FAIL, BeanNatLgNames.TYPE_MAP,false,false,new EffectBeanMapVarsFailGet(),null));
        ...
        methods_.add( new SpecNatMethod(IS_ADJ_ADV,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsAdjAdv()));
        methods_.add( new SpecNatMethod(IS_ADJ_MULT,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsAdjMult()));
        methods_.add( new SpecNatMethod(IS_ADJ_UNIQ,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsAdjUniq()));
        methods_.add( new SpecNatMethod(IS_ALLIE,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsAllie()));
        methods_.add( new SpecNatMethod(IS_ALLIES,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsAllies()));
        methods_.add( new SpecNatMethod(IS_ANY_FOE,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsAnyFoe()));
        methods_.add( new SpecNatMethod(IS_AUTRE_UNIQ,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsAutreUniq()));
        methods_.add( new SpecNatMethod(IS_GLOBALE,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsGlobale()));
        methods_.add( new SpecNatMethod(IS_LANCEUR,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsLanceur()));
        methods_.add( new SpecNatMethod(IS_PSEUDO_GLOBALE,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsPseudoGlobale()));
        methods_.add( new SpecNatMethod(IS_TOUS_ADV,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsTousAdv()));
        methods_.add( new SpecNatMethod(IS_UNIQUE_IMPORTE,BeanNatCommonLgNames.PRIM_BOOLEAN, false, MethodModifier.NORMAL,new EffectBeanIsUniqueImporte()));
    ...
    private static void buildEffectCloneBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(MOVES_END_ROUND, BeanNatLgNames.TYPE_LIST,false,false,new EffectCloneBeanMovesEndRoundGet(),null));
        fields_.add(new StandardField(MOVES_BATON_PASS, BeanNatLgNames.TYPE_LIST,false,false,new EffectCloneBeanMovesBatonPassGet(),null));
        fields_.add(new StandardField(MOVES_SENDING, BeanNatLgNames.TYPE_LIST,false,false,new EffectCloneBeanMovesSendingGet(),null));
    ...
    private static void buildEffectCommonStatisticsBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(COMMON_VALUE, BeanNatLgNames.TYPE_MAP,false,false,new EffectCommonStatisticsBeanCommonValueGet(),null));
        fields_.add(new StandardField(MAP_VARS_COMMON_STATISTICS, BeanNatLgNames.TYPE_MAP,false,false,new EffectCommonStatisticsBeanMapVarsCommonStatisticsGet(),null));
    ...
    private static void buildEffectCopyMoveBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(MOVES_TRANSFORMING, BeanNatLgNames.TYPE_LIST,false,false,new EffectCopyMoveBeanMovesTransformingGet(),null));
        fields_.add(new StandardField(MOVES_NOT_TO_BE_COPIED, BeanNatLgNames.TYPE_LIST,false,false,new EffectCopyMoveBeanMovesNotToBeCopiedGet(),null));
    ...
    private static void buildEffectCounterAttackBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(SUFFERING_DAMAGE_TYPES, BeanNatLgNames.TYPE_MAP,false,false,new EffectCounterAttackBeanSufferingDamageTypesGet(),null));
        fields_.add(new StandardField(DROPPED_STAT_DIRECT_MOVE, BeanNatLgNames.TYPE_MAP,false,false,new EffectCounterAttackBeanDroppedStatDirectMoveGet(),null));
        ...
        fields_.add(new StandardField(REASONS_PROTECT, BeanNatLgNames.TYPE_LIST,false,false,new EffectCounterAttackBeanReasonsProtectGet(),null));
        fields_.add(new StandardField(REASONS_COUNTER, BeanNatLgNames.TYPE_LIST,false,false,new EffectCounterAttackBeanReasonsCounterGet(),null));
        ...
        methods_.add( new SpecNatMethod(GET_MAP_VARS_FAIL_COUNTER, BeanNatLgNames.TYPE_MAP, false, MethodModifier.NORMAL,new EffectCounterAttackBeanGetMapVarsFailCounter()));
    ...
    private static void buildEffectDamageBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(HITS_LAW, BeanNatLgNames.TYPE_MAP,false,false,new EffectDamageBeanHitsLawGet(),null));
        ...
        fields_.add(new StandardField(DAMAGE_LAW, BeanNatLgNames.TYPE_MAP,false,false,new EffectDamageBeanDamageLawGet(),null));
        fields_.add(new StandardField(MAP_VARS_DAMAGE, BeanNatLgNames.TYPE_MAP,false,false,new EffectDamageBeanMapVarsDamageGet(),null));
        fields_.add(new StandardField(MULT_DAMAGE_AGAINST, BeanNatLgNames.TYPE_MAP,false,false,new EffectDamageBeanMultDamageAgainstGet(),null));
        fields_.add(new StandardField(CH_RATE, BeanNatCommonLgNames.PRIM_INTEGER,false,false,new EffectDamageBeanChRateGet(),null));
        fields_.add(new StandardField(CH_LAW, BeanNatLgNames.TYPE_MAP,false,false,new EffectDamageBeanChLawGet(),null));
        ...
        fields_.add(new StandardField(IGN_VAR_STAT_TARGET_POS, BeanNatLgNames.TYPE_LIST,false,false,new EffectDamageBeanIgnVarStatTargetPosGet(),null));
        fields_.add(new StandardField(IGN_VAR_STAT_USER_NEG, BeanNatLgNames.TYPE_LIST,false,false,new EffectDamageBeanIgnVarStatUserNegGet(),null));
        fields_.add(new StandardField(RAND_MAX,BeanNatCommonLgNames.PRIM_BOOLEAN,false,false,new EffectDamageBeanRandMaxGet(),null));
        fields_.add(new StandardField(BOOST_STATIS_ONCE_KO_FOE, BeanNatLgNames.TYPE_MAP,false,false,new EffectDamageBeanBoostStatisOnceKoFoeGet(),null));
    ...
    private static void buildEffectEndRoundMoveBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(REASONS_END_ROUND, BeanNatLgNames.TYPE_LIST,false,false,new EffectEndRoundMoveBeanReasonsEndRoundGet(),null));
        fields_.add(new StandardField(MAP_VARS_FAIL_END_ROUND, BeanNatLgNames.TYPE_MAP,false,false,new EffectEndRoundMoveBeanMapVarsFailEndRoundGet(),null));
    ...
    private static void buildEffectFullHpRateBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(MAP_VARS_RESTORED, BeanNatLgNames.TYPE_MAP,false,false,new EffectFullHpRateBeanMapVarsRestoredGet(),null));
    ...
    private static void buildEffectGlobalBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(PREVENT_STATUS, BeanNatLgNames.TYPE_LIST,false,false,new EffectGlobalBeanPreventStatusGet(),null));
        fields_.add(new StandardField(IMMUNE_TYPES, BeanNatLgNames.TYPE_LIST,false,false,new EffectGlobalBeanImmuneTypesGet(),null));
        fields_.add(new StandardField(EFFICIENCY_MOVES, BeanNatLgNames.TYPE_MAP,false,false,new EffectGlobalBeanEfficiencyMovesGet(),null));
        fields_.add(new StandardField(DISABLE_IMMU_AGAINST_TYPES, BeanNatLgNames.TYPE_LIST,false,false,new EffectGlobalBeanDisableImmuAgainstTypesGet(),null));
        fields_.add(new StandardField(CANCEL_PROTECTING_ABILITIES, BeanNatLgNames.TYPE_LIST,false,false,new EffectGlobalBeanCancelProtectingAbilitiesGet(),null));
        fields_.add(new StandardField(UNUSABLE_MOVES, BeanNatLgNames.TYPE_LIST,false,false,new EffectGlobalBeanUnusableMovesGet(),null));
        fields_.add(new StandardField(CANCEL_EFFECTS, BeanNatLgNames.TYPE_LIST,false,false,new EffectGlobalBeanCancelEffectsGet(),null));
        fields_.add(new StandardField(MULT_POWER_MOVES, BeanNatLgNames.TYPE_MAP,false,false,new EffectGlobalBeanMultPowerMovesGet(),null));
        fields_.add(new StandardField(MULT_DAMAGE_TYPES_MOVES, BeanNatLgNames.TYPE_MAP,false,false,new EffectGlobalBeanMultDamageTypesMovesGet(),null));
        fields_.add(new StandardField(CANCEL_CHGT_STAT, BeanNatLgNames.TYPE_LIST,false,false,new EffectGlobalBeanCancelChgtStatGet(),null));
        ...
        fields_.add(new StandardField(INVOKING_MOVES, BeanNatLgNames.TYPE_LIST,false,false,new EffectGlobalBeanInvokingMovesGet(),null));
        fields_.add(new StandardField(CHANGED_TYPES_TERRAIN, BeanNatLgNames.TYPE_LIST,false,false,new EffectGlobalBeanChangedTypesTerrainGet(),null));
        fields_.add(new StandardField(INVOKING_MOVES_CHANGING_TYPES, BeanNatLgNames.TYPE_LIST,false,false,new EffectGlobalBeanInvokingMovesChangingTypesGet(),null));
        fields_.add(new StandardField(MULT_STAT_IF_CONTAINS_TYPE, BeanNatLgNames.TYPE_MAP,false,false,new EffectGlobalBeanMultStatIfContainsTypeGet(),null));
        fields_.add(new StandardField(MULT_DAMAGE_PREPA_ROUND, BeanNatLgNames.TYPE_MAP,false,false,new EffectGlobalBeanMultDamagePrepaRoundGet(),null));
        fields_.add(new StandardField(MOVES_USED_BY_TARGETED_FIGHTERS, BeanNatLgNames.TYPE_LIST,false,false,new EffectGlobalBeanMovesUsedByTargetedFightersGet(),null));
    ...
    private static void buildEffectInvokeBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(MOVE_FCT_ENV, BeanNatLgNames.TYPE_MAP,false,false,new EffectInvokeBeanMoveFctEnvGet(),null));
        fields_.add(new StandardField(GLOBAL_MOVES, BeanNatLgNames.TYPE_LIST,false,false,new EffectInvokeBeanGlobalMovesGet(),null));
        fields_.add(new StandardField(INVOKING_MOVE_BY_USER_TYPES, BeanNatLgNames.TYPE_MAP,false,false,new EffectInvokeBeanInvokingMoveByUserTypesGet(),null));
        fields_.add(new StandardField(MOVES_NOT_TO_BE_INVOKED, BeanNatLgNames.TYPE_LIST,false,false,new EffectInvokeBeanMovesNotToBeInvokedGet(),null));
    ...
    private static void buildEffectMultSufferedMovePowerBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(MULT_MOVE_POWER_FCT_TYPE, BeanNatLgNames.TYPE_MAP,false,false,new EffectMultSufferedMovePowerBeanMultMovePowerFctTypeGet(),null));
    ...
    private static void buildEffectMultUsedMovePowerBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(MULT_MOVE_POWER_FCT_TYPE, BeanNatLgNames.TYPE_MAP,false,false,new EffectMultUsedMovePowerBeanMultMovePowerFctTypeGet(),null));
    ...
    private static void buildEffectProtectFromTypesBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(IMMU_AGAINST_TYPES, BeanNatLgNames.TYPE_LIST,false,false,new EffectProtectFromTypesBeanImmuAgainstTypesGet(),null));
    ...
    private static void buildEffectStatisticBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(STATIS_VAR_RANK, BeanNatLgNames.TYPE_MAP,false,false,new EffectStatisticBeanStatisVarRankGet(),null));
        fields_.add(new StandardField(MAP_VARS_STATISTICS, BeanNatLgNames.TYPE_MAP,false,false,new EffectStatisticBeanMapVarsStatisticsGet(),null));
        fields_.add(new StandardField(SWAP_BOOST_STATIS, BeanNatLgNames.TYPE_LIST,false,false,new EffectStatisticBeanSwapBoostStatisGet(),null));
        fields_.add(new StandardField(CANCEL_LOW_STAT, BeanNatLgNames.TYPE_LIST,false,false,new EffectStatisticBeanCancelLowStatGet(),null));
        ...
        fields_.add(new StandardField(CANCEL_CHGT_STAT, BeanNatLgNames.TYPE_LIST,false,false,new EffectStatisticBeanCancelChgtStatGet(),null));
        fields_.add(new StandardField(COPY_BOOST, BeanNatLgNames.TYPE_LIST,false,false,new EffectStatisticBeanCopyBoostGet(),null));
    ...
    private static void buildEffectStatusBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(LAW_STATUS, BeanNatLgNames.TYPE_MAP,false,false,new EffectStatusBeanLawStatusGet(),null));
        fields_.add(new StandardField(MAP_VARS_STATUS, BeanNatLgNames.TYPE_MAP,false,false,new EffectStatusBeanMapVarsStatusGet(),null));
        fields_.add(new StandardField(DELETED_STATUS, BeanNatLgNames.TYPE_LIST,false,false,new EffectStatusBeanDeletedStatusGet(),null));
    ...
    private static void buildEffectSwitchMoveTypesBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(REPLACING_TYPES, BeanNatLgNames.TYPE_LIST,false,false,new EffectSwitchMoveTypesBeanReplacingTypesGet(),null));
        fields_.add(new StandardField(CHANGE_TYPES, BeanNatLgNames.TYPE_MAP,false,false,new EffectSwitchMoveTypesBeanChangeTypesGet(),null));
    ...
    private static void buildEffectSwitchTypesBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(CHGT_TYPE_BY_ENV, BeanNatLgNames.TYPE_MAP,false,false,new EffectSwitchTypesBeanChgtTypeByEnvGet(),null));
        fields_.add(new StandardField(GLOBAL_MOVES, BeanNatLgNames.TYPE_LIST,false,false,new EffectSwitchTypesBeanGlobalMovesGet(),null));
        fields_.add(new StandardField(ADDED_TYPES, BeanNatLgNames.TYPE_LIST,false,false,new EffectSwitchTypesBeanAddedTypesGet(),null));
        fields_.add(new StandardField(CONST_TYPES, BeanNatLgNames.TYPE_LIST,false,false,new EffectSwitchTypesBeanConstTypesGet(),null));
    ...
    private static void buildEffectTeamBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(FORBIDDEN_BOOST, BeanNatLgNames.TYPE_LIST,false,false,new EffectTeamBeanForbiddenBoostGet(),null));
        fields_.add(new StandardField(CANCEL_CHGT_STAT_FOE_TEAM, BeanNatLgNames.TYPE_LIST,false,false,new EffectTeamBeanCancelChgtStatFoeTeamGet(),null));
        ...
        fields_.add(new StandardField(CANCEL_CHGT_STAT_TEAM, BeanNatLgNames.TYPE_LIST,false,false,new EffectTeamBeanCancelChgtStatTeamGet(),null));
        fields_.add(new StandardField(PROTECT_AGAINST_LOW_STAT, BeanNatLgNames.TYPE_LIST,false,false,new EffectTeamBeanProtectAgainstLowStatGet(),null));
        fields_.add(new StandardField(PROTECT_AGAINST_STATUS, BeanNatLgNames.TYPE_LIST,false,false,new EffectTeamBeanProtectAgainstStatusGet(),null));
        fields_.add(new StandardField(MULT_STATISTIC, BeanNatLgNames.TYPE_MAP,false,false,new EffectTeamBeanMultStatisticGet(),null));
        fields_.add(new StandardField(MULT_STATISTIC_FOE, BeanNatLgNames.TYPE_MAP,false,false,new EffectTeamBeanMultStatisticFoeGet(),null));
        fields_.add(new StandardField(MULT_DAMAGE, BeanNatLgNames.TYPE_MAP,false,false,new EffectTeamBeanMultDamageGet(),null));
        fields_.add(new StandardField(UNUSABLE_MOVES, BeanNatLgNames.TYPE_LIST,false,false,new EffectTeamBeanUnusableMovesGet(),null));
        fields_.add(new StandardField(DISABLE_FOE_TEAM_EFFECTS, BeanNatLgNames.TYPE_LIST,false,false,new EffectTeamBeanDisableFoeTeamEffectsGet(),null));
        fields_.add(new StandardField(DISABLE_FOE_TEAM_STATUS, BeanNatLgNames.TYPE_LIST,false,false,new EffectTeamBeanDisableFoeTeamStatusGet(),null));
    ...
    private static void buildEffectTeamWhileSendFoeBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(MAP_VARS_DAMAGE_SENT_FOE, BeanNatLgNames.TYPE_MAP,false,false,new EffectTeamWhileSendFoeBeanMapVarsDamageSentFoeGet(),null));
        fields_.add(new StandardField(STATISTICS, BeanNatLgNames.TYPE_MAP,false,false,new EffectTeamWhileSendFoeBeanStatisticsGet(),null));
        fields_.add(new StandardField(STATUS_BY_NB_USES, BeanNatLgNames.TYPE_MAP,false,false,new EffectTeamWhileSendFoeBeanStatusByNbUsesGet(),null));
        fields_.add(new StandardField(REASONS_SENDING, BeanNatLgNames.TYPE_LIST,false,false,new EffectTeamWhileSendFoeBeanReasonsSendingGet(),null));
        fields_.add(new StandardField(MAP_VARS_FAIL_SENDING, BeanNatLgNames.TYPE_MAP,false,false,new EffectTeamWhileSendFoeBeanMapVarsFailSendingGet(),null));
        fields_.add(new StandardField(DELETED_BY_FOE_TYPES, BeanNatLgNames.TYPE_LIST,false,false,new EffectTeamWhileSendFoeBeanDeletedByFoeTypesGet(),null));
    ...
    private static void buildEffectUnprotectFromTypesBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(TYPES, BeanNatLgNames.TYPE_LIST,false,false,new EffectUnprotectFromTypesBeanTypesGet(),null));
        fields_.add(new StandardField(DISABLE_IMMU_AGAINST_TYPES, BeanNatLgNames.TYPE_LIST,false,false,new EffectUnprotectFromTypesBeanDisableImmuAgainstTypesGet(),null));
        fields_.add(new StandardField(DISABLE_IMMU_FROM_MOVES, BeanNatLgNames.TYPE_LIST,false,false,new EffectUnprotectFromTypesBeanDisableImmuFromMovesGet(),null));
        fields_.add(new StandardField(ATTACK_TARGET_WITH_TYPES, BeanNatLgNames.TYPE_LIST,false,false,new EffectUnprotectFromTypesBeanAttackTargetWithTypesGet(),null));
