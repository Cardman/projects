...
public final class AikiBeansMovesEffectsStd {
    ...
    private static void buildEffectAllyBean(PokemonStandards _std) {
        ...
        type_ = new SpecialNatClass(TYPE_EFFECT_ALLY_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
    ...
    private static void buildEffectBatonPassBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_BATON_PASS_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
    ...
    private static void buildEffectBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_BEAN, fields_, constructors_, methods_, AikiBeansStd.TYPE_COMMON_BEAN, MethodModifier.NORMAL);
        ...
        fields_.add(new StandardField(NEED_SUCCESS_FIRST_EFFECT,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(EFFECT_BEAN,_std.getAliasString(),false,false,type_));
    ...
    private static void buildEffectCloneBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_CLONE_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(HP_RATE_CLONE,PokemonStandards.TYPE_RATE,false,false,type_));
        fields_.add(new StandardField(MOVES_END_ROUND, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(MOVES_BATON_PASS, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(MOVES_SENDING, BeanNatLgNames.TYPE_LIST,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_MOVE_END_ROUND,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_MOVES_END_ROUND,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_MOVE_BATON_PASS,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_MOVES_BATON_PASS,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_MOVE_SENDING,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_MOVES_SENDING,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectCommonStatisticsBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_COMMON_STATISTICS_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(COMMON_VALUE, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(MAP_VARS_COMMON_STATISTICS, BeanNatLgNames.TYPE_MAP,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
    ...
    private static void buildEffectCopyFighterBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_COPY_FIGHTER_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
    ...
    private static void buildEffectCopyMoveBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_COPY_MOVE_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        ...
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(COPY_MOVE_FOR_USER,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_MOVE_TRANS,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_MOVE_TRANS,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_MOVE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectCounterAttackBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_COUNTER_ATTACK_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(SUFFERING_DAMAGE_TYPES, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(DROPPED_STAT_DIRECT_MOVE, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(SUFFERING_DAMAGE_DIRECT_MOVE,PokemonStandards.TYPE_RATE,false,false,type_));
        fields_.add(new StandardField(REASONS_PROTECT, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(REASONS_COUNTER, BeanNatLgNames.TYPE_LIST,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_SUFFERING_DAMAGE_TYPES,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_DROPPED_STAT_DIRECT_MOVE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_MAP_VARS_FAIL_COUNTER,params_, BeanNatLgNames.TYPE_MAP, false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectDamageBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_DAMAGE_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(HITS_LAW, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(NB_HITS,_std.getAliasPrimLong(),false,false,type_));
        fields_.add(new StandardField(CONST_DAMAGE,_std.getAliasPrimBoolean(),false,false,type_));
        ...
        fields_.add(new StandardField(TARGET_DEFENSE,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(STATIS_DEF,_std.getAliasString(),false,false,type_));
        fields_.add(new StandardField(IGN_VAR_STAT_TARGET_POS, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(IGN_VAR_STAT_USER_NEG, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(RAND_MAX,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(BOOST_STATIS_ONCE_KO_FOE, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(SUMMING_USER_TEAM_OK_FIGHTER,_std.getAliasPrimBoolean(),false,false,type_));
        params_ = new StringList();
        method_ = new StandardMethod(HAS_LAW_FOR_DAMAGE,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(HAS_DETERMINATED_LAW_FOR_DAMAGE,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(COUNTER_DAMAGE_CAT,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(CONST_POWER,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(HAS_CONST_POWER,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TRANSLATED_STATIS_TARGET,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TRANSLATED_STATIS_USER,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TRANSLATED_STATIS_KO,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectDamageRateBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_DAMAGE_RATE_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(WIN_HP,_std.getAliasPrimBoolean(),false,false,type_));
    ...
    private static void buildEffectEndRoundMoveBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_END_ROUND_MOVE_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
    ...
    private static void buildEffectFullHpRateBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_FULL_HP_RATE_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(LEFT_USER_HP,PokemonStandards.TYPE_RATE,false,false,type_));
        fields_.add(new StandardField(RESTORED_HP,_std.getAliasString(),false,false,type_));
        fields_.add(new StandardField(MAP_VARS_RESTORED, BeanNatLgNames.TYPE_MAP,false,false,type_));
    ...
    private static void buildEffectGlobalBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_GLOBAL_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(WEATHER,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(CANCELED_IF_USED,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(REVERSE_ORDER_OF_SORT_BY_SPEED,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(UNUSABLE_ITEM,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(PUTTING_KO,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(MULT_ACCURACY,PokemonStandards.TYPE_RATE,false,false,type_));
        ...
        fields_.add(new StandardField(MULT_EFFECT_LOVING_ALLY,PokemonStandards.TYPE_RATE,false,false,type_));
        fields_.add(new StandardField(PREVENT_STATUS, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(IMMUNE_TYPES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(EFFICIENCY_MOVES, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(DISABLE_IMMU_AGAINST_TYPES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(CANCEL_PROTECTING_ABILITIES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(UNUSABLE_MOVES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(CANCEL_EFFECTS, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(MULT_POWER_MOVES, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(MULT_DAMAGE_TYPES_MOVES, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(CANCEL_CHGT_STAT, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(INVOKED_MOVE_TERRAIN,_std.getAliasString(),false,false,type_));
        fields_.add(new StandardField(INVOKING_MOVES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(CHANGED_TYPES_TERRAIN, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(INVOKING_MOVES_CHANGING_TYPES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(MULT_STAT_IF_CONTAINS_TYPE, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(MULT_DAMAGE_PREPA_ROUND, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(MOVES_USED_BY_TARGETED_FIGHTERS, BeanNatLgNames.TYPE_LIST,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_PREVENTED_STATUS,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_PREVENTED_STATUS,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_CANCELLED_ABILITY,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_CANCELLED_ABILITY,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_UNUSABLE_MOVE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_UNUSABLE_MOVES,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_CANCELLED_EFFECT,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_CANCELLED_EFFECT,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_MULT_MOVE_POWER,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_MULT_MOVE_POWER,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(CLICK_INVOKED_MOVE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_TR_INVOKED_MOVE_TERRAIN,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_INVOKING_MOVE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_INVOKING_MOVE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_INVOKING_MOVE_TYPES,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_INVOKING_MOVE_TYPES,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_MULT_STAT_IF_DAMGE_TYPE_FIRST,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_MULT_STAT_IF_DAMGE_TYPE_SECOND,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_MOVES_TARGET,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_MOVES_TARGET,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectInvokeBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_INVOKE_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(INVOKING_MOVE_BUT_USER,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(INVOKING_TARGET_CHOSEN_MOVE,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(INVOKING_USER_MOVE_WHILE_SLEEP,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(INVOKING_ALLY_MOVE,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(INVOKING_TARGET_SUCCESFUL_MOVE,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(INVOKING_SUFFERED_MOVE,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(RATE_INVOKATION_MOVE,PokemonStandards.TYPE_RATE,false,false,type_));
        fields_.add(new StandardField(MOVE_FCT_ENV, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(GLOBAL_MOVES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(INVOKING_MOVE_BY_USER_TYPES, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(MOVES_NOT_TO_BE_INVOKED, BeanNatLgNames.TYPE_LIST,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_ENV,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_MOVE_FCT_ENV,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_MOVE_FCT_ENV,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_GLOBAL_MOVE_FCT_ENV,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_GLOBAL_MOVE_FCT_ENV,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(IS_TYPE,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_USER_TYPES,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_MOVE_USER_TYPES,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_MOVE_USER_TYPES,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_MOVE_NOT_INVOK,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_MOVE_NOT_INVOK,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectMultSufferedMovePowerBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_MULT_SUFFERED_MOVE_POWER_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(MULT_MOVE_POWER_FCT_TYPE, BeanNatLgNames.TYPE_MAP,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
    ...
    private static void buildEffectMultUsedMovePowerBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_MULT_USED_MOVE_POWER_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(MULT_MOVE_POWER_FCT_TYPE, BeanNatLgNames.TYPE_MAP,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_TYPE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectOrderBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_ORDER_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
    ...
    private static void buildEffectProtectFromTypesBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_PROTECT_FROM_TYPES_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(IMMU_AGAINST_TYPES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_TYPE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectProtectionBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_PROTECTION_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(PROT_SINGLE,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(PROT_SINGLE_AGAINST_KO,PokemonStandards.TYPE_RATE,false,false,type_));
        fields_.add(new StandardField(PROT_TEAM_AGAINST_MULT_TARGETS,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(PROT_TEAM_AGAINST_PRIO,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(PROT_TEAM_AGAINST_STATUS_MOVES,_std.getAliasPrimBoolean(),false,false,type_));
    ...
    private static void buildEffectRemainedHpRateBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_REMAINED_HP_RATE_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(WIN_HP,_std.getAliasPrimBoolean(),false,false,type_));
    ...
    private static void buildEffectRestrictionBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_RESTRICTION_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(FORBID_TARGET_USING_ITEM,_std.getAliasPrimBoolean(),false,false,type_));
        params_ = new StringList();
        method_ = new StandardMethod(FORBID,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(FORBID_STATUS_MOVE,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(FORBID_LAST_MOVE,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(FORBID_USER_MOVES,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(FORBID_USE_MOVE,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(FORCE_USE_MOVE,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectStatisticBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_STATISTIC_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
    ...
    private static void buildEffectStatusBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_STATUS_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(LAW_STATUS, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(MAP_VARS_STATUS, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(DELETED_STATUS, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(KO_USER_HEAL_SUBST,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(STATUS_FROM_USER,_std.getAliasPrimBoolean(),false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
        ...
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_LINK,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_FAIL,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger(),_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_LINK_DELETED,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_LINK_DELETED,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectSwitchAbilitiesBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_SWITCH_ABILITIES_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        params_ = new StringList();
        method_ = new StandardMethod(GIVE_TO_TARGET,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(GIVE_TO_USER,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(GIVE_CONST,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(IS_DEF_ABILITY,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        ...
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(SWITCH_ABILITIES,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectSwitchItemsBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_SWITCH_ITEMS_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        params_ = new StringList();
        method_ = new StandardMethod(DELETE_TARGET_BERRY,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(TAKE_ITEM,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(REMOVE_TARGET_ITEM,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(SWITCH_ITEMS,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(RESUSE_LAST_ITEM,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(GIVE_TARGET_ITEM,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(USE_ITEM_AS_POSSIBLE,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectSwitchMoveTypesBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_SWITCH_MOVE_TYPES_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(REPLACING_TYPES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(CHANGE_TYPES, BeanNatLgNames.TYPE_MAP,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_REPLACING_TYPES,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_CHANGED_TYPES,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectSwitchPointViewBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_SWITCH_POINT_VIEW_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        params_ = new StringList();
        method_ = new StandardMethod(THIEVE_BONUS,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(MIRROR_AGAINST_USER,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(ATTRACT_DAMAGE_MOVES,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectSwitchTypesBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_SWITCH_TYPES_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(CHGT_TYPE_BY_ENV, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(GLOBAL_MOVES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(ADDED_TYPES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(CONST_TYPES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        params_ = new StringList();
        method_ = new StandardMethod(IS_RES_TYPES,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(IS_USER_TYPES,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(IS_CONST_TYPES,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_ENV,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        ...
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_ADDED_TYPE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(GIVE_TO_TARGET,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        ...
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(SWITCH_TYPES,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(GIVE_CONST,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_CONST_TYPE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectTeamBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_TEAM_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(FORBIDDING_HEALING,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(PROTECT_AGAINST_CH,_std.getAliasPrimBoolean(),false,false,type_));
        fields_.add(new StandardField(FORBIDDEN_BOOST, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(CANCEL_CHGT_STAT_FOE_TEAM, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(DEFAULT_BOOST,_std.getAliasPrimInteger(),false,false,type_));
        fields_.add(new StandardField(CANCEL_CHGT_STAT_TEAM, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(PROTECT_AGAINST_LOW_STAT, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(PROTECT_AGAINST_STATUS, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(MULT_STATISTIC, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(MULT_STATISTIC_FOE, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(MULT_DAMAGE, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(UNUSABLE_MOVES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(DISABLE_FOE_TEAM_EFFECTS, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(DISABLE_FOE_TEAM_STATUS, BeanNatLgNames.TYPE_LIST,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger(),_std.getAliasPrimInteger());
        ...
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_UNUSABLE_MOVE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger(),_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_DISABLE_FOE_TEAM_EFFECTS,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_DISABLE_FOE_TEAM_EFFECTS,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger(),_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_DISABLE_FOE_TEAM_STATUS,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_DISABLE_FOE_TEAM_STATUS,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectTeamWhileSendFoeBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_TEAM_WHILE_SEND_FOE_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(DAMAGE_RATE_AGAINST_FOE,_std.getAliasString(),false,false,type_));
        fields_.add(new StandardField(MAP_VARS_DAMAGE_SENT_FOE, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(STATISTICS, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(STATUS_BY_NB_USES, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(REASONS_SENDING, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(MAP_VARS_FAIL_SENDING, BeanNatLgNames.TYPE_MAP,false,false,type_));
        fields_.add(new StandardField(DELETED_BY_FOE_TYPES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
        ...
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TRANSLATED_STATUS,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TRANSLATED_TYPE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectUnprotectFromTypesBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_UNPROTECT_FROM_TYPES_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(TYPES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(DISABLE_IMMU_AGAINST_TYPES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(DISABLE_IMMU_FROM_MOVES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        fields_.add(new StandardField(ATTACK_TARGET_WITH_TYPES, BeanNatLgNames.TYPE_LIST,false,false,type_));
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_DAMAGE_TYPE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_POKEMON_TYPE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_DISABLE_IMMU_TYPE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger(),_std.getAliasPrimInteger());
        method_ = new StandardMethod(CLICK_MOVE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_DISABLE_IMMU_MOVE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(_std.getAliasPrimInteger());
        method_ = new StandardMethod(GET_TR_ATTACK_TARGET_TYPE,params_,_std.getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private static void buildEffectVarPPBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_VAR_P_P_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
    ...
    private static void buildEffectWinMoneyBean(PokemonStandards _std) {
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<StandardField>();
        type_ = new SpecialNatClass(TYPE_EFFECT_WIN_MONEY_BEAN, fields_, constructors_, methods_, AikiBeansMovesEffectsStd.TYPE_EFFECT_BEAN, MethodModifier.NORMAL);
        fields_.add(new StandardField(WINNING_RATE_BY_SUM_TARGET_USER,PokemonStandards.TYPE_RATE,false,false,type_));
        _std.getStandards().addEntry(TYPE_EFFECT_WIN_MONEY_BEAN, type_);
    }
    ...
    public static ResultErrorStd getResultEffectCloneBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,MOVES_END_ROUND)) {
            res_.setResult(std_.getStringArray(instance_.getMovesEndRound()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MOVES_BATON_PASS)) {
            res_.setResult(std_.getStringArray(instance_.getMovesBatonPass()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MOVES_SENDING)) {
            res_.setResult(std_.getStringArray(instance_.getMovesSending()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.getResultEffectBean(_cont, _classField, _instance);
    }
    public static ResultErrorStd getResultEffectCommonStatisticsBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,MAP_VARS_COMMON_STATISTICS)) {
            res_.setResult(PokemonStandards.getStrStr(_cont,instance_.getMapVarsCommonStatistics()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.getResultEffectBean(_cont, _classField, _instance);
    }
    ...
    public static ResultErrorStd getResultEffectCopyMoveBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,MOVES_TRANSFORMING)) {
            res_.setResult(std_.getStringArray(instance_.getMovesTransforming()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MOVES_NOT_TO_BE_COPIED)) {
            res_.setResult(std_.getStringArray(instance_.getMovesNotToBeCopied()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.getResultEffectBean(_cont, _classField, _instance);
    }
    public static ResultErrorStd getResultEffectCounterAttackBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,DROPPED_STAT_DIRECT_MOVE)) {
            res_.setResult(PokemonStandards.getStaByte(_cont,instance_.getDroppedStatDirectMove()));
            return res_;
        }
        ...
        if (StringUtil.quickEq(fieldName_,REASONS_PROTECT)) {
            res_.setResult(std_.getStringArray(instance_.getReasonsProtect()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,REASONS_COUNTER)) {
            res_.setResult(std_.getStringArray(instance_.getReasonsCounter()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.getResultEffectBean(_cont, _classField, _instance);
    }
    public static ResultErrorStd getResultEffectDamageBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,DAMAGE_LAW)) {
            res_.setResult(PokemonStandards.getStrRate(_cont,instance_.getDamageLaw()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MAP_VARS_DAMAGE)) {
            res_.setResult(PokemonStandards.getStrStr(_cont,instance_.getMapVarsDamage()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MULT_DAMAGE_AGAINST)) {
            res_.setResult(PokemonStandards.getStrRate(_cont,instance_.getMultDamageAgainst()));
            return res_;
        }
        ...
        if (StringUtil.quickEq(fieldName_,CH_LAW)) {
            res_.setResult(PokemonStandards.getRateRate(_cont,instance_.getChLaw()));
            return res_;
        }
        ...
        if (StringUtil.quickEq(fieldName_,IGN_VAR_STAT_TARGET_POS)) {
            res_.setResult(PokemonStandards.getSta(_cont,instance_.getIgnVarStatTargetPos()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,IGN_VAR_STAT_USER_NEG)) {
            res_.setResult(PokemonStandards.getSta(_cont,instance_.getIgnVarStatUserNeg()));
            return res_;
        }
        ...
        if (StringUtil.quickEq(fieldName_,BOOST_STATIS_ONCE_KO_FOE)) {
            res_.setResult(PokemonStandards.getStaByte(_cont,instance_.getBoostStatisOnceKoFoe()));
            return res_;
        }
    ...
    public static ResultErrorStd getResultEffectFullHpRateBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,MAP_VARS_RESTORED)) {
            res_.setResult(PokemonStandards.getStrStr(_cont,instance_.getMapVarsRestored()));
            return res_;
        }
    ...
    public static ResultErrorStd getResultEffectGlobalBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,PREVENT_STATUS)) {
            res_.setResult(std_.getStringArray(instance_.getPreventStatus()));
            return res_;
        }
        ...
        if (StringUtil.quickEq(fieldName_,EFFICIENCY_MOVES)) {
            res_.setResult(PokemonStandards.getTpDuoRate(_cont,instance_.getEfficiencyMoves()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,DISABLE_IMMU_AGAINST_TYPES)) {
            res_.setResult(std_.getStringArray(instance_.getDisableImmuAgainstTypes()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,CANCEL_PROTECTING_ABILITIES)) {
            res_.setResult(std_.getStringArray(instance_.getCancelProtectingAbilities()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,UNUSABLE_MOVES)) {
            res_.setResult(std_.getStringArray(instance_.getUnusableMoves()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,CANCEL_EFFECTS)) {
            res_.setResult(std_.getStringArray(instance_.getCancelEffects()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MULT_POWER_MOVES)) {
            res_.setResult(PokemonStandards.getStrRate(_cont,instance_.getMultPowerMoves()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MULT_DAMAGE_TYPES_MOVES)) {
            res_.setResult(PokemonStandards.getStrRate(_cont,instance_.getMultDamageTypesMoves()));
            return res_;
        }
        ...
        if (StringUtil.quickEq(fieldName_,INVOKING_MOVES)) {
            res_.setResult(std_.getStringArray(instance_.getInvokingMoves()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,CHANGED_TYPES_TERRAIN)) {
            res_.setResult(std_.getStringArray(instance_.getChangedTypesTerrain()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,INVOKING_MOVES_CHANGING_TYPES)) {
            res_.setResult(std_.getStringArray(instance_.getInvokingMovesChangingTypes()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MULT_STAT_IF_CONTAINS_TYPE)) {
            res_.setResult(PokemonStandards.getWcRateMap(_cont,instance_.getMultStatIfContainsType()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MULT_DAMAGE_PREPA_ROUND)) {
            res_.setResult(PokemonStandards.getStrRate(_cont,instance_.getMultDamagePrepaRound()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MOVES_USED_BY_TARGETED_FIGHTERS)) {
            res_.setResult(std_.getStringArray(instance_.getMovesUsedByTargetedFighters()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.getResultEffectBean(_cont, _classField, _instance);
    }
    public static ResultErrorStd getResultEffectInvokeBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,MOVE_FCT_ENV)) {
            res_.setResult(PokemonStandards.getStrStr(_cont,instance_.getMoveFctEnv()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,GLOBAL_MOVES)) {
            res_.setResult(std_.getStringArray(instance_.getGlobalMoves()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,INVOKING_MOVE_BY_USER_TYPES)) {
            res_.setResult(PokemonStandards.getStrStr(_cont,instance_.getInvokingMoveByUserTypes()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MOVES_NOT_TO_BE_INVOKED)) {
            res_.setResult(std_.getStringArray(instance_.getMovesNotToBeInvoked()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.getResultEffectBean(_cont, _classField, _instance);
    }
    ...
    public static ResultErrorStd getResultEffectStatusBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,MAP_VARS_STATUS)) {
            res_.setResult(PokemonStandards.getStrStr(_cont,instance_.getMapVarsStatus()));
            return res_;
        }
    ...
    public static ResultErrorStd getResultEffectSwitchMoveTypesBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,CHANGE_TYPES)) {
            res_.setResult(PokemonStandards.getStrStr(_cont,instance_.getChangeTypes()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.getResultEffectBean(_cont, _classField, _instance);
    }
    public static ResultErrorStd getResultEffectSwitchTypesBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,ADDED_TYPES)) {
            res_.setResult(std_.getStringArray(instance_.getAddedTypes()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,CONST_TYPES)) {
            res_.setResult(std_.getStringArray(instance_.getConstTypes()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.getResultEffectBean(_cont, _classField, _instance);
    }
    public static ResultErrorStd getResultEffectTeamBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,FORBIDDEN_BOOST)) {
            res_.setResult(std_.getStringArray(instance_.getForbiddenBoost()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,CANCEL_CHGT_STAT_FOE_TEAM)) {
            res_.setResult(std_.getStringArray(instance_.getCancelChgtStatFoeTeam()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,DEFAULT_BOOST)) {
            res_.setResult(new IntStruct(instance_.getDefaultBoost()));
        ...
        if (StringUtil.quickEq(fieldName_,CANCEL_CHGT_STAT_TEAM)) {
            res_.setResult(std_.getStringArray(instance_.getCancelChgtStatTeam()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,PROTECT_AGAINST_LOW_STAT)) {
            res_.setResult(std_.getStringArray(instance_.getProtectAgainstLowStat()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,PROTECT_AGAINST_STATUS)) {
            res_.setResult(std_.getStringArray(instance_.getProtectAgainstStatus()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MULT_STATISTIC)) {
            res_.setResult(PokemonStandards.getStrRate(_cont,instance_.getMultStatistic()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MULT_STATISTIC_FOE)) {
            res_.setResult(PokemonStandards.getStrRate(_cont,instance_.getMultStatisticFoe()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MULT_DAMAGE)) {
            res_.setResult(PokemonStandards.getCatMultRateMap(_cont,instance_.getMultDamage()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,UNUSABLE_MOVES)) {
            res_.setResult(std_.getStringArray(instance_.getUnusableMoves()));
        ...
        if (StringUtil.quickEq(fieldName_,DISABLE_FOE_TEAM_EFFECTS)) {
            res_.setResult(std_.getStringArray(instance_.getDisableFoeTeamEffects()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,DISABLE_FOE_TEAM_STATUS)) {
            res_.setResult(std_.getStringArray(instance_.getDisableFoeTeamStatus()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.getResultEffectBean(_cont, _classField, _instance);
    }
    public static ResultErrorStd getResultEffectTeamWhileSendFoeBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,MAP_VARS_DAMAGE_SENT_FOE)) {
            res_.setResult(PokemonStandards.getStrStr(_cont,instance_.getMapVarsDamageSentFoe()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,STATISTICS)) {
            res_.setResult(PokemonStandards.getStaByte(_cont,instance_.getStatistics()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,STATUS_BY_NB_USES)) {
            res_.setResult(PokemonStandards.getShortStr(_cont,instance_.getStatusByNbUses()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,REASONS_SENDING)) {
            res_.setResult(std_.getStringArray(instance_.getReasonsSending()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,MAP_VARS_FAIL_SENDING)) {
            res_.setResult(PokemonStandards.getStrStr(_cont,instance_.getMapVarsFailSending()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,DELETED_BY_FOE_TYPES)) {
            res_.setResult(std_.getStringArray(instance_.getDeletedByFoeTypes()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.getResultEffectBean(_cont, _classField, _instance);
    }
    public static ResultErrorStd getResultEffectUnprotectFromTypesBean(ContextEl _cont, ClassField _classField, Struct _instance) {
        ...
        if (StringUtil.quickEq(fieldName_,DISABLE_IMMU_FROM_MOVES)) {
            res_.setResult(std_.getStringArray(instance_.getDisableImmuFromMoves()));
            return res_;
        }
        if (StringUtil.quickEq(fieldName_,ATTACK_TARGET_WITH_TYPES)) {
            res_.setResult(std_.getStringArray(instance_.getAttackTargetWithTypes()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.getResultEffectBean(_cont, _classField, _instance);
    }
    ...
    public static ResultErrorStd invokeMethodEffectCounterAttackBean(ContextEl _cont, Struct _instance, ClassMethodId _method, Struct... _args) {
        ...
        if (StringUtil.quickEq(methodName_,GET_MAP_VARS_FAIL_COUNTER)) {
            res_.setResult(PokemonStandards.getStrStr(_cont,instance_.getMapVarsFailCounter()));
            return res_;
        }
        return AikiBeansMovesEffectsStd.invokeMethodEffectBean(_cont, _instance, _method, _args);
    }
