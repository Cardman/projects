...
public final class SimulationBean extends CommonBean  implements WithDifficultyCommon, BeanRenderWithAppName {
    ...
    private SimulationFightForm fightForm;
//    private CustList<SimulationTeamForm> teamsForm = new CustList<SimulationTeamForm>();
...
//        initPage();
//        setTitledBorder("");
        fightForm = new SimulationFightForm(this,currentUserList,fightState);
...
//        team(simulation.getGame().getFight().getFoeTeam(), messageRend(MessagesPkBean.SIMU,MessagesDataSimulation.M_P_86_TITLE_FOE));
    ...
    public void validateFightCoreForm() {
        fightForm.validateFightCoreForm();
...
//    }
    ...
    public SimulationFightForm getFightForm() {
        return fightForm;
    }
}