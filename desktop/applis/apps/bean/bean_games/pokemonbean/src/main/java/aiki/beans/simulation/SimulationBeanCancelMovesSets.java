...
public final class SimulationBeanCancelMovesSets implements NatCaller, IntBeanAction {
    private final SimulationBean bean;
    public SimulationBeanCancelMovesSets() {
        this(null);
    }
    ...
    public NaSt re(NaSt _instance, NaSt[] _args){
        ( (SimulationBean) ((PokemonBeanStruct)_instance).getInstance()).cancelMovesSets();
