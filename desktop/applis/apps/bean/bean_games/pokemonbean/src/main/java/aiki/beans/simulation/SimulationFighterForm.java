...
public final class SimulationFighterForm extends SimulationCommonForm {
    ...
    public SimulationFighterForm(SimulationBean _b, Fighter _f, int _max) {
        ...
        name = getBean().getBuilder().getGenInput().newString(pk_);
        ...
        nickname = getBean().getBuilder().getGenInput().newText();
        ...
        gender = getBean().getBuilder().getGenInput().newGender(genders_);
        ...
        weight = getBean().getBuilder().getGenInput().newRate();
        ...
        height = getBean().getBuilder().getGenInput().newRate();
        ...
        currentName = getBean().getBuilder().getGenInput().newString(pk_);
        ...
        currentGender = getBean().getBuilder().getGenInput().newGender(genders_);
        ...
        lastUsedItem = getBean().getBuilder().getGenInput().newString(itemsDef());
        ...
        nbRounds = getBean().getBuilder().getGenInput().newLgInt();
        ...
        types = getBean().getBuilder().getGenInput().newStringList(DictionaryComparatorUtil.buildTyStrElts(getBean().getDataBase(), getBean().getLanguage()));
        ...
        ability = getBean().getBuilder().getGenInput().newString(abilitiesDef());
        ...
        remainingHp = getBean().getBuilder().getGenInput().newRate();
        ...
        acted = getBean().getBuilder().getGenInput().newBool();
        ...
        groundPlace = getBean().getBuilder().getGenInput().newInt(ids_);
        ...
        groundPlaceSubst = getBean().getBuilder().getGenInput().newInt(ids_);
        ...
        wonExp = getBean().getBuilder().getGenInput().newRate();
        ...
        protectedAgainstMoveTypes = getBean().getBuilder().getGenInput().newStringList(DictionaryComparatorUtil.buildTyStrElts(getBean().getDataBase(), getBean().getLanguage()));
        ...
        wonExpSinceLastLevel = getBean().getBuilder().getGenInput().newRate();
        ...
        clone = getBean().getBuilder().getGenInput().newRate();
        ...
        usedBallCatching = getBean().getBuilder().getGenInput().newString(itemsDef());
        ...
        level = getBean().getBuilder().getGenInput().newLong();
        ...
        happiness = getBean().getBuilder().getGenInput().newLong();
        ...
        nbPrepaRound = getBean().getBuilder().getGenInput().newLong();
        ...
        disappeared = getBean().getBuilder().getGenInput().newBool();
        ...
        needingToRecharge = getBean().getBuilder().getGenInput().newBool();
        ...
        lastSufferedMove = getBean().getBuilder().getGenInput().newString(movesDef());
        ...
        lastSufferedMoveTypes = getBean().getBuilder().getGenInput().newStringList(DictionaryComparatorUtil.buildTyStrElts(getBean().getDataBase(), getBean().getLanguage()));
        ...
        alreadyInvokedMovesRound = getBean().getBuilder().getGenInput().newStringList(DictionaryComparatorUtil.buildMvStrElts(getBean().getDataBase(), getBean().getLanguage()));
        ...
        lastSuccessfulMove = getBean().getBuilder().getGenInput().newString(movesDef());
        ...
        nbRepeatingSuccessfulMoves = getBean().getBuilder().getGenInput().newLgInt();
        ...
        usingItem = getBean().getBuilder().getGenInput().newBool();
        ...
        usedMoveLastRound = getBean().getBuilder().getGenInput().newString(movesDef());
        ...
        lastUsedMove = getBean().getBuilder().getGenInput().newString(movesDef());
        ...
        movesToBeLearnt = getBean().getBuilder().getGenInput().newStringList(DictionaryComparatorUtil.buildMvStrElts(getBean().getDataBase(), getBean().getLanguage()));
        ...
        successfulMove = getBean().getBuilder().getGenInput().newBool();
        ...
        changed = getBean().getBuilder().getGenInput().newBool();
        ...
        IntBeanChgString first_ = getBean().getBuilder().getGenInput().newString(movesDef());
        ...
        IntBeanChgString last_ = getBean().getBuilder().getGenInput().newString(movesDef());
...
//        getBean().setTitledBorder(getBean().messageRend(MessagesPkBean.SIMULATION,MessagesDataSimulation.MOVES));
    ...
    private DictionaryComparator<String, String> abilitiesDef() {
        DictionaryComparator<String, String> ab_ = DictionaryComparatorUtil.buildAbStrElts(getBean().getDataBase(), getBean().getLanguage());
        ab_.put(DataBase.EMPTY_STRING, DataBase.EMPTY_STRING);
        return ab_;
    }

    private DictionaryComparator<String, String> itemsDef() {
    ...
    private DictionaryComparator<String, String> movesDef() {
        DictionaryComparator<String, String> mv_ = DictionaryComparatorUtil.buildMvStrElts(getBean().getDataBase(), getBean().getLanguage());
