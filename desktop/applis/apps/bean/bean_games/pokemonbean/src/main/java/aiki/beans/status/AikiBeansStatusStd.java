...
public final class AikiBeansStatusStd{
    ...
    private static void buildStatusBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(REASONS_END_ROUND, BeanNatCommonLgNames.TYPE_LIST,false,false,new StatusBeanReasonsEndRoundGet(),null));
        fields_.add(new StandardField(MAP_VARS_FAIL_END_ROUND, BeanNatCommonLgNames.TYPE_MAP,false,false,new StatusBeanMapVarsFailEndRoundGet(),null));
        ...
        fields_.add(new StandardField(CATCHING_RATE,BeanNatCommonLgNames.TYPE_RATE,false,false,new StatusBeanCatchingRateGet(),null));
        ...
        fields_.add(new StandardField(MULT_STAT, BeanNatCommonLgNames.TYPE_MAP,false,false,new StatusBeanMultStatGet(),null));
        fields_.add(new StandardField(REASONS, BeanNatCommonLgNames.TYPE_LIST,false,false,new StatusBeanReasonsGet(),null));
        fields_.add(new StandardField(MAP_VARS_FAIL, BeanNatCommonLgNames.TYPE_MAP,false,false,new StatusBeanMapVarsFailGet(),null));
        fields_.add(new StandardField(RATE_FOR_USING_A_MOVE,BeanNatCommonLgNames.TYPE_RATE,false,false,new StatusBeanRateForUsingAMoveGet(),null));
        fields_.add(new StandardField(NOT_ATTACK,BeanNatCommonLgNames.PRIM_BOOLEAN,false,false,new StatusBeanNotAttackGet(),null));
        fields_.add(new StandardField(RATE_FOR_USING_A_MOVE_IF_FOE,BeanNatCommonLgNames.TYPE_RATE,false,false,new StatusBeanRateForUsingAMoveIfFoeGet(),null));
        ...
        fields_.add(new StandardField(RATE_FOR_FULL_HEAL_IF_MOVE,BeanNatCommonLgNames.TYPE_RATE,false,false,new StatusBeanRateForFullHealIfMoveGet(),null));
        fields_.add(new StandardField(LAW_FOR_USING_A_MOVE_NB_ROUND, BeanNatCommonLgNames.TYPE_MAP,false,false,new StatusBeanLawForUsingAMoveNbRoundGet(),null));
        fields_.add(new StandardField(POWER,BeanNatCommonLgNames.TYPE_RATE,false,false,new StatusBeanPowerGet(),null));
        ...
        fields_.add(new StandardField(EFFECTS_PARTNER, BeanNatCommonLgNames.TYPE_LIST,false,false,new StatusBeanEffectsPartnerGet(),null));
    ...
    private static void buildStatusSetBean(PokemonStandards _std){
        ...
        fields_.add(new StandardField(SORTED_STATUS, BeanNatCommonLgNames.TYPE_LIST,false,false,new StatusSetBeanSortedStatusGet(),null));
