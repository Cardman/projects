...
public final class DictionaryComparatorUtil {
    ...
    public static DictionaryComparator<String,String> buildAbStrElts(DataBase _data, String _language) {
        StringMap<StringMap<String>> tp_ = _data.getTranslatedAbilities();
