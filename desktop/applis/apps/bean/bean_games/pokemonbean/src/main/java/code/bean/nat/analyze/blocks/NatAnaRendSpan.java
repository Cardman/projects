...
public final class NatAnaRendSpan extends NatAnaRendElementSpec {
    private StringMap<String> formatted=new StringMap<String>();
    private CustList<NatOperationNode> roots;
    private StringList texts;

    public NatAnaRendSpan(Element _elt) {
        super(_elt);
    }

    void span(Element _read, StringList _list, NatAnalyzingDoc _anaDoc, NatAnalyzedCode _page) {
        ...
        NatResultText result_ = new NatResultTextForm();
