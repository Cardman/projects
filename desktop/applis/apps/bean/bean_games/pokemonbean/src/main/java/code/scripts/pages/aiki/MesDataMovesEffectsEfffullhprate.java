...
private static final String C_P_48_6="Voici le taux des pv max restaur&eacute;s du lanceur:\n";
private static final String C_P_48_7="{0}\n";
private static final String C_P_48_8="Le lanceur sacrifie {0} de ses pv max.\n";
private static final String C_P_48_9="Chaque combattant adverse adjacent &agrave; la cible perd {0} de ses pv max.\n";
