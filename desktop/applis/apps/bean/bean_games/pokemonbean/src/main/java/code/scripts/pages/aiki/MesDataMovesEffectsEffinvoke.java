...
private static final String C_P_50_16="L''effet de l''attaque invoque une autre attaque non invoqu&eacute;e dans le tour du lanceur.Tant que l''attaque poss&egrave;de un effet qui invoque une attaque pas encore invoqu&eacute;e, les attaques sont successivement invoqu&eacute;es.\n";
private static final String C_P_50_17="Le lanceur invoque une attaque non invoqu&eacute;e qu''il ne conna&icirc;t pas actuellement.\n";
private static final String C_P_50_18="Le lanceur invoque l''attaque choisie par la cible.\n";
private static final String C_P_50_19="Le lanceur endormi invoque une attaque non invoqu&eacute;e qu''il conna&icirc;t actuellement.\n";
private static final String C_P_50_1="The user invokes a not invoked move that the user does not know currently.\n";
private static final String C_P_50_20="Le lanceur invoque une attaque d''un de ses partenaire qu''il ne conna&icirc;t pas actuellement.\n";
private static final String C_P_50_21="Le lanceur invoque la derni&egrave;re attaque r&eacute;ussie par la cible pendant le combat.\n";
private static final String C_P_50_22="Le lanceur invoque la derni&egrave;re attaque qu''il a subie pendant le combat.\n";
private static final String C_P_50_23="Les d&eacute;g&acirc;ts caus&eacute;s par l''attaque invoqu&eacute;e sont multipli&eacute;s par {0}.\n";
private static final String C_P_50_24="Les attaques suivantes ne peuvent pas &ecirc;tre invoqu&eacute;es:\n";
private static final String C_P_50_25="Voici le tableau des attaques invoqu&eacute;es en fonction du type d''environnement de combat:\n";
private static final String C_P_50_26="Les attaques ci-dessus ne sont pas invoqu&eacute;es si une des attaques suivantes est active:\n";
private static final String C_P_50_27="Type d''environnement\n";
private static final String C_P_50_28="Attaque invoqu&eacute;e\n";
private static final String C_P_50_29="Voici le tableau des attaques invoqu&eacute;es en fonction des types poss&eacute;d&eacute;s par le lanceur:\n";
