...
private static final String C_P_69_3="La cible perd {0} pp des pp max de sa derni&egrave;re attaque r&eacute;ussie.Si la derni&egrave;re attaque r&eacute;ussie de la cible poss&egrave;de moins de {0} pp des pp max, alors le nombre de pp devient nul.\n";
