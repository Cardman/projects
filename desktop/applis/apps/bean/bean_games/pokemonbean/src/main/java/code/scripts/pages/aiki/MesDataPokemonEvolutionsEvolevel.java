...
private static final String C_P_75_1="The level of {0} is greater or equals to {1}.<br/>\n";
private static final String C_P_75_2="{0} &eacute;volue en {1}.\n";
private static final String C_P_75_3="Le niveau de {0} est sup&eacute;rieur ou &eacute;gal &agrave; {1}.<br/>\n";
