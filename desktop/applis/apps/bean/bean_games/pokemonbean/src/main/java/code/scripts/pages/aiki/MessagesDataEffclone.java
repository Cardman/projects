...
public final class MessagesDataEffclone {
    public static final String M_P_40_EFFECT_1="effect_1";
    ...
    public static final String M_P_40_EFFECT_0="effect_0";
    private MessagesDataEffclone(){
    }
    public static TranslationsFile en(){
        TranslationsFile e_=new TranslationsFile();
        e_.add(M_P_40_EFFECT_1,"The user uses {0} of its hp maximum.");
        ...
        e_.add(M_P_40_EFFECT_0,"Rate");
        return e_;
    }
    public static TranslationsFile fr(){
        TranslationsFile f_=new TranslationsFile();
        f_.add(M_P_40_EFFECT_1,"Le lanceur utilise {0} de ses pv max.");
