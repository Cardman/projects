...
public final class MessagesDataEffclone {
    ...
    public static TranslationsFile en(){
        ...
        e_.add(M_P_40_EFFECT_4,"If the owner uses one of the following moves:");
        e_.add(M_P_40_EFFECT_5,"then the clone is forwarded to the sent pokemon and this last one suffers damage of the following moves:");
    ...
    public static TranslationsFile fr(){
        ...
        f_.add(M_P_40_EFFECT_4,"Si le possesseur utilise une des attaques suivantes:");
        f_.add(M_P_40_EFFECT_5,"alors le clone est transmis vers le pokémon entrant et ce dernier subit les dégâts des attaques suivantes:");
