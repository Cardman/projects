...
public final class MessagesDataEffcopyfighter {
    ...
    public static final String M_P_42_PP_MOVES_INTRO="pp_moves_intro";
    ...
    public static TranslationsFile en(){
        ...
        e_.add(M_P_42_PP_MOVES_INTRO,"The number of pp by copied move is:");
        return e_;
    }
    public static TranslationsFile fr(){
        ...
        f_.add(M_P_42_PP_MOVES_INTRO,"Le nombre de pp par attaque copiée est de:");
        return f_;
    }
}