...
public final class MessagesDataEffdamagerate {
    ...
    public static final String M_P_46_RATE="rate";
    ...
    public static TranslationsFile en(){
        ...
        e_.add(M_P_46_RATE,"The rate of damage points inflicted against the target is:");
    ...
    public static TranslationsFile fr(){
        ...
        f_.add(M_P_46_RATE,"Le taux de points de dégâts infligés à la cible par le lanceur est de:");
