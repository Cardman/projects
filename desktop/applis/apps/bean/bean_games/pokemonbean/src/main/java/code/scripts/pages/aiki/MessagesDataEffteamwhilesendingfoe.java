...
public final class MessagesDataEffteamwhilesendingfoe {
    ...
    public static final String M_P_67_DAMAGE_RATE_AGAINST_FOE_INTRO="damage_rate_against_foe_intro";
    ...
    public static final String M_P_67_SENDING="sending";
    ...
    public static TranslationsFile en(){
        ...
        e_.add(M_P_67_DAMAGE_RATE_AGAINST_FOE_INTRO,"The formula of damage rate inflicted against the of is:");
        ...
        e_.add(M_P_67_SENDING,"Fail effect condition:");
    ...
    public static TranslationsFile fr(){
        ...
        f_.add(M_P_67_DAMAGE_RATE_AGAINST_FOE_INTRO,"La formule du taux de dégâts infligés à l''adversaire vaut:");
        ...
        f_.add(M_P_67_SENDING,"Condition d'échec de l'effet:");
