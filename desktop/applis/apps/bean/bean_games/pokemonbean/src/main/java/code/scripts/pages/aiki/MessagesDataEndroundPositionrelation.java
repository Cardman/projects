...
public final class MessagesDataEndroundPositionrelation {
    ...
    public static final String M_P_8_HEAL_HP_INTRO="heal_hp_intro";
    ...
    public static TranslationsFile en(){
        ...
        e_.add(M_P_8_HEAL_HP_INTRO,"The rate of full life of the pokemon that is at the place of the effect is:");
        return e_;
    }
    public static TranslationsFile fr(){
        ...
        f_.add(M_P_8_HEAL_HP_INTRO,"Le taux de vie totale du pokemon qui est placé à l'emplacement de l'effet est de:");
        return f_;
    }
}