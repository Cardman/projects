...
public final class MessagesDataItemsItemforbattle {
    ...
    public static final String M_P_28_BOOST_TYPES_TYPE="boost_types_type";
    ...
    public static final String M_P_28_DAMAGE_RECOIL_INTRO="damage_recoil_intro";
    public static final String M_P_28_DRAINED_HP="drained_hp";
    public static final String M_P_28_DRAINED_HP_INTRO="drained_hp_intro";
    ...
    public static final String M_P_28_MULT_TRAPPING_INTRO="mult_trapping_intro";
    public static final String M_P_28_MULT_WIN_EV="mult_win_ev";
    public static final String M_P_28_MULT_WIN_EV_INTRO="mult_win_ev_intro";
    public static final String M_P_28_MULT_WIN_EXP="mult_win_exp";
    public static final String M_P_28_MULT_WIN_EXP_INTRO="mult_win_exp_intro";
    public static final String M_P_28_MULT_WIN_HAPPINESS="mult_win_happiness";
    public static final String M_P_28_MULT_WIN_HAPPINESS_INTRO="mult_win_happiness_intro";
    public static final String M_P_28_MULT_WIN_MONEY="mult_win_money";
    public static final String M_P_28_PROTECT_KO="protect_ko";
    public static final String M_P_28_PROTECT_KO_INTRO="protect_ko_intro";
    public static final String M_P_28_PROTECT_KO_ALL="protect_ko_all";
    public static final String M_P_28_PROTECT_KO_ALL_INTRO="protect_ko_all_intro";
    ...
    public static TranslationsFile en(){
        ...
        e_.add(M_P_28_BOOST_TYPES_TYPE, "Type");
        ...
        e_.add(M_P_28_DAMAGE_RECOIL_INTRO,"If the owner of the item is targetted by a direct move, then the user of the direct move suffers the following rate of the max hp of the user:");
        ...
        e_.add(M_P_28_DRAINED_HP_INTRO,"While the use of a damaging move by the owner of the item against a foe, the restored life of the owner of the item is the following rate of inflicted damage against the foe:");
        ...
        e_.add(M_P_28_MULT_TRAPPING_INTRO,"Damage at the end of the round inflicted by trapping moves used by the owner of the item are multiplied by:");
        e_.add(M_P_28_MULT_WIN_EV,"The winning of ev of the owner of the item is multiplied by {0}.");
        e_.add(M_P_28_MULT_WIN_EV_INTRO,"The winning of ev of the owner of the item is multiplied by:");
        e_.add(M_P_28_MULT_WIN_EXP,"The winning of experience of the owner of the item is multiplied by{0}.");
        e_.add(M_P_28_MULT_WIN_EXP_INTRO,"The winning of experience of the owner of the item is multiplied by:");
        e_.add(M_P_28_MULT_WIN_HAPPINESS,"The winning of happiness of the owner of the item is multiplied by {0}.");
        e_.add(M_P_28_MULT_WIN_HAPPINESS_INTRO,"The winning of happiness of the owner of the item is multiplied by:");
        ...
        e_.add(M_P_28_PROTECT_KO_INTRO,"The owner of the item keeps the following hp if it is to fall KO:");
        ...
        e_.add(M_P_28_PROTECT_KO_ALL_INTRO,"The owner of the item keeps the following hp if it is to fall KO and if it had all its hp:");
    ...
    public static TranslationsFile fr(){
        ...
        f_.add(M_P_28_BOOST_TYPES_TYPE, "Type");
        ...
        f_.add(M_P_28_DAMAGE_RECOIL_INTRO,"Si le porteur de l'objet est touché par une attaque directe, alors le lanceur de l'attaque directe subit le taux suivant des pv max du lanceur de cette attaque:");
        ...
        f_.add(M_P_28_DRAINED_HP_INTRO,"Lors de l'utilisation d'une attaque offensive par le porteur de l'objet contre un adversaire, la vie restaurée du porteur de l'objet vaut le taux suivant des dégâts infligés à l'adversaire:");
        ...
        f_.add(M_P_28_MULT_TRAPPING_INTRO,"Les dégâts de fin de tour causés par des attaques piégeantes utilisées par le porteur de l'objet sont multipliés par:");
        f_.add(M_P_28_MULT_WIN_EV,"Le gain de ev du porteur de l''objet est multiplié par {0}.");
        f_.add(M_P_28_MULT_WIN_EV_INTRO,"Le gain de ev du porteur de l'objet est multiplié par:");
        f_.add(M_P_28_MULT_WIN_EXP,"Le gain d''expérience du porteur de l''objet est multiplié par{0}.");
        f_.add(M_P_28_MULT_WIN_EXP_INTRO,"Le gain d'expérience du porteur de l'objet est multiplié par:");
        f_.add(M_P_28_MULT_WIN_HAPPINESS,"Le gain de bonheur du porteur de l''objet est multiplié par {0}.");
        f_.add(M_P_28_MULT_WIN_HAPPINESS_INTRO,"Le gain de bonheur du porteur de l'objet est multiplié par:");
        ...
        f_.add(M_P_28_PROTECT_KO_INTRO,"Le porteur de l'objet conserve les pv suivants s'il est censé tomber KO:");
        ...
        f_.add(M_P_28_PROTECT_KO_ALL_INTRO,"Le porteur de l'objet conserve les pv suivants s'il est censé tomber KO et s'il possédait tous ses pv:");
