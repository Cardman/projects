...
public final class MessagesDataStatus {
    ...
    public static final String M_P_88_AUTO_DAMAGE_POW="auto_damage_pow";
    public static final String M_P_88_CATCHING_RATE="catching_rate";
    public static final String M_P_88_CATCHING_RATE_INTRO="catching_rate_intro";
    public static final String M_P_88_DAMAGED_FOES="damaged_foes";
    public static final String M_P_88_DAMAGED_FOES_INTRO="damaged_foes_intro";
    ...
    public static final String M_P_88_HEAL_HP_INTRO="heal_hp_intro";
    ...
    public static final String M_P_88_INCREMENT_END_ROUND_INTRO="increment_end_round_intro";
    ...
    public static final String M_P_88_RATE_HEAL_MOVE_INTRO="rate_heal_move_intro";
    public static final String M_P_88_RATE_USE_MOVE="rate_use_move";
    public static final String M_P_88_RATE_USE_MOVE_INTRO="rate_use_move_intro";
    public static final String M_P_88_RATE_USE_MOVE_FOE="rate_use_move_foe";
    public static final String M_P_88_RATE_USE_MOVE_FOE_INTRO="rate_use_move_foe_intro";
    ...
    public static TranslationsFile en(){
        ...
        e_.add(M_P_88_AUTO_DAMAGE_POW,"Power:");
        e_.add(M_P_88_CATCHING_RATE,"The catching rate is multiplied by {0} for each owned status by the user.");
        e_.add(M_P_88_CATCHING_RATE_INTRO,"The catching rate is multiplied by the following rate for each owned status by the user:");
        e_.add(M_P_88_DAMAGED_FOES,"If the owner loves a partner, then damage are multiplied by {0} for each partner that it loves.");
        e_.add(M_P_88_DAMAGED_FOES_INTRO,"If the owner loves a partner, then damage are multiplied by the following rate for each partner that it loves:");
        ...
        e_.add(M_P_88_HEAL_HP_INTRO,"In the case when a move achieves a loved partner, the rate of restored life of this partner is:");
        ...
        e_.add(M_P_88_INCREMENT_END_ROUND_INTRO,"The rank of incrementing is:");
        ...
        e_.add(M_P_88_RATE_HEAL_MOVE_INTRO,"The probability that the owner is healed from the status knowing that the owner uses a move is:");
        e_.add(M_P_88_RATE_USE_MOVE,"The probability that the owner can act its round is {0}.");
        e_.add(M_P_88_RATE_USE_MOVE_INTRO,"The probability that the owner can act its round is:");
        ...
        e_.add(M_P_88_RATE_USE_MOVE_FOE_INTRO,"The probability that the owner can use a move against a target in relation with the owner is:");
    ...
    public static TranslationsFile fr(){
        ...
        f_.add(M_P_88_AUTO_DAMAGE_POW,"Puissance:");
        f_.add(M_P_88_CATCHING_RATE,"Le coefficient de capture est multiplié par {0} pour chaque statut possédé par le porteur.");
        f_.add(M_P_88_CATCHING_RATE_INTRO,"Le coefficient de capture est multiplié par le taux suivant pour chaque statut possédé par le porteur:");
        ...
        f_.add(M_P_88_DAMAGED_FOES_INTRO,"Si le porteur aime un partenaire, alors les dégâts sont multipliés par le taux suivant pour chaque partenaire qu'il aime:");
        ...
        f_.add(M_P_88_HEAL_HP_INTRO,"En cas d''attaque touchant un partenaire aimé, le taux de vie restaurés de ce partenaire vaut:");
        ...
        f_.add(M_P_88_INCREMENT_END_ROUND_INTRO,"Le rang d'incrémentation vaut:");
        ...
        f_.add(M_P_88_RATE_HEAL_MOVE_INTRO,"La probabilité que le porteur soit soigné du statut sachant que le porteur attaque est de:");
        f_.add(M_P_88_RATE_USE_MOVE,"La probabilité que le porteur puisse entamer son tour est de {0}.");
        f_.add(M_P_88_RATE_USE_MOVE_INTRO,"La probabilité que le porteur puisse entamer son tour est de:");
        ...
        f_.add(M_P_88_RATE_USE_MOVE_FOE_INTRO,"La probabilité que le porteur puisse utiliser une attaque sur une cible en relation avec le porteur est de:");
