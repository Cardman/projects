...
final class PageDataMovesEffectsEffglobal extends PageAikiCommon{
private static final String C_P_157_0="javahtml";
private static final String C_P_157_1="eff_global";
private static final String C_P_157_2="web/css/moves.css";
...
private static final String C_P_157_43="$clickPreventedStatus({([s])})";
...
private static final String C_P_157_76="$clickCancelledAbility({([t])})";
...
private static final String C_P_157_83="$clickUnusableMove({([t])})";
...
private static final String C_P_157_90="$clickCancelledEffect({([t])})";
...
private static final String C_P_157_102="$clickMultMovePower({([c])})";
...
private static final String C_P_157_125_LK="$clickInvokedMove";
...
private static final String C_P_157_161="$clickMovesTarget({([t])})";
