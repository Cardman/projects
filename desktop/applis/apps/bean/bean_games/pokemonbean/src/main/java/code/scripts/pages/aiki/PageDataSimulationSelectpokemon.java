...
final class PageDataSimulationSelectpokemon extends PageAikiCommon{
...
private static final String C_P_200_43="submit";
private static final String C_P_200_44="OK";
...
ad(elt0_,elt18_);
Element elt19_=el(_doc105,INPUT);
CustList<Attr> attrs13_=al(2);
attrs13_.add(at(TYPE,C_P_200_43));
attrs13_.add(at(VALUE,C_P_200_44));
at(elt19_,attrs13_);
ad(elt0_,elt19_);
ad(_body,elt0_);
}
