...
public abstract class InitDbBean extends BeanPokemonCommonTs {
    ...
    protected static final String IMG_H_1 = "AAABAADO";
    protected static final String IMG_H_2 = "AAABAAEO";
    protected static final String IMG_H_3 = "AAABAAFO";
    protected static final String IMG_H_4 = "AAABAAGO";
    protected static final String IMG_H_5 = "AAABAAHO";
    protected static final String IMG_PR_1 = "AAABAAD1";
    protected static final String IMG_PR_2 = "AAABAAD2";
    protected static final String IMG_PR_3 = "AAABAAD3";
    protected static final String IMG_PR_4 = "AAABAAD4";
    protected static final String IMG_PR_5 = "AAABAAD5";
    protected static final String IMG_PR_6 = "AAABAAD6";
    protected static final String IMG_MAX_PIKA = "AAABAACO";
    ...
    public static DataBase progress() {
        ...
        data_.getFrontHeros().addEntry(new ImageHeroKey(EnvironmentType.ROAD, Sex.GIRL), getImageByString(IMG_H_1));
        data_.getFrontHeros().addEntry(new ImageHeroKey(EnvironmentType.ROAD, Sex.BOY),getImageByString(IMG_H_2));
        data_.getBackHeros().addEntry(new ImageHeroKey(EnvironmentType.ROAD, Sex.GIRL),getImageByString(IMG_H_3));
        data_.getBackHeros().addEntry(new ImageHeroKey(EnvironmentType.ROAD, Sex.BOY),getImageByString(IMG_H_4));
        data_.setEndGameImage(getImageByString(IMG_H_5));
        ...
        data_.getMaxiPkFront().addEntry(PROG_PK1,getImageByString(IMG_PR_1));
        data_.getMaxiPkFront().addEntry(PROG_PK2,getImageByString(IMG_PR_2));
        data_.getMaxiPkFront().addEntry(PROG_PK3,getImageByString(IMG_PR_3));
        data_.getMaxiPkFront().addEntry(PROG_PK4,getImageByString(IMG_PR_4));
        data_.getMaxiPkFront().addEntry(PROG_PK5,getImageByString(IMG_PR_5));
        data_.getMaxiPkFront().addEntry(PROG_PK6,getImageByString(IMG_PR_6));
        return data_;
    }
