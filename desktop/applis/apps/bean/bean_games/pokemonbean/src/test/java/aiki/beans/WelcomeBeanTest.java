...
public final class WelcomeBeanTest extends InitDbWelcome {
    ...
    public void init() {
        ...
        Navigation nav_ = pk_.nav(Constants.getAvailableLanguages(),EN,new DataGameInit(), b_,builtOther_,builtMessages_,ACCESS_TO_DEFAULT_FILES);
        pk_.setDataBase(f_);
        ...
        new NatRendTitledAnchor(b_.getValue(0).getDocumentElement(),new StringMap<NatExecTextPart>(),new StringMap<NatExecTextPart>(),new CustList<NatExecOperationNode>(),new StringList(),new StringMap<String>(), txt_).processEl(new Configuration(), r_);
        new NatRendInactiveAnchor(b_.getValue(0).getDocumentElement(),new StringMap<NatExecTextPart>(),new StringMap<NatExecTextPart>()).processEl(new Configuration(), r_);
        ...
        new NatRendInput(radi_,new StringMap<NatExecTextPart>(),new StringMap<NatExecTextPart>(),exps2_,exps2_,null, up_).processEl(new Configuration(), r_);
        ...
        PokemonStandards.redir(new Argument(),new StringList(""), exps_,new StringList(""),r_);
        ...
        up_.setRad(true);
        NatRendElementForm.prStack(new Configuration(),b_.getValue(0).createElement(""),up_,new NatFetchedObjs(new CustList<Struct>(), st_,new Argument()),new Argument(),r_,"");
        NatRendElementForm.prStack(new Configuration(),b_.getValue(0).createElement(""),up_,new NatFetchedObjs(new CustList<Struct>(), st_,new Argument()),new Argument(),r_,"");
