...
public final class DifficultyBeanTest extends InitDbDifficultyBean {
    ...
    public void init() {
        ...
        assertEq("<html xmlns:c=\"javahtml\"><head><title>Difficulty choice</title><link href=\"web_game/css/difficulty.css\" rel=\"stylesheet\" type=\"text/css\"/><style>p{\n" +
                ...
                "\tcolor:red;\n" +
                "}\n" +
                "</style></head><body><form c:command=\"difficulty.change\" name=\"changingDiff\" action=\"\" n-f=\"0\">Difficulty of winning points<select name=\"difficulty_common.diffWinningExpPtsFight\" n-i=\"0\"><option value=\"TRES_FACILE\">W1</option><option value=\"FACILE\" selected=\"selected\">W2</option><option value=\"DIFFICILE\">W3</option><option value=\"TRES_DIFFICILE\">W4</option></select><br/>Allow catching ko pokemon<input name=\"difficulty_common.allowCatchingKo\" type=\"checkbox\" n-i=\"1\" checked=\"checked\"/><br/>Allow swicthing places at the front of battle at the end of round<input name=\"difficulty_common.allowedSwitchPlacesEndRound\" type=\"checkbox\" n-i=\"2\"/><br/>Rate of winning experience points de gain de points while a fight against a foe<input c:validator=\"rate_validator\" id=\"winTrainerExpRate\" name=\"difficulty_common.winTrainerExp\" type=\"text\" n-i=\"3\" value=\"2\"/><span c:for=\"winTrainerExpRate\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,rate_issue\"/><br/>Rate of winning experience points<input c:validator=\"rate_validator\" id=\"winExpRateFight\" name=\"difficulty_common.rateWinningExpPtsFight\" type=\"text\" n-i=\"4\" value=\"2\"/><span c:for=\"winExpRateFight\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,rate_issue\"/><br/>End of fight if a team is ko.<input name=\"difficulty_common.endFightIfOneTeamKo\" type=\"checkbox\" n-i=\"5\" checked=\"checked\"/><br/>Iv of your pokemon<input c:validator=\"short_validator\" id=\"ivPlayerId\" name=\"difficulty_common.ivPlayer\" type=\"text\" n-i=\"6\" value=\"31\"/><span c:for=\"ivPlayerId\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,short_issue\"/><br/>Iv of the pokemon of your foes<input c:validator=\"short_validator\" id=\"ivFoeId\" name=\"difficulty_common.ivFoe\" type=\"text\" n-i=\"7\" value=\"0\"/><span c:for=\"ivFoeId\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,short_issue\"/><br/>Rate of won money between winning money while a victory and winning base<input c:validator=\"rate_validator\" id=\"rateWinMoneyBaseId\" name=\"difficulty_common.rateWinMoneyBase\" type=\"text\" n-i=\"8\" value=\"2\"/><span c:for=\"rateWinMoneyBaseId\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,rate_issue\"/><br/>Rate of lost money between loss while a defeat and winning money while a victory<input c:validator=\"rate_validator\" id=\"rateLooseMoneyWinId\" name=\"difficulty_common.rateLooseMoneyWin\" type=\"text\" n-i=\"9\" value=\"2\"/><span c:for=\"rateLooseMoneyWinId\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,rate_issue\"/><br/>Healed moves of your pokemon at the end of fight<input name=\"difficulty_common.restoredMovesEndFight\" type=\"checkbox\" n-i=\"10\"/><br/>The moves wth single target can achieve any foe<input name=\"difficulty_common.enabledClosing\" type=\"checkbox\" n-i=\"11\" checked=\"checked\"/><br/>Random appearing pokemon<input name=\"difficulty_common.randomWildFight\" type=\"checkbox\" n-i=\"12\"/><br/>Flee always possible<input name=\"difficulty_common.stillPossibleFlee\" type=\"checkbox\" n-i=\"13\" checked=\"checked\"/><br/>Do not learnt the already known moves<input name=\"difficulty_common.skipLearningMovesWhileNotGrowingLevel\" type=\"checkbox\" n-i=\"14\" checked=\"checked\"/><br/>Choice of averages of damage rate for your pokemon<select name=\"difficulty_common.damageRatePlayer\" n-i=\"15\"><option value=\"CONSTANT_MIN\">M1</option><option value=\"CROISSANT\">M2</option><option value=\"UNIFORME\">M3</option><option value=\"DECROISSANT\">M4</option><option value=\"CONSTANT_MAX\" selected=\"selected\">M5</option></select><br/><table><thead><tr><th>Rate</th><th>Probability</th></tr></thead><tbody><tr><td>1</td><td>1</td></tr></tbody></table>Choix of averages of damage rate for the pokemon of your foes<select name=\"difficulty_common.damageRateLawFoe\" n-i=\"16\"><option value=\"CONSTANT_MIN\" selected=\"selected\">M1</option><option value=\"CROISSANT\">M2</option><option value=\"UNIFORME\">M3</option><option value=\"DECROISSANT\">M4</option><option value=\"CONSTANT_MAX\">M5</option></select><br/><table><thead><tr><th>Rate</th><th>Probability</th></tr></thead><tbody><tr><td>17/20</td><td>1</td></tr></tbody></table><input value=\"OK\" type=\"submit\"/></form></body></html>",nav_.getHtmlText());
    }
    @Test
    public void nav() {
        ...
        assertEq("<html xmlns:c=\"javahtml\"><head><title>Difficulty choice</title><link href=\"web_game/css/difficulty.css\" rel=\"stylesheet\" type=\"text/css\"/><style>p{\n" +
                ...
                "\tcolor:red;\n" +
                "}\n" +
                "</style></head><body><form c:command=\"difficulty.change\" name=\"changingDiff\" action=\"\" n-f=\"0\">Difficulty of winning points<select name=\"difficulty_common.diffWinningExpPtsFight\" n-i=\"0\"><option value=\"TRES_FACILE\">W1</option><option value=\"FACILE\" selected=\"selected\">W2</option><option value=\"DIFFICILE\">W3</option><option value=\"TRES_DIFFICILE\">W4</option></select><br/>Allow catching ko pokemon<input name=\"difficulty_common.allowCatchingKo\" type=\"checkbox\" n-i=\"1\" checked=\"checked\"/><br/>Allow swicthing places at the front of battle at the end of round<input name=\"difficulty_common.allowedSwitchPlacesEndRound\" type=\"checkbox\" n-i=\"2\"/><br/>Rate of winning experience points de gain de points while a fight against a foe<input c:validator=\"rate_validator\" id=\"winTrainerExpRate\" name=\"difficulty_common.winTrainerExp\" type=\"text\" n-i=\"3\" value=\"2\"/><span c:for=\"winTrainerExpRate\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,rate_issue\"/><br/>Rate of winning experience points<input c:validator=\"rate_validator\" id=\"winExpRateFight\" name=\"difficulty_common.rateWinningExpPtsFight\" type=\"text\" n-i=\"4\" value=\"2\"/><span c:for=\"winExpRateFight\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,rate_issue\"/><br/>End of fight if a team is ko.<input name=\"difficulty_common.endFightIfOneTeamKo\" type=\"checkbox\" n-i=\"5\" checked=\"checked\"/><br/>Iv of your pokemon<input c:validator=\"short_validator\" id=\"ivPlayerId\" name=\"difficulty_common.ivPlayer\" type=\"text\" n-i=\"6\" value=\"12\"/><span c:for=\"ivPlayerId\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,short_issue\"/><br/>Iv of the pokemon of your foes<input c:validator=\"short_validator\" id=\"ivFoeId\" name=\"difficulty_common.ivFoe\" type=\"text\" n-i=\"7\" value=\"4\"/><span c:for=\"ivFoeId\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,short_issue\"/><br/>Rate of won money between winning money while a victory and winning base<input c:validator=\"rate_validator\" id=\"rateWinMoneyBaseId\" name=\"difficulty_common.rateWinMoneyBase\" type=\"text\" n-i=\"8\" value=\"2\"/><span c:for=\"rateWinMoneyBaseId\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,rate_issue\"/><br/>Rate of lost money between loss while a defeat and winning money while a victory<input c:validator=\"rate_validator\" id=\"rateLooseMoneyWinId\" name=\"difficulty_common.rateLooseMoneyWin\" type=\"text\" n-i=\"9\" value=\"2\"/><span c:for=\"rateLooseMoneyWinId\" class=\"errormessage\" c:valueMessage=\"msg_difficulty,rate_issue\"/><br/>Healed moves of your pokemon at the end of fight<input name=\"difficulty_common.restoredMovesEndFight\" type=\"checkbox\" n-i=\"10\"/><br/>The moves wth single target can achieve any foe<input name=\"difficulty_common.enabledClosing\" type=\"checkbox\" n-i=\"11\" checked=\"checked\"/><br/>Random appearing pokemon<input name=\"difficulty_common.randomWildFight\" type=\"checkbox\" n-i=\"12\"/><br/>Flee always possible<input name=\"difficulty_common.stillPossibleFlee\" type=\"checkbox\" n-i=\"13\" checked=\"checked\"/><br/>Do not learnt the already known moves<input name=\"difficulty_common.skipLearningMovesWhileNotGrowingLevel\" type=\"checkbox\" n-i=\"14\" checked=\"checked\"/><br/>Choice of averages of damage rate for your pokemon<select name=\"difficulty_common.damageRatePlayer\" n-i=\"15\"><option value=\"CONSTANT_MIN\">M1</option><option value=\"CROISSANT\">M2</option><option value=\"UNIFORME\">M3</option><option value=\"DECROISSANT\">M4</option><option value=\"CONSTANT_MAX\" selected=\"selected\">M5</option></select><br/><table><thead><tr><th>Rate</th><th>Probability</th></tr></thead><tbody><tr><td>1</td><td>1</td></tr></tbody></table>Choix of averages of damage rate for the pokemon of your foes<select name=\"difficulty_common.damageRateLawFoe\" n-i=\"16\"><option value=\"CONSTANT_MIN\" selected=\"selected\">M1</option><option value=\"CROISSANT\">M2</option><option value=\"UNIFORME\">M3</option><option value=\"DECROISSANT\">M4</option><option value=\"CONSTANT_MAX\">M5</option></select><br/><table><thead><tr><th>Rate</th><th>Probability</th></tr></thead><tbody><tr><td>17/20</td><td>1</td></tr></tbody></table><input value=\"OK\" type=\"submit\"/></form></body></html>",nav_.getHtmlText());
    }
