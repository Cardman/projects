...
import aiki.beans.TrainerPlaceNamesGetPlace;
import aiki.beans.TrainerPlaceNamesGetTrainer;
...
public abstract class InitDbGameProgressionBean extends InitDbBean {
    public static Struct callGameProgressionBeanGetKeyPokemon(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanGetKeyPokemon(),_str,_args);
    }

    public static Struct callGameProgressionBeanGetImagePokemonFull(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanGetImagePokemonFull(),_str,_args);
    }

    public static Struct callGameProgressionBeanGetTrPokemonFull(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanGetTrPokemonFull(),_str,_args);
    }

    public static Struct callGameProgressionBeanGetImagePokemonNotAll(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanGetImagePokemonNotAll(),_str,_args);
    }

    public static Struct callGameProgressionBeanGetTrPokemonNotAll(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanGetTrPokemonNotAll(),_str,_args);
    }

    public static Struct callGameProgressionBeanGetImagePokemonPartialNot(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanGetImagePokemonPartialNot(),_str,_args);
    }

    public static Struct callGameProgressionBeanGetTrPokemonPartialNot(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanGetTrPokemonPartialNot(),_str,_args);
    }

    public static Struct callGameProgressionBeanGetImagePokemonPartial(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanGetImagePokemonPartial(),_str,_args);
    }

    public static Struct callGameProgressionBeanGetTrPokemonPartial(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanGetTrPokemonPartial(),_str,_args);
    }

    public static Struct callGameProgressionBeanGetRemainingOtherTrainersPlaceName(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanGetRemainingOtherTrainersPlaceName(),_str,_args);
    }

    public static Struct callGameProgressionBeanRemainingOtherTrainerPlacesGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanRemainingOtherTrainerPlacesGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanBeatenImportantTrainersGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanBeatenImportantTrainersGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanUnBeatenImportantTrainersGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanUnBeatenImportantTrainersGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanFullFamiliesBaseGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanFullFamiliesBaseGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanNotAtAllFamiliesBaseGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanNotAtAllFamiliesBaseGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanPartialFamiliesBaseNotCaughtGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanPartialFamiliesBaseNotCaughtGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanUnVisitedPlacesGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanUnVisitedPlacesGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanVisitedPlacesGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanVisitedPlacesGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanNbRemainingNotMaxLevelGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanNbRemainingNotMaxLevelGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanNbRemainingNotMaxHappinessGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanNbRemainingNotMaxHappinessGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanNbRemainingEggsGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanNbRemainingEggsGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanMoneyGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanMoneyGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanRemainStepsRepelGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanRemainStepsRepelGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanEndGameImageGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanEndGameImageGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanFinishedGameGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanFinishedGameGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanHeroImageOppositeSexGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanHeroImageOppositeSexGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanHeroImageGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanHeroImageGet(),_str,_args);
    }

    public static Struct callGameProgressionBeanNicknameGet(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new GameProgressionBeanNicknameGet(),_str,_args);
    }
    ...
    public static Struct callTrainerPlaceNamesGetPlace(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new TrainerPlaceNamesGetPlace(),_str,_args);
    }

    public static Struct callTrainerPlaceNamesGetTrainer(Struct _str, long... _args) {
        return InitDbPkBean.callLongs(new TrainerPlaceNamesGetTrainer(),_str,_args);
    }
}
