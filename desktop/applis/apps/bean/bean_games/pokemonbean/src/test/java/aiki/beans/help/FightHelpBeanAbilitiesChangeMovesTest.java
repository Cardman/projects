...
//    @Test
//    public void init() {
//        assertSizeEq(1,callFightHelpBeanAbilitiesCTM(bean(db())));
//    }
    @Test
    public void tr() {
        assertEq(M_DAM_TR,callFightHelpBeanGetTrAbilitiesChangeTypeMoves(bean(db()),0));
    }
    @Test
    public void cl1() {
    ...
    private String click() {
        NaSt b_ = bean(db());
        return toStr(callFightHelpBeanClickAbilitiesChangeTypeMoves(b_,0));
    }
