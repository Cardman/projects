...
public final class FightHelpBeanAbilitiesMultRateChTest extends InitDbFightHelp {
    @Test
    public void movesTypesDefWeatherInitTest() {
        StringList ls_ = FightHelpBean.abilitesMultRateChInit(db().getData());
        assertEq(1,ls_.size());
    ...
    private String click() {
        NaSt b_ = bean(db());
        return toStr(callFightHelpBeanClickAbilitiesMultRateCh(b_,0));
    }
