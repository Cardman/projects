...
public final class FightHelpBeanAbilitiesPartStatisTest extends InitDbFightHelp {
    ...
    @Test
    public void init() {
        assertSizeEq(1,callFightHelpBeanAbilitiesPartStatisGet(bean(db())));
    }
    @Test
    public void tr() {
        assertEq(M_DAM_TR,callFightHelpBeanGetTrAbilitiesPartStatis(bean(db()),0));
    }
    @Test
    public void cl1() {
    ...
    private String click() {
        NaSt b_ = bean(db());
        return toStr(callFightHelpBeanClickAbilitiesPartStatis(b_,0));
    }
    private String clickId() {
        NaSt b_ = bean(db());
        callFightHelpBeanClickAbilitiesPartStatis(b_,0);
