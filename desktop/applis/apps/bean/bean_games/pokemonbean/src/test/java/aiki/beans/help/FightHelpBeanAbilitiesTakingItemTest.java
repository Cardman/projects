...
public final class FightHelpBeanAbilitiesTakingItemTest extends InitDbFightHelp {
    ...
    @Test
    public void init() {
        assertSizeEq(1,callFightHelpBeanAbilitiesTakingItemGet(bean(db())));
    }
    @Test
    public void tr() {
        assertEq(M_DAM_TR,callFightHelpBeanGetTrAbilitiesTakingItem(bean(db()),0));
    }
    @Test
    public void cl1() {
    ...
    private String click() {
        NaSt b_ = bean(db());
        return toStr(callFightHelpBeanClickAbilitiesTakingItem(b_,0));
    }
    private String clickId() {
        NaSt b_ = bean(db());
        callFightHelpBeanClickAbilitiesTakingItem(b_,0);
