...
public final class FightHelpBeanDamagingMovesTest extends InitDbFightHelp {
    @Test
    public void movesTypesDefWeatherInitTest() {
        StringList ls_ = FightHelpBean.damagingMovesInit(db().getData());
        assertEq(1,ls_.size());
    ...
    @Test
    public void init() {
        assertSizeEq(1,callFightHelpBeanDamagingMovesGet(bean(db())));
    }
    @Test
    public void tr() {
        assertEq(M_DAM_TR,callFightHelpBeanGetTrDamagingMoves(bean(db()),0));
    }
    @Test
    public void cl1() {
