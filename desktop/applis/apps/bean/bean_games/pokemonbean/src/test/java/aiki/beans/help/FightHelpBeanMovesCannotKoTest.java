...
public final class FightHelpBeanMovesCannotKoTest extends InitDbFightHelp {
    ...
    @Test
    public void init() {
        assertSizeEq(1,callFightHelpBeanMovesCannotKoGet(bean(db())));
    }
    @Test
    public void tr() {
        assertEq(M_DAM_TR,callFightHelpBeanGetTrMovesCannotKo(bean(db()),0));
    }
    @Test
    public void cl1() {
    ...
    private String click() {
        NaSt b_ = bean(db());
        return toStr(callFightHelpBeanClickMovesCannotKo(b_,0));
    }
    private String clickId() {
        NaSt b_ = bean(db());
        callFightHelpBeanClickMovesCannotKo(b_,0);
