...
public final class FightHelpBeanMovesIgnAccTest extends InitDbFightHelp {
    ...
    @Test
    public void init() {
        assertSizeEq(1,callFightHelpBeanMovesIgnAccGet(bean(db())));
    }
    @Test
    public void tr() {
        assertEq(M_DAM_TR,callFightHelpBeanGetTrMovesIgnAcc(bean(db()),0));
    }
    @Test
    public void cl1() {
    ...
    private String click() {
        NaSt b_ = bean(db());
        return toStr(callFightHelpBeanClickMovesIgnAcc(b_,0));
    }
    private String clickId() {
        NaSt b_ = bean(db());
        callFightHelpBeanClickMovesIgnAcc(b_,0);
