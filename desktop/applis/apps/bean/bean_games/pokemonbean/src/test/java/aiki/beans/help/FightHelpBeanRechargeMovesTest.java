...
public final class FightHelpBeanRechargeMovesTest extends InitDbFightHelp {
    ...
    @Test
    public void init() {
        assertSizeEq(1,callFightHelpBeanRechargeMovesGet(bean(db())));
    }
    @Test
    public void tr() {
        assertEq(M_DAM_TR,callFightHelpBeanGetTrRechargeMoves(bean(db()),0));
    }
    @Test
    public void cl1() {
    ...
    private String clickId() {
        NaSt b_ = bean(db());
        callFightHelpBeanClickRechargeMoves(b_,0);
