...
public abstract class InitDbGeneralHelp extends InitDbConstr {
    ...
    public static Struct callGeneralHelpBeanFirstPokemonHasItem(Struct _str, long... _args) {
        return BeanPokemonCommonTs.callLongs(new GeneralHelpBeanFirstPokemonHasItem(),_str,_args);
    }
    ...
    public static Struct callGeneralHelpBeanGetMapWidth(Struct _str, long... _args) {
        return BeanPokemonCommonTs.callLongs(new GeneralHelpBeanGetMapWidth(),_str,_args);
    }

    public static Struct callGeneralHelpBeanGetMiniMapImage(Struct _str, long... _args) {
        return BeanPokemonCommonTs.callLongs(new GeneralHelpBeanGetMiniMapImage(),_str,_args);
    }
    ...
    public static Struct callGeneralHelpBeanGetPlaceName(Struct _str, long... _args) {
        return BeanPokemonCommonTs.callLongs(new GeneralHelpBeanGetPlaceName(),_str,_args);
    }

    public static Struct callGeneralHelpBeanGetTmPrice(Struct _str, long... _args) {
        return BeanPokemonCommonTs.callLongs(new GeneralHelpBeanGetTmPrice(),_str,_args);
    }
...
//    }
    ...
    public static Struct callGeneralHelpBeanMiniMapGet(Struct _str, long... _args) {
        return BeanPokemonCommonTs.callLongs(new GeneralHelpBeanMiniMapGet(),_str,_args);
    }
