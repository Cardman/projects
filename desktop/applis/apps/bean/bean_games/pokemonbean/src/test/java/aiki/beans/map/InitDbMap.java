...
//        _facade.getData().getMiniPk().addEntry(P_POK_15,BaseSixtyFourUtil.getImageByString("AAACAAAPBAAA////////"));
        ...
        _facade.getData().getMaxiPkFront().addEntry(P_POK_02,getImageByString("AAABAAAC"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_03,getImageByString("AAABAAAD"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_04,getImageByString("AAABAAAE"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_05,getImageByString("AAABAAAF"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_06,getImageByString("AAABAAAG"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_07,getImageByString("AAABAAAH"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_08,getImageByString("AAABAAAI"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_09,getImageByString("AAABAAAJ"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_10,getImageByString("AAABAAAK"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_11,getImageByString("AAABAAAL"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_12,getImageByString("AAABAAAM"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_13,getImageByString("AAABAAAN"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_14,getImageByString("AAABAAAO"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_15,getImageByString("AAABAAAP"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_16,getImageByString("AAABAAAQ"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_17,getImageByString("AAABAAAR"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_18,getImageByString("AAABAAAS"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_19,getImageByString("AAABAAAT"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_20,getImageByString("AAABAAAU"));
        _facade.getData().getMaxiPkFront().addEntry(P_POK_21,getImageByString("AAABAAAV"));
        ...
        _facade.getData().getMiniPk().addEntry(P_POK_02,getImageByString("AAABAAAC"));
        _facade.getData().getMiniPk().addEntry(P_POK_03,getImageByString("AAABAAAD"));
        _facade.getData().getMiniPk().addEntry(P_POK_04,getImageByString("AAABAAAE"));
        _facade.getData().getMiniPk().addEntry(P_POK_05,getImageByString("AAABAAAF"));
        _facade.getData().getMiniPk().addEntry(P_POK_06,getImageByString("AAABAAAG"));
        _facade.getData().getMiniPk().addEntry(P_POK_07,getImageByString("AAABAAAH"));
        _facade.getData().getMiniPk().addEntry(P_POK_08,getImageByString("AAABAAAI"));
        _facade.getData().getMiniPk().addEntry(P_POK_09,getImageByString("AAABAAAJ"));
        _facade.getData().getMiniPk().addEntry(P_POK_10,getImageByString("AAABAAAK"));
        _facade.getData().getMiniPk().addEntry(P_POK_11,getImageByString("AAABAAAL"));
        _facade.getData().getMiniPk().addEntry(P_POK_12,getImageByString("AAABAAAM"));
        _facade.getData().getMiniPk().addEntry(P_POK_13,getImageByString("AAABAAAN"));
        _facade.getData().getMiniPk().addEntry(P_POK_14,getImageByString("AAABAAAO"));
        _facade.getData().getMiniPk().addEntry(P_POK_15,getImageByString("AAABAAAP"));
        _facade.getData().getMiniPk().addEntry(P_POK_16,getImageByString("AAABAAAQ"));
        _facade.getData().getMiniPk().addEntry(P_POK_17,getImageByString("AAABAAAR"));
        _facade.getData().getMiniPk().addEntry(P_POK_18,getImageByString("AAABAAAS"));
        _facade.getData().getMiniPk().addEntry(P_POK_19,getImageByString("AAABAAAT"));
        _facade.getData().getMiniPk().addEntry(P_POK_20,getImageByString("AAABAAAU"));
        _facade.getData().getMiniPk().addEntry(P_POK_21,getImageByString("AAABAAAV"));
        _facade.getData().getTrainers().addEntry(DUAL,getImageByString("AAACAAAWAAAX"));
        _facade.getData().getTrainers().addEntry(SINGLE,getImageByString("AAABAAAW"));
        _facade.getData().getPeople().addEntry(DUAL_1,getImageByString("AAABAAAX"));
        _facade.getData().getPeople().addEntry(DUAL_2,getImageByString("AAABAAAY"));
        _facade.getData().getPeople().addEntry(SI,getImageByString("AAABAAAZ"));
        _facade.getData().getPeople().addEntry(NULL_REF,getImageByString("AAAB////"));
        _facade.getData().getImages().addEntry(NULL_REF,getImageByString("AAAB////"));
        _facade.getData().getLinks().addEntry(NULL_REF,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_BALL,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_BERRY,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_BOOST,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_ITEMBATTLE,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_EVO_ITEM,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_EVO_STONE,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_FOSSIL,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_HEAL,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_HEAL_HP,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_HEAL_PP,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_HEAL_HP_STATUS,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_HEAL_STATUS,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_REPEL,getImageByString("AAAB////"));
        _facade.getData().getMiniItems().addEntry(I_SELLING,getImageByString("AAAB////"));
