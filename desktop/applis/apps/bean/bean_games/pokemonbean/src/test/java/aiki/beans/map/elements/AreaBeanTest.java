...
public final class AreaBeanTest extends InitDbArea {
    ...
    public void getImage1() {
        assertEq("AAABAAAA",callAreaBeanGetImage(0,0));
    }
    @Test
    public void getImage2() {
        assertEq("AAABAAAB",callAreaBeanGetImage(0,1));
    }
    @Test
    public void getImage3() {
        assertEq("AAABAAAE",callAreaBeanGetImage(1,0));
    }
    @Test
    public void getImage4() {
        assertEq("AAABAAAF",callAreaBeanGetImage(1,1));
    }
    @Test
    public void getImageFishing1() {
        assertEq("AAABAAAC",callAreaBeanGetImageFishing(0,0));
    }
    @Test
    public void getImageFishing2() {
        assertEq("AAABAAAD",callAreaBeanGetImageFishing(0,1));
    }
    @Test
    public void getImageFishing3() {
        assertEq("AAABAAAG",callAreaBeanGetImageFishing(1,0));
    }
    @Test
    public void getImageFishing4() {
        assertEq("AAABAAAH",callAreaBeanGetImageFishing(1,1));
    }
    @Test
    ...
    public void clickItem5() {
        assertEq(AikiBeansItemsStd.WEB_HTML_ITEMS_FOSSIL_HTML,callAreaBeanClickItem(0,0));
    }
    @Test
    public void clickItem6() {
        assertEq(AikiBeansItemsStd.WEB_HTML_ITEMS_HEALINGSTATUS_HTML,callAreaBeanClickItem(0,1));
    }
    @Test
    public void clickItem7() {
        assertEq(AikiBeansItemsStd.WEB_HTML_ITEMS_FOSSIL_HTML,callAreaBeanClickItem(1,0));
    }
    @Test
    public void clickItem8() {
        assertEq(AikiBeansItemsStd.WEB_HTML_ITEMS_HEALINGSTATUS_HTML,callAreaBeanClickItem(1,1));
    }
    @Test
    public void clickItemFishing5() {
        assertEq(AikiBeansItemsStd.WEB_HTML_ITEMS_EVO_ITEM_HTML,callAreaBeanClickItemFishing(0,0));
    }
    @Test
    public void clickItemFishing6() {
        assertEq(AikiBeansItemsStd.WEB_HTML_ITEMS_EVO_STONE_HTML,callAreaBeanClickItemFishing(0,1));
    }
    @Test
    public void clickItemFishing7() {
        assertEq(AikiBeansItemsStd.WEB_HTML_ITEMS_EVO_ITEM_HTML,callAreaBeanClickItemFishing(1,0));
    }
    @Test
    public void clickItemFishing8() {
        assertEq(AikiBeansItemsStd.WEB_HTML_ITEMS_EVO_STONE_HTML,callAreaBeanClickItemFishing(1,1));
    }
}
