...
public final class EffectCloneBeanTest extends InitDbMoveEffectOther {
    ...
    public void clickMoveSending1() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_MOVES_DATA_HTML,callEffectCloneBeanClickMoveSending(dispMoveEffClone(),0));
    }
    @Test
    ...
    public void clickMoveBatonPass1() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_MOVES_DATA_HTML,callEffectCloneBeanClickMoveBatonPass(dispMoveEffClone(),0));
    }
    @Test
    ...
    public void clickMoveEndRound1() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_MOVES_DATA_HTML,callEffectCloneBeanClickMoveEndRound(dispMoveEffClone(),0));
    }
    @Test
