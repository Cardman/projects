...
public final class EffectCommonStatisticsBeanTest extends InitDbMoveEffectOther {
    ...
    public void getCommonValue2() {
        assertEq(Fight.TEMPS_TOUR,second(elt(callEffectCommonStatisticsBeanCommonValueGet(dispMoveEffCommonStatistics()),0)));
    }
    @Test
    ...
    public void getMapVarsCommonStatistics2() {
        assertEq(Fight.TEMPS_TOUR,first(elt(callEffectCommonStatisticsBeanMapVarsCommonStatisticsGet(dispMoveEffCommonStatistics()),0)));
    }
    @Test
