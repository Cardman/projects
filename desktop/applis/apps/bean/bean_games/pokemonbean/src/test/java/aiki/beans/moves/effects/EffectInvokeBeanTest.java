...
public final class EffectInvokeBeanTest extends InitDbMoveEffectInvoke {
    ...
    public void clickMoveUserTypes1() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_MOVES_DATA_HTML,callEffectInvokeBeanClickMoveUserTypes(dispMoveEffInvoke(true,true,true,true,true,true),0));
    }
    @Test
    ...
    public void clickMoveUserTypes3() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_MOVES_DATA_HTML,callEffectInvokeBeanClickMoveUserTypes(dispMoveEffInvoke(true,true,true,true,true,true),1));
    }
    @Test
    ...
    public void clickGlobalMoveFctEnv1() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_MOVES_DATA_HTML,callEffectInvokeBeanClickGlobalMoveFctEnv(dispMoveEffInvoke(true,true,true,true,true,true),0));
    }
    @Test
    ...
    public void clickMoveNotInvok1() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_MOVES_DATA_HTML,callEffectInvokeBeanClickMoveNotInvok(dispMoveEffInvoke(true,true,true,true,true,true),0));
    }
    @Test
    ...
    public void clickMoveFctEnv1() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_MOVES_DATA_HTML,callEffectInvokeBeanClickMoveFctEnv(dispMoveEffInvoke(true,true,true,true,true,true),0));
    }
    @Test
