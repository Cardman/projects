...
public final class EffectInvokeBeanTest extends InitDbMoveEffectInvoke {
    ...
    public void clickMoveUserTypes1() {
        assertEq(AikiBeansMovesStd.WEB_HTML_MOVES_DATA_HTML,callEffectInvokeBeanClickMoveUserTypes(dispMoveEffInvoke(true,true,true,true,true,true),0));
    }
    @Test
    ...
    public void clickMoveUserTypes3() {
        assertEq(AikiBeansMovesStd.WEB_HTML_MOVES_DATA_HTML,callEffectInvokeBeanClickMoveUserTypes(dispMoveEffInvoke(true,true,true,true,true,true),1));
    }
    @Test
    ...
    public void clickMoveNotInvok1() {
        assertEq(AikiBeansMovesStd.WEB_HTML_MOVES_DATA_HTML,callEffectInvokeBeanClickMoveNotInvok(dispMoveEffInvoke(true,true,true,true,true,true),0));
    }
    @Test
