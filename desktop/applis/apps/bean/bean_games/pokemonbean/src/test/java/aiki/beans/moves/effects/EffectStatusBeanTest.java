...
public final class EffectStatusBeanTest extends InitDbMoveEffectStatus {
    ...
    public void clickLink1() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_STATUS_DATA_HTML,callEffectStatusBeanClickLink(dispMoveEffStatus(feedDbMoveEffDataDamComp(withLawStatus(withLawStatus(eff(false,false),S_STA_SIM, LgInt.one()),S_STA_REL,LgInt.newLgInt("3"))),0),0));
    }
    @Test
    public void clickLink2() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_STATUS_DATA_HTML,callEffectStatusBeanClickLink(dispMoveEffStatus(feedDbMoveEffDataDamComp(withLawStatus(withLawStatus(eff(false,false),S_STA_SIM, LgInt.one()),S_STA_REL,LgInt.newLgInt("3"))),0),1));
    }
    @Test
    ...
    public void clickLinkDeleted1() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_STATUS_DATA_HTML,callEffectStatusBeanClickLinkDeleted(dispMoveEffStatus(feedDbMoveEffDataDamComp(withDeletedStatus(withDeletedStatus(eff(false,false),S_STA_SIM),S_STA_REL)),0),0));
    }
    @Test
    public void clickLinkDeleted2() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_STATUS_DATA_HTML,callEffectStatusBeanClickLinkDeleted(dispMoveEffStatus(feedDbMoveEffDataDamComp(withDeletedStatus(withDeletedStatus(eff(false,false),S_STA_SIM),S_STA_REL)),0),1));
    }
    @Test
