...
public final class EffectSwitchAbilitiesBeanTest extends InitDbMoveEffectSwitch {
    ...
    public void clickAbility1() {
        assertEq(AikiBeansAbilitiesStd.WEB_HTML_ABILITY_DATA_HTML,callEffectSwitchAbilitiesBeanClickAbility(dispMoveEffSwitchAbilities(A_ABILITY,ExchangeType.NOTHING),0));
    }
    @Test
