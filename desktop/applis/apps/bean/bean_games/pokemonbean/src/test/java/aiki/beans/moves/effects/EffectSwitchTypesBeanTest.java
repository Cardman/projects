...
public final class EffectSwitchTypesBeanTest extends InitDbMoveEffectSwitch {
    ...
    public void clickGlobalMoveFctEnv1() {
        assertEq(CommonBean.REN_ADD_WEB_HTML_MOVES_DATA_HTML,callEffectSwitchTypesBeanClickGlobalMoveFctEnv(dispMoveEffCopyMove(ConstValuesType.NOTHING,ExchangeType.NOTHING),0));
    }
    @Test
