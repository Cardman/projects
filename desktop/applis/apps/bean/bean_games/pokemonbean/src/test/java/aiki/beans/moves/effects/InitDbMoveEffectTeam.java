...
public abstract class InitDbMoveEffectTeam extends InitDbMoveEffect {
    ...
    public static Struct callEffectTeamBeanClickDisableFoeTeamEffects(Struct _str, long... _args) {
        return BeanPokemonCommonTs.callLongs(new EffectTeamBeanClickDisableFoeTeamEffects(),_str,_args);
    }

    public static Struct callEffectTeamBeanClickDisableFoeTeamStatus(Struct _str, long... _args) {
        return BeanPokemonCommonTs.callLongs(new EffectTeamBeanClickDisableFoeTeamStatus(),_str,_args);
    }

    public static Struct callEffectTeamBeanClickStatus(Struct _str, long... _args) {
        return BeanPokemonCommonTs.callLongs(new EffectTeamBeanClickStatus(),_str,_args);
    }

    public static Struct callEffectTeamBeanClickUnusableMove(Struct _str, long... _args) {
        return BeanPokemonCommonTs.callLongs(new EffectTeamBeanClickUnusableMove(),_str,_args);
    }
    ...
    public static Struct callEffectTeamWhileSendFoeBeanClickStatus(Struct _str, long... _args) {
        return BeanPokemonCommonTs.callLongs(new EffectTeamWhileSendFoeBeanClickStatus(),_str,_args);
    }
