...
//    }
    protected static FacadeGame feedDb() {
        ...
        PokemonData pk8_ = specPk(new StringList("__"), P_POK_08);
        ...
        PokemonData pk9_ = specPk(new StringList("__"), P_POK_08);
        ...
        facade_.getData().completeMembers(P_POK_10, specPk(new StringList("__"), P_POK_08));
