...
public abstract class InitDbPk extends InitDbConstr {
    ...
    protected static FacadeGame feedDb() {
        ...
        facade_.getData().getMiniPk().addEntry(P_POK_00,getImageByString("AAACAAAABAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_01,getImageByString("AAACAAABBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_02,getImageByString("AAACAAACBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_03,getImageByString("AAACAAADBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_04,getImageByString("AAACAAAEBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_05,getImageByString("AAACAAAFBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_06,getImageByString("AAACAAAGBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_07,getImageByString("AAACAAAHBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_08,getImageByString("AAACAAAIBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_09,getImageByString("AAACAAAJBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_10,getImageByString("AAACAAAKBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_11,getImageByString("AAACAAALBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_12,getImageByString("AAACAAAMBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_13,getImageByString("AAACAAANBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_14,getImageByString("AAACAAAOBAAA////////"));
        facade_.getData().getMiniPk().addEntry(P_POK_15,getImageByString("AAACAAAPBAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_00,getImageByString("AAACAAAADAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_01,getImageByString("AAACAAABDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_02,getImageByString("AAACAAACDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_03,getImageByString("AAACAAADDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_04,getImageByString("AAACAAAEDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_05,getImageByString("AAACAAAFDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_06,getImageByString("AAACAAAGDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_07,getImageByString("AAACAAAHDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_08,getImageByString("AAACAAAIDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_09,getImageByString("AAACAAAJDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_10,getImageByString("AAACAAAKDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_11,getImageByString("AAACAAALDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_12,getImageByString("AAACAAAMDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_13,getImageByString("AAACAAANDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_14,getImageByString("AAACAAAODAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_15,getImageByString("AAACAAAPDAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_00,getImageByString("AAACAAAAEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_01,getImageByString("AAACAAABEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_02,getImageByString("AAACAAACEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_03,getImageByString("AAACAAADEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_04,getImageByString("AAACAAAEEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_05,getImageByString("AAACAAAFEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_06,getImageByString("AAACAAAGEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_07,getImageByString("AAACAAAHEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_08,getImageByString("AAACAAAIEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_09,getImageByString("AAACAAAJEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_10,getImageByString("AAACAAAKEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_11,getImageByString("AAACAAALEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_12,getImageByString("AAACAAAMEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_13,getImageByString("AAACAAANEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_14,getImageByString("AAACAAAOEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_15,getImageByString("AAACAAAPEAAA////////"));
