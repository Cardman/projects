...
public abstract class InitDbPk extends InitDbConstr {
    ...
    protected static FacadeGame feedDb() {
        ...
        facade_.getData().getMaxiPkBack().addEntry(P_POK_00,BaseSixtyFourUtil.getImageByString("AAACAAAADAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_01,BaseSixtyFourUtil.getImageByString("AAACAAABDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_02,BaseSixtyFourUtil.getImageByString("AAACAAACDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_03,BaseSixtyFourUtil.getImageByString("AAACAAADDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_04,BaseSixtyFourUtil.getImageByString("AAACAAAEDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_05,BaseSixtyFourUtil.getImageByString("AAACAAAFDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_06,BaseSixtyFourUtil.getImageByString("AAACAAAGDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_07,BaseSixtyFourUtil.getImageByString("AAACAAAHDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_08,BaseSixtyFourUtil.getImageByString("AAACAAAIDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_09,BaseSixtyFourUtil.getImageByString("AAACAAAJDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_10,BaseSixtyFourUtil.getImageByString("AAACAAAKDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_11,BaseSixtyFourUtil.getImageByString("AAACAAALDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_12,BaseSixtyFourUtil.getImageByString("AAACAAAMDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_13,BaseSixtyFourUtil.getImageByString("AAACAAANDAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_14,BaseSixtyFourUtil.getImageByString("AAACAAAODAAA////////"));
        facade_.getData().getMaxiPkBack().addEntry(P_POK_15,BaseSixtyFourUtil.getImageByString("AAACAAAPDAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_00,BaseSixtyFourUtil.getImageByString("AAACAAAAEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_01,BaseSixtyFourUtil.getImageByString("AAACAAABEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_02,BaseSixtyFourUtil.getImageByString("AAACAAACEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_03,BaseSixtyFourUtil.getImageByString("AAACAAADEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_04,BaseSixtyFourUtil.getImageByString("AAACAAAEEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_05,BaseSixtyFourUtil.getImageByString("AAACAAAFEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_06,BaseSixtyFourUtil.getImageByString("AAACAAAGEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_07,BaseSixtyFourUtil.getImageByString("AAACAAAHEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_08,BaseSixtyFourUtil.getImageByString("AAACAAAIEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_09,BaseSixtyFourUtil.getImageByString("AAACAAAJEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_10,BaseSixtyFourUtil.getImageByString("AAACAAAKEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_11,BaseSixtyFourUtil.getImageByString("AAACAAALEAAA////////"));
        facade_.getData().getMaxiPkFront().addEntry(P_POK_12,BaseSixtyFourUtil.getImageByString("AAACAAAMEAAA////////"));
        ...
        facade_.getData().getExpGrowth().addEntry(ExpType.E, VAR_PREFIX+ DataBase.DEF_TEMPS_TOUR);
