...
//    }
    ...
    protected static LgInt editEditSelectedPlayerPkSimuStepsNbRounds(){
        ...
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getNbRounds();
    }
    ...
    protected static CustList<String> editEditSelectedPlayerPkSimuStepsLostObjects(String... _args){
        ...
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getLostObjects();
    }
    protected static CustList<String> editEditSelectedPlayerPkSimuStepsCaughtEvolutions(String... _args){
        ...
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getCaughtEvolutions();
    }
    protected static AbsMap<Integer,Integer> editEditSelectedPlayerPkSimuStepsFirstPositPlayerFighters(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        ((IntBeanChgInt)simu_.getFightForm().getFirstPositPlayerFighters().getInput().getValue(0)).valueInt(Fighter.BACK);
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getFirstPositPlayerFighters();
    }
    protected static AbsMap<Integer,Integer> editEditSelectedPlayerPkSimuStepsFirstPositFoeFighters(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        ((IntBeanChgInt)simu_.getFightForm().getFirstPositFoeFighters().getInput().getValue(0)).valueInt(Fighter.BACK);
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
    ...
    protected static AbsMap<String,ActivityOfMove> editEditSelectedPlayerPkSimuStepsEnabledMovesTeam(boolean _en){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsTeamEnabled();
        simu_.getFightForm().getTeamsForm().get(0).getEnabledMoves().getInput().setValue(0,chgAct(2,_en));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getEnabledMoves();
    }
    protected static AbsMap<String,BoolVal> editEditSelectedPlayerPkSimuStepsEnabledMovesWhileSendingFoeTeam(boolean _b){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsSendingFoe();
        simu_.getFightForm().getTeamsForm().get(0).getEnabledMovesWhileSendingFoe().getInput().setValue(0,chgBool(_b));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getEnabledMovesWhileSendingFoe();
    }
    protected static AbsMap<String,LgInt> editEditSelectedPlayerPkSimuStepsEnabledMovesWhileSendingFoeUsesTeam(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsSendingFoe();
        simu_.getFightForm().getTeamsForm().get(0).getEnabledMovesWhileSendingFoeUses().getInput().setValue(0,chgLgInt(new LgInt(2)));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getEnabledMovesWhileSendingFoeUses();
    }
    protected static AbsMap<String,Long> editEditSelectedPlayerPkSimuStepsNbUsesMovesTeam(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsNbUses();
        simu_.getFightForm().getTeamsForm().get(0).getNbUsesMoves().getInput().setValue(0,chgLg(2));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getNbUsesMoves();
    }
    protected static AbsMap<String,Long> editEditSelectedPlayerPkSimuStepsNbUsesMovesRoundTeam(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsNbUsesRound();
        simu_.getFightForm().getTeamsForm().get(0).getNbUsesMovesRound().getInput().setValue(0,chgLg(2));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getNbUsesMovesRound();
    }
    protected static long editEditSelectedPlayerPkSimuStepsNbKoRoundTeam(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getNbKoRound().valueLong(2);
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getNbKoRound();
    }
    protected static long editEditSelectedPlayerPkSimuStepsNbKoPreviousRoundTeam(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getNbKoPreviousRound().valueLong(2);
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getNbKoPreviousRound();
    }
    protected static CustList<String> editEditSelectedPlayerPkSimuStepsSuccessfulMovesRoundTeam(String... _args){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getSuccessfulMovesRound().setupValue(ls(_args));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getSuccessfulMovesRound();
    }
    protected static AbsMap<String,IntMap<Anticipation>> editEditSelectedPlayerPkSimuStepsEnabledMovesTeamAnt(boolean _en){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsAnt();
        simu_.getFightForm().getTeamsForm().get(0).getMovesAnticipation().getValue(0).getInput().setValue(0,chgAnt(2,_en,new Rate(3),0,1));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMovesAnticipation();
    }
    protected static AbsMap<String,IntMap<StacksOfUses>> editEditSelectedPlayerPkSimuStepsEnabledMovesTeamSou(boolean _f, boolean _l){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsHealAfter();
        simu_.getFightForm().getTeamsForm().get(0).getHealAfter().getValue(0).getInput().setValue(0,chgStack(_f,_l,2));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getHealAfter();
    }
    protected static ListActivityOfMoves editEditSelectedPlayerPkSimuStepsEnabledMovesTeamCombo(boolean _en){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getEnabledMovesByGroup().get(0).valueActivity(chgAct(4,_en).valueActivity());
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getEnabledMovesByGroup();
    }
    ...
    protected static AbsMap<String,Long> editEditSelectedPlayerPkSimuStepsFighterStatus(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowStatusSimple();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getStatus().getInput().setValue(0,chgLg(2));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getStatus();
    }
    protected static AbsMap<String,ActivityOfMove> editEditSelectedPlayerPkSimuStepsFighterEnabledMoves(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowAct();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getEnabledMoves().getInput().set(M_POK_07,chgAct(2,true));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getEnabledMoves();
    }
    protected static AbsMap<String,ActivityOfMove> editEditSelectedPlayerPkSimuStepsFighterEnabledMovesProt(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowProt();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getEnabledMovesProt().getInput().set(M_POK_07,chgAct(2,true));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getEnabledMovesProt();
    }
    protected static AbsMap<String,ActivityOfMove> editEditSelectedPlayerPkSimuStepsFighterEnabledMovesUnprot(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowUnProt();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getEnabledMovesUnprot().getInput().setValue(0,chgAct(2,true));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getEnabledMovesUnprot();
    }
    protected static AbsMap<String,ActivityOfMove> editEditSelectedPlayerPkSimuStepsFighterEnabledMovesEndRound(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowInd();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getEnabledMovesEndRound().getInput().setValue(0,chgAct(2,true));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getEnabledMovesEndRound();
    }
    protected static AbsMap<String,ActivityOfMove> editEditSelectedPlayerPkSimuStepsFighterEnabledMovesConstChoices(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowCst();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getEnabledMovesConstChoices().getInput().setValue(0,chgAct(2,true));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getEnabledMovesConstChoices();
    }
    protected static AbsMap<String,ActivityOfMove> editEditSelectedPlayerPkSimuStepsFighterEnabledChangingTypesMoves(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowSwMvTy();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getEnabledChangingTypesMoves().getInput().setValue(0,chgAct(2,true));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getEnabledChangingTypesMoves();
    }
    protected static AbsMap<String,ActivityOfMove> editEditSelectedPlayerPkSimuStepsFighterEnabledCounteringMoves(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowCount();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getEnabledCounteringMoves().getInput().setValue(0,chgAct(2,true));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getEnabledCounteringMoves();
    }
    protected static AbsMap<String,BoolVal> editEditSelectedPlayerPkSimuStepsFighterEnabledMovesForAlly(boolean _b){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowAlly();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getEnabledMovesForAlly().getInput().setValue(0,chgBool(_b));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getEnabledMovesForAlly();
    }
    protected static AbsMap<String,Rate> editEditSelectedPlayerPkSimuStepsFighterDamageRateInflictedByType(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getDamageRateInflictedByType().getInput().set(T_SIM_1,chgRate(new Rate(2)));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getDamageRateInflictedByType();
    }
    protected static AbsMap<String,Rate> editEditSelectedPlayerPkSimuStepsFighterDamageRateSufferedByType(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getDamageRateSufferedByType().getInput().set(T_SIM_1,chgRate(new Rate(2)));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getDamageRateSufferedByType();
    }
    protected static AbsMap<String,Long> editEditSelectedPlayerPkSimuStepsFighterNbUsesMoves(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowNbUses();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getNbUsesMoves().getInput().setValue(0,chgLg(2));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getNbUsesMoves();
    }
    protected static AbsMap<String,Rate> editEditSelectedPlayerPkSimuStepsFighterDamageSufferedCateg(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getDamageSufferedCateg().getInput().set(C_SIM_1,chgRate(new Rate(2)));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getDamageSufferedCateg();
    }
    protected static AbsMap<String,Rate> editEditSelectedPlayerPkSimuStepsFighterDamageSufferedCategRound(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getDamageSufferedCategRound().getInput().set(C_SIM_1,chgRate(new Rate(2)));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getDamageSufferedCategRound();
    }
    protected static AbsMap<String,CopiedMove> editEditSelectedPlayerPkSimuStepsFighterCopiedMoves(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowCp();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getCopiedMoves().getInput().setValue(0,chgCpMove(2,M_POK_06));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getCopiedMoves();
    }
    protected static AbsMap<Statistic,Long> editEditSelectedPlayerPkSimuStepsFighterEv(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getEv().getInput().set(Statistic.SPEED,chgLg(2));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getEv();
    }
    protected static AbsMap<Statistic,Long> editEditSelectedPlayerPkSimuStepsFighterIv(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getIv().getInput().set(Statistic.SPEED,chgLg(2));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getIv();
    }
    protected static AbsMap<Statistic,Rate> editEditSelectedPlayerPkSimuStepsFighterStatisBase(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getStatisBase().getInput().set(Statistic.SPEED,chgRate(new Rate(2)));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getStatisBase();
    }
    protected static AbsMap<Statistic,Long> editEditSelectedPlayerPkSimuStepsFighterStatisBoost(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getStatisBoost().getInput().set(Statistic.SPEED,chgLg(2));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getStatisBoost();
    }
    protected static AbsMap<String,UsesOfMove> editEditSelectedPlayerPkSimuStepsFighterMoves(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
...
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, UsesOfMove>(map_, chgStr(M_POK_03), chgUs(2,5), new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),map_,MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getMoves();
    }
    protected static AbsMap<String,UsesOfMove> editEditSelectedPlayerPkSimuStepsFighterMovesCurr(){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
//        PageFormSimu page_ = new PageFormSimu(simu_);
//        StringMap<UsesOfMove> map_ = simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getMoves();
...
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, UsesOfMove>(map_, chgStr(M_POK_07), chgUs(2,5), new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),map_,MessagesDataSimulation.M_P_86_CURRENT_MOVES), page_), simu_.getBuilder());
    ...
    protected static MoveTeamPositionsShort editEditSelectedPlayerPkSimuStepsFighterStatusRelat(){
        ...
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getStatusRelat();
    }
    protected static MoveTeamPositionsBoolVal editEditSelectedPlayerPkSimuStepsFighterIncrUserAccuracy(boolean _b){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowIncrAcc();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getIncrUserAccuracy().getInput().set(new MoveTeamPosition(M_POK_07,Fight.toFoeFighter(0)),chgBool(_b));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getIncrUserAccuracy();
    }
    protected static MoveTeamPositionsAffectedMove editEditSelectedPlayerPkSimuStepsFighterTrackingMoves(boolean _b){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowAff();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getTrackingMoves().getInput().set(new MoveTeamPosition(M_POK_07,Fight.toFoeFighter(0)),chgAfMove(2,_b,M_POK_06));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getTrackingMoves();
    }
    protected static MoveTeamPositionsActivityOfMove editEditSelectedPlayerPkSimuStepsFighterTrappingMoves(boolean _b){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowTrap();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getTrappingMoves().getInput().set(new MoveTeamPosition(M_POK_07,Fight.toFoeFighter(0)),chgAct(2, _b));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
        return simu_.getSimulation().getGame().getFight().getUserTeam().getMembers().getValue(0).getTrappingMoves();
    }
    protected static MoveTeamPositionsStringList editEditSelectedPlayerPkSimuStepsFighterPrivateMoves(String..._args){
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowPrivate();
        simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getPrivateMoves().getInput().set(new MoveTeamPosition(M_POK_07,Fight.toFoeFighter(0)),chgLs(ls(_args)));
        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
...
//        transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsCore() {
        ...
        return (SimulationBean)transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
    }
    ...
    protected static IntBeanAction editEditSelectedPlayerPkSimuStepsFirstPos3() {
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
//        StringMap<Long> map_ = simu_.getSimulation().getGame().getFight().getUsedItemsWhileRound();
//        PageFormSimu page_ = new PageFormSimu(simu_);
        ((IntBeanChgString)simu_.getFightForm().getUsedItemsWhileRoundAdd().getKey()).setupValue(I_BALL);
        transitSimuQuickChg(simu_.getFightForm().getUsedItemsWhileRoundAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getUsedItemsWhileRoundAdd().getKey()).setupValue(I_MULT_EXP);
        transitSimuQuickChg(simu_.getFightForm().getUsedItemsWhileRoundAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getUsedItemsWhileRoundAdd().getKey()).setupValue(I_NOTHING);
        transitSimuQuickChg(simu_.getFightForm().getUsedItemsWhileRoundAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getUsedItemsWhileRoundAdd().getKey()).setupValue(I_STONE);
        transitSimuQuickChg(simu_.getFightForm().getUsedItemsWhileRoundAdd(),simu_.getBuilder());
        return simu_.getFightForm().getUsedItemsWhileRoundAdd();
//        CommonBean after_ = transitSimuQuickChg(new SimulationBeanAddEntry<String, Long>(map_, chgStr(I_BALL), new BeanChgLong(), new UpdateFormUsedItem(simu_), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, Long>(map_, chgStr(I_MULT_EXP), new BeanChgLong(), new UpdateFormUsedItem(simu_), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, Long>(map_, chgStr(I_NOTHING), new BeanChgLong(), new UpdateFormUsedItem(simu_), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, Long>(map_, chgStr(I_STONE), new BeanChgLong(), new UpdateFormUsedItem(simu_), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, Long>(map_, I_BALL, new UpdateFormUsedItem(simu_), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, Long>(map_, I_MULT_EXP, new UpdateFormUsedItem(simu_), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, Long>(map_, I_NOTHING, new UpdateFormUsedItem(simu_), page_), simu_.getBuilder());
//        return (SimulationBean) transitSimuQuickChg(new SimulationBeanRemoveEntry<String, Long>(map_, I_STONE, new UpdateFormUsedItem(simu_), page_), after_.getBuilder());
    }

    protected static IntBeanAction editEditSelectedPlayerPkSimuStepsFirstPos4() {
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
        ((IntBeanChgInt)simu_.getFightForm().getChoicesAdd().getKey()).valueInt(0);
        transitSimuQuickChg(simu_.getFightForm().getChoicesAdd(),simu_.getBuilder());
        return simu_.getFightForm().getChoicesAdd();
//        IntMap<ChoiceOfEvolutionAndMoves> map_ = simu_.getSimulation().getGame().getFight().getChoices();
//        BeanChgInt key_ = new BeanChgInt();
//        key_.valueInt(0);
//        CommonBean after_ = transitSimuQuickChg(new SimulationBeanAddEntry<Integer, ChoiceOfEvolutionAndMoves>(map_, key_, new BeanChgChoiceOfEvolutionAndMoves(), new UpdateFormEvosChoices(simu_), new PageFormSimu(simu_)), simu_.getBuilder());
//        return (SimulationBean) transitSimuQuickChg(new SimulationBeanRemoveEntry<Integer, ChoiceOfEvolutionAndMoves>(map_, 0, new UpdateFormEvosChoices(simu_), new PageFormSimu(simu_)), after_.getBuilder());
    }
    protected static IntBeanAction editEditSelectedPlayerPkSimuStepsFirstPos5() {
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
...
//        key_.valueMt(d_);
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(MoveTarget.def());
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_00, Fight.CST_PLAYER, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_00, Fight.CST_PLAYER, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_00, Fight.CST_FOE, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_00, Fight.CST_FOE, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_01, Fight.CST_PLAYER, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_01, Fight.CST_PLAYER, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_01, Fight.CST_FOE, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_01, Fight.CST_FOE, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_02, Fight.CST_PLAYER, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_02, Fight.CST_PLAYER, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_02, Fight.CST_FOE, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_02, Fight.CST_FOE, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_03, Fight.CST_PLAYER, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_03, Fight.CST_PLAYER, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_03, Fight.CST_FOE, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_03, Fight.CST_FOE, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_04, Fight.CST_PLAYER, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_04, Fight.CST_PLAYER, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_04, Fight.CST_FOE, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_04, Fight.CST_FOE, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_05, Fight.CST_PLAYER, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_05, Fight.CST_PLAYER, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_05, Fight.CST_FOE, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_05, Fight.CST_FOE, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_06, Fight.CST_PLAYER, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_06, Fight.CST_PLAYER, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_06, Fight.CST_FOE, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_06, Fight.CST_FOE, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_07, Fight.CST_PLAYER, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_07, Fight.CST_PLAYER, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_07, Fight.CST_FOE, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_07, Fight.CST_FOE, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_08, Fight.CST_PLAYER, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_08, Fight.CST_PLAYER, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_08, Fight.CST_FOE, 0));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        ((IntBeanChgMoveTarget)simu_.getFightForm().getAllyChoiceAdd().getKey()).valueMt(mt(M_POK_08, Fight.CST_FOE, 1));
        transitSimuQuickChg(simu_.getFightForm().getAllyChoiceAdd(),simu_.getBuilder());
        return simu_.getFightForm().getAllyChoiceAdd();
//        PageFormSimu page_ = new PageFormSimu(simu_);
...
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, zero01_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, zero1_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, zero2_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, one0_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, one01_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, one1_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, one2_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, two0_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, two01_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, two1_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, two2_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, three0_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, three01_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, three1_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, three2_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, four0_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, four01_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, four1_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, four2_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, five0_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, five01_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, five1_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, five2_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, six0_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, six01_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, six1_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, six2_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, seven0_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, seven01_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, seven1_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, seven2_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, eight0_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, eight01_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, eight1_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, eight2_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
//        return (SimulationBean) transitSimuQuickChg(new SimulationBeanRemoveEntry<MoveTarget, MoveTarget>(map_, d_, new UpdateFormAllyChoices(simu_), page_), after_.getBuilder());
    }
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsTeam2() {
        SimulationBean simu_ = editEditSelectedPlayerPkSimuSteps();
//        return (SimulationBean)transitSimuQuick(new SimulationBeanUpdateValue(simu_.getSimulation().getGame().getFight().getUserTeam().getEnabledMovesByGroup(),new StringList(M_POK_07),new BeanChgActivityOfMove(true)), simu_.getBuilder());
        return (SimulationBean)transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
    }
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsFighter3() {
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowAlly();
        ((BeanChgBool)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getEnabledMovesForAlly().getInput().getValue(0)).setSelected(true);
//        BeanChgBool chg_ = new BeanChgBool();
//        chg_.setSelected(true);
//        return (SimulationBean)transitSimuQuick(new SimulationBeanUpdateEntryValue<String, BoolVal>(fighter(simu_).getEnabledMovesForAlly().getEntry(0), chg_), simu_.getBuilder());
        return (SimulationBean)transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
    }
    protected static IntBeanAction editEditSelectedPlayerPkSimuStepsFighter4() {
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLow();
//        PageFormSimu page_ = new PageFormSimu(simu_);
//        page_.setFormGroup(7);
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES).getKey()).setupValue(M_POK_01);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES).getKey()).setupValue(M_POK_02);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES).getKey()).setupValue(M_POK_03);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES).getKey()).setupValue(M_POK_04);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES).getKey()).setupValue(M_POK_05);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES).getKey()).setupValue(M_POK_06);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES),simu_.getBuilder());
//        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES).getKey()).setupValue(M_POK_07);
//        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES),simu_.getBuilder());
        return simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAdd().getVal(MessagesDataSimulation.M_P_86_MOVES);

//        transitSimuQuickChg(new SimulationBeanAddEntry<String, UsesOfMove>(moves(simu_), chgStr(M_POK_01), new BeanChgUsesOfMove(), new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, UsesOfMove>(moves(simu_), chgStr(M_POK_02), new BeanChgUsesOfMove(), new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, UsesOfMove>(moves(simu_), chgStr(M_POK_03), new BeanChgUsesOfMove(), new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, UsesOfMove>(moves(simu_), chgStr(M_POK_04), new BeanChgUsesOfMove(), new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, UsesOfMove>(moves(simu_), chgStr(M_POK_05), new BeanChgUsesOfMove(), new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, UsesOfMove>(moves(simu_), chgStr(M_POK_06), new BeanChgUsesOfMove(), new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, UsesOfMove>(moves(simu_), chgStr(M_POK_07), new BeanChgUsesOfMove(), new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, UsesOfMove>(moves(simu_), M_POK_01, new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, UsesOfMove>(moves(simu_), M_POK_02, new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, UsesOfMove>(moves(simu_), M_POK_03, new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, UsesOfMove>(moves(simu_), M_POK_04, new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, UsesOfMove>(moves(simu_), M_POK_05, new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, UsesOfMove>(moves(simu_), M_POK_07, new UpdateFormUsesOfMove(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),moves(simu_),MessagesDataSimulation.M_P_86_MOVES), page_), simu_.getBuilder());
//        return (SimulationBean)transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
    }

    private static StringMap<UsesOfMove> moves(SimulationBean _simu) {
        return fighter(_simu).getMoves();
    }
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsFighter6() {
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowIncrAcc();
        ((BeanChgBool)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getIncrUserAccuracy().getInput().getValue(0)).setSelected(true);
//        BeanChgBool chg_ = new BeanChgBool();
//        chg_.setSelected(true);
//        return (SimulationBean)transitSimuQuick(new SimulationBeanUpdateEntryValue<MoveTeamPosition,BoolVal>(fighter(simu_).getIncrUserAccuracy().getEntry(0), chg_), simu_.getBuilder());
        return (SimulationBean)transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
    }
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsFighter8() {
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowTrap();
//        return (SimulationBean)transitSimuQuick(new SimulationBeanUpdateEntryValue<MoveTeamPosition,ActivityOfMove>(fighter(simu_).getTrappingMoves().getEntry(0), new BeanChgActivityOfMove(true)), simu_.getBuilder());
        return (SimulationBean)transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
    }
    ...
    protected static IntBeanAction editEditSelectedPlayerPkSimuStepsFighter11() {
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLow();
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd().getKey()).setupValue(P_POK_00);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd().getKey()).setupValue(P_POK_01);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd().getKey()).setupValue(P_POK_02);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd().getKey()).setupValue(P_POK_03);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd().getKey()).setupValue(P_POK_04);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd().getKey()).setupValue(P_POK_05);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd().getKey()).setupValue(P_POK_06);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd().getKey()).setupValue(P_POK_07);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd().getKey()).setupValue(P_POK_08);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd(),simu_.getBuilder());
        ((IntBeanChgString)simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd().getKey()).setupValue(P_POK_09);
        transitSimuQuickChg(simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd(),simu_.getBuilder());
        return simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0).getMovesAbilitiesEvosAdd();
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), chgStr(P_POK_00), new BeanChgMovesAbilities(), new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), chgStr(P_POK_01), new BeanChgMovesAbilities(), new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), chgStr(P_POK_02), new BeanChgMovesAbilities(), new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), chgStr(P_POK_03), new BeanChgMovesAbilities(), new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), chgStr(P_POK_04), new BeanChgMovesAbilities(), new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), chgStr(P_POK_05), new BeanChgMovesAbilities(), new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), chgStr(P_POK_06), new BeanChgMovesAbilities(), new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), chgStr(P_POK_07), new BeanChgMovesAbilities(), new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), chgStr(P_POK_08), new BeanChgMovesAbilities(), new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanAddEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), chgStr(P_POK_09), new BeanChgMovesAbilities(), new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), P_POK_00, new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), P_POK_01, new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), P_POK_02, new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), P_POK_03, new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), P_POK_04, new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), P_POK_05, new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), P_POK_07, new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), P_POK_08, new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        transitSimuQuickChg(new SimulationBeanRemoveEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), P_POK_09, new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
//        return (SimulationBean)transitSimuQuickChg(new SimulationBeanRemoveEntry<String, MovesAbilities>(fighter(simu_).getMovesAbilitiesEvos(), P_POK_09, new UpdateFormEvosFighter(simu_,simu_.getFightForm().getTeamsForm().get(0).getMembers().get(0),fighter(simu_)), page_), simu_.getBuilder());
    }

    private static Fighter fighter(SimulationBean _simu) {
        return _simu.getSimulation().getGame().getFight().getFighter(0, 0);
    }

    protected static SimulationBean editEditSelectedPlayerPkSimuStepsFighter12() {
        SimulationBean simu_ = editEditSelectedPlayerPkSimuStepsLowAct();
        return (SimulationBean)transitSimuQuick(new SimulationBeanValidateFightCoreForm(simu_), simu_.getBuilder());
    }
    ...
    private static BeanChgList<String> chgLs(StringList _v) {
        BeanChgList<String> k_ = new BeanChgList<String>();
        k_.setupValue(_v);
        return k_;
    }
    ...
    private static IntBeanChgCopiedMove chgCpMove(long _v, String _en) {
        BeanChgCopiedMove k_ = new BeanChgCopiedMove();
        CopiedMove v_ = new CopiedMove();
        v_.setMove(_en);
        v_.setPp(_v);
        k_.valCp(v_);
        return k_;
    ...
    private static IntBeanChgAffectedMove chgAfMove(long _v, boolean _a, String _en) {
        BeanChgAffectedMove k_ = new BeanChgAffectedMove();
        AffectedMove v_ = new AffectedMove(_en,chgAct(_v,_a).valueActivity());
        v_.setMove(_en);
        k_.valAff(v_);
        return k_;
    }
    ...
    private static IntBeanChgUsesOfMove chgUs(long _v, long _en) {
        BeanChgUsesOfMove k_ = new BeanChgUsesOfMove();
        k_.valueUse(new UsesOfMove(_v,_en));
        return k_;
    }

    private static IntBeanChgMovesAbilities chgEv(StringList _moves, StringList _abilities) {
        BeanChgMovesAbilities k_ = new BeanChgMovesAbilities();
        k_.valEvo(new MovesAbilities(_moves, _abilities));
        return k_;
    }

    private static IntBeanChgAnticipation chgAnt(long _v, boolean _en, Rate _d, int _t, int _p) {
        BeanChgAnticipation k_ = new BeanChgAnticipation();
        Anticipation v_ = new Anticipation();
        v_.setDamage(_d);
        v_.setTargetPosition(new TargetCoords(_t, _p));
        v_.setIncrementing(_en);
        v_.setNbRounds(_v);
        k_.valueAnt(v_);
        return k_;
    }

    private static IntBeanChgStackOfUses chgStack(boolean _f, boolean _l,long _v) {
        BeanChgStackOfUses k_ = new BeanChgStackOfUses();
        StacksOfUses v_ = new StacksOfUses();
        v_.setFirstStacked(_f);
        v_.setLastStacked(_l);
        v_.setNbRounds(_v);
        k_.valueStack(v_);
        return k_;
    }
    ...
    private static IntBeanChgLgInt chgLgInt(LgInt _v) {
        IntBeanChgLgInt k_ = new BeanChgLgInt();
        k_.valueLgInt(_v);
        return k_;
    }

    private static IntBeanChgRate chgRate(Rate _v) {
        IntBeanChgRate k_ = new BeanChgRate();
        k_.valueRate(_v);
        return k_;
    }

    private static IntBeanChgBool chgBool(boolean _v) {
        IntBeanChgBool k_ = new BeanChgBool();
        k_.setSelected(_v);
        return k_;
    }
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsLowProt() {
        FacadeGame db_ = dbInc();
        StatusMoveData status_ = Instances.newStatusMoveData();
        status_.getEffects().add(Instances.newEffectProtectFromTypes());
        db_.getData().completeMembers(M_POK_07, status_);
        db_.getData().getTranslatedMoves().getVal(EN).addEntry(M_POK_07, M_POK_07_TR);
        db_.getData().completeVariables();
        db_.getData().completeMembersCombos();
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsLowUnProt() {
        FacadeGame db_ = dbInc();
        StatusMoveData status_ = Instances.newStatusMoveData();
        status_.getEffects().add(Instances.newEffectUnprotectFromTypes());
        db_.getData().completeMembers(M_POK_07, status_);
        db_.getData().getTranslatedMoves().getVal(EN).addEntry(M_POK_07, M_POK_07_TR);
        db_.getData().completeVariables();
        db_.getData().completeMembersCombos();
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsLowSwMvTy() {
        FacadeGame db_ = dbInc();
        StatusMoveData status_ = Instances.newStatusMoveData();
        status_.getEffects().add(Instances.newEffectSwitchMoveTypes());
        db_.getData().completeMembers(M_POK_07, status_);
        db_.getData().getTranslatedMoves().getVal(EN).addEntry(M_POK_07, M_POK_07_TR);
        db_.getData().completeVariables();
        db_.getData().completeMembersCombos();
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsLowCount() {
        FacadeGame db_ = dbInc();
        StatusMoveData status_ = Instances.newStatusMoveData();
        status_.getEffects().add(Instances.newEffectCounterAttack());
        db_.getData().completeMembers(M_POK_07, status_);
        db_.getData().getTranslatedMoves().getVal(EN).addEntry(M_POK_07, M_POK_07_TR);
        db_.getData().completeVariables();
        db_.getData().completeMembersCombos();
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsLowInd() {
        FacadeGame db_ = dbInc();
        StatusMoveData status_ = Instances.newStatusMoveData();
        status_.getEffects().add(Instances.newEffectEndRoundIndividual());
        db_.getData().completeMembers(M_POK_07, status_);
        db_.getData().getTranslatedMoves().getVal(EN).addEntry(M_POK_07, M_POK_07_TR);
        db_.getData().completeVariables();
        db_.getData().completeMembersCombos();
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsLowCst() {
        FacadeGame db_ = dbInc();
        DamagingMoveData status_ = power(T_SIM_1, C_SIM_1, "10");
        status_.setConstUserChoice(true);
        status_.getRepeatRoundLaw().addEvent(Rate.one(),LgInt.one());
        db_.getData().completeMembers(M_POK_07, status_);
        db_.getData().getTranslatedMoves().getVal(EN).addEntry(M_POK_07, M_POK_07_TR);
        db_.getData().completeVariables();
        db_.getData().completeMembersCombos();
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsLowAct() {
        FacadeGame db_ = dbInc();
        StatusMoveData status_ = Instances.newStatusMoveData();
        EffectRestriction eff_ = Instances.newEffectRestriction();
        eff_.setChoiceRestriction(MoveChoiceRestrictionType.DER);
        status_.getEffects().add(eff_);
        db_.getData().completeMembers(M_POK_07, status_);
        StatusMoveData status2_ = Instances.newStatusMoveData();
        EffectRestriction eff2_ = Instances.newEffectRestriction();
        eff2_.setChoiceRestriction(MoveChoiceRestrictionType.DER);
        status2_.getEffects().add(eff2_);
        status2_.getRepeatRoundLaw().addEvent(Rate.one(),LgInt.one());
        db_.getData().completeMembers(M_POK_08, status2_);
        db_.getData().getTranslatedMoves().getVal(EN).addEntry(M_POK_07, M_POK_07_TR);
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsNbUsesRound() {
        FacadeGame db_ = dbInc();
        DamagingMoveData mv_ = Instances.newDamagingMoveData();
        EffectDamage eff_ = Instances.newEffectDamage();
        eff_.setPower(MessagesDataBaseConstants.VAR_DEF+DataBase.SEP_BETWEEN_KEYS+MessagesDataBaseConstants.DEF_NB_UTILI_ATT_EQ_TOUR+DataBase.SEP_BETWEEN_KEYS+M_POK_07);
        mv_.getEffects().add(eff_);
        db_.getData().completeMembers(M_POK_07,mv_);
        db_.getData().getTranslatedMoves().getVal(EN).addEntry(M_POK_07, M_POK_07_TR);
        db_.getData().completeVariables();
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsTeamEnabled() {
        FacadeGame db_ = dbInc();
        StatusMoveData mv_ = Instances.newStatusMoveData();
        mv_.getEffects().add(Instances.newEffectTeam());
        db_.getData().completeMembers(M_POK_07,mv_);
        db_.getData().getTranslatedMoves().getVal(EN).addEntry(M_POK_07, M_POK_07_TR);
        db_.getData().completeVariables();
        db_.getData().completeMembersCombos();
    ...
    protected static SimulationBean editEditSelectedPlayerPkSimuStepsSendingFoe() {
        FacadeGame db_ = dbInc();
        StatusMoveData mv_ = Instances.newStatusMoveData();
        mv_.getEffects().add(Instances.newEffectTeamWhileSendFoe());
        db_.getData().completeMembers(M_POK_07,mv_);
        db_.getData().getTranslatedMoves().getVal(EN).addEntry(M_POK_07, M_POK_07_TR);
        db_.getData().completeVariables();
        db_.getData().completeMembersCombos();
...
//        s_.build(_stds.getDataBase(), s_.getForms());
    ...
    public static CommonBean transitSimuQuick(IntBeanAction _caller, IntBeanBuilderHelper _builder) {
        String url_ = _caller.actionBean();
        _builder.build(url_);
        _builder.build(CommonBean.REN_ADD_WEB_HTML_SIMULATION_SIMULATION_HTML);
//        NaSt dest_ = _all.getVal(_mapping.getVal(url_));
//        setFormsBy((CommonBean) ((PokemonBeanStruct)dest_).getBean(),_caller.getBean());
//        CommonBean s_ = (CommonBean) ((BeanStruct) dest_).getBean();
//        s_.build(_stds.getDataBase(), s_.getForms());
        return (CommonBean) _builder.getRenders().getVal(CommonBean.REN_ADD_WEB_HTML_SIMULATION_SIMULATION_HTML);// _all.getVal(_mapping.getVal(url_));
    }

    public static CommonBean transitSimuQuickChg(IntBeanAction _caller, IntBeanBuilderHelper _builder) {
//        String url_ = _caller.actionBean();
//        _builder.build(url_);
        _builder.build(_caller);
//        NaSt dest_ = _all.getVal(_mapping.getVal(url_));
//        setFormsBy((CommonBean) ((PokemonBeanStruct)dest_).getBean(),_caller.getBean());
//        CommonBean s_ = (CommonBean) ((BeanStruct) dest_).getBean();
//        s_.build(_stds.getDataBase(), s_.getForms());
