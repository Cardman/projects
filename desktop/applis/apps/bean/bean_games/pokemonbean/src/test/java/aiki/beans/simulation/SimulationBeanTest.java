...
//    }
    ...
    public void simuSteps0() {
        ...
        assertEq(2,editEditSelectedPlayerPkSimuStepsNbKoRound());
        assertEq(2,editEditSelectedPlayerPkSimuStepsNbKoPreviousRound());
        assertEq(1,editEditSelectedPlayerPkSimuStepsSuccessfulMovesRound(M_POK_07).size());
        assertEq(M_POK_07,editEditSelectedPlayerPkSimuStepsSuccessfulMovesRound(M_POK_07).get(0));
        assertEq(1,editEditSelectedPlayerPkSimuStepsNbUsesMoves().size());
        assertEq(M_POK_07,editEditSelectedPlayerPkSimuStepsNbUsesMoves().getKey(0));
        assertEq(2,editEditSelectedPlayerPkSimuStepsNbUsesMoves().getValue(0));
        assertEq(1,editEditSelectedPlayerPkSimuStepsNbUsesMovesRound().size());
        assertEq(M_POK_07,editEditSelectedPlayerPkSimuStepsNbUsesMovesRound().getKey(0));
        assertEq(2,editEditSelectedPlayerPkSimuStepsNbUsesMovesRound().getValue(0));
        ...
        assertEq(1,editEditSelectedPlayerPkSimuStepsEnabledMovesWhileSendingFoe(false).size());
        assertEq(BoolVal.FALSE,editEditSelectedPlayerPkSimuStepsEnabledMovesWhileSendingFoe(false).getVal(M_POK_07));
        assertEq(1,editEditSelectedPlayerPkSimuStepsEnabledMovesWhileSendingFoe(true).size());
        assertEq(BoolVal.TRUE,editEditSelectedPlayerPkSimuStepsEnabledMovesWhileSendingFoe(true).getVal(M_POK_07));
        assertEq(1,editEditSelectedPlayerPkSimuStepsEnabledMovesWhileSendingFoeUses().size());
        assertEq(new LgInt(2),editEditSelectedPlayerPkSimuStepsEnabledMovesWhileSendingFoeUses().getVal(M_POK_07));
