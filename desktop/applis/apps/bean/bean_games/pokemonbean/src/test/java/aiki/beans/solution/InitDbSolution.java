...
public abstract class InitDbSolution extends InitDbConstr {
    ...
    public static final String IMG_OTHER = "AAAB////";
...
//        _facade.getData().getPeople().addEntry(NULL_REF,BaseSixtyFourUtil.getImageByString("AAAB////"));
        _facade.getData().getImages().addEntry(NULL_REF,getImageByString(IMG_OTHER));
        _facade.getData().getLinks().addEntry(NULL_REF,getImageByString(IMG_OTHER));
        _facade.getData().setImageTmHm(getImageByString(IMG_OTHER));
