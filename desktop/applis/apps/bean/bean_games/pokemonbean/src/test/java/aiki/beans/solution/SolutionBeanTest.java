...
public final class SolutionBeanTest extends InitDbSolution {
    ...
    public void getImage1() {
        assertEq("AAABAAAA", callWildPokemonDtoImageGet(elt(second(elt(callStepDtoGetPokemon(elt(callSolutionBeanStepsGet(),0)),0)),0)));
    }
    @Test
    public void getImage2() {
        assertEq("AAABAAAC", callWildPokemonDtoImageGet(elt(second(elt(callStepDtoGetPokemon(elt(callSolutionBeanStepsGet(),1)),0)),0)));
    }
    @Test
    public void getImage3() {
        assertEq("AAABAAAE", callWildPokemonDtoImageGet(elt(second(elt(callStepDtoGetPokemon(elt(callSolutionBeanStepsGet(),3)),0)),0)));
    }
    @Test
    public void getImage4() {
        assertEq("AAABAAAF", callWildPokemonDtoImageGet(elt(second(elt(callStepDtoGetPokemon(elt(callSolutionBeanStepsGet(),3)),1)),0)));
    }
    @Test
