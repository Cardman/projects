...
public final class RateValidatorTest extends BeanPokemonCommonTs {
    @Test
    ...
    public void validate4() {
        Message message_ = validate("0");
        assertEq("",message_.getContent());
        assertEq(1,message_.getArgs().size());
        assertEq("0",message_.getArgs().get(0));
    }
    @Test
    ...
    private Message validate(StringList _v) {
        return new RateValidator().validate(_v);
    }
}
