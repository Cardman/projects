...
public final class ShortValidatorTest extends BeanPokemonCommonTs {
    @Test
    ...
    public void validate4() {
        Message message_ = validate("-123456789");
        assertEq("",message_.getContent());
        assertEq(1,message_.getArgs().size());
        assertEq("-123456789",message_.getArgs().get(0));
    }
    @Test
    ...
    private Message validate(StringList _v) {
        return new ShortValidator().validate(_v);
    }
}
