...
public final class RulesPresidentBeanTest extends BeanPresidentCommonTs {
    ...
    public void init() {
        ...
        NativeConfigurationLoader nat_ = new NativeConfigurationLoader(stds_, new RulesPresidentLoader());
        ...
        StringMap<Document> docs_ = NatDualConfigurationContext.docs(PagesPresidents.buildRules(),"");
