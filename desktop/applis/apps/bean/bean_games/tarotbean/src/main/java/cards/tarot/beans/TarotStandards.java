...
public final class TarotStandards extends BeanNatLgNames {
    ...
    public void buildOther() {
        ...
        std_ = new SpecialNatClass(TYPE_TAROT_BEAN, fields_, constructors_, methods_, TYPE_BEAN, MethodModifier.ABSTRACT);
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_RATE, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        std_.getDirectInterfaces().add(TYPE_DISPLAYABLE);
        getStandards().addEntry(TYPE_RATE, std_);
        fields_ = new CustList<StandardField>();
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_BID_TAROT, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        std_.getDirectInterfaces().add(TYPE_DISPLAYABLE);
        getStandards().addEntry(TYPE_BID_TAROT, std_);
        fields_ = new CustList<StandardField>();
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_DETAILS_RESULTS_TAROT_BEAN, fields_, constructors_, methods_, TYPE_TAROT_BEAN, MethodModifier.NORMAL);
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_SUM_DECLARING_PLAYER, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_SCORES_PLAYERS, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        fields_.add( new StandardField(NICKNAME, getAliasString(), false, false, std_));
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_RANKING_PLAYER_VARIANT_GAME, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        fields_.add( new StandardField(NICKNAME, getAliasString(), false, false, std_));
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_POINTS_PLAYER_VARIANT_GAME, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        fields_.add( new StandardField(NICKNAME, getAliasString(), false, false, std_));
        fields_.add( new StandardField(RATE, getPrimInt(), false, false, std_));
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_BONUSES_PLAYERS, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        fields_.add( new StandardField(NICKNAME, getAliasString(), false, false, std_));
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_RESULTS_TAROT_BEAN, fields_, constructors_, methods_, TYPE_TAROT_BEAN, MethodModifier.NORMAL);
        params_ = new StringList();
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_LINE_DEAL, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_RULES_TAROT_BEAN, fields_, constructors_, methods_, TYPE_TAROT_BEAN, MethodModifier.NORMAL);
        ...
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_RESULTS_TAROT, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
        getStandards().addEntry(TYPE_RESULTS_TAROT, std_);
        fields_ = new CustList<StandardField>();
        constructors_ = new CustList<StandardConstructor>();
        methods_ = new CustList<StandardMethod>();
        std_ = new SpecialNatClass(TYPE_RULES_TAROT, fields_, constructors_, methods_, getAliasObject(), MethodModifier.NORMAL);
