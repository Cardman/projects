...
public final class TarotStandards extends BeanNatLgNames {
    ...
    public void buildOther() {
        ...
        fields_.add( new StandardField(RATE, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(MULTIPLIED_TMP, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(SUM_PLAYERS, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(ADDITIONNAL_BONUSES_ATTACK, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(ADDITIONNAL_BONUSES_DEFENSE, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(DIFF_ATTACK_DEFENSE_BONUSES, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(BASE_POINTS, PRIM_INTEGER, false, false));
        ...
        fields_.add( new StandardField(SCORE, PRIM_INTEGER, false, false));
        ...
        fields_.add( new StandardField(NICKNAME, STRING, false, false));
        fields_.add( new StandardField(POSITION_DIFF, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(POSITION_OUDLERS, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(POSITION_CHARACTERS, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(POSITION_STRENGTH_CHARACTERS, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(FINAL_POSITION, PRIM_INTEGER, false, false));
        ...
        fields_.add( new StandardField(NICKNAME, STRING, false, false));
        fields_.add( new StandardField(RATE, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(MINIMUM_POINTS, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(SCORE, PRIM_INTEGER, false, false));
        ...
        fields_.add( new StandardField(NICKNAME, STRING, false, false));
        fields_.add( new StandardField(BONUS, PRIM_INTEGER, false, false));
        ...
        methods_.add( method_);
        fields_.add( new StandardField(NUMBER_OUDLERS_TAKER, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(NEEDLY_SCORES_TAKER, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(SCORE_TAKER, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(DIFFERENCE_SCORE_TAKER, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(ADDITIONNAL_BONUSES_ATTACK, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(ADDITIONNAL_BONUSES_DEFENSE, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(SCORE_TAKER_WITHOUT_DECLARING, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(MAX_DOUBLED_DIFFERENCE, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(MAX_DIFFERENCE, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(INITIAL_USER_POSITION, PRIM_INTEGER, false, false));
        fields_.add( new StandardField(FINAL_USER_POSITION, PRIM_INTEGER, false, false));
