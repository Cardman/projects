...
public final class HelpScriptPagesImgs {
    ...
    public static StringMap<StringMap<String>> ct(){
        StringMap<StringMap<String>> m = new StringMap<StringMap<String>>(new CollCapacity(71));
    ...
    public static StringMap<String> initAnaData(String _prop){
