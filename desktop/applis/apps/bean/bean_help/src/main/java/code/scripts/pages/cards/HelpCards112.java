...
final class HelpCards112 extends HelpCardsCommon{
private HelpCards112(){}
static String en(){
String e="";
e+=M_41_0+"=Save a deal (raccourci: CTRL + S):\n";
e+=M_41_1+"=The action of the sub menu \"Save a deal\" shows a dialog box.\n";
e+=M_41_2+"=This sub menu lets save a deal in progress as soon as possible.\n";
e+=M_41_3+"=The user can play this deal later. Besides, if the user plays a \"TriaCartes\", the user can save the deal in progress.\n";
e+=M_41_4+"=The dialog box set the relative path of the folder for saving regarding the deal in progress.\n";
e+=M_41_5+"=Files can be sorted:\n";
e+=M_41_6+"=by alphabetic order of name of file.\n";
e+=M_41_7+"=by order of modification date of file.\n";
e+=M_41_8+"=by order of size of file.\n";
e+=M_41_9+"=The user will not have to add the extension of the file after its name.\n";
e+=M_41_10+"=The user, for saving the deal, after typing a name, will be able to click either the button \"Save\", or press the key \"Enter\".\n";
e+=M_41_11+"=The button \"Cancel\" lets close the dialog box.\n";
e+=M_41_12+"=If the user tries to use the characters &lt; &gt; ? \" * / \\ | : ., the line return, the tabulations, then an error message appears.\n";
e+=M_41_13+"=If the user tries to create a save file containing only spaces (With Windows), then an error message appears.\n";
e+=M_41_14+"=If the user tries to save a deal in a deal whose name already exists, then a warning message appears.\n";
return e;
}
static String fr(){
String f="";
