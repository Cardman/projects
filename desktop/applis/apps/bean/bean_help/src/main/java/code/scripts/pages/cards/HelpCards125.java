...
final class HelpCards125 extends HelpCardsCommon{
private HelpCards125(){}
static String en(){
String e="";
e+=M_54_0+"=\"Help for deal\" Shortcut F2\n";
e+=M_54_1+"=Acting the sub menu \"Help for deal\" lets have the set of played cards, the set of possible repartition of cards for the other players, and the set of cards surely owned by the other players, in function by rules of games, for games with different players.\n";
e+=M_54_2+"=This action opens a dialog box.\n";
e+=M_54_3+"=This dialog box introduces the set of the possibilitie of owning cards by players.\n";
e+=M_54_4+"=The letter P, behind a name of card, means this card is possibly owned by this player.\n";
e+=M_54_5+"=The letter C, behind a name of card, means this card is surely owned by this player.\n";
e+=M_54_6+"=The letter J, behind a name of card, means this card is already played.\n";
e+=M_54_7+"=If none of the two letters is behind a name of card, then this card is played (discarded in the dog, if taker at tarot; or in a trick) or owned by the user.\n";
return e;
}
static String fr(){
String f="";
