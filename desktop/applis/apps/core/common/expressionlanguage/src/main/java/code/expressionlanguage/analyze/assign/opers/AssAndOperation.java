...
public final class AssAndOperation extends AssMultMethodOperation {
    AssAndOperation(OperationNode _ex) {
        super(_ex);
    }
    ...
    public void analyzeAssignmentBeforeNextSibling(AssBlock _ass, AssignedVariablesBlock _a, AssOperationNode _nextSibling, AssOperationNode _previous) {
        analyzeTrueAssignmentBeforeNextSibling(_ass,_a, _nextSibling, _previous);
    }
