...
public abstract class NamedCalledFunctionBlock extends NamedFunctionBlock {
    protected NamedCalledFunctionBlock(boolean _retRef, OffsetAccessInfo _access, OffsetStringInfo _retType, OffsetStringInfo _fctName, StringList _paramTypes, Ints _paramTypesOffset, StringList _paramNames, Ints _paramNamesOffset, OffsetsBlock _offset, BooleanList _refParams) {
