...
public final class ChoiceFctOperation extends InvokingOperation {
    ...
    public void analyze(ContextEl _conf) {
        ...
        ClassMethodIdReturn clMeth_ = getDeclaredCustMethod(this,_conf, varargOnly_, isStaticAccess(), bounds_, trimMeth_, false, false, import_, feed_,varargParam_,ClassArgumentMatching.toArgArray(firstArgs_));
