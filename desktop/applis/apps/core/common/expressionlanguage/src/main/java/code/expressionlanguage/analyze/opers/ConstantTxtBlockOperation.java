...
public final class ConstantTxtBlockOperation extends ConstantOperation {

    private final TextBlockInfo textInfo;

    public ConstantTxtBlockOperation(int _index, int _indexChild, MethodOperation _m, OperationsSequence _op) {
        super(_index, _indexChild, _m, _op);
        textInfo = _op.getTextInfo();
    }
    ...
    public void analyze(AnalyzedPageEl _page) {
        ...
        if (textInfo.isKo()) {
            ...
            //constant len
            badFormat_.buildError(_page.getAnalysisMessages().getBadCharFormat(),textInfo.getFound());
