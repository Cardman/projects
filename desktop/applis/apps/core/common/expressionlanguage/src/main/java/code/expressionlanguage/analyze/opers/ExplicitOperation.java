...
public final class ExplicitOperation extends AbstractUnaryOperation {
    ...
    public void analyzeUnary(AnalyzedPageEl _page) {
        ...
        args_.add(resultClass_);
        AnaClassArgumentMatching[] argsClass_ = OperationNode.toArgArray(args_);
        ClassMethodIdReturn resMethod_ = tryGetCast(explicitContent.getClassName(), null, argsClass_, _page, _page.getExplicitCastMethods(), _page.getExplicitIdCastMethods(), _page.getExplicitFromCastMethods());
        if (resMethod_ == null) {
            return;
        }
        memberId = resMethod_.getMemberId();
