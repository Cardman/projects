...
public final class LambdaPartTypeId extends AbsLambdaPartTypeImpl {
    ...
    public LambdaPartTypeId(String _cl, CustList<AnaResultPartTypeDtoInt> _parts, String _fromType) {
        super(_cl,_parts);
        from = _fromType;
    }
    ...
    public String resolve(boolean _wrap, int _offset, String _in, AnalyzedPageEl _page) {
        ...
        getPartOffsets().add(new AnaResultPartTypeDirectDto(resolved_));
