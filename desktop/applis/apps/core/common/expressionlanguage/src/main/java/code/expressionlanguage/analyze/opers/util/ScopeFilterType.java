...
public final class ScopeFilterType {
    ...
    public ScopeFilterType(ScopeFilter _scope,MethodAccessKind _kind, int _anc, StringList _superTypesBase, StringMap<String> _superTypesBaseAncBis, String _formatted, String _fullName) {
