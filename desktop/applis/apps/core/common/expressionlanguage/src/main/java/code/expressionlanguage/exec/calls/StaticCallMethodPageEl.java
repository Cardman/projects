...
public final class StaticCallMethodPageEl extends AbstractRefectMethodPageEl {
    ...
    public StaticCallMethodPageEl(Argument _instance, Argument _array, MethodMetaInfo _metaInfo, boolean _refer) {
    ...
    Argument prepare(ContextEl _context, ArrayStruct _args, Argument _right, StackCall _stack) {
        ...
        if (callee_ instanceof ExecAbstractSwitchMethod) {
            ab_ = new SwitchParamChecker((ExecAbstractSwitchMethod) callee_, _args.listArgs(), MethodAccessKind.STATIC_CALL);
        } else {
            ab_ = new ReflectStaticCallParamChecker(pair_, _args, isRef());
        }
