...
public final class StaticCallMethodPageEl extends AbstractRefectMethodPageEl {
    ...
    Argument prepare(ContextEl _context, String _className, MethodId _mid, Argument _instance, CustList<Argument> _args, Argument _right, StackCall _stack) {
        ...
        return prepareStaticCall(getPair(),method_.getCache(),_args,res_, _context, _stack);
    }
    private static Argument prepareStaticCall(ExecTypeFunction _pair, Cache _cache, CustList<Argument> _arguments, String _className,
        ...
        return checkStaticCall(_pair,_cache, _arguments, _className, _conf, _stackCall);
    }
