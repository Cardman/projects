...
public final class OperNatPointBlockPair implements AbsPairPoint {
    ...
    public OperNatPointBlockPair(String _k, String _symbol, AbstractInterceptorStdCaller _v, boolean _enabled, String _f, String _s, boolean _enableComp) {
        this.on = new OperNatPointBlockKey(_k, _f, _s);
        this.symbol = _symbol;
        this.value = new OperNatPoint(_v, this, getOn(), _enableComp);
