...
public final class ExecAnonymousLambdaOperation extends ExecAbstractLambdaOperation {
    ...
    public Struct newAnonymousLambda(CallersInfo _info, ExecLambdaCommonContent _common, ExecLambdaMethodContent _anonCont, Struct _previous,
    ...
    public static LambdaMethodStruct newAnonymousLambda(CallersInfo _info, ExecLambdaCommonContent _common, ExecLambdaMethodContent _anonCont, Struct _previous, PageElContent _lastPage, String _clArg) {
    ...
    public void calculate(IdMap<ExecOperationNode, ArgumentsPair> _nodes, ContextEl _conf, StackCall _stack) {
        ...
        Struct res_ = newAnonymousLambda(format(lambdaAnoContent,_stack),getLambdaCommonContent(),lambdaAnoContent,previous_,
