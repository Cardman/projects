...
public final class ExecChoiceFctOperation extends ExecSettableCallFctOperation {
    ...
    public void calculate(IdMap<ExecOperationNode, ArgumentsPair> _nodes,
        ...
        if (_conf.callsOrException(_stack)) {
            ...
            res_ = callPrepare(_conf, classNameFound_, pair, prev_, null, fetchFormattedArgs(_nodes, _conf, prev_.getStruct(), getClassName(), pair.getType(), instFctContent.getLastType(), instFctContent.getNaturalVararg()), null, MethodAccessKind.INSTANCE, _stack);
        }
