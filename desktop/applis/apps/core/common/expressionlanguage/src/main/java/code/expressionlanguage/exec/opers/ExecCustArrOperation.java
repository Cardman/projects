...
public final class ExecCustArrOperation extends ExecInvokingOperation implements ExecSettableElResult {
    ...
    public void calculate(IdMap<ExecOperationNode, ArgumentsPair> _nodes, ContextEl _conf, StackCall _stack) {
        ...
        Argument res_ = getArgument(this,_conf, _stack,readWrite.getRead(),readWrite.getInstRead(),ArgumentListCall.wrapCall(argumentListCall_.getArgumentWrappers(),null), parent_);
    ...
    public Argument calculateSetting(IdMap<ExecOperationNode, ArgumentsPair> _nodes, ContextEl _conf, Argument _right, StackCall _stack) {
        ...
        return getArgument(this,_conf, _stack,readWrite.getWrite(),readWrite.getInstWrite(),ArgumentListCall.wrapCall(argumentList_,_right), par_.getStruct());
    }
    ...
    static Argument getArgument(ExecOperationNode _me, ContextEl _conf, StackCall _stackCall, ExecTypeFunction _fctUse, ExecInstFctContent _insUse, ArgumentListCall _call, Struct _parent) {
        if (_conf.callsOrException(_stackCall)) {
            return new Argument();
        }
        _me.setRelativeOffsetPossibleLastPage(_stackCall);
        return redirect(_conf, _stackCall, _fctUse,_insUse, _parent,_call);
    }

    public static Argument redirect(ContextEl _conf, StackCall _stackCall, ExecTypeFunction _fctUse, ExecInstFctContent _insUse, Struct _parent, ArgumentListCall _call) {
        ExecTypeFunction fct_ = _fctUse;
        Argument prev_ = new Argument(_parent);
        Struct pr_ = prev_.getStruct();
        ExecOverrideInfo polymorph_ = polymorphOrSuper(_insUse.isStaticChoiceMethod(), _conf,pr_, _insUse.getFormattedType(),fct_);
