...
public final class ExecDirectStandardInstancingOperation extends
    ...
    public void calculate(IdMap<ExecOperationNode, ArgumentsPair> _nodes, ContextEl _conf, StackCall _stack) {
        ...
        Argument res_ = instancePrepareStd(_conf, instancingCommonContent.getConstId(), fectchArgs(_nodes, instancingCommonContent.getLastType(), instancingCommonContent.getNaturalVararg()), _stack);
