...
public final class ExecImplicitOperation extends ExecAbstractUnaryOperation {
    ...
    public ExecImplicitOperation(ImplicitOperation _a, ExecNamedFunctionBlock _named) {
        super(_a);
    ...
    public void calculate(IdMap<ExecOperationNode, ArgumentsPair> _nodes, ContextEl _conf) {
        ...
        Argument argres_ =  ExecExplicitOperation.prepare(new DefaultExiting(_conf),false,named,arguments_,className,classNameOwner,_conf.getLastPage(),_conf);
