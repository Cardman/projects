...
public final class ExecInterfaceInvokingConstructor extends ExecAbstractInvokingConstructor {
    ...
    public void calculate(IdMap<ExecOperationNode, ArgumentsPair> _nodes,
        ...
        checkParametersCtors(_conf, superClass_, getPair(), fectchArgs(lastType_, getNaturalVararg(),null,_conf,_stack, buildInfos(_nodes)), InstancingStep.USING_SUPER, _stack);
