...
public final class ExecOrOperation extends ExecQuickOperation {
    ...
    public ExecOrOperation(ExecOperationContent _opCont, ExecStaticEltContent _staticEltContent, ExecNamedFunctionBlock _named, ExecRootBlock _rootBlock, ImplicitMethods _converter) {
