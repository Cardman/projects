...
public final class ExecOrOperation extends ExecQuickOperation {
    ...
    public ExecOrOperation(ExecOperationContent _opCont, ExecStaticEltContent _staticEltContent, ExecTypeFunction _pair, ImplicitMethods _converter, int _opOffset) {
