...
public final class FctAnnotatedGetAnnotations1 extends FctReflection {
    ...
    public ArgumentWrapper call(AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        _stackCall.setCallingState(new CustomReflectAnnotations(ReflectingType.ANNOTATION, annotated_, new CustList<Struct>(_firstArgs.getArgumentWrappers().get(0).getValue())));
