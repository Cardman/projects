...
public final class FctMathBinQuot implements AnaStdCaller {
    private final byte wrap;

    public FctMathBinQuot(byte _wrap) {
        this.wrap = _wrap;
    }

    @Override
    public Struct call(AnalyzedPageEl _page, Struct _instance, Struct[] _args) {
        return binQuot(_args[0], _args[1]);
    }
    ...
    private Struct binQuot(Struct _one, Struct _two) {
        Struct arg_ = NumParsers.calculateDiv(NumParsers.convertToNumber(_one), NumParsers.convertToNumber(_two), wrap);
