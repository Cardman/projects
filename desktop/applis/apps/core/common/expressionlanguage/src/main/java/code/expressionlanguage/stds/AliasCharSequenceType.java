...
public final class AliasCharSequenceType {
    ...
    private StandardType chTypeType(LgNames _lgNames) {
        ...
        StandardNamedFunction.addFct(methods_, method_);
        StandardType.addType(standards_, aliasCharSequence, std_);
        return std_;
    }
    private void strType(LgNames _lgNames, StandardType _t) {
        ...
        StandardType.addType(standards_, aliasString, std_);
    }
    private void strBuildType(LgNames _lgNames, StandardType _t) {
        ...
        StandardNamedFunction.addFct(constructors_, ctor_);
        std_.getDirectInterfaces().add(aliasCharSequence);
        StandardType.addType(standards_, aliasStringBuilder, std_);
    }
    public void build(LgNames _lgNames) {
        ...
        StandardNamedFunction.addFct(constructors_, ctor_);
        StandardType.addType(standards_, aliasReplacement, std_);
    }
