...
public final class AliasCore {
    ...
    public void build(LgNames _lgNames) {
        ...
        method_ = new StandardMethod(_lgNames.getAliasCurrentStack(), params_, stackElt_, false, MethodModifier.NORMAL);
        ...
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasGetCause, params_, _lgNames.getAliasObject(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        std_ = stdcl_;
