...
public final class AliasReflection {
    ...
    private void buildAnnotatedCl(LgNames _stds) {
        ...
        StandardNamedFunction.addFct(methods_, method_);
        StandardType.addType(_stds.getStandards(), aliasClassType, stdcl_);
    }
    private void buildAnnotatedCtor(LgNames _stds) {
        ...
        StandardNamedFunction.addFct(methods_, method_);
        StandardType.addType(_stds.getStandards(), aliasConstructor, stdcl_);
    }
    private void buildAnnotatedField(LgNames _stds) {
        ...
        StandardNamedFunction.addFct(methods_, method_);
        StandardType.addType(_stds.getStandards(), aliasField, stdcl_);
    }
    private void buildAnnotatedMethod(LgNames _stds) {
        ...
        StandardNamedFunction.addFct(methods_, method_);
        StandardType.addType(_stds.getStandards(), aliasMethod, stdcl_);
    }
    public void build(LgNames _stds) {
        ...
        fctType = stdcl_;
        StandardType.addType(_stds.getStandards(), aliasFct, stdcl_);
        ...
        stdcl_.addSuperStdTypes(_stds.getCoreNames().getObjType());
        StandardType.addType(_stds.getStandards(), aliasInvokeTarget, stdcl_);
        methods_ = new CustList<StandardMethod>();
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<CstFieldInfo>();
        ...
        stdcl_.addSuperStdTypes(_stds.getCoreNames().getErrType());
        stdcl_.addSuperStdTypes(_stds.getCoreNames().getObjType());
        StandardType.addType(_stds.getStandards(), aliasClassNotFoundError, stdcl_);
        methods_ = new CustList<StandardMethod>();
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new CustList<CstFieldInfo>();
        ...
        StandardNamedFunction.addFct(methods_, method_);
        StandardType.addType(_stds.getStandards(), aliasAnnotationType, stdcl_);
    }
