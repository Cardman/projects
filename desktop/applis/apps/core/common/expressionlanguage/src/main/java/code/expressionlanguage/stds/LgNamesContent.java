...
public final class LgNamesContent {
    ...
    public void build(StringMap<String> _util, StringMap<String> _cust) {
        ...
        getMathRef().getParams().setAliasMath2Abs0(get(_util,_cust, AliasParamMath.MATH_2_ABS_0));
        getMathRef().getParams().setAliasMath3Abs0(get(_util,_cust, AliasParamMath.MATH_3_ABS_0));
        ...
        getMathRef().getParams().setAliasMath2Max0(get(_util,_cust, AliasParamMath.MATH_2_MAX_0));
        getMathRef().getParams().setAliasMath2Max1(get(_util,_cust, AliasParamMath.MATH_2_MAX_1));
        getMathRef().getParams().setAliasMath3Max0(get(_util,_cust, AliasParamMath.MATH_3_MAX_0));
        getMathRef().getParams().setAliasMath3Max1(get(_util,_cust, AliasParamMath.MATH_3_MAX_1));
        getMathRef().getParams().setAliasMath2Min0(get(_util,_cust, AliasParamMath.MATH_2_MIN_0));
        getMathRef().getParams().setAliasMath2Min1(get(_util,_cust, AliasParamMath.MATH_2_MIN_1));
        getMathRef().getParams().setAliasMath3Min0(get(_util,_cust, AliasParamMath.MATH_3_MIN_0));
        getMathRef().getParams().setAliasMath3Min1(get(_util,_cust, AliasParamMath.MATH_3_MIN_1));
    ...
    public StringMap<String> allRefTypes() {
        ...
        list_.addEntry(RANGE, getCoreNames().getAliasRange());
    ...
    public CustList<CustList<KeyValueMemberName>> allTableTypeMethodParamNames() {
        ...
        map_.add(new CustList<KeyValueMemberName>(new KeyValueMemberName(AliasParamMath.MATH_2_ABS_0, getMathRef().getParams().getAliasMath2Abs0())));
        map_.add(new CustList<KeyValueMemberName>(new KeyValueMemberName(AliasParamMath.MATH_3_ABS_0, getMathRef().getParams().getAliasMath3Abs0())));
        ...
        map_.add(new CustList<KeyValueMemberName>(new KeyValueMemberName(AliasParamMath.MATH_2_MAX_0, getMathRef().getParams().getAliasMath2Max0()),new KeyValueMemberName(AliasParamMath.MATH_2_MAX_1, getMathRef().getParams().getAliasMath2Max1())));
        map_.add(new CustList<KeyValueMemberName>(new KeyValueMemberName(AliasParamMath.MATH_3_MAX_0, getMathRef().getParams().getAliasMath3Max0()),new KeyValueMemberName(AliasParamMath.MATH_3_MAX_1, getMathRef().getParams().getAliasMath3Max1())));
        map_.add(new CustList<KeyValueMemberName>(new KeyValueMemberName(AliasParamMath.MATH_2_MIN_0, getMathRef().getParams().getAliasMath2Min0()),new KeyValueMemberName(AliasParamMath.MATH_2_MIN_1, getMathRef().getParams().getAliasMath2Min1())));
        map_.add(new CustList<KeyValueMemberName>(new KeyValueMemberName(AliasParamMath.MATH_3_MIN_0, getMathRef().getParams().getAliasMath3Min0()),new KeyValueMemberName(AliasParamMath.MATH_3_MIN_1, getMathRef().getParams().getAliasMath3Min1())));
