...
public final class FileResolverTest extends ProcessMethodCommon {
    ...
    public void parseFile4Test() {
        ...
        assertEq("pkgthree.Inherit", getDirectSuperTypes(r_).first().trim());
        assertEq(1, countFileTypes(context_));
    }
    @Test
    public void parseFile5Test() {
        ...
        assertEq("<#Param>",r_.getTemplateDef());
        assertEq(1, getDirectSuperTypes(r_).size());
        assertEq("pkgthree.Inherit<#Param>", getDirectSuperTypes(r_).first().trim());
        assertEq(1, countFileTypes(context_));
    }
    @Test
    public void parseFile6Test() {
        ...
        assertEq("pkgthree.Inherit<#Param>", getDirectSuperTypes(r_).first().trim());
        assertEq("pkgfour.Inherit<#SecondParam>", getDirectSuperTypes(r_).last().trim());
        assertEq(1, countFileTypes(context_));
    }
    @Test
    public void parseFile7Test() {
        ...
        assertEq(2, getDirectSuperTypes(r_).size());
        assertEq("pkgthree.Inherit<#T>", getDirectSuperTypes(r_).first().trim());
        assertEq("pkgfour.Inherit<#T>", getDirectSuperTypes(r_).last().trim());
    ...
    public void parseFile8Test() {
        ...
        assertEq("<#T>",r_.getTemplateDef());
        assertEq(2, getDirectSuperTypes(r_).size());
        assertEq("hello.word<#T>", getDirectSuperTypes(r_).first().trim());
        assertEq("every.body<#T>", getDirectSuperTypes(r_).last().trim());
        AbsBk child_ = cl_.getFirstChild();
        assertTrue(child_ instanceof FieldBlock);
        FieldBlock field_ = (FieldBlock) child_;
        assertTrue(!field_.isStaticField());
    ...
    public void parseFile9Test() {
        ...
        assertEq("hello.word<Ex>", getDirectSuperTypes(r_).first().trim());
        assertEq("every.body", getDirectSuperTypes(r_).get(1).trim());
        assertEq("java.lang.$Enum<pkgtwo.Toto>", getDirectSuperTypes(r_).last().trim());
        AbsBk child_ = cl_.getFirstChild();
    ...
    public void parseFile12Test() {
        ...
        assertEq("",r_.getTemplateDef());
        assertEq(3, getDirectSuperTypes(r_).size());
        assertEq("hello.word<pkgtwo.Inherit>", getDirectSuperTypes(r_).first().trim());
        assertEq("every.body<pkgtwo.Inherit>", getDirectSuperTypes(r_).get(1).trim());
        assertEq("java.lang.$Enum<pkgtwo.Toto>", getDirectSuperTypes(r_).last().trim());
        AbsBk child_ = cl_.getFirstChild();
        assertTrue(child_ instanceof ElementBlock);
    ...
    public void parseFile16Test() {
        ...
        assertEq("",r_.getTemplateDef());
        assertEq(3, getDirectSuperTypes(r_).size());
        assertEq("hello.word", getDirectSuperTypes(r_).first().trim());
        assertEq("every.body", getDirectSuperTypes(r_).get(1).trim());
        assertEq("java.lang.$Enum<pkgtwo.Toto>", getDirectSuperTypes(r_).last().trim());
        AbsBk child_ = cl_.getFirstChild();
        assertTrue(child_ instanceof ElementBlock);
    ...
    public void parseFile53Test() {
        ...
        assertEq("@MyAnnot", r_.getAnnotations().getAnnotations().first().getAnnotation());
        assertEq(19, r_.getAnnotations().getAnnotations().first().getIndex());
    }
    @Test
    public void parseFile54Test() {
        ...
        assertEq("1i,\n3i", ((ElementBlock)field_).getValue());
        assertEq(1, field_.getAnnotations().getAnnotations().size());
        assertEq("@MyAnnot", field_.getAnnotations().getAnnotations().first().getAnnotation());
        assertEq(126, field_.getAnnotations().getAnnotations().first().getIndex());
    ...
    public void parseFile55Test() {
        ...
        assertTrue(!field_.isFinalField());
        assertSame(AccessEnum.PRIVATE, field_.getAccess());
        assertEq(1, ((FieldBlock)child_).getAnnotations().getAnnotations().size());
        assertEq("@MyAnnot", ((FieldBlock)child_).getAnnotations().getAnnotations().first().getAnnotation());
        assertEq(73, ((FieldBlock)child_).getAnnotations().getAnnotations().first().getIndex());
    ...
    public void parseFile56Test() {
        ...
        assertTrue(!method_.isAbstractMethod());
        assertTrue(method_.isNormalMethod());
        assertEq(1, method_.getAnnotations().getAnnotations().size());
        assertEq("@MyAnnot", method_.getAnnotations().getAnnotations().first().getAnnotation());
        assertEq(73, method_.getAnnotations().getAnnotations().first().getIndex());
        assertSame(AccessEnum.PRIVATE, method_.getAccess());
    ...
    public void parseFile57Test() {
        ...
        assertEq(1, method_.getAnnotationsParams().first().getAnnotations().size());
        assertEq("@MyAnnotTwo", method_.getAnnotationsParams().first().getAnnotations().first().getAnnotation());
        assertEq(116, method_.getAnnotationsParams().first().getAnnotations().first().getIndex());
    ...
    public void parseFile59Test() {
        ...
        NamedCalledFunctionBlock method_ = (NamedCalledFunctionBlock) child_;
        assertEq(0, method_.getAnnotations().getAnnotations().size());
        assertSame(AccessEnum.PUBLIC, method_.getAccess());
        assertEq("exmethod", method_.getName());
    ...
    public void parseFile61Test() {
        ...
        assertEq(1, method_.getAnnotations().getAnnotations().size());
        assertEq("@MyAnnot", method_.getAnnotations().getAnnotations().first().getAnnotation());
        assertEq(78, method_.getAnnotations().getAnnotations().first().getIndex());
        assertNull(child_.getNextSibling());
        assertEq(0, method_.getParametersTypes().size());
        assertEq(0, method_.getParametersNames().size());
        assertEq(0, method_.getAnnotationsParams().size());
    ...
    public void parseFile65Test() {
        ...
        assertEq(1, ops_.size());
        OperatorBlock op_ = ops_.first();
        assertEq(1, op_.getAnnotations().getAnnotations().size());
        assertEq("@MyAnnot", op_.getAnnotations().getAnnotations().first().getAnnotation());
        assertEq(0, op_.getAnnotations().getAnnotations().first().getIndex());
        assertEq("+", op_.getName());
    ...
    public void parseFile66Test() {
        ...
        assertEq(1, op_.getAnnotationsParams().first().getAnnotations().size());
        assertEq("@MyAnnot", op_.getAnnotationsParams().first().getAnnotations().first().getAnnotation());
        assertEq(18, op_.getAnnotationsParams().first().getAnnotations().first().getIndex());
        assertEq(2, op_.getParametersTypes().size());
        assertEq("$int", op_.getParametersTypes().get(0));
        assertEq("$short", op_.getParametersTypes().get(1));
        assertEq(2, op_.getParametersNames().size());
    ...
    public void parseFile84Test() {
        ...
        assertEq("@MyAnnot", ((RootBlock)inner_).getAnnotations().getAnnotations().first().getAnnotation());
        assertEq(28, ((RootBlock)inner_).getAnnotations().getAnnotations().first().getIndex());
    ...
    public void parseFile95Test() {
        ...
        assertEq(2, getDirectSuperTypes(r_).size());
        assertEq("hello.word", getDirectSuperTypes(r_).first().trim());
        assertEq("every.body", getDirectSuperTypes(r_).last().trim());
        AbsBk child_ = cl_.getFirstChild();
        assertTrue(child_ instanceof FieldBlock);
        FieldBlock field_ = (FieldBlock) child_;
        assertTrue(!field_.isStaticField());
    ...
    public void endAll() {
        StringBuilder file_ = new StringBuilder();
        file_.append("$public $class pkgtwo.ExClass {\n");
        file_.append(" int field;\n");
        file_.append(" {\n");
        file_.append("  $if (t){\n");
        file_.append("   $return v;\n");
        file_.append("  }\n");
        file_.append("  $switch (t){\n");
        file_.append("   $case v;{\n");
        file_.append("    $return v;\n");
        file_.append("   }\n");
        file_.append("   $case w;\n");
        file_.append("    $return w;\n");
        file_.append("   $case x;\n");
        file_.append("   $case y;\n");
        file_.append("  }\n");
        file_.append(" }\n");
        file_.append(" $public $enum En1{\n");
        file_.append("  ONE,\n");
        file_.append("  TWO{},\n");
        file_.append("  THREE,\n");
        file_.append("  FOUR{};\n");
        ...
        file_.append("}\n");
        file_.append("\n");
        file_.append("$public $annotation pkgtwo.Annot{\n");
        file_.append(" $final $int v;\n");
        file_.append(" {\n");
        file_.append("  v=((int a:int)->a).call(0);\n");
        file_.append("  v=((int a:int)->{int b = a + 1;$return b;}).call(0);\n");
        file_.append(" }\n");
        file_.append(" $int one();\n");
        file_.append(" $int two();\n");
        file_.append("}\n");
        AnalyzedPageEl context_ = AnalyzedPageEl.setInnerAnalyzing();
        context_.setKeyWords(new KeyWords());
        context_.setStandards(getLgNames().getContent());
        context_.setOptions(new Options());
        context_.setAnalysisMessages(new AnalysisMessages());
        context_.setDefaultAccess(context_.getOptions().getDefaultAccess());
        StringMap<String> files_ = new StringMap<String>();
        files_.addEntry("my_file",file_.toString());
        StringBuilder file2_ = new StringBuilder();
        file2_.append("$public $class pkgtwo.ExClass2 {\n");
        file2_.append(" {\n");
        file2_.append("  $switch (t){\n");
        file2_.append("   $case w;\n");
        file2_.append("    $return w;\n");
        file2_.append("  }\n");
        file2_.append(" }\n");
        file2_.append("}\n");
        file2_.append("\n");
        files_.addEntry("my_file2",file2_.toString());
        StringBuilder file3_ = new StringBuilder();
        file3_.append("$public $class pkgtwo.ExClass3 {\n");
        file3_.append(" {\n");
        file3_.append("  v=$switch (t){\n");
        file3_.append("   $case w;\n");
        file3_.append("    $return w;\n");
        file3_.append("  };\n");
        file3_.append("  v=$new Type(t){\n");
        file3_.append("   m(){}\n");
        file3_.append("  };\n");
        file3_.append(" }\n");
        file3_.append("}\n");
        file3_.append("\n");
        files_.addEntry("my_file3",file3_.toString());
        StringBuilder file4_ = new StringBuilder();
        file4_.append("$public $class pkgtwo.ExClass4 {\n");
        file4_.append(" {\n");
        file4_.append("  $if (t);\n");
        file4_.append(" }\n");
        file4_.append("}\n");
        file4_.append("\n");
        files_.addEntry("my_file4",file4_.toString());
        ClassesUtil.buildFilesBodies(files_,false, context_);
        parseFiles(context_);
        AbsBk f_ = context_.getFilesBodies().getVal("my_file");
        AbsBk r_ = f_.getFirstChild();
        assertEq(297,r_.getEndAll());
        assertEq(43,r_.getFirstChild().getEndAll());
        assertEq(71,r_.getFirstChild().getNextSibling().getFirstChild().getFirstChild().getEndAll());
        assertEq(75,r_.getFirstChild().getNextSibling().getFirstChild().getEndAll());
        assertEq(118,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getFirstChild().getFirstChild().getEndAll());
        assertEq(123,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getFirstChild().getEndAll());
        assertEq(127,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getEndAll());
        assertEq(150,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getEndAll());
        assertEq(154,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getNextSibling().getEndAll());
        assertEq(166,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getNextSibling().getNextSibling().getEndAll());
        assertEq(178,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getNextSibling().getNextSibling().getNextSibling().getEndAll());
        assertEq(178,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getEndAll());
        assertEq(181,r_.getFirstChild().getNextSibling().getEndAll());
        assertEq(208,r_.getFirstChild().getNextSibling().getNextSibling().getFirstChild().getEndAll());
        assertEq(216,r_.getFirstChild().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getEndAll());
        assertEq(226,r_.getFirstChild().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getNextSibling().getEndAll());
        assertEq(235,r_.getFirstChild().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getNextSibling().getNextSibling().getEndAll());
        assertEq(244,r_.getFirstChild().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getEndAll());
        assertEq(247,r_.getFirstChild().getNextSibling().getNextSibling().getEndAll());
        assertEq(274,r_.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getFirstChild().getEndAll());
        assertEq(282,r_.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getEndAll());
        assertEq(292,r_.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getNextSibling().getEndAll());
        assertEq(295,r_.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getEndAll());
        assertEq(348,r_.getNextSibling().getFirstChild().getEndAll());
        assertEq(381,r_.getNextSibling().getFirstChild().getNextSibling().getFirstChild().getEndAll());
        AnonymousResult a1_ = ((Line) r_.getNextSibling().getFirstChild().getNextSibling().getFirstChild()).getRes().getAnonymousResults().get(0);
        assertEq(371,a1_.getType().getEndAll());
        assertEq(371,a1_.getType().getFirstChild().getEndAll());
        ...
        assertEq(452,r_.getNextSibling().getFirstChild().getNextSibling().getNextSibling().getEndAll());
        assertEq(465,r_.getNextSibling().getFirstChild().getNextSibling().getNextSibling().getNextSibling().getEndAll());
        assertEq(467,r_.getNextSibling().getEndAll());
        assertEq(468,r_.getFile().getEndAll());
        AbsBk f2_ = context_.getFilesBodies().getVal("my_file2");
        AbsBk r2_ = f2_.getFirstChild();
        assertEq(77,r2_.getFirstChild().getFirstChild().getFirstChild().getFirstChild().getEndAll());
        assertEq(81,r2_.getFirstChild().getFirstChild().getFirstChild().getEndAll());
        assertEq(81,r2_.getFirstChild().getFirstChild().getEndAll());
        assertEq(84,r2_.getFirstChild().getEndAll());
        assertEq(86,r2_.getEndAll());
        AbsBk f3_ = context_.getFilesBodies().getVal("my_file3");
        AbsBk r3_ = f3_.getFirstChild();
        assertEq(84,r3_.getFirstChild().getFirstChild().getEndAll());
        AnonymousResult a3_ = ((Line) r3_.getFirstChild().getFirstChild()).getRes().getAnonymousResults().get(0);
        assertEq(79,a3_.getType().getFirstChild().getFirstChild().getEndAll());
        assertEq(83,a3_.getType().getFirstChild().getEndAll());
        assertEq(83,a3_.getType().getEndAll());
        assertEq(116,r3_.getFirstChild().getFirstChild().getNextSibling().getEndAll());
        AnonymousResult a4_ = ((Line) r3_.getFirstChild().getFirstChild().getNextSibling()).getRes().getAnonymousResults().get(0);
        assertEq(111,a4_.getType().getFirstChild().getEndAll());
        assertEq(115,a4_.getType().getEndAll());
        assertEq(119,r3_.getFirstChild().getEndAll());
        assertEq(121,r3_.getEndAll());
        AbsBk f4_ = context_.getFilesBodies().getVal("my_file4");
        AbsBk r4_ = f4_.getFirstChild();
        assertEq(46,r4_.getFirstChild().getFirstChild().getEndAll());
        assertEq(49,r4_.getFirstChild().getEndAll());
        assertEq(51,r4_.getEndAll());
    }
    @Test
...
//        return AnalyzedPageEl.customFiles(_cont.getFilesBodies().values()).size();
    ...
    private static RootBlock getCustomTypes(AnalyzedPageEl _cont, int _i) {
        return customTypes(_cont).get(_i);
//        int count_ = 0;
//        for (RootBlock r: _cont.getFoundTypes()) {
//            if (r.getFile().isPredefined()) {
//                continue;
...
//        return null;
    ...
    private static CustList<RootBlock> customTypes(AnalyzedPageEl _cont) {
        return AnalyzedPageEl.customTypes(_cont.getFoundTypes());
    }
