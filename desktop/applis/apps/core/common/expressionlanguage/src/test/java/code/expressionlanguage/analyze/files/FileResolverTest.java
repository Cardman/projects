...
public final class FileResolverTest extends ProcessMethodCommon {
    ...
    public void endAll() {
        ...
        assertEq(296,r_.getEndAll());
        assertEq(42,r_.getFirstChild().getEndAll());
        assertEq(70,r_.getFirstChild().getNextSibling().getFirstChild().getFirstChild().getEndAll());
        assertEq(74,r_.getFirstChild().getNextSibling().getFirstChild().getEndAll());
        assertEq(117,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getFirstChild().getFirstChild().getEndAll());
        assertEq(122,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getFirstChild().getEndAll());
        assertEq(127,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getEndAll());
        assertEq(149,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getEndAll());
        ...
        assertEq(177,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getFirstChild().getNextSibling().getNextSibling().getNextSibling().getEndAll());
        assertEq(177,r_.getFirstChild().getNextSibling().getFirstChild().getNextSibling().getEndAll());
        assertEq(180,r_.getFirstChild().getNextSibling().getEndAll());
        assertEq(207,r_.getFirstChild().getNextSibling().getNextSibling().getFirstChild().getEndAll());
        assertEq(215,r_.getFirstChild().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getEndAll());
        assertEq(225,r_.getFirstChild().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getNextSibling().getEndAll());
        assertEq(234,r_.getFirstChild().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getNextSibling().getNextSibling().getEndAll());
        assertEq(243,r_.getFirstChild().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getEndAll());
        assertEq(246,r_.getFirstChild().getNextSibling().getNextSibling().getEndAll());
        assertEq(273,r_.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getFirstChild().getEndAll());
        assertEq(281,r_.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getEndAll());
        assertEq(291,r_.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getFirstChild().getNextSibling().getNextSibling().getEndAll());
        assertEq(294,r_.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getEndAll());
        assertEq(347,r_.getNextSibling().getFirstChild().getEndAll());
        assertEq(380,r_.getNextSibling().getFirstChild().getNextSibling().getFirstChild().getEndAll());
        ...
        assertEq(435,r_.getNextSibling().getFirstChild().getNextSibling().getFirstChild().getNextSibling().getEndAll());
        ...
        assertEq(425,a2_.getType().getEndAll());
        assertEq(404,a2_.getType().getFirstChild().getEndAll());
        assertEq(414,a2_.getType().getFirstChild().getNextSibling().getEndAll());
        assertEq(424,a2_.getType().getFirstChild().getNextSibling().getNextSibling().getEndAll());
        assertEq(438,r_.getNextSibling().getFirstChild().getNextSibling().getEndAll());
        assertEq(451,r_.getNextSibling().getFirstChild().getNextSibling().getNextSibling().getEndAll());
        assertEq(464,r_.getNextSibling().getFirstChild().getNextSibling().getNextSibling().getNextSibling().getEndAll());
        assertEq(466,r_.getNextSibling().getEndAll());
        assertEq(468,r_.getFile().getEndAll());
        AbsBk f2_ = context_.getFilesBodies().getVal("my_file2");
        AbsBk r2_ = f2_.getFirstChild();
        assertEq(76,r2_.getFirstChild().getFirstChild().getFirstChild().getFirstChild().getEndAll());
        assertEq(80,r2_.getFirstChild().getFirstChild().getFirstChild().getEndAll());
        assertEq(80,r2_.getFirstChild().getFirstChild().getEndAll());
        assertEq(83,r2_.getFirstChild().getEndAll());
        assertEq(85,r2_.getEndAll());
        AbsBk f3_ = context_.getFilesBodies().getVal("my_file3");
        AbsBk r3_ = f3_.getFirstChild();
        assertEq(83,r3_.getFirstChild().getFirstChild().getEndAll());
        AnonymousResult a3_ = ((Line) r3_.getFirstChild().getFirstChild()).getRes().getAnonymousResults().get(0);
        assertEq(78,a3_.getType().getFirstChild().getFirstChild().getEndAll());
        assertEq(82,a3_.getType().getFirstChild().getEndAll());
        assertEq(82,a3_.getType().getEndAll());
        assertEq(115,r3_.getFirstChild().getFirstChild().getNextSibling().getEndAll());
        AnonymousResult a4_ = ((Line) r3_.getFirstChild().getFirstChild().getNextSibling()).getRes().getAnonymousResults().get(0);
        assertEq(110,a4_.getType().getFirstChild().getEndAll());
        assertEq(114,a4_.getType().getEndAll());
        assertEq(118,r3_.getFirstChild().getEndAll());
        assertEq(120,r3_.getEndAll());
        AbsBk f4_ = context_.getFilesBodies().getVal("my_file4");
        AbsBk r4_ = f4_.getFirstChild();
        assertEq(45,r4_.getFirstChild().getFirstChild().getEndAll());
        assertEq(48,r4_.getFirstChild().getEndAll());
        assertEq(50,r4_.getEndAll());
    }
    @Test
