...
public final class ParsedFctHeaderTest extends EquallableElUtil {
    ...
    public void test7() {
        ...
        assertEq(0, getAnnotationsParams(p_).size());
        assertEq(0, getAnnotationsIndexesParams(p_).size());
    ...
    public void test8() {
        ...
        assertEq(0, getAnnotations(p_).size());
        assertEq(0, getAnnotationsIndexes(p_).size());
        assertEq(1, getAnnotationsParams(p_).size());
        assertEq(0, getAnnotationsParams(p_).get(0).size());
        assertEq(1, getAnnotationsIndexesParams(p_).size());
        assertEq(0, getAnnotationsIndexesParams(p_).get(0).size());
    ...
    public void test11() {
        ...
        assertEq("@Annot", getAnnotations(p_).get(0));
        assertEq(1, getAnnotationsIndexes(p_).size());
        assertEq(14, getAnnotationsIndexes(p_).get(0));
        assertEq(0, getAnnotationsParams(p_).size());
        assertEq(0, getAnnotationsIndexesParams(p_).size());
        assertEq(0,p_.getParametersType().size());
        assertEq(0,p_.getParametersRef().size());
    ...
    public void test14() {
        ...
        assertEq("@Annot", getAnnotations(p_).get(0));
        assertEq("@AnnotTwo", getAnnotations(p_).get(1));
        assertEq(2, getAnnotationsIndexes(p_).size());
        assertEq(14, getAnnotationsIndexes(p_).get(0));
        assertEq(20, getAnnotationsIndexes(p_).get(1));
        assertEq(0, getAnnotationsParams(p_).size());
        assertEq(0, getAnnotationsIndexesParams(p_).size());
        assertEq(0,p_.getParametersType().size());
        assertEq(0,p_.getParametersRef().size());
    ...
    public void test17() {
        ...
        assertEq(0, getAnnotationsIndexes(p_).size());
        assertEq(1, getAnnotationsParams(p_).size());
        assertEq(1, getAnnotationsParams(p_).get(0).size());
        assertEq("@Annot", getAnnotationsParams(p_).get(0).get(0));
        assertEq(1, getAnnotationsIndexesParams(p_).size());
        assertEq(1, getAnnotationsIndexesParams(p_).get(0).size());
        assertEq(13, getAnnotationsIndexesParams(p_).get(0).get(0));
        assertEq(1,p_.getParametersType().size());
        assertEq("int",p_.getParametersType().get(0));
        assertEq(1,p_.getParametersRef().size());
        assertSame(BoolVal.FALSE,p_.getParametersRef().get(0));
    ...
    public void test24() {
        ...
        assertEq(0, getAnnotations(p_).size());
        assertEq(0, getAnnotationsIndexes(p_).size());
        assertEq(2, getAnnotationsParams(p_).size());
        assertEq(1, getAnnotationsParams(p_).get(0).size());
        assertEq("@Annot", getAnnotationsParams(p_).get(0).get(0));
        assertEq(2, getAnnotationsIndexesParams(p_).size());
        assertEq(1, getAnnotationsIndexesParams(p_).get(0).size());
        assertEq(13, getAnnotationsIndexesParams(p_).get(0).get(0));
    ...
    public void test37() {
        ...
        assertEq("@Annot", getAnnotations(p_).get(0));
        assertEq(1, getAnnotationsIndexes(p_).size());
        assertEq(15, getAnnotationsIndexes(p_).get(0));
        assertEq(1, getAnnotationsParams(p_).size());
        assertEq(0, getAnnotationsParams(p_).get(0).size());
        assertEq(1, getAnnotationsIndexesParams(p_).size());
        assertEq(0, getAnnotationsIndexesParams(p_).get(0).size());
