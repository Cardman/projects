...
public final class ProcessDbgWatchesTest extends ProcessDbgCommon {
    ...
    public void logs1() {
        ...
        assertNull(logs_.getWatchedTrace());
        assertEq("log",getString(ArgumentListCall.toStr(logs_.getWatchedObject())));
    }
    @Test
    public void logs2() {
        StringMap<String> files_ = new StringMap<String>();
        ...
        assertNull(logs_.getWatchedTrace());
        assertNull(logs_.getWatchedObject());
    }
    @Test
    public void logs3() {
        StringMap<String> files_ = new StringMap<String>();
        ...
        assertNull(logs_.getWatchedObject());
        ArrayStruct stack_ = (ArrayStruct) logs_.getWatchedTrace();
    ...
    public void logs4() {
        ...
        assertNull(logs_.getWatchedTrace());
        assertEq("pkg.Ex..Sec+1",logs_.getWatchedObject().getClassName(logs_.getSubContext()));
    }
    @Test
    public void logs5() {
        StringMap<String> files_ = new StringMap<String>();
    ...
    public void logs6() {
        ...
        assertNull(logs_.getWatchedTrace());
        assertEq(3,getNumber(ArgumentListCall.toStr(logs_.getWatchedObject())));
    }
    @Test
    public void logs7() {
        StringMap<String> files_ = new StringMap<String>();
    ...
    public void logs9() {
        ...
        assertNull(logs_.getWatchedTrace());
        assertEq("pkg.Ex..Sec+1",logs_.getWatchedObject().getClassName(logs_.getSubContext()));
        assertEq(2, getNumber(ExecFieldTemplates.getInstanceField(ArgumentListCall.toStr(logs_.getWatchedObject()),logs_.getSubContext(), StackCall.newInstance(InitPhase.NOTHING,logs_.getSubContext()),new ClassField("pkg.Ex..Sec+1","v"))));
    }
}
