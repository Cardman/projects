...
public final class ClassesTest extends ProcessMethodCommon {
    ...
    public void emptyClassesTest() {
        ...
        ExecVariableTemplates.trySetArgument(ctx_, ArgumentListCall.toStr(NullStruct.NULL_VALUE),new ArgumentsPair(), null);
        ...
        assertSame(NullStruct.NULL_VALUE,NullStruct.nullValue(NullStruct.DEF_VALUE));
        assertSame(NullStruct.NULL_VALUE,NullStruct.nullValue(NullStruct.NULL_VALUE));
...
//        assertEq(1, StandardConstructor.look(lgName_.getCoreNames().getObjType(),getConstructorId("")).size());
    ...
    public void resolve11Test() {
        ...
        assertEq("pkg.Outer..Inner", types_.last());
    }
    @Test
    ...
    public void calculateStaticField1Test() {
        ...
        assertEq(2, countStaticFields(ctx_.getClasses().getStaticFields()));
        Struct str_ = getStaticField(ctx_, new ClassField("pkg.ExTwo", "myf"));
        assertEq(2, ((NumberStruct)str_).intStruct());
        str_ = getStaticField(ctx_, new ClassField("pkg.ExTwo", "mys"));
    ...
    public void calculateStaticField2Test() {
        ...
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(0, countStaticFields(ctx_.getClasses().getStaticFields()));
    }
    @Test
    ...
    public void calculateStaticField4Test() {
        ...
        Struct str_ = getStaticField(ctx_, new ClassField("pkg.ExTwo", "mys"));
    ...
    public void calculateStaticField5Test() {
        ...
        Struct str_ = getStaticField(ctx_, new ClassField("pkg.ExTwo", "mys"));
        assertEq(1, ((NumberStruct)str_).intStruct());
        str_ = getStaticField(ctx_, new ClassField("pkg.ExTwo", "myt"));
    ...
    public void calculateStaticField14Test() {
        ...
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(1, countStaticFields(ctx_.getClasses().getStaticFields()));
        Struct str_ = getStaticField(ctx_, new ClassField("pkg.ExTwo", "ch"));
    ...
    public void calculateStaticField16Test() {
        ...
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(3, countStaticFields(ctx_.getClasses().getStaticFields()));
    ...
    public void calculateStaticField63Test() {
        ...
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(4, countStaticFields(ctx_.getClasses().getStaticFields()));
        Struct str_ = getStaticField(ctx_, new ClassField("pkg.ExTwo", "field"));
        assertTrue(str_);
    }
    @Test
    ...
    public void calculateStaticField87Test() {
        ...
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        StringMap<StringMap<Struct>> ctx_ = validateStaticFieldsFail(files_);
    ...
    public void calculateStaticField101Test() {
        ...
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(14, countStaticFields(ctx_.getClasses().getStaticFields()));
    }
    @Test
    ...
    public void calculateStaticField152Test() {
        ...
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(1, countStaticFields(ctx_.getClasses().getStaticFields()));
        assertEq(Long.MIN_VALUE, ((NumberStruct) getStaticField(ctx_, new ClassField("pkg.ExTwo","a1"))).longStruct());
    }
    @Test
    ...
    public void calculateStaticField176Test() {
        ...
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = ctxOk(files_);
        assertEq(1,((NumberStruct) getStaticField(ctx_, new ClassField("pkg.ExTwo","a1"))).intStruct());
    }
    @Test
    public void calculateStaticField177Test() {
        ...
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = ctxOk(files_);
        assertEq(3,((NumberStruct) getStaticField(ctx_, new ClassField("pkg.ExTwo","a1"))).intStruct());
    }
    @Test
    ...
    public void calculateStaticField196Test() {
        ...
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
        xml_.append(" $public $static $final $float a1=0f;\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(1, countStaticFields(ctx_.getClasses().getStaticFields()));
    ...
    public void calculateStaticField197Test() {
        ...
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
        xml_.append(" $public $static $final $float a1=0.0f;\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(1, countStaticFields(ctx_.getClasses().getStaticFields()));
    ...
    @Test
    public void calculateStaticField200Test() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
        xml_.append(" $public $static $final $float a1=0e1f;\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(1, countStaticFields(ctx_.getClasses().getStaticFields()));
    ...
    @Test
    public void calculateStaticField201Test() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
        xml_.append(" $public $static $final $float a1=0.0e+1f;\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(1, countStaticFields(ctx_.getClasses().getStaticFields()));
    ...
    @Test
    public void calculateStaticField202Test() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
    ...
    @Test
    public void calculateStaticField203Test() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
        xml_.append(" $public $static $final $float a1=0x0p0f;\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(1, countStaticFields(ctx_.getClasses().getStaticFields()));
    ...
    @Test
    public void calculateStaticField204Test() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
        xml_.append(" $public $static $final $float a1=0b0p0f;\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(1, countStaticFields(ctx_.getClasses().getStaticFields()));
    ...
    @Test
    public void calculateStaticField205Test() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
        xml_.append(" $public $static $final $float a1=00p0f;\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(1, countStaticFields(ctx_.getClasses().getStaticFields()));
    ...
    @Test
    public void calculateStaticField206Test() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
        xml_.append(" $public $static $final $float a1=1.5f;\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        ContextEl ctx_ = validateStaticFields(files_);
        assertEq(1, countStaticFields(ctx_.getClasses().getStaticFields()));
    ...
    public void validateEl182FailTest() {
        ...
        xml_.append(" $public $void outer2(){$public $static $class Inn{};}\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        assertTrue(hasErr(files_));
    }
    @Test
    public void validateEl183FailTest() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
        xml_.append(" {$return;$return;}\n");
        xml_.append(" $public $void outer(){$public $static $class Inn{};}\n");
        xml_.append(" $public $void outer2(){$public $static $class Inn2{};}\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        assertTrue(hasErr(files_));
    }
    @Test
    public void validateEl184FailTest() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
        xml_.append(" {$return;$return;}\n");
        xml_.append(" $public $static $class Inn{}\n");
        xml_.append(" $public $void outer(){$public $static $class Inn{};}\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        assertTrue(hasErr(files_));
    ...
    @Test
    public void validateEl185FailTest() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo<Inn> {\n");
        xml_.append(" {$return;$return;}\n");
        xml_.append(" $public $void outer(){$public $static $class Inn{};}\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
    ...
    @Test
    public void validateEl186FailTest() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
        xml_.append(" $public $void outer(){$public $static $class Inn{};$public $static $class Inn{};}\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        assertTrue(hasErr(files_));
    }
    @Test
    public void validateEl187FailTest() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$operator+ $int() {\n");
        xml_.append(" $public $static $class Inn{}$public $static $class Inn{};\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
        assertTrue(hasErr(files_));
    }
    @Test
    public void validateEl188FailTest() {
        StringMap<String> files_ = new StringMap<String>();
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("$public $class pkg.ExTwo {\n");
