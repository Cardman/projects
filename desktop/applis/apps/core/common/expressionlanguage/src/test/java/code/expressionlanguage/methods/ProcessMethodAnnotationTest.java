...
public final class ProcessMethodAnnotationTest extends ProcessMethodCommon {
    ...
    public void calculateArgument10_Test() {
        ...
        xml_.append(" $int infoIntTwo()4i;\n");
        xml_.append("}\n");
        xml_.append("@MyAnnot(infoIntTwo=6i,infoIntOne=8i)\n");
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $static $int catching(){\n");
        xml_.append("  $Annotation[] arr = $class(Ex).getAnnotations();\n");
        xml_.append("  $if (arr.length != 1i){\n");
    ...
    public void calculateArgument84Test() {
        ...
        ContextEl cont_ = ctxOk(files_);
        MethodId id_ = getMethodId("catching");
        assertEq("@pkg.MyAnnot(info=@pkg.MyAnnotTwo(infoInt=4,infoIntTwo={\"$class(ExTwo)\\+00000\"}))", getString(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    public void calculateArgument85Test() {
        ...
        ContextEl cont_ = ctxOk(files_);
        MethodId id_ = getMethodId("catching");
        assertEq("@pkg.MyAnnot(info=@pkg.MyAnnotTwo(infoInt=4,infoIntTwo={\"$class(ExTwo)\\+00001\"}))", getString(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    public void calculateArgument86Test() {
        ...
        ContextEl cont_ = ctxOk(files_);
        MethodId id_ = getMethodId("catching");
        assertEq("@pkg.MyAnnot(info=@pkg.MyAnnotTwo(infoInt=4,infoIntTwo={\"$class(ExTwo)\\+00020\"}))", getString(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    ...
    public void calculateArgument105Test() {
        ...
        xml_.append(" @MyAnnot(infoIntOne=1i)\n");
        xml_.append(" @MyAnnotTwo(infoIntTwo=3i)\n");
        xml_.append(" $operator+ $int($int p){\n");
        xml_.append("  $return 0i;\n");
        xml_.append(" }\n");
        xml_.append(" $public $static $int catching(){\n");
        xml_.append("  $Annotation[] arr = $class(Ex).getDeclaredMethods()[0i].getAnnotations();\n");
        xml_.append("  $if (arr.length != 2i){\n");
        xml_.append("   $return 5i;\n");
        xml_.append("  }\n");
        xml_.append("  $if ($static($Class).getClass(arr) != $class($Annotation[])){\n");
    ...
    public void calculateArgument106Test() {
        ...
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append("\n");
        xml_.append(" $operator+ $int(@MyAnnot(infoIntOne=1i)@MyAnnotTwo(infoIntTwo=3i) $int p){\n");
        xml_.append("  $return 0i;\n");
        xml_.append(" }\n");
        xml_.append(" $public $static $int catching(){\n");
        xml_.append("  $Annotation[][] arrs = $class(Ex).getDeclaredMethods()[0i].getAnnotationsParameters();\n");
    ...
    public void calculateArgumentSupp1Test() {
        ...
        xml_.append("  $return 0i;\n");
        xml_.append(" }\n");
        xml_.append(" $public $void $this($int p, @MyAnnot(infoIntOne=1i)@MyAnnotTwo(infoIntTwo=3i) $int $value){\n");
        xml_.append(" }\n");
        xml_.append(" $public $static $int catching(){\n");
    ...
    public void calculateArgumentSupp2Test() {
        ...
        xml_.append(" }\n");
        xml_.append(" $public $static $int catching(){\n");
        xml_.append("  $Annotation[] arr = $class(Ex).getDeclaredMethods()[1i].getAnnotationsSupp($class(MyAnnotTwo));\n");
        xml_.append("  $if (arr.length != 1i){\n");
        xml_.append("   $return 5i;\n");
        xml_.append("  }\n");
        xml_.append("  $if ($static($Class).getClass(arr) != $class($Annotation[])){\n");
        xml_.append("   $return 4i;\n");
        xml_.append("  }\n");
        xml_.append("  $if ($static($Class).getClass(arr[0i]) != $class(MyAnnotTwo)){\n");
        xml_.append("   $return 3i;\n");
        xml_.append("  }\n");
        xml_.append("  MyAnnotTwo a = $(MyAnnotTwo)arr[0i];\n");
        xml_.append("  $int info = a.infoIntTwo();\n");
        xml_.append("  $if (info != 3i){\n");
        xml_.append("   $return 2i;\n");
        xml_.append("  }\n");
        xml_.append("  $return 0i;\n");
    ...
    public void calculateArgumentSupp3Test() {
        ...
        xml_.append(" }\n");
        xml_.append(" $public $static $int catching(){\n");
        xml_.append("  $Annotation[] arr = $class(Ex).getDeclaredMethods()[1i].getAnnotationsSupp($null);\n");
        xml_.append("  $if (arr.length != 2i){\n");
        xml_.append("   $return 5i;\n");
        xml_.append("  }\n");
        xml_.append("  $if ($static($Class).getClass(arr) != $class($Annotation[])){\n");
    ...
    public void calculateArgumentSupp5Test() {
        ...
        xml_.append(" }\n");
        xml_.append(" $public $static $int catching(){\n");
        xml_.append("  $Annotation[] arr = $class(String).getDeclaredMethods()[0i].getAnnotationsSupp();\n");
        xml_.append("  $if (arr.length != 0i){\n");
        xml_.append("   $return 5i;\n");
        xml_.append("  }\n");
        xml_.append("  $if ($static($Class).getClass(arr) != $class($Annotation[])){\n");
