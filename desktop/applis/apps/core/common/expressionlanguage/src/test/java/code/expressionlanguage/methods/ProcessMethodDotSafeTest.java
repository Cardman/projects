...
public final class ProcessMethodDotSafeTest extends ProcessMethodCommon {
    ...
    public void calculateArgument13Test() {
        ...
        ContextEl cont_ = ctxLgOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq("world", getString(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    ...
    public void calculateArgument15Test() {
        ...
        ContextEl cont_ = ctxLgOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq("helloworld", getString(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    ...
    public void calculateArgument21Test() {
        ...
        ContextEl cont_ = ctxLgOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq("hello", getString(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
