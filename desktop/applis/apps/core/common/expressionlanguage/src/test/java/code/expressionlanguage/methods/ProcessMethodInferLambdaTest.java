...
public final class ProcessMethodInferLambdaTest extends ProcessMethodCommon {
    ...
    public void test76_____() {
        ...
        xml_.append(" }\n");
        xml_.append(" $public $staticCall T exmeth(T p){\n");
        xml_.append("  $Fct<$int,$int,T[][][]> f = $lambda(T[][],$new,$int,$int);\n");
        xml_.append("  T[][][] a = f.call(1,1);\n");
        xml_.append("  a[0][0] = {p};\n");
        xml_.append("  $return a[0][0][0];\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        StringMap<String> files_ = new StringMap<String>();
        files_.put("pkg/Ex", xml_.toString());
    ...
    public void fail19() {
        ...
        xml_.append(" }\n");
        xml_.append(" $public $static $int exmeth(){\n");
        xml_.append("  $Fct c = $staticCall(pkg.Ex<>).$lambda($new);\n");
        xml_.append("  $return ((Ex)c.call(14)).exmethtwo();\n");
        xml_.append(" }\n");
        xml_.append(" $public $int exmethtwo(){\n");
        xml_.append("  $return f;\n");
