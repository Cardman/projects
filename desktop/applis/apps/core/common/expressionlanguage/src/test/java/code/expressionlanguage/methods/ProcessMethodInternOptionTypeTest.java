...
public final class ProcessMethodInternOptionTypeTest extends ProcessMethodCommon {
    ...
    public void calculateArgument47Test() {
        ...
        assertTrue(calculateNormal("pkgtwo.OuterThree", id_, cont_));
    }
    @Test
    ...
    public void calculateArgument51Test() {
        ...
        xml_.append(" public static int method(){\n");
        xml_.append("  Outer<String> parent = new Outer<String>();\n");
        xml_.append("  Outer<String> parent2 = new Outer<String>();\n");
        xml_.append("  pkg.Outer<String>.Inner w = $(pkg.Outer<String>.Inner) class(pkg.Outer<String>.Inner).defaultInstance(parent);\n");
        xml_.append("  if (static(Class).getClass(w).getName() != \"pkg.Outer<$core.String>..Inner\") {\n");
        xml_.append("   return 2i;\n");
        xml_.append("  }\n");
    ...
    public void calculateArgument53Test() {
        ...
        xml_.append("   InnerFive.this.field = static(Class).getClass(this).getName();\n");
        xml_.append("  }\n");
        xml_.append("  public class InnerInner<G> {\n");
        xml_.append("   public normal String get(){\n");
        xml_.append("    return field;\n");
        xml_.append("   }\n");
        xml_.append("  }\n");
        xml_.append("  public final String field;\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        files_.put("pkg/ExThree", xml_.toString());
        xml_ = new StringBuilder();
    ...
    public void calculateArgument57Test() {
        ...
        ContextEl cont_ = ctxLgOk(files_);
        MethodId id_ = getMethodId("method");
        assertEq("CS", getString(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    public void calculateArgument58Test() {
        ...
        xml_.append(" public class InnerFive2<E2>:InnerFive<E2> {\n");
        xml_.append("  public String field = CST;\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        files_.put("pkg/ExThree", xml_.toString());
        xml_ = new StringBuilder();
        ...
        xml_.append("public class pkg.Ex {\n");
        xml_.append(" public static String method(){\n");
        xml_.append("  OuterThree2<String>.InnerFive2<String> f = new OuterThree2<String>().new();\n");
    ...
    public void calculateArgument59Test() {
        ...
        xml_.append("}\n");
        xml_.append("public class pkgtwo.OuterThree2<A2>:OuterThree<A2> {\n");
        xml_.append(" public static class InnerFive2<E2>:InnerFive<E2> {\n");
        xml_.append("  public String field = CST;\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        files_.put("pkg/ExThree", xml_.toString());
        ...
        xml_.append("public class pkg.Ex {\n");
        xml_.append(" public static String method(){\n");
        xml_.append("  OuterThree2.InnerFive2<String> f = new OuterThree2<String>().new();\n");
        xml_.append("  return f.field;\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        files_.put("pkg/ExFour", xml_.toString());
    ...
    public void calculateArgument60Test() {
        ...
        xml_.append("public class pkg.Ex {\n");
        xml_.append(" public static String method(){\n");
        xml_.append("  OuterThree2.InnerFive2<String> f = new OuterThree2<String>().new InnerFive2<>();\n");
        xml_.append("  return f.field;\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        files_.put("pkg/ExFour", xml_.toString());
    ...
    public void calculateArgument61Test() {
        ...
        xml_.append("public class pkg.Ex {\n");
        xml_.append(" public static String method(){\n");
        xml_.append("  OuterThree2.InnerFive2<String> f = new OuterThree2<String>().new InnerFive2<String>();\n");
        xml_.append("  return f.field;\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        files_.put("pkg/ExFour", xml_.toString());
    ...
    public void calculateArgumentFailTest() {
        ...
        StringBuilder xml_;
        xml_ = new StringBuilder();
        xml_.append("public class [pkgtwo.OuterThree.InnerFive.*;] pkg.Outer: pkgtwo.OuterTwo {\n");
        xml_.append(" public static class Inner {\n");
        xml_.append(" }\n");
    ...
    public void calculateArgument17FailTest() {
        ...
        xml_.append("public class pkg.Ex {\n");
        xml_.append(" public static int method(){\n");
        xml_.append("  Outer<String> outer = null;\n");
        xml_.append("  Outer<String>.InnerThree<String>.InnerInner<String> v;\n");
        xml_.append("  v = outer.new InnerThree<String>().new InnerInner<String>();\n");
        xml_.append("  return 0i;\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        files_.put("pkg/ExFour", xml_.toString());
    ...
    public void calculateArgument21FailTest() {
        ...
        xml_.append("  return exmeth().field;\n");
        xml_.append(" }\n");
        xml_.append(" public static Inner<int> exmeth(){\n");
        xml_.append("  return new ExOuter().new Inner<int>(10);\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        files_.put("pkg/ExFour", xml_.toString());
        xml_ = new StringBuilder();
