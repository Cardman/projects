...
public final class ProcessMethodLocalTypesTest extends ProcessMethodCommon {
    ...
    public void calculate5() {
        ...
        ContextEl cont_ = ctxLgOk(files_);
        MethodId id_ = getMethodId("m");
        assertEq("Loc:4,2;LocTwo:8,6;",getString(calculateNormal("pkg.Ext", id_, cont_)));
    }
    @Test
    public void calculate6() {
        ...
        ContextEl cont_ = ctxLgOk(files_);
        MethodId id_ = getMethodId("m");
        assertEq("2,6,",getString(calculateNormal("pkg.Ext", id_, cont_)));
    }
    @Test
    public void calculate7() {
        ...
        ContextEl cont_ = ctxLgOk(files_);
        MethodId id_ = getMethodId("m");
        assertEq("pkg.Ext..Loc+1,pkg.Ext..Loc+2",getString(calculateNormal("pkg.Ext", id_, cont_)));
    }
    @Test
    ...
    public void calculate25() {
        ...
        xml_.append("  }\n");
        xml_.append(" }\n");
        xml_.append(" return (pkg.Int)new Loc(a.field+b.field);\n");
        xml_.append("}\n");
    ...
    public void calculate29() {
        ...
        xml_ = new StringBuilder();
        xml_.append("operator+ pkg.Int(pkg.Comp a, pkg.Comp b) {\n");
        xml_.append(" public class MyInt:pkg.Int{\n");
        xml_.append("  int field;\n");
        xml_.append("  public MyInt(int p){\n");
        xml_.append("   field = p;\n");
        xml_.append("  }\n");
        xml_.append("  public int field(){\n");
        xml_.append("   return field;\n");
        xml_.append("  }\n");
        xml_.append(" }\n");
        xml_.append(" public class Loc:MyInt{\n");
        xml_.append("  public Loc(int p){\n");
        xml_.append("   super(p);\n");
        xml_.append("  }\n");
        xml_.append(" }\n");
    ...
    public void calculate31() {
        ...
        xml_ = new StringBuilder();
        xml_.append("operator+ pkg.Int(pkg.Comp a, pkg.Comp b) {\n");
        xml_.append(" return (int q:pkg.Int)->{\n");
        xml_.append("  public class Loc:pkg.Int{\n");
        xml_.append("   int field;\n");
        xml_.append("   public Loc(int p){\n");
        xml_.append("    field = p;\n");
        ...
        xml_.append("   }\n");
        xml_.append("  }\n");
        xml_.append("  return new Loc(q);\n");
        xml_.append(" }.call(a.field+b.field);\n");
        xml_.append("}\n");
        xml_.append("public interface pkg.Int {\n");
        xml_.append(" int field();\n");
        xml_.append("}\n");
    ...
    public void calculate33() {
        ...
        xml_.append("   }\n");
        xml_.append("  }\n");
        xml_.append("  return new Loc(q){public Loc(int p){super(p);}};\n");
        xml_.append(" }.call(a.field+b.field);\n");
        xml_.append("}\n");
        xml_.append("public interface pkg.Int {\n");
        xml_.append(" int field();\n");
    ...
    public void calculate34() {
        ...
        xml_.append("  }\n");
        xml_.append(" }\n");
        xml_.append(" return new Loc(q:a.field+b.field){public Loc(int q){super(q);}};\n");
        xml_.append("}\n");
        xml_.append("public interface pkg.Int {\n");
        xml_.append(" int field();\n");
        xml_.append("}\n");
    ...
    public void calculate35() {
        ...
        xml_.append("class pkg.Ext {\n");
        xml_.append(" static int m(){\n");
        xml_.append("  return Class.getOperators()[0].getDeclaredLocalTypes().length;\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        files_.put("pkg/Ex", xml_.toString());
        ContextEl cont_ = ctxLgOk(files_);
