...
public final class ProcessMethodRecordTest extends ProcessMethodCommon {
    ...
    public void calculateArgument5Test() {
        ...
        ContextEl cont_ = ctxReadOnlyOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq("code.expressionlanguage.exceptions.DynamicCastClassException", calculateError("pkg.Ex",id_,cont_).getClassName(cont_));
    }
    @Test
    ...
    public void calculateArgument46Test() {
        ...
        ContextEl cont_ = ctxReadOnlyOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq(42, getNumber(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    public void calculateArgument47Test() {
        ...
        ContextEl cont_ = ctxReadOnlyOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq(56, getNumber(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    ...
    public void calculateArgument68Test() {
        ...
        ContextEl cont_ = ctxReadOnlyOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq(cont_.getStandards().getContent().getCoreNames().getAliasCastType(), calculateError("pkg.Ex",id_,cont_).getClassName(cont_));
    }
    @Test
    ...
    public void calculateArgument89Test() {
        ...
        xml_.append("  U field2=(U)extfield;\n");
        xml_.append(" }\n");
        xml_.append(" $class RecClass<V> {\n");
        xml_.append("  T field3 = Ex.$this.extfield;\n");
        xml_.append(" }\n");
        xml_.append(" @$class $interfaces(Ex.RecInt) Rec<S>:RecClass<S>:RecInt<S> {\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        StringMap<String> files_ = new StringMap<String>();
        files_.put("pkg/Ex", xml_.toString());
    ...
    public void calculateArgument90Test() {
        ...
        xml_.append(" }\n");
        xml_.append(" $public T exmeth (){\n");
        xml_.append("  Rec<T> r = $new Rec<T>(Ex.RecClass.field3:extfield,Ex.RecInt.field:(T)1);\n");
        xml_.append("  $return r.field3;\n");
        xml_.append(" }\n");
        xml_.append(" $interface RecInt<U> {\n");
        xml_.append("  U field;\n");
    ...
    public void calculateArgument91Test() {
        ...
        xml_.append("  U field2=(U)extfield;\n");
        xml_.append(" }\n");
        xml_.append(" $class RecClass<V>:RecSupClass<V> {\n");
        xml_.append(" }\n");
        xml_.append(" $class RecSupClass<W> {\n");
        xml_.append("  T field3 = Ex.$this.extfield;\n");
        xml_.append(" }\n");
        xml_.append(" @$class $interfaces(Ex.RecInt) Rec<S>:RecClass<S>:RecInt<S> {\n");
        xml_.append(" }\n");
    ...
    public void calculateArgument92Test() {
        ...
        xml_.append(" $class RecClass<V>:RecSupClass<V> {\n");
        xml_.append(" }\n");
        xml_.append(" $class $interfaces(Ex.RecInt2) RecSupClass<W>:RecInt2 {\n");
        xml_.append("  T field3 = (T)(($int) Ex.$this.extfield+st);\n");
        xml_.append(" }\n");
        xml_.append(" @$class $interfaces(Ex.RecInt) Rec<S>:RecClass<S>:RecInt<S> {\n");
        xml_.append(" }\n");
        xml_.append("}\n");
    ...
    public void ints() {
        ...
        xml_.append("public class pkg.Ex {\n");
        xml_.append(" public static int exmeth (){\n");
        xml_.append("  return new Ex().new interfaces(Ex.RecSuper,Ex.RecSuper2) Rec(field:1).field2;\n");
        xml_.append(" }\n");
        xml_.append(" @class interfaces( Ex.RecSuper , Ex.RecSuper2 ) Rec:RecSuper:RecSuper2 {\n");
        xml_.append("  int field;\n");
        xml_.append(" }\n");
    ...
    public void recordTest() {
        ...
        args_.add(new ArgumentWrapper(new IntStruct(10)));
        ...
        assertEq(10, ((NumberStruct)getField(out_,new ClassField("pkg.Rec","field"))).intStruct());
    }
    @Test
