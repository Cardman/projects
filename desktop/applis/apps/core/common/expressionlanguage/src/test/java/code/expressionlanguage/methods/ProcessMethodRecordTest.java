...
public final class ProcessMethodRecordTest extends ProcessMethodCommon {
    ...
    public void recordTest() {
        ...
        ArgumentWrapper argumentWrapper_ = ProcessMethod.instanceRecordArgument("pkg.Rec", new ExecTypeFunction(cont_.getClasses().getClassBody("pkg.Rec"),null), id_,args_,cont_);
