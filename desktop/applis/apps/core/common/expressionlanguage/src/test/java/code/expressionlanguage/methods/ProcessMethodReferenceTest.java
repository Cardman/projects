...
public final class ProcessMethodReferenceTest extends ProcessMethodCommon {
    ...
    public void calculateArgument0Test() {
        ...
        xml_.append("  t=8;\n");
        xml_.append("  $Fct<$int,$int> f = $static().$lambda(Ex,exmethtwo,$int);\n");
        xml_.append("  $return f.callRef(5i);\n");
        xml_.append(" }\n");
        xml_.append(" $public $static $int exmethtwo($int p){\n");
        xml_.append("  $long t;\n");
        xml_.append("  t=8;\n");
    ...
    public void calculateArgument10Test() {
        ...
        ContextEl cont_ = ctxOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq(26, getNumber(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    ...
    public void calculateArgument18Test() {
        ...
        ContextEl cont_ = ctxOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq("java.lang.$Fct<java.lang.Number,$int>",getString(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    ...
    public void calculateArgument43Test() {
        ...
        ContextEl cont_ = ctxOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq("sample", getString(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    ...
    @Test
    public void calculateArgument44_Test() {
        StringBuilder xml_ = new StringBuilder();
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $static $int exmeth(){\n");
    ...
    @Test
    public void calculateArgument44_ref_Test() {
        StringBuilder xml_ = new StringBuilder();
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $static $int exmeth(){\n");
        xml_.append("  $Method f = $class($Fct).makeGeneric($class($int),$class($int)).getDeclaredMethods()[2i];\n");
        xml_.append("  $Fct<~$int,$void> g = $new Ex().$lambda(Ex,exmethtwo,~$int);\n");
        xml_.append("  $var a = $new java.lang.Object[]{5i};\n");
        xml_.append("  f.invokeRef(g,$new java.lang.Object[]{a});\n");
        xml_.append("  $return $($int) a[0];\n");
        xml_.append(" }\n");
        xml_.append(" $public $normal $void exmethtwo($that $int p){\n");
        xml_.append("  p=14;\n");
    ...
    public void calculateArgument53Test() {
        ...
        ContextEl cont_ = ctxOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq(36, getNumber(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    ...
    public void calculateArgument57Test() {
        ...
        ContextEl cont_ = ctxOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq(28, getNumber(calculateNormal("pkg.Ex", id_, cont_)));
    }
    @Test
    ...
    public void calculateArgument95Test() {
        ...
        ContextEl cont_ = ctxOk(files_);
        MethodId id_ = getMethodId("exmeth");
        Struct arg_ = calculateError("pkg.Ex", id_, cont_);
        assertEq("code.expressionlanguage.exceptions.NegativeSizeException", arg_.getClassName(cont_));
        assertEq("-1<0", ((StringStruct)((ErroneousStruct) arg_).getMessage()).getInstance());
    }
    @Test
    ...
    public void calculateArgument112_Test() {
        ...
        MethodId id_ = getMethodId("exmeth");
        assertEq(28, getNumber(calculateNormal("pkg.Ex..Inner", id_, cont_)));
    }
    @Test
    ...
    public void calculateArgument162Test() {
        ...
        ContextEl cont_ = ctxOk(files_);
        MethodId id_ = getMethodId("exmeth");
        assertEq(34, getNumber(calculateNormal("pkg.Ex", id_, cont_)));
    }
    ...
    @Test
    public void calculateArgument178_Test() {
        StringBuilder xml_ = new StringBuilder();
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $int f;\n");
        xml_.append(" $public Ex($int f){\n");
    ...
    @Test
    public void calculateArgument179_Test() {
        StringBuilder xml_ = new StringBuilder();
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $int f;\n");
        xml_.append(" $public Ex($int f){\n");
    ...
    public void calculateArgument179Test() {
        ...
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $static $int exmeth(){\n");
        xml_.append("  $Fct<$int,$int,$int> f = $lambda($operator,$int,+,$int,$int);\n");
        xml_.append("  $return f.call(1,2);\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        StringMap<String> files_ = new StringMap<String>();
        files_.put("pkg/Ex", xml_.toString());
    ...
    public void calculateArgument180Test() {
        ...
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $static $int exmeth(){\n");
        xml_.append("  $Fct<$int,$int> f = 1.$lambda($operator,$int,+,$int);\n");
        xml_.append("  $return f.call(2);\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        StringMap<String> files_ = new StringMap<String>();
        files_.put("pkg/Ex", xml_.toString());
    ...
    public void calculateArgument181Test() {
        ...
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $static $int exmeth(){\n");
        xml_.append("  $Fct<$int,$int> f = $lambda($operator,$int,-,$int);\n");
    ...
    public void calculateArgument182Test() {
        ...
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $static $int exmeth(){\n");
        xml_.append("  $Fct<$int> f = 1.$lambda($operator,$int,-);\n");
        xml_.append("  $return f.call();\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        StringMap<String> files_ = new StringMap<String>();
    ...
    @Test
    public void calculateArgument_0FailTest() {
        StringBuilder xml_ = new StringBuilder();
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $int f;\n");
        xml_.append(" $public Ex($int f){\n");
        ...
        xml_.append(" $public $static $int exmeth(){\n");
        xml_.append("  ExCont e = $new($new(5));\n");
        xml_.append("  $Fct<$int,$int> f = $lambda($operator,$int,-);\n");
        xml_.append("  $Fct<$int,$int> f = $lambda($operator,String,+,String,String);\n");
        xml_.append("  $Fct<$int,$int> f = $lambda($operator,String,*,String,String);\n");
        xml_.append("  $Fct<$int,$int> f = $lambda($operator,String,*,String);\n");
        xml_.append("  $var f = $lambda(Ex,=,ExTwo);\n");
        xml_.append("  f.call($that(e[0]),$new(6));\n");
        xml_.append("  $return e[0].f;\n");
        xml_.append(" }\n");
