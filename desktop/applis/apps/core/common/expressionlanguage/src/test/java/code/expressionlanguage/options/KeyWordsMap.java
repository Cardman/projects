...
//        stds.put("en", _lgNames);
    ...
    public static void initFrStds(LgNames _lgNames) {
        ...
        _lgNames.getContent().getReflect().setAliasGetDeclaredAnonymousLambdaLocalVarsNb("valLocalVarsLambdaAnonymesDeclaresNb");
        ...
        _lgNames.getContent().getReflect().setAliasGetDeclaredSwitchMethods("valMethodesSelon");
        ...
        _lgNames.getContent().getCoreNames().setAliasRangeStep("pas");
        _lgNames.getContent().getCoreNames().setAliasRangeUnlimited("illimite");
        _lgNames.getContent().getCoreNames().setAliasRangeUnlimitedStep("illimitePas");
