...
public final class KeyWordsMap {
    ...
    public void initEnStds(LgNames _lgNames) {
        ...
        _lgNames.setAliasEnumType("$core.$en");
        ...
        _lgNames.setAliasCastType("$core.BadCast");
        ...
        _lgNames.setAliasClassType("$core.Class");
        ...
        _lgNames.setAliasAnnotationType("$core.Annotation");
    ...
    public void initFrStds(LgNames _lgNames) {
        ...
        _lgNames.setAliasToStringMethod("chaine");
        ...
        _lgNames.setAliasEnumType("$coeur.$en");
        ...
        _lgNames.setAliasCastType("$coeur.MauvaisTranstype");
        ...
        _lgNames.setAliasClassType("$coeur.Classe");
        ...
        _lgNames.setAliasMetaInfo("metaInfo");
        _lgNames.setAliasInstance("instance");
        _lgNames.setAliasAnnotationType("$coeur.Annotation");
        ...
        _lgNames.setAliasGetDeclaredTrueOperators("valOperateursVraiDeclares");
        _lgNames.setAliasGetDeclaredFalseOperators("valOperateursFauxDeclares");
