...
public class LgNamesTest extends ProcessMethodCommon {
    ...
    public void fail69Test() {
        ...
        lgName_.getNbAlias().getParams().setAliasByte2ParseByte0("");
        lgName_.getNbAlias().getParams().setAliasByte2ParseByte1("");
        lgName_.getNbAlias().getParams().setAliasByte2ParseByte2("");
        ...
        lgName_.getNbAlias().getParams().setAliasByte2ParseByteOrNull0("");
        lgName_.getNbAlias().getParams().setAliasByte2ParseByteOrNull1("");
        lgName_.getNbAlias().getParams().setAliasByte2ParseByteOrNull2("");
        ...
        lgName_.getNbAlias().getParams().setAliasShort2ParseShort0("");
        lgName_.getNbAlias().getParams().setAliasShort2ParseShort1("");
        lgName_.getNbAlias().getParams().setAliasShort2ParseShort2("");
        ...
        lgName_.getNbAlias().getParams().setAliasShort2ParseShortOrNull0("");
        lgName_.getNbAlias().getParams().setAliasShort2ParseShortOrNull1("");
        lgName_.getNbAlias().getParams().setAliasShort2ParseShortOrNull2("");
        ...
        lgName_.getNbAlias().getParams().setAliasInteger2ParseInt0("");
        lgName_.getNbAlias().getParams().setAliasInteger2ParseInt1("");
        lgName_.getNbAlias().getParams().setAliasInteger2ParseInt2("");
        ...
        lgName_.getNbAlias().getParams().setAliasInteger2ParseIntOrNull0("");
        lgName_.getNbAlias().getParams().setAliasInteger2ParseIntOrNull1("");
        lgName_.getNbAlias().getParams().setAliasInteger2ParseIntOrNull2("");
        ...
        lgName_.getNbAlias().getParams().setAliasLong2ToStringMethod0("");
        lgName_.getNbAlias().getParams().setAliasLong2ToStringMethod1("");
        lgName_.getNbAlias().getParams().setAliasLong2ToStringMethod2("");
        ...
        lgName_.getNbAlias().getParams().setAliasLong2ParseLong0("");
        lgName_.getNbAlias().getParams().setAliasLong2ParseLong1("");
        lgName_.getNbAlias().getParams().setAliasLong2ParseLong2("");
        ...
        lgName_.getNbAlias().getParams().setAliasLong2ParseLongOrNull0("");
        lgName_.getNbAlias().getParams().setAliasLong2ParseLongOrNull1("");
        lgName_.getNbAlias().getParams().setAliasLong2ParseLongOrNull2("");
        ...
        lgName_.getNbAlias().getParams().setAliasByte1ToHexString0("");
        lgName_.getNbAlias().getParams().setAliasByte1ToHexString1("");
        ...
        lgName_.getNbAlias().getParams().setAliasShort1ToHexString0("");
        lgName_.getNbAlias().getParams().setAliasShort1ToHexString1("");
        ...
        lgName_.getNbAlias().getParams().setAliasInteger1ToHexString0("");
        lgName_.getNbAlias().getParams().setAliasInteger1ToHexString1("");
        ...
        lgName_.getNbAlias().getParams().setAliasLong1ToHexString0("");
        lgName_.getNbAlias().getParams().setAliasLong1ToHexString1("");
        ...
        lgName_.getNbAlias().getParams().setAliasCharacter1Digit0("");
        lgName_.getNbAlias().getParams().setAliasCharacter1Digit1("");
        lgName_.getNbAlias().getParams().setAliasCharacter1Digit2("");
        lgName_.getNbAlias().getParams().setAliasCharacter0ForDigit0("");
        lgName_.getNbAlias().getParams().setAliasCharacter0ForDigit1("");
        lgName_.getNbAlias().getParams().setAliasCharacter1ForDigit0("");
        lgName_.getNbAlias().getParams().setAliasCharacter1ForDigit1("");
        lgName_.getNbAlias().getParams().setAliasCharacter1ForDigit2("");
        ...
        lgName_.getReflect().getParams().setAliasClassType1ArrayGet0("");
        lgName_.getReflect().getParams().setAliasClassType1ArrayGet1("");
        lgName_.getReflect().getParams().setAliasClassType1ArraySet0("");
        lgName_.getReflect().getParams().setAliasClassType1ArraySet1("");
        lgName_.getReflect().getParams().setAliasClassType1ArraySet2("");
...
//        page_.setMappingAliases(LgNamesContent.mapping());
        ...
        Struct ret_ = ProcessMethod.calculate(new CustomFoundMethod(NullStruct.NULL_VALUE, new ExecFormattedRootBlock(classBody_, "pkg.Ex"), new ExecTypeFunction(classBody_, method_), new Parameters()), ctx_.getContext(), stackCall_).getValue();
...
//        page_.setMappingAliases(LgNamesContent.mapping());
    ...
    public void success3Test() {
        ...
        Struct ret_ = ExecClassesUtil.tryInitStaticlyTypes(res_.getContext(), res_.getForwards().getOptions(),stackCall_,new CustomFoundMethod(NullStruct.NULL_VALUE, new ExecFormattedRootBlock(classBody_, "pkg.Ex"), new ExecTypeFunction(classBody_, method_), new Parameters()),StepDbgActionEnum.RUN,true).getStack().aw().getValue();
        assertNull(stackCall_.getCallingState());
        assertEq(2, getNumber(ret_));
    }
    @Test
    public void success4Test() {
        ...
        CustomFoundMethod cf_ = new CustomFoundMethod(NullStruct.NULL_VALUE, new ExecFormattedRootBlock(classBody_, "pkg.Ex"), new ExecTypeFunction(classBody_, method_), new Parameters());
...
//        page_.setMappingAliases(LgNamesContent.mapping());
    ...
    @Test
    public void parseLineArg25Test() {
        StringList args_ = ParseLinesArgUtil.parseLineArg(app(),"first_arg second_arg\\+00012");
        assertEq(2, args_.size());
        assertEq("first_arg", args_.get(0));
        assertEq("second_arg\n", args_.get(1));
    }
    @Test
    public void parseLineArg26Test() {
        StringList args_ = ParseLinesArgUtil.parseLineArg(app(),"first_arg second_arg\\+00012v");
        assertEq(2, args_.size());
        assertEq("first_arg", args_.get(0));
        assertEq("second_arg\nv", args_.get(1));
    }
    @Test
    public void parseLineArg27Test() {
        StringList args_ = ParseLinesArgUtil.parseLineArg(app(),"first_arg second_arg\\+00012");
        assertEq(2, args_.size());
        assertEq("first_arg", args_.get(0));
        assertEq("second_arg\n", args_.get(1));
    ...
    @Test
    public void parseLineArg28Test() {
        StringList args_ = ParseLinesArgUtil.parseLineArg(app(),"first_arg second_arg\\+00012v");
        assertEq(2, args_.size());
        assertEq("first_arg", args_.get(0));
        assertEq("second_arg\nv", args_.get(1));
    ...
    @Test
    public void parseLineArg29Test() {
        StringList args_ = ParseLinesArgUtil.parseLineArg(app(),"first_arg second_arg\\-00012");
        assertEq(2, args_.size());
        assertEq("first_arg", args_.get(0));
        assertEq("second_arg"+(char)32778, args_.get(1));
    }
    @Test
    public void parseLineArg30Test() {
        StringList args_ = ParseLinesArgUtil.parseLineArg(app(),"first_arg second_arg\\+0001");
        assertEq(2, args_.size());
        assertEq("first_arg", args_.get(0));
        assertEq("second_arg+0001", args_.get(1));
    }
    @Test
    public void parseLineArg31Test() {
        StringList args_ = ParseLinesArgUtil.parseLineArg(app(),"first_arg second_arg\\+00018");
        assertEq(2, args_.size());
        assertEq("first_arg", args_.get(0));
        assertEq("second_arg+00018", args_.get(1));
    }
    @Test
    ...
    @Test
    public void parseValue24Test() {
        assertEq("first_arg\n", ParseLinesArgUtil.parseValue(app(),"first_arg\\+00012"));
    }
    @Test
    public void parseValue25Test() {
        assertEq("first_arg\nafter", ParseLinesArgUtil.parseValue(app(),"first_arg\\+00012after"));
    }
    @Test
    public void parseValue26Test() {
        assertEq("first_arg\n", ParseLinesArgUtil.parseValue(app(),"first_arg\\+00012"));
    }
    @Test
    public void parseValue27Test() {
        assertEq("first_arg\nafter", ParseLinesArgUtil.parseValue(app(),"first_arg\\+00012after"));
    }
    @Test
    public void parseValue28Test() {
        assertEq("first_arg"+(char)32778, ParseLinesArgUtil.parseValue(app(),"first_arg\\-00012"));
    }
    @Test
    public void parseValue29Test() {
        assertEq("first_arg-0001", ParseLinesArgUtil.parseValue(app(),"first_arg\\-0001"));
    }
    @Test
    public void parseValue30Test() {
        assertEq("first_arg-00018", ParseLinesArgUtil.parseValue(app(),"first_arg\\-00018"));
    }
    @Test
    ...
    public void exportLineArg1Test() {
        assertEq("\\+00040", ParseLinesArgUtil.exportLineArg(new StringList(" ")));
    }
    @Test
    public void exportLineArg2Test() {
        assertEq("\\+00134", ParseLinesArgUtil.exportLineArg(new StringList("\\")));
    }
    @Test
    public void exportLineArg3Test() {
        assertEq("\\+00012", ParseLinesArgUtil.exportLineArg(new StringList("\n")));
    }
    @Test
    public void exportLineArg4Test() {
        assertEq("\\+00011", ParseLinesArgUtil.exportLineArg(new StringList("\t")));
    }
    @Test
    ...
    public void exportMapLine2Test() {
        StringMap<String> map_ = new StringMap<String>();
        map_.addEntry("k",",");
        assertEq("k=\\+00054", ParseLinesArgUtil.buildMapLine(map_));
    }
    @Test
    ...
    public void exportComment1Test() {
        ...
        assertEq("\\+00134,\\+00012", ParseLinesArgUtil.buildCommentsLine(comments_));
    }
    @Test
    public void exportComment2Test() {
        CustList<CommentDelimiters> comments_ = new CustList<CommentDelimiters>();
        comments_.add(new CommentDelimiters("\\*",new StringList("*\\")));
        assertEq("\\+00134*,*\\+00134", ParseLinesArgUtil.buildCommentsLine(comments_));
    }
    @Test
    public void exportComment3Test() {
        CustList<CommentDelimiters> comments_ = new CustList<CommentDelimiters>();
        comments_.add(new CommentDelimiters("\\ ;",new StringList(", \\")));
        assertEq("\\+00134\\+00040\\+00073,\\+00054\\+00040\\+00134", ParseLinesArgUtil.buildCommentsLine(comments_));
    }
    @Test
    ...
    public void patchDisplayingHex1() {
        assertEq(MessagesCdmBase.DEF_ALPHA_HEX, DisplayedStrings.patchAlphaHex("0", MessagesCdmBase.DEF_ALPHA_HEX));
    }
    @Test
    public void patchDisplayingHex2() {
        assertEq(MessagesCdmBase.DEF_ALPHA_HEX, DisplayedStrings.patchAlphaHex(MessagesCdmBase.DEF_ALPHA_HEX, MessagesCdmBase.DEF_ALPHA_HEX));
    }
