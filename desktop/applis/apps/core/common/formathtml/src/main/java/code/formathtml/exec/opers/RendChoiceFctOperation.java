...
public final class RendChoiceFctOperation extends RendInvokingOperation implements RendCalculableOperation, RendCallable {
    ...
    public RendChoiceFctOperation(ExecNamedFunctionBlock _named, ExecRootBlock _rootBlock, ExecOperationContent _content, boolean _intermediateDottedOperation, ExecInstFctContent _instFctContent) {
    ...
    public Argument getArgument(Argument _previous, IdMap<RendDynOperationNode, ArgumentsPair> _all, Configuration _conf, Argument _right) {
        ...
        return ExecInvokingOperation.callPrepare(_context.getExiting(),_conf.getContext(), classNameFound_,rootBlock, prev_, firstArgs_, null,named,MethodAccessKind.INSTANCE, "");
    }
