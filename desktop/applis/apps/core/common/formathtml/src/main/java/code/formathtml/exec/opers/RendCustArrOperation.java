...
public final class RendCustArrOperation extends RendInvokingOperation implements RendCalculableOperation,RendSettableElResult {
    ...
    public void calculate(IdMap<RendDynOperationNode, ArgumentsPair> _nodes, ContextEl _context, RendStackCall _rendStack) {
        ...
        processCalling(this,_nodes,null, _context, _rendStack,readWrite.getRead(),readWrite.getInstRead());
    }
    ...
    public Argument calculateSetting(IdMap<RendDynOperationNode, ArgumentsPair> _nodes, Argument _right, ContextEl _context, RendStackCall _rendStack) {
         return processCalling(this,_nodes,_right, _context, _rendStack,readWrite.getWrite(),readWrite.getInstWrite());
    }

    static Argument processCalling(RendMethodOperation _ren, IdMap<RendDynOperationNode, ArgumentsPair> _nodes, Argument _right, ContextEl _context, RendStackCall _rendStackCall, ExecTypeFunction _fctUse, ExecInstFctContent _insUse) {
        ...
        Argument result_ = ExecCustArrOperation.redirect(_context, _rendStackCall.getStackCall(), _fctUse,_insUse, argumentParent_.getStruct(), ArgumentListCall.wrapCall(argumentList_,_right));
