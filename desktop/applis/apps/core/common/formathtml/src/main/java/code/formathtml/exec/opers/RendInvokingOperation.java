...
public abstract class RendInvokingOperation extends RendMethodOperation implements RendPossibleIntermediateDotted {
    ...
    public ArgumentListCall fectchArgs(IdMap<RendDynOperationNode, ArgumentsPair> _nodes, String _lastType, int _naturalVararg, RendStackCall _rendStackCall,Argument _right, ContextEl _conf, StackCall _stack) {
        ...
        ExecInvokingOperation.listArguments(argumentList_.getNaturalVararg(), _lastType, first_,_conf,_stack);
