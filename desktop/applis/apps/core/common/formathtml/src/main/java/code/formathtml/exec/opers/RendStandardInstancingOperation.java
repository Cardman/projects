...
public final class RendStandardInstancingOperation extends RendInvokingOperation implements RendCalculableOperation {
    ...
    public void calculate(IdMap<RendDynOperationNode, ArgumentsPair> _nodes, ContextEl _context, RendStackCall _rendStack) {
        ...
        Argument result_ = ParamCheckerUtil.prep(_context,_rendStack.getStackCall(),previous_, StackCall.formatVarType(_rendStack,formattedType),infos_,instancingCommonContent,instancingStdContent);
