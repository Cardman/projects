...
public final class RendValuesOperation extends RendLeafOperation implements RendCalculableOperation {
    ...
    public void calculate(IdMap<RendDynOperationNode, ArgumentsPair> _nodes, ContextEl _context, RendStackCall _rendStack) {
        ...
        ArgumentWrapper argres_ = RendDynOperationNode.processCall(IndirectCalledFctUtil.tryGetEnumValues(_context.getExiting(), _context, valuesContent.getRootBlock(), ClassCategory.ENUM, _rendStack.getStackCall()), _context, _rendStack);
