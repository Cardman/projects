...
public final class FctDocumentValidatorArray implements StdCaller {
    private final RendExecutingBlocks executingBlocks;

    public FctDocumentValidatorArray(RendExecutingBlocks _ex) {
        this.executingBlocks = _ex;
    }
    @Override
    public ArgumentWrapper call(AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        StringMap<Struct> renders_ = executingBlocks.getBuiltValidators();
