...
public abstract class CommonRender {
    ...
    protected static String getCommOneBean(String html_, StringMap<String> filesSec_) {
        ...
        b_.setExps(ops_);
        b_.setResolvedClassName(cont_.getAnalyzing().getCurrentRoot().getResultClass().getSingleNameOrEmpty());
    ...
    protected static String getResTwoPagesTwo(String folder_, String relative_, String html_, String htmlTwo_, StringMap<String> filesSec_) {
        ...
        b1_.setResolvedClassName(cont_.getAnalyzing().getCurrentRoot().getResultClass().getSingleNameOrEmpty());
        ...
        b2_.setResolvedClassName(cont_.getAnalyzing().getCurrentRoot().getResultClass().getSingleNameOrEmpty());
    ...
    protected static Struct getExThreeBeans(String folder_, String relative_, String html_, String htmlTwo_, String htmlThree_, StringMap<String> filesSec_) {
        ...
        b3_.setResolvedClassName(cont_.getAnalyzing().getCurrentRoot().getResultClass().getSingleNameOrEmpty());
