...
public final class InitializationLgNames {
    ...
    public static AnalyzedTestContext buildStdThree(Options _opt) {
        ...
        ContextFactory.validatedStds(a_, kw_, new CustList<CommentDelimiters>(), _opt, contextEl_.getClasses().getCommon(), new DefaultConstantsCalculator(lgNames_.getNbAlias()), BeanFileBuilder.newInstance(lgNames_.getContent(),lgNames_.getBeanAliases()), lgNames_.getContent(), tabWidth_, page_, new DefaultFieldFilter());
        lgNames_.build();
    ...
    private static void basicCustStandards(BeanCustLgNames _lgNames) {
        ...
        _lgNames.getBeanAliases().setAliasMapAddEntry("addEntry");
        _lgNames.getBeanAliases().setAliasMapGetValue("getValue");
        _lgNames.getBeanAliases().setAliasMapFirstValue("firstValue");
        _lgNames.getBeanAliases().setAliasMapLastValue("lastValue");
        _lgNames.getBeanAliases().setAliasMapSetValue("setValue");
        _lgNames.getBeanAliases().setAliasMapPut("put");
        _lgNames.getBeanAliases().setAliasMapPutAll("putAll");
        _lgNames.getBeanAliases().setAliasMapContains("contains");
        _lgNames.getBeanAliases().setAliasMapGetVal("getVal");
        _lgNames.getBeanAliases().setAliasMapRemoveKey("removeKey");
        _lgNames.getBeanAliases().setAliasMapGetKey("getKey");
        _lgNames.getBeanAliases().setAliasMapFirstKey("firstKey");
        _lgNames.getBeanAliases().setAliasMapLastKey("lastKey");
        _lgNames.getBeanAliases().setAliasMapSetKey("setKey");
        _lgNames.getBeanAliases().setAliasMapSize("size");
        _lgNames.getBeanAliases().setAliasMapIsEmpty("isEmpty");
        ...
        _lgNames.getBeanAliases().setAliasLanguage("language");
        _lgNames.getBeanAliases().setAliasGetLanguage("getLanguage");
        _lgNames.getBeanAliases().setAliasSetLanguage("setLanguage");
        _lgNames.getBeanAliases().setAliasScope("scope");
        _lgNames.getBeanAliases().setAliasGetScope("getScope");
        _lgNames.getBeanAliases().setAliasSetScope("setScope");
        _lgNames.getBeanAliases().setAliasDataBaseField("dataBase");
        _lgNames.getBeanAliases().setAliasGetDataBase("getDataBase");
        ...
        _lgNames.getBeanAliases().setAliasMessageSetArgs("setArgs");
    }
