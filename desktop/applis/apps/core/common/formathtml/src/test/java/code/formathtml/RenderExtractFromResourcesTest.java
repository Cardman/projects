...
public final class RenderExtractFromResourcesTest {
    ...
    public void indexCorrectMessages1Test() {
        assertEq(-1,RendExtractFromResources.indexCorrectMessages("first=k\nsecond=v"));
    }
    @Test
    ...
    public void indexCorrectMessages4Test() {
        assertEq(1,RendExtractFromResources.indexCorrectMessages("first"));
    }
    @Test
    public void getMessages1Test() {
        StringMap<String> messages_ = RendExtractFromResources.getMessages("first=k\nsecond=v");
    ...
    public void getMessages4Test() {
        StringMap<String> messages_ = RendExtractFromResources.getMessages("\t second\nfirst=k");
        assertEq(1,messages_.size());
        assertEq("first",messages_.getKey(0));
        assertEq("k",messages_.getValue(0));
    }
