...
public final class RenderInitStdsTest extends CommonRender {
    ...
    public void process6Test() {
        ...
        int tabWidth_ = 4;
        ContextEl contextEl_ = ContextFactory.simpleBuild(-1, lk_, di_, options_, b_, tabWidth_, com_);
        AnalyzedPageEl page_ = ContextFactory.validateStds(am_, k_, b_, new CustList<CommentDelimiters>(), options_, com_, null, BeanFileBuilder.newInstance(b_.getContent(),b_.getBeanAliases()), b_.getContent(), tabWidth_);
    ...
    private boolean contextEl(StringMap<String> _files, Options _opt, BeanCustLgNames _beanLgNames, AnalysisMessages _mess, KeyWords _kw, AbstractConstantsCalculator _calculator) {
        ...
        ClassesCommon com_ = new ClassesCommon();
        int tabWidth_ = 4;
        ContextEl contextEl_ = ContextFactory.simpleBuild(-1, lk_, di_, _opt, _beanLgNames, tabWidth_, com_);
        AnalyzedPageEl page_ = ContextFactory.validateStds(_mess, _kw, _beanLgNames, new CustList<CommentDelimiters>(), _opt, com_, _calculator, BeanFileBuilder.newInstance(_beanLgNames.getContent(),_beanLgNames.getBeanAliases()), _beanLgNames.getContent(), tabWidth_);
