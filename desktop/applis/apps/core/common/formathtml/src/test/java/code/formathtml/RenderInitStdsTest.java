...
public final class RenderInitStdsTest extends CommonRender {
    ...
    public void process6Test() {
        ...
        AnalyzedPageEl page_ = ContextFactory.validateStds(am_, k_, b_, new CustList<CommentDelimiters>(), options_, com_, null, new BeanFileBuilder(b_.getContent(),b_.getBeanAliases()), b_.getContent(), tabWidth_);
    ...
    private boolean contextEl(StringMap<String> _files, Options _opt, BeanCustLgNames _beanLgNames, AnalysisMessages _mess, KeyWords _kw, AbstractConstantsCalculator _calculator) {
        ...
        AnalyzedPageEl page_ = ContextFactory.validateStds(_mess, _kw, _beanLgNames, new CustList<CommentDelimiters>(), _opt, com_, _calculator, new BeanFileBuilder(_beanLgNames.getContent(),_beanLgNames.getBeanAliases()), _beanLgNames.getContent(), tabWidth_);
