...
public final class RenderInitStdsTest extends CommonRender {
    ...
    public void process6Test() {
        ...
        AnalyzedTestConfiguration a_ = new AnalyzedTestConfiguration(conf_, forwards_, b_, dual_, options_, page_);
    ...
    private boolean contextEl(StringMap<String> _files, Options _opt, BeanCustLgNames _beanLgNames, AnalysisMessages _mess, KeyWords _kw, AbstractConstantsCalculator _calculator) {
        ...
        ValidatorStandard.setupOverrides(page_);
        DualConfigurationContext dual_ = new DualConfigurationContext();
        AnalyzedTestConfiguration a_ = new AnalyzedTestConfiguration(conf_, forwards_, _beanLgNames, dual_, _opt, page_);
