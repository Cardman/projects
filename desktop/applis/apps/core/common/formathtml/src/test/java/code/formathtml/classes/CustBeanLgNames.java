...
public final class CustBeanLgNames extends BeanNatLgNames {
    ...
    private void buildBeanOne() {
        ...
        method_ = new StandardMethod(GET_DOUBLE,params_,getAliasPrimInteger(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(VALIDATE_STRINGS,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private void buildBeanTwo() {
        ...
        fields_.add(new StandardField(NULLABLE_CHECKBOX,getAliasBoolean(),false,false,cl_));
        fields_.add(new StandardField(NULLABLE_INT,getAliasLong(),false,false,cl_));
        fields_.add(new StandardField(RATE,TYPE_RATE,false,false,cl_));
        fields_.add(new StandardField(TYPED_INT,getAliasPrimInteger(),false,false,cl_));
        fields_.add(new StandardField(TYPED_SHORT,getAliasPrimShort(),false,false,cl_));
        ...
        methods_.add( method_);
        params_ = new StringList(getAliasPrimInteger());
        method_ = new StandardMethod(SET_TYPED_INT,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(SET_TYPED_STRING,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(VALIDATE,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private void buildBeanThree() {
        ...
        fields_.add(new StandardField(INDEX,getAliasPrimInteger(),false,false,cl_));
        fields_.add(new StandardField(INDEX_TWO,getAliasPrimInteger(),false,false,cl_));
    ...
    private void buildBeanFour() {
        ...
        params_ = new StringList(getAliasInteger());
        method_ = new StandardMethod(SET_INVISIBLE_FIELD,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(getAliasPrimInteger());
        method_ = new StandardMethod(SET_INVISIBLE_INT_FIELD,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(SETTER,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private void buildBeanSeven() {
        ...
        method_ = new StandardMethod(GET_DOUBLE,params_,getAliasPrimDouble(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        ...
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(VALIDATE_INTS_SAVE,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(VALIDATE_MAP,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(VALIDATE_STRINGS,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(VALIDATE_STRINGS_SAVE,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private void buildBeanEight() {
        ...
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_RADIO_LONG,params_,getAliasPrimLong(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(SET_CHECK_BOX,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(TYPE_ENUM_NUMBER);
        method_ = new StandardMethod(SET_COMBO_NUMBER,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(TYPE_ENUM_NUMBER);
        method_ = new StandardMethod(SET_COMBO_NUMBER_TWO,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(TYPE_ENUM_NUMBERS);
        method_ = new StandardMethod(SET_COMBO_NUMBERS,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(getAliasPrimLong());
        method_ = new StandardMethod(SET_RADIO_LONG,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(SET_TYPED_STRING,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(SET_TYPED_TEXT,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
    ...
    private void buildComposite() {
        ...
        fields_.add(new StandardField(INTEGER,getAliasPrimInteger(),false,false,cl_));
        fields_.add(new StandardField(MAP, TYPE_MAP,false,false,cl_));
        fields_.add(new StandardField(MY_CHAR,getAliasPrimChar(),false,false,cl_));
        ...
        methods_.add( method_);
        params_ = new StringList(getAliasPrimInteger());
        method_ = new StandardMethod(SUMMUM,params_,getAliasPrimInteger(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(getAliasPrimInteger());
        method_ = new StandardMethod(GET_STRING_ELT,params_,getAliasString(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(SET_STRING,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList("code.formathtml.util.ValueChangeEvent");
        method_ = new StandardMethod(UPDATE_VALUE,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(getAliasString());
    ...
    private void buildBeanUtil() {
        ...
        params_ = new StringList(getAliasPrimInteger(),getAliasPrimInteger());
        method_ = new StandardMethod(SUM,params_,getAliasPrimInteger(), false, MethodModifier.STATIC);
        methods_.add( method_);
    ...
    private void buildGeneObjs() {
        ...
        method_ = new StandardMethod(ADD,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList(getAliasPrimInteger());
    ...
    private void buildGeneObjects() {
        ...
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(CLEAR,params_,getAliasVoid(), false, MethodModifier.NORMAL);
        methods_.add( method_);
        params_ = new StringList();
        ctor_ = new StandardConstructor(params_,false);
        constructors_.add(ctor_);
    ...
    private void buildSimpleDataBase() {
        ...
        params_ = new StringList();
        method_ = new StandardMethod(GET_VALUE,params_,getAliasPrimInteger(), false, MethodModifier.NORMAL);
        methods_.add( method_);
