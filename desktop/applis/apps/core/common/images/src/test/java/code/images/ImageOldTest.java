...
public class ImageOldTest extends EquallableImageUtil {

    @Test
    public void newImage1Test() {
        ImageOld img_ = new ImageOld("0");
    ...
    public void newImage2Test() {
        ImageOld img_ = new ImageOld(StringUtil.concat("1",String.valueOf(ImageOld.SEPARATOR_CHAR),"2"));
    ...
    public void newImage3Test() {
        ImageOld img_ = new ImageOld(StringUtil.concat("1",String.valueOf(ImageOld.SEPARATOR_CHAR),"2",String.valueOf(ImageOld.SEPARATOR_CHAR),"3"));
        assertEq(1, img_.getWidth());
    ...
    public void newImage4Test() {
        ImageOld img_ = new ImageOld(StringUtil.concat("2",String.valueOf(ImageOld.SEPARATOR_CHAR),"3",String.valueOf(ImageOld.SEPARATOR_CHAR),"4"));
    ...
    public void isValid1Test() {
        ImageOld img_ = new ImageOld(StringUtil.concat("0",String.valueOf(ImageOld.SEPARATOR_CHAR),"1"));
    ...
    public void isValid3Test() {
        ImageOld img_ = new ImageOld(StringUtil.concat("1",String.valueOf(ImageOld.SEPARATOR_CHAR),"1"));
        assertTrue(img_.isValid());
    }

    @Test
    public void isValid4Test() {
        ImageOld img_ = new ImageOld("1");
        assertTrue(!img_.isValid());
    }

    @Test
    public void isValid5Test() {
        ImageOld img_ = new ImageOld(StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR),"4",String.valueOf(ImageOld.SEPARATOR_CHAR),"5"));
        assertTrue(!img_.isValid());
    }
    ...
    public void isValid6Test() {
        ...
        ImageOld img_ = new ImageOld(StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR)));
        assertTrue(img_.isValid());
    }
    ...
    public void toString2Test() {
        ImageOld img_ = new ImageOld(StringUtil.concat("1",String.valueOf(ImageOld.SEPARATOR_CHAR),"2"));
        assertEq(StringUtil.concat("1",String.valueOf(ImageOld.SEPARATOR_CHAR),"2"), img_.display());
    }
    ...
    public void toString3Test() {
        StringList pixels_ = new StringList("1","2","1","2","1","2");
        ImageOld img_ = new ImageOld(StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR)));
        assertEq(StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR)), img_.display());
    }
    ...
    public void getDimensions1Test() {
        ...
        IntPoint dims_ = ImageOld.getDimensions(StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR)), 1);
    ...
    public void clip2Test() {
        StringList pixels_ = new StringList("1","2","6","9","-1","12");
        ImageOld img_ = new ImageOld(StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR)));
        assertEq(new ImageOld("0").display(), img_.clip(2, 2, 1, 1).display());
    }
    ...
    public void clip3Test() {
        StringList pixels_ = new StringList("1","2","6","9","-1","12");
        ImageOld img_ = new ImageOld(StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR)));
        assertEq(new ImageOld("0").display(), img_.clip(3, 1, 1, 1).display());
    }
    ...
    public void clip4Test() {
        StringList pixels_ = new StringList("1","2","6","9","-1","12");
        ImageOld img_ = new ImageOld(StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR)));
        ImageOld res_ = new ImageOld(StringUtil.concat("2",String.valueOf(ImageOld.SEPARATOR_CHAR),"-1",String.valueOf(ImageOld.SEPARATOR_CHAR),"12"));
    ...
    public void clip5Test() {
        StringList pixels_ = new StringList("1","2","6","9","-1","12");
        ImageOld img_ = new ImageOld(StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR)));
        ImageOld res_ = new ImageOld(StringUtil.concat("2",String.valueOf(ImageOld.SEPARATOR_CHAR),"2",String.valueOf(ImageOld.SEPARATOR_CHAR),"6",String.valueOf(ImageOld.SEPARATOR_CHAR),"-1",String.valueOf(ImageOld.SEPARATOR_CHAR),"12"));
    ...
    public void clip7Test() {
        StringList pixels_ = new StringList("1","2","6","9","-1","12");
        String img_ = StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        String res_ = StringUtil.concat("2",String.valueOf(ImageOld.SEPARATOR_CHAR),"2",String.valueOf(ImageOld.SEPARATOR_CHAR),"6",String.valueOf(ImageOld.SEPARATOR_CHAR),"-1",String.valueOf(ImageOld.SEPARATOR_CHAR),"12");
        assertEq(res_, ImageOld.clip(img_, 1, 0, 3, 3));
    }
    ...
    public void isValidNotEmpty1Test() {
        ...
        String img_ = StringUtil.concat("0",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        assertTrue(!ImageOld.isValidNotEmpty(img_, 5));
    }

    @Test
    public void isValidNotEmpty2Test() {
        assertTrue(!ImageOld.isValidNotEmpty("0", 5));
    }

    @Test
    public void isValidNotEmpty3Test() {
        assertTrue(!ImageOld.isValidNotEmpty("", 5));
    }
    ...
    public void isValidNotEmpty5Test() {
        ...
        String img_ = StringUtil.concat("1",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        assertTrue(!ImageOld.isValidNotEmpty(img_, 5));
    }
    ...
    public void isValidNotEmpty9Test() {
        StringList pixels_ = new StringList("1");
        String img_ = StringUtil.concat("5",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        assertTrue(!ImageOld.isValidNotEmpty(img_, 5));
    }
    ...
    public void isValidNotEmpty10Test() {
        ...
        String img_ = StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        assertTrue(ImageOld.isValidNotEmpty(img_, 3));
    }
    ...
    public void isValidNotEmpty11Test() {
        StringList pixels_ = new StringList();
        String img_ = StringUtil.concat("0",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        assertTrue(!ImageOld.isValidNotEmpty(img_, 5, 3));
    }

    @Test
    public void isValidNotEmpty12Test() {
        assertTrue(!ImageOld.isValidNotEmpty("0", 5, 3));
    }

    @Test
    public void isValidNotEmpty13Test() {
        assertTrue(!ImageOld.isValidNotEmpty("", 5, 3));
    }
    ...
    public void isValidNotEmpty20Test() {
        ...
        String img_ = StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        assertTrue(ImageOld.isValidNotEmpty(img_, 3, 2));
    }
    ...
    public void isValidNotEmptyLower1Test() {
        StringList pixels_ = new StringList();
        String img_ = StringUtil.concat("0",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        assertTrue(!ImageOld.isValidNotEmptyLower(img_, 5));
    }

    @Test
    public void isValidNotEmptyLower2Test() {
        assertTrue(!ImageOld.isValidNotEmptyLower("0", 5));
    }

    @Test
    public void isValidNotEmptyLower3Test() {
        assertTrue(!ImageOld.isValidNotEmptyLower("", 5));
    }
    ...
    public void isValidNotEmptyLower10Test() {
        StringList pixels_ = new StringList("1","2","3","4","-5","-6","-7","-8","-9");
        String img_ = StringUtil.concat("3",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        assertTrue(ImageOld.isValidNotEmptyLower(img_, 3));
    }

    @Test
    public void isValidNotEmptyLower11Test() {
        StringList pixels_ = new StringList("1","2","3","4","-5","-6","-7","-8","-9");
        String img_ = StringUtil.concat("4",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        assertTrue(!ImageOld.isValidNotEmptyLower(img_, 3));
    }
    ...
    public void isValidNotEmptyLower12Test() {
        StringList pixels_ = new StringList("1","2","3","4","-5","-6","-7","-8","-9");
        String img_ = StringUtil.concat("2",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        assertTrue(!ImageOld.isValidNotEmptyLower(img_, 3));
    }
    ...
    public void isValidNotEmptyLower14Test() {
        StringList pixels_ = new StringList("1","2","3","1","2","3","4","-5","-6","-7","-8","-9");
        String img_ = StringUtil.concat("6",String.valueOf(ImageOld.SEPARATOR_CHAR), StringUtil.join(pixels_, ImageOld.SEPARATOR_CHAR));
        assertTrue(!ImageOld.isValidNotEmptyLower(img_, 3));
    }
}
