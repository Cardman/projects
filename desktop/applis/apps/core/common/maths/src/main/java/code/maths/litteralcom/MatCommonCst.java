...
public final class MatCommonCst {
    ...
    public static final int ASS_PRIO = 2;
    public static final int OR_PRIO = 3;
    public static final int AND_PRIO = 4;
    public static final int EQ_PRIO = 5;
    public static final int CMP_PRIO = 6;
    public static final int ADD_PRIO = 7;
    public static final int MULT_PRIO = 8;
    public static final int UNARY_PRIO = 9;
    public static final int FACT_PRIO = 10;
    public static final int FCT_OPER_PRIO = 11;
    ...
    public static final char BRA_LEFT = '{';
    public static final char BRA_RIGHT = '}';
    public static final char SEP_ARG = ',';
    public static final char SEP_ARG_BRA = ';';
