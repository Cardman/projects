...
public class LgIntTest extends EquallableMathUtil {
    ...
    public void new_LgInt_1(){
        ...
        assertEq(LgInt.SIGNE_POSITIF,entier_.isSignum());
    ...
    public void new_LgInt_long_2Test(){
        ...
        Longs resDigits_ = int_.getGrDigits();
        assertEqDigits(Longs.newList(0L), resDigits_);
        assertEq(LgInt.SIGNE_POSITIF, int_.isSignum());
    }
    @Test
    ...
    public void new_LgInt_long_6Test(){
        ...
        Longs resDigits_ = int_.getGrDigits();
        assertEqDigits(Longs.newList(9L,223372036L,854775807L), resDigits_);
        assertEq(LgInt.SIGNE_POSITIF, int_.isSignum());
    }
    @Test
    ...
    public void new_LgInt_copy_Test() {
        ...
        assertEqDigits(Longs.newList(2L), resDigits_);
        assertEq(LgInt.SIGNE_POSITIF, j_.isSignum());
...
//        repartitions_.add(new LgInt(14));
    ...
    public void seqAmong2(){
        ...
        assertEq(5, count(combinatoire_, 0));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 0, 0));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 0, 1));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 0, 2));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 0, 3));
        assertEq(new LgInt(8), eltEvt(combinatoire_, 0, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 0));
        assertEq(5, count(combinatoire_, 1));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 1, 0));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 1, 1));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 1, 2));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 1, 3));
        assertEq(new LgInt(7), eltEvt(combinatoire_, 1, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 1));
        assertEq(5, count(combinatoire_, 2));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 2, 0));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 2, 1));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 2, 2));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 2, 3));
        assertEq(new LgInt(6), eltEvt(combinatoire_, 2, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 2));
        assertEq(5, count(combinatoire_, 3));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 3, 0));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 3, 1));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 3, 2));
        assertEq(new LgInt(3), eltEvt(combinatoire_, 3, 3));
        assertEq(new LgInt(5), eltEvt(combinatoire_, 3, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 3));
        assertEq(5, count(combinatoire_, 4));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 4, 0));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 4, 1));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 4, 2));
        assertEq(new LgInt(4), eltEvt(combinatoire_, 4, 3));
        assertEq(new LgInt(4), eltEvt(combinatoire_, 4, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 4));
        assertEq(5, count(combinatoire_, 5));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 5, 0));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 5, 1));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 5, 2));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 5, 3));
        assertEq(new LgInt(6), eltEvt(combinatoire_, 5, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 5));
        assertEq(5, count(combinatoire_, 6));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 6, 0));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 6, 1));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 6, 2));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 6, 3));
        assertEq(new LgInt(5), eltEvt(combinatoire_, 6, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 6));
        assertEq(5, count(combinatoire_, 7));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 7, 0));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 7, 1));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 7, 2));
        assertEq(new LgInt(3), eltEvt(combinatoire_, 7, 3));
        assertEq(new LgInt(4), eltEvt(combinatoire_, 7, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 7));
        assertEq(5, count(combinatoire_, 8));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 8, 0));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 8, 1));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 8, 2));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 8, 3));
        assertEq(new LgInt(4), eltEvt(combinatoire_, 8, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 8));
        assertEq(5, count(combinatoire_, 9));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 9, 0));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 9, 1));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 9, 2));
        assertEq(new LgInt(3), eltEvt(combinatoire_, 9, 3));
        assertEq(new LgInt(3), eltEvt(combinatoire_, 9, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 9));
        assertEq(5, count(combinatoire_, 10));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 10, 0));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 10, 1));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 10, 2));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 10, 3));
        assertEq(new LgInt(5), eltEvt(combinatoire_, 10, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 10));
        assertEq(5, count(combinatoire_, 11));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 11, 0));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 11, 1));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 11, 2));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 11, 3));
        assertEq(new LgInt(4), eltEvt(combinatoire_, 11, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 11));
        assertEq(5, count(combinatoire_, 12));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 12, 0));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 12, 1));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 12, 2));
        assertEq(new LgInt(3), eltEvt(combinatoire_, 12, 3));
        assertEq(new LgInt(3), eltEvt(combinatoire_, 12, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 12));
        assertEq(5, count(combinatoire_, 13));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 13, 0));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 13, 1));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 13, 2));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 13, 3));
        assertEq(new LgInt(3), eltEvt(combinatoire_, 13, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 13));
        assertEq(5, count(combinatoire_, 14));
        assertEq(new LgInt(0), eltEvt(combinatoire_, 14, 0));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 14, 1));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 14, 2));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 14, 3));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 14, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 14));
        assertEq(5, count(combinatoire_, 15));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 15, 0));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 15, 1));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 15, 2));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 15, 3));
        assertEq(new LgInt(4), eltEvt(combinatoire_, 15, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 15));
        assertEq(5, count(combinatoire_, 16));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 16, 0));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 16, 1));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 16, 2));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 16, 3));
        assertEq(new LgInt(3), eltEvt(combinatoire_, 16, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 16));
        assertEq(5, count(combinatoire_, 17));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 17, 0));
        assertEq(new LgInt(1), eltEvt(combinatoire_, 17, 1));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 17, 2));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 17, 3));
        assertEq(new LgInt(2), eltEvt(combinatoire_, 17, 4));
        assertEq(new LgInt(478), freq(combinatoire_, 17));

    }

    private static LgInt freq(CustList<EventFreq<CustList<LgInt>>> _combinatoire, int _i) {
        return _combinatoire.get(_i).getFreq();
    }

    private static LgInt eltEvt(CustList<EventFreq<CustList<LgInt>>> _combinatoire, int _i, int _j) {
        return _combinatoire.get(_i).getEvent().get(_j);
    }

    private static int count(CustList<EventFreq<CustList<LgInt>>> _combinatoire, int _i) {
        return _combinatoire.get(_i).getEvent().size();
    }
    ...
    public void seqAmong3(){
        ...
        assertEq(0, count(combinatoire_,0));
