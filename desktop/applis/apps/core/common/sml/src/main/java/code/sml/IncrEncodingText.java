...
public final class IncrEncodingText extends AbstractEncodingText {
    ...
    protected void incr(String _htmlText, StringMap<String> _map, StringBuilder _str, int _iBegin, int _index) {
        incrInner(_htmlText, _map, _str, _iBegin, _index);
    }

    private static void incrInner(String _htmlText, StringMap<String> _map, StringBuilder _str, int _iBegin, int _index) {
