...
public final class RendKeyWordsTags {
    ...
    private String keyWordBreak;
    private String keyWordContinue;

    private String keyWordSet;
    private String keyWordImport;
    private String keyWordPackage;
    private String keyWordClass;
    private String keyWordField;
    private String keyWordForm;
    private String keyWordSubmit;
    private String keyWordImg;
    private String keyWordSelect;
    private String keyWordMessage;
    private String keyWordAnchor;
    private String keyWordInput;
    private String keyWordTextarea;
    ...
    private String keyWordMap;
    private String keyWordLi;
    private String keyWordOl;
    private String keyWordUl;
    private String keyWordBold;
    private String keyWordItalic;
    private String keyWordPre;
    private String keyWordHOne;
    private String keyWordHTwo;
    private String keyWordHThree;
    private String keyWordHFour;
    private String keyWordHFive;
    private String keyWordHSix;
    private String keyWordBr;
    private String keyWordHr;
    private String keyWordPar;
    private String keyWordTable;
    private String keyWordCaption;
    private String keyWordTd;
    private String keyWordTh;
    private String keyWordTr;
