...
//    }
    @Test
    public void buildQuickLong1Test() {
        assertEq(0, NumberUtil.buildQuickLong(Ints.newList(0),16));
    }
    @Test
    public void buildQuickLong2Test() {
        assertEq(10, NumberUtil.buildQuickLong(Ints.newList(10),16));
    }
    @Test
    public void buildQuickLong3Test() {
        assertEq(172, NumberUtil.buildQuickLong(Ints.newList(10,12),16));
    }
    @Test
