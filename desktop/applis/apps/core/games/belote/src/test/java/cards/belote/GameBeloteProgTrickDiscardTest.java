...
public final class GameBeloteProgTrickDiscardTest extends CommonGameBelote {
    ...
    public void defausseCouleurOrdinaireCouleurDominante3Test() {
        ...
        DealBelote deal_ = new DealBelote(new CustList<HandBelote>(),d_);
        deal_.getDeal().add(create(CardBelote.SPADE_1,CardBelote.SPADE_JACK,CardBelote.SPADE_8,CardBelote.SPADE_7,CardBelote.DIAMOND_1,CardBelote.DIAMOND_KING,CardBelote.DIAMOND_QUEEN,CardBelote.DIAMOND_JACK));
        deal_.getDeal().add(create(CardBelote.HEART_9,CardBelote.HEART_1,CardBelote.HEART_10,CardBelote.HEART_KING,CardBelote.HEART_QUEEN,CardBelote.HEART_8,CardBelote.HEART_7,CardBelote.SPADE_10));
        deal_.getDeal().add(create(CardBelote.SPADE_KING,CardBelote.SPADE_QUEEN,CardBelote.SPADE_9,CardBelote.DIAMOND_10,CardBelote.DIAMOND_9,CardBelote.DIAMOND_8,CardBelote.DIAMOND_7,CardBelote.CLUB_1));
        deal_.getDeal().add(create(CardBelote.HEART_JACK,CardBelote.CLUB_10,CardBelote.CLUB_KING,CardBelote.CLUB_JACK,CardBelote.CLUB_9,CardBelote.CLUB_8,CardBelote.CLUB_7));
        deal_.getDeal().add(create(CardBelote.HEART_JACK,CardBelote.CLUB_10,CardBelote.CLUB_KING,CardBelote.SPADE_1,CardBelote.SPADE_JACK,CardBelote.SPADE_8,CardBelote.HEART_9,CardBelote.HEART_1,CardBelote.HEART_10,CardBelote.SPADE_KING,CardBelote.SPADE_QUEEN,CardBelote.SPADE_9));
        GameBelote g_ = newGameBeloteWithourDecl(r_, trs_, pr_, d_, bids_, deal_);
        GameBeloteTeamsRelation team_ = g_.getTeamsRelation();
        GameBeloteTrickInfo info_ = newGameBeloteTrickInfo(g_);
        GameBeloteProgTrick gt_ = newGameBeloteProgTrickDeal(g_, info_, team_, h_);
    ...
    public void defausseAtoutCouleurDominante2Test() {
        ...
        deal_.getDeal().add(create(CardBelote.HEART_7,CardBelote.SPADE_10,CardBelote.SPADE_KING,CardBelote.SPADE_QUEEN,CardBelote.SPADE_9,CardBelote.DIAMOND_10,CardBelote.DIAMOND_9));
        deal_.getDeal().add(create(CardBelote.SPADE_1,CardBelote.SPADE_JACK,CardBelote.SPADE_8,CardBelote.SPADE_7,CardBelote.DIAMOND_1,CardBelote.DIAMOND_KING,CardBelote.DIAMOND_QUEEN,CardBelote.DIAMOND_JACK));
        deal_.getDeal().add(create(CardBelote.DIAMOND_8,CardBelote.DIAMOND_7,CardBelote.CLUB_9,CardBelote.CLUB_10,CardBelote.CLUB_KING,CardBelote.CLUB_8,CardBelote.CLUB_7));
        deal_.getDeal().add(create(CardBelote.CLUB_JACK,CardBelote.DIAMOND_8,CardBelote.DIAMOND_7,CardBelote.CLUB_9,CardBelote.HEART_1,CardBelote.HEART_10,CardBelote.HEART_7,CardBelote.SPADE_10,CardBelote.SPADE_KING,CardBelote.SPADE_1,CardBelote.SPADE_JACK,CardBelote.SPADE_8));
        GameBelote g_ = newGameBeloteWithourDecl(r_, trs_, pr_, d_, bids_, deal_);
        GameBeloteTeamsRelation team_ = g_.getTeamsRelation();
        GameBeloteTrickInfo info_ = newGameBeloteTrickInfo(g_);
        GameBeloteProgTrick gt_ = newGameBeloteProgTrickDeal(g_, info_, team_, h_);
    ...
    public void defausseAtoutCouleurDominante3Test() {
        ...
        deal_.getDeal().add(create(CardBelote.SPADE_10,CardBelote.SPADE_KING,CardBelote.SPADE_QUEEN,CardBelote.SPADE_9,CardBelote.DIAMOND_10,CardBelote.DIAMOND_9,CardBelote.DIAMOND_8,CardBelote.DIAMOND_7));
        deal_.getDeal().add(create(CardBelote.CLUB_JACK,CardBelote.CLUB_9,CardBelote.CLUB_1,CardBelote.CLUB_10,CardBelote.CLUB_KING,CardBelote.CLUB_8,CardBelote.CLUB_7));
        deal_.getDeal().add(create(CardBelote.CLUB_JACK,CardBelote.CLUB_9,CardBelote.CLUB_1,CardBelote.SPADE_1,CardBelote.SPADE_JACK,CardBelote.SPADE_8,CardBelote.HEART_1,CardBelote.HEART_10,CardBelote.HEART_KING,CardBelote.SPADE_10,CardBelote.SPADE_KING,CardBelote.SPADE_QUEEN));
        GameBelote g_ = newGameBeloteWithourDecl(r_, trs_, pr_, d_, bids_, deal_);
        GameBeloteTeamsRelation team_ = g_.getTeamsRelation();
        GameBeloteTrickInfo info_ = newGameBeloteTrickInfo(g_);
        GameBeloteProgTrick gt_ = newGameBeloteProgTrickDeal(g_, info_, team_, h_);
    ...
    public void defausseCouleurOrdinaireSansAtout2Test() {
        ...
        deal_.getDeal().add(create(CardBelote.HEART_7,CardBelote.SPADE_10,CardBelote.SPADE_KING,CardBelote.SPADE_QUEEN,CardBelote.SPADE_9,CardBelote.DIAMOND_10,CardBelote.DIAMOND_9));
        deal_.getDeal().add(create(CardBelote.SPADE_1,CardBelote.SPADE_JACK,CardBelote.SPADE_8,CardBelote.SPADE_7,CardBelote.DIAMOND_1,CardBelote.DIAMOND_KING,CardBelote.DIAMOND_QUEEN,CardBelote.DIAMOND_JACK));
        deal_.getDeal().add(create(CardBelote.DIAMOND_8,CardBelote.DIAMOND_7,CardBelote.CLUB_10,CardBelote.CLUB_KING,CardBelote.CLUB_9,CardBelote.CLUB_8,CardBelote.CLUB_7));
        deal_.getDeal().add(create(CardBelote.CLUB_1,CardBelote.DIAMOND_8,CardBelote.DIAMOND_7,CardBelote.CLUB_10,CardBelote.HEART_1,CardBelote.HEART_10,CardBelote.HEART_7,CardBelote.SPADE_10,CardBelote.SPADE_KING,CardBelote.SPADE_1,CardBelote.SPADE_JACK,CardBelote.SPADE_8));
        GameBelote g_ = newGameBeloteWithourDecl(r_, trs_, pr_, d_, bids_, deal_);
        GameBeloteTeamsRelation team_ = g_.getTeamsRelation();
        GameBeloteTrickInfo info_ = newGameBeloteTrickInfo(g_);
        GameBeloteProgTrick gt_ = newGameBeloteProgTrickDeal(g_, info_, team_, h_);
    ...
    public void defausseCouleurOrdinaireSansAtout3Test() {
        ...
        deal_.getDeal().add(create(CardBelote.HEART_1,CardBelote.HEART_10,CardBelote.HEART_KING,CardBelote.HEART_QUEEN,CardBelote.HEART_JACK,CardBelote.HEART_9,CardBelote.HEART_8,CardBelote.HEART_7));
        deal_.getDeal().add(create(CardBelote.SPADE_10,CardBelote.SPADE_KING,CardBelote.SPADE_QUEEN,CardBelote.SPADE_9,CardBelote.DIAMOND_10,CardBelote.DIAMOND_9,CardBelote.DIAMOND_8,CardBelote.DIAMOND_7));
        deal_.getDeal().add(create(CardBelote.CLUB_1,CardBelote.CLUB_10,CardBelote.CLUB_KING,CardBelote.CLUB_JACK,CardBelote.CLUB_9,CardBelote.CLUB_8,CardBelote.CLUB_7));
        deal_.getDeal().add(create(CardBelote.CLUB_1,CardBelote.CLUB_10,CardBelote.CLUB_KING,CardBelote.SPADE_1,CardBelote.SPADE_JACK,CardBelote.SPADE_8,CardBelote.HEART_1,CardBelote.HEART_10,CardBelote.HEART_KING,CardBelote.SPADE_10,CardBelote.SPADE_KING,CardBelote.SPADE_QUEEN));
        GameBelote g_ = newGameBeloteWithourDecl(r_, trs_, pr_, d_, bids_, deal_);
        GameBeloteTeamsRelation team_ = g_.getTeamsRelation();
        GameBeloteTrickInfo info_ = newGameBeloteTrickInfo(g_);
        GameBeloteProgTrick gt_ = newGameBeloteProgTrickDeal(g_, info_, team_, h_);
    ...
    public void defausseAtoutToutAtout2Test() {
        ...
        deal_.getDeal().add(create(CardBelote.SPADE_JACK,CardBelote.SPADE_1,CardBelote.SPADE_8,CardBelote.SPADE_7,CardBelote.DIAMOND_JACK,CardBelote.DIAMOND_1,CardBelote.DIAMOND_KING,CardBelote.DIAMOND_QUEEN));
        deal_.getDeal().add(create(CardBelote.DIAMOND_8,CardBelote.DIAMOND_7,CardBelote.CLUB_9,CardBelote.CLUB_10,CardBelote.CLUB_KING,CardBelote.CLUB_8,CardBelote.CLUB_7));
        deal_.getDeal().add(create(CardBelote.CLUB_JACK,CardBelote.DIAMOND_8,CardBelote.DIAMOND_7,CardBelote.CLUB_9,CardBelote.HEART_JACK,CardBelote.HEART_9,CardBelote.HEART_7,CardBelote.SPADE_9,CardBelote.SPADE_10,CardBelote.SPADE_JACK,CardBelote.SPADE_1,CardBelote.SPADE_8));
        GameBelote g_ = newGameBeloteWithourDecl(r_, trs_, pr_, d_, bids_, deal_);
        GameBeloteTeamsRelation team_ = g_.getTeamsRelation();
        GameBeloteTrickInfo info_ = newGameBeloteTrickInfo(g_);
        GameBeloteProgTrick gt_ = newGameBeloteProgTrickDeal(g_, info_, team_, h_);
    ...
    public void defausseAtoutToutAtout3Test() {
        ...
        deal_.getDeal().add(create(CardBelote.SPADE_9,CardBelote.SPADE_10,CardBelote.SPADE_KING,CardBelote.SPADE_QUEEN,CardBelote.DIAMOND_9,CardBelote.DIAMOND_10,CardBelote.DIAMOND_8,CardBelote.DIAMOND_7));
        deal_.getDeal().add(create(CardBelote.CLUB_JACK,CardBelote.CLUB_9,CardBelote.CLUB_1,CardBelote.CLUB_10,CardBelote.CLUB_KING,CardBelote.CLUB_8,CardBelote.CLUB_7));
        deal_.getDeal().add(create(CardBelote.CLUB_JACK,CardBelote.CLUB_9,CardBelote.CLUB_1,CardBelote.SPADE_JACK,CardBelote.SPADE_1,CardBelote.SPADE_8,CardBelote.HEART_JACK,CardBelote.HEART_9,CardBelote.HEART_1,CardBelote.SPADE_9,CardBelote.SPADE_10,CardBelote.SPADE_KING));
        GameBelote g_ = newGameBeloteWithourDecl(r_, trs_, pr_, d_, bids_, deal_);
        GameBeloteTeamsRelation team_ = g_.getTeamsRelation();
        GameBeloteTrickInfo info_ = newGameBeloteTrickInfo(g_);
        GameBeloteProgTrick gt_ = newGameBeloteProgTrickDeal(g_, info_, team_, h_);
