...
public final class GameBeloteProgTrickUtilTest extends CommonGameBelote {
    ...
    public void cartesRelativementMaitre1Test() {
        ...
        GameBeloteProgTrick gt_ = gameBeloteProgTrick(r_, bids_, last_, h_);
        HandBelote p_ = new HandBelote();
        IdMap<Suit, HandBelote> rp_ = p_.couleurs(bid_);
    ...
    private GameBeloteProgTrick gameBeloteProgTrick(RulesBelote _r, CustList<BidBeloteSuit> _bids, HandBelote _last, HandBelote _h) {
