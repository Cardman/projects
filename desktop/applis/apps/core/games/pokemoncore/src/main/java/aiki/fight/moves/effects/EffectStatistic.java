...
public final class EffectStatistic extends Effect {
    ...
    private IdMap<Statistic,Long> statisVarRank;
    ...
    public IdMap<Statistic,Long> getStatisVarRank() {
        return statisVarRank;
    }

    public void setStatisVarRank(IdMap<Statistic,Long> _statisVarRank) {
