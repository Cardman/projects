...
public final class DataBaseValidationCoreTest extends DataBaseValidationCommon {
    ...
    public void fail1Test() {
        ...
        pkData_.setTechnicalMoves(Ints.newList(100));
        pkData_.setHiddenMoves(Ints.newList(100));
        ...
        pkData_.getStatistics().addEntry(Statistic.ACCURACY,new StatBaseEv(-1,-1));
        pkData_.getLevMoves().add(new LevelMove(-1,NULL_REF));
        pkData_.getLevMoves().add(new LevelMove(1,NULL_REF));
        pkData_.getLevMoves().add(new LevelMove(0,NULL_REF));
    ...
    public void fail2Test() {
        ...
        pkData_.getLevMoves().add(new LevelMove(2,LUTTE));
        data_.completeMembers(PIKACHU,pkData_);
        data_.sortEndRound();
        initPlaces(data_);
        data_.getMap().setMiniMap(new MiniMapCoordsList());
    ...
    public void fail3Test() {
        ...
        mvStatus_.getRepeatRoundLaw().addQuickEvent(Rate.newRate("0"),LgInt.newLgInt("-1"));
        mvStatus_.getRepeatRoundLaw().addQuickEvent(Rate.newRate("1/2"),LgInt.newLgInt("-1"));
        mvStatus_.setPp(200);
        ...
        effectDamage_.getDamageLaw().addQuickEvent(NULL_REF,LgInt.newLgInt("-1"));
        effectDamage_.setPower(CHARGE);
        effectDamage_.getHitsLaw().addQuickEvent(Rate.newRate("0"),LgInt.newLgInt("-1"));
        effectDamage_.setTargetChoice(TargetChoice.ANY_FOE);
        ...
        effectCopyMove_.setCopyingMoveForUser(1);
        ...
        mvDam_.getEffects().add(effectStatis_);
        effectDamage_ = Instances.newEffectDamage();
        effectDamage_.getChLaw().addQuickEvent(Rate.newRate("-1"),LgInt.newLgInt("-1"));
        effectDamage_.getHitsLaw().addQuickEvent(Rate.newRate("-1"),LgInt.newLgInt("-1"));
        effectDamage_.getHitsLaw().addQuickEvent(Rate.newRate("1/2"),LgInt.newLgInt("-1"));
        effectDamage_.getBoostStatisOnceKoFoe().addEntry(Statistic.HP,-1L);
        ...
        effectDamage_.getDamageLaw().addQuickEvent(CHARGE,LgInt.newLgInt("-1"));
        effectDamage_.setPower(CHARGE);
        mvDam_.getEffects().add(effectDamage_);
        effectDamage_ = Instances.newEffectDamage();
    ...
    public void fail4Test() {
        ...
        effectStatistic_.getLawBoost().addQuickEvent(Statistic.HP,LgInt.newLgInt("-1"));
        effectStatistic_.getLawBoost().addQuickEvent(Statistic.ATTACK,LgInt.newLgInt("-1"));
        effectStatistic_.setEvtRate(Rate.newRate("-1"));
        effectStatistic_.getStatisVarRank().addEntry(Statistic.HP,1L);
        effectStatistic_.getStatisVarRank().addEntry(Statistic.PV_RESTANTS,1L);
    ...
    public void fail5Test() {
        ...
        effectTeam_.getMultDamage().addEntry(new CategoryMult(ELECTRICK,0),Rate.newRate("-1"));
        effectTeam_.getMultDamage().addEntry(new CategoryMult(NULL_REF,10),Rate.newRate("-1"));
        effectTeam_.getMultDamage().addEntry(new CategoryMult(NULL_REF,0),Rate.newRate("-1"));
        effectTeam_.getMultDamage().addEntry(new CategoryMult(ELECTRICK,10),Rate.newRate("-1"));
    ...
    public void fail6Test() {
        ...
        effectStatus_.getLawStatus().addQuickEvent(CHARGE,LgInt.newLgInt("-1"));
        effectStatus_.getLawStatus().addQuickEvent(ELECTRICK,LgInt.newLgInt("-1"));
    ...
    public void fail8Test() {
        ...
        effectCounterAttack_.getDroppedStatDirectMove().addEntry(Statistic.HP,1L);
        ...
        effectTeamWhileSendFoe_.getStatusByNbUses().addEntry( 0L,ELECTRICK);
        effectTeamWhileSendFoe_.getStatusByNbUses().addEntry( 1L,CHARGE4);
        effectTeamWhileSendFoe_.getStatistics().addEntry(Statistic.HP,0L);
        ...
        effectEndRoundSingleRelation_.getLawForEnablingEffect().addQuickEvent(Rate.newRate("0"),LgInt.newLgInt("-1"));
        effectEndRoundSingleRelation_.getLawForEnablingEffect().addQuickEvent(Rate.newRate("1/2"),LgInt.newLgInt("-1"));
        ...
        effectEndRoundSingleRelation_.getLawForEnablingEffect().addQuickEvent(Rate.newRate("-1"),LgInt.newLgInt("-1"));
        effectEndRoundSingleRelation_.getLawForEnablingEffect().addQuickEvent(Rate.newRate("1/2"),LgInt.newLgInt("-1"));
        mvDam_.getEffects().add(effectEndRoundSingleRelation_);
        effectEndRoundSingleRelation_ = Instances.newEffectEndRoundSingleRelation();
        ...
        effectCombo_.getRepeatedRoundsLaw().addQuickEvent(Rate.newRate("-1"),LgInt.newLgInt("-1"));
        effectCombo_.getRepeatedRoundsLaw().addQuickEvent(Rate.newRate("1/2"),LgInt.newLgInt("-1"));
        ...
        effectCombo_.getRepeatedRoundsLaw().addQuickEvent(Rate.newRate("0"),LgInt.newLgInt("-1"));
        effectCombo_.getRepeatedRoundsLaw().addQuickEvent(Rate.newRate("1/2"),LgInt.newLgInt("-1"));
        effectCombo_.setMultEvtRateSecEff(Rate.newRate("-1"));
    ...
    public void fail9Test() {
        ...
        abilityData_.getSingleStatus().addQuickEvent(ELECTRICK,LgInt.newLgInt("-1"));
        ...
        abilityData_.getIncreasedPrioTypes().addEntry(ELECTRICK,0L);
        abilityData_.getIncreasedPrio().addEntry(ELECTRICK,0L);
        abilityData_.getMaxStatisticsIfCh().add(Statistic.HP);
        abilityData_.getBonusStatRank().addEntry(Statistic.HP,0L);
        abilityData_.getBoostStatRankEndRound().addEntry(Statistic.HP,0L);
        abilityData_.getBoostStatRankProtected().addEntry(Statistic.HP,0L);
        abilityData_.getMultStatIfLowStat().addEntry(Statistic.HP,0L);
        abilityData_.getMultStatIfKoFoe().addEntry(Statistic.HP,0L);
        abilityData_.getLowStatFoeHit().addEntry(Statistic.HP,0L);
        abilityData_.getMultStatIfDamageCat().addEntry(new StatisticCategory(Statistic.HP,ELECTRICK),0L);
        abilityData_.getMultStatIfDamageCat().addEntry(new StatisticCategory(Statistic.HP,NULL_REF),0L);
        abilityData_.getMultStatIfStatutRank().addEntry(new StatisticStatus(Statistic.HP,ELECTRICK),0L);
        abilityData_.getMultStatIfDamgeType().addEntry(new StatisticType(Statistic.HP,ELECTRICK),0L);
    ...
    public void fail11Test() {
        ...
        itemForBattle_.getEffectSending().add(Instances.newEffectWhileSendingSimple());
        itemForBattle_.getMultStatPokemonRank().addEntry(new StatisticPokemon(Statistic.HP,ELECTRICK),0L);
        itemForBattle_.getMultStatPokemonRank().addEntry(new StatisticPokemon(Statistic.HP,CHARGE4),0L);
        itemForBattle_.getMultStatPokemonRank().addEntry(new StatisticPokemon(Statistic.ATTACK,ELECTRICK),0L);
        itemForBattle_.getMultStatPokemonRank().addEntry(new StatisticPokemon(Statistic.ATTACK,CHARGE4),0L);
        itemForBattle_.getMultStatRank().addEntry(Statistic.HP,0L);
        itemForBattle_.getMultStat().addEntry(Statistic.HP, NULL_REF);
        itemForBattle_.getIncreasingMaxNbRoundGlobalMove().addEntry(ELECTRICK,-1L);
        itemForBattle_.getIncreasingMaxNbRoundTeamMove().addEntry(ELECTRICK,-1L);
        itemForBattle_.getIncreasingMaxNbRoundTrap().addEntry(ELECTRICK,-1L);
        ...
        itemForBattle_.getBoostStatisSuperEff().addEntry(Statistic.HP,0L);
        IdMap<Statistic,Long> v_ = new IdMap<Statistic,Long>();
        v_.addEntry(Statistic.HP,0L);
        ...
        itemForBattle_.getWinEvFight().addEntry(Statistic.ACCURACY,-1L);
        ...
        berry_.getMultStat().addEntry(Statistic.HP,new BoostHpRate( -1,Rate.newRate("-1")));
        berry_.getBoostStatis().addEntry(Statistic.HP,0L);
    ...
    public void fail12Test() {
        ...
        boost_.getEvs().addEntry(Statistic.ACCURACY,-1L);
        boost_.getHappiness().addEntry(ELECTRICK,-1L);
        boost_.setPrice(-1);
        data_.completeMembers(CHARGE,boost_);
        HealingHp healingHp_ = Instances.newHealingHp();
        healingHp_.getHappiness().addEntry(ELECTRICK,-1L);
