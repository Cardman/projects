...
public final class DataBaseValidationCoreTest extends DataBaseValidationCommon {
    ...
    public void fail3Test() {
        ...
        effectDamage_.getBoostStatisOnceKoFoe().addEntry(Statistic.HP,  -1);
    ...
    public void fail4Test() {
        ...
        effectStatistic_.getStatisVarRank().addEntry(Statistic.HP,  1);
        effectStatistic_.getStatisVarRank().addEntry(Statistic.PV_RESTANTS,  1);
    ...
    public void fail8Test() {
        ...
        effectCounterAttack_.getDroppedStatDirectMove().addEntry(Statistic.HP,  1);
        ...
        effectTeamWhileSendFoe_.getStatusByNbUses().addEntry( 0,ELECTRICK);
        effectTeamWhileSendFoe_.getStatusByNbUses().addEntry( 1,CHARGE4);
        effectTeamWhileSendFoe_.getStatistics().addEntry(Statistic.HP,0);
    ...
    public void fail9Test() {
        ...
        abilityData_.getBonusStatRank().addEntry(Statistic.HP,0);
        abilityData_.getBoostStatRankEndRound().addEntry(Statistic.HP,0);
        abilityData_.getBoostStatRankProtected().addEntry(Statistic.HP,0);
        abilityData_.getMultStatIfLowStat().addEntry(Statistic.HP,0);
        abilityData_.getMultStatIfKoFoe().addEntry(Statistic.HP,0);
        abilityData_.getLowStatFoeHit().addEntry(Statistic.HP,0);
        abilityData_.getMultStatIfDamageCat().addEntry(new StatisticCategory(Statistic.HP,ELECTRICK),0);
        abilityData_.getMultStatIfDamageCat().addEntry(new StatisticCategory(Statistic.HP,NULL_REF),0);
        abilityData_.getMultStatIfStatutRank().addEntry(new StatisticStatus(Statistic.HP,ELECTRICK),0);
        abilityData_.getMultStatIfDamgeType().addEntry(new StatisticType(Statistic.HP,ELECTRICK),0);
    ...
    public void fail11Test() {
        ...
        itemForBattle_.getMultStatRank().addEntry(Statistic.HP,  0);
        ...
        itemForBattle_.getBoostStatisSuperEff().addEntry(Statistic.HP,  0);
        IdMap<Statistic, Integer> v_ = new IdMap<Statistic, Integer>();
        v_.addEntry(Statistic.HP,  0);
        ...
        itemForBattle_.getWinEvFight().addEntry(Statistic.ACCURACY,  -1);
        ...
        berry_.getBoostStatis().addEntry(Statistic.HP,  0);
    ...
    public void fail12Test() {
        ...
        boost_.getEvs().addEntry(Statistic.ACCURACY,  -1);
