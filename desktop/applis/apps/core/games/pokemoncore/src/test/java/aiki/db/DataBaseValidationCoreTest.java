...
public final class DataBaseValidationCoreTest extends DataBaseValidationCommon {
    ...
    public void fail9Test() {
        ...
        abilityData_.getIncreasedPrioTypes().addEntry(ELECTRICK,0);
        abilityData_.getIncreasedPrio().addEntry(ELECTRICK,0);
        ...
        abilityData_.getMultStatIfStatutRank().addEntry(new StatisticStatus(Statistic.HP,ELECTRICK),0);
    ...
    public void fail11Test() {
        ...
        itemForBattle_.getEffectSending().add(Instances.newEffectWhileSendingSimple());
        itemForBattle_.getMultStatPokemonRank().addEntry(new StatisticPokemon(Statistic.HP,ELECTRICK),  0);
        itemForBattle_.getMultStatPokemonRank().addEntry(new StatisticPokemon(Statistic.HP,CHARGE4),  0);
        itemForBattle_.getMultStatPokemonRank().addEntry(new StatisticPokemon(Statistic.ATTACK,ELECTRICK),  0);
        itemForBattle_.getMultStatPokemonRank().addEntry(new StatisticPokemon(Statistic.ATTACK,CHARGE4),  0);
        itemForBattle_.getMultStatRank().addEntry(Statistic.HP,0L);
        itemForBattle_.getMultStat().addEntry(Statistic.HP, NULL_REF);
        itemForBattle_.getIncreasingMaxNbRoundGlobalMove().addEntry(ELECTRICK,  -1);
        itemForBattle_.getIncreasingMaxNbRoundTeamMove().addEntry(ELECTRICK,  -1);
        itemForBattle_.getIncreasingMaxNbRoundTrap().addEntry(ELECTRICK,  -1);
    ...
    public void fail12Test() {
        ...
        boost_.getHappiness().addEntry(ELECTRICK,  -1);
        boost_.setPrice(-1);
        data_.completeMembers(CHARGE,boost_);
        HealingHp healingHp_ = Instances.newHealingHp();
        healingHp_.getHappiness().addEntry(ELECTRICK,  -1);
