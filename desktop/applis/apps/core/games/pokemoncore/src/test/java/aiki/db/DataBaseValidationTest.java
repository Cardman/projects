...
public final class DataBaseValidationTest extends DataBaseValidationCommon {
    ...
    public void fail4Test() {
        ...
        StringMap<AbsMap<EnvironmentType, String>> translatedEnvironment_ = data_.getTranslatedEnvironment();
        AbsMap<EnvironmentType, String> e_ = new IdMap<EnvironmentType, String>();
        ...
        StringMap<AbsMap<DifficultyModelLaw, String>> translatedDiffModelLaw_ = data_.getTranslatedDiffModelLaw();
        AbsMap<DifficultyModelLaw, String> dw_ = new IdMap<DifficultyModelLaw, String>();
        ...
        StringMap<AbsMap<DifficultyWinPointsFight, String>> translatedDiffWinPts_ = data_.getTranslatedDiffWinPts();
        AbsMap<DifficultyWinPointsFight, String> dwp_ = new IdMap<DifficultyWinPointsFight, String>();
        ...
        StringMap<AbsMap<TargetChoice, String>> translatedTargets_ = data_.getTranslatedTargets();
        AbsMap<TargetChoice, String> targets_ = new IdMap<TargetChoice, String>();
        ...
        StringMap<AbsMap<SelectedBoolean, String>> translatedBooleans_ = data_.getTranslatedBooleans();
        AbsMap<SelectedBoolean, String> bools_ = new IdMap<SelectedBoolean, String>();
        ...
        StringMap<AbsMap<Gender, String>> translatedGenders_ = data_.getTranslatedGenders();
        AbsMap<Gender, String> genders_ = new IdMap<Gender, String>();
        ...
        StringMap<AbsMap<Statistic, String>> translatedStatistics_ = data_.getTranslatedStatistics();
        AbsMap<Statistic, String> stats_ = new IdMap<Statistic, String>();
    ...
    public void checkTranslations5Test() {
        ...
        data_.getTranslatedCategories().addEntry(LANGUAGE, tr_);
        StringMap<AbsMap<EnvironmentType, String>> translatedEnvironment_ = data_.getTranslatedEnvironment();
        AbsMap<EnvironmentType, String> envType_ = new IdMap<EnvironmentType, String>();
    ...
    public void checkTranslations9Test() {
        ...
        tr_ = new StringMap<String>();
        data_.getTranslatedCategories().addEntry(LANGUAGE, tr_);
        StringMap<AbsMap<Statistic, String>> translatedEnvironment_ = data_.getTranslatedStatistics();
        AbsMap<Statistic, String> envType_ = new IdMap<Statistic, String>();
    ...
    public void checkTranslations10Test() {
        ...
        tr_ = new StringMap<String>();
        data_.getTranslatedCategories().addEntry(LANGUAGE, tr_);
        StringMap<AbsMap<Gender, String>> translatedEnvironment_ = data_.getTranslatedGenders();
        AbsMap<Gender, String> envType_ = new IdMap<Gender, String>();
    ...
    public void getFormula5Test() {
        ...
        AbsMap<Statistic, String> tr_ = data_.getTranslatedStatistics().getVal(LANGUAGE);
    ...
    @Test
    public void adv() {
        TstsLoadFlagImpl l_ = new LoadFlagSampleSix();
        l_.set(true);
        l_.set(false);
        l_.getLoadFlag().setPercent(0);
