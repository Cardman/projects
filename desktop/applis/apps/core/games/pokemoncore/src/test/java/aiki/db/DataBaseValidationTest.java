...
public final class DataBaseValidationTest extends DataBaseValidationCommon {
    ...
    public void fail1Test() {
        ...
        pkData_.getStatistics().addEntry(Statistic.ATTACK,new StatBaseEv(1,0));
        pkData_.getStatistics().addEntry(Statistic.DEFENSE,new StatBaseEv(1,0));
        pkData_.getStatistics().addEntry(Statistic.SPECIAL_ATTACK,new StatBaseEv(1,0));
        pkData_.getStatistics().addEntry(Statistic.SPECIAL_DEFENSE,new StatBaseEv(1,0));
        pkData_.getStatistics().addEntry(Statistic.SPEED,new StatBaseEv(1,0));
        pkData_.getStatistics().addEntry(Statistic.HP,new StatBaseEv(1,0));
    ...
    public void fail3Test() {
        ...
        move_.setTypes(new StringList(ELECTRICK));
        move_.setRankIncrementNbRound(1);
        ...
        data_.getTm().addEntry(0,TREMPETTE2);
        data_.getTm().addEntry(1,TREMPETTE2);
        data_.getTm().addEntry(2,LUTTE);
        data_.getTmPrice().addEntry(3, LgInt.newLgInt("-1"));
        data_.getHm().addEntry(0,TREMPETTE2);
        data_.getHm().addEntry(1,TREMPETTE2);
        data_.sortEndRound();
        initPlaces(data_);
        data_.getMap().setMiniMap(new MiniMapCoordsList());
        data_.getMap().setUnlockedCity(NULL_REF);
    ...
    public void validate3Test() {
        ...
        pokemon_.getStatistics().addEntry(Statistic.ATTACK,new StatBaseEv(1,1));
        pokemon_.getStatistics().addEntry(Statistic.SPECIAL_ATTACK,new StatBaseEv(1,1));
        pokemon_.getStatistics().addEntry(Statistic.DEFENSE,new StatBaseEv(1,1));
        pokemon_.getStatistics().addEntry(Statistic.SPECIAL_DEFENSE,new StatBaseEv(1,1));
        pokemon_.getStatistics().addEntry(Statistic.SPEED,new StatBaseEv(1,1));
        pokemon_.getStatistics().addEntry(Statistic.HP,new StatBaseEv(1,1));
    ...
    public void validate14Test() {
        ...
        pokemon_.getStatistics().addEntry(Statistic.SPECIAL_DEFENSE,new StatBaseEv(1,1));
        pokemon_.getStatistics().addEntry(Statistic.SPEED,new StatBaseEv(1,1));
        pokemon_.getLevMoves().add(new LevelMove(1,CHARGE));
        pokemon_.getHiddenMoves().add(100);
        pokemon_.getTechnicalMoves().add(100);
        data_.completeMembers(PIKACHU, pokemon_);
        data_.completeMembers(TREMPETTE,Instances.newAbilityData());
        data_.getTm().addEntry(100,CHARGE);
        data_.getHm().addEntry(100,CHARGE);
        DamagingMoveData damagingMoveData_ = Instances.newDamagingMoveData();
        data_.completeMembers(CHARGE, damagingMoveData_);
        initConstants(data_);
        data_.setDefMove(CHARGE);
    ...
    public void validate21Test() {
        ...
        pokemon_.getStatistics().addEntry(Statistic.SPEED,new StatBaseEv(1,1));
        pokemon_.getStatistics().addEntry(Statistic.HP,new StatBaseEv(1,1));
        pokemon_.getLevMoves().add(new LevelMove(1,CHARGE3));
        pokemon_.getHiddenMoves().add(100);
        pokemon_.getTechnicalMoves().add(100);
        data_.completeMembers(PIKACHU, pokemon_);
        data_.completeMembers(TREMPETTE,Instances.newAbilityData());
    ...
    public void validate22Test() {
        ...
        pokemon_.getStatistics().addEntry(Statistic.SPEED,new StatBaseEv(1,1));
        pokemon_.getStatistics().addEntry(Statistic.HP,new StatBaseEv(1,1));
        pokemon_.getLevMoves().add(new LevelMove(1,CHARGE2));
        pokemon_.getHiddenMoves().add(100);
        pokemon_.getTechnicalMoves().add(100);
        data_.completeMembers(PIKACHU, pokemon_);
        data_.completeMembers(TREMPETTE,Instances.newAbilityData());
