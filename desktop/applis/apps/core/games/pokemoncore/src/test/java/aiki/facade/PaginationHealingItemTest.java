...
public class PaginationHealingItemTest extends InitializationDataBase {
    ...
    public void sort1Test() {
        ...
        sorting_.setIndex(0);
        itemName_ = BAIE_ORAN;
        pagination_.getHealingItems().put(sorting_, itemName_);
        sorting_ = new SortingHealingItem();
        ...
        pagination_.sort();
        assertEq(2, pagination_.getHealingItems().size());
        CustList<SortingHealingItem> sorted_;
        sorted_ = new CustList<SortingHealingItem>(pagination_.getHealingItems().getKeys());
        itemName_ = pagination_.getHealingItems().getVal(sorted_.get(0));
        assertEq(BAIE_ORAN, itemName_);
        itemName_ = pagination_.getHealingItems().getVal(sorted_.get(1));
    ...
    public void search1Test() {
        ...
        sorted_ = new CustList<SortingHealingItem>(pagination_.getHealingItems().getKeys());
        elt_ = sorted_.get(0);
        itemName_ = pagination_.getHealingItems().getVal(elt_);
    ...
    public void search2Test() {
        ...
        pagination_.setInventory(inv_);
        pagination_.search(items_, data_);
        assertEq(6, pagination_.getHealingItems().size());
        String itemName_;
        SortingHealingItem elt_;
        CustList<SortingHealingItem> sorted_;
        sorted_ = new CustList<SortingHealingItem>(pagination_.getHealingItems().getKeys());
...
//        pagination_.getCriteria().setContentOfName("..I*");
        pagination_.setInventory(inv_);
        pagination_.search(items_, data_);
        assertEq(0, pagination_.getHealingItems().size());
        CustList<SortingHealingItem> sorted_;
        sorted_ = pagination_.getRendered();
...
//        pagination_.getCriteria().setContentOfName("..I*");
        pagination_.setInventory(inv_);
        pagination_.search(items_, data_);
        assertEq(1, pagination_.getHealingItems().size());
        CustList<SortingHealingItem> sorted_;
        sorted_ = pagination_.getRendered();
        assertEq(1, sorted_.size());
        assertEq(REVEIL, sorted_.get(0).getName());
...
//        assertEq(Rate.zero(), elt_.getHpRate());
    ...
    public void search16Test() {
        ...
        pagination_.setInventory(inv_);
        pagination_.search(items_, data_);
        assertEq(10, pagination_.getHealingItems().size());
        String itemName_;
        CustList<SortingHealingItem> sorted_;
        SortingHealingItem elt_;
        sorted_ = new CustList<SortingHealingItem>(pagination_.getHealingItems().getKeys());
