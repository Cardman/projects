...
public class FightEffectsDamageTest extends InitializationDataBase {
    ...
    private static StringMap<String> getValues(Fight _fight, TeamPosition _thrower, TeamPosition _target, String _move, Rate _power, DataBase _data) {
        ...
        variables_.put(StringUtil.concat(VAR_PREFIX,Fight.ATTAQUE_CATEGORIE), _data.getCategory(move_));
        variables_.put(StringUtil.concat(VAR_PREFIX,Fight.LANCEUR_NOM), nomActuelLanceur_);
        variables_.put(StringUtil.concat(VAR_PREFIX,Fight.ATTAQUE_TYPES), StringUtil.join(typeAtt_, _data.getSepartorSetChar()));
        variables_.put(StringUtil.concat(VAR_PREFIX,Fight.ATTAQUE_NOM), _move);
        variables_.put(StringUtil.concat(VAR_PREFIX,Fight.PUISSANCE_BASE), _power.toNumberString());
        return variables_;
    }
    ...
    private static StringMap<String> getValues(Fight _fight, TeamPosition _thrower, TeamPosition _target, String _move, Rate _power, Rate _efficiency, DataBase _data) {
        ...
        variables_.put(StringUtil.concat(VAR_PREFIX,Fight.COEFF_EFF), _efficiency.toNumberString());
        variables_.put(StringUtil.concat(VAR_PREFIX,Fight.NB_UTILISATION_CONSECUTIF), fighter_.getNbRepeatingSuccessfulMoves().toNumberString());
        return variables_;
    }
