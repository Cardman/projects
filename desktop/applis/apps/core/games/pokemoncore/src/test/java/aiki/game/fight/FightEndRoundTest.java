...
public class FightEndRoundTest extends InitializationDataBase {
    ...
    private Fight processActivityCom3(DataBase _data, Difficulty _diff, StringMap<Integer> _moves) {
    ...
    private Fight processActivityCom2(DataBase _data, Difficulty _diff, StringMap<Integer> _moves) {
        Player player_ = Player.build(NICKNAME, _diff,false, _data);
        player_.getTeam().add(pkPlayer(_diff, _data,  3, _moves));
        player_.getTeam().add(pkPlayer(_diff, _data,  4, _moves));
        CustList<PkTrainer> allyTeam_ = new CustList<PkTrainer>();
    ...
    private Fight processActivityCom(DataBase _data, Difficulty _diff, StringMap<Integer> _moves) {
        Player player_ = Player.build(NICKNAME, _diff,false, _data);
        player_.getTeam().add(pkPlayer(_diff, _data,  3, _moves));
        player_.getTeam().add(pkPlayer(_diff, _data,  4, _moves));
        CustList<PkTrainer> allyTeam_ = new CustList<PkTrainer>();
    ...
    private Fight effectEndRoundPositionRelationCom(DataBase _data, Difficulty _diff, StringMap<Integer> _moves) {
        Player player_ = Player.build(NICKNAME, _diff,false, _data);
        player_.getTeam().add(pkPlayer(_diff, _data,  3, _moves));
        player_.getTeam().add(pkPlayer(_diff, _data,  4, _moves));
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
    ...
    private Fight effectEndRoundPositionRelationCom2(DataBase _data, Difficulty _diff, StringMap<Integer> _moves) {
        Player player_ = Player.build(NICKNAME, _diff,false, _data);
        player_.getTeam().add(pkPlayer(_diff, _data, 3, _moves));
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
        foeTeam_.add(pkTrainer( 3, new StringList(DETECTION)));
    ...
    private Fight effectEndRoundPositionRelationCom3(DataBase _data, Difficulty _diff, StringMap<Integer> _moves) {
        Player player_ = Player.build(NICKNAME, _diff,false, _data);
        player_.getTeam().add(pkPlayer(_diff, _data,  3, _moves));
        player_.getTeam().add(pkPlayer(_diff, _data,  4, _moves));
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
    ...
    private Fight effectEndRoundPositionRelationCom4(DataBase _data, Difficulty _diff, StringMap<Integer> _moves) {
        Player player_ = Player.build(NICKNAME, _diff,false, _data);
        player_.getTeam().add(pkPlayer(_diff, _data,  3, _moves));
        player_.getTeam().add(pkPlayer(_diff, _data,  4, _moves));
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
    ...
    private static PokemonPlayer pkPlayer(Difficulty _diff, DataBase _data, int _level, StringMap<Integer> _movesPp) {
        Pokemon pokemon_ = new WildPk();
