...
public class FightFacadeSimulationTest extends InitializationDataBase {
    ...
    public void simulate1Test() {
        ...
        action_.setChosenTargets(TargetCoordsList.newList(POKEMON_FOE_TARGET_ZERO));
        action_.setSubstitute(Fighter.BACK);
        round_.add(action_);
        action_ = new ActionMove();
        action_.setFirstChosenMove(PISTOLET_A_O);
        action_.setChosenTargets(TargetCoordsList.newList(POKEMON_FOE_TARGET_ONE));
        action_.setSubstitute(Fighter.BACK);
        round_.add(action_);
...
//        fightSimulation_.chooseMove(0, 0, 1, BROUHAHA, POKEMON_FOE_TARGET_ZERO);
    ...
    public void nextFight2Test() {
        ...
        pkOneSecond_.setLevel((short) 38);
        ...
        pkTwoSecond_.setLevel((short) 38);
