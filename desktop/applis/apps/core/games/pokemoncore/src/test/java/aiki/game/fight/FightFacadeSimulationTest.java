...
public class FightFacadeSimulationTest extends InitializationDataBase {
    ...
    public void simulate1Test() {
        ...
        foesMoves_.add(new LevelMoves((short)3,foeMoves_));
        Fight fight_ = simulate(partnersMoves_, foesMoves_, player_, diff_);
    ...
    public void simulate5Test() {
        ...
        foesMoves_.add(new LevelMoves((short)1,foeMoves_));
        Fight fight_ = simulate(partnersMoves_, foesMoves_, player_, diff_, 2);
        CustList<CustList<ActionMove>> actionsRound_ = new CustList<CustList<ActionMove>>();
        CustList<ActionMove> round_ = new CustList<ActionMove>();
        ActionMove action_;
        action_ = new ActionMove();
...
//        diff_.setAllowedSwitchPlacesEndRound(false);
    ...
    public void simulate17Test() {
        ...
        Fight fight_ = simulate(partnersMoves_, foesMoves_, player_, diff_, 1);
        CustList<CustList<ActionMove>> actionsRound_ = new CustList<CustList<ActionMove>>();
        CustList<ActionMove> round_ = new CustList<ActionMove>();
        ActionMove action_;
        action_ = new ActionMove();
...
//        fight_.getKos().put(Fight.PLAYER, false);
    ...
    public void simulate19Test() {
        ...
        foesMoves_.add(new LevelMoves((short)1,foeMoves_));
        foesMoves_.add(new LevelMoves((short)1,foeMoves_));
        Fight fight_ = simulate(partnersMoves_, foesMoves_, player_, diff_, 3);
        CustList<CustList<ActionMove>> actionsRound_ = new CustList<CustList<ActionMove>>();
        CustList<ActionMove> round_ = new CustList<ActionMove>();
        ActionMove action_;
        action_ = new ActionMove();
...
//        fightSimulation_.validateMovesOneFight(2, data);
        ...
        fightSimulation_.simulateFight(data);
    ...
    public void simulateFight2Test() {
        ...
        pokemon_.setGender(Gender.NO_GENDER);
        fightSimulation_.addPokemonPlayer(pokemon_, new StringList(CHARGE), (byte) 70, Rate.zero(), data);
        fightSimulation_.validateTeam(data);
        fightSimulation_.setFirstEvolutions(data);
        fightSimulation_.initializeFrontFighters();
        fightSimulation_.getFrontFighters().first().first().put((byte)0, (byte)0);
        fightSimulation_.getFrontFighters().first().first().put((byte)1, Fighter.BACK);
...
//        fightSimulation_.validateMovesOneFight(2, data);
        ...
        fightSimulation_.chooseMove(0, 1, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, data);
...
//        fightSimulation_.addMoveBetweenFights(1, 0, TORGNOLES);
        ...
        fightSimulation_.chooseMove(0, 1, 0, CHARGE, POKEMON_FOE_TARGET_ZERO, data);
...
//        fightSimulation_.chooseMove(1, 1, 2, CHARGE, POKEMON_FOE_TARGET_ZERO);
    ...
    public void simulateFight10Test() {
        ...
        fightSimulation_.validateTeam(data);
        fightSimulation_.setFirstEvolutions(data);
        fightSimulation_.setNextEvolutions(0, TETARTE, (short) 55, data);
        fightSimulation_.initializeFrontFighters();
        fightSimulation_.getFrontFighters().first().first().put((byte)0, (byte)0);
        fightSimulation_.getFrontFighters().first().first().put((byte)1, Fighter.BACK);
        fightSimulation_.getFrontFighters().first().first().put((byte)2, Fighter.BACK);
        ...
        fightSimulation_.validateMovesOneFight(1, data);
        fightSimulation_.validateMovesOneFight(2, data);
        fightSimulation_.keepMoves(0, new StringList(BROUHAHA), data);
        fightSimulation_.setAbilityWhileFight(0, 0, 1, ABSORB_EAU);
        fightSimulation_.keepMoves(0, new StringList(BROUHAHA, BULLES_D_O, PLAQUAGE, PISTOLET_A_O), data);
        fightSimulation_.validateAllMoves(data);
        fightSimulation_.chooseMove(0, 0, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.chooseMove(0, 1, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.simulateFight(data);
...
//        assertTrue(!fightSimulation_.getProbleme());
    ...
    public void simulateFight11Test() {
        ...
        pokemon_.setItem(NULL_REF);
        pokemon_.setGender(Gender.NO_GENDER);
        fightSimulation_.addPokemonPlayer(pokemon_, new StringList(BROUHAHA, BULLES_D_O, PLAQUAGE, PISTOLET_A_O), (byte) 70, Rate.zero(), data);
        pokemon_ = new WildPk();
        pokemon_.setLevel((short) 100);
        pokemon_.setName(TETARTE);
        pokemon_.setAbility(ABSORB_EAU);
        ...
        fightSimulation_.keepMoves(0, new StringList(BROUHAHA, BULLES_D_O, PLAQUAGE, PISTOLET_A_O), data);
        fightSimulation_.setAbilityWhileFight(0, 0, 1, ABSORB_EAU);
        fightSimulation_.keepMoves(0, new StringList(BROUHAHA, BULLES_D_O, PLAQUAGE), data);
        fightSimulation_.validateAllMoves(data);
        fightSimulation_.chooseMove(0, 0, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.chooseMove(0, 1, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.simulateFight(data);
...
//        fightSimulation_.chooseMove(1, 1, 2, CHARGE, POKEMON_FOE_TARGET_ZERO);
        fightSimulation_.simulateFight(data);
        assertTrue(!fightSimulation_.getProbleme());
        assertTrue(fightSimulation_.hasNextFight(data));
    }
...
//        fightSimulation_.chooseMove(1, 1, 2, CHARGE, POKEMON_FOE_TARGET_ZERO);
        fightSimulation_.simulateFight(data);
        assertTrue(!fightSimulation_.getProbleme());
        fightSimulation_.nextFight(data);
...
//        fightSimulation_.chooseMove(0, 0, 1, BROUHAHA, POKEMON_FOE_TARGET_ZERO);
        fightSimulation_.chooseMove(0, 0, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.chooseMove(0, 1, 2, CHARGE, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.simulateFight(data);
        assertTrue(!fightSimulation_.getProbleme());
    }
    ...
    public void simulateFights1Test() {
        ...
        fightSimulation_.addMove(2, GRIFFE_ACIER);
        fightSimulation_.validateAllMoves(data);
        fightSimulation_.simulateFights(data);
        assertTrue(fightSimulation_.getProbleme());
        assertTrue(fightSimulation_.isOk());
    ...
    public void simulateFights2Test() {
        ...
        fightSimulation_.chooseMove(0, 0, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.chooseMove(0, 1, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.chooseMove(1, 0, 1, BROUHAHA, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.chooseMove(1, 1, 2, CHARGE, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.simulateFights(data);
        assertTrue(!fightSimulation_.getProbleme());
        assertEq(2, fightSimulation_.getKoFoes().size());
        assertEq(0, fightSimulation_.getNotKoFrontFoes().size());
    ...
    public void simulateFights7Test() {
        ...
        fightSimulation_.chooseMove(0, 0, 0, CHARGE, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.chooseMove(0, 1, 0, CHARGE, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.chooseMove(1, 0, 1, CHARGE, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.chooseMove(1, 1, 2, CHARGE, POKEMON_FOE_TARGET_ZERO, data);
        fightSimulation_.simulateFights(data);
        assertTrue(!fightSimulation_.getProbleme());
        assertEq(2, fightSimulation_.getKoFoes().size());
