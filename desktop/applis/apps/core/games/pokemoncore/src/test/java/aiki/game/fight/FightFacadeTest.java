...
public class FightFacadeTest extends InitializationDataBase {
    ...
    private static Fight win(Difficulty _diff, DataBase _data) {
        ...
        pokemon_.setGender(Gender.NO_GENDER);
        pokemon_.setLevel( 3);
        PokemonPlayer lasPk_ = pkMoves(_data, _diff, pokemon_);
        player_.getTeam().add(lasPk_);
        Egg egg_ = new Egg(PIKACHU);
        player_.getTeam().add(egg_);
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
    ...
    public void defaultChoices1Test(){
        ...
        IntMap<ChoiceOfEvolutionAndMoves> map_;
    ...
    public void defaultChoices2Test(){
        ...
        ChoiceOfEvolutionAndMoves moves_ = map_.getVal( 0);
    ...
    public void possibleChoices2Test(){
        ...
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getWonExp().affect(new Rate("18"));
        FightEndRound.proponeMovesEvolutions(fight_, player_, diff_, data_);
        StringList moves_ = fight_.getChoices().getVal( 0).getKeptMoves();
    ...
    public void fighterMoves1Test() {
        ...
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).usePowerPointsByMove(diff_, ECUME,  25);
        NatStringTreeMap< ChosenMoveInfos> moves_;
        moves_ = FightFacade.fighterMoves(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), data_);
    ...
    public void fighterMoves2Test() {
        ...
        Fight fight_ = defChoicesSending5(data_, diff_, player_, new StringList(DETECTION, CHARGE), 3, new StringList(DETECTION, CHARGE), 3);
        NatStringTreeMap< ChosenMoveInfos> moves_;
        moves_ = FightFacade.fighterMoves(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ONE), data_);
    ...
    public void frontFighterMoves1Test() {
        ...
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).usePowerPointsByMove(diff_, ECUME,  25);
        NatStringTreeMap< ChosenMoveInfos> moves_;
        moves_ = FightFacade.frontFighterMoves(fight_,  0, data_);
        ChosenMoveInfos infos_;
        assertEq(4, moves_.size());
        infos_ = moves_.getVal(ECUME);
        assertEq(1,infos_.getTypes().size());
    ...
    public void frontFighterMoves2Test() {
        ...
        Fight fight_ = defChoicesSending5(data_, diff_, player_, new StringList(DETECTION, CHARGE), 3, new StringList(DETECTION, CHARGE), 3);
        NatStringTreeMap< ChosenMoveInfos> moves_;
        moves_ = FightFacade.frontFighterMoves(fight_,  1, data_);
        assertEq(0, moves_.size());
    }
    ...
    public void frontFighterMoves3Test() {
        ...
        Fight fight_ = defChoicesSending5(data_, diff_, player_, new StringList(DETECTION, CHARGE), 3, new StringList(DETECTION, CHARGE), 3);
        NatStringTreeMap< ChosenMoveInfos> moves_;
        moves_ = FightFacade.frontFighterMoves(fight_,  2, data_);
        assertEq(0, moves_.size());
    }
    ...
    public void backFighterMoves1Test() {
        ...
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = defChoicesSending5(data_, diff_, player_, new StringList(DETECTION, CHARGE), 3, new StringList(DETECTION, CHARGE), 3);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE).usePowerPointsByMove(diff_, ECUME,  25);
        NatStringTreeMap< ChosenMoveInfos> moves_;
        moves_ = FightFacade.backFighterMoves(fight_,  0, data_);
        ChosenMoveInfos infos_;
        assertEq(4, moves_.size());
        infos_ = moves_.getVal(ECUME);
        assertEq(1,infos_.getTypes().size());
    ...
    public void backFighterMoves2Test() {
        ...
        Fight fight_ = defChoicesSending5(data_, diff_, player_, new StringList(DETECTION, CHARGE), 3, new StringList(DETECTION, CHARGE), 3);
        NatStringTreeMap< ChosenMoveInfos> moves_;
        moves_ = FightFacade.backFighterMoves(fight_,  1, data_);
        assertEq(0, moves_.size());
    }
    ...
    public void initChosableTargets3Test() {
        ...
        action_ = fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getAction();
        assertNull(action_);
        assertEq(2, fight_.getTemp().getChosableFoeTargets().size());
    ...
    public void initChosableTargets5Test() {
        ...
        PokemonPlayer lasPk_ = pkMoves(data_, diff_, pokemon_, map_);
        player_.getTeam().add(lasPk_);
        lasPk_ = pkMoves(data_, diff_, pokemon_, map_);
        player_.getTeam().add(lasPk_);
        lasPk_ = pkMoves(data_, diff_, pokemon_, map_);
        player_.getTeam().add(lasPk_);
        player_.recupererOeufPensions(new Egg(PTITARD));
    ...
    public void initChosableTargets10Test() {
        ...
        AbstractAction action_;
        action_ = fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_TWO).getAction();
        assertNull(action_);
        assertEq(3, fight_.getTemp().getChosableFoeTargets().size());
        assertSame(BoolVal.FALSE,  fight_.getTemp().getChosableFoeTargets().first().getChosable());
        assertSame(BoolVal.TRUE, fight_.getTemp().getChosableFoeTargets().get(1).getChosable());
    ...
    public void chooseFrontFighter1Test() {
        ...
        Fight fight_ = FightFacade.newFight();
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
        PkTrainer foePokemon_ = pkTrainer( 3, new StringList(DETECTION, CHARGE));
        foeTeam_.add(foePokemon_);
        DualFight dual_ = new DualFight();
        Ally ally_ = new Ally();
        CustList<PkTrainer> allyTeam_ = new CustList<PkTrainer>();
        PkTrainer allyPokemon_ = pkTrainer( 3, new StringList(DETECTION, CHARGE));
...
//        assertEq(Fighter.BACK, fight_.getChosenFoeTarget());
        ...
        assertEq(0, fight_.getTemp().getTargetCoords().size());
    }
...
//        assertEq(0, fight_.getChosenFoeTarget());
        ...
        assertEq(NULL_REF, fight_.getTemp().getChosenHealingMove());
        assertEq(Fighter.BACK, fight_.getTemp().getChosenSubstitute());
        assertEq(1, fight_.getTemp().getTargetCoords().size());
        assertTrue(TargetCoords.eq(tc(KEY_FOE, POKEMON_TARGET_ZERO),fight_.getTemp().getTargetCoords().get(0)));
    }
    ...
    public void chooseFrontFighter4Test() {
        ...
        FightSending.firstEffectWhileSendingTeams(fight_, diff_, data_);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).usePowerPointsByMove(diff_, ECUME,  25);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).setFirstChosenMoveTarget(PISTOLET_A_O, tc(KEY_PLAYER, POKEMON_TARGET_ONE));
        FightFacade.chooseFrontFighter(fight_, 0, diff_, data_);
        assertEq(0, fight_.getTemp().getChosenIndexFront());
        assertEq(Fighter.BACK, fight_.getTemp().getChosenIndexBack());
        assertEq(4, fight_.getTemp().getPossibleActionsCurFighter().size());
...
//        assertEq(Fighter.BACK, fight_.getChosenFoeTarget());
        ...
        assertEq(Fighter.BACK, fight_.getTemp().getChosenSubstitute());
        assertEq(1, fight_.getTemp().getTargetCoords().size());
        assertTrue(TargetCoords.eq(tc(KEY_PLAYER, POKEMON_TARGET_ONE),fight_.getTemp().getTargetCoords().get(0)));
    }
    ...
    public void chooseFrontFighter5Test() {
        ...
        pokemon_.setGender(Gender.NO_GENDER);
        pokemon_.setLevel( 17);
        StringMap<Long> initMoves_ = new StringMap<Long>();
        initMoves_.put(SEISME,10L);
        PokemonPlayer lasPk_ = pkMoves(data_, diff_, pokemon_, initMoves_);
        player_.getTeam().add(lasPk_);
        lasPk_ = pkMoves(data_, diff_, pokemon_);
        player_.getTeam().add(lasPk_);
        player_.recupererOeufPensions(new Egg(PTITARD));
...
//        assertEq(Fighter.BACK, fight_.getChosenFoeTarget());
    ...
    public void chooseFrontFighter8Test() {
        ...
        FightSending.firstEffectWhileSendingTeams(fight_, diff_, data_);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).usePowerPointsByMove(diff_, ECUME,  25);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).setChosenHealingObjectMove(HUILE, ECUME);
        FightFacade.chooseFrontFighter(fight_, 0, diff_, data_);
        assertEq(0, fight_.getTemp().getChosenIndexFront());
        assertEq(Fighter.BACK, fight_.getTemp().getChosenIndexBack());
        assertEq(4, fight_.getTemp().getPossibleActionsCurFighter().size());
...
//        assertEq(Fighter.BACK, fight_.getChosenFoeTarget());
    ...
    public void chooseFrontFighter9Test() {
        ...
        FightSending.firstEffectWhileSendingTeams(fight_, diff_, data_);
        fight_.setState(FightState.SWITCH_PROPOSE);
        FightFacade.chooseFrontFighter(fight_, 2, diff_, data_);
...
//        assertEq(Fighter.BACK, fight_.getChosenFoeTarget());
    ...
    public void chooseFrontFighter10Test() {
        ...
        fight_.setEnvType(EnvironmentType.ROAD);
        FightSending.firstEffectWhileSendingTeams(fight_, diff_, data_);
        FightFacade.chooseFrontFighter(fight_, 1, diff_, data_);
        assertEq(Fighter.BACK, fight_.getTemp().getChosenIndexFront());
        assertEq(Fighter.BACK, fight_.getTemp().getChosenIndexBack());
        assertEq(0, fight_.getTemp().getPossibleActionsCurFighter().size());
        assertEq(ActionType.NOTHING, fight_.getTemp().getSelectedActionCurFighter());
...
//        assertEq(Fighter.BACK, fight_.getChosenFoeTarget());
    ...
    public void changeAction5Test() {
        ...
        FightFacade.chooseFrontFighter(fight_,  0, diff_, data_);
        FightFacade.changeAction(fight_, ActionType.SWITCH, data_, diff_);
        FightFacade.chooseSubstituteFighter(fight_,0,data_);
        FightFacade.changeAction(fight_, ActionType.MOVE, data_, diff_);
        assertEq(1, fight_.getTemp().getCurrentFighterMoves().size());
        assertEq(ActionType.MOVE, fight_.getTemp().getSelectedActionCurFighter());
    }
    ...
    public void changeAction7Test() {
        ...
        TeamPosition userOne_ = tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
        TeamPosition userTwo_ = tp(KEY_PLAYER, POKEMON_FIGHTER_ONE);
        fight_.getFighter(userOne_).setGroundPlace( 1);
        fight_.getFighter(userOne_).setGroundPlaceSubst( 1);
        fight_.getFighter(userTwo_).setGroundPlace( 0);
        fight_.getFighter(userTwo_).setGroundPlaceSubst( 0);
        fight_.getFighter(userTwo_).usePowerPointsByMove(diff_, ECUME,  2);
        FightFacade.chooseFrontFighter(fight_,  0, diff_, data_);
        FightFacade.changeAction(fight_, ActionType.HEALING, data_, diff_);
    ...
    public void changeAction8Test() {
        ...
        FightFacade.changeAction(fight_, ActionType.SWITCH, data_, diff_);
        FightFacade.chooseSubstituteFighter(fight_,0,data_);
        FightFacade.chooseBackFighter(fight_,0,data_);
        FightFacade.changeAction(fight_, ActionType.HEALING, data_, diff_);
        FightFacade.chooseFrontFighter(fight_,  0, diff_, data_);
        assertEq(ActionType.SWITCH, fight_.getTemp().getSelectedActionCurFighter());
        FightFacade.changeAction(fight_, ActionType.SWITCH, data_, diff_);
    ...
    public void changeAction9Test() {
        ...
        assertEq(SEISME, fight_.getTemp().getChosenMoveFront());
        assertEq(1, fight_.getTemp().getCurrentFighterMoves().size());
        assertEq(SEISME, fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getFirstChosenMove());
    }
    ...
    public void setSubstituteSwitch3Test() {
        ...
        fight_.getFighter(userTwo_).setGroundPlace( 0);
        fight_.getFighter(userTwo_).setGroundPlaceSubst( 0);
        fight_.getTemp().setChosenIndexFront( 2);
        setSubstituteSwitch(fight_, 1, data_);
        Fighter fighter_ = fight_.getFighter(userOne_);
        AbstractAction action_ = fighter_.getAction();
        assertNull(action_);
    ...
    public void chooseBackFighterAddon1Test() {
        ...
        fight_.getTemp().setChosenIndexFront( 1);
...
//        assertEq(Fighter.BACK, fight_.getChosenFoeTarget());
    ...
    public void chooseBackFighter5Test() {
        ...
        FightSending.firstEffectWhileSendingTeams(fight_, diff_, data_);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE).usePowerPointsByMove(diff_, ECUME,  25);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE).setChosenHealingObjectMove(HUILE, ECUME);
        FightFacade.chooseBackFighter(fight_, 0, data_);
        assertEq(Fighter.BACK, fight_.getTemp().getChosenIndexFront());
        assertEq(0, fight_.getTemp().getChosenIndexBack());
        assertEq(2, fight_.getTemp().getPossibleActionsCurFighter().size());
...
//        assertEq(Fighter.BACK, fight_.getChosenFoeTarget());
    ...
    public void chooseBackFighter10Test() {
        ...
        FightSending.firstEffectWhileSendingTeams(fight_, diff_, data_);
        fight_.setState(FightState.SWITCH_PROPOSE);
        FightFacade.chooseBackFighter(fight_, 1, data_);
        assertEq(Fighter.BACK, fight_.getTemp().getChosenIndexFront());
        assertEq(Fighter.BACK, fight_.getTemp().getChosenIndexBack());
        assertEq(0, fight_.getTemp().getPossibleActionsCurFighter().size());
        assertEq(ActionType.NOTHING, fight_.getTemp().getSelectedActionCurFighter());
...
//        assertEq(Fighter.BACK, fight_.getChosenFoeTarget());
    ...
    public void chooseBackFighter14Test() {
        ...
        fight_.getFighter(userTwo_).setGroundPlace( 0);
        fight_.getFighter(userTwo_).setGroundPlaceSubst( 0);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_THREE).getRemainingHp().affectZero();
        FightFacade.chooseFrontFighter(fight_,  0, diff_, data_);
        FightFacade.chooseMove(fight_, RELAIS, diff_, data_);
        assertTrue(FightFacade.requiredSwitch(fight_, data_));
        FightFacade.chooseSubstituteFighter(fight_,  1, data_);
        assertTrue(fight_.isError());
        Fighter fighter_ = fight_.getFighter(userTwo_);
        AbstractAction action_ = fighter_.getAction();
        assertTrue(action_ instanceof ActionMove);
    ...
    public void setChosenHealingItemBack1Test() {
        ...
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = defChoicesSending2(data_, diff_, player_, new StringList(DETECTION, CHARGE));
        TeamPosition user_ = tp(KEY_PLAYER, POKEMON_FIGHTER_TWO);
    ...
    public void setChosenHealingItemBack7Test() {
        ...
        TeamPosition user_ = tp(KEY_PLAYER, POKEMON_FIGHTER_TWO);
        fight_.getFighter(user_).setRemainedHp(Rate.one());
        fight_.getTemp().setChosenIndexBack( 2);
        FightFacade.setChosenHealingItemBack(fight_, HUILE_MAX, data_);
        Fighter fighter_ = fight_.getFighter(user_);
        AbstractAction action_ = fighter_.getAction();
        assertNull(action_);
    ...
    public void setChosenHealingItem4Test() {
        ...
        Fight fight_ = defChoicesSending2(data_, diff_, player_, new StringList(DETECTION, CHARGE));
        TeamPosition user_ = tp(KEY_PLAYER, POKEMON_FIGHTER_TWO);
        fight_.getFighter(user_).usePowerPointsByMove(diff_, ECUME,  2);
        FightFacade.chooseBackFighter(fight_,  0, data_);
        FightFacade.changeAction(fight_, ActionType.HEALING, data_, diff_);
        FightFacade.setChosenHealingItem(fight_, HUILE, data_);
        Fighter fighter_ = fight_.getFighter(user_);
    ...
    public void setChosenHealingItemMove1Test() {
        ...
        fight_.getFighter(userTwo_).setGroundPlace( 0);
        fight_.getFighter(userTwo_).setGroundPlaceSubst( 0);
        fight_.getFighter(userTwo_).usePowerPointsByMove(diff_, PISTOLET_A_O,  1);
        FightFacade.chooseFrontFighter(fight_,  0, diff_, data_);
        FightFacade.changeAction(fight_, ActionType.HEALING, data_, diff_);
        FightFacade.setChosenHealingItem(fight_, HUILE, data_);
    ...
    public void setChosenHealingItemMove2Test() {
        ...
        Fight fight_ = defChoicesSending2(data_, diff_, player_, new StringList(DETECTION, CHARGE));
        TeamPosition user_ = tp(KEY_PLAYER, POKEMON_FIGHTER_TWO);
        fight_.getFighter(user_).usePowerPointsByMove(diff_, PISTOLET_A_O,  1);
        FightFacade.chooseBackFighter(fight_,  0, data_);
        FightFacade.changeAction(fight_, ActionType.HEALING, data_, diff_);
        FightFacade.setChosenHealingItem(fight_, HUILE, data_);
        FightFacade.setChosenHealingItemMove(fight_, PISTOLET_A_O);
...
//        assertTrue(!fight_.getChosablePlayerTargets().first());
    ...
    public void allowedMovesNotEmpty1Test() {
        ...
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = defChoicesSending5(data_, diff_, player_, new StringList(DETECTION, CHARGE), 3, new StringList(DETECTION, CHARGE), 3);
        StringList moves_ = FightFacade.allowedMovesNotEmpty(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), data_);
        assertEq(4, moves_.size());
    ...
    public void remainingThrowersTargetsHp1Test() {
        ...
        assertEq(3, map_.getVal(tp(KEY_PLAYER, POKEMON_FIGHTER_ONE)).size());
        ...
        assertEq(new Rate("4587/100"), mapFighters_.getPlayer().getVal(tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO)).getFront());
        assertEq(new Rate("4587/100"), mapFighters_.getPlayer().getVal(tp(KEY_PLAYER, POKEMON_FIGHTER_ONE)).getFront());
        assertEq(new Rate("4587/100"), mapFighters_.getPlayer().getVal(tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO)).getBack());
        assertEq(new Rate("4587/100"), mapFighters_.getPlayer().getVal(tp(KEY_PLAYER, POKEMON_FIGHTER_ONE)).getBack());
        mapFighters_ = mapMoves_.getVal(ECUME);
        assertEq(1, mapFighters_.getFoe().size());
        assertEq(new Rate("16909/5200"), mapFighters_.getFoe().getVal(tp(KEY_FOE, POKEMON_FIGHTER_ZERO)).getFront());
        assertEq(new Rate("16909/5200"), mapFighters_.getFoe().getVal(tp(KEY_FOE, POKEMON_FIGHTER_ZERO)).getBack());
        assertEq(2, mapFighters_.getPlayer().size());
        assertEq(new Rate("4587/100"), mapFighters_.getPlayer().getVal(tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO)).getFront());
        assertEq(new Rate("4587/100"), mapFighters_.getPlayer().getVal(tp(KEY_PLAYER, POKEMON_FIGHTER_ONE)).getFront());
        assertEq(new Rate("4587/100"), mapFighters_.getPlayer().getVal(tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO)).getBack());
    ...
    public void setFirstChosenMoveFoeTarget1Test() {
        ...
        assertTrue(targets_.containsObj(tc(KEY_FOE, POKEMON_TARGET_ZERO)));
        assertEq(Fighter.BACK, fighter_.getSubstistute());
    }
    ...
    public void setFirstChosenMovePlayerTarget1Test() {
        ...
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = defChoicesSending8(data_, diff_, player_, new StringList(DETECTION, CHARGE), 3, 3, 3, 3);
        TeamPosition userOne_ = tp(KEY_PLAYER, POKEMON_FIGHTER_ONE);
        FightFacade.chooseFrontFighter(fight_,  1, diff_, data_);
        FightFacade.chooseMove(fight_, INTERVERSION, diff_, data_);
        FightFacade.setFirstChosenMovePlayerTarget(fight_,  0);
        Fighter fighter_ = fight_.getFighter(userOne_);
        AbstractAction action_ = fighter_.getAction();
        assertTrue(action_ instanceof ActionMove);
        ...
        TargetCoordsList targets_ = fighter_.getChosenTargets();
        assertEq(1, targets_.size());
        assertTrue(targets_.containsObj(tc(KEY_PLAYER, POKEMON_TARGET_ZERO)));
        assertEq(Fighter.BACK, fighter_.getSubstistute());
    }
    ...
    public void sortedFightersUsingMoveDependingOnPlayerChoices1Test() {
        ...
        fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE).setFirstChosenMove(DETECTION);
        ...
        assertEq(SEISME, tree_.getVal(tp(KEY_PLAYER, POKEMON_FIGHTER_ONE)).getFirstChosenMove());
        ...
        assertTrue(fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE).getAction() instanceof ActionMove);
        assertEq(DETECTION, fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO).getFirstChosenMove());
        assertEq(DETECTION, fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE).getFirstChosenMove());
        assertEq(SEISME, fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getFirstChosenMove());
        assertEq(SEISME, fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE).getFirstChosenMove());
        assertEq(NULL_REF, fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO).getFinalChosenMove());
        assertEq(NULL_REF, fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE).getFinalChosenMove());
        assertEq(NULL_REF, fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getFinalChosenMove());
        assertEq(NULL_REF, fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE).getFinalChosenMove());
    }
    ...
    public void sortedFightersUsingMoveDependingOnPlayerChoices2Test() {
        ...
        assertEq(DETECTION, tree_.getVal(tp(KEY_FOE, POKEMON_FIGHTER_ONE)).getFirstChosenMove());
        assertEq(SEISME, tree_.getVal(tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO)).getFirstChosenMove());
        assertEq(SEISME, tree_.getVal(tp(KEY_PLAYER, POKEMON_FIGHTER_FOUR)).getFirstChosenMove());
        assertTrue(fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO).getAction() instanceof ActionMove);
        assertTrue(fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE).getAction() instanceof ActionMove);
        assertTrue(fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getAction() instanceof ActionMove);
        assertEq(DETECTION, fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO).getFirstChosenMove());
        ...
        assertEq(NULL_REF, fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE).getFinalChosenMove());
        assertEq(NULL_REF, fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getFinalChosenMove());
        assertNull(fight_.getFighter(tp(KEY_PLAYER, POKEMON_FIGHTER_FOUR)).getAction());
    }
...
//        assertEq(Fighter.BACK, fight_.getFirstPositPlayerFighters().getVal( 1));
    ...
    public void setSubstituteFront7Test() {
        ...
        FightArtificialIntelligence.choiceForSubstituing(fight_, data_);
        FightFacade.chooseFrontFighter(fight_,  1, diff_, data_);
        FightFacade.setSubstituteFront(fight_,  1);
        assertEq(1, fight_.getFirstPositPlayerFighters().getVal( 0));
//        assertEq(1, fight_.getFirstPositPlayerFighters().getVal( 1));
        assertEq(0, fight_.getFirstPositPlayerFighters().getVal( 1));
        assertEq(Fighter.BACK, fight_.getFirstPositPlayerFighters().getVal( 2));
    ...
    public void setSubstituteBack1Test() {
        ...
        FightArtificialIntelligence.choiceForSubstituing(fight_, data_);
        FightFacade.chooseBackFighter(fight_,  0, data_);
        FightFacade.setSubstituteBack(fight_,  0);
        assertEq(0, fight_.getFirstPositPlayerFighters().getVal( 0));
        assertEq(0, fight_.getFirstPositPlayerFighters().getVal( 1));
    }
    ...
    public void setSubstituteEndRound2Test() {
        ...
        FightArtificialIntelligence.choiceForSubstituing(fight_, data_);
        FightFacade.chooseBackFighter(fight_,  0, data_);
        FightFacade.setSubstituteEndRound(fight_,  0);
        assertEq(0, fight_.getFirstPositPlayerFighters().getVal( 0));
        assertEq(0, fight_.getFirstPositPlayerFighters().getVal( 1));
        assertEq(0, fight_.getTemp().getChosenSubstitute());
    }
    ...
    public void isChosableForLearningAndEvolving1Test() {
        ...
        FightKo.setKoMoveTeams(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), diff_, data_);
        FightEndRound.proponeMovesEvolutions(fight_, player_, diff_, data_);
        assertTrue(FightFacade.isChosableForLearningAndEvolving(fight_,  0));
    }
    ...
    public void isChosableForLearningAndEvolving2Test() {
        ...
        FightKo.setKoMoveTeams(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), diff_, data_);
        FightEndRound.proponeMovesEvolutions(fight_, player_, diff_, data_);
        assertTrue(!FightFacade.isChosableForLearningAndEvolving(fight_,  -1));
    }
    ...
    public void choosePokemonForLearningAndEvolving2Test() {
        ...
        FightKo.setKoMoveTeams(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), diff_, data_);
        FightEndRound.proponeMovesEvolutions(fight_, player_, diff_, data_);
        FightFacade.choosePokemonForLearningAndEvolving(fight_,  -1, data_);
    ...
    public void setEvolution1Test() {
        ...
        IntMap<ChoiceOfEvolutionAndMoves> choices_ = fight_.getChoices();
        ChoiceOfEvolutionAndMoves choice_ = choices_.getVal( 0);
    ...
    public void getPlayerFrontTeam1Test() {
        ...
        fight_.getFighter(userTwo_).setGroundPlace( 0);
        fight_.getFighter(userTwo_).setGroundPlaceSubst( 0);
        CustList< FighterPosition> mapFighters_ = FightFacade.getPlayerFrontTeam(fight_);
        assertEq(2, mapFighters_.size());
        assertSame(mapFighters_.get( 0).getFighter(), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE));
        assertSame(mapFighters_.get( 1).getFighter(), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO));
    }
    ...
    public void getPlayerFrontTeam2Test() {
        ...
        TeamPosition userOne_ = tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
        TeamPosition userTwo_ = tp(KEY_PLAYER, POKEMON_FIGHTER_THREE);
        fight_.getFighter(userOne_).setGroundPlace( 1);
        fight_.getFighter(userOne_).setGroundPlaceSubst( 1);
        fight_.getFighter(userTwo_).setGroundPlace( 0);
        fight_.getFighter(userTwo_).setGroundPlaceSubst( 0);
        ...
        assertSame(mapFighters_.get( 0).getFighter(), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO));
    }
    ...
    public void getAllyFrontTeam1Test() {
        ...
        fight_.getFighter(userTwo_).setGroundPlace( 0);
        fight_.getFighter(userTwo_).setGroundPlaceSubst( 0);
        IntTreeMap< Fighter> mapFighters_ = FightFacade.getAllyFrontTeam(fight_);
        assertEq(1, mapFighters_.size());
        assertSame(mapFighters_.getVal( 0), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_THREE));
    }
    ...
    public void getUnionFrontTeam1Test() {
        ...
        fight_.getFighter(userTwo_).setGroundPlace( 0);
        fight_.getFighter(userTwo_).setGroundPlaceSubst( 0);
        IntTreeMap< FighterPosition> mapFighters_ = FightFacade.getUnionFrontTeam(fight_);
        assertEq(2, mapFighters_.size());
        assertSame(mapFighters_.getVal( 0).getFighter(), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_THREE));
        assertSame(mapFighters_.getVal( 1).getFighter(), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO));
        assertEq(1,FightFacade.retrieve( 0,mapFighters_));
        assertEq(Fighter.BACK,FightFacade.retrieve( 1,mapFighters_));
        assertEq(Fighter.BACK,FightFacade.retrieve( 2,mapFighters_));
        assertEq(0,FightFacade.retrieve( 3,mapFighters_));
    }
    ...
    public void getPlayerBackTeam1Test() {
        ...
        assertEq(2, mapFighters_.size());
        assertSame(mapFighters_.get( 0).getFighter(), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE));
        assertSame(mapFighters_.get( 1).getFighter(), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_TWO));
    }
    ...
    public void getPlayerTeam1Test() {
        ...
        assertSame(mapFighters_.get( 0).getFighter(), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO));
        assertSame(mapFighters_.get( 1).getFighter(), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE));
        assertSame(mapFighters_.get( 2).getFighter(), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_TWO));
    }
    ...
    public void getAllyBackTeam1Test() {
        ...
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = defChoicesSending4(data_, diff_, player_, new StringList(DETECTION, CHARGE), 3, 3, new StringList(DETECTION, CHARGE), 3, 3, 3);
        IntTreeMap< FighterPosition> mapFighters_ = FightFacade.getAllyBackTeam(fight_);
        assertEq(1, mapFighters_.size());
        assertSame(mapFighters_.getVal( 0).getFighter(), fight_.getFighter(tp(KEY_PLAYER, POKEMON_FIGHTER_FOUR)));
    }
    ...
    public void getFoeFrontTeam1Test() {
        ...
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = defChoicesSending4(data_, diff_, player_, new StringList(DETECTION, CHARGE), 3, 3, new StringList(DETECTION, CHARGE), 3, 3, 3);
        TeamPosition userOne_ = tp(KEY_FOE, POKEMON_FIGHTER_ZERO);
        TeamPosition userTwo_ = tp(KEY_FOE, POKEMON_FIGHTER_ONE);
        fight_.getFighter(userOne_).setGroundPlace( 1);
        fight_.getFighter(userOne_).setGroundPlaceSubst( 1);
        fight_.getFighter(userTwo_).setGroundPlace( 0);
        fight_.getFighter(userTwo_).setGroundPlaceSubst( 0);
        IntTreeMap< FighterPosition> mapFighters_ = FightFacade.getFoeFrontTeam(fight_);
        assertEq(2, mapFighters_.size());
        assertSame(mapFighters_.getVal( 0).getFighter(), fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE));
        assertSame(mapFighters_.getVal( 1).getFighter(), fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO));
        assertEq(1,FightFacade.retrieve( 0,mapFighters_));
        assertEq(0,FightFacade.retrieve( 1,mapFighters_));
        assertEq(Fighter.BACK,FightFacade.retrieve( 2,mapFighters_));
    }

    @Test
    public void getFoeFrontTeamWild1() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        ...
        IntTreeMap< FighterPosition> mapFighters_ = FightFacade.getFoeFrontTeam(fight_);
        assertEq(1, mapFighters_.size());
        assertEq(0,FightFacade.retrieve( 0,mapFighters_));
    }

    @Test
    public void getFoeFrontTeamWild2() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        ...
        assertEq(Fighter.BACK,FightFacade.retrieve( 0,mapFighters_));
    }
    ...
    public void getPlayerToCatch() {
        ...
        player_.getTeam().add(lasPk_);
        Fight fight_ = fightRoad(player_, PIKACHU,  1, diff_, data_);
        assertEq(1,FightFacade.getPlayerToCatch(fight_).size());
        assertEq(PTITARD,FightFacade.getSinglePlayerToCatch(fight_,0).getFighter().getName());
    }
    @Test
    public void getSingleFoeToBeCaught1() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        ...
        player_.getTeam().add(lasPk_);
        Fight fight_ = fightRoad(player_, PIKACHU,  1, diff_, data_);
        assertEq(1,FightFacade.getFoeToBeCaught(fight_).size());
        assertEq(PIKACHU,FightFacade.getSingleFoeToBeCaught(fight_,0).getFighter().getName());
        assertEq(1,FightFacade.getFoeToBeCaught(fight_,false).size());
        assertEq(PIKACHU,FightFacade.getSingleFoeToBeCaught(fight_,false,0).getFighter().getName());
        assertEq(0,FightFacade.swallow(fight_,FightFacade.attempted(fight_)).size());
    }
    @Test
    public void getSingleFoeToBeCaught2() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        ...
        assertEq(1,FightFacade.getFoeToBeCaught(fight_).size());
        assertEq(PIKACHU,FightFacade.getSingleFoeToBeCaught(fight_,0).getFighter().getName());
        assertEq(1,FightFacade.getFoeToBeCaught(fight_,true).size());
        assertEq(PIKACHU,FightFacade.getSingleFoeToBeCaught(fight_,true,0).getFighter().getName());
        assertEq(0,FightFacade.swallow(fight_,FightFacade.attempted(fight_)).size());
    }
    @Test
    public void getSingleFoeToBeCaught3() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
    ...
    @Test
    public void getSingleFoeToBeCaught4() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
    ...
    public void getPlayerBackTeamForSubstituting2Test() {
        ...
        CustList< FighterPosition> mapFighters_ = FightFacade.getPlayerBackTeam(fight_);
        assertEq(1, mapFighters_.size());
        assertSame(mapFighters_.get( 0).getFighter(), fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_TWO));
    }
    ...
    public void deselect1Test() {
        ...
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = defChoicesSending2(data_, diff_, player_, new StringList(DETECTION, CHARGE));
        fight_.getTemp().setChosenIndexBack( 0);
    ...
    public void deselect2Test() {
        ...
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = defChoicesSending2(data_, diff_, player_, new StringList(DETECTION, CHARGE));
        fight_.getTemp().setChosenIndexFront( 0);
        FightFacade.deselect(fight_);
        assertEq(Fighter.BACK, fight_.getTemp().getChosenIndexFront());
    }
//
...
//    }
    ...
    public void roundAllThrowersChooseActionsFoe3Test() {
        ...
        pokemon_.setLevel( 15);
        Fight fight_ = fihtRoadSending(pokemon_, player_, diff_, data_);
        fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO).usePowerPointsByMove(diff_, OEIL_MIRACLE,  50);
        fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO).usePowerPointsByMove(diff_, PASSE_PASSE,  50);
        fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO).usePowerPointsByMove(diff_, ORAGE,  50);
        fight_.getFoeTeam().activerEffetEquipe(AIR_VEINARD);
        fight_.getUserTeam().activerEffetEquipe(AIR_VEINARD);
        FightFacade.chooseFrontFighter(fight_,  0, diff_, data_);
        FightFacade.chooseMove(fight_, PISTOLET_A_O, diff_, data_);
    ...
    public void roundAllThrowersChooseActionsFoe5Test() {
        ...
        assertTrue(!FightKo.endedFight(fight_, diff_));
        assertEq(FightState.SWITCH_APRES_ATTAQUE, fight_.getState());
        fighter_ = fight_.getFighter( tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO));
        FightFacade.chooseFrontFighter(fight_,fighter_.getGroundPlace(), diff_, data_);
        FightFacade.changeAction(fight_, ActionType.SWITCH, data_, diff_);
        setSubstituteSwitch(fight_, 0, data_);
        FightFacade.roundAllThrowersChooseActionsFoe(fight_, diff_, player_, data_);
...
//        assertEq(FightState.ATTAQUES, fight_.getState());
    ...
    public void learnAndEvolveAttack8Test() {
        ...
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getWonExp().affect(new Rate("25"));
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).setGroundPlace( 1);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_TWO).setGroundPlace( 0);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).setGroundPlaceSubst( 1);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_TWO).setGroundPlaceSubst( 0);
        FightKo.setKoMoveTeams(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), diff_, data_);
        //FightKo.setKoMoveTeams(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), diff_, data_);
        FightEndRound.proponeMovesEvolutions(fight_, player_, diff_, data_);
        FightFacade.choosePokemonForLearningAndEvolving(fight_,  0, data_);
        ...
        FightFacade.learnAndEvolveAttack(fight_, diff_, data_);
        assertTrue(!fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).estKo());
        assertEq(1, fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getGroundPlace());
        assertEq(Fighter.BACK, fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE).getGroundPlace());
        assertEq(0, fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_TWO).getGroundPlace());
//        assertEq(FightState.ATTAQUES, fight_.getState());
        assertEq(FightState.SWITCH_PROPOSE, fight_.getState());
    }
...
//        pokemon_.setLevel( 24);
        ...
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = defChoicesSending7(data_, diff_, player_, new StringList(JACKPOT), new StringList(DETECTION));
        //fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getWonExp().affect(new Rate("50"));
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).setGroundPlace( 1);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_TWO).setGroundPlace( 0);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).setGroundPlaceSubst( 1);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_TWO).setGroundPlaceSubst( 0);
...
//        assertEq(FightState.ATTAQUES, fight_.getState());
    ...
    public void sendSubstitutesChooseActions2Test() {
        ...
        fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_TWO).setRemainedHp(Rate.one());
        FightKo.setKoMoveTeams(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), diff_, data_);
        fight_.setState(FightState.SWITCH_PROPOSE);
        FightArtificialIntelligence.choiceForSubstituing(fight_, data_);
    ...
    public void sendSubstitutesChooseActions4Test() {
        ...
        FightArtificialIntelligence.choiceForSubstituing(fight_, data_);
        FightFacade.chooseBackFighter(fight_,  0, data_);
        FightFacade.setSubstituteBack(fight_,  1);
        FightFacade.sendSubstitutesChooseActions(fight_, diff_, player_, data_);
        assertEq(FightState.ATTAQUES, fight_.getState());
    }
    ...
    public void attemptCatching1Test() {
        ...
        assertEq(NULL_REF,fight_.getCatchingBalls().first().getCatchingBall());
        assertTrue(FightKo.endedFight(fight_, diff_));
    }
    ...
    @Test
    public void attemptCatching7Test() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        ...
        fight_.getCatchingBalls().first().setCaught(true);
        FightFacade.attemptCatching(fight_, diff_, player_, data_, false);
        assertEq(HYPER_BALL,fight_.getCatchingBalls().first().getCatchingBall());
    }
    @Test
    public void calculateCatchingRates1Test() {
        ...
        fight_.getUserTeam().activerEffetEquipe(AIR_VEINARD);
        fight_.wildPokemon().setRemainedHp(Rate.one());
        NatStringTreeMap<BallNumberRate> rates_ = FightFacade.calculateCatchingRatesSingle(fight_, diff_, player_, data_, 0, 0);
        assertEq(0, rates_.size());
        assertTrue(FightFacade.enoughBall(fight_,player_,data_));
    }
    ...
    public void calculateCatchingRates2Test() {
        ...
        assertEq(1, rates_.getVal(HYPER_BALL).getLaw().nbEvents());
        assertEq(Rate.one(), rates_.getVal(HYPER_BALL).getLaw().getEvent(0));
...
//        assertEq("100", rates_.getVal(HYPER_BALL).getPercent());
    ...
    @Test
    public void calculateCatchingRates3Test() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        ...
        fight_.getUserTeam().activerEffetEquipe(AIR_VEINARD);
        fight_.wildPokemon().setRemainedHp(Rate.one());
        NatStringTreeMap<BallNumberRate> rates_ = FightFacade.calculateCatchingRatesSingle(fight_, diff_, player_, data_, -1, 0);
        assertEq(1, rates_.size());
        assertEq(LgInt.one(), rates_.getVal(HYPER_BALL).getNumber());
        assertEq(0, rates_.getVal(HYPER_BALL).getLaw().nbEvents());
        assertEq(HYPER_BALL, rates_.getVal(HYPER_BALL).getName());
        assertTrue(FightFacade.enoughBall(fight_,player_,data_));
    }

    @Test
    public void calculateCatchingRates4Test() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        ...
        fight_.getUserTeam().activerEffetEquipe(AIR_VEINARD);
        fight_.wildPokemon().setRemainedHp(Rate.one());
        NatStringTreeMap<BallNumberRate> rates_ = FightFacade.calculateCatchingRatesSingle(fight_, diff_, player_, data_, 0, -1);
        assertEq(1, rates_.size());
        assertEq(LgInt.one(), rates_.getVal(HYPER_BALL).getNumber());
        assertEq(1, rates_.getVal(HYPER_BALL).getLaw().nbEvents());
        assertEq(Rate.one(), rates_.getVal(HYPER_BALL).getLaw().getEvent(0));
    ...
    @Test
    public void calculateCatchingRates5Test() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
    ...
    @Test
    public void calculateCatchingRates6Test() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
...
//        assertEq("100", rates_.getVal(HYPER_BALL).getPercent());
    ...
    @Test
    public void calculateCatchingRates7Test() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
...
//        assertEq("100", rates_.getVal(HYPER_BALL).getPercent());
    ...
    @Test
    public void calculateCatchingRatesSum1() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        ...
        fight_.getUserTeam().activerEffetEquipe(AIR_VEINARD);
        fight_.wildPokemon().setRemainedHp(Rate.one());
        assertEq(0,FightFacade.calculateCatchingRatesSum(fight_,player_,diff_,data_).size());
        assertEq(0,FightFacade.swallow(fight_,FightFacade.attempted(fight_)).size());
    }

    @Test
    public void calculateCatchingRatesSum2() {
        DataBase data_ = initDb();
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        ...
        fight_.wildPokemon().setRemainedHp(Rate.one());
        fight_.getCatchingBalls().first().setCatchingBall(HYPER_BALL);
        IntMap<BallNumberRatePk> res_ = FightFacade.calculateCatchingRatesSum(fight_, player_, diff_, data_);
        assertEq(1, res_.size());
        assertEq(0,res_.getKey(0));
        assertEq(PIKACHU,res_.getValue(0).getNamePk());
        assertEq(HYPER_BALL,res_.getValue(0).getName());
        assertEq(Rate.one(),res_.getValue(0).getRate());
        assertEq("100",res_.getValue(0).getPercent());
        assertEq(1,FightFacade.swallow(fight_,FightFacade.attempted(fight_)).size());
    }
    @Test
    public void sortedFightersBeginRoundWildFight1Test() {
        ...
        player_.getTeam().add(lasPk_);
        player_.getItem(HYPER_BALL);
        Fight fight_ = fightRoad(player_, PTITARD,  1, diff_, data_);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).setFirstChosenMove(ECUME);
    ...
    public void sortedFightersBeginRoundWildFight2Test() {
        ...
        player_.getTeam().add(lasPk_);
        player_.getItem(HYPER_BALL);
        Fight fight_ = fightRoad(player_, PTITARD,  10, diff_, data_);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).setFirstChosenMove(ECUME);
        CustList<MovesListTeamPositionsList> map_;
        map_ = FightFacade.sortedFightersBeginRoundWildFight(fight_, diff_, data_);
    ...
    public void attemptFlee1Test() {
        ...
        lasPk_.setRemainedHp(Rate.one());
        player_.getTeam().add(lasPk_);
        Fight fight_ = fightRoad(player_, PIKACHU,  14, diff_, data_);
        fight_.getUserTeam().activerEffetEquipe(AIR_VEINARD);
    ...
    public void attemptFlee3Test() {
        ...
        lasPk_.setRemainedHp(Rate.one());
        player_.getTeam().add(lasPk_);
        Fight fight_ = fightRoad(player_, PIKACHU,  2, diff_, data_);
        fight_.getUserTeam().activerEffetEquipe(AIR_VEINARD);
        FightFacade.attemptFlee(fight_, diff_, player_, data_, false);
        assertEq(1, fight_.getNbFleeAttempt());
        assertTrue(FightFacade.loose(fight_));
    ...
    public void keepLoop3Test() {
        ...
        Fight fight_ = fightRoad(player_, PIKACHU,  1, diff_, data_);
        fight_.setState(FightState.SWITCH_PROPOSE);
        FightKo.setKo(fight_,Fight.toUserFighter( 0),diff_,data_);
    ...
    public void movesAfterFight3Test() {
        ...
        Fight fight_ = fightRoad(player_, PIKACHU,  1, diff_, data_);
        TeamPosition playerPk_ = tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
        fight_.getFighter(playerPk_).usePowerPointsByMove(diff_, TOURNIQUET,  1);
        StringMap<UsesOfMove> mapMoves_ = FightFacade.movesAfterFight(fight_, playerPk_, diff_);
        assertEq(1, mapMoves_.size());
    ...
    public void movesAfterFight5Test() {
        ...
        Fight fight_ = fightRoad(player_, PIKACHU,  1, diff_, data_);
        TeamPosition playerPk_ = tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
        fight_.getFighter(playerPk_).transformer(fight_.wildPokemon(),  5);
        fight_.getFighter(playerPk_).usePowerPointsByMove(diff_, JACKPOT,  1);
        StringMap<UsesOfMove> mapMoves_ = FightFacade.movesAfterFight(fight_, playerPk_, diff_);
        assertEq(1, mapMoves_.size());
        assertEq(15, mapMoves_.getVal(TOURNIQUET).getCurrent());
        assertEq(15, mapMoves_.getVal(TOURNIQUET).getMax());
    ...
    public void movesAfterFight7Test() {
        ...
        Fight fight_ = fightRoad(player_, PIKACHU,  1, diff_, data_);
        TeamPosition playerPk_ = tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
        fight_.getFighter(playerPk_).getMoves().put(TOURNIQUET, new UsesOfMove( 15));
        fight_.getFighter(playerPk_).usePowerPointsByMove(diff_, TOURNIQUET,  1);
        StringMap<UsesOfMove> mapMoves_ = FightFacade.movesAfterFight(fight_, playerPk_, diff_);
    ...
    public void initTypeEnv1Test() {
        ...
        PokemonPlayer lasPk_ = pkMoves(data_, diff_, pokemon_);
        player_.getTeam().add(lasPk_);
        Fight fight_ = initializeFromSavedGame(player_, PIKACHU,  1, diff_, data_);
    ...
    public void initializeFromSavedGame1Test() {
        ...
        IntMap<BoolVal> ko_ = loadedFight_.getTemp().getKos();
        assertEq(2, ko_.size());
        assertEq(2, getNbKoByValue(ko_, BoolVal.FALSE));
        assertEq(0, getNbKoByValue(ko_, BoolVal.TRUE));
        assertEq(0, getNbKoByValue(ko_, null));
        Fighter playerPk_ = loadedFight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
        Fighter wildPk_ = loadedFight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO);
    ...
    public void initializeFromSavedGame3Test() {
        ...
        actionMove_.getChosenTargets().add(tc(KEY_FOE, POKEMON_TARGET_ZERO));
        assertEq(FightState.ATTAQUES, fight_.getState());
        Fight loadedFight_ = saveFight(fight_);
        FightFacade.initializeFromSavedGame(loadedFight_, diff_, player_, data_);
        IntMap<BoolVal> ko_ = loadedFight_.getTemp().getKos();
    ...
    public void initializeFromSavedGame4Test() {
        ...
        assertEq(FightState.ATTAQUES, fight_.getState());
        Fight loadedFight_ = saveFight(fight_);
        ActionMove actionMove_ = (ActionMove) loadedFight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getAction();
    ...
    public void initializeFromSavedGame5Test() {
        ...
        assertEq(0, getNbKoByValue(ko_, null));
        Fighter playerPk_ = loadedFight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
        Fighter playerBackPk_ = loadedFight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE);
        Fighter wildPk_ = loadedFight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO);
        assertEq(20, playerPk_.getIv().getVal(Statistic.ATTACK));
        assertEq(20, playerPk_.getIv().getVal(Statistic.DEFENSE));
        assertEq(20, playerPk_.getIv().getVal(Statistic.SPECIAL_ATTACK));
    ...
    public void initializeFromSavedGame7Test() {
        ...
        assertEq(0, getNbKoByValue(ko_, null));
        Fighter playerPk_ = loadedFight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
        Fighter playerAllyPk_ = loadedFight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE);
        Fighter wildPk_ = loadedFight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO);
        assertEq(20, playerPk_.getIv().getVal(Statistic.ATTACK));
        assertEq(20, playerPk_.getIv().getVal(Statistic.DEFENSE));
        assertEq(20, playerPk_.getIv().getVal(Statistic.SPECIAL_ATTACK));
    ...
    private Fight defChoicesSending15(DataBase _data, Difficulty _diff, Player _player, StringList _moves, int _p, StringList _foeMoves, int _f1, int _f2) {
        ...
        CustList<PkTrainer> allyTeam_ = new CustList<PkTrainer>();
        allyTeam_.add(pkTrainer(_p, _moves));
    ...
    private Fight defChoicesSending14(DataBase _data, Difficulty _diff, Player _player, StringList _partnerMoves, int _p, StringList _foeMoves, int _f) {
        ...
        foeTeam_.add(pkTrainer(_f, _foeMoves));
        CustList<PkTrainer> allyTeam_ = new CustList<PkTrainer>();
        allyTeam_.add(pkTrainer(_p, _partnerMoves));
        Fight fight_ = initTypeEnvDual(_player, _diff, _data, foeTeam_, allyTeam_);
        setEnvTypeCom(_diff, _data, fight_);
        return fight_;
    }
    ...
    private Fight defChoicesSending13(DataBase _data, Difficulty _diff, Player _player, StringList _partnerMoves, int _p1, StringList _second, int _p2, StringList _foeMoves) {
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
        foeTeam_.add(pkTrainer(17, _foeMoves));
        foeTeam_.add(pkTrainer(17, _foeMoves));
        foeTeam_.add(pkTrainer(17, _foeMoves));
        foeTeam_.add(pkTrainer(17, _foeMoves));
        CustList<PkTrainer> allyTeam_ = new CustList<PkTrainer>();
        allyTeam_.add(pkTrainer(_p1, _partnerMoves));
        allyTeam_.add(pkTrainer(_p2, _partnerMoves));
        Fight fight_ = initTypeEnvDual(_player, _diff, _data, foeTeam_, allyTeam_);
        setEnvTypeCom(_diff, _data, fight_);
        return fight_;
    }
    ...
    private Fight defChoicesSending11(DataBase _data, Difficulty _diff, Player _player, StringList _partnerMoves, int _p, StringList _foeMoves, int _f1, int _f2, int _f3) {
        ...
        foeTeam_.add(pkTrainer(_f1, _foeMoves));
        foeTeam_.add(pkTrainer(_f2, _foeMoves));
        foeTeam_.add(pkTrainer(_f3, _foeMoves));
        CustList<PkTrainer> allyTeam_ = new CustList<PkTrainer>();
        allyTeam_.add(pkTrainer(_p, _partnerMoves));
        Fight fight_ = initTypeEnvDual(_player, _diff, _data, foeTeam_, allyTeam_);
        setEnvTypeCom(_diff, _data, fight_);
    ...
    private Fight defChoicesSending3(DataBase _data, Difficulty _diff, Player _player, StringList _first, StringList _second, StringList _third, StringList _foeMoves) {
        ...
        foeTeam_.add(pkTrainer(3, _foeMoves));
        CustList<PkTrainer> allyTeam_ = new CustList<PkTrainer>();
        allyTeam_.add(pkTrainer(3, _first));
        allyTeam_.add(pkTrainer(3, _first));
        allyTeam_.add(pkTrainer(3, _first));
        Fight fight_ = initTypeEnvDual(_player, _diff, _data, foeTeam_, allyTeam_);
        setEnvTypeCom(_diff, _data, fight_);
    ...
    private static Fight fightRoad(Player _player, String _name, int _level, Difficulty _diff, DataBase _data) {
        Fight fight_ = initTypeEnv(_player, _name, _level, _diff, _data);
        fight_.setEnvType(EnvironmentType.ROAD);
        firstEffectWhileSendingTeams(fight_, _diff, _data);
        return fight_;
    ...
    private static int getNbKoByValue(IntMap<BoolVal> _map, BoolVal _value) {
...
//        return nb_;
    ...
    private void chooseBackFighterAddon(Fight _fight, int _x, DataBase _data) {
        ...
        FightFacade.chooseSubstituteFighter(_fight, _x,_data);
//        FightFacade.chooseBackFighterAddon(_fight, _data, _fight.getUserTeam().substituteAtIndex( _x));
    }

    private static void initChosableTargets(Fight _fight, int _x, String _move, Difficulty _diff, DataBase _data) {
        FightFacade.initChosableTargets(_fight, _move, _diff, _data, _fight.getUserTeam().playerFighterAtIndex( _x).first());
    }
    ...
    private void chooseBackFighterWhileRound(Fight _fight, int _x, DataBase _data) {
        FightFacade.chooseBackFighterWhileRound(_fight, _data, _fight.getUserTeam().substituteAtIndex( _x));
    }

    private NatStringTreeMap<BoolVal> getMoves(Fight _fight) {
        return FightFacade.getMoves(_fight, TARINORME, _fight.getUserTeam().fighterAtIndex( 0));
    }

    private StringList getAbilities(Fight _fight) {
        return FightFacade.getAbilities(_fight, TARINORME, _fight.getUserTeam().fighterAtIndex( 0));
    }

    private EvolutionChoiceMap getEvolutions(DataBase _data, Fight _fight) {
        return FightFacade.getEvolutions(_fight, _data, _fight.getUserTeam().fighterAtIndex( 0));
    }

    private void setFirstChosenMove(Fight _fight, int _x) {
        FightFacade.setFirstChosenMove(SEISME, _fight.getUserTeam().playerFighterAtIndex( _x));
    }

    private void setSubstituteForMove(Fight _fight) {
        FightFacade.setSubstituteForMove(_fight.getUserTeam().substituteAtIndex( 0).first(), _fight.getUserTeam().playerFighterAtIndex( 1).first().getFighter());
    }
