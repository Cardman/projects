...
public class FightItemsTest extends InitializationDataBase {
    ...
    public void canUseItsObject1Test() {
        ...
        assertTrue(!FightItems.canUseItsObject(fight_,tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), data_));
    ...
    public void canUseItsBerry1Test() {
        ...
        Fight fight_ = canUseBerry(data_);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).backUpObject(NULL_REF);
        assertTrue(!FightItems.canUseItsBerry(fight_,tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), data_));
    ...
    public void bonusHp1Test() {
        DataBase data_ = initDb();
        Fight fight_ = canUseBerry(data_);
        TeamPosition fighterCoords_ = tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
    ...
    public void enableBerryPp3Test(){
        ...
        TeamPosition fighterCoords_ = tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
        Fighter fighter_ = fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
        fighter_.getCurrentMoves().getVal(BROUHAHA).setCurrent( 0);
        FightItems.enableBerryPp(fight_, fighterCoords_, BAIE_MEPO, false, data_);
        fighter_ = fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
