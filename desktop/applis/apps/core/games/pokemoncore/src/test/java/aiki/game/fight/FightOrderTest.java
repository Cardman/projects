...
public class FightOrderTest extends InitializationDataBase {
    ...
    public void sortFightersUsingMoveAmongList9Test() {
        ...
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getEv().put(Statistic.SPEED,  0L);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getIv().put(Statistic.SPEED,  0L);
...
//        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_TWO)));
    ...
    public void targetsEffect() {
        ...
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        StringMap<Long> movs_ = new StringMap<Long>();
        movs_.addEntry(PISTOLET_A_O,5L);
    ...
    private Fight sortedFightersAmongListEndRound2(DataBase _data, Difficulty _diff, StringMap<Long> _moves) {
        Player player_ = Player.build(NICKNAME, _diff,false, _data);
    ...
    private Fight sortedFightersAmongListEndRound1(DataBase _data, Difficulty _diff, StringMap<Long> _moves) {
        Player player_ = Player.build(NICKNAME, _diff,false, _data);
        player_.getTeam().add(pkPlayer(_diff, _data,  3, _moves));
        player_.getTeam().add(pkPlayer(_diff, _data,  4, _moves));
        CustList<PkTrainer> allyTeam_ = new CustList<PkTrainer>();
