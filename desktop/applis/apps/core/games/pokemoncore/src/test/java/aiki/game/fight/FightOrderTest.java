...
public class FightOrderTest extends InitializationDataBase {
    ...
    public void sortFightersUsingMoveAmongList9Test() {
        DataBase data_ = initDb();
        Fight fight_ = sortFightersHavingToActAmongList(data_);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).setLevel((short) 5);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).setFirstChosenMove(BROUHAHA);
        ...
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getEv().put(Statistic.SPEED, (short) 0);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO).getIv().put(Statistic.SPEED, (short) 0);
        fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO).setLevel((short) 5);
    ...
    public void closestFightersAmongList1Test() {
        ...
        Fight fight_ = FightFacade.newFight();
        FightFacade.initFight(fight_,player_, diff_, trainer_, data_);
        TeamPositionList list_ = closestFightersAmongList(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), Bytes.newList());
        assertEq(0,list_.size());
        list_ = closestFightersAmongList(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), Bytes.newList());
        assertEq(0,list_.size());
    }
    ...
    public void closestFightersAmongList2Test() {
        ...
        Fight fight_ = FightFacade.newFight();
        FightFacade.initFight(fight_,player_, diff_, trainer_, data_);
        TeamPositionList list_ = closestFightersAmongList(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), Bytes.newList((byte) 0));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_ZERO)));
        list_ = closestFightersAmongList(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), Bytes.newList((byte) 0));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO)));
    }
    ...
    public void closestFightersAmongList3Test() {
        ...
        Fight fight_ = FightFacade.newFight();
        FightFacade.initFight(fight_,player_, diff_, trainer_, data_);
        TeamPositionList list_ = closestFightersAmongList(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), Bytes.newList((byte)0,(byte)1));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_ZERO)));
        list_ = closestFightersAmongList(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), Bytes.newList((byte)0,(byte)1));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO)));
        fight_.getTemp().setMustFront(false);
        list_ = closestFightersAmongList(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), Bytes.newList((byte)0,(byte)1));
        assertEq(2,list_.size());
        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_ZERO)));
    ...
    public void closestFightersAmongList5Test() {
        ...
        Fight fight_ = FightFacade.newFight();
        FightFacade.initFight(fight_,player_, diff_, trainer_, data_);
        TeamPositionList list_ = closestFightersAmongList(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ONE), Bytes.newList((byte)0,(byte)1,(byte)2));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_ONE)));
        list_ = closestFightersAmongList(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ONE), Bytes.newList((byte)0,(byte)1,(byte)2));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_PLAYER, POKEMON_FIGHTER_ONE)));
        list_ = closestFightersAmongList(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ONE), Bytes.newList((byte)2,(byte)1,(byte)0));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_ONE)));
        list_ = closestFightersAmongList(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ONE), Bytes.newList((byte)2,(byte)1,(byte)0));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_PLAYER, POKEMON_FIGHTER_ONE)));
        list_ = closestFightersAmongList(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ONE), Bytes.newList((byte)2,(byte)0,(byte)1));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_ONE)));
        list_ = closestFightersAmongList(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ONE), Bytes.newList((byte)2,(byte)0,(byte)1));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_PLAYER, POKEMON_FIGHTER_ONE)));
        list_ = closestFightersAmongList(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ONE), Bytes.newList((byte)0,(byte)2,(byte)1));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_ONE)));
        list_ = closestFightersAmongList(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ONE), Bytes.newList((byte)0,(byte)2,(byte)1));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_PLAYER, POKEMON_FIGHTER_ONE)));
        list_ = closestFightersAmongList(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ONE), Bytes.newList((byte)0,(byte)2));
        assertEq(2,list_.size());
        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_ZERO)));
        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_TWO)));
        list_ = closestFightersAmongList(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ONE), Bytes.newList((byte)0,(byte)2));
        assertEq(2,list_.size());
        assertTrue(list_.containsObj(tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO)));
    ...
    public void closestFightersAmongList6Test() {
        ...
        Fight fight_ = FightFacade.newFight();
        FightFacade.initFight(fight_,player_, diff_, trainer_, data_);
        TeamPositionList list_ = closestFightersAmongList(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), Bytes.newList((byte)0,(byte)1,(byte)2,(byte)3));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_ZERO)));
        list_ = closestFightersAmongList(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), Bytes.newList((byte)3,(byte)2,(byte)1,(byte)0));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_ZERO)));
        list_ = closestFightersAmongList(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ONE), Bytes.newList((byte) 0));
        assertEq(1,list_.size());
        assertTrue(list_.containsObj(tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO)));
    }
    ...
    public void closestFightersAmongList7Test() {
        ...
        Fight fight_ = FightFacade.newFight();
        FightFacade.initFight(fight_,player_, diff_, trainer_, data_);
        TeamPositionList list_ = closestFightersAmongList(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ONE), Bytes.newList());
        assertEq(0,list_.size());
    }
...
//        assertTrue(list_.containsObj(tp(KEY_FOE, POKEMON_FIGHTER_TWO)));
    ...
    private TeamPositionList closestFigthersTeam(Difficulty _diff, int _i, byte _cst, Fight _fight) {
        Team team_ = _fight.getTeams().getVal(_cst);
        return FightOrder.closestFigthersTeam(_fight, team_.getMembers().getVal((byte) _i), _cst, team_, _diff);
    }
