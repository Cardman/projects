...
//        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL));
    ...
    public void takers1Test() {
        ...
        FightRound.initRound(fight_);
        EqList<TeamPosition> takers_ = FightRound.takers(fight_,POKEMON_PLAYER_FIGHTER_ZERO, data_);
    ...
    public void processEffectTargets1Test() {
        ...
        Fight fight_ = processEffectTargets(userMoves_, partnersMoves_, foesMoves_, diff_, data_);
        TeamPosition thrower_ = POKEMON_PLAYER_FIGHTER_ZERO;
        TeamPosition target_ = POKEMON_FOE_FIGHTER_ZERO;
        Fighter fighter_ = fight_.getFighter(thrower_);
    ...
    public void processEffectTargets13Test() {
        ...
        FightRound.processEffectTargets(fight_, thrower_, thrower_, false, IndexConstants.SECOND_INDEX, new Ints(0), diff_, data_);
    ...
    public void processEffectTargets14Test() {
        ...
        EqList<TeamPosition> list_ = FightRound.takers(fight_,thrower_, data_);
    ...
    public void processEffectTargets15Test() {
        ...
        FightRound.processEffectTargets(fight_, thrower_, target_, true, IndexConstants.FIRST_INDEX, new Ints(), diff_, data_);
    ...
    public void selectTargetHavingToPlayAfterThrower5Test() {
        ...
        fighter_ = fight_.getFighter(thrower_);
        assertTrue(fighter_.isSuccessfulMove());
        EqList<TeamPosition> targets_ = FightRound.selectTargetHavingToPlayAfterThrower(fight_, thrower_, data_);
    ...
    public void calculateCatchingRate1Test() {
        ...
        userMoves_.add(new LevelMoves((short)3,moves_));
        userMoves_.add(new LevelMoves((short)4,moves_));
        Fight fight_ = calculateCatchingRate(userMoves_, PIKACHU, (short) 3, diff_, data_);
    ...
    public void calculateCatchingRate6Test() {
        ...
        userMoves_.add(new LevelMoves((short)3,moves_));
        userMoves_.add(new LevelMoves((short)4,moves_));
        Fight fight_ = calculateCatchingRate(userMoves_, TETARTE, (short) 3, diff_, data_);
        assertEq(new Rate("1"),FightRound.calculateCatchingRate(fight_, MASTER_BALL, false, diff_, data_));
    }
    ...
    public void calculateFleeingRate3Test() {
        ...
        userMoves_.add(new LevelMoves((short)3,moves_));
        userMoves_.add(new LevelMoves((short)4,moves_));
        Fight fight_ = calculateCatchingRate(userMoves_, PIKACHU, (short) 10, diff_, data_);
    ...
    public void calculateFleeingRate4Test() {
        ...
        userMoves_.add(new LevelMoves((short)3,moves_));
        userMoves_.add(new LevelMoves((short)4,moves_));
        Fight fight_ = calculateCatchingRate(userMoves_, MELOFEE, (short) 10, diff_, data_);
        assertEq(new Rate("0"),FightRound.calculateFleeingRate(fight_, diff_, data_));
    }
    ...
    public void calculateFleeingRate5Test() {
        ...
        userMoves_.add(new LevelMoves((short)3,moves_));
        userMoves_.add(new LevelMoves((short)4,moves_));
        Fight fight_ = calculateCatchingRate(userMoves_, TARINOR, (short) 10, diff_, data_);
        assertEq(new Rate("0"),FightRound.calculateFleeingRate(fight_, diff_, data_));
    }
    ...
    public void nextFighters1Test(){
        ...
        foesMoves_.add(new LevelMoves((short)15,foeMoves_));
        Fight fight_ = nextFighters(partnersMoves_, foesMoves_, player_, diff_, data_, 2);
        ...
        FightRound.initRound(fight_);
        NextUsers p_;
        p_ = FightRound.nextFighters(fight_, new EqList<TeamPosition>(), data_);
    ...
    public void nextFighters2Test(){
        ...
        FightRound.initRound(fight_);
        NextUsers p_;
        p_ = FightRound.nextFighters(fight_, new EqList<TeamPosition>(userPk_), data_);
        assertEq(1, p_.getNextFighters().size());
    ...
    public void nextFighters1SimulationTest(){
        ...
        fighter_.setFirstChosenMoveTarget(BULLES_D_O, POKEMON_PLAYER_TARGET_ONE);
        FightRound.initRound(fight_);
        FightRound.nextFighters(fight_, new EqList<TeamPosition>(), data_);
        assertTrue(!fight_.getAcceptableChoices());
    }
...
//        assertEq(FightState.ATTAQUES, fight_.getState());
    ...
    public void calculateNextFighters1Test() {
        ...
        FightRound.initRound(fight_);
        FightRound.calculateNextFighters(fight_, new EqList<TeamPosition>(), data_);
    ...
    public void roundUser4Test() {
        ...
        EqList<TeamPosition> cbts_=FightRound.selectTargetHavingToPlayAfterThrower(fight_,currentUser_,data_);
