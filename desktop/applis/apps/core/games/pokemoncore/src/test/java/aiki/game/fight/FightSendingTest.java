...
public class FightSendingTest extends InitializationDataBase {
    ...
    public void effectWhileSendingBegin1Test() {
        ...
        Fighter fighter_ = fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE);
        Item obj_ = fighter_.ficheObjet(data_);
        EffectWhileSendingWithStatistic effect_ = ((ItemForBattle)obj_).getEffectSending().first();
        FightSending.effectWhileSendingBegin(fight_,tp(KEY_PLAYER, POKEMON_FIGHTER_ONE), effect_, data_);
    ...
    public void effectWhileSendingBegin6Test() {
        ...
        FightAbilities.enableAbilityByWeather(fight_,tp(KEY_FOE, POKEMON_FIGHTER_ONE), data_);
        fighter_ = fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE);
    ...
    public void effectSendingObjectBegin1Test() {
        ...
        FightInitialization.initFight(fight_, player_, diff_, trainer_, data_);
        FightInitialization.initFight(fight_, data_);
        FightSending.effectSendingObjectBegin(fight_,tp(KEY_PLAYER, POKEMON_FIGHTER_ONE), data_);
        assertEq(new Rate("3/2"),fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE).getWeight());
    }
    ...
    public void effectPlate1Test() {
        ...
        FightInitialization.initFight(fight_, data_);
        Fighter fighter_ = fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE);
        FightSending.effectPlate(fight_,tp(KEY_PLAYER, POKEMON_FIGHTER_ONE), data_);
    ...
    public void sendBegin2Test() {
        ...
        FightInitialization.initFight(fight_, player_, diff_, trainer_, data_);
        FightInitialization.initFight(fight_, data_);
        FightSending.sendBegin(fight_,tp(KEY_FOE, POKEMON_FIGHTER_ONE), data_);
    ...
    public void sendBegin3Test() {
        ...
        FightInitialization.initFight(fight_, player_, diff_, trainer_, data_);
        FightInitialization.initFight(fight_, data_);
        fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE).affecterStatut(GEL);
        FightSending.sendBegin(fight_,tp(KEY_FOE, POKEMON_FIGHTER_ONE), data_);
        assertTrue(fight_.getEnabledMoves().getVal(ZENITH).isEnabled());
        assertEq(0, fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE).getStatusNbRound(GEL));
        assertEq(new Rate("3/2"), fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE).getWeight());
    }
    ...
    public void sendBegin4Test() {
        ...
        fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE).affecterStatut(GEL);
        FightSending.sendBegin(fight_,tp(KEY_PLAYER, POKEMON_FIGHTER_ONE), data_);
        StringList list_ = fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ONE).getTypes();
    ...
    public void endRelations1Test() {
        ...
        fighter_.affecterPseudoStatut(tp(KEY_FOE, POKEMON_FIGHTER_ONE), VAMPIGRAINE);
        fighter_.getPrivateMoves().getVal(new MoveTeamPosition(POSSESSIF, tp(KEY_FOE, POKEMON_FIGHTER_ZERO))).add(JACKPOT);
        fighter_.getPrivateMoves().getVal(new MoveTeamPosition(POSSESSIF, tp(KEY_FOE, POKEMON_FIGHTER_ONE))).add(JACKPOT);
        AffectedMove aff_ = fighter_.getTrackingMoves().getVal(new MoveTeamPosition(ENCORE, tp(KEY_FOE, POKEMON_FIGHTER_ZERO)));
        aff_.getActivity().enable();
        aff_.setMove(JACKPOT);
        aff_ = fighter_.getTrackingMoves().getVal(new MoveTeamPosition(ENCORE, tp(KEY_FOE, POKEMON_FIGHTER_ONE)));
        aff_.getActivity().enable();
        aff_.setMove(JACKPOT);
        fighter_.getTrappingMoves().getVal(new MoveTeamPosition(SIPHON, tp(KEY_FOE, POKEMON_FIGHTER_ZERO))).enable();
        fighter_.getTrappingMoves().getVal(new MoveTeamPosition(SIPHON, tp(KEY_FOE, POKEMON_FIGHTER_ONE))).enable();
        fighter_.getIncrUserAccuracy().put(new MoveTeamPosition(LIRE_ESPRIT, tp(KEY_FOE, POKEMON_FIGHTER_ZERO)), BoolVal.TRUE);
        fighter_.getIncrUserAccuracy().put(new MoveTeamPosition(LIRE_ESPRIT, tp(KEY_FOE, POKEMON_FIGHTER_ONE)), BoolVal.TRUE);
        FightSending.endRelations(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), data_);
        assertEq(0, fighter_.getStatusRelatNbRound(new MoveTeamPosition(VAMPIGRAINE, tp(KEY_FOE, POKEMON_FIGHTER_ZERO))));
        assertEq(1, fighter_.getStatusRelatNbRound(new MoveTeamPosition(VAMPIGRAINE, tp(KEY_FOE, POKEMON_FIGHTER_ONE))));
        assertEq(0, fighter_.getPrivateMoves().getVal(new MoveTeamPosition(POSSESSIF, tp(KEY_FOE, POKEMON_FIGHTER_ZERO))).size());
        assertEq(1, fighter_.getPrivateMoves().getVal(new MoveTeamPosition(POSSESSIF, tp(KEY_FOE, POKEMON_FIGHTER_ONE))).size());
        assertEq(JACKPOT, fighter_.getPrivateMoves().getVal(new MoveTeamPosition(POSSESSIF, tp(KEY_FOE, POKEMON_FIGHTER_ONE))).first());
        assertTrue(!fighter_.getTrackingMoves().getVal(new MoveTeamPosition(ENCORE, tp(KEY_FOE, POKEMON_FIGHTER_ZERO))).getActivity().isEnabled());
        assertTrue(fighter_.getTrackingMoves().getVal(new MoveTeamPosition(ENCORE, tp(KEY_FOE, POKEMON_FIGHTER_ONE))).getActivity().isEnabled());
        assertTrue(!fighter_.getTrappingMoves().getVal(new MoveTeamPosition(SIPHON, tp(KEY_FOE, POKEMON_FIGHTER_ZERO))).isEnabled());
        assertTrue(fighter_.getTrappingMoves().getVal(new MoveTeamPosition(SIPHON, tp(KEY_FOE, POKEMON_FIGHTER_ONE))).isEnabled());
        assertSame(BoolVal.FALSE,fighter_.getIncrUserAccuracy().getVal(new MoveTeamPosition(LIRE_ESPRIT, tp(KEY_FOE, POKEMON_FIGHTER_ZERO))));
        assertSame(BoolVal.TRUE,fighter_.getIncrUserAccuracy().getVal(new MoveTeamPosition(LIRE_ESPRIT, tp(KEY_FOE, POKEMON_FIGHTER_ONE))));
    }
    ...
    public void disableEffectsExceptHp1Test() {
        ...
        assertEq(0,f_.getStatusRelatNbRound(new MoveTeamPosition(VAMPIGRAINE, tp(KEY_FOE, POKEMON_FIGHTER_ZERO))));
    ...
    public void disableEffectsExceptHp6Test() {
        ...
        TeamPosition fighter_ = tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
        Fighter f_ = fight_.getFighter(fighter_);
        f_.transformer(fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ZERO),  5);
        FightSending.disableEffectsExceptHp(fight_, fighter_, data_);
        f_ = fight_.getFighter(fighter_);
    ...
    private static Fight addFighterAgainstFoeTeam(Difficulty _diff, DataBase _data) {
        ...
        PkTrainer allyPokemon_ = pkTrainer( 3, new StringList(JACKPOT, PAR_ICI, COPIE));
    ...
    public void effectTeamWhileSendingFoeFighter10Test() {
        ...
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        Fight fight_ = endRelations(diff_, data_);
        fight_.getTemp().setFullHealing(true);
        String move_ = PICOTS;
        fight_.getFoeTeam().ajouterEffetEquipeEntreeAdv(move_);
        TeamPosition fighter_ = tp(KEY_PLAYER, POKEMON_FIGHTER_TWO);
        Fighter f_ = fight_.getFighter(fighter_);
    ...
    public void effectWhileSendingAbility1SimulationTest() {
        ...
        fighter_.setAbility(ab_);
        fighter_.setCurrentAbility(ab_);
        fighter_.variationBoostStatistique(Statistic.ATTACK,5L);
        fighter_.variationBoostStatistique(Statistic.SPECIAL_ATTACK,5L);
        FightSending.effectWhileSendingAbility(fight_, thrower_, data_.getAbility(ab_).getEffectSending().first(), diff_, data_);
    ...
    public void effectWhileSending1Test() {
        ...
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        Fight fight_ = effectWhileSendingAbility(diff_, data_);
        TeamPosition thrower_ = tp(KEY_FOE, POKEMON_FIGHTER_TWO);
        Fighter fighter_ = fight_.getFighter(thrower_);
    ...
    public void sending1Test() {
        ...
        diff_.setDamageRatePlayer(DifficultyModelLaw.CONSTANT_MAX);
        Fight fight_ = effectWhileSendingAbility(diff_, data_);
        TeamPosition thrower_ = tp(KEY_PLAYER, POKEMON_FIGHTER_ONE);
        Fighter fighter_ = fight_.getFighter(thrower_);
        fighter_.backUpObject(NULL_REF);
    ...
    public void sendSubstitutes1Test() {
        ...
        Fight fight_ = sendSubstitutes0(data_, diff_, player_, new StringList(DETECTION));
    ...
    public void sendSubstitutes3Test() {
        ...
        player_.getTeam().add(lasPk_);
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = sendSubstitutes2(data_, diff_, player_, new StringList(DETECTION));
        FightKo.setKoMoveTeams(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), diff_, data_);
        fight_.setState(FightState.SWITCH_PROPOSE);
        FightArtificialIntelligence.choiceForSubstituing(fight_, data_);
    ...
    public void sendSubstitutes5Test() {
        ...
        player_.getTeam().add(lasPk_);
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = sendSubstitutes1(data_, diff_, player_, 3, new StringList(DETECTION));
    ...
    public void sendSubstitutes6Test() {
        ...
        player_.getTeam().add(lasPk_);
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = sendSubstitutes3(data_, diff_, player_, new StringList(DETECTION));
        fight_.getUserTeam().ajouterEffetEquipeEntreeAdv(PICOTS);
        fight_.getFighter(KEY_FOE, POKEMON_FIGHTER_ONE).setRemainedHp(Rate.one());
        FightKo.setKoMoveTeams(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), diff_, data_);
        fight_.setState(FightState.SWITCH_PROPOSE);
        FightArtificialIntelligence.choiceForSubstituing(fight_, data_);
        FightSending.sendSubstitutes(fight_, diff_, player_, data_);
    ...
    public void sendSubstitutes13Test() {
        ...
        player_.getTeam().add(lasPk_);
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = sendSubstitutes1(data_, diff_, player_, 17, new StringList(DETECTION));
        fight_.getFoeTeam().ajouterEffetEquipeEntreeAdv(PICOTS);
        fight_.getFighter(tp(KEY_PLAYER, POKEMON_FIGHTER_FOUR)).setRemainedHp(Rate.one());
        FightKo.setKoMoveTeams(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_THREE), diff_, data_);
        fight_.setState(FightState.SWITCH_PROPOSE);
        FightArtificialIntelligence.choiceForSubstituing(fight_, data_);
        fight_.getFirstPositPlayerFighters().put( 0, Fighter.BACK);
    ...
    public void sendSubstitutes16Test() {
        ...
        Fight fight_ = sendSubstitutes1(data_, diff_, player_, 17, new StringList(DETECTION));
        fight_.getFoeTeam().ajouterEffetEquipeEntreeAdv(PICOTS);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_TWO).setRemainedHp(Rate.one());
        FightKo.setKoMoveTeams(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), diff_, data_);
        FightKo.setKoMoveTeams(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ONE), diff_, data_);
    ...
    public void sendSubstitutes21Test() {
        ...
        player_.getTeam().add(lasPk_);
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = sendSubstitutes4(data_, diff_, player_, new StringList(DETECTION));
        FightKo.setKoMoveTeams(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), diff_, data_);
        FightKo.setKoMoveTeams(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ONE), diff_, data_);
        fight_.setState(FightState.SWITCH_PROPOSE);
        FightArtificialIntelligence.choiceForSubstituing(fight_, data_);
        ...
        assertEq(0, fighter_.getGroundPlaceSubst());
        //assertEq(Fighter.BACK, fighter_.getSubstistute());
        fighter_ = fight_.getFighter(tp(KEY_FOE, POKEMON_FIGHTER_FOUR));
        assertEq(1, fighter_.getGroundPlace());
        assertEq(1, fighter_.getGroundPlaceSubst());
        //assertEq(Fighter.BACK, fighter_.getSubstistute());
        fighter_ = fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_ZERO);
    ...
    public void sendSubstitutes22Test() {
        ...
        player_.getTeam().add(lasPk_);
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = sendSubstitutes5(data_, diff_, player_, new StringList(DETECTION));
        FightKo.setKoMoveTeams(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ZERO), diff_, data_);
        FightKo.setKoMoveTeams(fight_, tp(KEY_FOE, POKEMON_FIGHTER_ONE), diff_, data_);
        fight_.setState(FightState.SWITCH_PROPOSE);
        FightArtificialIntelligence.choiceForSubstituing(fight_, data_);
...
//        //assertEq(Fighter.BACK, fighter_.getSubstistute());
    ...
    public void sendSubstitutes25Test() {
        ...
        player_.getTeam().add(lasPk_);
        player_.recupererOeufPensions(new Egg(PTITARD));
        Fight fight_ = sendSubstitutes6(data_, diff_, player_, new StringList(DETECTION));
        fight_.getFoeTeam().ajouterEffetEquipeEntreeAdv(PICOTS);
        FightKo.setKoMoveTeams(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_ZERO), diff_, data_);
        FightKo.setKoMoveTeams(fight_, tp(KEY_PLAYER, POKEMON_FIGHTER_TWO), diff_, data_);
        fight_.getFighter(KEY_PLAYER, POKEMON_FIGHTER_THREE).getRemainingHp().affect(Rate.one());
        FightArtificialIntelligence.choiceForSubstituing(fight_, data_);
        fight_.getFirstPositPlayerFighters().put( 0, Fighter.BACK);
        fight_.getFirstPositPlayerFighters().put( 1,  0);
        FightSending.sendSubstitutes(fight_, diff_, player_, data_);
    ...
    private Fight sendSubstitutes6(DataBase _data, Difficulty _diff, Player _player, StringList _moves) {
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
        foeTeam_.add(pkTrainer(17, _moves));
        foeTeam_.add(pkTrainer(17, _moves));
        foeTeam_.add(pkTrainer(17, _moves));
        CustList<PkTrainer> allyTeam_ = new CustList<PkTrainer>();
        allyTeam_.add(pkTrainer(17, _moves));
        allyTeam_.add(pkTrainer(17, _moves));
        allyTeam_.add(pkTrainer(17, _moves));
        return sendSubstitutesDual(_player, _diff, _data, foeTeam_, allyTeam_);

    }

    private Fight sendSubstitutes5(DataBase _data, Difficulty _diff, Player _player, StringList _foeMoves) {
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
        foeTeam_.add(pkTrainer(3, _foeMoves));
        foeTeam_.add(pkTrainer(3, _foeMoves));
        foeTeam_.add(pkTrainer(3, _foeMoves));
        foeTeam_.add(pkTrainer(3, _foeMoves));
        return sendSubstitutesGym(_player, _diff, _data, foeTeam_, 3);

    }

    private Fight sendSubstitutes4(DataBase _data, Difficulty _diff, Player _player, StringList _moves) {
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
        foeTeam_.add(pkTrainer(3, _moves));
        foeTeam_.add(pkTrainer(3, _moves));
        foeTeam_.add(pkTrainer(3, _moves));
        foeTeam_.add(pkTrainer(3, _moves));
        foeTeam_.add(pkTrainer(3, _moves));
    ...
    private Fight sendSubstitutes3(DataBase _data, Difficulty _diff, Player _player, StringList _foeMoves) {
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
        foeTeam_.add(pkTrainer(3, _foeMoves));
        foeTeam_.add(pkTrainer(3, _foeMoves));
        foeTeam_.add(pkTrainer(3, _foeMoves));
        return sendSubstitutesGym(_player, _diff, _data, foeTeam_);

    }

    private Fight sendSubstitutes2(DataBase _data, Difficulty _diff, Player _player, StringList _foeMoves) {
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
        foeTeam_.add(pkTrainer(3, _foeMoves));
        foeTeam_.add(pkTrainer(3, _foeMoves));
        foeTeam_.add(pkTrainer(3, _foeMoves));
        return sendSubstitutesGym(_player, _diff, _data, foeTeam_, 2);

    }

    private Fight sendSubstitutes1(DataBase _data, Difficulty _diff, Player _player, int _l, StringList _moves) {
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
        foeTeam_.add(pkTrainer(_l, _moves));
        foeTeam_.add(pkTrainer(_l, _moves));
        foeTeam_.add(pkTrainer(_l, _moves));
        CustList<PkTrainer> allyTeam_ = new CustList<PkTrainer>();
        allyTeam_.add(pkTrainer(_l, _moves));
        allyTeam_.add(pkTrainer(_l, _moves));
        return sendSubstitutesDual(_player, _diff, _data, foeTeam_, allyTeam_);

    }

    private Fight sendSubstitutes0(DataBase _data, Difficulty _diff, Player _player, StringList _foeMoves) {
        CustList<PkTrainer> foeTeam_ = new CustList<PkTrainer>();
        foeTeam_.add(pkTrainer(3, _foeMoves));
        foeTeam_.add(pkTrainer(3, _foeMoves));
        return sendSubstitutesGym(_player, _diff, _data, foeTeam_);
    ...
    private static Fight sendSubstitutesGym(Player _user, Difficulty _diff, DataBase _data, CustList<PkTrainer> _foeTeam) {
        Fight fight_ = FightFacade.newFight();
    ...
    private static Fight sendSubstitutesGym(Player _user, Difficulty _diff, DataBase _data, CustList<PkTrainer> _foeTeam, int _mult) {
        Fight fight_ = FightFacade.newFight();
        GymLeader leader_ = new GymLeader();
        leader_.setTeam(_foeTeam);
    ...
    private static Fight sendSubstitutesDual(Player _user, Difficulty _diff, DataBase _data, CustList<PkTrainer> _foeTeam, CustList<PkTrainer> _allyTeam) {
        Fight fight_ = FightFacade.newFight();
        DualFight dual_ = new DualFight();
        Ally ally_ = new Ally();
