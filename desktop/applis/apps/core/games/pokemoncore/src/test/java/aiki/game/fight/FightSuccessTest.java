...
public class FightSuccessTest extends InitializationDataBase {
    ...
    public void forbiddenStatus1Test() {
        ...
        assertEq(0, FightSuccess.forbiddenStatus(fight_,data).size());
    }
    ...
    public void tirage1Test() {
        assertTrue(FightSuccess.tirage(data,Rate.one()));
        assertTrue(!FightSuccess.tirage(data,Rate.zero()));
        assertTrue(FightSuccess.tirage(data,new Rate("2")));
        assertTrue(FightSuccess.random(data,new MonteCarloString()).isEmpty());
    }

    private Fight isProtectedAgainstMoveType() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void isProtectedAgainstMoveType1Test() {
        ...
        assertTrue(!FightSuccess.isProtectedAgainstMoveType(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, SOL, data));
    }
    ...
    public void isProtectedAgainstMoveType2Test() {
        ...
        FightRound.initRound(fight_);
        assertTrue(FightSuccess.isProtectedAgainstMoveType(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, SOL, data));
        assertTrue(!FightSuccess.isProtectedAgainstMoveType(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, VOL, data));
    }
    ...
    public void isProtectedAgainstMoveType4Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMoveTarget(JACKPOT, POKEMON_PLAYER_TARGET_ZERO);
        FightRound.initRound(fight_);
        assertTrue(!FightSuccess.isProtectedAgainstMoveType(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, PSY, data));
    }
    ...
    public void isProtectedAgainstMoveType5Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setCurrentAbility(ATTENTION);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).activerAttaqueImmu(VOL_MAGNETIK, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).activerAttaqueImmu(TROU, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).activerAttaqueAntiImmu(ANTI_AIR);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).backUpObject(NULL_REF);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(SEISME);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMoveTarget(JACKPOT, POKEMON_PLAYER_TARGET_ZERO);
    ...
    public void isProtectedAgainstMoveType6Test() {
        ...
        FightRound.initRound(fight_);
        assertTrue(!FightSuccess.isProtectedAgainstMoveType(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ELECTRIQUE, data));
    }
    ...
    public void isProtectedAgainstMoveType13Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMoveTarget(JACKPOT, POKEMON_PLAYER_TARGET_ZERO);
        FightRound.initRound(fight_);
        assertTrue(FightSuccess.isProtectedAgainstMoveType(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, ELECTRIQUE, data));
    }
    ...
    public void isProtectedAgainstMoveType23Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMoveTarget(JACKPOT, POKEMON_PLAYER_TARGET_ZERO);
        FightRound.initRound(fight_);
        assertTrue(!FightSuccess.isProtectedAgainstMoveType(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, SOL, data));
    }
    ...
    private Fight rateEffAgainstTarget() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void rateEffAgainstTarget1Test() {
        ...
        assertEq(new Rate("2"), FightSuccess.rateEffAgainstTarget(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, EAU, data));
    }
    ...
    public void rateEffAgainstTarget2Test() {
        Fight fight_ = rateEffAgainstTarget();
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).affecterTypes(TENEBRE);
        assertEq(new Rate("0"), FightSuccess.rateEffAgainstTarget(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, PSY, data));
    }
    ...
    public void rateEffAgainstTarget3Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).affecterTypes(TENEBRE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).activerAttaqueAntiImmu(OEIL_MIRACLE);
        assertEq(new Rate("1"), FightSuccess.rateEffAgainstTarget(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, PSY, data));
    }
    ...
    public void rateEffAgainstTarget4Test() {
        ...
        fight_.enableGlobalMove(ORAGE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).affecterTypes(ELECTRIQUE);
        assertEq(new Rate("0"), FightSuccess.rateEffAgainstTarget(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, SOL, data));
    }
    ...
    public void rateEffAgainstTarget5Test() {
        ...
        fight_.enableGlobalMove(ORAGE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).affecterTypes(SOL);
        assertEq(new Rate("2"), FightSuccess.rateEffAgainstTarget(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ELECTRIQUE, data));
    }
    ...
    public void rateEffAgainstTarget6Test() {
        ...
        assertEq(new Rate("1"), FightSuccess.rateEffAgainstTarget(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, NORMAL, data));
    }
    ...
    public void rateEffAgainstTarget8Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).affecterTypes(VOL);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).activerAttaqueAntiImmu(ANTI_AIR);
        assertEq(new Rate("1"), FightSuccess.rateEffAgainstTarget(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, SOL, data));
    }
    ...
    private Fight isProtectedAgainstMove() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void isProtectedAgainstMove1Test() {
        ...
        assertTrue(!FightSuccess.isProtectedAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, SOIN, data));
        assertTrue(!FightSuccess.isProtectedAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, INTERVERSION, data));
        assertTrue(!FightSuccess.isProtectedAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, GLAS_DE_SOIN, data));
    }

    @Test
    public void isProtectedAgainstMove2Test() {
        Fight fight_ = isProtectedAgainstMove();
        assertTrue(!FightSuccess.isProtectedAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, SEISME, data));
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setCurrentAbility(LEVITATION);
        assertTrue(FightSuccess.isProtectedAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, SEISME, data));
        fight_.enableGlobalMove(GRAVITE);
        assertTrue(!FightSuccess.isProtectedAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, SEISME, data));
    ...
    public void isProtectedAgainstMove3Test() {
        ...
        assertTrue(FightSuccess.isProtectedAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, SEISME, data));
        assertTrue(!FightSuccess.isProtectedAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, LIRE_ESPRIT, data));
    }
    ...
    public void isProtectedAgainstMove8Test() {
        ...
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ONE).setCurrentAbility(GARDE_MYSTIK);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ONE).affecterTypes(NORMAL);
        assertTrue(!FightSuccess.isProtectedAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, IMPLORE, data));
    }
    ...
    public void isProtectedAgainstMove17Test() {
        ...
        assertTrue(!FightSuccess.isProtectedAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, EMBARGO, data));
    }
    ...
    public void isProtectedAgainstMove19Test() {
        ...
        assertTrue(FightSuccess.isProtectedAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, POUDRE_TOXIK, data));
    }
    ...
    private Fight sufferingDamageTypes() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void sufferingDamageTypes1Test() {
        ...
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(BROUHAHA, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(DETECTION, COPIE, data);
        ...
        StringMap<Rate> map_;
        map_ = FightSuccess.sufferingDamageTypes(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ROUE_DE_FEU, data);
    ...
    public void sufferingDamageTypes2Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        StringMap<Rate> map_;
        map_ = FightSuccess.sufferingDamageTypes(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, PISTOLET_A_O, data);
        assertEq(0, map_.size());
    }
    ...
    public void droppedStatis1Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).enableCounteringMoves(PICO_DEFENSE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(!FightSuccess.droppedStatis(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ELECTRISATION, true, data));
    }
    ...
    public void droppedStatis3Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).enableCounteringMoves(BOUCLIER_ROYAL);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(FightSuccess.droppedStatis(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, PISTOLET_A_O, true, data));
    }
    ...
    public void droppedStatis4Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).enableCounteringMoves(BOUCLIER_ROYAL);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(!FightSuccess.droppedStatis(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, PISTOLET_A_O, false, data));
    }
    ...
    public void droppedStatis5Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).enableCounteringMoves(BOUCLIER_ROYAL);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(FightSuccess.droppedStatis(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, COMBO_GRIFFE, true, data));
        assertTrue(FightSuccess.droppedStatis(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, COMBO_GRIFFE, false, data));
    }
    ...
    private Fight sufferingDirectMoves() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void sufferingDirectMoves1Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).enableCounteringMoves(BOUCLIER_ROYAL);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(!FightSuccess.sufferingDirectMoves(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ELECTRISATION, true, data));
    }
    ...
    public void sufferingDirectMoves3Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).enableCounteringMoves(PICO_DEFENSE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(FightSuccess.sufferingDirectMoves(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, PISTOLET_A_O, true, data));
    }
    ...
    public void sufferingDirectMoves4Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).enableCounteringMoves(PICO_DEFENSE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(!FightSuccess.sufferingDirectMoves(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, PISTOLET_A_O, false, data));
    }
    ...
    public void sufferingDirectMoves5Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).enableCounteringMoves(PICO_DEFENSE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(FightSuccess.sufferingDirectMoves(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, COMBO_GRIFFE, true, data));
        assertTrue(FightSuccess.sufferingDirectMoves(fight_, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, COMBO_GRIFFE, false, data));
    }
    ...
    private Fight protectedTargetAgainstMove() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void protectedTargetAgainstMove1Test() {
        ...
        FightRound.initRound(fight_);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, BROUHAHA, data));
    }

    @Test
    public void protectedTargetAgainstMove2Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(VAS_Y, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(DETECTION, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMoveTarget(VAS_Y, POKEMON_FOE_TARGET_ZERO);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(DETECTION);
        FightRound.initRound(fight_);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(!FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, VAS_Y, data));
    }
    ...
    public void protectedTargetAgainstMove3Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(BROUHAHA, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(PREVENTION, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(BROUHAHA);
    ...
    public void protectedTargetAgainstMove4Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(BROUHAHA, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(GARDE_LARGE, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(BROUHAHA);
    ...
    public void protectedTargetAgainstMove5Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(REFLET_MAGIK, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(PREVENTION, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(REFLET_MAGIK);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(PREVENTION);
        FightRound.initRound(fight_);
        assertTrue(!FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, REFLET_MAGIK, data));
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, REFLET_MAGIK, data));
    }
    ...
    public void protectedTargetAgainstMove6Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(ZONE_ETRANGE, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(PREVENTION, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(ZONE_ETRANGE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(PREVENTION);
        FightRound.initRound(fight_);
        assertTrue(!FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, ZONE_ETRANGE, data));
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(!FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, ZONE_ETRANGE, data));
    }
    ...
    public void protectedTargetAgainstMove7Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(IMPLORE, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(PREVENTION, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(IMPLORE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(PREVENTION);
        FightRound.initRound(fight_);
        assertTrue(!FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, IMPLORE, data));
    ...
    public void protectedTargetAgainstMove8Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(FONCE, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(PREVENTION, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMoveTarget(FONCE, POKEMON_FOE_TARGET_ZERO);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(PREVENTION);
        FightRound.initRound(fight_);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, FONCE, data));
    }
    ...
    public void protectedTargetAgainstMove10Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(ROUE_DE_FEU, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(NUEE_DE_POUDRE, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMoveTarget(ROUE_DE_FEU, POKEMON_FOE_TARGET_ZERO);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(NUEE_DE_POUDRE);
        FightRound.initRound(fight_);
        assertTrue(!FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, ROUE_DE_FEU, data));
    }

    @Test
    public void protectedTargetAgainstMove11Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(COMBO_GRIFFE, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(BOUCLIER_ROYAL, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMoveTarget(COMBO_GRIFFE, POKEMON_FOE_TARGET_ZERO);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(BOUCLIER_ROYAL);
        FightRound.initRound(fight_);
        assertTrue(!FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, COMBO_GRIFFE, data));
    }
    ...
    public void protectedTargetAgainstMove12Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(COMBO_GRIFFE, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(PICO_DEFENSE, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMoveTarget(COMBO_GRIFFE, POKEMON_FOE_TARGET_ZERO);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(PICO_DEFENSE);
        FightRound.initRound(fight_);
        assertTrue(!FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, COMBO_GRIFFE, data));
    ...
    public void protectedTargetAgainstMove17Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(COMBO_GRIFFE, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(TATAMIGAESHI, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMoveTarget(COMBO_GRIFFE, POKEMON_FOE_TARGET_ZERO);
    ...
    public void protectedTargetAgainstMove18Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(ELECTRISATION, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(TATAMIGAESHI, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMoveTarget(ELECTRISATION, POKEMON_FOE_TARGET_ZERO);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(TATAMIGAESHI);
        FightRound.initRound(fight_);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(!FightSuccess.protectedTargetAgainstMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO,POKEMON_FOE_FIGHTER_ZERO, ELECTRISATION, data));
    }
    ...
    public void protectedTargetAgainstMove19Test() {
        Fight fight_ = protectedTargetAgainstMove();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(COMBO_GRIFFE, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(VIGILANCE, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMoveTarget(COMBO_GRIFFE, POKEMON_FOE_TARGET_ZERO);
    ...
    private Fight successfulEffectWhileIfTargetIsNotThrower() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void successfulEffectWhileIfTargetIsNotThrower1Test() {
        ...
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, GLAS_DE_SOIN, 0, true, data));
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, INTERVERSION, 0, true, data));
    }

    @Test
    public void successfulEffectWhileIfTargetIsNotThrower2Test() {
        Fight fight_ = successfulEffectWhileIfTargetIsNotThrower();
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, IMPLORE, 0, true, data));
        fight_.getSuccessfulEffects().put(new NbEffectFighterCoords(0,POKEMON_FOE_FIGHTER_ZERO), false);
        assertTrue(!FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, IMPLORE, 1, true, data));
    }
    ...
    public void successfulEffectWhileIfTargetIsNotThrower5Test() {
        Fight fight_ = successfulEffectWhileIfTargetIsNotThrower();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(SEISME, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(TUNNEL, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(SEISME);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMoveTarget(TUNNEL, POKEMON_PLAYER_TARGET_ZERO);
        FightRound.initRound(fight_);
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, SEISME, 0, true, data));
    ...
    public void successfulEffectWhileIfTargetIsNotThrower6Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMoveTarget(TUNNEL, POKEMON_PLAYER_TARGET_ZERO);
        FightRound.initRound(fight_);
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, BROUHAHA, 0, true, data));
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setDisappeared(true);
        assertTrue(!FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, BROUHAHA, 0, true, data));
    }
    ...
    public void successfulEffectWhileIfTargetIsNotThrower10Test() {
        ...
        FightRound.initRound(fight_);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, VAS_Y, 0, true, data));
    }
    ...
    public void successfulEffectWhileIfTargetIsNotThrower13Test() {
        Fight fight_ = successfulEffectWhileIfTargetIsNotThrower();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(IMPLORE, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(SEISME, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(IMPLORE);
        ...
        fight_.getSuccessfulEffects().put(new NbEffectFighterCoords(0,POKEMON_FOE_FIGHTER_ZERO), true);
        assertTrue(!FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, IMPLORE, 1, true, data));
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, IMPLORE, 1, true, data));
    }
    ...
    public void successfulEffectWhileIfTargetIsNotThrower14Test() {
        ...
        FightRound.initRound(fight_);
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, IMPLORE, 0, true, data));
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).successUsingMove();
    ...
    public void successfulEffectWhileIfTargetIsNotThrower15Test() {
        Fight fight_ = successfulEffectWhileIfTargetIsNotThrower();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(TONNERRE, COPIE, data);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).apprendreAttaqueEcrasant(PLANNEUR, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(TONNERRE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMoveTarget(PLANNEUR, POKEMON_PLAYER_TARGET_ZERO);
        FightRound.initRound(fight_);
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, TONNERRE, 0, true, data));
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setDisappeared(true);
        assertTrue(!FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, TONNERRE, 0, true, data));
    }
    ...
    public void successfulEffectWhileIfTargetIsNotThrower18Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(PREVENTION);
        FightRound.initRound(fight_);
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, REFLET_MAGIK, 0, true, data));
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(!FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, REFLET_MAGIK, 0, true, data));
    }
    ...
    public void successfulEffectWhileIfTargetIsNotThrower20Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(PREVENTION);
        FightRound.initRound(fight_);
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ZONE_ETRANGE, 0, true, data));
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ZONE_ETRANGE, 0, true, data));
    }
    ...
    public void successfulEffectWhileIfTargetIsNotThrower21Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMove(PREVENTION);
        FightRound.initRound(fight_);
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, IMPLORE, 0, false, data));
        fight_.getSuccessfulEffects().put(new NbEffectFighterCoords(0,POKEMON_FOE_FIGHTER_ZERO), false);
        assertTrue(FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, IMPLORE, 1, false, data));
    }
    ...
    public void successfulEffectWhileIfTargetIsNotThrower23Test() {
        ...
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setCurrentAbility(ANNULE_GARDE);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).apprendreAttaqueEcrasant(SEISME, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ONE).apprendreAttaqueEcrasant(GARDE_LARGE, COPIE, data);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(SEISME);
        ...
        assertTrue(!FightSuccess.successfulEffectWhileIfTargetIsNotThrower(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, SEISME, 0, true, data));
    }

    private Fight rateEffAgainstTargetMove() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void rateEffAgainstTargetMove1Test() {
        ...
        FightRound.initRound(fight_);
        assertEq(new Rate("4"),FightSuccess.rateEffAgainstTargetMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, data));
    }
    ...
    public void rateEffAgainstTargetMove2Test() {
        ...
        FightRound.initRound(fight_);
        assertEq(new Rate("0"),FightSuccess.rateEffAgainstTargetMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, data));
    }
    ...
    private Fight successChangedStatisticProtect() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void successChangedStatisticProtect1Test() {
        ...
        assertTrue(FightSuccess.successChangedStatisticProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, Statistic.ATTACK, (byte) -1, false, new StringList(), data));
    }
    ...
    public void successChangedStatisticProtect3Test() {
        Fight fight_ = successChangedStatisticProtect();
        fight_.getFoeTeam().activerEffetEquipe(BRUME);
        assertTrue(FightSuccess.successChangedStatisticProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, Statistic.ATTACK, (byte) -1, false, new StringList(BRUME), data));
    }
    ...
    public void successChangedStatisticProtect6Test() {
        Fight fight_ = successChangedStatisticProtect();
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setCurrentAbility(HYPER_CUTTER);
        assertTrue(FightSuccess.successChangedStatisticProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, Statistic.ATTACK, (byte) -1, true, new StringList(), data));
    }
    ...
    public void successChangedStatisticProtect16Test() {
        Fight fight_ = successChangedStatisticProtect();
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).variationBoostStatistique(Statistic.ATTACK, (byte) data.getMinBoost());
        assertTrue(FightSuccess.successChangedStatisticProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, Statistic.ATTACK, (byte) 1, false, new StringList(), data));
        assertTrue(!FightSuccess.successChangedStatisticProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, Statistic.ATTACK, (byte) -1, false, new StringList(), data));
    }
    ...
    public void successChangedStatisticProtect20Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setTypes(new StringList(PLANTE));
        assertTrue(FightSuccess.successChangedStatisticProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, Statistic.SPEED, (byte) -1, false, new StringList(), data));
    }
    ...
    private Fight successChangedStatistic() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void successChangedStatistic1Test() {
        ...
        assertTrue(FightSuccess.successChangedStatistic(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, Statistic.ATTACK, (byte) -1, data));
    }
    ...
    public void successChangedStatistic4Test() {
        ...
        assertTrue(!FightSuccess.successChangedStatistic(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, Statistic.ATTACK, (byte) -1, data));
    }
    ...
    private Fight successfulChangedBoostedStatistics() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void successfulChangedBoostedStatistics1Test() {
        ...
        MoveData move_ = data.getMove(COUD_BOUE);
        EffectStatistic eff_ = (EffectStatistic) move_.getEffet(1+move_.indexOfPrimaryEffect());
        EnumList<Statistic> stats_ = FightSuccess.successfulChangedBoostedStatistics(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data);
    ...
    public void successfulChangedBoostedStatistics3Test() {
        Fight fight_ = successfulChangedBoostedStatistics();
        MoveData move_ = data.getMove(ACUPRESSION);
    ...
    private Fight successfulChangedStatistics() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void successfulChangedStatistics1Test() {
        ...
        MoveData move_ = data.getMove(COUD_BOUE);
        EffectStatistic eff_ = (EffectStatistic) move_.getEffet(1+move_.indexOfPrimaryEffect());
        EnumList<Statistic> stats_ = FightSuccess.successfulChangedStatistics(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data);
        assertEq(1, stats_.size());
        assertTrue(stats_.containsObj(Statistic.ACCURACY));
    }
    ...
    public void successfulChangedStatistics4Test() {
        Fight fight_ = successfulChangedStatistics();
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).creerClone(new Rate("1/2"));
        MoveData move_ = data.getMove(MUR_DE_FER);
        EffectStatistic eff_ = (EffectStatistic) move_.getEffet(move_.indexOfPrimaryEffect());
        EnumList<Statistic> stats_ = FightSuccess.successfulChangedStatistics(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data);
        assertEq(1, stats_.size());
        assertTrue(stats_.containsObj(Statistic.DEFENSE));
    ...
    public void successfulChangedStatistics5Test() {
        ...
        MoveData move_ = data.getMove(DEGOMMAGE);
    ...
    public void successfulChangedStatistics6Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).variationBoostStatistique(Statistic.SPECIAL_DEFENSE, (byte) -1);
        fight_.getUserTeam().activerEffetEquipe(BRUME);
        MoveData move_ = data.getMove(BOOST);
        EffectStatistic eff_ = (EffectStatistic) move_.getEffet(move_.indexOfPrimaryEffect());
        EnumList<Statistic> stats_ = FightSuccess.successfulChangedStatistics(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data);
        assertEq(3, stats_.size());
        assertTrue(stats_.containsObj(Statistic.ATTACK));
    ...
    public void successfulChangedStatistics7Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).variationBoostStatistique(Statistic.DEFENSE, (byte) -1);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).variationBoostStatistique(Statistic.SPECIAL_DEFENSE, (byte) -1);
        MoveData move_ = data.getMove(BUEE_NOIRE);
        EffectStatistic eff_ = (EffectStatistic) move_.getEffects().last();
        EnumList<Statistic> stats_ = FightSuccess.successfulChangedStatistics(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data);
        assertEq(7, stats_.size());
        assertTrue(stats_.containsObj(Statistic.ATTACK));
    ...
    public void successfulChangedStatistics8Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).variationBoostStatistique(Statistic.DEFENSE, (byte) -1);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).variationBoostStatistique(Statistic.SPECIAL_DEFENSE, (byte) -1);
        MoveData move_ = data.getMove(PERMUCOEUR);
        EffectStatistic eff_ = (EffectStatistic) move_.getEffects().last();
        EnumList<Statistic> stats_ = FightSuccess.successfulChangedStatistics(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data);
    ...
    public void successfulChangedStatistics12Test() {
        Fight fight_ = successfulChangedStatistics();
        MoveData move_ = data.getMove(TROU_BIS);
    ...
    private Fight successfulAffectedStatusProtect() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void successfulAffectedStatusProtect1Test() {
        ...
        assertTrue(!FightSuccess.successfulAffectedStatusProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, SOMMEIL, false, new StringList(), data));
    }
    ...
    public void successfulAffectedStatusProtect4Test() {
        Fight fight_ = successfulAffectedStatusProtect();
        fight_.getFoeTeam().activerEffetEquipe(RUNE_PROTECT);
        assertTrue(FightSuccess.successfulAffectedStatusProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, SOMMEIL, false, new StringList(RUNE_PROTECT), data));
    }
    ...
    public void successfulAffectedStatusProtect5Test() {
        Fight fight_ = successfulAffectedStatusProtect();
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setCurrentAbility(NULL_REF);
        assertTrue(FightSuccess.successfulAffectedStatusProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, BRULURE, false, new StringList(RUNE_PROTECT), data));
    }
    ...
    public void successfulAffectedStatusProtect7Test() {
        Fight fight_ = successfulAffectedStatusProtect();
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setCurrentAbility(GARDE_MAGIK);
        assertTrue(FightSuccess.successfulAffectedStatusProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, BRULURE, true, new StringList(RUNE_PROTECT), data));
    }
    ...
    public void successfulAffectedStatusProtect13Test() {
        ...
        assertTrue(!FightSuccess.successfulAffectedStatusProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, AMOUR, false, new StringList(RUNE_PROTECT), data));
    }
    ...
    public void successfulAffectedStatusProtect17Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ONE).setCurrentAbility(FLORA_VOILE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setTypes(new StringList(PLANTE));
        assertTrue(FightSuccess.successfulAffectedStatusProtect(fight_,POKEMON_FOE_FIGHTER_ZERO, BRULURE, false, new StringList(), data));
    }
    ...
    private Fight successfulAffectedStatus() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void successfulAffectedStatus1Test() {
        ...
        fight_.disableGlobalMove(ZENITH);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).backUpObject(HERBE_MENTAL);
        assertTrue(!FightSuccess.successfulAffectedStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, AMOUR, data));
    }
    ...
    public void successfulAffectedStatus2Test() {
        ...
        assertTrue(FightSuccess.successfulAffectedStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, AMOUR, data));
    }
    ...
    public void successfulAffectedStatus3Test() {
        ...
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setCurrentAbility(NULL_REF);
        fight_.getFoeTeam().activerEffetEquipe(RUNE_PROTECT);
        assertTrue(!FightSuccess.successfulAffectedStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, SOMMEIL, data));
    }
    ...
    public void successfulAffectedStatus5Test() {
        ...
        assertTrue(!FightSuccess.successfulAffectedStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, SOMMEIL, data));
    }
    ...
    public void successfulAffectedStatus6Test() {
        ...
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setCurrentAbility(INFILTRATION);
        fight_.getUserTeam().activerEffetEquipe(RUNE_PROTECT);
        assertTrue(FightSuccess.successfulAffectedStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, AMOUR_TRES_MOU, data));
    }

    private Fight successfulEffectStatus() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void successfulEffectStatus1Test() {
        ...
        MoveData move_ = data.getMove(ECHANGE_PSY);
        EffectStatus eff_ = (EffectStatus) move_.getEffects().last();
        assertTrue(!FightSuccess.successfulEffectStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data));
    }
    ...
    public void successfulEffectStatus4Test() {
        Fight fight_ = successfulEffectStatus();
        MoveData move_ = data.getMove(REPOS);
        EffectStatus eff_ = (EffectStatus) move_.getEffects().first();
        assertTrue(FightSuccess.successfulEffectStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, eff_, data));
    }

    @Test
    public void successfulEffectStatus5Test() {
        Fight fight_ = successfulEffectStatus();
        MoveData move_ = data.getMove(DANSE_LUNE);
        EffectStatus eff_ = (EffectStatus) move_.getEffects().first();
        assertTrue(FightSuccess.successfulEffectStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, eff_, data));
    }
    ...
    public void successfulEffectStatus6Test() {
        Fight fight_ = successfulEffectStatus();
        MoveData move_ = data.getMove(BERCEUSE);
        EffectStatus eff_ = (EffectStatus) move_.getEffects().first();
        assertTrue(FightSuccess.successfulEffectStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data));
    }
    ...
    public void successfulEffectStatus9Test() {
        Fight fight_ = successfulEffectStatus();
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).creerClone(new Rate("1/2"));
        MoveData move_ = data.getMove(PSYKOUD_BOUL);
        EffectStatus eff_ = (EffectStatus) move_.getEffects().last();
        assertTrue(!FightSuccess.successfulEffectStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data));
    }
    ...
    public void successfulEffectStatus10Test() {
        Fight fight_ = successfulEffectStatus();
        MoveData move_ = data.getMove(DODO);
        EffectStatus eff_ = (EffectStatus) move_.getEffects().first();
        assertTrue(FightSuccess.successfulEffectStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data));
    }
    ...
    public void successfulEffectStatus11Test() {
        Fight fight_ = successfulEffectStatus();
        MoveData move_ = data.getMove(DODO_PETIT);
        EffectStatus eff_ = (EffectStatus) move_.getEffects().first();
        assertTrue(FightSuccess.successfulEffectStatus(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data));
    }

    private Fight successEffect() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void successEffect1Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMoveTarget(JACKPOT, POKEMON_PLAYER_TARGET_ZERO);
        FightRound.initRound(fight_);
        Effect eff_ = data.getMove(MUR_DE_FER).getEffects().first();
        assertTrue(FightSuccess.successEffect(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, eff_, data));
    }
    ...
    public void successEffect2Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setFirstChosenMoveTarget(JACKPOT, POKEMON_PLAYER_TARGET_ZERO);
        FightRound.initRound(fight_);
        Effect eff_ = data.getMove(BERCEUSE).getEffects().first();
        assertTrue(FightSuccess.successEffect(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data));
    }
    ...
    public void successEffect5Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).affecterStatut(SOMMEIL);
        FightRound.initRound(fight_);
        Effect eff_ = data.getMove(PHOTOCOPIE).getEffects().first();
        assertTrue(!FightSuccess.successEffect(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data));
    }
    ...
    public void successEffect6Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).affecterStatut(SOMMEIL);
        FightRound.initRound(fight_);
        Effect eff_ = data.getMove(METRONOME).getEffects().first();
        assertTrue(FightSuccess.successEffect(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, eff_, data));
    }

    private Fight successfulMove() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void successfulMove1Test() {
        ...
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, SEISME, 0, true, data);
    ...
    public void successfulMove2Test() {
        ...
        RandomBoolResults pair_;
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, PICOTS, 0, true, data);
        assertTrue(!pair_.isSuccessful());
        assertTrue(pair_.isEffectIfFail());
    }
    ...
    public void successfulMove4Test() {
        ...
        FightRound.initRound(fight_);
        RandomBoolResults pair_;
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, VAMPIPOING, 0, true, data);
        assertTrue(pair_.isSuccessful());
        assertTrue(!pair_.isEffectIfFail());
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).successUsingMove();
        fight_.getSuccessfulEffects().put(new NbEffectFighterCoords(0, POKEMON_FOE_FIGHTER_ZERO), true);
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, VAMPIPOING, 1, true, data);
        assertTrue(pair_.isSuccessful());
        assertTrue(!pair_.isEffectIfFail());
    }
    ...
    public void successfulMove7Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        RandomBoolResults pair_;
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, SOIN, 0, true, data);
        assertTrue(pair_.isSuccessful());
        assertTrue(!pair_.isEffectIfFail());
    }
    ...
    public void successfulMove8Test() {
        ...
        FightRound.initRound(fight_);
        RandomBoolResults pair_;
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, DEVOREVE, 0, true, data);
        assertTrue(!pair_.isSuccessful());
        assertTrue(!pair_.isEffectIfFail());
    }
    ...
    public void successfulMove12Test() {
        ...
        fight_.setSending(true);
        RandomBoolResults pair_;
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, PIEGE_DE_ROC, 0, true, data);
        assertTrue(pair_.isSuccessful());
        assertTrue(!pair_.isEffectIfFail());
    }
    ...
    public void successfulMove13Test() {
        ...
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).successUsingMove();
        fight_.getSuccessfulEffects().put(new NbEffectFighterCoords(0, POKEMON_FOE_FIGHTER_ZERO), false);
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, VAMPIPOING, 1, false, data);
        assertTrue(pair_.isSuccessful());
        assertTrue(!pair_.isEffectIfFail());
    }
    ...
    public void successfulMove14Test() {
        ...
        FightRound.initRound(fight_);
        RandomBoolResults pair_;
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, MUR_DE_FER, 0, false, data);
        assertTrue(!pair_.isSuccessful());
        assertTrue(!pair_.isEffectIfFail());
    }
    ...
    public void successfulMove15Test() {
        ...
        FightRound.initRound(fight_);
        RandomBoolResults pair_;
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, TOUR_RAPIDE, 0, true, data);
        assertTrue(pair_.isSuccessful());
        assertTrue(!pair_.isEffectIfFail());
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).successUsingMove();
        fight_.getSuccessfulEffects().put(new NbEffectFighterCoords(0, POKEMON_FOE_FIGHTER_ZERO), true);
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, TOUR_RAPIDE, 1, true, data);
        assertTrue(pair_.isSuccessful());
        assertTrue(!pair_.isEffectIfFail());
    }
    ...
    public void successfulMove17Test() {
        ...
        RandomBoolResults pair_;
        pair_ = FightSuccess.successfulMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ROUE_DE_FEU, 0, true, data);
        assertTrue(!pair_.isSuccessful());
        assertTrue(!pair_.isEffectIfFail());
    }
    ...
    private Fight canUseDirectlyMove() {
        Difficulty diff_ = new Difficulty();
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void canUseDirectlyMove1Test() {
        ...
        FightRound.initRound(fight_);
        assertTrue(FightSuccess.canUseDirectlyMove(fight_,POKEMON_PLAYER_FIGHTER_ZERO, data));
    }
    ...
    public void canSkipRecharge1Test() {
        ...
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setCurrentAbility(NULL_REF);
        assertTrue(!FightSuccess.canSkipRecharge(fight_,POKEMON_PLAYER_FIGHTER_ZERO, data));
    }
    ...
    public void accuracy1Test() {
        ...
        assertEq(new Rate("0"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ABIME, data));
    }

    @Test
    public void accuracy2Test() {
        Fight fight_ = accuracy();
        assertEq(new Rate("1"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, TONNERRE, data));
    }
    ...
    public void accuracy3Test() {
        Fight fight_ = accuracy();
        fight_.enableGlobalMove(GRAVITE);
        assertEq(new Rate("8/5"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, TONNERRE, data));
    }
    ...
    public void accuracy4Test() {
        Fight fight_ = accuracy();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setCurrentAbility(NULL_REF);
        assertEq(new Rate("9/10"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ROULADE, data));
    }
    ...
    public void accuracy6Test() {
        Fight fight_ = accuracy();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setCurrentAbility(ANNULE_GARDE);
        assertEq(new Rate("1"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ROULADE, data));
    }
    ...
    public void accuracy9Test() {
        Fight fight_ = accuracy();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).variationBoostStatistique(Statistic.ACCURACY, (byte) -1);
        assertEq(new Rate("2/3"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, TONNERRE, data));
    }
    ...
    public void accuracy10Test() {
        Fight fight_ = accuracy();
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).variationBoostStatistique(Statistic.ACCURACY, (byte) -1);
        assertEq(new Rate("1"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, COPIE_TYPE, data));
    }
    ...
    public void accuracy14Test() {
        ...
        assertEq(new Rate("1"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, RELAIS, data));
    }
    ...
    public void accuracy15Test() {
        ...
        assertEq(new Rate("11/40"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, BERCEUSE, data));
    }
    ...
    public void accuracy16Test() {
        Fight fight_ = accuracy();
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setCurrentAbility(NULL_REF);
        assertEq(new Rate("11/20"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, BERCEUSE, data));
    }
    ...
    public void accuracy17Test() {
        ...
        assertEq(new Rate("1"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, BERCEUSE, data));
    }
    ...
    public void accuracy18Test() {
        ...
        assertEq(new Rate("0"), FightSuccess.accuracy(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, BERCEUSE, data));
    }

    private Fight rateCriticalHit() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void rateCriticalHit1Test() {
        ...
        assertEq(new Rate("1/16"), FightSuccess.rateCriticalHit(fight_, fighter_, (byte) 0, data));
    }
    ...
    public void rateCriticalHit3Test() {
        ...
        assertEq(new Rate("1/8"), FightSuccess.rateCriticalHit(fight_, fighter_, (byte) 0, data));
    }

    private Fight multProbaByComboOfMoves() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
    ...
    public void probaEffectStatistic1Test() {
        ...
        assertEq(new Rate("1/2"), FightSuccess.probaEffectStatistic(fight_, fighter_, new Rate("1/2"), true, data));
    }
    ...
    public void probaEffectStatistic2Test() {
        ...
        Fighter f_ = fight_.getFighter(fighter_);
        f_.setCurrentAbility(NULL_REF);
        assertEq(new Rate("1/2"), FightSuccess.probaEffectStatistic(fight_, fighter_, new Rate("1/2"), false, data));
    }
    ...
    public void probaEffectStatistic4Test() {
        ...
        Fighter f_ = fight_.getFighter(fighter_);
        f_.setCurrentAbility(SERENITE);
        assertEq(new Rate("1"), FightSuccess.probaEffectStatistic(fight_, fighter_, new Rate("1/2"), false, data));
    }
    ...
    public void probaEffectStatistic6Test() {
        ...
        fight_.getUserTeam().addSuccessfulMoveRound(AIRE_D_EAU);
        fight_.getUserTeam().addSuccessfulMoveRound(AIRE_D_HERBE);
        assertEq(new Rate("2"), FightSuccess.probaEffectStatistic(fight_, fighter_, new Rate("1/2"), false, data));
    }
    ...
    public void probaEffectStatistic7Test() {
        ...
        MoveData move_ = data.getMove(MUR_DE_FER);
        EffectStatistic eff_ = (EffectStatistic) move_.getEffet(move_.indexOfPrimaryEffect());
        assertEq(new Rate("1"), FightSuccess.probaEffectStatistic(fight_, fighter_, eff_, false, data));
    }

    private Fight probaEffectStatus() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,data);
        Pokemon pokemon_ = new WildPk();
