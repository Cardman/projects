...
//        assertEq(1, fighter_.getStatus().getKeys( 1).size());
        assertEq(1, fighter_.getNbStatusByRounds( 1));
        assertEq(1, fighter_.getStatusNbRound(GEL));
//        assertTrue(fighter_.getStatus().getKeys( 1).containsObj(GEL));
//        assertEq(16, fighter_.getStatus().getKeys( 0).size());
        assertEq(16, fighter_.getNbStatusByRounds( 0));
...
//        assertEq(16, fighter_.getStatus().getKeys( 0).size());
    ...
    public void initCreatureNonUser1Test() {
        ...
        assertEq(3, fighter_.getLevel());
        assertEq(17, fighter_.getStatus().size());
//        assertEq(0, fighter_.getStatus().getKeys( 1).size());
//        assertEq(17, fighter_.getStatus().getKeys( 0).size());
        assertEq(0, fighter_.getNbStatusByRounds( 1));
    ...
    public void initUserMoves1Test() {
        ...
        pokemon_.setLevel( 3);
        PokemonPlayer pokemonUser_ = pkMoves(data_, new Difficulty(), pokemon_);
        pokemonUser_.getMoves().getVal(OEIL_MIRACLE).setCurrent( 0);
        pokemonUser_.setNickname(PIKA);
        pokemonUser_.setUsedBallCatching(SUPER_BALL);
        pokemonUser_.setHappiness( 40);
        pokemonUser_.setWonExpSinceLastLevel(new Rate(3,2));
...
//    }
    ...
    public void new_Fighter_PokemonTrainer_DataBase_byte_1Test() {
        ...
        pokemon_.setLevel( 3);
        pokemon_.setMoves(new StringList(JACKPOT));
        Fighter fighter_ = new Fighter(pokemon_, data_,  0);
        assertEq(0, fighter_.getGroundPlace());
        assertEq(0, fighter_.getGroundPlaceSubst());
    }
    ...
    public void ajouterRelationAutre1Test() {
        ...
        pokemon_.setLevel( 3);
        Fighter fighter_ = new Fighter(pokemon_, data_,  0);
        TeamPosition fighterCoords_ = new TeamPosition(Fight.CST_PLAYER, 0);
        fighter_.ajouterRelationAutre(fighterCoords_, data_);
        assertEq(12, fighter_.getStatusRelat().size());
//        assertEq(11, fighter_.getStatusRelat().getKeys( 0).size());
    ...
    public void initCreatureRelationsAutre1Test() {
        ...
        pokemon_.setLevel( 3);
        Fighter fighter_ = new Fighter(pokemon_, data_,  0);
        TeamPosition fighterCoordsOne_ = new TeamPosition(Fight.CST_PLAYER, 0);
        TeamPosition fighterCoordsTwo_ = new TeamPosition(Fight.CST_PLAYER, 1);
...
//        assertEq(22, fighter_.getStatusRelat().getKeys( 0).size());
        assertEq(0, fighter_.getStatusRelatValues().getMinimum(-1));
        assertEq(0, fighter_.getStatusRelatValues().getMaximum(-1));
    ...
    public void attaquesUtilisables2Test() {
        ...
        Fighter fighter_ = new Fighter(pokemonUser_, data_,  0);
        fighter_.apprendreAttaqueEcrasant(DETECTION, COPIE, data_);
        fighter_.getCopiedMoves().getVal(COPIE).setPp( 0);
        StringList list_ = fighter_.attaquesUtilisables();
        assertEq(3, list_.size());
    ...
    public void powerPointsMove2Test() {
        ...
        UsesOfMove uses_ = new UsesOfMove( 7, 8);
    ...
    public void usePowerPointsByMove1Test() {
        ...
        fighter_.usePowerPointsByMove(diff_, BROUHAHA,  1);
    ...
    public void usePowerPointsByMove2Test() {
        ...
        Difficulty diff_ = new Difficulty();
        diff_.setRestoredMovesEndFight(false);
        fighter_.usePowerPointsByMove(diff_, DETECTION,  1);
    ...
    public void usePowerPointsByMove3Test() {
        ...
        Difficulty diff_ = new Difficulty();
        diff_.setRestoredMovesEndFight(false);
        fighter_.usePowerPointsByMove(diff_, DETECTION,  6);
    ...
    public void usePowerPointsByMove4Test() {
        ...
        Difficulty diff_ = new Difficulty();
        diff_.setRestoredMovesEndFight(false);
        fighter_.usePowerPointsByMove(diff_, BROUHAHA,  11);
    ...
    public void formeNormale2Test() {
        ...
        fighter_.getCurrentMoves().put(SEISME, new UsesOfMove( 5));
        fighter_.formeNormale(data_);
        ActivityOfMove activity_ = fighter_.getEnabledMoves().getVal(PROVOC);
        assertTrue(!activity_.isEnabled());
        assertEq(0, activity_.getNbTurn());
    ...
    public void disableAllStatusByEnabledWeather5Test() {
        ...
        pokemon_.setLevel( 3);
        Fighter fighter_ = new Fighter(pokemon_, data_, 0);
        TeamPosition fighterCoordsOne_ = new TeamPosition(Fight.CST_FOE, 0);
        TeamPositionList fightersCoords_ = new TeamPositionList();
        fightersCoords_.add(fighterCoordsOne_);
        fighter_.initCreatureRelationsAutre(fightersCoords_, data_);
    ...
    public void variationBoostStatistique1Test() {
        ...
        pokemon_.setLevel( 3);
        Fighter fighter_ = new Fighter(pokemon_, data_, 0);
        fighter_.variationBoostStatistique(Statistic.ATTACK,2L);
    ...
    public void setFirstChosenMoveTargetSubstitute1Test() {
        ...
        Fighter fighter_ = new Fighter(pokemonUser_, data_,  0);
        fighter_.setFirstChosenMoveTargetSubstitute(DEMI_TOUR, tc(KEY_FOE, POKEMON_TARGET_ZERO),  1);
    ...
    public void getSubstistute2Test() {
        ...
        fighter_.setSubstituteForMove( 1);
        //fighter_.setFirstChosenMoveSubstitute(DEMI_TOUR,  1);
    ...
    public void healedPpMove2Test() {
        ...
        fighter_.usePowerPointsByMove(new Difficulty(), ULTRASON,  5);
    ...
    public void healedPpMove3Test() {
        ...
        pokemonUser_.setWonExpSinceLastLevel(new Rate("3167"));
        Fighter fighter_ = new Fighter(pokemonUser_, data_,  0);
        fighter_.usePowerPointsByMove(new Difficulty(), POURSUITE,  5);
    ...
    public void healedPpMove4Test() {
        ...
        pokemonUser_.setWonExpSinceLastLevel(new Rate("3167"));
        Fighter fighter_ = new Fighter(pokemonUser_, data_,  0);
        fighter_.usePowerPointsByMove(new Difficulty(), POURSUITE,  12);
    ...
    public void healPowerPoints1Test() {
        ...
        Fighter fighter_ = new Fighter(pokemonUser_, data_,  0);
        fighter_.usePowerPointsByMove(new Difficulty(), POURSUITE,  12);
        fighter_.healPowerPoints(POURSUITE,  10);
    ...
    public void numberNecessaryPointsForGrowingLevel1Test() {
        ...
        pokemonUser_.setWonExpSinceLastLevel(new Rate(3,2));
        Fighter fighter_ = new Fighter(pokemonUser_, data_,  0);
        Rate nbPoints_ = fighter_.numberNecessaryPointsForGrowingLevel( 4, data_);
        assertEq(new Rate("7"),nbPoints_);
        nbPoints_ = fighter_.numberNecessaryPointsForGrowingLevel( 5, data_);
    ...
    public void effectBatonPass1Test() {
        ...
        pokemonUser_.setWonExpSinceLastLevel(new Rate(3));
        Fighter fighter_ = new Fighter(pokemonUser_, data_,  0);
        pokemonUser_ = pkMoves(data_, new Difficulty(), pokemon_, moves_);
        pokemonUser_.getEv().put(Statistic.ATTACK,1L);
        pokemonUser_.setNickname(PIKA);
        pokemonUser_.setUsedBallCatching(SUPER_BALL);
        pokemonUser_.setHappiness( 140);
...
//        StringList attaquesApprendre_=new StringList(newMoves_.getKeys(true));
    ...
    public void learnMoves2Test() {
        ...
        pokemonUser_.setWonExpSinceLastLevel(new Rate("3167"));
        Fighter fighter_ = new Fighter(pokemonUser_, data_,  0);
        fighter_.getCurrentMoves().put(POUV_ANTIQUE, new UsesOfMove( 5));
        fighter_.setWonExp(new Rate("3"));
        LevelExpPoints result_ = fighter_.newLevelWonPoints(data_);
        fighter_.changeWonPoints(result_.getLevel(), result_.getExpPoints(), data_);
        StringMap<BoolVal> newMoves_ = fighter_.newMoves(result_.getLevel(), diff_, data_);
...
//        StringList attaquesApprendre_=new StringList(newMoves_.getKeys(true));
    ...
    public void fullHeal1Test() {
        ...
        fighter_.getMoves().getVal(MORPHING).setCurrent( 0);
        fighter_.getMoves().getVal(BROUHAHA).setCurrent( 5);
        fighter_.getMoves().getVal(POUV_ANTIQUE).setCurrent( 0);
        fighter_.getCurrentMoves().getVal(MORPHING).setCurrent( 0);
        fighter_.getCurrentMoves().getVal(BROUHAHA).setCurrent( 5);
        fighter_.getCurrentMoves().getVal(POUV_ANTIQUE).setCurrent( 0);
        fighter_.fullHeal();
    ...
    public void wonEvStatistic1Test() {
        ...
        pokemonUser_.setWonExpSinceLastLevel(new Rate(3));
        Fighter fighter_ = new Fighter(pokemonUser_, data_,  0);
        fighter_.wonEvStatistic(Statistic.ATTACK,1L,  100, data_);
    ...
    public void wonEvStatistic2Test() {
        ...
        moves_.put(POUV_ANTIQUE,10L);
        PokemonPlayer pokemonUser_ = pkMoves(data_, new Difficulty(), pokemon_, moves_);
        pokemonUser_.getEv().put(Statistic.ATTACK,90L);
        pokemonUser_.setNickname(PIKA);
        pokemonUser_.setUsedBallCatching(SUPER_BALL);
        pokemonUser_.setHappiness( 140);
        pokemonUser_.setWonExpSinceLastLevel(new Rate(3));
        Fighter fighter_ = new Fighter(pokemonUser_, data_,  0);
        fighter_.wonEvStatistic(Statistic.ATTACK,20L,  100, data_);
    ...
    public void isKoAt2Test() {
        ...
        fighter_.setGroundPlaceSubst( 1);
        assertTrue(!fighter_.isKoAt( 0));
    }
    ...
    public void patch6() {
        ...
        act_.setChosenTargets(TargetCoordsList.newList(TargetCoords.toFoeTarget( 1)));
        fighter_.setAction(act_);
        fighter_.patch(data_);
    ...
    private void winHappinessByGrowingLevel(Fighter _f, DataBase _data) {
        _f.winHappinessByGrowingLevel( 5, _data, new TransientFight());
    }

//
//    static int getNbStatusRelatByRounds(Fighter _f, int _nbRounds) {
////        int i_ = IndexConstants.SIZE_EMPTY;
////        for (CommonParam<MoveTeamPosition, Integer> e: _f.getStatusRelat().entryList()) {
