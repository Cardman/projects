...
//        _data.addConstNotNumTest(DataBase.DEFAULT_EGG_GROUP, "METAMORPH");
    ...
    protected static void initTranslations(DataBase _data) {
        ...
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_EFFET,StringUtil.concat(MOVE_FORMULA,TAB,"targ_eff__{0}",TAB,"The target is under the effect of the move {0}"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_GENRES_EGAUX, StringUtil.concat(MOVE_FORMULA,TAB,"gr_eg",TAB,"The genders equal to themselves."));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PK_SAUVAGE_GENRE, StringUtil.concat(ITEM_FORMULA,TAB,"wild_pk_gr",TAB,"Gender of the wild pokemon"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_GENRE, StringUtil.concat(MOVE_FORMULA,TAB,"user_gr",TAB,"Genre of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_PV_MAX, StringUtil.concat(MOVE_FORMULA,TAB,"usr_max_hp",TAB,"Full health points of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_EXISTE_GENRE_ASSEXUE, StringUtil.concat(MOVE_FORMULA,TAB,"exist_no_gr",TAB,"It exists a no-sexual gender."));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_EFFET, StringUtil.concat(MOVE_FORMULA,TAB,"usr_eff__{0}",TAB,"The user is under the effect of the move {0}"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_STATUTS, StringUtil.concat(MOVE_FORMULA,TAB,"targ_status",TAB,"status of the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_TAILLE, StringUtil.concat(MOVE_FORMULA,TAB,"targ_height",TAB,"Height of the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_OBJET, StringUtil.concat(MOVE_FORMULA,TAB,"targ_it",TAB,"Item of the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_IMMU_TYPE_ATT_COMBATTANT_ENTRANT, StringUtil.concat(TYPE_FORMULA,TAB,"immu_move_type_fighter__{0}",TAB,"The sent fighter is protected against the moves of type {0}"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_DEGATS_RECUS_TOTAL_TOUR, StringUtil.concat(MOVE_FORMULA,TAB,"usr_suffered_damg_rd",TAB,"Suffered damage against the user while the round"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_DEJA_CAPTURE, StringUtil.concat(ITEM_FORMULA,TAB,"already_caught",TAB,"Already caught pokemon"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_TYPES, StringUtil.concat(MOVE_FORMULA,TAB,"targ_t",TAB,"types of the targets"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_COMBATTANT_ENTRANT_TYPES, StringUtil.concat(MOVE_FORMULA,TAB,"sent_fighter_type",TAB,"Types of the sent fighter"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_STATUTS, StringUtil.concat(MOVE_FORMULA,TAB,"usr_status",TAB,"status of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PAS_PP_ATTAQUE_CIBLE, StringUtil.concat(MOVE_FORMULA,TAB,"no_pp_target",TAB,"The target has no power point for the move that the target owns"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_SOMME_BOOST_POS_CIBLE, StringUtil.concat(MOVE_FORMULA,TAB,"sum_boost_pos_tar",TAB,"Sum of the positive boosts of the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_ATTAQUE_NOM, StringUtil.concat(MOVE_FORMULA,TAB,"move_name",TAB,"Name of the move"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_BOOST, StringUtil.concat(STATIS_FORMULA,TAB,"usr_boost__{0}",TAB,"{0} of terms of boost of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_ATTACK, StringUtil.concat(MOVE_FORMULA,TAB,"att",TAB,"Value of the move of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_PV_RESTANTS, StringUtil.concat(MOVE_FORMULA,TAB,"targ_left_hp",TAB,"Remaining health points of the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_POSSEDE_STATUT_RELATION, StringUtil.concat(STATUS_FORMULA,TAB,"target_pseudo_st__{0}",TAB,"The target is victim of the pseudo status {0}"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_ATTAQUE_TYPES, StringUtil.concat(MOVE_FORMULA,TAB,"move_types",TAB,"Types of the move"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_FIGHTER_OBJET, StringUtil.concat(ITEM_FORMULA,TAB,"fighter_it",TAB,"Item of the owner"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_CLONE, StringUtil.concat(MOVE_FORMULA,TAB,"usr_clone",TAB,"PV of the clone of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_POWER, StringUtil.concat(MOVE_FORMULA,TAB,"pow",TAB,"Value of the power of the move of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PUISSANCE_BASE, StringUtil.concat(ITEM_FORMULA,TAB,"power_base",TAB,"Power of base of the move of the owner"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_MASSE_MOYENNE_PK, StringUtil.concat(ITEM_FORMULA,TAB,"avg_pk_weight",TAB,"Average weight of the pokemon"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_ATTAQUES_TYPES, StringUtil.concat(MOVE_FORMULA,TAB,"usr_moves_types",TAB,"Types of the moves of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PK_UT_NIVEAU, StringUtil.concat(ITEM_FORMULA,TAB,"pk_player_lev",TAB,"Level of the pokemon of the player"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_DEFENSE, StringUtil.concat(MOVE_FORMULA,TAB,"def",TAB,"Value of the defence of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PK_SAUVAGE_TYPES_BASE, StringUtil.concat(ITEM_FORMULA,TAB,"wild_pk_types",TAB,"Types de base of the wild pokemon"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_CAPACITE, StringUtil.concat(MOVE_FORMULA,TAB,"usr_ab",TAB,"Current ability of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_FIGHTER_NOM, StringUtil.concat(ITEM_FORMULA,TAB,"fighter_nom",TAB,"Name of the owner"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_NB_UTILISATION_CONSECUTIF, StringUtil.concat(ITEM_FORMULA,TAB,"nb_uses_cons",TAB,"Number of consecutive uses of the move."));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_FIGHTER_DER_JOUE, StringUtil.concat(ITEM_FORMULA,TAB,"fighter_last_acted",TAB,"The owner has played the last one"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_TEMPS_TOUR, StringUtil.concat(ITEM_FORMULA,TAB,"tps_rd",TAB,"Time of round"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_ATTAQUES, StringUtil.concat(MOVE_FORMULA,TAB,"usr_att",TAB,"Moves of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_BONHEUR, StringUtil.concat(MOVE_FORMULA,TAB,"usr_hap",TAB,"Happiness of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PK_SAUVAGE_PIERRES_EVOS, StringUtil.concat(ITEM_FORMULA,TAB,"wild_pk_ev",TAB,"Evolution stones of the wild pokemon"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_BOOST, StringUtil.concat(STATIS_FORMULA,TAB,"targ_boost__{0}",TAB,"{0} in terms of boost of the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PAS_PARTENAIRE_ARRIERE, StringUtil.concat(MOVE_FORMULA,TAB,"no_back_part",TAB,"No back partner"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_DISPARAIT, StringUtil.concat(MOVE_FORMULA,TAB,"usr_disap",TAB,"The user disappears while the round"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_JOUE, StringUtil.concat(MOVE_FORMULA,TAB,"usr_acted",TAB,"The user has acted"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_DEGATS_RECUS_TOTAL, StringUtil.concat(MOVE_FORMULA,TAB,"usr_amt_suff_damg",TAB,"Full suffered damage against the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_NB_UTILISATION, StringUtil.concat(MOVE_FORMULA,TAB,"usr_nb_uses__{0}",TAB,"Number of uses of the move {0} of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_STATIS, StringUtil.concat(STATIS_FORMULA,TAB,"targ_statis__{0}",TAB,"{0} in terms of base of statistic of the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_NB_UTILI_ATT_EQ_TOUR, StringUtil.concat(MOVE_FORMULA,TAB,"nb_uses_team_move_rd__{0}",TAB,"Number of uses of the move {0} by the team"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_NIVEAU, StringUtil.concat("level",TAB,"l",TAB,"The level of the Pokemon"));
//        litteral_.addEntry(DataBase.DEF_EV, StringUtil.concat("ev",TAB,"ev",TAB,"The ev of a statistic of the pokemon"));
//        litteral_.addEntry(DataBase.DEF_IV, StringUtil.concat("iv",TAB,"iv",TAB,"The iv of a statistic of the pokemon"));
//        litteral_.addEntry(DataBase.DEF_BASE, StringUtil.concat("base",TAB,"base",TAB,"The base value of a statistic of the pokemon"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_TAILLE, StringUtil.concat(MOVE_FORMULA,TAB,"usr_height",TAB,"height of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LIEU_COMBAT, StringUtil.concat(ITEM_FORMULA,TAB,"fight_env",TAB,"Fight environment"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_GENRE, StringUtil.concat(MOVE_FORMULA,TAB,"targ_gr",TAB,"Genre of the target"));
        ...
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_PV_MAX, StringUtil.concat(MOVE_FORMULA,TAB,"targ_max_hp",TAB,"Full health points of the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_TYPES, StringUtil.concat(MOVE_FORMULA,TAB,"usr_t",TAB,"types of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_FIGHTER_TYPES, StringUtil.concat(STATUS_FORMULA,TAB,"fighter_types",TAB,"Types of the fighter"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PAS_UTILIS_ATTAQUE_CIBLE, StringUtil.concat(MOVE_FORMULA,TAB,"no_use_tar",TAB,"No used move by the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_ATTAQUE_CATEGORIE, StringUtil.concat(MOVE_FORMULA,TAB,"move_cat",TAB,"Category of the move of the owner"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_NB_KO_EQUIPE_LANCEUR, StringUtil.concat(MOVE_FORMULA,TAB,"nb_ko_user",TAB,"Number of ko pokemon of the team of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_CAPACITE, StringUtil.concat(MOVE_FORMULA,TAB,"targ_ab",TAB,"Current ability of the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_DEGATS_RECUS_TOTAL_TOUR, StringUtil.concat(MOVE_FORMULA,TAB,"targ_suffered_damg_rd",TAB,"Suffered damage against the target while the round"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_FIGHTER_PP, StringUtil.concat(MOVE_FORMULA,TAB,"usr_pp__{0}",TAB,"Remaining power points of the move {0} of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_PP, StringUtil.concat(MOVE_FORMULA,TAB,"usr_pp__{0}",TAB,"Remaining power points of the move {0} of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_PP, StringUtil.concat(MOVE_FORMULA,TAB,"usr_pp__{0}",TAB,"Remaining power points of the move {0} of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PAS_TOUR_TERRAIN, StringUtil.concat(MOVE_FORMULA,TAB,"no_rd",TAB,"Has just been sent on the ground."));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_FIGHTER_CLONE, StringUtil.concat(STATUS_FORMULA,TAB,"fighter_clone",TAB,"PV of the clone of the fighter"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_NIVEAU, StringUtil.concat(MOVE_FORMULA,TAB,"targ_lev",TAB,"Level of the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_FIGHTER_STATUTS, StringUtil.concat(ITEM_FORMULA,TAB,"fighter_st",TAB,"Status of the owner"));
        ...
        litteral_.addEntry(MessagesDataBaseConstants.DEF_COEFF_EFF_BASE_TYPES_COMBATTANT_ENTRANT, StringUtil.concat(TYPE_FORMULA,TAB,"eff_base_sent_fighter__{0}",TAB,"Rate of efficiency of the type {0} against the types of the sent fighter"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_COEFF_EFF_BASE_TYPES_FIGHTER, StringUtil.concat(TYPE_FORMULA,TAB,"eff_base_sent_fighter__{0}",TAB,"Rate of efficiency of the type {0} against the types of the sent fighter"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_COEFF_EFF_BASE_TYPES_CIBLE, StringUtil.concat(TYPE_FORMULA,TAB,"eff_base_sent_fighter__{0}",TAB,"Rate of efficiency of the type {0} against the types of the sent fighter"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_COEFF_EFF_BASE_TYPES_LANCEUR, StringUtil.concat(TYPE_FORMULA,TAB,"eff_base_sent_fighter__{0}",TAB,"Rate of efficiency of the type {0} against the types of the sent fighter"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_NOM, StringUtil.concat(MOVE_FORMULA,TAB,"user_name",TAB,"Name of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PK_UT_GENRE, StringUtil.concat(ITEM_FORMULA,TAB,"pk_player_gr",TAB,"Gender of the pokemon of the player"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_FIGHTER_NB_UTILISATION, StringUtil.concat(MOVE_FORMULA,TAB,"cbt_nb_uses__{0}",TAB,"Number of uses of the move {0} of the fighter"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_EQUIPE_NB_UTILISATION, StringUtil.concat(MOVE_FORMULA,TAB,"cbt_nb_uses__{0}",TAB,"Number of uses of the move {0} of the fighter"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_NB_TOUR, StringUtil.concat(MOVE_FORMULA,TAB,"nb_rd__{0}",TAB,"number of round of the move {0}"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PAS_ATTAQUE_INVOC, StringUtil.concat(MOVE_FORMULA,TAB,"no_invok_move",TAB,"No invokable move"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_JOUE, StringUtil.concat(MOVE_FORMULA,TAB,"targ_acted",TAB,"The target has acted"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_CIBLE_MASSE, StringUtil.concat(MOVE_FORMULA,TAB,"targ_weight",TAB,"Weight of the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_EQUIPE_ADV_COMBATTANT_ENTRANT_NB_UTILISATION, StringUtil.concat(MOVE_FORMULA,TAB,"sent_foe_team_nb_uses__{0}",TAB,"Number of uses of the move {0} by the members of the foe team of the sent fighter."));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_OBJET, StringUtil.concat(MOVE_FORMULA,TAB,"usr_obj",TAB,"Item of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_ATTAQUE_CHOISIE, StringUtil.concat(MOVE_FORMULA,TAB,"usr_chosen_move",TAB,"Chosen move of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PK_SAUVAGE_VITESSE, StringUtil.concat(ITEM_FORMULA,TAB,"wild_pk_speed",TAB,"Base speed of the wild pokemon"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PAS_ATTAQUES_COPIABLES, StringUtil.concat(MOVE_FORMULA,TAB,"no_copy_moves",TAB,"No move can be copied"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_NB_COMBATTANTS_TERRAIN, StringUtil.concat(MOVE_FORMULA,TAB,"nb_fighters",TAB,"Number of fighters on the ground"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PK_SAUVAGE_NIVEAU, StringUtil.concat(ITEM_FORMULA,TAB,"wild_pk_lev",TAB,"Level of the wild pokemon"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_PV_RESTANTS, StringUtil.concat(MOVE_FORMULA,TAB,"usr_left_hp",TAB,"Remaining points de vie of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LANCEUR_NIVEAU, StringUtil.concat(MOVE_FORMULA,TAB,"usr_lev",TAB,"Level of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_COEFF_EFF, StringUtil.concat(ITEM_FORMULA,TAB,"rate_eff",TAB,"Rate of efficiency of the move of the owner"));
//        litteral_.addEntry(DataBase.DEF_LANCEUR_POSSEDE_STATUT_RELATION, StringUtil.concat(STATUS_FORMULA,TAB,"target_pseudo_st__{0}",TAB,"The user suffers of the pseudo status {0}"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_NB_TOUR_GLOBAL, StringUtil.concat(MOVE_FORMULA,TAB,"nb_gl_move__{0}",TAB,"Number of tour of the move {0}"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_SOMME_BOOST_POS_LANCEUR, StringUtil.concat(MOVE_FORMULA,TAB,"sum_boost_pos_user",TAB,"Sum of the positive boosts of the user"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PAS_PARTENAIRE_TERRAIN, StringUtil.concat(MOVE_FORMULA,TAB,"no_part",TAB,"No partner on the ground"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_COMBATTANT_ENTRANT_CLONE, StringUtil.concat(MOVE_FORMULA,TAB,"sent_fighter_clone",TAB,"Remaining health points of the clone of the sent fighter"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_AUCUN_BOOST_POSSIBLE, StringUtil.concat(MOVE_FORMULA,TAB,"no_boost",TAB,"No boost is possible pour the target"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_BASE_CAPT_PK, StringUtil.concat(MOVE_FORMULA,TAB,"catch_base",TAB,"Base catching rate of the wild pokemon"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_RATE_BALL_STATUS, StringUtil.concat(MOVE_FORMULA,TAB,"ball_status_rate",TAB,"Product between catching rate of the ball and rates of the status of the wild pokemon."));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_FOE_PK_MAX_HP, StringUtil.concat(MOVE_FORMULA,TAB,"full_hp",TAB,"Full health points of the wild pokemon."));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_FOE_PK_REMOTE_HP, StringUtil.concat(MOVE_FORMULA,TAB,"rem_hp",TAB,"Remaining health points of the wild pokemon."));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PK_UT_VITESSE, StringUtil.concat(MOVE_FORMULA,TAB,"pk_pl_speed",TAB,"Speed of the first pokemon of the player."));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_PK_SAUVAGE_VITESSE, StringUtil.concat(MOVE_FORMULA,TAB,"pk_foe_speed",TAB,"Speed of the wild pokemon."));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_NB_FLEES, StringUtil.concat(MOVE_FORMULA,TAB,"nb_flees",TAB,"Number of attempts of flee."));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LEVEL_WINNER, StringUtil.concat(MOVE_FORMULA,TAB,"lvl_l",TAB,"Level of the KO fighter"));
        litteral_.addEntry(MessagesDataBaseConstants.DEF_LEVEL_LOOSER, StringUtil.concat(MOVE_FORMULA,TAB,"lvl_w",TAB,"Level of the player fighter which wins points"));
