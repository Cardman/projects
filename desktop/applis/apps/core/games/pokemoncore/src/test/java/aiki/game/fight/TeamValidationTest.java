...
public class TeamValidationTest extends InitializationDataBase {
    ...
    public void validate1Test(){
        ...
        assertTrue(game_.getFight().getUserTeam().validate(data, Fight.PLAYER, game_.getFight()));
    }
    @Test
    ...
    public void validate3Test(){
        Game game_ = newGameInFight(Sex.GIRL);
        assertTrue(game_.getFight().getFoeTeam().validate(data, Fight.FOE, game_.getFight()));
    }
    @Test
