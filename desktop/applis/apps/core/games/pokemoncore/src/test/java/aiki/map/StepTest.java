...
public class StepTest extends EquallablePkUtil {
    ...
    public void new_Step_Map_Map_Tree_1Test() {
        ...
        assertTrue(step_.getCaughtPokemonPlaceLevel().contains(new PlaceLevel(1,0)));
        assertEq(2, count(step_.getCaughtPokemonPlaceLevel().getVal(new PlaceLevel(1,0))));
        assertTrue(containsGenderName(step_.getCaughtPokemonPlaceLevel().getVal(new PlaceLevel(1,0)),new GenderName(Gender.FEMALE,"PIKACHU")));
        assertTrue(containsGenderName(step_.getCaughtPokemonPlaceLevel().getVal(new PlaceLevel(1,0)),new GenderName(Gender.MALE,"PIKACHU")));
    ...
    public void nextStep2Test() {
        ...
        assertEq(1, step_.getCaughtPokemonPlaceLevel().size());
        assertTrue(step_.getCaughtPokemonPlaceLevel().contains(new PlaceLevel(7,0)));
        assertEq(1, step_.getCaughtPokemonPlaceLevel().getVal(new PlaceLevel(7,0)).size());
        assertTrue(containsGenderName(step_.getCaughtPokemonPlaceLevel().getVal(new PlaceLevel(7,0)),new GenderName(Gender.NO_GENDER,"ELECTHOR")));
