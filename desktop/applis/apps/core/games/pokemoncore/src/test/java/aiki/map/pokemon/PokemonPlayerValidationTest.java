...
public class PokemonPlayerValidationTest extends InitializationDataBase {
    ...
    public void validate1Test() {
        assertTrue(pokemonPlayer(data, (short) 3).validate(data));
    }
    ...
    public void validate9Test() {
        assertTrue(!pokemonPlayer(data, (short) -1).validate(data));
    }

    @Test
    public void validate10Test() {
        assertTrue(!pokemonPlayer(data, (short) 1000).validate(data));
    }

    @Test
    public void validate11Test() {
        assertTrue(!new PokemonPlayer().validate(data));
    }
    ...
    public void validate30Test() {
        PokemonPlayer pk_ = pokemonPlayer(data, (short) 15);
        assertTrue(pk_.validate(data));
