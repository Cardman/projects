...
public enum DealingTarot {
    ...
    DEAL_2_VS_2_CALL_KING(4,CallingCard.KING,6,1, 60, 110, "3"),
    DEAL_2_VS_2_CALL_CHAR(4,CallingCard.CHARACTER_CARD,6,1, 60, 110, "4"),
    DEAL_1_VS_4(5,CallingCard.WITHOUT,8,0, 80, 130, "5"),
    DEAL_2_VS_3_CALL_KING(5,CallingCard.KING,3,1, 60, 100, "6"),
    DEAL_2_VS_3_CALL_CHAR(5,CallingCard.CHARACTER_CARD,3,1, 60, 100, "7"),
    DEAL_2_VS_4_WITHOUT_CALL(6,CallingCard.DEFINED,6,1, 50, 90, "8"),
    DEAL_2_VS_4_CALL_KING(6,CallingCard.KING,6,1, 90, 150, "9"),
    DEAL_2_VS_4_CALL_CHAR(6,CallingCard.CHARACTER_CARD,6,1, 90, 150, "_");
    ...
    DealingTarot(int _nombreJoueurs, CallingCard _appel,
                 ...
                 int _nbAppeles, int _p, int _g, String _s){
