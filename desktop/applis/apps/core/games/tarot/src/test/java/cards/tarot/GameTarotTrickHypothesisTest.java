...
public final class GameTarotTrickHypothesisTest extends CommonGameTarot {
    ...
    public void hypothesesRepartitionsJoueurs1Test() {
        ...
        bids_.add(BidTarot.FOLD);
        bids_.add(BidTarot.FOLD);
        TrickTarot t_ = new TrickTarot(getTaker(r_,2,bids_));
        t_.ajouter(CardTarot.HEART_QUEEN);
        t_.ajouter(CardTarot.HEART_KNIGHT);
        t_.ajouter(CardTarot.HEART_10);
        trs_.add(t_);
        t_ = new TrickTarot(r_.getDealing().getId().getNextPlayer(2));
        ...
        DealTarot deal_ = new DealTarot(new CustList<HandTarot>(), 2);
...
//        GameTarotTrickHypothesis.hypothesesRepartitionsJoueurs(team_, _g.getCalledCards(), tricks_, next_,poss_,sure_);
    ...
    private static BoolVal confidenceSelfValue(GameTarot _g, CustList<CustList<BoolVal>> _c) {
        ...
        int next_ = _g.getProgressingTrick().getNextPlayer(nbPl_);
