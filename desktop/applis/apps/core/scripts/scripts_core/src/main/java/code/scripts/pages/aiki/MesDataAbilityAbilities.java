...
private static final String M_P_CONTENT="content";
...
static String en(){
String f=M_P_TITLE+SEP+C_P_0_0;
f+=M_P_ABILITIES+SEP+C_P_0_1;
f+=M_P_CONTENT+SEP+C_P_0_2;
f+=M_P_INDEX+SEP+C_P_0_3;
return f;
}
static String fr(){
String f=M_P_TITLE+SEP+C_P_0_4;
f+=M_P_ABILITIES+SEP+C_P_0_5;
f+=M_P_CONTENT+SEP+C_P_0_6;
f+=M_P_INDEX+SEP+C_P_0_7;
return f;
}
}
