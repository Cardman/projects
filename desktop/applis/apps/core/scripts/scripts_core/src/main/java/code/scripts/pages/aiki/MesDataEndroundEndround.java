...
static String en(){
String f="title=End of round\n";
f+="EFFET=L'effet a lieu en fin de tour.<br/>${A}${O}${C}${S}${ORDRE_FIN_TOUR}${TYPE_RELATION}${ANTICIPE}${TAUX_PV_INFLIGES_CIBLE_LOI_PIEGE}${STATUT_FIN_TOUR_LANCEUR}${STATUT_OK}${STATUT_OK_PART}${DEGATS_STATUT}${MULT_DEGATS_STATUT}${TAUX_PV_INFLIGE_CIBLE}${TAUX_PV_ABS_CIBLE_VERS_LANCEUR}${SOIN_APRES}${TAUX_PV_RESTAURES}${GAIN_PV_TOUS}${GAIN_PV_SEL}\n";
f+="A=L'effet appartient &agrave; l'attaque ${ATTAQUE}.<br/>\n";
...
f+="TYPE_RELATION__INDIVIDUEL=Cet effet concerne un seul combattant.<br/>\n";
...
f+="DEGATS_RECUL=Le taux de d&eacute;g&acirc;ts de recul pour le combattant est de ${TAUX}.<br/>\n";
f+="GAIN_PV_TOUS=Le combattant restaure ${TAUX} de sa vie totale.<br/>\n";
f+="GAIN_PV_SEL=Voici la variation des pv du combattant en fonction des types poss&eacute;d&eacute;s,<br/>les variations de vie sont cumul&eacute;s en fonction des types poss&eacute;d&eacute;s:<br/><table><tr><td>Types poss&eacute;d&eacute;s</td><td>Sens de variation</td><td>Taux de pv du combattant</td></tr>${GAIN_PV_SEL__LIGNE}</table><br/>\n";
f+="GAIN_PV_SEL__LIGNE=${TYPE}${AUTRE}\n";
f+="GAIN_PV_SEL__LIGNE_POS=<tr><td>${TYPE}</td><td>Pv gagn&eacute;s</td><td>${TAUX}</td></tr>\n";
f+="GAIN_PV_SEL__LIGNE_NEG=<tr><td>${TYPE}</td><td>Pv perdus</td><td>${TAUX}</td></tr>\n";
f+="GAIN_PV_SEL__LIGNE_AUTRE_POS=<tr><td>Autre que ceux ci-dessus</td><td>Pv gagn&eacute;s</td><td>${TAUX}</td></tr>\n";
f+="GAIN_PV_SEL__LIGNE_AUTRE_NEG=<tr><td>Autre que ceux ci-dessus</td><td>Pv perdus</td><td>${TAUX}</td></tr>\n";
f+="STATUT_FIN_TOUR_LANCEUR=Le combattant prend le statut ${STATUT} si ce n'est pas d&eacute;j&agrave; fait.<br/>\n";
return f;
}
static String fr(){
String f="title=Fin de tour\n";
f+="EFFET=L'effet a lieu en fin de tour.<br/>${A}${O}${C}${S}${ORDRE_FIN_TOUR}${TYPE_RELATION}${ANTICIPE}${TAUX_PV_INFLIGES_CIBLE_LOI_PIEGE}${STATUT_FIN_TOUR_LANCEUR}${STATUT_OK}${STATUT_OK_PART}${DEGATS_STATUT}${MULT_DEGATS_STATUT}${TAUX_PV_INFLIGE_CIBLE}${TAUX_PV_ABS_CIBLE_VERS_LANCEUR}${SOIN_APRES}${TAUX_PV_RESTAURES}${GAIN_PV_TOUS}${GAIN_PV_SEL}\n";
f+="A=L'effet appartient &agrave; l'attaque ${ATTAQUE}.<br/>\n";
f+="O=L'effet appartient &agrave; l'objet ${OBJET}.<br/>\n";
f+="C=L'effet appartient &agrave; la capacit&eacute; ${CAPACITE}.<br/>\n";
