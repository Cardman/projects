...
private static final String M_P_ITEM_TYPE="item_type";
private static final String M_P_PRICE="price";
private static final String M_P_TITLE="title";
private static final char SEP='=';
private MesDataItemsItem(){}
static String en(){
String f=M_P_TITLE+SEP+C_P_27_0;
f+=M_P_PRICE+SEP+C_P_27_1;
f+=M_P_ITEM_TYPE+SEP+C_P_27_2;
f+=M_P_ITEMS+SEP+C_P_27_3;
return f;
}
static String fr(){
String f=M_P_TITLE+SEP+C_P_27_4;
f+=M_P_PRICE+SEP+C_P_27_5;
f+=M_P_ITEM_TYPE+SEP+C_P_27_6;
f+=M_P_ITEMS+SEP+C_P_27_7;
return f;
}
}
