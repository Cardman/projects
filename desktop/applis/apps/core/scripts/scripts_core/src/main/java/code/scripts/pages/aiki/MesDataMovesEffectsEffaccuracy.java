...
private static final String M_P_ACCURACY_MAX="accuracy_max";
private static final String M_P_EFFECT="effect";
private static final char SEP='=';
private MesDataMovesEffectsEffaccuracy(){}
static String en(){
String f=M_P_EFFECT+SEP+C_P_37_0;
f+=M_P_ACCURACY_MAX+SEP+C_P_37_1;
return f;
}
static String fr(){
String f=M_P_EFFECT+SEP+C_P_37_2;
f+=M_P_ACCURACY_MAX+SEP+C_P_37_3;
return f;
}
}
