...
private static final String C_P_44_0="The effect protects its user against some moves and can let its user counter attack (return some effects of these moves).<br/>\n";
private static final String C_P_44_10="{0}\n";
private static final String C_P_44_11="L''effet prot&egrave;ge son lanceur contre certains attaques et peut permettre de contre attaquer (retourner certains des effets de ces attaques).<br/>\n";
private static final String C_P_44_12="Lorsqu''un pokemon attaque le lanceur de l''attaque {0}, la protection de l''effet &eacute;choue si et seulement si une des conditions est v&eacute;rifi&eacute;e:<br/>\n";
private static final String C_P_44_13="Lorsqu''un pokemon adverse attaque le lanceur de l''attaque {0}, la contre-attaque de l''effet &eacute;choue si et seulement si une des conditions est v&eacute;rifi&eacute;e:<br/>\n";
private static final String C_P_44_14="Lorsqu''un pokemon adverse attaque le lanceur de l''attaque {0}, il perd des d&eacute;g&acirc;ts en fonction des types de l''attaque utilis&eacute;e (les degats sont cumules s''il y a plusieurs types pour l''attaque):<br/>\n";
private static final String C_P_44_15="Type de l''attaque\n";
private static final String C_P_44_16="Taux de vie perdue\n";
private static final String C_P_44_17="Lorsqu''un pokemon adverse attaque le lanceur de l''attaque {0} avec une attaque directe, ses boosts de statistiques varient de la fa&ccedil;on suivante:<br/>\n";
private static final String C_P_44_18="Statistique\n";
private static final String C_P_44_19="Variation de la statistique\n";
private static final String C_P_44_1="While a pokemon uses a move against the user of the move {0}, the protection of the effect fails if and only if one of the conditions is checked:<br/>\n";
private static final String C_P_44_20="Lorsqu''un pokemon adverse attaque le lanceur de l''attaque {0} avec une attaque directe, le taux de vie perdue est de {1}.<br/>\n";
private static final String C_P_44_21="{0}\n";
private static final String C_P_44_2="While a pokemon uses a move against the user of the move {0}, the counter attack of the effect fails if and only if one of the conditions is checked:<br/>\n";
private static final String C_P_44_3="While a pokemon uses a move against the user of the move {0}, it loose health points in function by the types of the used move (damage is added if there is some types for the move):<br/>\n";
private static final String C_P_44_4="Type of the move\n";
private static final String C_P_44_5="Rate of lost life\n";
private static final String C_P_44_6="While a pokemon uses a move against the user of the move {0} with a direct move, the levels of its statistics vary by the following way:<br/>\n";
