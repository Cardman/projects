...
private static final String M_P_MULT_POWER="mult_power";
private static final String M_P_MULT_POWER_RATE="mult_power_rate";
private static final String M_P_MULT_POWER_TYPE="mult_power_type";
private static final char SEP='=';
private MesDataMovesEffectsEffmultusedmovepower(){}
static String en(){
String f=M_P_EFFECT+SEP+C_P_52_0;
f+=M_P_MULT_POWER+SEP+C_P_52_1;
f+=M_P_MULT_POWER_TYPE+SEP+C_P_52_2;
f+=M_P_MULT_POWER_RATE+SEP+C_P_52_3;
return f;
}
static String fr(){
String f=M_P_EFFECT+SEP+C_P_52_4;
f+=M_P_MULT_POWER+SEP+C_P_52_5;
f+=M_P_MULT_POWER_TYPE+SEP+C_P_52_6;
f+=M_P_MULT_POWER_RATE+SEP+C_P_52_7;
return f;
}
}
