...
private static final String M_P_IMMU_MOVE_TYPES="immu_move_types";
private static final char SEP='=';
private MesDataMovesEffectsEffprotectfromtypes(){}
static String en(){
String f=M_P_EFFECT+SEP+C_P_54_0;
f+=M_P_IMMU_MOVE_TYPES+SEP+C_P_54_1;
return f;
}
static String fr(){
String f=M_P_EFFECT+SEP+C_P_54_2;
f+=M_P_IMMU_MOVE_TYPES+SEP+C_P_54_3;
return f;
}
}
