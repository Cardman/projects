...
private static final String M_P_PROT_MULTI_TARGETS="prot_multi_targets";
private static final String M_P_PROT_PRIO="prot_prio";
private static final String M_P_PROT_SINGLE="prot_single";
private static final String M_P_PROT_SINGLE_DAMAGE="prot_single_damage";
private static final String M_P_PROT_SINGLE_KO="prot_single_ko";
private static final String M_P_PROT_SINGLE_STATUS="prot_single_status";
private static final char SEP='=';
private MesDataMovesEffectsEffprotection(){}
static String en(){
String f=M_P_EFFECT+SEP+C_P_55_0;
f+=M_P_PROT_MULTI_TARGETS+SEP+C_P_55_1;
f+=M_P_PROT_PRIO+SEP+C_P_55_2;
f+=M_P_PROT_SINGLE+SEP+C_P_55_3;
f+=M_P_PROT_SINGLE_KO+SEP+C_P_55_4;
f+=M_P_PROT_SINGLE_DAMAGE+SEP+C_P_55_5;
f+=M_P_PROT_SINGLE_STATUS+SEP+C_P_55_6;
return f;
}
static String fr(){
String f=M_P_EFFECT+SEP+C_P_55_7;
f+=M_P_PROT_MULTI_TARGETS+SEP+C_P_55_8;
f+=M_P_PROT_PRIO+SEP+C_P_55_9;
f+=M_P_PROT_SINGLE+SEP+C_P_55_10;
f+=M_P_PROT_SINGLE_KO+SEP+C_P_55_11;
f+=M_P_PROT_SINGLE_DAMAGE+SEP+C_P_55_12;
f+=M_P_PROT_SINGLE_STATUS+SEP+C_P_55_13;
return f;
}
}
