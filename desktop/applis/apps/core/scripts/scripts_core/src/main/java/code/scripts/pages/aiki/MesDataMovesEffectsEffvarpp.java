...
private static final String M_P_DELETE_PP="delete_pp";
private static final String M_P_EFFECT="effect";
private static final char SEP='=';
private MesDataMovesEffectsEffvarpp(){}
static String en(){
String f=M_P_EFFECT+SEP+C_P_69_0;
f+=M_P_DELETE_PP+SEP+C_P_69_1;
return f;
}
static String fr(){
String f=M_P_EFFECT+SEP+C_P_69_2;
f+=M_P_DELETE_PP+SEP+C_P_69_3;
return f;
}
}
