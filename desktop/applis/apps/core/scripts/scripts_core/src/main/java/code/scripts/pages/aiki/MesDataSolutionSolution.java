...
private static final String M_P_87_GENDER="gender";
private static final String M_P_87_IMAGE="image";
private static final String M_P_87_INDEX="index";
private static final String M_P_87_NAME="name";
private static final String M_P_87_TITLE="title";
private static final char SEP='=';
private MesDataSolutionSolution(){}
static String en(){
String f=M_P_87_TITLE+SEP+C_P_87_0;
f+=M_P_87_NAME+SEP+C_P_87_1;
f+=M_P_87_GENDER+SEP+C_P_87_2;
f+=M_P_87_IMAGE+SEP+C_P_87_3;
f+=M_P_87_INDEX+SEP+C_P_87_4;
return f;
}
static String fr(){
String f=M_P_87_TITLE+SEP+C_P_87_5;
f+=M_P_87_NAME+SEP+C_P_87_6;
f+=M_P_87_GENDER+SEP+C_P_87_7;
f+=M_P_87_IMAGE+SEP+C_P_87_8;
f+=M_P_87_INDEX+SEP+C_P_87_9;
return f;
}
}
