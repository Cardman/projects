...
static String en(){
String f=M_P_TITLE+SEP+C_P_89_0;
f+=M_P_STATUS+SEP+C_P_89_1;
f+=M_P_CONTENT+SEP+C_P_89_2;
f+=M_P_INDEX+SEP+C_P_89_3;
return f;
}
static String fr(){
String f=M_P_TITLE+SEP+C_P_89_4;
f+=M_P_STATUS+SEP+C_P_89_5;
f+=M_P_CONTENT+SEP+C_P_89_6;
f+=M_P_INDEX+SEP+C_P_89_7;
return f;
}
}
