...
final class PageDataComboCombos{
...
CustList<Attr> attrs1_=al(1);
attrs1_.add(at("value","msg_combo,index"));
at(elt1_,attrs1_);
ad(elt0_,elt1_);
ad(_body,elt0_);
}
...
CustList<Attr> attrs0_=al(2);
attrs0_.add(at("list","getCombosKey()"));
attrs0_.add(at("var","m"));
at(elt0_,attrs0_);
Element elt1_=el(_doc,"c:import");
CustList<Attr> attrs1_=al(1);
attrs1_.add(at("page","{combo}"));
at(elt1_,attrs1_);
...
attrs3_.add(at("name","EffectComboBean"));
at(elt3_,attrs3_);
Element elt4_=el(_doc,"c:field");
CustList<Attr> attrs4_=al(1);
attrs4_.add(at("prepare","$intern.combos=combos"));
at(elt4_,attrs4_);
ad(elt3_,elt4_);
Element elt5_=el(_doc,"c:field");
CustList<Attr> attrs5_=al(1);
attrs5_.add(at("prepare","$intern.index=([m])"));
at(elt5_,attrs5_);
ad(elt3_,elt5_);
ad(elt2_,elt3_);
ad(elt1_,elt2_);
