...
attrs0_.add(at("condition","!move.isEmpty()"));
at(elt1_,attrs0_);
...
attrs2_.add(at("condition","!ability.isEmpty()"));
at(elt3_,attrs2_);
...
attrs4_.add(at("condition","!item.isEmpty()"));
at(elt5_,attrs4_);
...
attrs6_.add(at("condition","!status.isEmpty()"));
at(elt7_,attrs6_);
