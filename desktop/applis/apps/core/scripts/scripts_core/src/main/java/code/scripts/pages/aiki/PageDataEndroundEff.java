...
final class PageDataEndroundEff extends PageAikiCommon{
...
at(elt2_,attrs1_);
Text txt0_=tx(_doc,C_P_101_8);
ad(elt2_,txt0_);
ad(elt1_,elt2_);
ad(elt0_,elt1_);
Element elt3_=el(_doc,C_IF);
