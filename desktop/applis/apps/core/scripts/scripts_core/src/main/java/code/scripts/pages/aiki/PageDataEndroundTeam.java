...
final class PageDataEndroundTeam{
...
attrs0_.add(at("c:bean","end_team"));
at(elt0_,attrs0_);
...
CustList<Attr> attrs0_=al(1);
attrs0_.add(at("condition","!deleteAllStatus.isZero()"));
at(elt1_,attrs0_);
Element elt2_=el(_doc,"c:message");
CustList<Attr> attrs1_=al(1);
attrs1_.add(at("value","msg_team,effect"));
at(elt2_,attrs1_);
ad(elt1_,elt2_);
Element elt3_=el(_doc,"c:message");
CustList<Attr> attrs2_=al(1);
attrs2_.add(at("value","msg_team,owner"));
at(elt3_,attrs2_);
...
attrs4_.add(at("value","msg_team,team"));
at(elt5_,attrs4_);
Element elt6_=el(_doc,"param");
CustList<Attr> attrs5_=al(1);
attrs5_.add(at("value","deleteAllStatusAlly"));
at(elt6_,attrs5_);
ad(elt5_,elt6_);
ad(elt0_,elt5_);
ad(_body,elt0_);
