...
final class PageDataItemsBoost extends PageAikiCommon{
...
at(elt21_,attrs11_);
Text txt0_=tx(_doc,C_P_117_28);
ad(elt21_,txt0_);
ad(elt20_,elt21_);
ad(elt19_,elt20_);
ad(elt15_,elt19_);
Element elt22_=el(_doc,TD);
Text txt1_=tx(_doc,C_P_117_29);
ad(elt22_,txt1_);
ad(elt15_,elt22_);
ad(elt14_,elt15_);
ad(elt13_,elt14_);
...
Text txt2_=tx(_doc,C_P_117_40);
ad(elt37_,txt2_);
ad(elt36_,elt37_);
Element elt38_=el(_doc,TD);
Text txt3_=tx(_doc,C_P_117_41);
ad(elt38_,txt3_);
ad(elt36_,elt38_);
ad(elt35_,elt36_);
ad(elt34_,elt35_);
