...
final class PageDataItemsHealinghpstatus{
...
attrs0_.add(at("c:bean","healinghpstatus"));
at(elt0_,attrs0_);
...
attrs0_.add(at("page","{healingStatusBean}"));
at(elt0_,attrs0_);
...
CustList<Attr> attrs0_=al(1);
attrs0_.add(at("value","msg_healinghpstatus,rate"));
at(elt1_,attrs0_);
Element elt2_=el(_doc,"param");
CustList<Attr> attrs1_=al(1);
attrs1_.add(at("value","healedHpRate"));
at(elt2_,attrs1_);
ad(elt1_,elt2_);
ad(elt0_,elt1_);
ad(_body,elt0_);
