...
final class PageDataItemsItems{
...
attrs0_.add(at("c:bean","items"));
at(elt0_,attrs0_);
Element elt1_=el(_doc,"head");
Element elt2_=el(_doc,"title");
Element elt3_=el(_doc,"c:message");
CustList<Attr> attrs1_=al(1);
attrs1_.add(at("value","msg_items,title"));
at(elt3_,attrs1_);
ad(elt2_,elt3_);
ad(elt1_,elt2_);
Element elt4_=el(_doc,"link");
CustList<Attr> attrs2_=al(3);
attrs2_.add(at("href","web/css/items.css"));
...
CustList<Attr> attrs1_=al(1);
attrs1_.add(at("value","msg_items,index"));
at(elt1_,attrs1_);
ad(elt0_,elt1_);
ad(_body,elt0_);
}
...
ad(elt0_,elt9_);
Element elt10_=el(_doc,"input");
CustList<Attr> attrs7_=al(2);
attrs7_.add(at("type","submit"));
attrs7_.add(at("value","OK"));
at(elt10_,attrs7_);
ad(elt0_,elt10_);
ad(_body,elt0_);
}
