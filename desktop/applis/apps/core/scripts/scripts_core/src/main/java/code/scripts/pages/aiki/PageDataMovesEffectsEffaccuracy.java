...
final class PageDataMovesEffectsEffaccuracy{
...
attrs0_.add(at("c:bean","eff_accuracy"));
at(elt0_,attrs0_);
...
attrs0_.add(at("value","msg_effaccuracy,effect"));
at(elt1_,attrs0_);
ad(elt0_,elt1_);
...
attrs6_.add(at("value","msg_effaccuracy,accuracy_max"));
at(elt7_,attrs6_);
ad(elt0_,elt7_);
ad(_body,elt0_);
}
