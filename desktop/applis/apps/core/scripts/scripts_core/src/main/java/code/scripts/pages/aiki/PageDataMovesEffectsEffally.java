...
final class PageDataMovesEffectsEffally{
...
attrs0_.add(at("c:bean","eff_ally"));
at(elt0_,attrs0_);
...
attrs0_.add(at("value","msg_effally,effect"));
at(elt1_,attrs0_);
ad(elt0_,elt1_);
...
attrs6_.add(at("value","msg_effally,mul_ally_damage"));
at(elt7_,attrs6_);
Element elt8_=el(_doc,"param");
CustList<Attr> attrs7_=al(1);
attrs7_.add(at("value","multAllyDamage"));
at(elt8_,attrs7_);
ad(elt7_,elt8_);
ad(elt0_,elt7_);
ad(_body,elt0_);
