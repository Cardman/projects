...
final class PageDataMovesEffectsEffmultsufferedmovepower{
...
attrs0_.add(at("c:bean","eff_multsufferedmovepower"));
at(elt0_,attrs0_);
...
attrs0_.add(at("value","msg_effmultsufferedmovepower,effect"));
at(elt1_,attrs0_);
ad(elt0_,elt1_);
...
attrs6_.add(at("value","msg_effmultsufferedmovepower,mult_power"));
at(elt7_,attrs6_);
ad(elt0_,elt7_);
...
attrs7_.add(at("value","msg_effmultsufferedmovepower,mult_power_type"));
at(elt12_,attrs7_);
ad(elt11_,elt12_);
ad(elt10_,elt11_);
...
attrs8_.add(at("value","msg_effmultsufferedmovepower,mult_power_rate"));
at(elt14_,attrs8_);
ad(elt13_,elt14_);
ad(elt10_,elt13_);
ad(elt9_,elt10_);
