...
final class PageDataMovesEffectsEfforder{
...
attrs0_.add(at("c:bean","eff_order"));
at(elt0_,attrs0_);
...
attrs0_.add(at("value","msg_efforder,effect"));
at(elt1_,attrs0_);
ad(elt0_,elt1_);
...
attrs6_.add(at("condition","targetAttacksLast"));
at(elt7_,attrs6_);
Element elt8_=el(_doc,"c:message");
CustList<Attr> attrs7_=al(1);
attrs7_.add(at("value","msg_efforder,last"));
at(elt8_,attrs7_);
ad(elt7_,elt8_);
ad(elt0_,elt7_);
Element elt9_=el(_doc,"c:if");
CustList<Attr> attrs8_=al(1);
attrs8_.add(at("condition","!targetAttacksLast"));
at(elt9_,attrs8_);
Element elt10_=el(_doc,"c:message");
CustList<Attr> attrs9_=al(1);
attrs9_.add(at("value","msg_efforder,after_user"));
at(elt10_,attrs9_);
ad(elt9_,elt10_);
ad(elt0_,elt9_);
ad(_body,elt0_);
