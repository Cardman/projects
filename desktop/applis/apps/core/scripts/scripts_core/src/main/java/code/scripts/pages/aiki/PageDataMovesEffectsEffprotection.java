...
final class PageDataMovesEffectsEffprotection{
...
attrs0_.add(at("c:bean","eff_protection"));
at(elt0_,attrs0_);
...
attrs0_.add(at("value","msg_effprotection,effect"));
at(elt1_,attrs0_);
ad(elt0_,elt1_);
...
attrs6_.add(at("condition","protSingle"));
at(elt7_,attrs6_);
Element elt8_=el(_doc,"c:message");
CustList<Attr> attrs7_=al(1);
attrs7_.add(at("value","msg_effprotection,prot_single"));
at(elt8_,attrs7_);
ad(elt7_,elt8_);
ad(elt0_,elt7_);
Element elt9_=el(_doc,"c:if");
CustList<Attr> attrs8_=al(1);
attrs8_.add(at("condition","!protSingleAgainstKo.isZero()"));
at(elt9_,attrs8_);
Element elt10_=el(_doc,"c:message");
CustList<Attr> attrs9_=al(1);
attrs9_.add(at("value","msg_effprotection,prot_single_ko"));
at(elt10_,attrs9_);
Element elt11_=el(_doc,"param");
CustList<Attr> attrs10_=al(1);
attrs10_.add(at("value","protSingleAgainstKo"));
at(elt11_,attrs10_);
ad(elt10_,elt11_);
ad(elt9_,elt10_);
ad(elt0_,elt9_);
...
attrs11_.add(at("condition","protTeamAgainstMultTargets"));
at(elt12_,attrs11_);
Element elt13_=el(_doc,"c:message");
CustList<Attr> attrs12_=al(1);
attrs12_.add(at("value","msg_effprotection,prot_multi_targets"));
at(elt13_,attrs12_);
ad(elt12_,elt13_);
ad(elt0_,elt12_);
Element elt14_=el(_doc,"c:if");
CustList<Attr> attrs13_=al(1);
attrs13_.add(at("condition","protTeamAgainstPrio"));
at(elt14_,attrs13_);
Element elt15_=el(_doc,"c:message");
CustList<Attr> attrs14_=al(1);
attrs14_.add(at("value","msg_effprotection,prot_prio"));
at(elt15_,attrs14_);
ad(elt14_,elt15_);
ad(elt0_,elt14_);
Element elt16_=el(_doc,"c:if");
CustList<Attr> attrs15_=al(1);
attrs15_.add(at("condition","protTeamAgainstStatusMoves"));
at(elt16_,attrs15_);
Element elt17_=el(_doc,"c:message");
CustList<Attr> attrs16_=al(1);
attrs16_.add(at("value","msg_effprotection,prot_single_status"));
at(elt17_,attrs16_);
ad(elt16_,elt17_);
ad(elt0_,elt16_);
Element elt18_=el(_doc,"c:if");
CustList<Attr> attrs17_=al(1);
attrs17_.add(at("condition","protTeamAgainstDamageMoves"));
at(elt18_,attrs17_);
Element elt19_=el(_doc,"c:message");
CustList<Attr> attrs18_=al(1);
attrs18_.add(at("value","msg_effprotection,prot_single_damage"));
at(elt19_,attrs18_);
ad(elt18_,elt19_);
ad(elt0_,elt18_);
ad(_body,elt0_);
