...
final class PageDataMovesEffectsEffremainedhprate{
...
attrs0_.add(at("c:bean","eff_remainedhprate"));
at(elt0_,attrs0_);
...
attrs0_.add(at("value","msg_effremainedhprate,effect"));
at(elt1_,attrs0_);
ad(elt0_,elt1_);
...
attrs7_.add(at("value","msg_effremainedhprate,rate_win"));
at(elt8_,attrs7_);
Element elt9_=el(_doc,"param");
CustList<Attr> attrs8_=al(1);
attrs8_.add(at("value","rateHp"));
at(elt9_,attrs8_);
ad(elt8_,elt9_);
ad(elt7_,elt8_);
ad(elt0_,elt7_);
...
attrs10_.add(at("value","msg_effremainedhprate,rate_loose"));
at(elt11_,attrs10_);
Element elt12_=el(_doc,"param");
CustList<Attr> attrs11_=al(1);
attrs11_.add(at("value","rateHp"));
at(elt12_,attrs11_);
ad(elt11_,elt12_);
ad(elt10_,elt11_);
ad(elt0_,elt10_);
