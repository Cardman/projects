...
final class PageDataMovesEffectsEffswitchpointview{
...
attrs0_.add(at("c:bean","eff_switchpointview"));
at(elt0_,attrs0_);
...
attrs0_.add(at("value","msg_effswitchpointview,effect"));
at(elt1_,attrs0_);
ad(elt0_,elt1_);
...
attrs6_.add(at("condition","thieveBonus()"));
at(elt7_,attrs6_);
Element elt8_=el(_doc,"c:message");
CustList<Attr> attrs7_=al(1);
attrs7_.add(at("value","msg_effswitchpointview,thief"));
at(elt8_,attrs7_);
...
attrs9_.add(at("condition","mirrorAgainstUser()"));
at(elt10_,attrs9_);
Element elt11_=el(_doc,"c:message");
CustList<Attr> attrs10_=al(1);
attrs10_.add(at("value","msg_effswitchpointview,mirror"));
at(elt11_,attrs10_);
Element elt12_=el(_doc,"param");
CustList<Attr> attrs11_=al(1);
attrs11_.add(at("value","move"));
at(elt12_,attrs11_);
ad(elt11_,elt12_);
ad(elt10_,elt11_);
ad(elt0_,elt10_);
...
attrs12_.add(at("condition","attractDamageMoves()"));
at(elt13_,attrs12_);
Element elt14_=el(_doc,"c:message");
CustList<Attr> attrs13_=al(1);
attrs13_.add(at("value","msg_effswitchpointview,attract"));
at(elt14_,attrs13_);
ad(elt13_,elt14_);
ad(elt0_,elt13_);
ad(_body,elt0_);
