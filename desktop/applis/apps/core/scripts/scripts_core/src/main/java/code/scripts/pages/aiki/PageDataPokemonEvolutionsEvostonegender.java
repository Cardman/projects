...
final class PageDataPokemonEvolutionsEvostonegender{
...
attrs0_.add(at("c:bean","evo_stonegender"));
at(elt0_,attrs0_);
...
attrs1_.add(at("value","msg_evostonegender,stone_gender"));
at(elt4_,attrs1_);
...
attrs3_.add(at("value","stone"));
at(elt6_,attrs3_);
ad(elt4_,elt6_);
Element elt7_=el(_doc,"param");
CustList<Attr> attrs4_=al(1);
attrs4_.add(at("value","gender"));
at(elt7_,attrs4_);
ad(elt4_,elt7_);
Element elt8_=el(_doc,"param");
CustList<Attr> attrs5_=al(1);
attrs5_.add(at("value","index"));
at(elt8_,attrs5_);
ad(elt4_,elt8_);
ad(elt3_,elt4_);
ad(elt0_,elt3_);
