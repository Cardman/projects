...
final class PageDataPokemonEvolutionsEvoteam{
...
attrs0_.add(at("c:bean","evo_team"));
at(elt0_,attrs0_);
...
attrs1_.add(at("value","msg_evoteam,team"));
at(elt4_,attrs1_);
...
attrs3_.add(at("value","other"));
at(elt6_,attrs3_);
ad(elt4_,elt6_);
Element elt7_=el(_doc,"param");
CustList<Attr> attrs4_=al(1);
attrs4_.add(at("value","index"));
at(elt7_,attrs4_);
ad(elt4_,elt7_);
ad(elt3_,elt4_);
ad(elt0_,elt3_);
