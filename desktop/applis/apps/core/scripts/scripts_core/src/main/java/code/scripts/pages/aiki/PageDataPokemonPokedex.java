...
final class PageDataPokemonPokedex{
...
CustList<Attr> attrs1_=al(1);
attrs1_.add(at("value","msg_pokedex,index"));
at(elt1_,attrs1_);
ad(elt0_,elt1_);
ad(_body,elt0_);
}
...
attrs7_.add(at("value","msg_pokedex,nb_evos"));
at(elt10_,attrs7_);
ad(elt0_,elt10_);
Element elt11_=el(_doc,"input");
CustList<Attr> attrs8_=al(3);
attrs8_.add(at("c:varValue","typedMinNbPossEvos"));
attrs8_.add(at("name","typedMinNbPossEvos"));
attrs8_.add(at("type","text"));
at(elt11_,attrs8_);
ad(elt0_,elt11_);
Element elt12_=el(_doc,"input");
CustList<Attr> attrs9_=al(3);
attrs9_.add(at("c:varValue","typedMaxNbPossEvos"));
attrs9_.add(at("name","typedMaxNbPossEvos"));
...
attrs10_.add(at("value","msg_pokedex,is_evo"));
at(elt14_,attrs10_);
ad(elt0_,elt14_);
Element elt15_=el(_doc,"c:select");
CustList<Attr> attrs11_=al(5);
attrs11_.add(at("default",""));
attrs11_.add(at("map","booleans"));
attrs11_.add(at("name","isEvo"));
attrs11_.add(at("update",""));
attrs11_.add(at("varValue","isEvo"));
at(elt15_,attrs11_);
ad(elt0_,elt15_);
...
attrs12_.add(at("value","msg_pokedex,leg"));
at(elt17_,attrs12_);
ad(elt0_,elt17_);
Element elt18_=el(_doc,"c:select");
CustList<Attr> attrs13_=al(5);
attrs13_.add(at("default",""));
attrs13_.add(at("map","booleans"));
attrs13_.add(at("name","isLeg"));
attrs13_.add(at("update",""));
attrs13_.add(at("varValue","isLeg"));
at(elt18_,attrs13_);
ad(elt0_,elt18_);
...
attrs14_.add(at("type","submit"));
attrs14_.add(at("value","OK"));
at(elt20_,attrs14_);
ad(elt0_,elt20_);
ad(_body,elt0_);
}
