...
at(elt0_,attrs0_);
Element elt1_=el(_doc,C_SUBMIT);
CustList<Attr> attrs1_=al(1);
...
at(elt2_,attrs1_);
Element elt3_=el(_doc,C_SUBMIT);
...
Text txt0_=tx(_doc,C_P_195_42);
ad(elt29_,txt0_);
ad(elt28_,elt29_);
Element elt30_=el(_doc,TD);
Text txt1_=tx(_doc,C_P_195_43);
ad(elt30_,txt1_);
ad(elt28_,elt30_);
Element elt31_=el(_doc,TD);
Element elt32_=el(_doc,C_FOR);
...
at(elt32_,attrs14_);
Text txt2_=tx(_doc,C_P_195_47);
ad(elt32_,txt2_);
ad(elt31_,elt32_);
ad(elt28_,elt31_);
Element elt33_=el(_doc,TD);
Text txt3_=tx(_doc,C_P_195_48);
ad(elt33_,txt3_);
ad(elt28_,elt33_);
...
at(elt35_,attrs15_);
Element elt36_=el(_doc,C_MESSAGE);
...
ad(elt40_,elt41_);
ad(elt39_,elt40_);
Element elt42_=el(_doc,C_IF);
CustList<Attr> attrs21_=al(1);
attrs21_.add(at(CONDITION,C_P_195_55));
at(elt42_,attrs21_);
Element elt43_=el(_doc,C_IF);
...
ad(elt5_,elt26_);
ad(elt4_,elt5_);
Element elt50_=el(_doc,C_SUBMIT);
...
ad(elt51_,elt55_);
Element elt56_=el(_doc,C_MESSAGE);
CustList<Attr> attrs32_=al(1);
attrs32_.add(at(VALUE,C_P_195_78));
at(elt56_,attrs32_);
ad(elt51_,elt56_);
Element elt57_=el(_doc,C_SELECT);
...
ad(elt51_,elt58_);
Element elt59_=el(_doc,C_MESSAGE);
...
at(elt72_,attrs43_);
Text txt5_=tx(_doc,C_P_195_112);
ad(elt72_,txt5_);
