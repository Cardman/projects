...
final class PageDataSimulationEditpokemonmoves extends PageAikiCommon{
...
at(elt4_,attrs3_);
ad(elt0_,elt4_);
Element elt5_=el(_doc,C_SELECT);
...
ad(elt13_,elt16_);
ad(elt0_,elt13_);
Element elt17_=el(_doc,C_SUBMIT);
...
Text txt0_=tx(_doc,C_P_196_53);
ad(elt25_,txt0_);
ad(elt24_,elt25_);
Element elt26_=el(_doc,TD);
Text txt1_=tx(_doc,C_P_196_54);
ad(elt26_,txt1_);
ad(elt24_,elt26_);
...
at(elt28_,attrs11_);
Text txt2_=tx(_doc,C_P_196_58);
ad(elt28_,txt2_);
ad(elt27_,elt28_);
ad(elt24_,elt27_);
Element elt29_=el(_doc,TD);
Text txt3_=tx(_doc,C_P_196_59);
ad(elt29_,txt3_);
ad(elt24_,elt29_);
Element elt30_=el(_doc,TD);
Element elt31_=el(_doc,C_IF);
CustList<Attr> attrs12_=al(1);
...
at(elt38_,attrs18_);
Element elt39_=el(_doc,C_IF);
CustList<Attr> attrs19_=al(1);
attrs19_.add(at(CONDITION,C_P_196_67));
at(elt39_,attrs19_);
Element elt40_=el(_doc,C_MESSAGE);
...
ad(elt1_,elt22_);
ad(elt0_,elt1_);
Element elt46_=el(_doc,C_SUBMIT);
