...
private static final String C_P_198_3="web/css/simulation.css";
...
private static final String C_P_198_17="submit";
private static final String C_P_198_18="OK";
...
ad(elt0_,elt3_);
Element elt4_=el(_doc103,INPUT);
CustList<Attr> attrs3_=al(2);
attrs3_.add(at(TYPE,C_P_198_17));
attrs3_.add(at(VALUE,C_P_198_18));
at(elt4_,attrs3_);
ad(elt0_,elt4_);
ad(_body,elt0_);
}
static void build3(Element _body,Document _doc103){
Element elt0_=el(_doc103,BR);
ad(_body,elt0_);
}
