...
private static final String C_P_203_6="web/html/index.html";
...
Text txt2_=tx(_doc,C_P_203_26);
ad(elt20_,txt2_);
ad(elt17_,elt20_);
Element elt21_=el(_doc,TD);
Text txt3_=tx(_doc,C_P_203_27);
ad(elt21_,txt3_);
ad(elt17_,elt21_);
ad(elt16_,elt17_);
ad(elt15_,elt16_);
