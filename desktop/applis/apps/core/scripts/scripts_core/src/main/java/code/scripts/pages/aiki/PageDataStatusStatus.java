...
final class PageDataStatusStatus{
...
attrs0_.add(at("c:bean","status_set"));
at(elt0_,attrs0_);
Element elt1_=el(_doc,"head");
Element elt2_=el(_doc,"title");
Element elt3_=el(_doc,"c:message");
CustList<Attr> attrs1_=al(1);
attrs1_.add(at("value","msg_statusset,title"));
at(elt3_,attrs1_);
ad(elt2_,elt3_);
ad(elt1_,elt2_);
...
CustList<Attr> attrs1_=al(1);
attrs1_.add(at("value","msg_statusset,index"));
at(elt1_,attrs1_);
ad(elt0_,elt1_);
ad(_body,elt0_);
}
...
Element elt1_=el(_doc,"c:message");
CustList<Attr> attrs1_=al(1);
attrs1_.add(at("value","msg_statusset,content"));
at(elt1_,attrs1_);
ad(elt0_,elt1_);
Element elt2_=el(_doc,"input");
CustList<Attr> attrs2_=al(3);
attrs2_.add(at("c:varValue","typedStatus"));
attrs2_.add(at("name","typedStatus"));
...
CustList<Attr> attrs0_=al(2);
attrs0_.add(at("list","sortedStatus"));
attrs0_.add(at("var","a"));
at(elt1_,attrs0_);
Element elt2_=el(_doc,"li");
Element elt3_=el(_doc,"a");
CustList<Attr> attrs1_=al(2);
attrs1_.add(at("c:command","$clickStatus({([a])})"));
attrs1_.add(at("href",""));
at(elt3_,attrs1_);
Text txt0_=tx(_doc,"{getTrStatus(([a]))}");
ad(elt3_,txt0_);
ad(elt2_,elt3_);
ad(elt1_,elt2_);
ad(elt0_,elt1_);
