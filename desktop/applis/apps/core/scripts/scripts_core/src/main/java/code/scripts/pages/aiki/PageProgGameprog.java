...
final class PageProgGameprog extends PageAikiCommon{
...
private static final String C_P_212_16="web_prog/html/gameprognotatall.html";
private static final String C_P_212_17="msg_prog,titleNotAtAll";
private static final String C_P_212_18="web_prog/html/gameprogpart.html";
private static final String C_P_212_19="msg_prog,titlePart";
private static final String C_P_212_20="web_prog/html/gameprogall.html";
...
at(elt0_,attrs0_);
Element elt1_=el(_doc,C_IMG);
CustList<Attr> attrs1_=al(1);
attrs1_.add(at(SRC,C_P_212_7));
at(elt1_,attrs1_);
ad(elt0_,elt1_);
Text txt0_=tx(_doc,C_P_212_8);
ad(elt0_,txt0_);
...
at(elt2_,attrs2_);
ad(elt0_,elt2_);
Text txt1_=tx(_doc,C_P_212_10);
ad(elt0_,txt1_);
Element elt3_=el(_doc,C_IMG);
...
Text txt0_=tx(_doc,C_P_212_40);
ad(elt12_,txt0_);
ad(elt11_,elt12_);
Element elt13_=el(_doc,TD);
Text txt1_=tx(_doc,C_P_212_41);
ad(elt13_,txt1_);
ad(elt11_,elt13_);
ad(elt10_,elt11_);
ad(elt9_,elt10_);
