...
final class PageProgGameprognotatall{
...
attrs0_.add(at("map","notAtAllFamiliesBase"));
...
attrs4_.add(at("src","{getImagePokemonNotAll(([k]),([l]),([e]))}"));
at(elt10_,attrs4_);
ad(elt9_,elt10_);
Text txt1_=tx(_doc,"{getTrPokemonNotAll(([k]),([l]),([e]))}");
ad(elt9_,txt1_);
