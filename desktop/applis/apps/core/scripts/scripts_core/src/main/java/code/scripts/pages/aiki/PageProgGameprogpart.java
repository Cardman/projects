...
final class PageProgGameprogpart{
...
attrs0_.add(at("map","partialFamiliesBaseNotCaught"));
...
CustList<Attr> attrs1_=al(1);
attrs1_.add(at("value","msg_prog,notCaughtPkCaughtNotPart"));
at(elt6_,attrs1_);
ad(elt5_,elt6_);
ad(elt4_,elt5_);
...
attrs4_.add(at("src","{getImagePokemonPartialNot(([k]),([l]),([e]))}"));
at(elt10_,attrs4_);
ad(elt9_,elt10_);
Text txt1_=tx(_doc,"{getTrPokemonPartialNot(([k]),([l]),([e]))}");
ad(elt9_,txt1_);
...
attrs5_.add(at("value","msg_prog,notCaughtPkCaughtPart"));
at(elt14_,attrs5_);
ad(elt13_,elt14_);
ad(elt12_,elt13_);
Element elt15_=el(_doc,"c:for");
CustList<Attr> attrs6_=al(3);
attrs6_.add(at("className","ls"));
attrs6_.add(at("list","m"));
attrs6_.add(at("var","l"));
at(elt15_,attrs6_);
Element elt16_=el(_doc,"td");
Element elt17_=el(_doc,"c:for");
CustList<Attr> attrs7_=al(2);
attrs7_.add(at("list","getKeyPokemon(([k]),([l]))"));
attrs7_.add(at("var","e"));
at(elt17_,attrs7_);
Element elt18_=el(_doc,"c:img");
CustList<Attr> attrs8_=al(1);
attrs8_.add(at("src","{getImagePokemonPartial(([k]),([l]),([e]))}"));
at(elt18_,attrs8_);
ad(elt17_,elt18_);
Text txt2_=tx(_doc,"{getTrPokemonPartial(([k]),([l]),([e]))}");
ad(elt17_,txt2_);
