...
ad(elt1_,elt26_);
Text txt17_=tx(_doc,"&#160;En cas de r&#233;ussite du contrat pour le preneur, et s''il marque un nombre non entier de points,");
ad(elt1_,txt17_);
Element elt27_=el(_doc,"br");
ad(elt1_,elt27_);
Text txt18_=tx(_doc,"&#160;&#160;alors sa diff&#233;rence est arrondie &#224; l''entier sup&#233;rieur.");
ad(elt1_,txt18_);
Element elt28_=el(_doc,"br");
ad(elt1_,elt28_);
Element elt29_=el(_doc,"br");
ad(elt1_,elt29_);
Text txt19_=tx(_doc,"&#160;En cas d''&#233;chec du contrat pour le preneur, et s''il marque un nombre non entier de points,");
ad(elt1_,txt19_);
Element elt30_=el(_doc,"br");
ad(elt1_,elt30_);
Text txt20_=tx(_doc,"&#160;&#160;alors sa diff&#233;rence est arrondie &#224; l''entier sup&#233;rieur.");
ad(elt1_,txt20_);
