...
Text txt0_=tx(_doc,"La pr&#233;sentation de la fin de partie s''effectue directement sur la fen&#234;tre,");
ad(elt1_,txt0_);
Element elt2_=el(_doc,"br");
ad(elt1_,elt2_);
Text txt1_=tx(_doc,"par un conteneur &#224; onglets, donc pas de bo&#238;te de dialogue.");
ad(elt1_,txt1_);
...
ad(elt1_,elt35_);
Text txt24_=tx(_doc,"Si l''utilisateur a choisi l''option \"Arr&#234;ter\", alors deux cas se pr&#233;sentent:");
ad(elt1_,txt24_);
Element elt36_=el(_doc,"br");
ad(elt1_,elt36_);
Element elt37_=el(_doc,"ol");
Element elt38_=el(_doc,"li");
Text txt25_=tx(_doc,"Si au moins une partie al&#233;atoire a &#233;t&#233; jou&#233;e, alors c''est le menu du jeu correspondant qui appara&#238;t.");
ad(elt38_,txt25_);
ad(elt37_,elt38_);
Element elt39_=el(_doc,"li");
Text txt26_=tx(_doc,"Sinon, c''est le menu principal qui appara&#238;t.");
ad(elt39_,txt26_);
ad(elt37_,elt39_);
ad(elt1_,elt37_);
ad(elt0_,elt1_);
