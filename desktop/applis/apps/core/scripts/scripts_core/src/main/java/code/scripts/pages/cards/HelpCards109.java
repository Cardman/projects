...
ad(elt1_,elt2_);
Text txt1_=tx(_doc,"L''action du sous menu Changer de jeu permet de changer d''\"&#233;tat du logiciel\",");
ad(elt1_,txt1_);
Element elt3_=el(_doc,"br");
ad(elt1_,elt3_);
Text txt2_=tx(_doc,"en revenant au menu de lancement du logiciel par d&#233;faut, c''est &#224; dire celui qui contient");
ad(elt1_,txt2_);
Element elt4_=el(_doc,"br");
ad(elt1_,elt4_);
Text txt3_=tx(_doc,"les noms des jeux.");
ad(elt1_,txt3_);
Element elt5_=el(_doc,"br");
ad(elt1_,elt5_);
Element elt6_=el(_doc,"br");
ad(elt1_,elt6_);
Text txt4_=tx(_doc,"Si une partie est en train d''&#234;tre jou&#233;e, et si la partie ne vient pas d''&#234;tre sauvegard&#233;e, alors");
ad(elt1_,txt4_);
Element elt7_=el(_doc,"br");
ad(elt1_,elt7_);
Text txt5_=tx(_doc,"un message d''avertissement pour la partie en cours appara&#238;t.");
ad(elt1_,txt5_);
...
ad(elt11_,elt14_);
ad(elt1_,elt11_);
Text txt10_=tx(_doc,"Si l''utilisateur a choisi oui, alors une bo&#238;te de dialogue pour sauvegarder appara&#238;t et");
ad(elt1_,txt10_);
Element elt15_=el(_doc,"br");
ad(elt1_,elt15_);
Text txt11_=tx(_doc,"Celui-ci doit donner un nom &#224; la partie en train d''&#234;tre jou&#233;e.");
ad(elt1_,txt11_);
