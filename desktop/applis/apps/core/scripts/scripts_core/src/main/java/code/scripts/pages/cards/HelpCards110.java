...
ad(elt1_,elt2_);
Text txt1_=tx(_doc,"Le sous menu \"Charger une partie\" ouvre une bo&#238;te de dialogue permettant de charger");
ad(elt1_,txt1_);
Element elt3_=el(_doc,"br");
ad(elt1_,elt3_);
Text txt2_=tx(_doc,"n''importe quelle partie depuis cette bo&#238;te.");
ad(elt1_,txt2_);
Element elt4_=el(_doc,"br");
ad(elt1_,elt4_);
Element elt5_=el(_doc,"br");
ad(elt1_,elt5_);
Text txt3_=tx(_doc,"Si une partie est en train d''&#234;tre jou&#233;e, et si la partie ne vient pas d''&#234;tre sauvegard&#233;e, alors");
ad(elt1_,txt3_);
Element elt6_=el(_doc,"br");
ad(elt1_,elt6_);
Text txt4_=tx(_doc,"un message d''avertissement pour la partie en cours appara&#238;t.");
ad(elt1_,txt4_);
...
ad(elt10_,elt13_);
ad(elt1_,elt10_);
Text txt9_=tx(_doc,"Si l''utilisateur a choisi oui, alors une bo&#238;te de dialogue pour sauvegarder appara&#238;t et");
ad(elt1_,txt9_);
Element elt14_=el(_doc,"br");
ad(elt1_,elt14_);
Text txt10_=tx(_doc,"Celui-ci doit donner un nom &#224; la partie en train d''&#234;tre jou&#233;e.");
ad(elt1_,txt10_);
Element elt15_=el(_doc,"br");
ad(elt1_,elt15_);
Element elt16_=el(_doc,"br");
ad(elt1_,elt16_);
Text txt11_=tx(_doc,"Si l''utilisateur a choisi non, alors il y a ouverture d''une bo&#238;te de dialogue de");
ad(elt1_,txt11_);
Element elt17_=el(_doc,"br");
ad(elt1_,elt17_);
Text txt12_=tx(_doc,"chargement.");
ad(elt1_,txt12_);
...
ad(elt1_,elt21_);
Text txt14_=tx(_doc,"L''utilisateur peut alors jouer ou rejouer");
ad(elt1_,txt14_);
Element elt22_=el(_doc,"br");
ad(elt1_,elt22_);
Text txt15_=tx(_doc,"une partie sauvegard&#233;e dans un fichier. De plus, si la partie est &#233;dit&#233;e, il peut");
ad(elt1_,txt15_);
Element elt23_=el(_doc,"br");
ad(elt1_,elt23_);
Text txt16_=tx(_doc,"encha&#238;ner les donnes suivantes s''il a choisi de jouer plusieurs d''affil&#233;.");
ad(elt1_,txt16_);
Element elt24_=el(_doc,"br");
ad(elt1_,elt24_);
Element elt25_=el(_doc,"br");
ad(elt1_,elt25_);
Text txt17_=tx(_doc,"A l''installation de la bo&#238;te de dialogue, le premier dossier ouvert est le dossier \"Sauvegardes\".");
ad(elt1_,txt17_);
...
Text txt24_=tx(_doc,"Si le fichier est accessible en lecture, alors la partie (Que ce soit une simple partie ou un ensemble,");
ad(elt38_,txt24_);
Element elt39_=el(_doc,"br");
ad(elt38_,elt39_);
Text txt25_=tx(_doc,"&#160;&#160;dans le cas o&#249; c''est un ensemble, la partie charg&#233;e est la derni&#232;re jou&#233;e.), contenue dans ce fichier, sera charg&#233;e.");
ad(elt38_,txt25_);
ad(elt37_,elt38_);
Element elt40_=el(_doc,"li");
Text txt26_=tx(_doc,"Sinon un message d''erreur appara&#238;t indiquant l''&#233;chec du chargement.");
ad(elt40_,txt26_);
ad(elt37_,elt40_);
ad(elt1_,elt37_);
