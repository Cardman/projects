...
ad(elt1_,elt3_);
Text txt2_=tx(_doc,"Ce sous menu permet de sauvegarder une partie de cartes en train d''&#234;tre jou&#233;e d&#232;s que possible.");
ad(elt1_,txt2_);
Element elt4_=el(_doc,"br");
ad(elt1_,elt4_);
Text txt4_=tx(_doc,"L''utilisateur peut alors reprendre cette partie apr&#232;s. De plus, s''il encha&#238;ne un \"TriaCartes\", il peut sauvegarder la partie en train d''&#234;tre jou&#233;e.");
ad(elt1_,txt4_);
...
ad(elt1_,elt19_);
Text txt13_=tx(_doc,"L''utilisateur, pour sauvegarder la partie, apr&#232;s avoir entr&#233; un nom, pourra soit cliquer sur le bouton \"Sauvegarder\", soit taper sur la touche \"Entree\".");
ad(elt1_,txt13_);
