...
Text txt0_=tx(_doc,"Tarot raccourci MAJ + T");
ad(elt1_,txt0_);
Element elt2_=el(_doc,"br");
ad(elt1_,elt2_);
Text txt1_=tx(_doc,"L''action du sous menu \"Tarot\" permet de changer les variantes de jeu pour le tarot.");
ad(elt1_,txt1_);
...
ad(elt1_,elt8_);
Text txt5_=tx(_doc,"On change les r&#232;gles du jeu du tarot &#224; partir de la prochaine partie de cartes al&#233;atoire ou d''entra&#238;nement.");
ad(elt1_,txt5_);
Element elt9_=el(_doc,"br");
ad(elt1_,elt9_);
Text txt6_=tx(_doc,"On ne change pas les r&#232;gles du jeu du tarot lors d''un tournoi.");
ad(elt1_,txt6_);
