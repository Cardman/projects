...
ad(elt1_,elt3_);
Text txt1_=tx(_doc,"Pour chaque nombre de joueurs diff&#233;rents (trois, quatre, cinq ou six), il existe trois modes d''entra&#238;nement au tarot:");
ad(elt1_,txt1_);
Element elt4_=el(_doc,"br");
ad(elt1_,elt4_);
Element elt5_=el(_doc,"ol");
Element elt6_=el(_doc,"li");
Text txt2_=tx(_doc,"Petit &#224; chasser");
ad(elt6_,txt2_);
ad(elt5_,elt6_);
Element elt8_=el(_doc,"li");
Text txt3_=tx(_doc,"Petit &#224; sauver");
ad(elt8_,txt3_);
ad(elt5_,elt8_);
...
ad(elt1_,elt10_);
Text txt6_=tx(_doc,"Ceci est programm&#233; par des tirages de Monte - Carlo, c''est - &#224; - dire des tirages de nombres al&#233;atoires.");
ad(elt1_,txt6_);
Element elt11_=el(_doc,"br");
ad(elt1_,elt11_);
Element elt12_=el(_doc,"br");
ad(elt1_,elt12_);
Text txt8_=tx(_doc,"On tire un nombre al&#233;atoire d''atouts suivant une loi bin&#244;miale conditionnelle; pour garder les &#233;v&#233;nements &#233;quiprobables.");
ad(elt1_,txt8_);
