...
ad(elt1_,elt21_);
Text txt13_=tx(_doc,"&#160;If the taker scores 43 points with 2 Oudlers in the tricks, by declaring \"Take\", without declaring handfuls for the 4 players, without slam, by with a misere of trump declared by a defender,");
ad(elt1_,txt13_);
