...
Text txt29_=tx(_doc,"If the taker scores 43,5 points with 2 Oudlers in the tricks, by declaring \"Take\", without declaring handfuls for all players, without slam,");
ad(elt41_,txt29_);
Element elt42_=el(_doc,"br");
ad(elt41_,elt42_);
Text txt30_=tx(_doc,"&#160;&#160;if the taker has a partner,");
ad(elt41_,txt30_);
Element elt43_=el(_doc,"br");
ad(elt41_,elt43_);
Text txt31_=tx(_doc,"&#160;&#160;if none of 4 players has played the Small at the last trick,");
ad(elt41_,txt31_);
Element elt44_=el(_doc,"br");
ad(elt41_,elt44_);
Text txt32_=tx(_doc,"&#160;&#160;then the taker wins the deal by 2 points and scores ((25+(43-41)+0)x1+0+0+0) x 1,5=41 points,");
ad(elt41_,txt32_);
Element elt45_=el(_doc,"br");
ad(elt41_,elt45_);
Text txt33_=tx(_doc,"&#160;&#160;&#160;the called player scores ((25+(43-41)+0)x1+0+0+0) x 0,5=13 points,");
ad(elt41_,txt33_);
Element elt46_=el(_doc,"br");
ad(elt41_,elt46_);
Text txt34_=tx(_doc,"&#160;&#160;&#160;each defender scores ((-25-(43-41)+0)x1+0+0+0)X1=-27 points.");
ad(elt41_,txt34_);
Element elt47_=el(_doc,"br");
ad(elt41_,elt47_);
ad(elt40_,elt41_);
Element elt48_=el(_doc,"li");
Text txt35_=tx(_doc,"If the taker scores 43 points with 1 Oudler in the tricks, by declaring \"Take\", without declaring handfuls for all players, without slam,");
ad(elt48_,txt35_);
Element elt49_=el(_doc,"br");
ad(elt48_,elt49_);
Text txt36_=tx(_doc,"&#160;&#160;if the taker has a partner,");
ad(elt48_,txt36_);
Element elt50_=el(_doc,"br");
ad(elt48_,elt50_);
Text txt37_=tx(_doc,"&#160;&#160;if none of 4 players has played the Small at the last trick,");
ad(elt48_,txt37_);
Element elt51_=el(_doc,"br");
ad(elt48_,elt51_);
Text txt38_=tx(_doc,"&#160;&#160;then the taker looses the deal by 8 points and scores ((-25+(43-51)+0)x1+0+0+0) x 1,5=-50 points,");
ad(elt48_,txt38_);
Element elt52_=el(_doc,"br");
ad(elt48_,elt52_);
Text txt39_=tx(_doc,"&#160;&#160;&#160;the called player scores ((-25+(43-51)+0)x1+0+0+0) x 0,5=-16 points,");
ad(elt48_,txt39_);
Element elt53_=el(_doc,"br");
ad(elt48_,elt53_);
Text txt40_=tx(_doc,"&#160;&#160;&#160;each defender scores ((25-(43-51)+0)x1+0+0+0) x 1=33 points.");
ad(elt48_,txt40_);
Element elt54_=el(_doc,"br");
ad(elt48_,elt54_);
ad(elt40_,elt48_);
Element elt55_=el(_doc,"li");
Text txt41_=tx(_doc,"If the taker scores 43 points with 1 Oudler in the tricks, by declaring \"Take\", without declaring handfuls for all players, without slam,");
ad(elt55_,txt41_);
Element elt56_=el(_doc,"br");
ad(elt55_,elt56_);
Text txt42_=tx(_doc,"&#160;&#160;if none of 4 players has played the Small at the last trick,");
ad(elt55_,txt42_);
Element elt57_=el(_doc,"br");
ad(elt55_,elt57_);
Text txt43_=tx(_doc,"&#160;&#160;if the taker has no partner,");
ad(elt55_,txt43_);
Element elt58_=el(_doc,"br");
ad(elt55_,elt58_);
Text txt44_=tx(_doc,"&#160;&#160;then the taker looses the deal by 8 points and scores ((-25+(43-51)+0)x1+0+0+0)x3=-99 points, and each defender scores ((25-(43-51)+0)x1+0+0+0)X1=33 points.");
ad(elt55_,txt44_);
