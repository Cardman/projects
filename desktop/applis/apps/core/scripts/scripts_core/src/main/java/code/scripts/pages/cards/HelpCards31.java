...
ad(elt1_,elt28_);
Text txt17_=tx(_doc,"&#160;If the taker score a not integer points, then the difference is rounded to the greater integer.");
ad(elt1_,txt17_);
...
ad(elt35_,elt37_);
Text txt22_=tx(_doc,"&#160;&#160;then the taker wins the deal by 3 points and scores ((25+(44-41)+0)x1+0+0+0)x2=56 points, each defender scores ((-25-(44-41)+0)x1+0+0+0)X1=-28 points.");
ad(elt35_,txt22_);
