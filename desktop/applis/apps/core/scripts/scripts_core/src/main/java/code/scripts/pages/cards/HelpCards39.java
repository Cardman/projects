...
ad(elt1_,elt2_);
Text txt1_=tx(_doc,"The sub menu \"Load a deal\" opens a dialog box which lets load");
ad(elt1_,txt1_);
Element elt3_=el(_doc,"br");
ad(elt1_,elt3_);
Text txt2_=tx(_doc,"any deal from this dialog box.");
ad(elt1_,txt2_);
...
ad(elt1_,elt20_);
Text txt13_=tx(_doc,"The user can play or replay");
ad(elt1_,txt13_);
Element elt21_=el(_doc,"br");
ad(elt1_,elt21_);
Text txt14_=tx(_doc,"a saved deal from a file. Besides, if the deal is edited, the user can play");
ad(elt1_,txt14_);
Element elt22_=el(_doc,"br");
ad(elt1_,elt22_);
Text txt15_=tx(_doc,"the next deals if the user has chosen to play several consecutive deals.");
ad(elt1_,txt15_);
...
Text txt22_=tx(_doc,"If the file is readable, then the deal (Either a simple deal or a set of deals,");
ad(elt35_,txt22_);
Element elt36_=el(_doc,"br");
ad(elt35_,elt36_);
Text txt23_=tx(_doc,"&#160;&#160;in the case when it is a set of deals, the loaded deal is the last played deal.), contained in this file, will be loaded.");
ad(elt35_,txt23_);
ad(elt34_,elt35_);
Element elt37_=el(_doc,"li");
Text txt24_=tx(_doc,"Else an error message appears displaying the loading fail.");
ad(elt37_,txt24_);
ad(elt34_,elt37_);
ad(elt1_,elt34_);
