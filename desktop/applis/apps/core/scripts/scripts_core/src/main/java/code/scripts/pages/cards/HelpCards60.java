...
ad(elt1_,elt3_);
Text txt1_=tx(_doc,"There are three training modes at tarot:");
ad(elt1_,txt1_);
...
ad(elt1_,elt11_);
Text txt6_=tx(_doc,"A random number of trump cards is edited following a binomial conditionnal law;");
ad(elt1_,txt6_);
Element elt12_=el(_doc,"br");
ad(elt1_,elt12_);
Text txt7_=tx(_doc,"for keeping the events with the same probability.");
ad(elt1_,txt7_);
