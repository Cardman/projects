...
Text txt0_=tx(_doc,"This software lets play with two card games");
ad(elt1_,txt0_);
Element elt2_=el(_doc,"br");
ad(elt1_,elt2_);
Text txt1_=tx(_doc,"which are belote and tarot and president.");
ad(elt1_,txt1_);
...
ad(elt1_,elt5_);
Text txt3_=tx(_doc,"The software is made for people who like playing cards, do not want download");
ad(elt1_,txt3_);
Element elt6_=el(_doc,"br");
ad(elt1_,elt6_);
Text txt4_=tx(_doc,"card games everywhere on internet, and do not want to pay for playing");
ad(elt1_,txt4_);
Element elt7_=el(_doc,"br");
ad(elt1_,elt7_);
Text txt5_=tx(_doc,"a card game.");
ad(elt1_,txt5_);
