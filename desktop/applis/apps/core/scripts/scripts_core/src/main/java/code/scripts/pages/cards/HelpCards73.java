...
Text txt22_=tx(_doc,"Si le 1er joueur, qui doit parler, passe,");
ad(elt38_,txt22_);
Element elt39_=el(_doc,"br");
ad(elt38_,elt39_);
Text txt23_=tx(_doc,"&#160;si le 2e annonce une petite,");
ad(elt38_,txt23_);
Element elt40_=el(_doc,"br");
ad(elt38_,elt40_);
Text txt24_=tx(_doc,"&#160;alors le 3e ne peut pas demander une petite, mais il peut demander une garde ou un contrat sup&#233;rieur.");
ad(elt38_,txt24_);
ad(elt37_,elt38_);
Element elt41_=el(_doc,"li");
Text txt25_=tx(_doc,"Si le 1er joueur, qui doit parler, passe,");
ad(elt41_,txt25_);
Element elt42_=el(_doc,"br");
ad(elt41_,elt42_);
Text txt26_=tx(_doc,"&#160;si le 2e annonce une petite,");
ad(elt41_,txt26_);
Element elt43_=el(_doc,"br");
ad(elt41_,elt43_);
Text txt27_=tx(_doc,"&#160;si le 3e passe,");
ad(elt41_,txt27_);
Element elt44_=el(_doc,"br");
ad(elt41_,elt44_);
Text txt28_=tx(_doc,"&#160;si le dernier demande une garde sans,");
ad(elt41_,txt28_);
Element elt45_=el(_doc,"br");
ad(elt41_,elt45_);
Text txt29_=tx(_doc,"&#160;alors le preneur est le dernier joueur.");
ad(elt41_,txt29_);
ad(elt37_,elt41_);
Element elt46_=el(_doc,"li");
Text txt30_=tx(_doc,"3. Si 1er joueur, qui doit parler, passe,");
ad(elt46_,txt30_);
Element elt47_=el(_doc,"br");
ad(elt46_,elt47_);
Text txt31_=tx(_doc,"&#160;Si le 2e annonce une garde contre,");
ad(elt46_,txt31_);
Element elt48_=el(_doc,"br");
ad(elt46_,elt48_);
Text txt32_=tx(_doc,"&#160;alors, les deux autres joueurs doivent passer.");
ad(elt46_,txt32_);
ad(elt37_,elt46_);
ad(elt1_,elt37_);
