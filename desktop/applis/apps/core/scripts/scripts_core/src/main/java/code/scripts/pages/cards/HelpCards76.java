...
Text txt10_=tx(_doc,"Si le joueur ne poss&#232;de pas de l''atout,");
ad(elt20_,txt10_);
Element elt21_=el(_doc,"br");
ad(elt20_,elt21_);
Text txt11_=tx(_doc,"il joue la carte de son choix.");
ad(elt20_,txt11_);
ad(elt19_,elt20_);
Element elt22_=el(_doc,"li");
Text txt12_=tx(_doc,"Sinon si ce dernier peut monter &agrave; l''atout (jouer un atout sup&eacute;rieur),");
ad(elt22_,txt12_);
Element elt23_=el(_doc,"br");
ad(elt22_,elt23_);
Text txt13_=tx(_doc,"alors il doir monter,");
ad(elt22_,txt13_);
Element elt24_=el(_doc,"br");
ad(elt22_,elt24_);
ad(elt19_,elt22_);
Element elt25_=el(_doc,"li");
Text txt14_=tx(_doc,"sinon, il doit fournier un atout,");
ad(elt25_,txt14_);
Element elt26_=el(_doc,"br");
ad(elt25_,elt26_);
ad(elt19_,elt25_);
Element elt27_=el(_doc,"li");
Text txt15_=tx(_doc,"sinon il joue la carte de son choix.");
ad(elt27_,txt15_);
...
Text txt16_=tx(_doc,"Si la couleur demand&#233;e n''est pas atout,");
ad(elt29_,txt16_);
Element elt30_=el(_doc,"br");
ad(elt29_,elt30_);
Element elt31_=el(_doc,"ol");
Element elt32_=el(_doc,"li");
Text txt17_=tx(_doc,"Si le joueur poss&#232;de des cartes de m&#234;me couleur que celle de la carte entam&#233;e,");
ad(elt32_,txt17_);
Element elt33_=el(_doc,"br");
ad(elt32_,elt33_);
Text txt18_=tx(_doc,"alors celui-ci doit fournir &#224; la couleur sans &#234;tre oblig&#233; de monter.");
ad(elt32_,txt18_);
Element elt34_=el(_doc,"br");
ad(elt32_,elt34_);
ad(elt31_,elt32_);
Element elt35_=el(_doc,"li");
Text txt19_=tx(_doc,"Sinon, si son partenaire est ma&#238;tre,");
ad(elt35_,txt19_);
Element elt36_=el(_doc,"br");
ad(elt35_,elt36_);
Text txt20_=tx(_doc,"alors il joue la carte de son choix.");
ad(elt35_,txt20_);
Element elt37_=el(_doc,"br");
ad(elt35_,elt37_);
ad(elt31_,elt35_);
Element elt38_=el(_doc,"li");
Text txt21_=tx(_doc,"Sinon si le joueur ne poss&#232;de pas d''atout, il joue la carte de son choix.");
ad(elt38_,txt21_);
Element elt39_=el(_doc,"br");
ad(elt38_,elt39_);
ad(elt31_,elt38_);
Element elt40_=el(_doc,"li");
Text txt22_=tx(_doc,"Sinon si le pli n''est pas coup&#233;,");
ad(elt40_,txt22_);
Element elt41_=el(_doc,"br");
ad(elt40_,elt41_);
Text txt23_=tx(_doc,"alors il doit utiliser un atout de son choix (le joueur coupe).");
ad(elt40_,txt23_);
Element elt42_=el(_doc,"br");
ad(elt40_,elt42_);
ad(elt31_,elt40_);
Element elt43_=el(_doc,"li");
Text txt24_=tx(_doc,"Sinon si le joueur peut monter sur le maximum des atouts jou&#233;s,");
ad(elt43_,txt24_);
Element elt44_=el(_doc,"br");
ad(elt43_,elt44_);
Text txt25_=tx(_doc,"alors il doit utiliser un atout et monter sur les atouts pr&#233;c&#233;dents, (le joueur sur-coupe).");
ad(elt43_,txt25_);
Element elt45_=el(_doc,"br");
ad(elt43_,elt45_);
ad(elt31_,elt43_);
Element elt46_=el(_doc,"li");
Text txt26_=tx(_doc,"Sinon il joue la carte de son choix.");
ad(elt46_,txt26_);
