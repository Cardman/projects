...
ad(elt1_,elt2_);
Text txt0_=tx(_doc,"L''ordre des cartes est:");
ad(elt1_,txt0_);
Element elt3_=el(_doc,"br");
ad(elt1_,elt3_);
Text txt1_=tx(_doc,"2-As-Roi-Dame-Valet-10-9-8-7-6-5-4-3");
ad(elt1_,txt1_);
Element elt4_=el(_doc,"br");
ad(elt1_,elt4_);
Text txt2_=tx(_doc,"Ordre des cartes:");
ad(elt1_,txt2_);
