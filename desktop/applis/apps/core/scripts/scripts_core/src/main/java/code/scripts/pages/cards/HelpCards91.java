...
ad(elt1_,elt3_);
Text txt1_=tx(_doc,"Chaque joueur annonce un contrat, dans le sens contraire des aiguilles d''une montre, en commen&#231;ant par le joueur plac&#233;, &#224; droite du donneur.");
ad(elt1_,txt1_);
Element elt4_=el(_doc,"br");
ad(elt1_,elt4_);
Text txt3_=tx(_doc,"Un joueur doit soit passer, soit annoncer un contrat sup&#233;rieur aux pr&#233;c&#233;dents. Chaque joueur doit annoncer une fois seulement.");
ad(elt1_,txt3_);
