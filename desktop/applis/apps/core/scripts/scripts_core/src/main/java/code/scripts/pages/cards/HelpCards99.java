...
ad(elt1_,elt22_);
Text txt13_=tx(_doc,"&#160;Si le preneur marque 43 points avec 2 Bouts dans ses plis, en demandant une petite, sans annonces de poign&#233;e pour les 4 joueurs, ni de chelem,");
ad(elt1_,txt13_);
Element elt23_=el(_doc,"br");
ad(elt1_,elt23_);
Text txt14_=tx(_doc,"&#160;&#160;mais avec une mis&#232;re d''atout en d&#233;fense,");
ad(elt1_,txt14_);
