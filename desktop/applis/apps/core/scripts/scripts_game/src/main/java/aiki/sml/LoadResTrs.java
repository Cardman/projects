...
public final class LoadResTrs {
    ...
    public static void loadResources(DataBase _d) {
        ...
        for (String l : _d.getLanguages()) {
            IdMap<Gender, String> genders_ = trGenders(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_GENDERS));
            _d.getTranslatedGenders().addEntry(l, genders_);
            IdMap<SelectedBoolean, String> booleans_ = trBooleans(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_BOOLEANS));
            _d.getTranslatedBooleans().addEntry(l, booleans_);
            IdMap<DifficultyWinPointsFight, String> diffWinPts_ = trDiffWinPts(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_DIFF_WIN_PTS));
            _d.getTranslatedDiffWinPts().addEntry(l, diffWinPts_);
            IdMap<DifficultyModelLaw, String> diffLaw_ = trDiffLaw(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_DIFF_MODEL_LAW));
            _d.getTranslatedDiffModelLaw().addEntry(l, diffLaw_);
            IdMap<EnvironmentType, String> environments_ = trEnv(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_ENVIRONMENTS));
            _d.getTranslatedEnvironment().addEntry(l, environments_);
            IdMap<Statistic, String> statistics_ = trStat(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_STATISTICS));
            _d.getTranslatedStatistics().addEntry(l, statistics_);
            IdMap<TargetChoice, String> targets_ = trTargets(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_TARGETS));
            _d.getTranslatedTargets().addEntry(l, targets_);
            StringMap<String> categories_ = tr(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_CATEGORIES));
            _d.getTranslatedCategories().addEntry(l, categories_);
            StringMap<String> types_ = tr(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_TYPES));
            _d.getTranslatedTypes().addEntry(l, types_);
            StringMap<String> pokemon_ = tr(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_POKEMON));
            _d.getTranslatedPokemon().addEntry(l, pokemon_);
            StringMap<String> moves_ = tr(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_MOVES));
            _d.getTranslatedMoves().addEntry(l, moves_);
            StringMap<String> items_ = tr(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_ITEMS));
            _d.getTranslatedItems().addEntry(l, items_);
            StringMap<String> abilities_ = tr(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_ABILITIES));
            _d.getTranslatedAbilities().addEntry(l, abilities_);
            StringMap<String> status_ = tr(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_STATUS));
            _d.getTranslatedStatus().addEntry(l, status_);
            StringMap<String> fctsMath_ = tr(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_MATH));
            _d.getTranslatedFctMath().addEntry(l, fctsMath_);
            StringMap<String> descrClasses_ = tr(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_CLASSES));
            _d.getTranslatedClassesDescriptions().addEntry(l, descrClasses_);
            StringMap<String> litteral_ = trLitt(trs_.getVal(l + DataBase.SEPARATOR_FILES + TRANSLATION_LITTERAL));
