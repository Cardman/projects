...
m136abilityData_.setMultPower(LP+R_5_4+OM+A_CARACFERME+LP+A_ABS+LP+V_CIBLE_GENRE+OD+V_LANCEUR_GENRE+RP+OC+R_1+OC+R_1+RP+OP+R_3_4+OM+A_CARACFERME+LP+V_CIBLE_GENRE+OD+V_LANCEUR_GENRE+OC+R_0+OC+R_0+RP+RP+OM+A_CARACFERME+LP+V_CIBLE_GENRE+OC+R_0+OC+R_1+RP+OM+A_CARACFERME+LP+V_LANCEUR_GENRE+OC+R_0+OC+R_1+RP);
