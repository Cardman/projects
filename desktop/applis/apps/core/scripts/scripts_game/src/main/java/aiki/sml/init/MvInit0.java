...
EnumMap<Statistic,Byte> m549enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m549enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m551enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m552enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m552enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m554enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(7));
...
EnumMap<Statistic,Byte> m558enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m559enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(2));
...
EnumMap<Statistic,Byte> m561enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m566enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m567enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumList<Statistic> m571enumListStatistic_=new EnumList<Statistic>(new CollCapacity(1));
m571enumListStatistic_.add(Statistic.EVASINESS);
m571effectTeam_.setForbiddenBoost(m571enumListStatistic_);
m571enumListStatistic_=new EnumList<Statistic>(new CollCapacity(1));
m571enumListStatistic_.add(Statistic.EVASINESS);
