...
EnumMap<Statistic,Byte> m576enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(2));
...
EnumMap<Statistic,Byte> m580enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m584enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(5));
...
EnumMap<Statistic,String> m584enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(4));
...
EnumList<Statistic> m588enumListStatistic_=new EnumList<Statistic>(new CollCapacity(1));
...
EnumList<Statistic> m596enumListStatistic_=new EnumList<Statistic>(new CollCapacity(7));
...
EnumMap<Statistic,String> m597enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m599enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
m599enumMapStatisticByte_.addEntry(Statistic.SPEED,(byte)-1);
m599effectStatistic_.setStatisVarRank(m599enumMapStatisticByte_);
EnumMap<Statistic,String> m599enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
