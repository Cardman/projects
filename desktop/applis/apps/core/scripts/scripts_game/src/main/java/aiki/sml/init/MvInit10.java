...
EnumMap<Statistic,Byte> m603enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m603enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m611enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m611enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m612enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m617enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m617enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
m617enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
m617enumMapStatisticByte_.addEntry(Statistic.ACCURACY,(byte)-1);
m617effectStatistic_.setStatisVarRank(m617enumMapStatisticByte_);
m617enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
m617enumMapStatisticString_.addEntry(Statistic.ACCURACY,V_CIBLE_CLONE+GT+R_0);
m617effectStatistic_.setLocalFailStatis(m617enumMapStatisticString_);
m617effectStatistic_.setEvtRate(Rate.newRate(R_1));
m617effectStatistic_.setTargetChoice(TargetChoice.ADJ_UNIQ);
...
EnumMap<Statistic,Byte> m619enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(2));
...
EnumMap<EnvironmentType,String> m620enumMapEnvironmentTypeString_=new EnumMap<EnvironmentType,String>(new CollCapacity(8));
