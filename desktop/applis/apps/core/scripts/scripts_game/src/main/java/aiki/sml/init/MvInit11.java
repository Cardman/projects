...
EnumMap<Statistic,Byte> m629enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m633enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m633enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m635enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m638enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(3));
...
EnumMap<Statistic,Byte> m644enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(2));
...
EnumMap<Statistic,Byte> m649enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m651enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
m651enumMapStatisticByte_.addEntry(Statistic.SPEED,(byte)-2);
m651effectStatistic_.setStatisVarRank(m651enumMapStatisticByte_);
EnumMap<Statistic,String> m651enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m652enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m652enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
