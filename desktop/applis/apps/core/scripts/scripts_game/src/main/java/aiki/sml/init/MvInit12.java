...
IdMap<Statistic,Integer> m656enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m656enumMapStatisticByte_.addEntry(Statistic.ATTACK,1);
...
IdMap<Statistic,Integer> m657enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m657enumMapStatisticByte_.addEntry(Statistic.DEFENSE,-1);
...
IdMap<Statistic,Integer> m663enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m663enumMapStatisticByte_.addEntry(Statistic.SPEED,2);
...
IdMap<Statistic,Integer> m678enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m678enumMapStatisticByte_.addEntry(Statistic.ACCURACY,-1);
