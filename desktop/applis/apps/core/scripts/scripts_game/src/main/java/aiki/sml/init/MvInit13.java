...
IdMap<Statistic,Integer> m701enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m701enumMapStatisticByte_.addEntry(Statistic.EVASINESS,1);
...
IdMap<Statistic,Integer> m703enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m703enumMapStatisticByte_.addEntry(Statistic.SPECIAL_DEFENSE,-1);
...
IdMap<Statistic,Integer> m704enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m704enumMapStatisticByte_.addEntry(Statistic.SPECIAL_ATTACK,2);
...
IdMap<Statistic,Integer> m705enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m705enumMapStatisticByte_.addEntry(Statistic.SPECIAL_DEFENSE,-1);
