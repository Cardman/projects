...
IdMap<Statistic,Byte> m776enumMapStatisticByte_=new IdMap<Statistic,Byte>(new CollCapacity(1));
...
IdMap<Statistic,Byte> m787enumMapStatisticByte_=new IdMap<Statistic,Byte>(new CollCapacity(3));
...
IdMap<Statistic,Byte> m788enumMapStatisticByte_=new IdMap<Statistic,Byte>(new CollCapacity(1));
