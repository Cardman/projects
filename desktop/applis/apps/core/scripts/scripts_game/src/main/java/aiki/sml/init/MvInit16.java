...
IdMap<Statistic,Integer> m776enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m776enumMapStatisticByte_.addEntry(Statistic.ACCURACY,-1);
...
IntMap<String> m782shortMapString_=new IntMap<String>(new CollCapacity(4));
m782shortMapString_.addEntry(1,I_SIMPLE_POISON);
m782shortMapString_.addEntry(2,I_POISON_GRAVE);
...
IdMap<Statistic,Integer> m787enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(3));
m787enumMapStatisticByte_.addEntry(Statistic.ATTACK,-1);
m787enumMapStatisticByte_.addEntry(Statistic.SPECIAL_ATTACK,-1);
m787enumMapStatisticByte_.addEntry(Statistic.SPEED,-1);
...
IdMap<Statistic,Integer> m788enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m788enumMapStatisticByte_.addEntry(Statistic.SPEED,-1);
