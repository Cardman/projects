...
IdMap<Statistic,Integer> m800enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(2));
m800enumMapStatisticByte_.addEntry(Statistic.SPECIAL_ATTACK,1);
m800enumMapStatisticByte_.addEntry(Statistic.SPECIAL_DEFENSE,1);
...
IdMap<Statistic,Integer> m804enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m804enumMapStatisticByte_.addEntry(Statistic.ATTACK,1);
...
IdMap<Statistic,Integer> m810enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m810enumMapStatisticByte_.addEntry(Statistic.ATTACK,1);
...
IdMap<Statistic,Integer> m813enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m813enumMapStatisticByte_.addEntry(Statistic.SPEED,2);
