...
EnumMap<Statistic,Byte> m908enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m908enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m915enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
m915enumMapStatisticByte_.addEntry(Statistic.SPEED,(byte)-1);
m915effectStatistic_.setStatisVarRank(m915enumMapStatisticByte_);
EnumMap<Statistic,String> m915enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m916enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m916enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
