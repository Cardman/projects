...
IdMap<Statistic,Integer> m908enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m908enumMapStatisticByte_.addEntry(Statistic.ATTACK,-1);
...
IdMap<Statistic,Integer> m915enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m915enumMapStatisticByte_.addEntry(Statistic.SPEED,-1);
...
IdMap<Statistic,Integer> m916enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m916enumMapStatisticByte_.addEntry(Statistic.SPECIAL_ATTACK,-2);
