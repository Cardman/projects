...
IdMap<Statistic,Integer> m928enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(2));
m928enumMapStatisticByte_.addEntry(Statistic.ATTACK,-1);
m928enumMapStatisticByte_.addEntry(Statistic.SPECIAL_ATTACK,-1);
...
IdMap<Statistic,Integer> m931enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m931enumMapStatisticByte_.addEntry(Statistic.SPEED,-2);
...
IdMap<Statistic,Integer> m934enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(2));
m934enumMapStatisticByte_.addEntry(Statistic.SPECIAL_DEFENSE,1);
m934enumMapStatisticByte_.addEntry(Statistic.DEFENSE,1);
...
IdMap<Statistic,Integer> m936enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m936enumMapStatisticByte_.addEntry(Statistic.SPECIAL_DEFENSE,-2);
...
IdMap<Statistic,Integer> m938enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m938enumMapStatisticByte_.addEntry(Statistic.SPECIAL_ATTACK,-2);
...
IdMap<Statistic,Integer> m940enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(2));
m940enumMapStatisticByte_.addEntry(Statistic.ATTACK,-1);
m940enumMapStatisticByte_.addEntry(Statistic.DEFENSE,-1);
...
IdMap<Statistic,Integer> m941enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m941enumMapStatisticByte_.addEntry(Statistic.SPECIAL_ATTACK,-1);
...
IdMap<Statistic,Integer> m949enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m949enumMapStatisticByte_.addEntry(Statistic.ACCURACY,-1);
