...
EnumList<Statistic> m986enumListStatistic_=new EnumList<Statistic>(new CollCapacity(1));
m986enumListStatistic_.add(Statistic.EVASINESS);
m986effectDamage_.setIgnVarStatTargetPos(m986enumListStatistic_);
m986enumListStatistic_=new EnumList<Statistic>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m1000enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m1004enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(5));
