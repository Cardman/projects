...
IdMap<Statistic,Integer> m1000enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(1));
m1000enumMapStatisticByte_.addEntry(Statistic.ATTACK,2);
...
IdMap<Statistic,Integer> m1004enumMapStatisticByte_=new IdMap<Statistic,Integer>(new CollCapacity(5));
m1004enumMapStatisticByte_.addEntry(Statistic.ATTACK,1);
m1004enumMapStatisticByte_.addEntry(Statistic.SPECIAL_ATTACK,1);
m1004enumMapStatisticByte_.addEntry(Statistic.SPECIAL_DEFENSE,1);
m1004enumMapStatisticByte_.addEntry(Statistic.DEFENSE,1);
m1004enumMapStatisticByte_.addEntry(Statistic.SPEED,1);
