...
IdMap<Statistic,Byte> m1009enumMapStatisticByte_=new IdMap<Statistic,Byte>(new CollCapacity(1));
...
IdMap<Statistic,Byte> m1010enumMapStatisticByte_=new IdMap<Statistic,Byte>(new CollCapacity(5));
...
IdMap<Statistic,Byte> m1028enumMapStatisticByte_=new IdMap<Statistic,Byte>(new CollCapacity(1));
