...
EnumMap<Statistic,Byte> m1064enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m1067enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m1067enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m1069enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(2));
...
EnumMap<Statistic,String> m1069enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(2));
...
EnumMap<Statistic,Byte> m1070enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(2));
...
EnumMap<Statistic,Byte> m1079enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(2));
...
EnumMap<Statistic,String> m1079enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(2));
...
EnumMap<Statistic,Byte> m1081enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m1084enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m1084enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
...
EnumMap<Statistic,Byte> m1085enumMapStatisticByte_=new EnumMap<Statistic,Byte>(new CollCapacity(1));
...
EnumMap<Statistic,String> m1085enumMapStatisticString_=new EnumMap<Statistic,String>(new CollCapacity(1));
