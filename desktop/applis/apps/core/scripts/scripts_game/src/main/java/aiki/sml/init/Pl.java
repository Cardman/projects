...
m2002pokemonCenter_.setExitCity(new Point(5,9));
m2002objectMapPointBuilding_.addEntry(new Point(6,7),m2002pokemonCenter_);
Gym m2002gym_ = Instances.newGym();
m2002gym_.setLevel(Lv.p0());
m2002gym_.setImageFileName(F_BUILDING_INSIDE_LINK_TXT);
m2002gym_.setExitCity(new Point(5,9));
m2002objectMapPointBuilding_.addEntry(new Point(18,8),m2002gym_);
...
m2002objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(25,9),Direction.RIGHT),LvUt.newCoords(9,0,new Point(0,4)));
m2002objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(9,0),Direction.UP),LvUt.newCoords(1,0,new Point(4,11)));
m2002objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(0,9),Direction.LEFT),LvUt.newCoords(11,0,new Point(11,4)));
...
m2003objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(4,11),Direction.DOWN),LvUt.newCoords(0,0,new Point(9,0)));
m2003objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(4,0),Direction.UP),LvUt.newCoords(2,0,new Point(9,18)));
...
m2004gym_.setExitCity(new Point(5,9));
m2004objectMapPointBuilding_.addEntry(new Point(18,8),m2004gym_);
...
m2004pokemonCenter_.setExitCity(new Point(5,9));
m2004objectMapPointBuilding_.addEntry(new Point(6,7),m2004pokemonCenter_);
...
m2004objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(25,9),Direction.RIGHT),LvUt.newCoords(3,0,new Point(0,4)));
m2004objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(9,18),Direction.DOWN),LvUt.newCoords(1,0,new Point(4,0)));
...
m2005objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(11,4),Direction.RIGHT),LvUt.newCoords(4,0,new Point(0,9)));
m2005objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(0,4),Direction.LEFT),LvUt.newCoords(2,0,new Point(25,9)));
...
m2006pokemonCenter_.setExitCity(new Point(5,9));
m2006objectMapPointBuilding_.addEntry(new Point(6,7),m2006pokemonCenter_);
Gym m2006gym_ = Instances.newGym();
m2006gym_.setLevel(Lv.p4());
m2006gym_.setImageFileName(F_BUILDING_INSIDE_LINK_TXT);
m2006gym_.setExitCity(new Point(5,9));
m2006objectMapPointBuilding_.addEntry(new Point(18,8),m2006gym_);
...
m2006objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(9,18),Direction.DOWN),LvUt.newCoords(5,0,new Point(4,0)));
m2006objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(0,9),Direction.LEFT),LvUt.newCoords(3,0,new Point(11,4)));
...
m2007objectMapPointLink_.addEntry(new Point(7,6),LvUt.newLink(F_LINK_OUTSIDE_TXT,LvUt.newCoords(6,0,new Point(6,4))));
...
m2007objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(4,0),Direction.UP),LvUt.newCoords(4,0,new Point(9,18)));
...
m2008objectMapLevelPointLink_.addEntry(LvUt.newLevelPoint(0,new Point(6,23)),LvUt.newLink(F_LINK_INSIDE_TXT,LvUt.newCoords(7,0,new Point(6,3))));
m2008objectMapLevelPointLink_.addEntry(LvUt.newLevelPoint(0,new Point(6,4)),LvUt.newLink(F_LINK_INSIDE_TXT,LvUt.newCoords(5,0,new Point(7,6))));
...
m2009objectMapPointLink_.addEntry(new Point(6,3),LvUt.newLink(F_LINK_OUTSIDE_2_TXT,LvUt.newCoords(6,0,new Point(6,23))));
...
m2009objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(4,9),Direction.DOWN),LvUt.newCoords(8,0,new Point(9,0)));
...
m2010pokemonCenter_.setExitCity(new Point(5,9));
m2010objectMapPointBuilding_.addEntry(new Point(6,7),m2010pokemonCenter_);
...
m2010objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(9,0),Direction.UP),LvUt.newCoords(7,0,new Point(4,9)));
m2010objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(0,9),Direction.LEFT),LvUt.newCoords(9,0,new Point(11,4)));
...
m2011objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(11,4),Direction.RIGHT),LvUt.newCoords(8,0,new Point(0,9)));
m2011objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(0,4),Direction.LEFT),LvUt.newCoords(0,0,new Point(25,9)));
...
m2012league_.setAccessCoords(LvUt.newCoords(9,0,new Point(7,7)));
m2012league_.setFileName(F_LINK_LEAGUE_LEVELS_TXT);
m2012league_.setBegin(new Point(4,0));
return m2012league_;
}
...
m2013objectMapPlaceInterConnectCoords_.addEntry(new PlaceInterConnect(new Point(11,4),Direction.RIGHT),LvUt.newCoords(0,0,new Point(0,9)));
