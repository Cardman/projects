...
f.addEntry("DAMAGE_FORMULA",MbOperationNode.DIV_FCT+"((5+"+DataBase.VAR_DEF+DataBase.SEP_BETWEEN_KEYS+"LANCEUR_NIVEAU),125)*"+DataBase.VAR_DEF+DataBase.SEP_BETWEEN_KEYS+"POWER*"+MbOperationNode.DIV_FCT+"("+DataBase.VAR_DEF+DataBase.SEP_BETWEEN_KEYS+"ATTACK,"+DataBase.VAR_DEF+DataBase.SEP_BETWEEN_KEYS+"DEFENSE)");
