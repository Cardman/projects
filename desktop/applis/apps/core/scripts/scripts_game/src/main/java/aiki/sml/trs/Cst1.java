...
f.addEntry("DAMAGE_FORMULA",MbOperationNode.DIV_FCT+"((5+"+DataBase.VAR_DEF+DataBase.SEP_BETWEEN_KEYS+DataBase.DEF_LANCEUR_NIVEAU+"),125)*"+DataBase.VAR_DEF+DataBase.SEP_BETWEEN_KEYS+DataBase.DEF_POWER+"*"+MbOperationNode.DIV_FCT+"("+DataBase.VAR_DEF+DataBase.SEP_BETWEEN_KEYS+DataBase.DEF_ATTACK+","+DataBase.VAR_DEF+DataBase.SEP_BETWEEN_KEYS+DataBase.DEF_DEFENSE+")");
f.addEntry("BALL_DEF","POKE_BALL");
f.addEntry("DEFAULT_EGG_GROUP",DataBase.DEFAULT_EGG_GROUP_VALUE);
