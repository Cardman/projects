...
static final String VAR_LEVEL_LOOSER=DataBase.VAR_DEF+DataBase.SEP_BETWEEN_KEYS+"LEVEL_LOOSER";
static final String VAR_LEVEL_WINNER=DataBase.VAR_DEF+DataBase.SEP_BETWEEN_KEYS+"LEVEL_WINNER";
private Cst5(){}
