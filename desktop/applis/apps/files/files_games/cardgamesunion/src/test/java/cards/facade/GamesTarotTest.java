...
public final class GamesTarotTest extends EquallableCardsFileUtil {
    ...
    public void autoriseMessEcartDe1() {
        ...
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseMessEcartDe(t_,ReasonDiscard.NOTHING,CardTarot.TRUMP_21,"en")).isEmpty());
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseMessEcartDe(t_,ReasonDiscard.NOTHING,CardTarot.TRUMP_21,"fr")).isEmpty());
    }
    @Test
    public void autoriseMessEcartDe2() {
        GameTarot t_ = init();
        t_.setPreneur((byte) 0);
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseMessEcartDe(t_,ReasonDiscard.NOTHING,CardTarot.HEART_KING,"en")).isEmpty());
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseMessEcartDe(t_,ReasonDiscard.NOTHING,CardTarot.HEART_KING,"fr")).isEmpty());
    }
    @Test
    ...
    public void autoriseMessEcartDe5() {
        ...
        t_.getDeal().derniereMain().ajouter(CardTarot.HEART_2);
        t_.getDeal().derniereMain().ajouter(CardTarot.HEART_3);
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseMessEcartDe(t_,ReasonDiscard.NOTHING,CardTarot.TRUMP_20,"en")).isEmpty());
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseMessEcartDe(t_,ReasonDiscard.NOTHING,CardTarot.TRUMP_20,"fr")).isEmpty());
    }
    @Test
    public void autoriseMessEcartDe6() {
        ...
        t_.getDeal().derniereMain().ajouter(CardTarot.HEART_2);
        t_.getDeal().derniereMain().ajouter(CardTarot.HEART_3);
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseMessEcartDe(t_,ReasonDiscard.NOTHING,CardTarot.TRUMP_1,"en")).isEmpty());
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseMessEcartDe(t_,ReasonDiscard.NOTHING,CardTarot.TRUMP_1,"fr")).isEmpty());
    }
    @Test
    public void autoriseMessEcartDe7() {
        GameTarot t_ = init();
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseMessEcartDe(t_,ReasonDiscard.TOO_MUCH,CardTarot.TRUMP_1,"en")).isEmpty());
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseMessEcartDe(t_,ReasonDiscard.TOO_MUCH,CardTarot.TRUMP_1,"fr")).isEmpty());
    }
    @Test
    ...
    public void autoriseTarot1() {
        ...
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseTarot(t_,"en")).isEmpty());
        assertFalse(StringUtil.nullToEmpty(" "+ Games.autoriseTarot(t_,"fr")).isEmpty());
    }
    @Test
