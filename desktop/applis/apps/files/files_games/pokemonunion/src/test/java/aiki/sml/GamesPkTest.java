...
public final class GamesPkTest extends EquallablePkFileUtil {
    ...
    public void t13() {
        ...
        assertFalse(GamesPk.getSoftParamsContentTr(GamesPk.getAppliTr(en_)).getMapping().isEmpty());
        ...
        assertFalse(GamesPk.getPaginatorHealItContentTr(GamesPk.getAppliTr(en_)).getMapping().isEmpty());
        ...
        assertFalse(GamesPk.getSoftParamsContentTr(GamesPk.getAppliTr(fr_)).getMapping().isEmpty());
        ...
        assertFalse(GamesPk.getPaginatorHealItContentTr(GamesPk.getAppliTr(fr_)).getMapping().isEmpty());
