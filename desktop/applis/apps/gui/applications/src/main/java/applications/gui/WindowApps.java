...
public final class WindowApps extends GroupFrame {
    ...
    public WindowApps(String _lg, AbstractProgramInfos _list, CardFactories _cardFactories, AikiFactory _aikiFactory, GuiFactroy _guiFact) {
        ...
        AbsPanel linePokemon_ = Panel.newLineBox();
        ...
        AbsPanel lineCards_ = Panel.newLineBox();
        ...
        AbsPanel lineTests_ = Panel.newLineBox();
        ...
        AbsPanel lineRenders_ = Panel.newLineBox();
        ...
        AbsPanel lineDemo_ = Panel.newLineBox();
        ...
        AbsPanel linePlayer_ = Panel.newLineBox();
        ...
        AbsPanel lineConverter_ = Panel.newLineBox();
        ...
        AbsPanel lineApp_ = Panel.newLineBox();
