...
//        checkNoAnim(_g);
    ...
    private LaunchingApplications la(MockProgramInfos _p) {
        ...
        return new LaunchingApplications(new WithAppFactories(_p, new AppFactories(new AikiFactory(_p, new MockBaseExecutorServiceParam<DataBase>()), new CardFactories(_p, new MockBaseExecutorServiceParam<HelpIndexesTree>()), new CdmFactory(_p, new MockInterceptor()), TEMP_FOLDER)));
    }
