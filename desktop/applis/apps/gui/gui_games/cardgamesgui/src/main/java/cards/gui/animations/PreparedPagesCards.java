...
public final class PreparedPagesCards extends AbstractPreparedPagesCards {
    ...
    public PreparedPagesCards(BeanNatCommonLgNames _stds, AbstractNativeInit _init, StringMap<Document> _built, StringMap<String> _other, StringList _lgs) {
        super(_stds, _built, _lgs);
        init = _init;
        other = _other;
    }
    @Override
