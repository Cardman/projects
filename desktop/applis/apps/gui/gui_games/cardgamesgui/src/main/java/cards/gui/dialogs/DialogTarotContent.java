...
public final class DialogTarotContent implements DialogVaryingPlayerNumber,DialogVaryingDealing,DialogVaryingHandful{
    ...
    public DialogTarotContent(AbstractProgramInfos _fr) {
        frames = _fr;
    }
    ...
    public AbsTabbedPane initJt(AbsSpinner _nbGames, boolean _enabledChangingNbPlayers, int _nbPlayers, WindowCardsInt _window) {
        ...
        listeChoix=DialogHelpCards.build(_window,getReglesTarot().getCommon().getMixedCards());
...
//        }
    ...
    public void validateHandfulTrumps() {
        ...
        getValidateButton().setEnabled(RulesTarot.sortedHandfuls(poigneesAutorisees));
    }
