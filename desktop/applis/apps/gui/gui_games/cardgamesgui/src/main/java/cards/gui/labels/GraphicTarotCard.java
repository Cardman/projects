...
public final class GraphicTarotCard extends AbsMetaLabelCard {
    ...
    public GraphicTarotCard(AbstractImageFactory _fact, String _lg, CardTarot _pc, int _i, boolean _fullCard, AbsCompoFactory _compoFactory, StringMap<StringMap<int[][]>> _images) {
...
//                StreamTextFile.SEPARATEUR,card.getImageFileName(FileConst.TXT_EXT))));
    ...
    void setCarte(AbstractImageFactory _fact, String _lg, CardTarot _pc, StringMap<StringMap<int[][]>> _images) {
        lg = _lg;
        card=_pc;
        peindreCarte=true;
        int[][] file_ = _images.getVal(_lg).getVal(StringUtil.concat(FileConst.RESOURCES_IMAGES,
...
//                StreamTextFile.SEPARATEUR,card.getImageFileName(FileConst.TXT_EXT))));
    ...
    public void setCarteEnJeu(AbstractImageFactory _fact, String _lg, CardTarot _carte, StringMap<StringMap<int[][]>> _images) {
        peindreCarte=true;
