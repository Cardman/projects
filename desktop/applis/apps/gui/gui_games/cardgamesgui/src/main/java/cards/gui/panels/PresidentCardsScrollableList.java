...
public final class PresidentCardsScrollableList extends CardsScrollableList<CardPresident> {
    ...
    public PresidentCardsScrollableList(WindowCardsInt _parent, int _nb, int _pmax, String _titre, DisplayingPresident _dis) {
        super(_parent.getCompoFactory(),_nb,_pmax,_titre,CardFactories.president(_parent.getCompoFactory(), _parent.getImageFactory(),new CardPresidentCellRenderer(_parent)),new CardPresidentCmp(_dis.getDisplaying().getSuits(), _dis.getDisplaying().isDecreasing()));
    }
