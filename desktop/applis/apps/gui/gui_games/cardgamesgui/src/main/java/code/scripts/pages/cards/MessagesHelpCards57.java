...
public final class MessagesHelpCards57{
public static final String M_57_0="_57_0";
public static final String M_57_1="_57_1";
public static final String M_57_2="_57_2";
public static final String M_57_3="_57_3";
public static final String M_57_4="_57_4";
public static final String M_57_5="_57_5";
public static final String M_57_6="_57_6";
public static final String M_57_7="_57_7";
public static final String M_57_8="_57_8";
private MessagesHelpCards57(){
}
public static TranslationsFile en(){
TranslationsFile e=new TranslationsFile(9);
e.add(M_57_0,"Belote");
e.add(M_57_1,"The action of a sub menu \"Edit\" lets made some deal of belote in order that the user test its way of playing and the user returns errors of playing to the author.");
e.add(M_57_2,"This action opens a dialog box.");
...
f.add(M_57_0,"Belote");
f.add(M_57_1,"L'action d'un sous menu du sous menu Editer permet de construire une partie quelconque de belote pour que l'utilisateur teste sa façon de jouer et que l'utilisateur signale à l'auteur des erreurs de jouerie.");
f.add(M_57_2,"Cette action ouvre une boîte de dialogue.");
