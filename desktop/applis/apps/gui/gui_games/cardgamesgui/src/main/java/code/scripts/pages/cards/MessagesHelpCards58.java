...
public final class MessagesHelpCards58{
public static final String M_58_0="_58_0";
public static final String M_58_1="_58_1";
public static final String M_58_2="_58_2";
public static final String M_58_3="_58_3";
public static final String M_58_4="_58_4";
public static final String M_58_5="_58_5";
public static final String M_58_6="_58_6";
public static final String M_58_7="_58_7";
private MessagesHelpCards58(){
}
public static TranslationsFile en(){
TranslationsFile e=new TranslationsFile(8);
e.add(M_58_0,"Tarot");
e.add(M_58_1,"The action of a sub menu \"Edit\" lets made some deal of tarot in order that the user test its way of playing and the user returns errors of playing to the author.");
e.add(M_58_2,"This action opens a dialog box.");
...
f.add(M_58_0,"Tarot");
f.add(M_58_1,"L'action d'un sous menu du sous menu Editer permet de construire une partie quelconque de tarot pour que l'utilisateur teste sa façon de jouer et que l'utilisateur signale à l'auteur des erreurs de jouerie.");
f.add(M_58_2,"Cette action ouvre une boîte de dialogue.");
