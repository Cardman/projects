...
public final class BeloteSampleFirstDeal implements IntFirstDealBelote {
    ...
    public static void passDeal(MockGameBelote _mock) {
    ...
    public static DealBelote dealAll(int _dealer) {
        ...
        hands_.get(2).ajouterCartes(HandBelote.create(new CardBelote[]{CardBelote.CLUB_QUEEN,CardBelote.CLUB_8,CardBelote.CLUB_7}));
        HandBelote hand_;
        hand_ = new HandBelote();
        hands_.add(hand_);
        return new DealBelote(hands_, _dealer);
