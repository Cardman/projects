...
public final class BeloteSampleFirstDealThreePlayersSec implements IntFirstDealBelote {
    @Override
    ...
    public static void mock(MockGameBelote _mock, BoolVal _slam) {
