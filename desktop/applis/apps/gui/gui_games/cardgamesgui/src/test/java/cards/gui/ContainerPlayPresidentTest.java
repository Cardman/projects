...
//    }
    ...
    private int count(ContainerSinglePresident _c) {
        return ((MockCustComponent) _c.window().getPane()).getTreeAccessible().size() - ((MockCustComponent) _c.getGamePart()).getTreeAccessible().size();
    }
}
