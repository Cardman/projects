...
public final class ContainerPlayTarotTest extends EquallableCardsGuiUtil {
    ...
    public void p83() {
        ...
        nextCard(mock_, CardTarot.EXCUSE);
        nextCard(mock_, CardTarot.TRUMP_5);
        nextCard(mock_, CardTarot.TRUMP_7);
        nextCard(mock_, CardTarot.TRUMP_20);
        nextCard(mock_, CardTarot.TRUMP_6);
        nextCard(mock_, CardTarot.TRUMP_2);
        nextCard(mock_, CardTarot.TRUMP_9);
        nextCard(mock_, CardTarot.TRUMP_11);
        nextCard(mock_, CardTarot.TRUMP_19);
        nextCard(mock_, CardTarot.TRUMP_13);
        nextCard(mock_, CardTarot.TRUMP_8);
        nextCard(mock_, CardTarot.TRUMP_15);
        nextCard(mock_, CardTarot.CLUB_3);
        nextCard(mock_, CardTarot.TRUMP_18);
        nextCard(mock_, CardTarot.CLUB_4);
        nextCard(mock_, CardTarot.TRUMP_12);
        nextCard(mock_, CardTarot.SPADE_3);
        nextCard(mock_, CardTarot.CLUB_6);
        nextCard(mock_, CardTarot.TRUMP_17);
        nextCard(mock_, CardTarot.SPADE_4);
        nextCard(mock_, CardTarot.SPADE_1);
        nextCard(mock_, CardTarot.DIAMOND_5);
        nextCard(mock_, CardTarot.HEART_5);
        nextCard(mock_, CardTarot.TRUMP_16);
        nextCard(mock_, CardTarot.HEART_4);
        nextCard(mock_, CardTarot.SPADE_2);
        nextCard(mock_, CardTarot.SPADE_8);
        nextCard(mock_, CardTarot.SPADE_6);
        nextCard(mock_, CardTarot.TRUMP_14);
        nextCard(mock_, CardTarot.CLUB_5);
        nextCard(mock_, CardTarot.HEART_2);
        nextCard(mock_, CardTarot.CLUB_8);
        nextCard(mock_, CardTarot.HEART_6);
        nextCard(mock_, CardTarot.TRUMP_10);
        nextCard(mock_, CardTarot.DIAMOND_7);
        nextCard(mock_, CardTarot.CLUB_7);
        nextCard(mock_, CardTarot.DIAMOND_8);
        nextCard(mock_, CardTarot.SPADE_7);
        nextCard(mock_, CardTarot.TRUMP_4);
        nextCard(mock_, CardTarot.HEART_7);
        nextCard(mock_, CardTarot.HEART_3);
        nextCard(mock_, CardTarot.DIAMOND_9);
        nextCard(mock_, CardTarot.SPADE_9);
        nextCard(mock_, CardTarot.HEART_KING);
        nextCard(mock_, CardTarot.HEART_8);
        nextCard(mock_, CardTarot.HEART_9);
        nextCard(mock_, CardTarot.HEART_10);
        nextCard(mock_, CardTarot.DIAMOND_10);
        nextCard(mock_, CardTarot.HEART_QUEEN);
        nextCard(mock_, CardTarot.CLUB_10);
        nextCard(mock_, CardTarot.SPADE_5);
        nextCard(mock_, CardTarot.HEART_JACK);
        nextCard(mock_, CardTarot.DIAMOND_JACK);
        nextCard(mock_, CardTarot.SPADE_KING);
        nextCard(mock_, CardTarot.SPADE_10);
        nextCard(mock_, CardTarot.CLUB_9);
        nextCard(mock_, CardTarot.CLUB_JACK);
        nextCard(mock_, CardTarot.DIAMOND_QUEEN);
        nextCard(mock_, CardTarot.SPADE_QUEEN);
        nextCard(mock_, CardTarot.SPADE_JACK);
        nextCard(mock_, CardTarot.DIAMOND_KNIGHT);
        nextCard(mock_, CardTarot.HEART_KNIGHT);
        nextCard(mock_, CardTarot.DIAMOND_KING);
        nextCard(mock_, CardTarot.TRUMP_1);
        nextCard(mock_, CardTarot.SPADE_KNIGHT);
        nextCard(mock_, CardTarot.CLUB_KNIGHT);
        nextCard(mock_, CardTarot.CLUB_QUEEN);
        nextCard(mock_, CardTarot.CLUB_KING);
        ContainerSingleTarot cst_ = editTarot(rules_, deal_, mock_);
        tryClickBid(cst_,mock_);
        tryAnimate(cst_);
        clickUniqButton(cst_);
    ...
    public void p115() {
        ...
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.EXCUSE);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_5);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_7);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_20);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_6);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_2);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_9);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_11);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_19);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_13);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_8);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_15);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_3);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_18);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_4);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_12);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_3);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_6);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_17);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_4);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_1);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.DIAMOND_5);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_5);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_16);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_4);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_2);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_8);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_6);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_14);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_5);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_2);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_8);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_6);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_10);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.DIAMOND_7);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_7);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.DIAMOND_8);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_7);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_4);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_7);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_3);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.DIAMOND_9);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_9);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_KING);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_8);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_9);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_10);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.DIAMOND_10);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_QUEEN);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_10);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_5);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_JACK);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.DIAMOND_JACK);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_KING);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_10);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_9);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_JACK);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.DIAMOND_QUEEN);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_QUEEN);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_JACK);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.DIAMOND_KNIGHT);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.HEART_KNIGHT);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.DIAMOND_KING);
        gt_.ajouterPetitAuBoutPliEnCours();
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.TRUMP_1);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.SPADE_KNIGHT);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_KNIGHT);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_QUEEN);
        gt_.ajouterUneCarteDansPliEnCours(CardTarot.CLUB_KING);
        gt_.ajouterPetitAuBoutPliEnCours();
        MockGameTarot mock_ = new MockGameTarot();
