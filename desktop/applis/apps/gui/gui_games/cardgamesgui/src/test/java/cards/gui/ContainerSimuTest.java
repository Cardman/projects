...
public final class ContainerSimuTest extends EquallableCardsGuiUtil {
    ...
    public void s1() {
        ...
        AbstractThread at_ = tryAnimate(csb_);
        IdList<AbsCustComponent> tr_ = ((MockCustComponent) csb_.getOwner().getPane()).getTreeAccessible();
        assertEq(3, tr_.size()-((MockCustComponent) ((SimulationGameBelote)at_.getRunnable()).getSimulatingBelote().getResult()).getTreeAccessible().size());
    }
    @Test
    public void s2() {
        MockGameBelote mock_ = new MockGameBelote();
    ...
    public void s7() {
        ...
        assertEq(4, tr_.size()-((MockCustComponent) ((SimulationGamePresident)at_.getRunnable()).getSimulatingPresident().getResult()).getTreeAccessible().size());
        ...
        assertEq(4, tr2_.size()-((MockCustComponent) ((SimulationGamePresident)at_.getRunnable()).getSimulatingPresident().getResult()).getTreeAccessible().size());
    ...
    public void s10() {
        ...
        AbstractThread at_ = tryAnimate(cst_);
        IdList<AbsCustComponent> tr_ = ((MockCustComponent) cst_.getOwner().getPane()).getTreeAccessible();
        assertEq(3, tr_.size()-((MockCustComponent) ((SimulationGameTarot)at_.getRunnable()).getSimulatingTarot().getResult()).getTreeAccessible().size());
    }
    @Test
    public void s11() {
        MockGameTarot mock_ = new MockGameTarot();
