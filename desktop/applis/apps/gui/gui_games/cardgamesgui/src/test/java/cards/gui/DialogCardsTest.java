...
public final class DialogCardsTest extends EquallableCardsGuiUtil {
    ...
    public void launching() {
        ...
        assertTrue(fr_.getDialogSoftLaunching().getCardDialog().isVisible());
        IdList<AbsCustComponent> tr_ = ((MockCustComponent) fr_.getDialogSoftLaunching().getCardDialog().getPane()).getTreeAccessible();
        assertEq(3, tr_.size());
        assertTrue(tr_.containsObj(fr_.getDialogSoftLaunching().getList().self()));
        assertTrue(tr_.containsObj(fr_.getDialogSoftLaunching().getValidate()));
        assertTrue(tr_.containsObj(fr_.getDialogSoftLaunching().getSaveHomeFolder()));
        assertEq(GameEnum.NONE,fr_.getDialogSoftLaunching().getList().getCurrent());
        assertTrue(fr_.getDialogSoftLaunching().getSaveHomeFolder().isSelected());
        fr_.getDialogSoftLaunching().getList().setSelectedItem(GameEnum.TAROT);
        tryToggle(fr_.getDialogSoftLaunching().getSaveHomeFolder());
        tryClick(fr_.getDialogSoftLaunching().getValidate());
        assertFalse(fr_.getDialogSoftLaunching().getCardDialog().isVisible());
        ...
        tryClick(fr_.getLaunching());
        assertTrue(fr_.getDialogSoftLaunching().getCardDialog().isVisible());
        assertEq(GameEnum.TAROT,fr_.getDialogSoftLaunching().getList().getCurrent());
        assertFalse(fr_.getDialogSoftLaunching().getSaveHomeFolder().isSelected());
        fr_.getDialogSoftLaunching().getList().setSelectedItem(GameEnum.PRESIDENT);
        tryToggle(fr_.getDialogSoftLaunching().getSaveHomeFolder());
        tryClick(fr_.getDialogSoftLaunching().getValidate());
        assertFalse(fr_.getDialogSoftLaunching().getCardDialog().isVisible());
        ...
        tryClick(fr_.getLaunching());
        assertTrue(fr_.getDialogSoftLaunching().getCardDialog().isVisible());
        assertEq(GameEnum.PRESIDENT,fr_.getDialogSoftLaunching().getList().getCurrent());
        assertTrue(fr_.getDialogSoftLaunching().getSaveHomeFolder().isSelected());
        fr_.getDialogSoftLaunching().getList().setSelectedItem(GameEnum.BELOTE);
        tryClick(fr_.getDialogSoftLaunching().getValidate());
        assertFalse(fr_.getDialogSoftLaunching().getCardDialog().isVisible());
        assertTrue(fr_.getParametresLogiciel().isSaveHomeFolder());
        ...
        tryClick(fr_.getLaunching());
        assertTrue(fr_.getDialogSoftLaunching().getCardDialog().isVisible());
        assertEq(GameEnum.BELOTE,fr_.getDialogSoftLaunching().getList().getCurrent());
        assertTrue(fr_.getDialogSoftLaunching().getSaveHomeFolder().isSelected());
        fr_.getDialogSoftLaunching().getList().setSelectedItem(GameEnum.NONE);
        tryClick(fr_.getDialogSoftLaunching().getValidate());
        assertFalse(fr_.getDialogSoftLaunching().getCardDialog().isVisible());
        assertTrue(fr_.getParametresLogiciel().isSaveHomeFolder());
    ...
    public void timing() {
        WindowCards fr_ = frameDialogSoft("/__/", "/_/");
        tryClick(fr_.getTiming());
        assertTrue(fr_.getDialogSoftTiming().getCardDialog().isVisible());
        IdList<AbsCustComponent> tr_ = ((MockCustComponent) fr_.getDialogSoftTiming().getCardDialog().getPane()).getTreeAccessible();
        assertEq(5, tr_.size());
        assertTrue(tr_.containsObj(fr_.getDialogSoftTiming().getValidate()));
        assertTrue(tr_.containsObj(fr_.getDialogSoftTiming().getDelayWaitBids()));
        assertTrue(tr_.containsObj(fr_.getDialogSoftTiming().getDelayWaitCards()));
        assertTrue(tr_.containsObj(fr_.getDialogSoftTiming().getDelayWaitTricks()));
        assertTrue(tr_.containsObj(fr_.getDialogSoftTiming().getWaitTrickClick()));
        assertEq(300,fr_.getDialogSoftTiming().getDelayWaitBids().getMinimum());
        assertEq(2000,fr_.getDialogSoftTiming().getDelayWaitBids().getMaximum());
        assertEq(500,fr_.getDialogSoftTiming().getDelayWaitBids().getValue());
        assertEq(300,fr_.getDialogSoftTiming().getDelayWaitCards().getMinimum());
        assertEq(2000,fr_.getDialogSoftTiming().getDelayWaitCards().getMaximum());
        assertEq(500,fr_.getDialogSoftTiming().getDelayWaitCards().getValue());
        assertEq(500,fr_.getDialogSoftTiming().getDelayWaitTricks().getMinimum());
        assertEq(3000,fr_.getDialogSoftTiming().getDelayWaitTricks().getMaximum());
        assertEq(500,fr_.getDialogSoftTiming().getDelayWaitTricks().getValue());
        assertTrue(fr_.getDialogSoftTiming().getWaitTrickClick().isSelected());
        fr_.getDialogSoftTiming().getDelayWaitBids().setValue(600);
        fr_.getDialogSoftTiming().getDelayWaitCards().setValue(700);
        fr_.getDialogSoftTiming().getDelayWaitTricks().setValue(800);
        tryToggle(fr_.getDialogSoftTiming().getWaitTrickClick());
        tryClick(fr_.getDialogSoftTiming().getValidate());
        assertFalse(fr_.getDialogSoftTiming().getCardDialog().isVisible());
        ...
        assertEq(300,fr_.getDialogSoftTiming().getDelayWaitBids().getMinimum());
        assertEq(2000,fr_.getDialogSoftTiming().getDelayWaitBids().getMaximum());
        assertEq(600,fr_.getDialogSoftTiming().getDelayWaitBids().getValue());
        assertEq(300,fr_.getDialogSoftTiming().getDelayWaitCards().getMinimum());
        assertEq(2000,fr_.getDialogSoftTiming().getDelayWaitCards().getMaximum());
        assertEq(700,fr_.getDialogSoftTiming().getDelayWaitCards().getValue());
        assertEq(500,fr_.getDialogSoftTiming().getDelayWaitTricks().getMinimum());
        assertEq(3000,fr_.getDialogSoftTiming().getDelayWaitTricks().getMaximum());
        assertEq(800,fr_.getDialogSoftTiming().getDelayWaitTricks().getValue());
        assertFalse(fr_.getDialogSoftTiming().getWaitTrickClick().isSelected());
        fr_.getDialogSoftTiming().getDelayWaitBids().setValue(900);
        fr_.getDialogSoftTiming().getDelayWaitCards().setValue(1000);
        fr_.getDialogSoftTiming().getDelayWaitTricks().setValue(1100);
        tryToggle(fr_.getDialogSoftTiming().getWaitTrickClick());
        tryClick(fr_.getDialogSoftTiming().getValidate());
        assertFalse(fr_.getDialogSoftTiming().getCardDialog().isVisible());
    ...
    public void interact() {
        WindowCards fr_ = frameDialogSoft("/__/", "/_/");
        tryClick(fr_.getInteract());
        assertTrue(fr_.getDialogSoftInteract().getCardDialog().isVisible());
        IdList<AbsCustComponent> tr_ = ((MockCustComponent) fr_.getDialogSoftInteract().getCardDialog().getPane()).getTreeAccessible();
        assertEq(2, tr_.size());
        assertTrue(tr_.containsObj(fr_.getDialogSoftInteract().getValidate()));
        assertTrue(tr_.containsObj(fr_.getDialogSoftInteract().getClickCard()));
        assertTrue(fr_.getDialogSoftInteract().getClickCard().isSelected());
        tryToggle(fr_.getDialogSoftInteract().getClickCard());
        tryClick(fr_.getDialogSoftInteract().getValidate());
        assertFalse(fr_.getDialogSoftInteract().getCardDialog().isVisible());
        assertFalse(fr_.getParametresLogiciel().isPlayCardClick());
        tryClick(fr_.getInteract());
        assertTrue(fr_.getDialogSoftInteract().getCardDialog().isVisible());
        assertFalse(fr_.getDialogSoftInteract().getClickCard().isSelected());
        tryToggle(fr_.getDialogSoftInteract().getClickCard());
        tryClick(fr_.getDialogSoftInteract().getValidate());
        assertFalse(fr_.getDialogSoftInteract().getCardDialog().isVisible());
