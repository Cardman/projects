...
//        fr_.getEditorTarot().getNbStacks().setValue(2);
        ...
        IdList<CardTarot> hand_ = stack_.valElts();
        selectEventTarot(input_, Ints.newList(hand_.indexOfObj(CardTarot.HEART_1),hand_.indexOfObj(CardTarot.HEART_8)));
        fr_.getEditorTarot().getEditorCards().getListeTwo().selectItem(1);
        tryClick(fr_.getEditorTarot().getEditorCards().getMoveCards());
        IdList<CardTarot> result_ = fr_.getEditorTarot().stackHands().get(1).valElts();
        assertEq(2,result_.size());
        assertEq(CardTarot.HEART_8,result_.get(0));
        assertEq(CardTarot.HEART_1,result_.get(1));
        assertEq(76,stack_.valElts().size());
    }
    @Test
    public void deplacer2() {
        ...
        selectEventTarot(input_, Ints.newList(handFirst_.indexOfObj(CardTarot.HEART_1),handFirst_.indexOfObj(CardTarot.HEART_10)));
        fr_.getEditorTarot().getEditorCards().getListeTwo().selectItem(1);
        tryClick(fr_.getEditorTarot().getEditorCards().getMoveCards());
        IdList<CardTarot> handSecond_ = stack_.valElts();
        selectEventTarot(input_, Ints.newList(handSecond_.indexOfObj(CardTarot.HEART_8)));
        tryClick(fr_.getEditorTarot().getEditorCards().getMoveCards());
        IdList<CardTarot> result_ = fr_.getEditorTarot().stackHands().get(1).valElts();
        ...
        assertEq(75,stack_.valElts().size());
    }
    @Test
    public void deplacer3() {
        ...
        ScrollCustomGraphicList<CardTarot> input_ = stack_.getListe();
        IdList<CardTarot> handFirst_ = stack_.valElts();
        selectEventTarot(input_, Ints.newList(handFirst_.indexOfObj(CardTarot.HEART_1),handFirst_.indexOfObj(CardTarot.HEART_8)));
        fr_.getEditorTarot().getEditorCards().getListeTwo().selectItem(5);
        tryClick(fr_.getEditorTarot().getEditorCards().getMoveCards());
        IdList<CardTarot> handSecond_ = stack_.valElts();
        selectEventTarot(input_, Ints.newList(handSecond_.indexOfObj(CardTarot.HEART_10)));
        tryClick(fr_.getEditorTarot().getEditorCards().getMoveCards());
        IdList<CardTarot> result_ = fr_.getEditorTarot().stackHands().get(5).valElts();
        assertEq(3,result_.size());
        assertEq(CardTarot.HEART_10,result_.get(0));
        assertEq(CardTarot.HEART_8,result_.get(1));
        assertEq(CardTarot.HEART_1,result_.get(2));
    ...
    public void deplacer4() {
        ...
        fr_.getEditorTarot().getEditorCards().getListeTwo().selectItem(1);
        tryClick(fr_.getEditorTarot().getEditorCards().getMoveCards());
        assertEq(78,stack_.valElts().size());
