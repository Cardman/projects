...
public final class TarotSampleFirstDealAutoCall implements IntFirstDealTarot {
    @Override
    public GameTarot deal(ContainerTarot _container, RulesTarot _rules, long _nb) {
        DealTarot donne_=dealAutoCall(4);
    ...
    public static void simu1(MockGameTarot _mock) {
        ...
        nextBid(_mock, BidTarot.FOLD);
        nextBid(_mock, BidTarot.FOLD);
        nextCall(_mock, CardTarot.HEART_KING);
        nextDiscardIa(_mock,CardTarot.HEART_1,CardTarot.CLUB_1,CardTarot.DIAMOND_4);
        ...
        nextCard(_mock, CardTarot.DIAMOND_3);
    ...
    public static void simu2(MockGameTarot _mock) {
        ...
        nextBid(_mock, BidTarot.FOLD);
        nextBid(_mock, BidTarot.FOLD);
        nextCall(_mock, CardTarot.DIAMOND_KING);
        nextDiscardIa(_mock,CardTarot.HEART_1,CardTarot.CLUB_1,CardTarot.DIAMOND_4);
        nextSlam(_mock, BoolVal.TRUE);
        nextHandful(_mock, Handfuls.TWO, CardTarot.TRUMP_21, CardTarot.TRUMP_20, CardTarot.TRUMP_19, CardTarot.TRUMP_18, CardTarot.TRUMP_17, CardTarot.TRUMP_16, CardTarot.TRUMP_14, CardTarot.TRUMP_10, CardTarot.TRUMP_4, CardTarot.TRUMP_1);
        nextMisere(_mock, Miseres.LOW_CARDS);
    ...
    public static void simu3(MockGameTarot _mock) {
        ...
        nextBid(_mock, BidTarot.FOLD);
        nextBid(_mock, BidTarot.FOLD);
        nextDiscardVarIaCall(_mock, true,CardTarot.HEART_KING,CardTarot.HEART_1,CardTarot.CLUB_1,CardTarot.DIAMOND_4);
        nextHandful(_mock, Handfuls.TWO, CardTarot.TRUMP_21, CardTarot.TRUMP_20, CardTarot.TRUMP_19, CardTarot.TRUMP_18, CardTarot.TRUMP_17, CardTarot.TRUMP_16, CardTarot.TRUMP_14, CardTarot.TRUMP_10, CardTarot.TRUMP_4, CardTarot.TRUMP_1);
        nextMisere(_mock, Miseres.LOW_CARDS);
        nextNoHandful(_mock);
        nextMisere(_mock);
