...
import cards.gui.containers.IntFirstDealTarot;
import cards.tarot.*;
...
public final class TarotSampleFirstDealNoCall implements IntFirstDealTarot {
    @Override
    public GameTarot deal(ContainerTarot _container, RulesTarot _rules, long _nb) {
        DealTarot donne_=dealNoCall(5);
    ...
    public static void simu1(MockGameTarot _mock) {
        ...
        nextCard(_mock, CardTarot.CLUB_2);
        ...
        nextCard(_mock, CardTarot.DIAMOND_1);
        ...
        nextCard(_mock, CardTarot.DIAMOND_2);
        nextCard(_mock, CardTarot.CLUB_1);
        nextCard(_mock, CardTarot.DIAMOND_5);
        nextCard(_mock, CardTarot.DIAMOND_6);
    ...
    private static DealTarot dealNoCall(int _dealer) {
