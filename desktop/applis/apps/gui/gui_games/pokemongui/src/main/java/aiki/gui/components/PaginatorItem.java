...
public final class PaginatorItem extends PaginatorCommonItem {
...
//        getWindow().pack();
    ...
    private void setInfos() {
        SearchingMode s_;
        getFacade().setContentOfNameItem(convertStringField(getName().getText()));
        getFacade().setContentOfDescriptionItem(convertStringField(getDescription().getText()));
        s_ = getModeName().getCurrent();
        getFacade().setSearchModeNameItem(s_);
        s_ = getModeDescription().getCurrent();
        getFacade().setSearchModeDescriptionItem(s_);
        getFacade().setMinPriceItem(convertLongNumberField(getMinPrice().getText()));
        getFacade().setMaxPriceItem(convertLongNumberField(getMaxPrice().getText()));
        getFacade().setMinNumberItem(convertLgIntField(getMinNumber().getText()));
        getFacade().setMaxNumberItem(convertLgIntField(getMaxNumber().getText()));
        getFacade().setCmpNameIncreasingItem(getCmpNameSorting().getCurrent());
        getFacade().setCmpDescriptionIncreasingItem(getCmpDescriptionSorting().getCurrent());
        getFacade().setCmpPriceIncreasingItem(getCmpPriceSorting().getCurrent());
        getFacade().setCmpNumberIncreasingItem(getCmpNumberSorting().getCurrent());
        getFacade().setCmpNamePriorityItem(getCmpNamePrio().getCurrent());
        getFacade().setCmpDescriptionPriorityItem(getCmpDescriptionPrio().getCurrent());
        getFacade().setCmpPricePriorityItem(getCmpPricePrio().getCurrent());
        getFacade().setCmpNumberPriorityItem(getCmpNumberPrio().getCurrent());
    }
