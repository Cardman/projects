...
//    private NumComboBox cmpTypesPrio = new NumComboBox();
    ...
    public PaginatorMove(WindowAiki _window, AbsPanel _p, ChangeableTitle _w, FacadeGame _d, boolean _buy) {
        ...
        cmpTargetsPrio = new NumComboBox(_window.getFrames(),_window.getFrames().getGeneComboBox());
        ...
        cmpPrioPrio = new NumComboBox(_window.getFrames(),_window.getFrames().getGeneComboBox());
        setWindow(_w);
        setFacade(_d);
        buy = _buy;
        ...
        modeTypes = new ComboBox<SearchingMode>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        modeTypes.setWithDefaultValue(false);
        modeTypes.refresh(order, getMessagesSearchMode());
        damaging = new ComboBox<SelectedBoolean>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        damaging.setWithDefaultValue(false);
        damaging.refresh(getFacade().getTranslatedBooleansCurLanguage());
        targets = new ComboBox<TargetChoice>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        ...
        cmpTargetsSorting = new ComboBox<SelectedBoolean>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
...
//        cmpTypesSorting.refresh(getFacade().getData().getTranslatedBooleans().getVal(Constants.getLanguage()));
        cmpDamagingSorting = new ComboBox<SelectedBoolean>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        cmpDamagingSorting.setWithDefaultValue(false);
        cmpDamagingSorting.refresh(getFacade().getTranslatedBooleansCurLanguage());
        cmpPrioSorting = new ComboBox<SelectedBoolean>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
...
//        });
        ...
        search_.add(getMain().getCompoFactory().newPlainLabel(getMessages().getVal(CST_TYPES)));
        search_.add(types);
        search_.add(modeTypes.self());
        search_.add(getMain().getCompoFactory().newPlainLabel(getMessages().getVal(CST_PRIORITY)));
        search_.add(minPriority);
        search_.add(maxPriority);
        search_.add(getMain().getCompoFactory().newPlainLabel(getMessages().getVal(CST_PP)));
        search_.add(minPp);
        search_.add(maxPp);
        search_.add(getMain().getCompoFactory().newPlainLabel(getMessages().getVal(CST_PRICE)));
        search_.add(minPrice);
        search_.add(maxPrice);
        search_.add(getMain().getCompoFactory().newPlainLabel(getMessages().getVal(CST_DAMAGING)));
        search_.add(damaging.self());
        search_.add(getMain().getCompoFactory().newPlainLabel(DataBase.EMPTY_STRING));
        search_.add(getMain().getCompoFactory().newPlainLabel(getMessages().getVal(CST_TARGETS)));
        ...
        sorting_.add(getMain().getCompoFactory().newPlainLabel(getMessages().getVal(CST_PRICE)));
        sorting_.add(cmpPriceSorting.self());
        sorting_.add(cmpPricePrio.self());
        sorting_.add(getMain().getCompoFactory().newPlainLabel(getMessages().getVal(CST_PRIORITY)));
        sorting_.add(cmpPrioSorting.self());
        sorting_.add(cmpPrioPrio.self());
        sorting_.add(getMain().getCompoFactory().newPlainLabel(getMessages().getVal(CST_PP)));
        sorting_.add(cmpPpSorting.self());
        sorting_.add(cmpPpPrio.self());
        sorting_.add(getMain().getCompoFactory().newPlainLabel(getMessages().getVal(CST_DAMAGING)));
        sorting_.add(cmpDamagingSorting.self());
        sorting_.add(cmpDamagingPrio.self());
        sorting_.add(getMain().getCompoFactory().newPlainLabel(getMessages().getVal(CST_TARGETS)));
