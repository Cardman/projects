...
public final class PaginatorPokemon extends Paginator {
    ...
    public PaginatorPokemon(WindowAiki _window, AbsPanel _p, ChangeableTitle _w, FacadeGame _d) {
        ...
        cmpItemPrio = new NumComboBox(_window.getFrames(),_window.getFrames().getGeneComboBox());
        cmpLevelPrio = new NumComboBox(_window.getFrames(),_window.getFrames().getGeneComboBox());
        cmpGenderPrio = new NumComboBox(_window.getFrames(),_window.getFrames().getGeneComboBox());
        cmpPossEvosPrio = new NumComboBox(_window.getFrames(),_window.getFrames().getGeneComboBox());
        setWindow(_w);
        setFacade(_d);
        ...
        modeAbility = new ComboBox<SearchingMode>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        modeAbility.setWithDefaultValue(false);
        modeAbility.refresh(order, getMessagesSearchMode());
        modeItem = new ComboBox<SearchingMode>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        modeItem.setWithDefaultValue(false);
        modeItem.refresh(order, getMessagesSearchMode());
        withItem = new ComboBox<SelectedBoolean>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        withItem.setWithDefaultValue(false);
        withItem.refresh(getFacade().getTranslatedBooleansCurLanguage());
        modeMoves = new ComboBox<SearchingMode>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        modeMoves.setWithDefaultValue(false);
        modeMoves.refresh(order, getMessagesSearchMode());
        gender = new ComboBox<Gender>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        ...
        cmpAbilitySorting = new ComboBox<SelectedBoolean>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        cmpAbilitySorting.setWithDefaultValue(false);
        cmpAbilitySorting.refresh(getFacade().getTranslatedBooleansCurLanguage());
        cmpItemSorting = new ComboBox<SelectedBoolean>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        cmpItemSorting.setWithDefaultValue(false);
        cmpItemSorting.refresh(getFacade().getTranslatedBooleansCurLanguage());
        cmpLevelSorting = new ComboBox<SelectedBoolean>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        cmpLevelSorting.setWithDefaultValue(false);
        cmpLevelSorting.refresh(getFacade().getTranslatedBooleansCurLanguage());
        cmpGenderSorting = new ComboBox<SelectedBoolean>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
        cmpGenderSorting.setWithDefaultValue(false);
        cmpGenderSorting.refresh(getFacade().getTranslatedBooleansCurLanguage());
        cmpPossEvosSorting = new ComboBox<SelectedBoolean>(_window.getFrames().getGeneComboBox().createCombo(_window.getImageFactory(),new StringList(), -1, getMain().getCompoFactory()));
