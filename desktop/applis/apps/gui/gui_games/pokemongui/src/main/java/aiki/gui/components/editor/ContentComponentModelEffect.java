...
public final class ContentComponentModelEffect {
    ...
    AbsPanel effectForm(AbsCommonFrame _f, AbstractProgramInfos _core, FacadeGame _fac, SubscribedTranslationList _fact) {
        ...
        targetChoice = ConverterCommonMapUtil.buildTargetChoice(_core, _fac);
        selected_.add(targetChoice.geneEnum(TargetChoice.NOTHING));
    ...
    void buildEntity(Effect _edited) {
        ...
        _edited.setTargetChoice(targetChoice.tryRet(TargetChoice.NOTHING));
