...
public final class ContentComponentModelEffectStatistic {
    ...
    AbsPanel effectForm(AbsCommonFrame _f, AbstractProgramInfos _core, FacadeGame _fac, SubscribedTranslationList _fact) {
        ...
        statisVarRank.initFormWithVal(new DisplayEntryCustSubElementImpl<Statistic,Long>(_fact.getFactoryStat(),_core,_fac, new IdMap<Statistic, String>()), new GeneComponentModelSubscribeFactorySelEltEnum<Statistic>(_core, _fact.getFactoryStat(), _fac), new GeneComponentModelSubscribeFactoryDirect<Long>(new GeneComponentModelSubscribeLong(_core)),formatTxt(_core,MessagesDataEffstatis.M_P_58_STATISTIC),formatTxt(_core,MessagesDataEffstatis.M_P_58_BOOST));
        ...
        lawBoost.initFormKeys(ConverterCommonMapUtil.buildStatisticsElt(_core, _fac, _fact),new DisplayEntryCustSubElementLgIntImpl<Statistic>(_fact.getFactoryStat(),_core,_fac, new IdMap<Statistic, String>()),formatTxt(_core,MessagesDataEffstatis.M_P_58_STATISTIC),formatTxt(_core,MessagesDataEffstatis.M_P_58_RATE_EVENT));
