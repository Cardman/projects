...
public final class ContentComponentModelItemForBattle {
    ...
    AbsPanel form(GeneComponentModelItem _parent) {
        ...
        multPower = new GeneComponentModelString(_parent.getCompoFactory(),new StringList(),new DefValidateText());
        itemForBattleForm.add(multPower.geneString());
        multDamage = new GeneComponentModelString(_parent.getCompoFactory(),new StringList(),new DefValidateText());
