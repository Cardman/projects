...
public final class CrudGeneFormSimpleFormSub<K, V> {
    ...
    public void initFormWithVal(DisplayEntryCustSubElement<EditedCrudPair<K, V>> _d, AbsGeneComponentModelSubscribeFactory<K> _k, AbsGeneComponentModelSubscribeFactory<V> _v) {
    ...
    public void initFormWithVal(DisplayEntryCustSubElement<EditedCrudPair<K, V>> _d, AbsGeneComponentModelSubscribeFactory<K> _k, AbsGeneComponentModelSubscribeFactory<V> _v, String _txtKey, String _txtValue) {
        crud = new CrudGeneFormSimpleForm<K,V>(programInfos, facadeGame, subscribedTranslationList, commonFrame);
        crud.initForm();
        crud.initForm(_d, programInfos, _k, _v,new WithValidateElementPairFactory<K, V>(),_txtKey,_txtValue);
    }
