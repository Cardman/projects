...
public final class GeneComponentModelEffect extends AbsGeneComponentModelEffect {
    ...
    public IdList<SubscribedTranslation> all() {
        ...
        ids_.addAllElts(getContentEffectGlobal().getPreventStatusFail().getSubs());
        ...
        ids_.addAllElts(getContentEffectGlobal().getMultPowerUsedMoves().subscribeButtons());
        ids_.addAllElts(getContentEffectGlobal().getMultPowerSufferedMoves().subscribeButtons());
        ids_.addAllElts(getContentEffectGlobal().getMultDamageTypesMoves().subscribeButtons());
        ids_.addAllElts(getContentEffectGlobal().getMultPowerUsedTypesMoves().subscribeButtons());
        ids_.addAllElts(getContentEffectGlobal().getMultPowerSufferedTypesMoves().subscribeButtons());
        ...
        ids_.addAllElts(getContentEffectGlobal().getImmuDamageByDisappearingMoves().getSubs());
        ids_.addAllElts(getContentEffectGlobal().getGroundedTypes().getSubs());
