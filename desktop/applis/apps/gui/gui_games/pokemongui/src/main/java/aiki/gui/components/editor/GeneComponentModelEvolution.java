...
public final class GeneComponentModelEvolution implements ChangeableFormType{
    ...
    private AbsCustComponent compoLevel;
    ...
    public AbsPanel geneEvo() {
        ...
        compoItem = line(MessagesDataPokemonData.M_P_72_EVO_ITEM,item.geneEnum());
        compoItem.setVisible(false);
        selected_.add(compoItem);
        compoGender = line(MessagesDataPokemonData.M_P_72_EVO_GENDER,evoGender.geneEnum());
        compoGender.setVisible(false);
        selected_.add(compoGender);
        compoMove = line(MessagesDataPokemonData.M_P_72_EVO_MOVE,evoMove.geneEnum());
        compoMove.setVisible(false);
        selected_.add(compoMove);
        compoMoveType = line(MessagesDataPokemonData.M_P_72_EVO_TYPE,evoMoveType.geneEnum());
        compoMoveType.setVisible(false);
        selected_.add(compoMoveType);
        compoTeamPokemon = line(MessagesDataPokemonData.M_P_72_EVO_TEAM,evoTeamPokemon.geneEnum());
