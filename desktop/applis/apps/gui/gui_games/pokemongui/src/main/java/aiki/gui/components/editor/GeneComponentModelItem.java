...
public final class GeneComponentModelItem extends GeneComponentModelEntity<Item> implements ChangeableFormType {
    ...
    public AbsCustComponent gene(int _select) {
        ...
        ballForm.add(line(MessagesPkBean.IT_BALL,MessagesDataItemsBall.M_P_16_RATE_CATCHING,catchingRate.geneEnum()));
        ...
        healHpForm.add(line(MessagesPkBean.IT_HEALINGHP,MessagesDataItemsHealinghp.M_P_22_HEAL_HP_INTRO,hp.geneRate()));
        ...
        healHpStatusForm.add(line(MessagesPkBean.IT_HEALINGHPSTATUS,MessagesDataItemsHealinghpstatus.M_P_23_RATE_INTRO,healedHpRate.geneRate()));
        ...
        repelForm.add(line(MessagesPkBean.IT_REPEL,MessagesDataItemsRepel.M_P_30_STEPS_INTRO,steps.geneLong()));
