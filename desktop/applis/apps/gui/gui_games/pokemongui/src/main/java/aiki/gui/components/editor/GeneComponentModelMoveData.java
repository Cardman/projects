...
public final class GeneComponentModelMoveData extends GeneComponentModelEntity<MoveData> implements ChangeableFormType {
    ...
    public AbsCustComponent gene(int _select) {
        ...
        typesByOwnedItem.initFormWithVal(new DisplayEntryCustSubElementImpl<String,String>(getSubscribedTranslationList().getFactoryIt(),getCompoFactory(),getFacade(), ConverterCommonMapUtil.defKeyEmpty(" ")), buildPart(getSubscribedTranslationList().getFactoryIt(), ConverterCommonMapUtil.defKeyEmpty("")),buildPart(getSubscribedTranslationList().getFactoryTy(), new StringMap<String>()),SubscribedTranslationList.formatTxt(getCompoFactory(),MessagesPkBean.MV_DATA,MessagesDataMovesData.M_P_35_ITEM),SubscribedTranslationList.formatTxt(getCompoFactory(),MessagesPkBean.MV_DATA,MessagesDataMovesData.M_P_35_TYPE_TITLE));
        typesByWeather.initFormWithVal(new DisplayEntryCustSubElementImpl<String,String>(getSubscribedTranslationList().getFactoryMv(),getCompoFactory(),getFacade(), ConverterCommonMapUtil.defKeyEmpty(" ")), buildPart(getSubscribedTranslationList().getFactoryMv(), ConverterCommonMapUtil.defKeyEmpty("")),buildPart(getSubscribedTranslationList().getFactoryTy(), new StringMap<String>()),SubscribedTranslationList.formatTxt(getCompoFactory(),MessagesPkBean.MV_DATA,MessagesDataMovesData.M_P_35_WEATHER),SubscribedTranslationList.formatTxt(getCompoFactory(),MessagesPkBean.MV_DATA,MessagesDataMovesData.M_P_35_TYPE_TITLE));
        secEffectsByItem.initFormWithVal(new DisplayEntryCustSubElementImpl<String,Ints>(getSubscribedTranslationList().getFactoryIt(),getCompoFactory(),getFacade(), ConverterCommonMapUtil.defKeyEmpty(" ")), buildPart(getSubscribedTranslationList().getFactoryIt(), ConverterCommonMapUtil.defKeyEmpty("")),new GeneComponentModelSubscribeFactoryDirect<Ints>(new GeneComponentModelSubscribeInts(getCompoFactory(), getFacade(), getSubscribedTranslationList(), secEffectsByItem.getCommonFrame())),SubscribedTranslationList.formatTxt(getCompoFactory(),MessagesPkBean.MV_DATA,MessagesDataMovesData.M_P_35_ITEM),SubscribedTranslationList.formatTxt(getCompoFactory(),MessagesPkBean.MV_DATA,MessagesDataMovesData.M_P_35_EFFECTS_NB));
