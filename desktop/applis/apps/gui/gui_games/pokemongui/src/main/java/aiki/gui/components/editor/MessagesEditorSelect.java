...
public final class MessagesEditorSelect {
    ...
    public static final String TRS_ENT_PK = TRS_ENT+"_3";
    public static final String TRS_ENT_ST = TRS_ENT+"_4";
    public static final String TRS_ENT_CA = TRS_ENT+"_5";
    public static final String TRS_ENT_TY = TRS_ENT+"_6";
    public static final String TRS_ENT_CL = TRS_ENT+"_7";
    public static final String TRS_ENT_FCT = TRS_ENT+"_8";
    public static final String TRS_ENT_ET = TRS_ENT+"_9";
    public static final String TRS_ENT_DIFF_MODEL = TRS_ENT+"_10";
    public static final String TRS_ENT_DIFF_WIN = TRS_ENT+"_11";
    public static final String TRS_ENT_CONST = TRS_ENT+"_12";
    public static final String TRS_ENT_CONST_OTHER = TRS_ENT+"_13";
    public static final String TRS_ENT_CONST_NUM = TRS_ENT+"_14";
    public static final String TM_HM_0 = TM_HM+"_0";
    public static final String TM_HM_1 = TM_HM+"_1";
    public static final String ENT_AB = ENT+"_0";
    public static final String ENT_IT = ENT+"_1";
    public static final String ENT_MV = ENT+"_2";
    public static final String ENT_PK = ENT+"_3";
    public static final String ENT_ST = ENT+"_4";
    public static final String ENT_CO = ENT+"_5";
    public static final String ENT_TY = ENT+"_6";
    public static final String TRS_CST_STAT = TRS_CST+"_0";
    public static final String TRS_CST_TARGET = TRS_CST+"_1";
    public static final String TRS_CST_GENDER = TRS_CST+"_2";
    public static final String TRS_CST_ENV = TRS_CST+"_3";
    public static final String TRS_CST_DIFF_MODEL = TRS_CST+"_4";
    public static final String TRS_CST_DIFF_WIN = TRS_CST+"_5";
    public static final String TRS_CST_SEL = TRS_CST+"_6";
    public static final String IMG_PK_MINI = IMG+"_0";
    public static final String IMG_PK_BACK = IMG+"_1";
    public static final String IMG_PK_FRONT = IMG+"_2";
    public static final String IMG_IT = IMG+"_3";
    public static final String IMG_ST = IMG+"_4";
    public static final String IMG_TY = IMG+"_5";
    public static final String IMG_LK = IMG+"_6";
    public static final String IMG_PEOPLE = IMG+"_7";
    public static final String IMG_TR = IMG+"_8";
    public static final String IMG_BK = IMG+"_9";
    public static final String IMG_MAP = IMG+"_10";
    public static final String IMG_TYPE = IMG+"_11";
    public static final String IMG_BOOST = IMG+"_12";
    public static final String IMG_HEROS_MINI = IMG+"_13";
    public static final String IMG_HEROS_FRONT = IMG+"_14";
    public static final String IMG_HEROS_BACK = IMG+"_15";
    public static final String IMG_OTHER = IMG+"_16";
    ...
    public static TranslationsFile enMenus() {
        ...
        e_.add(TRS_ENT_PK, POKEMON);
        e_.add(TRS_ENT_ST, STATUS);
        e_.add(TRS_ENT_CA,"Categories");
        e_.add(TRS_ENT_TY, TYPES);
        e_.add(TRS_ENT_CL,"Descriptions of items");
        e_.add(TRS_ENT_FCT,"Math functions");
        e_.add(TRS_ENT_ET,"Experience growth");
        e_.add(TRS_ENT_DIFF_MODEL,"Difficulty about model experience");
        e_.add(TRS_ENT_DIFF_WIN,"Difficulty about winning points");
        e_.add(TRS_ENT_CONST,"Const");
        e_.add(TRS_ENT_CONST_NUM,"Numeric const");
        e_.add(TRS_ENT_CONST_OTHER,"Other const");
        e_.add(TM_HM_0,"Technical moves");
        e_.add(TM_HM_1,"Hidden moves");
        e_.add(ENT_AB,"Abilities");
        e_.add(ENT_IT, ITEMS);
        e_.add(ENT_MV,"Moves");
        e_.add(ENT_PK, POKEMON);
        e_.add(ENT_ST, STATUS);
        e_.add(ENT_CO,"Combining moves");
        e_.add(ENT_TY, TYPES);
        e_.add(TRS_CST_STAT, "Statistic");
        e_.add(TRS_CST_TARGET, "Target choice");
        e_.add(TRS_CST_GENDER, "Gender");
        e_.add(TRS_CST_ENV, "Environment");
        e_.add(TRS_CST_DIFF_MODEL, "Difficulty about model experience");
        e_.add(TRS_CST_DIFF_WIN, "Difficulty about winning points");
        e_.add(TRS_CST_SEL, "Selected boolean");
        e_.add(IMG_PK_MINI, "Pokemon mini");
        e_.add(IMG_PK_BACK, "Pokemon back");
        e_.add(IMG_PK_FRONT, "Pokemon front");
        e_.add(IMG_IT, ITEMS);
        e_.add(IMG_ST, STATUS);
        e_.add(IMG_TY, TYPES);
        e_.add(IMG_LK, "Links");
        e_.add(IMG_PEOPLE, "People");
        e_.add(IMG_TR, "Trainers");
        e_.add(IMG_BK, "Blocks");
        e_.add(IMG_MAP, "Map");
        e_.add(IMG_TYPE, "Type color");
        e_.add(IMG_BOOST, "Variation of statistic");
        e_.add(IMG_HEROS_MINI, "Hero mini");
        e_.add(IMG_HEROS_FRONT, "Hero front");
        e_.add(IMG_HEROS_BACK, "Hero back");
        e_.add(IMG_OTHER, "Other");
        return e_;
    }
    public static TranslationsFile frMenus() {
        ...
        f_.add(TRS_ENT_PK, POKEMON);
        f_.add(TRS_ENT_ST, STATUTS);
        f_.add(TRS_ENT_CA,"Catégories");
        f_.add(TRS_ENT_TY, TYPES);
        f_.add(TRS_ENT_CL,"Descriptions d'objets");
        f_.add(TRS_ENT_FCT,"Fonctions math");
        f_.add(TRS_ENT_ET,"Croissance d'expérience");
        f_.add(TRS_ENT_DIFF_MODEL,"Difficulté à propos du modèle d'expérience");
        f_.add(TRS_ENT_DIFF_WIN,"Difficulté à propos du gain de points");
        f_.add(TRS_ENT_CONST,"Constantes");
        f_.add(TRS_ENT_CONST_NUM,"Constantes numériques");
        f_.add(TRS_ENT_CONST_OTHER,"Autres constantes");
        f_.add(TM_HM_0,"Capsules techniques");
        f_.add(TM_HM_1,"Capsules secrètes");
        f_.add(ENT_AB,"Capacités");
        f_.add(ENT_IT, OBJETS);
        f_.add(ENT_MV,"Attaques");
        f_.add(ENT_PK, POKEMON);
        f_.add(ENT_ST, STATUTS);
        f_.add(ENT_CO,"Combinaisons d'attaques");
        f_.add(ENT_TY, TYPES);
        f_.add(TRS_CST_STAT, "Statistique");
        f_.add(TRS_CST_TARGET, "Choix de cible");
        f_.add(TRS_CST_GENDER, "Genre");
        f_.add(TRS_CST_ENV, "Environnement");
        f_.add(TRS_CST_DIFF_MODEL, "Difficulté à propos du modèle d'expérience");
        f_.add(TRS_CST_DIFF_WIN, "Difficulté à propos du gain de points");
        f_.add(TRS_CST_SEL, "Booléen sélectionné");
        f_.add(IMG_PK_MINI, "Pokemon mini");
        f_.add(IMG_PK_BACK, "Pokemon dos");
        f_.add(IMG_PK_FRONT, "Pokemon face");
        f_.add(IMG_IT, OBJETS);
        f_.add(IMG_ST, STATUTS);
        f_.add(IMG_TY, TYPES);
        f_.add(IMG_LK, "Liens");
        f_.add(IMG_PEOPLE, "Personnages");
        f_.add(IMG_TR, "Dresseurs");
        f_.add(IMG_BK, "Blocs");
        f_.add(IMG_MAP, "Carte");
        f_.add(IMG_TYPE, "Couleur de type");
        f_.add(IMG_BOOST, "Variation de statistique");
        f_.add(IMG_HEROS_MINI, "Héros mini");
