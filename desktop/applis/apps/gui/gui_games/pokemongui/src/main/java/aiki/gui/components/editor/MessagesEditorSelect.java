...
public final class MessagesEditorSelect {
    ...
    public static TranslationsFile enEff(){
        ...
        e_.add(EFF_END_ROUND_FOE,"Regards the foe team of the user.");
        e_.add(EFF_END_ROUND_GLOBAL,"Regards all fighters at the end.");
        e_.add(EFF_END_ROUND_INDIVIDUAL,"Regards one fighter.");
        e_.add(EFF_END_ROUND_MULTI_RELATION,"Regards all possible relations between users and targets on the front of battle.");
        e_.add(EFF_END_ROUND_POSITION_RELATION,"Regards the position of the user and the possible substitute.");
        e_.add(EFF_END_ROUND_POSITION_TARGET,"Regards the position of the user and the position of the target.");
        e_.add(EFF_END_ROUND_SINGLE_RELATION,"Regards the user and the target.");
        e_.add(EFF_END_ROUND_STATUS,"Regards one fighter.");
        e_.add(EFF_END_ROUND_STATUS_RELATION,"Regards the user and the target.");
        e_.add(EFF_END_ROUND_TEAM,"Regards the team of the user.");
    ...
    public static TranslationsFile frEff(){
        TranslationsFile f_ = new TranslationsFile();
        f_.add(EFF_END_ROUND_FOE,"Concerne l'équipe adverse du lanceur.");
        f_.add(EFF_END_ROUND_GLOBAL,"Concerne tous les combattants à la fin.");
        f_.add(EFF_END_ROUND_INDIVIDUAL,"Concerne un seul combattant.");
        f_.add(EFF_END_ROUND_MULTI_RELATION,"Prend en compte toutes les relations possibles entre lanceurs et cibles sur le terrains.");
        f_.add(EFF_END_ROUND_POSITION_RELATION,"Tient compte de la position du lanceur et le remplacant éventuel.");
        f_.add(EFF_END_ROUND_POSITION_TARGET,"Tient compte de la position du lanceur et celle de la cible.");
        f_.add(EFF_END_ROUND_SINGLE_RELATION,"Concerne le lanceur et la cible.");
        f_.add(EFF_END_ROUND_STATUS,"Concerne un seul combattant.");
        f_.add(EFF_END_ROUND_STATUS_RELATION,"Concerne le lanceur et la cible.");
        f_.add(EFF_END_ROUND_TEAM,"Concerne l'équipe du lanceur.");
        ...
        f_.add(EFF_COPY_MOVE,"A lieu lors d'une copie d'attque de combattant");
