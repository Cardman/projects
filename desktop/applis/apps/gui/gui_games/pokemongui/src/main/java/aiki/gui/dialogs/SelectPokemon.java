...
//        ok = false;
        ...
        mainComponent.add(compo.newAbsScrollPane(paginatorPokemon.getContainer()), MessagesGuiFct.BORDER_LAYOUT_CENTER);
...
//        buttons_.add(cancel_);
        mainComponent.add(buttons_, MessagesGuiFct.BORDER_LAYOUT_SOUTH);
...
//        }
        ...
        pkDetailContent.group(window, getFacade(), getSelectDial(), null);
        getSelectDial().pack();
