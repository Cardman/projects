...
Thread safe class*/
public final class CreateMainWindowNoParam extends AbsCreateMainWindowParam {
    ...
    public void run() {
//        String loadRom_;
        if (!getLoad().isLoadLastRom()) {
            getWindow().setLoadingConf(getLoad(), true);
            return;
        }
        super.run();
//        String path_;
