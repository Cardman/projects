...
public final class FightGuiRoundTest extends InitDbGuiAiki {
    ...
    public void eff41() {
        WindowAiki window_ = newFight();
        coreDataBaseAttStBall(window_, MbOperationNode.CARAC_DROITE_FERME+"("+MbOperationNode.DIV_FCT+"("+VAR_PREFIX+ MessagesDataBaseConstants.DEF_FOE_PK_MAX_HP+","+VAR_PREFIX+ MessagesDataBaseConstants.DEF_FOE_PK_REMOTE_HP+"),2)", MbOperationNode.CARAC_DROITE_FERME+"("+MbOperationNode.DIV_FCT+"("+VAR_PREFIX+ MessagesDataBaseConstants.DEF_PK_UT_VITESSE+","+VAR_PREFIX+ MessagesDataBaseConstants.DEF_PK_SAUVAGE_VITESSE+"),1)");
        window_.getBattle().getBattle().getFighterFrontPanel().getListe().select(0);
        window_.getBattle().getBattle().getFighterFrontPanel().getListe().events();
        tryClick(window_.getBattle().getBattle().getMovesLabels().get(1));
        tryClick(window_.getBattle().getBattle().getValidateActions());
    ...
    public void eff43() {
        WindowAiki window_ = newFight();
        coreDataBaseAttStBall(window_, "1", MbOperationNode.CARAC_DROITE_FERME+"("+MbOperationNode.DIV_FCT+"("+VAR_PREFIX+ MessagesDataBaseConstants.DEF_PK_UT_VITESSE+","+VAR_PREFIX+ MessagesDataBaseConstants.DEF_PK_SAUVAGE_VITESSE+"),1)");
        window_.getBattle().getBattle().getFighterFrontPanel().getListe().select(0);
        window_.getBattle().getBattle().getFighterFrontPanel().getListe().events();
        tryClick(window_.getBattle().getBattle().getCatchBall());
        tryAn((MockThreadFactory) window_.getFrames().getThreadFactory());
    ...
    public void eff44() {
        WindowAiki window_ = newFight();
        coreDataBaseAttStBall(window_, "1", MbOperationNode.CARAC_DROITE_FERME+"("+MbOperationNode.DIV_FCT+"("+VAR_PREFIX+ MessagesDataBaseConstants.DEF_PK_SAUVAGE_VITESSE+","+VAR_PREFIX+ MessagesDataBaseConstants.DEF_PK_UT_VITESSE+"),1)");
    ...
    public void eff47() {
        WindowAiki window_ = newFight();
        coreDataBaseAttStBallTwo(window_, "1", MbOperationNode.CARAC_DROITE_FERME+"("+MbOperationNode.DIV_FCT+"("+VAR_PREFIX+ MessagesDataBaseConstants.DEF_PK_UT_VITESSE+","+VAR_PREFIX+ MessagesDataBaseConstants.DEF_PK_SAUVAGE_VITESSE+"),1)");
...
//        initMiniMap(data_);
    ...
    private static void coreDataBaseAttSt(WindowAiki _window) {
        ...
        eone_.getStatisVarRank().addEntry(Statistic.SPEED,0L);
        ...
        etwo_.getStatisVarRank().addEntry(Statistic.SPEED,0L);
    ...
    private static void coreDataBaseAttStFast(WindowAiki _window) {
        ...
        eone_.getStatisVarRank().addEntry(Statistic.SPEED,1L);
        eone_.setTargetChoice(TargetChoice.ANY_FOE);
        first_.getEffects().add(eone_);
        StatusMoveData second_ = ppStatus();
        second_.setTargetChoice(TargetChoice.ANY_FOE);
        ...
        etwo_.getStatisVarRank().addEntry(Statistic.SPEED,1L);
        etwo_.setTargetChoice(TargetChoice.ANY_FOE);
        second_.getEffects().add(etwo_);
        loadRom(_window, coreDataBaseAttSt(first_,second_));
        Game game_ = build(_window.getFacade());
