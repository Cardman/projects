...
public final class FolderOpenSaveFrame extends AbsOpenSaveFrame {
    ...
    public static void setFileSaveDialogByFrame(boolean _currentFolderRoot, String _folder, FolderOpenSaveFrame _fileSave, AbsSaveFile _s, AbsContinueFile _c) {
        ...
        _fileSave.common();
        s_.setFileSaveContentDialogByFrame(_currentFolderRoot,_folder, new OpenSavePostFileFrameEvent(_fileSave, s_, FileSaveDialog.FILE_SAVE_DIAL, MessagesFileSaveDialog.SAVE, _fileSave.getTabs(), _fileSave.getLabSave()));
        o_.setFolderOpenDialogPart(_currentFolderRoot, new OpenSavePostFileFrameEvent(_fileSave, o_, FolderOpenDialog.FOLDER_OPEN_DIAL, MessagesFolderOpenDialog.OPEN, _fileSave.getTabs(), _fileSave.getLabOpen()));
