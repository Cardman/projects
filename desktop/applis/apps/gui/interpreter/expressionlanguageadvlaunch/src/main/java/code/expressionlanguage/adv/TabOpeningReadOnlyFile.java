...
public final class TabOpeningReadOnlyFile implements AbsOpeningReadOnlyFile {
    @Override
    public void openFile(AbsDebuggerGui _curr, ResultContext _r, String _str, String _content) {
        ...
        _curr.addTab(_r,_curr.getManageOptions(),fullPath_,content_, _curr.getManageOptions().getOptions());
