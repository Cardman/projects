...
public final class GuiAliases {
    ...
    public StringMap<String> buildFiles(KeyWords _keyWords, LgNamesContent _content, StringList _predefinedClasses, StringList _predefinedInterfacesInitOrder) {
        ...
        map_.put("{e}", tr("e", _keyWords, pr_, co_));
        ...
        map_.put("{void}", co_.getAliasVoid());
        map_.put("{e}", tr("e", _keyWords, pr_, co_));
        map_.put("{f}", tr("f", _keyWords, pr_, co_));
        map_.put("{endLine}", endLine_);
        content_ = StringList.formatQuote(content_, map_);
        ...
        map_.put("{i}", tr("i", _keyWords, pr_, co_));
        map_.put("{l}", tr("l", _keyWords, pr_, co_));
    ...
    public void buildOther(LgNamesContent _content, CustAliases _cust) {
        ...
        method_ = new StandardMethod(aliasSetContent, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getCoreNames().getAliasObject());
        method_ = new StandardMethod(aliasWindowTypeRelative, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        ...
        method_ = new StandardMethod(aliasSetVisible, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(aliasSetMenuBar, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasWindowListener);
        method_ = new StandardMethod(aliasAddWindowListener, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(aliasConfirmField, params_, _content.getCharSeq(). getAliasString(), false, MethodModifier.STATIC);
        methods_.add( method_);
        ...
        methods_.add( method_);
        params_ = new StringList(aliasImage,aliasWindowType,_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasConfirmFull, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(aliasWindowType,_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasConfirmFull, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.STATIC);
        methods_.add( method_);
        ...
        method_ = new StandardMethod(aliasConfirmYesNo, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.STATIC);
        methods_.add( method_);
        ...
        method_ = new StandardMethod(aliasConfirmOk, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.STATIC);
        methods_.add( method_);
        ...
        methods_.add( method_);
        params_ = new StringList(aliasImage,aliasWindowType,_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasConfirmMessage, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(aliasWindowType,_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString(),_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasConfirmMessage, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.STATIC);
        methods_.add( method_);
        ...
        method_ = new StandardMethod(aliasWindowSetAdd, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasWindowSetAll, params_, aliasWindowSet, false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(aliasWindow);
        method_ = new StandardMethod(aliasWindowSetContains, params_, _content.getPrimTypes().getAliasPrimBoolean(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasWindow);
        method_ = new StandardMethod(aliasWindowSetRemove, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasDialogSetModal, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ctor_ = new StandardConstructor(params_,false);
        constructors_.add(ctor_);
        ...
        method_ = new StandardMethod(aliasSetFont, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasCompBack, params_, aliasColor, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasColor);
        method_ = new StandardMethod(aliasCompBack, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasCompFore, params_, aliasColor, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasColor);
        method_ = new StandardMethod(aliasCompFore, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasCompFocusable, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasCompOpaque, params_, _content.getPrimTypes().getAliasPrimBoolean(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasCompOpaque, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(aliasCompToolTip, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(aliasCompLoc, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasColor);
        method_ = new StandardMethod(aliasCompBorLine, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasColor,_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasCompBorLine, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasCompBorTitle, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(aliasComponentSetPaint, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(type_);
        method_ = new StandardMethod(aliasComponentSetAutoscrolls, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(aliasComponentSetPreferredSize, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasComponentSetVisible, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_cust.getAliasRunnable());
        method_ = new StandardMethod(aliasComponentInvokeLater, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList(aliasKeyListener);
        method_ = new StandardMethod(aliasAddKeyListener, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasWheelListener);
        method_ = new StandardMethod(aliasAddWheelListener, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasMouseListener);
        method_ = new StandardMethod(aliasAddListener, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(aliasTreeNodeAdd, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),aliasTreeNode);
        method_ = new StandardMethod(aliasTreeNodeInsert, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTreeNodeRemove, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasTreeNode);
        method_ = new StandardMethod(aliasTreeNodeRemove, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasTreeNodeSetUserObject, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(aliasTreeNode);
        method_ = new StandardMethod(aliasTreeNodeIsAncestor, params_,_content.getPrimTypes().getAliasPrimBoolean(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasTreeNode);
        method_ = new StandardMethod(aliasTreeNodeIsDescendant, params_,_content.getPrimTypes().getAliasPrimBoolean(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ctor_ = new StandardConstructor(params_,false);
        constructors_.add(ctor_);
        ...
        method_ = new StandardMethod(aliasTreeAddTreeListener, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasTreeSetRootVisible, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(aliasTreeNode);
        method_ = new StandardMethod(aliasTreeGetSelected, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        params_ = new StringList(aliasMouseListener);
        method_ = new StandardMethod(aliasTableAddHeader, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasTableListener);
        method_ = new StandardMethod(aliasTableAddSelect, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasTableSetMultiple, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasTableSetReorder, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTableGetColumnName, params_, _content.getCharSeq(). getAliasString(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTableGetColumnAtPoint, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTableGetRowAtPoint, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasTableSetColumns, params_, _content.getCoreNames(). getAliasVoid(), true, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTableMoveColumn, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTableGetValue, params_, _content.getCharSeq(). getAliasString(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        ...
        method_ = new StandardMethod(aliasAddCompo, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasComponent,_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasAddCompo, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasComponent);
        method_ = new StandardMethod(aliasRemoveCompo, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasRemoveCompo, params_, aliasComponent, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasGetIndexCompo, params_, aliasComponent, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasPanelGrid, params_, aliasPanel, false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(aliasTabbedPaneAdd, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTabbedPaneSelIndex, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasComponent);
        method_ = new StandardMethod(aliasTabbedPaneIndex, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasComponent);
        method_ = new StandardMethod(aliasTabbedPaneRemove, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTabbedPaneRemove, params_, aliasComponent, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),aliasComponent);
        method_ = new StandardMethod(aliasTabbedPaneSet, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasTabbedPaneSetTitle, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTabbedPaneGet, params_, aliasComponent, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTabbedPaneGetTitle, params_, _content.getCharSeq(). getAliasString(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasScrollPaneHorizontalValue, params_,_content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasScrollPaneVerticalValue, params_,_content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(aliasComponent);
        method_ = new StandardMethod(aliasScrollPaneSetView, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ctor_ = new StandardConstructor(params_,false);
        constructors_.add(ctor_);
        ...
        methods_.add( method_);
        params_ = new StringList(aliasComponent);
        method_ = new StandardMethod(aliasSplitPaneSetLeft, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasSplitPaneGetRight, params_,aliasComponent, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasComponent);
        method_ = new StandardMethod(aliasSplitPaneSetRight, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasSplitPaneSetDividerLocation, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasSplitPaneSetDividerSize, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasSplitPaneSetOneTouchExpandable, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasSplitPaneSetContinuousLayout, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasInputSetEnabled, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        std_ = stdcl_;
        ...
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasProgBarMin, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasProgBarMin, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasProgBarValue, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasProgBarMax, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasProgBarMax, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasProgBarOr, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasSetLabelText, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ctor_ = new StandardConstructor(params_,false);
        constructors_.add(ctor_);
        ...
        method_ = new StandardMethod(aliasSetLabelImage, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ctor_ = new StandardConstructor(params_,false);
        constructors_.add(ctor_);
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasFontStringWidth, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasImage,_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasFontStringWidth, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.STATIC);
        methods_.add( method_);
        params_ = new StringList();
        ctor_ = new StandardConstructor(params_,false);
        constructors_.add(ctor_);
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasImageGet, params_, _content.getPrimTypes().getAliasPrimInteger(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger(), _content.getPrimTypes().getAliasPrimInteger());
        ...
        methods_.add( method_);
        params_ = new StringList(aliasColor);
        method_ = new StandardMethod(aliasImageSetColor, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasImageGetFont, params_, aliasFont, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasFont);
        method_ = new StandardMethod(aliasImageSetFont, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);

        params_ = new StringList(aliasImage,_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasImageDraw, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString(),_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasImageDraw, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasImageDrawOval, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(arrInt_,arrInt_);
        method_ = new StandardMethod(aliasImageDrawPolygon, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        ...
        methods_.add( method_);
        params_ = new StringList(arrInt_,arrInt_);
        method_ = new StandardMethod(aliasImageFillPolygon, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
    ...
    private void buildMenus(LgNamesContent _content) {
        ...
        method_ = new StandardMethod(aliasMenuBarAdd, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasMenu);
        method_ = new StandardMethod(aliasMenuBarRemove, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasMenuBarGet, params_, aliasMenu, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasAbsMenuSetText, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasAbsMenuGetText, params_, _content.getCharSeq(). getAliasString(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasAbsMenuSetEnabled, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasAbsMenuSetDeepEnabled, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        ...
        method_ = new StandardMethod(aliasMenuAdd, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasAbsMenu);
        method_ = new StandardMethod(aliasMenuRemove, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasMenuGet, params_, aliasAbsMenu, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        params_ = new StringList(aliasActionListener);
        method_ = new StandardMethod(aliasAbsMenuItemAddAction, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        ...
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasMenuItemCheckSetSelected, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
    ...
    private void buildInputs(LgNamesContent _content) {
        ...
        method_ = new StandardMethod(aliasRenderSetHeight, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        ...
        method_ = new StandardMethod(aliasRenderSetWidth, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        ...
        method_ = new StandardMethod(aliasRenderSetPaint, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        ...
        method_ = new StandardMethod(aliasGrListSetRender, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(aliasGrListSetSelection, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasGrListSetVisibleRowCount, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getCoreNames().getAliasObject());
        method_ = new StandardMethod(aliasGrListAdd, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),aliasImageLabel,_content.getCoreNames().getAliasObject());
        method_ = new StandardMethod(aliasGrListAdd, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),aliasImageLabel,_content.getCoreNames().getAliasObject());
        method_ = new StandardMethod(aliasGrListSet, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasGrListSetSelectedIndexes, params_, _content.getCoreNames(). getAliasVoid(), true, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasGrListRemove, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(aliasListSelection);
        method_ = new StandardMethod(aliasComboSetListener, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasComboAddItem, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasComboSelectItem, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasComboRemoveItem, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        method_ = new StandardMethod(aliasButtonGroupAdd, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        ...
        params_ = new StringList(aliasComponent);
        method_ = new StandardMethod(aliasPopupMenuAdd, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasPopupMenuGetComp, params_, aliasComponent, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasComponent);
        method_ = new StandardMethod(aliasPopupMenuRemoveComp, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(aliasAbsMenu);
        method_ = new StandardMethod(aliasPopupMenuAddMenu, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasPopupMenuGetMenu, params_, aliasAbsMenu, false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasAbsMenu);
        method_ = new StandardMethod(aliasPopupMenuRemoveMenu, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasRadioSetSelected, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasRadioGetText, params_, _content.getCharSeq(). getAliasString(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasRadioSetText, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasChangeListener);
        method_ = new StandardMethod(aliasAddChange, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ctor_ = new StandardConstructor(params_,false);
        constructors_.add(ctor_);
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimBoolean());
        method_ = new StandardMethod(aliasCheckBoxSetSelected, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasCheckBoxGetText, params_, _content.getCharSeq(). getAliasString(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasCheckBoxSetText, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ctor_ = new StandardConstructor(params_,false);
        constructors_.add(ctor_);
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasTextFieldSetText, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasActionListener);
        method_ = new StandardMethod(aliasTextFieldAddAction, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ctor_ = new StandardConstructor(params_,false);
        constructors_.add(ctor_);
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasTextAreaSetText, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasTextAreaAppend, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTextAreaInsert, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTextAreaSetSelectionStart, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTextAreaSetSelectionEnd, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTextAreaSetTabSize, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString(),_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getCharSeq(). getAliasString());
        method_ = new StandardMethod(aliasTextAreaReplaceSelection, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasTextAreaSelect, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasSpinnerSetMax, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasSpinnerSetMin, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasSpinnerSetValue, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasSpinnerSetStep, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasSpinnerSetRange, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger(),_content.getPrimTypes().getAliasPrimInteger());
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasSliderSetMin, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList();
        ...
        methods_.add( method_);
        params_ = new StringList(_content.getPrimTypes().getAliasPrimInteger());
        method_ = new StandardMethod(aliasSliderSetOrientation, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
        params_ = new StringList(aliasChangeListener);
        method_ = new StandardMethod(aliasAddChange, params_, _content.getCoreNames(). getAliasVoid(), false, MethodModifier.FINAL);
        methods_.add( method_);
    ...
    public ResultErrorStd getOtherResult(CustAliases _custAliases,ContextEl _cont, Struct _instance,
        ...
        return _custAliases.getOtherResult(_cont,_instance,_method,_args);
    }
    ...
    public void otherAliasGui(StringMap<String> _util, StringMap<String> _cust) {
        setAliasTreeNode(CustAliases.get(_util, _cust, TREE_NODE));
        setAliasTree(CustAliases.get(_util, _cust, TREE));
        setAliasTableGui(CustAliases.get(_util, _cust, TABLE_GUI));
        setAliasButton(CustAliases.get(_util, _cust, BUTTON));
        setAliasConfirm(CustAliases.get(_util, _cust, CONFIRM));
        setAliasFrame(CustAliases.get(_util, _cust, FRAME));
        setAliasDialog(CustAliases.get(_util, _cust, DIALOG));
        setAliasPanel(CustAliases.get(_util, _cust, PANEL));
        setAliasProgBar(CustAliases.get(_util, _cust, PROG_BAR));
        setAliasImageSet(CustAliases.get(_util, _cust, IMAGE_SET));
        setAliasArgs(CustAliases.get(_util, _cust, ARGS));
        setAliasKeyEvent(CustAliases.get(_util, _cust, KEY_EVENT));
        setAliasRadio(CustAliases.get(_util, _cust, RADIO));
        setAliasCheckBox(CustAliases.get(_util, _cust, CHECK_BOX));
        setAliasSetFont(CustAliases.get(_util, _cust, SET_FONT));
        setAliasSpinner(CustAliases.get(_util, _cust, SPINNER));
        setAliasDispose(CustAliases.get(_util, _cust, DISPOSE));
        setAliasGrList(CustAliases.get(_util, _cust, GR_LIST));
        setAliasGetFont(CustAliases.get(_util, _cust, GET_FONT));
        setAliasImage(CustAliases.get(_util, _cust, IMAGE));
        setAliasSlider(CustAliases.get(_util, _cust, SLIDER));
        setAliasPaintAdd(CustAliases.get(_util, _cust, PAINT_ADD));
        setAliasCount(CustAliases.get(_util, _cust, COUNT));
        setAliasPack(CustAliases.get(_util, _cust, PACK));
        setAliasColor(CustAliases.get(_util, _cust, COLOR));
        setAliasWindow(CustAliases.get(_util, _cust, WINDOW));
        setAliasWindowSet(CustAliases.get(_util, _cust, WINDOW_SET));
        setAliasWindowSetAdd(CustAliases.get(_util, _cust, WINDOW_SET_ADD));
        setAliasWindowSetAll(CustAliases.get(_util, _cust, WINDOW_SET_ALL));
        setAliasWindowSetContains(CustAliases.get(_util, _cust, WINDOW_SET_CONTAINS));
        setAliasWindowSetRemove(CustAliases.get(_util, _cust, WINDOW_SET_REMOVE));
        setAliasWindowSetSnapshot(CustAliases.get(_util, _cust, WINDOW_SET_SNAPSHOT));
        setAliasCompBack(CustAliases.get(_util, _cust, COMP_BACK));
        setAliasPaint(CustAliases.get(_util, _cust, PAINT));
        setAliasCompLoc(CustAliases.get(_util, _cust, COMP_LOC));
        setAliasImageGet(CustAliases.get(_util, _cust, IMAGE_GET));
        setAliasRender(CustAliases.get(_util, _cust, RENDER));
        setAliasCombo(CustAliases.get(_util, _cust, COMBO));
        setAliasAddCompo(CustAliases.get(_util, _cust, ADD_COMPO));
        setAliasInput(CustAliases.get(_util, _cust, INPUT));
        setAliasFont(CustAliases.get(_util, _cust, FONT));
        setAliasCompFore(CustAliases.get(_util, _cust, COMP_FORE));
        setAliasKeyTyped(CustAliases.get(_util, _cust, KEY_TYPED));
        setAliasColorRed(CustAliases.get(_util, _cust, COLOR_RED));
        setAliasTextArea(CustAliases.get(_util, _cust, TEXT_AREA));
        setAliasFontGetSize(CustAliases.get(_util, _cust, FONT_GET_SIZE));
        setAliasDimension(CustAliases.get(_util, _cust, DIMENSION));
        setAliasProgBarOr(CustAliases.get(_util, _cust, PROG_BAR_OR));
        setAliasFontIsBold(CustAliases.get(_util, _cust, FONT_IS_BOLD));
        setAliasDimensionGetHeight(CustAliases.get(_util, _cust, DIMENSION_GET_HEIGHT));
        setAliasPanelBorderNorth(CustAliases.get(_util, _cust, PANEL_BORDER_NORTH));
        setAliasPanelBorderSouth(CustAliases.get(_util, _cust, PANEL_BORDER_SOUTH));
        setAliasRemoveWindowListener(CustAliases.get(_util, _cust, REMOVE_WINDOW_LISTENER));
        setAliasWindowTypeRelative(CustAliases.get(_util, _cust, WINDOW_TYPE_RELATIVE));
        setAliasPanelBorderAfterLast(CustAliases.get(_util, _cust, PANEL_BORDER_AFTER_LAST));
        setAliasFontGetName(CustAliases.get(_util, _cust, FONT_GET_NAME));
        setAliasDimensionGetWidth(CustAliases.get(_util, _cust, DIMENSION_GET_WIDTH));
        setAliasComponent(CustAliases.get(_util, _cust, COMPONENT));
        setAliasPanelBorderAfterLineEnds(CustAliases.get(_util, _cust, PANEL_BORDER_AFTER_LINE_ENDS));
        setAliasComponentSetAutoscrolls(CustAliases.get(_util, _cust, COMPONENT_SET_AUTOSCROLLS));
        setAliasComponentIsAutoscrolls(CustAliases.get(_util, _cust, COMPONENT_IS_AUTOSCROLLS));
        setAliasComponentGetWidth(CustAliases.get(_util, _cust, COMPONENT_GET_WIDTH));
        setAliasComponentGetHeight(CustAliases.get(_util, _cust, COMPONENT_GET_HEIGHT));
        setAliasPanelBorderEast(CustAliases.get(_util, _cust, PANEL_BORDER_EAST));
        setAliasProgBarMax(CustAliases.get(_util, _cust, PROG_BAR_MAX));
        setAliasGetWindowListeners(CustAliases.get(_util, _cust, GET_WINDOW_LISTENERS));
        setAliasPanelBorderBeforeFirst(CustAliases.get(_util, _cust, PANEL_BORDER_BEFORE_FIRST));
        setAliasTextLabel(CustAliases.get(_util, _cust, TEXT_LABEL));
        setAliasPanelBorderWest(CustAliases.get(_util, _cust, PANEL_BORDER_WEST));
        setAliasProgBarMin(CustAliases.get(_util, _cust, PROG_BAR_MIN));
        setAliasProgBarValue(CustAliases.get(_util, _cust, PROG_BAR_VALUE));
        setAliasPanelBorder(CustAliases.get(_util, _cust, PANEL_BORDER));
        setAliasFontIsItalic(CustAliases.get(_util, _cust, FONT_IS_ITALIC));
        setAliasImageLabel(CustAliases.get(_util, _cust, IMAGE_LABEL));
        setAliasPanelBorderCenter(CustAliases.get(_util, _cust, PANEL_BORDER_CENTER));
        setAliasFontStringWidth(CustAliases.get(_util, _cust, FONT_STRING_WIDTH));
        setAliasTableSetColumns(CustAliases.get(_util, _cust, TABLE_SET_COLUMNS));
        setAliasTreeIsRootVisible(CustAliases.get(_util, _cust, TREE_IS_ROOT_VISIBLE));
        setAliasTreeNodeRemoveFromParent(CustAliases.get(_util, _cust, TREE_NODE_REMOVE_FROM_PARENT));
        setAliasTreeNodeSetUserObject(CustAliases.get(_util, _cust, TREE_NODE_SET_USER_OBJECT));
        setAliasTreeReload(CustAliases.get(_util, _cust, TREE_RELOAD));
        setAliasTreeAddTreeListener(CustAliases.get(_util, _cust, TREE_ADD_TREE_LISTENER));
        setAliasTreeNodeNb(CustAliases.get(_util, _cust, TREE_NODE_NB));
        setAliasTableIsMultiple(CustAliases.get(_util, _cust, TABLE_IS_MULTIPLE));
        setAliasTableListener(CustAliases.get(_util, _cust, TABLE_LISTENER));
        setAliasTableGetRowCount(CustAliases.get(_util, _cust, TABLE_GET_ROW_COUNT));
        setAliasTreeNodeIsAncestor(CustAliases.get(_util, _cust, TREE_NODE_IS_ANCESTOR));
        setAliasTreeNodeGetNextSibling(CustAliases.get(_util, _cust, TREE_NODE_GET_NEXT_SIBLING));
        setAliasTreeNodeGetLastChild(CustAliases.get(_util, _cust, TREE_NODE_GET_LAST_CHILD));
        setAliasTreeSetRootVisible(CustAliases.get(_util, _cust, TREE_SET_ROOT_VISIBLE));
        setAliasTableSetMultiple(CustAliases.get(_util, _cust, TABLE_SET_MULTIPLE));
        setAliasTreeNodeGetParentNode(CustAliases.get(_util, _cust, TREE_NODE_GET_PARENT_NODE));
        setAliasTreeNodeRemove(CustAliases.get(_util, _cust, TREE_NODE_REMOVE));
        setAliasTableGetSelectedRow(CustAliases.get(_util, _cust, TABLE_GET_SELECTED_ROW));
        setAliasTreeNodeGetFirstChild(CustAliases.get(_util, _cust, TREE_NODE_GET_FIRST_CHILD));
        setAliasTreeNodeGetUserObject(CustAliases.get(_util, _cust, TREE_NODE_GET_USER_OBJECT));
        setAliasTableGetSelectedRows(CustAliases.get(_util, _cust, TABLE_GET_SELECTED_ROWS));
        setAliasTableValueTableChanged(CustAliases.get(_util, _cust, TABLE_VALUE_TABLE_CHANGED));
        setAliasTableGetColumnCount(CustAliases.get(_util, _cust, TABLE_GET_COLUMN_COUNT));
        setAliasTableGetRowAtPoint(CustAliases.get(_util, _cust, TABLE_GET_ROW_AT_POINT));
        setAliasTableSetRowCount(CustAliases.get(_util, _cust, TABLE_SET_ROW_COUNT));
        setAliasTableGetColumnName(CustAliases.get(_util, _cust, TABLE_GET_COLUMN_NAME));
        setAliasTableGetValue(CustAliases.get(_util, _cust, TABLE_GET_VALUE));
        setAliasTreeNodeIsDescendant(CustAliases.get(_util, _cust, TREE_NODE_IS_DESCENDANT));
        setAliasTableSetValue(CustAliases.get(_util, _cust, TABLE_SET_VALUE));
        setAliasTreeGetSelected(CustAliases.get(_util, _cust, TREE_GET_SELECTED));
        setAliasTableGetSelectedRowCount(CustAliases.get(_util, _cust, TABLE_GET_SELECTED_ROW_COUNT));
        setAliasTableGetColumnAtPoint(CustAliases.get(_util, _cust, TABLE_GET_COLUMN_AT_POINT));
        setAliasConfirmOk(CustAliases.get(_util, _cust, CONFIRM_OK));
        setAliasConfirmYesNo(CustAliases.get(_util, _cust, CONFIRM_YES_NO));
        setAliasTableRemoveInterval(CustAliases.get(_util, _cust, TABLE_REMOVE_INTERVAL));
        setAliasConfirmFieldOk(CustAliases.get(_util, _cust, CONFIRM_FIELD_OK));
        setAliasDialogSetModal(CustAliases.get(_util, _cust, DIALOG_SET_MODAL));
        setAliasTableApplyChanges(CustAliases.get(_util, _cust, TABLE_APPLY_CHANGES));
        setAliasTableIsReorder(CustAliases.get(_util, _cust, TABLE_IS_REORDER));
        setAliasConfirmFieldYes(CustAliases.get(_util, _cust, CONFIRM_FIELD_YES));
        setAliasTableSetReorder(CustAliases.get(_util, _cust, TABLE_SET_REORDER));
        setAliasConfirmField(CustAliases.get(_util, _cust, CONFIRM_FIELD));
        setAliasConfirmFieldNo(CustAliases.get(_util, _cust, CONFIRM_FIELD_NO));
        setAliasTableAddSelect(CustAliases.get(_util, _cust, TABLE_ADD_SELECT));
        setAliasConfirmMessage(CustAliases.get(_util, _cust, CONFIRM_MESSAGE));
        setAliasTableAddHeader(CustAliases.get(_util, _cust, TABLE_ADD_HEADER));
        setAliasConfirmFull(CustAliases.get(_util, _cust, CONFIRM_FULL));
        setAliasDialogIsModal(CustAliases.get(_util, _cust, DIALOG_IS_MODAL));
        setAliasWindowType(CustAliases.get(_util, _cust, WINDOW_TYPE));
        setAliasTableAddInterval(CustAliases.get(_util, _cust, TABLE_ADD_INTERVAL));
        setAliasTableMoveColumn(CustAliases.get(_util, _cust, TABLE_MOVE_COLUMN));
        setAliasConfirmFieldCancel(CustAliases.get(_util, _cust, CONFIRM_FIELD_CANCEL));
        setAliasTextAreaSetSelectionStart(CustAliases.get(_util, _cust, TEXT_AREA_SET_SELECTION_START));
        setAliasTreeListener(CustAliases.get(_util, _cust, TREE_LISTENER));
        setAliasTreeNodeAdd(CustAliases.get(_util, _cust, TREE_NODE_ADD));
        setAliasTreeListenerValueChanged(CustAliases.get(_util, _cust, TREE_LISTENER_VALUE_CHANGED));
        setAliasTreeNodeInsert(CustAliases.get(_util, _cust, TREE_NODE_INSERT));
        setAliasActionEvent(CustAliases.get(_util, _cust, ACTION_EVENT));
        setAliasChangeListener(CustAliases.get(_util, _cust, CHANGE_LISTENER));
        setAliasActionListener(CustAliases.get(_util, _cust, ACTION_LISTENER));
        setAliasActionPerformed(CustAliases.get(_util, _cust, ACTION_PERFORMED));
        setAliasAddChange(CustAliases.get(_util, _cust, ADD_CHANGE));
        setAliasStateChanged(CustAliases.get(_util, _cust, STATE_CHANGED));
        setAliasTreeNodeGetPreviousSibling(CustAliases.get(_util, _cust, TREE_NODE_GET_PREVIOUS_SIBLING));
        setAliasComponentGetPreferredSize(CustAliases.get(_util, _cust, COMPONENT_GET_PREFERRED_SIZE));
        setAliasSplitPaneSetDividerLocation(CustAliases.get(_util, _cust, SPLIT_PANE_SET_DIVIDER_LOCATION));
        setAliasSplitPaneIsOneTouchExpandable(CustAliases.get(_util, _cust, SPLIT_PANE_IS_ONE_TOUCH_EXPANDABLE));
        setAliasSplitPaneSetOneTouchExpandable(CustAliases.get(_util, _cust, SPLIT_PANE_SET_ONE_TOUCH_EXPANDABLE));
        setAliasSplitPaneIsContinuousLayout(CustAliases.get(_util, _cust, SPLIT_PANE_IS_CONTINUOUS_LAYOUT));
        setAliasScrollPaneHorizontalValue(CustAliases.get(_util, _cust, SCROLL_PANE_HORIZONTAL_VALUE));
        setAliasTreeNodeRemoveAllChildren(CustAliases.get(_util, _cust, TREE_NODE_REMOVE_ALL_CHILDREN));
        setAliasPanelBorderBeforeLineBegins(CustAliases.get(_util, _cust, PANEL_BORDER_BEFORE_LINE_BEGINS));
        setAliasComponentSetPreferredSize(CustAliases.get(_util, _cust, COMPONENT_SET_PREFERRED_SIZE));
        setAliasSplitPaneGetDividerLocation(CustAliases.get(_util, _cust, SPLIT_PANE_GET_DIVIDER_LOCATION));
        setAliasSplitPaneSetContinuousLayout(CustAliases.get(_util, _cust, SPLIT_PANE_SET_CONTINUOUS_LAYOUT));
        setAliasMouseEventIsCtrl(CustAliases.get(_util, _cust, MOUSE_EVENT_IS_CTRL));
        setAliasMouseReleased(CustAliases.get(_util, _cust, MOUSE_RELEASED));
        setAliasMouseEventIsShift(CustAliases.get(_util, _cust, MOUSE_EVENT_IS_SHIFT));
        setAliasScrollPaneGetView(CustAliases.get(_util, _cust, SCROLL_PANE_GET_VIEW));
        setAliasPaintRefresh(CustAliases.get(_util, _cust, PAINT_REFRESH));
        setAliasMouseExited(CustAliases.get(_util, _cust, MOUSE_EXITED));
        setAliasSplitPane(CustAliases.get(_util, _cust, SPLIT_PANE));
        setAliasSplitPaneSetRight(CustAliases.get(_util, _cust, SPLIT_PANE_SET_RIGHT));
        setAliasSetVisible(CustAliases.get(_util, _cust, SET_VISIBLE));
        setAliasRemoveCompo(CustAliases.get(_util, _cust, REMOVE_COMPO));
        setAliasMouseClicked(CustAliases.get(_util, _cust, MOUSE_CLICKED));
        setAliasMouseMoved(CustAliases.get(_util, _cust, MOUSE_MOVED));
        setAliasMouseEvent(CustAliases.get(_util, _cust, MOUSE_EVENT));
        setAliasMouseEventGetClicks(CustAliases.get(_util, _cust, MOUSE_EVENT_GET_CLICKS));
        setAliasMouseEventIsAlt(CustAliases.get(_util, _cust, MOUSE_EVENT_IS_ALT));
        setAliasMouseEventGetSecond(CustAliases.get(_util, _cust, MOUSE_EVENT_GET_SECOND));
        setAliasScrollPane(CustAliases.get(_util, _cust, SCROLL_PANE));
        setAliasScrollPaneValidate(CustAliases.get(_util, _cust, SCROLL_PANE_VALIDATE));
        setAliasSplitPaneSetDividerSize(CustAliases.get(_util, _cust, SPLIT_PANE_SET_DIVIDER_SIZE));
        setAliasSplitPaneGetLeft(CustAliases.get(_util, _cust, SPLIT_PANE_GET_LEFT));
        setAliasSplitPaneGetDividerSize(CustAliases.get(_util, _cust, SPLIT_PANE_GET_DIVIDER_SIZE));
        setAliasSplitPaneValidate(CustAliases.get(_util, _cust, SPLIT_PANE_VALIDATE));
        setAliasMouseEntered(CustAliases.get(_util, _cust, MOUSE_ENTERED));
        setAliasScrollPaneSetView(CustAliases.get(_util, _cust, SCROLL_PANE_SET_VIEW));
        setAliasSplitPaneSetLeft(CustAliases.get(_util, _cust, SPLIT_PANE_SET_LEFT));
        setAliasMousePressed(CustAliases.get(_util, _cust, MOUSE_PRESSED));
        setAliasMouseListener(CustAliases.get(_util, _cust, MOUSE_LISTENER));
        setAliasIsVisible(CustAliases.get(_util, _cust, IS_VISIBLE));
        setAliasMouseDragged(CustAliases.get(_util, _cust, MOUSE_DRAGGED));
        setAliasScrollPaneVerticalValue(CustAliases.get(_util, _cust, SCROLL_PANE_VERTICAL_VALUE));
        setAliasSplitPaneGetRight(CustAliases.get(_util, _cust, SPLIT_PANE_GET_RIGHT));
        setAliasMouseEventGetFirst(CustAliases.get(_util, _cust, MOUSE_EVENT_GET_FIRST));
        setAliasGetIndexCompo(CustAliases.get(_util, _cust, GET_INDEX_COMPO));
        setAliasImageFillPolygon(CustAliases.get(_util, _cust, IMAGE_FILL_POLYGON));
        setAliasComponentIsVisible(CustAliases.get(_util, _cust, COMPONENT_IS_VISIBLE));
        setAliasImageDrawRect(CustAliases.get(_util, _cust, IMAGE_DRAW_RECT));
        setAliasComponentSetVisible(CustAliases.get(_util, _cust, COMPONENT_SET_VISIBLE));
        setAliasComponentSetSize(CustAliases.get(_util, _cust, COMPONENT_SET_SIZE));
        setAliasImageGetColor(CustAliases.get(_util, _cust, IMAGE_GET_COLOR));
        setAliasImageDrawOval(CustAliases.get(_util, _cust, IMAGE_DRAW_OVAL));
        setAliasComponentInvokeLater(CustAliases.get(_util, _cust, COMPONENT_INVOKE_LATER));
        setAliasImageGetHeight(CustAliases.get(_util, _cust, IMAGE_GET_HEIGHT));
        setAliasImageSetFont(CustAliases.get(_util, _cust, IMAGE_SET_FONT));
        setAliasImageDispose(CustAliases.get(_util, _cust, IMAGE_DISPOSE));
        setAliasImageGetFont(CustAliases.get(_util, _cust, IMAGE_GET_FONT));
        setAliasColorIsTransparent(CustAliases.get(_util, _cust, COLOR_IS_TRANSPARENT));
        setAliasImageDrawLine(CustAliases.get(_util, _cust, IMAGE_DRAW_LINE));
        setAliasImageFillRect(CustAliases.get(_util, _cust, IMAGE_FILL_RECT));
        setAliasColorBlue(CustAliases.get(_util, _cust, COLOR_BLUE));
        setAliasImageDrawPolygon(CustAliases.get(_util, _cust, IMAGE_DRAW_POLYGON));
        setAliasComponentRepaint(CustAliases.get(_util, _cust, COMPONENT_REPAINT));
        setAliasImageIsWithAlpha(CustAliases.get(_util, _cust, IMAGE_IS_WITH_ALPHA));
        setAliasImageGetWidth(CustAliases.get(_util, _cust, IMAGE_GET_WIDTH));
        setAliasColorGreen(CustAliases.get(_util, _cust, COLOR_GREEN));
        setAliasComponentSetPaint(CustAliases.get(_util, _cust, COMPONENT_SET_PAINT));
        setAliasRemoveAll(CustAliases.get(_util, _cust, REMOVE_ALL));
        setAliasImageFillOval(CustAliases.get(_util, _cust, IMAGE_FILL_OVAL));
        setAliasColorAlpha(CustAliases.get(_util, _cust, COLOR_ALPHA));
        setAliasImageDraw(CustAliases.get(_util, _cust, IMAGE_DRAW));
        setAliasImageSetColor(CustAliases.get(_util, _cust, IMAGE_SET_COLOR));
        setAliasSetContent(CustAliases.get(_util, _cust, SET_CONTENT));
        setAliasGetNextCompo(CustAliases.get(_util, _cust, GET_NEXT_COMPO));
        setAliasComponentGetPaint(CustAliases.get(_util, _cust, COMPONENT_GET_PAINT));
        setAliasGetParentCompo(CustAliases.get(_util, _cust, GET_PARENT_COMPO));
        setAliasSetLabelText(CustAliases.get(_util, _cust, SET_LABEL_TEXT));
        setAliasSetLabelImage(CustAliases.get(_util, _cust, SET_LABEL_IMAGE));
        setAliasTabbedPaneSetTitle(CustAliases.get(_util, _cust, TABBED_PANE_SET_TITLE));
        setAliasTabbedPaneAdd(CustAliases.get(_util, _cust, TABBED_PANE_ADD));
        setAliasTabbedPaneNb(CustAliases.get(_util, _cust, TABBED_PANE_NB));
        setAliasPanelFlow(CustAliases.get(_util, _cust, PANEL_FLOW));
        setAliasTabbedPaneRemove(CustAliases.get(_util, _cust, TABBED_PANE_REMOVE));
        setAliasAddWindowListener(CustAliases.get(_util, _cust, ADD_WINDOW_LISTENER));
        setAliasPaintMethod(CustAliases.get(_util, _cust, PAINT_METHOD));
        setAliasPanelPageBox(CustAliases.get(_util, _cust, PANEL_PAGE_BOX));
        setAliasPanelAbsolute(CustAliases.get(_util, _cust, PANEL_ABSOLUTE));
        setAliasPanelGrid(CustAliases.get(_util, _cust, PANEL_GRID));
        setAliasTabbedPaneGet(CustAliases.get(_util, _cust, TABBED_PANE_GET));
        setAliasTabbedPane(CustAliases.get(_util, _cust, TABBED_PANE));
        setAliasTabbedPaneGetTitle(CustAliases.get(_util, _cust, TABBED_PANE_GET_TITLE));
        setAliasPanelValidate(CustAliases.get(_util, _cust, PANEL_VALIDATE));
        setAliasTabbedPaneIndex(CustAliases.get(_util, _cust, TABBED_PANE_INDEX));
        setAliasTabbedPaneSet(CustAliases.get(_util, _cust, TABBED_PANE_SET));
        setAliasTabbedPaneSelIndex(CustAliases.get(_util, _cust, TABBED_PANE_SEL_INDEX));
        setAliasAddListener(CustAliases.get(_util, _cust, ADD_LISTENER));
        setAliasMenuItemCheck(CustAliases.get(_util, _cust, MENU_ITEM_CHECK));
        setAliasMenuAddSeparator(CustAliases.get(_util, _cust, MENU_ADD_SEPARATOR));
        setAliasAbsMenuItem(CustAliases.get(_util, _cust, ABS_MENU_ITEM));
        setAliasMenuItemCheckIsSelected(CustAliases.get(_util, _cust, MENU_ITEM_CHECK_IS_SELECTED));
        setAliasAbsMenuSetEnabled(CustAliases.get(_util, _cust, ABS_MENU_SET_ENABLED));
        setAliasMenuRemove(CustAliases.get(_util, _cust, MENU_REMOVE));
        setAliasAbsMenuItemAddAction(CustAliases.get(_util, _cust, ABS_MENU_ITEM_ADD_ACTION));
        setAliasAbsMenuSetText(CustAliases.get(_util, _cust, ABS_MENU_SET_TEXT));
        setAliasAbsMenuGetText(CustAliases.get(_util, _cust, ABS_MENU_GET_TEXT));
        setAliasMenuItemCheckSetSelected(CustAliases.get(_util, _cust, MENU_ITEM_CHECK_SET_SELECTED));
        setAliasAbsMenuSetDeepEnabled(CustAliases.get(_util, _cust, ABS_MENU_SET_DEEP_ENABLED));
        setAliasCompToolTip(CustAliases.get(_util, _cust, COMP_TOOL_TIP));
        setAliasWindowClosed(CustAliases.get(_util, _cust, WINDOW_CLOSED));
        setAliasMouseEventIsRight(CustAliases.get(_util, _cust, MOUSE_EVENT_IS_RIGHT));
        setAliasKeyPressed(CustAliases.get(_util, _cust, KEY_PRESSED));
        setAliasMouseEventIsLeft(CustAliases.get(_util, _cust, MOUSE_EVENT_IS_LEFT));
        setAliasWheelListener(CustAliases.get(_util, _cust, WHEEL_LISTENER));
        setAliasCompBorLine(CustAliases.get(_util, _cust, COMP_BOR_LINE));
        setAliasKeyEventCode(CustAliases.get(_util, _cust, KEY_EVENT_CODE));
        setAliasRequestFocus(CustAliases.get(_util, _cust, REQUEST_FOCUS));
        setAliasCompBorRaise(CustAliases.get(_util, _cust, COMP_BOR_RAISE));
        setAliasWheelEvent(CustAliases.get(_util, _cust, WHEEL_EVENT));
        setAliasKeyEventIsShift(CustAliases.get(_util, _cust, KEY_EVENT_IS_SHIFT));
        setAliasCompGetFirstPos(CustAliases.get(_util, _cust, COMP_GET_FIRST_POS));
        setAliasCompBorTitle(CustAliases.get(_util, _cust, COMP_BOR_TITLE));
        setAliasAddKeyListener(CustAliases.get(_util, _cust, ADD_KEY_LISTENER));
        setAliasKeyEventIsAlt(CustAliases.get(_util, _cust, KEY_EVENT_IS_ALT));
        setAliasKeyListener(CustAliases.get(_util, _cust, KEY_LISTENER));
        setAliasKeyEventChar(CustAliases.get(_util, _cust, KEY_EVENT_CHAR));
        setAliasWindowListener(CustAliases.get(_util, _cust, WINDOW_LISTENER));
        setAliasWheelMove(CustAliases.get(_util, _cust, WHEEL_MOVE));
        setAliasCompGetSecondPos(CustAliases.get(_util, _cust, COMP_GET_SECOND_POS));
        setAliasKeyEventIsCtrl(CustAliases.get(_util, _cust, KEY_EVENT_IS_CTRL));
        setAliasMouseEventIsMiddle(CustAliases.get(_util, _cust, MOUSE_EVENT_IS_MIDDLE));
        setAliasWheelRotatedClicks(CustAliases.get(_util, _cust, WHEEL_ROTATED_CLICKS));
        setAliasCompBorLower(CustAliases.get(_util, _cust, COMP_BOR_LOWER));
        setAliasWindowOpened(CustAliases.get(_util, _cust, WINDOW_OPENED));
        setAliasCompFocusable(CustAliases.get(_util, _cust, COMP_FOCUSABLE));
        setAliasCompOpaque(CustAliases.get(_util, _cust, COMP_OPAQUE));
        setAliasWindowIconified(CustAliases.get(_util, _cust, WINDOW_ICONIFIED));
        setAliasKeyReleased(CustAliases.get(_util, _cust, KEY_RELEASED));
        setAliasAddWheelListener(CustAliases.get(_util, _cust, ADD_WHEEL_LISTENER));
        setAliasWindowClosing(CustAliases.get(_util, _cust, WINDOW_CLOSING));
        setAliasGrListSet(CustAliases.get(_util, _cust, GR_LIST_SET));
        setAliasWindowActivated(CustAliases.get(_util, _cust, WINDOW_ACTIVATED));
        setAliasWindowDeactivated(CustAliases.get(_util, _cust, WINDOW_DEACTIVATED));
        setAliasRenderSetHeight(CustAliases.get(_util, _cust, RENDER_SET_HEIGHT));
        setAliasListSelection(CustAliases.get(_util, _cust, LIST_SELECTION));
        setAliasRenderGetWidth(CustAliases.get(_util, _cust, RENDER_GET_WIDTH));
        setAliasRenderGetHeight(CustAliases.get(_util, _cust, RENDER_GET_HEIGHT));
        setAliasGrListGetSelectedIndexes(CustAliases.get(_util, _cust, GR_LIST_GET_SELECTED_INDEXES));
        setAliasGrListGetSelection(CustAliases.get(_util, _cust, GR_LIST_GET_SELECTION));
        setAliasRenderSetWidth(CustAliases.get(_util, _cust, RENDER_SET_WIDTH));
        setAliasInputIsEnabled(CustAliases.get(_util, _cust, INPUT_IS_ENABLED));
        setAliasGrListUpdateGraphics(CustAliases.get(_util, _cust, GR_LIST_UPDATE_GRAPHICS));
        setAliasGrListGetVisibleRowCount(CustAliases.get(_util, _cust, GR_LIST_GET_VISIBLE_ROW_COUNT));
        setAliasGrListClearSelection(CustAliases.get(_util, _cust, GR_LIST_CLEAR_SELECTION));
        setAliasRenderGetPaint(CustAliases.get(_util, _cust, RENDER_GET_PAINT));
        setAliasWindowEvent(CustAliases.get(_util, _cust, WINDOW_EVENT));
        setAliasGrListClear(CustAliases.get(_util, _cust, GR_LIST_CLEAR));
        setAliasGrListSetRender(CustAliases.get(_util, _cust, GR_LIST_SET_RENDER));
        setAliasGrListSetSelection(CustAliases.get(_util, _cust, GR_LIST_SET_SELECTION));
        setAliasGrListRemove(CustAliases.get(_util, _cust, GR_LIST_REMOVE));
        setAliasInputSetEnabled(CustAliases.get(_util, _cust, INPUT_SET_ENABLED));
        setAliasWindowDeiconified(CustAliases.get(_util, _cust, WINDOW_DEICONIFIED));
        setAliasValueChanged(CustAliases.get(_util, _cust, VALUE_CHANGED));
        setAliasGrListGetListView(CustAliases.get(_util, _cust, GR_LIST_GET_LIST_VIEW));
        setAliasRenderSetPaint(CustAliases.get(_util, _cust, RENDER_SET_PAINT));
        setAliasGrListAdd(CustAliases.get(_util, _cust, GR_LIST_ADD));
        setAliasGrListGetRender(CustAliases.get(_util, _cust, GR_LIST_GET_RENDER));
        setAliasGrListSetSelectedIndexes(CustAliases.get(_util, _cust, GR_LIST_SET_SELECTED_INDEXES));
        setAliasGrListSetVisibleRowCount(CustAliases.get(_util, _cust, GR_LIST_SET_VISIBLE_ROW_COUNT));
        setAliasComboGetSelectedItem(CustAliases.get(_util, _cust, COMBO_GET_SELECTED_ITEM));
        setAliasComboAddItem(CustAliases.get(_util, _cust, COMBO_ADD_ITEM));
        setAliasPopupMenuGetComp(CustAliases.get(_util, _cust, POPUP_MENU_GET_COMP));
        setAliasComboGetListener(CustAliases.get(_util, _cust, COMBO_GET_LISTENER));
        setAliasComboGetSelectedIndex(CustAliases.get(_util, _cust, COMBO_GET_SELECTED_INDEX));
        setAliasPopupMenu(CustAliases.get(_util, _cust, POPUP_MENU));
        setAliasPopupMenuAddMenu(CustAliases.get(_util, _cust, POPUP_MENU_ADD_MENU));
        setAliasPopupMenuNbMenu(CustAliases.get(_util, _cust, POPUP_MENU_NB_MENU));
        setAliasTextFieldAddPopup(CustAliases.get(_util, _cust, TEXT_FIELD_ADD_POPUP));
        setAliasPopupMenuNbComp(CustAliases.get(_util, _cust, POPUP_MENU_NB_COMP));
        setAliasComboRemoveAllItems(CustAliases.get(_util, _cust, COMBO_REMOVE_ALL_ITEMS));
        setAliasPopupMenuShow(CustAliases.get(_util, _cust, POPUP_MENU_SHOW));
        setAliasPopupMenuGetMenu(CustAliases.get(_util, _cust, POPUP_MENU_GET_MENU));
        setAliasTextFieldAuto(CustAliases.get(_util, _cust, TEXT_FIELD_AUTO));
        setAliasRadioGetText(CustAliases.get(_util, _cust, RADIO_GET_TEXT));
        setAliasButtonGroupAdd(CustAliases.get(_util, _cust, BUTTON_GROUP_ADD));
        setAliasButtonGroup(CustAliases.get(_util, _cust, BUTTON_GROUP));
        setAliasPopupMenuAdd(CustAliases.get(_util, _cust, POPUP_MENU_ADD));
        setAliasRadioIsSelected(CustAliases.get(_util, _cust, RADIO_IS_SELECTED));
        setAliasComboSetListener(CustAliases.get(_util, _cust, COMBO_SET_LISTENER));
        setAliasTextField(CustAliases.get(_util, _cust, TEXT_FIELD));
        setAliasComboRemoveItem(CustAliases.get(_util, _cust, COMBO_REMOVE_ITEM));
        setAliasRadioSetSelected(CustAliases.get(_util, _cust, RADIO_SET_SELECTED));
        setAliasTextFieldGetText(CustAliases.get(_util, _cust, TEXT_FIELD_GET_TEXT));
        setAliasPopupMenuRemoveMenu(CustAliases.get(_util, _cust, POPUP_MENU_REMOVE_MENU));
        setAliasTextFieldAddDocument(CustAliases.get(_util, _cust, TEXT_FIELD_ADD_DOCUMENT));
        setAliasComboGetSelectedIndexes(CustAliases.get(_util, _cust, COMBO_GET_SELECTED_INDEXES));
        setAliasTextFieldAddAction(CustAliases.get(_util, _cust, TEXT_FIELD_ADD_ACTION));
        setAliasTextAreaGetText(CustAliases.get(_util, _cust, TEXT_AREA_GET_TEXT));
        setAliasRadioSetText(CustAliases.get(_util, _cust, RADIO_SET_TEXT));
        setAliasComboSelectItem(CustAliases.get(_util, _cust, COMBO_SELECT_ITEM));
        setAliasComboGetItemCount(CustAliases.get(_util, _cust, COMBO_GET_ITEM_COUNT));
        setAliasPopupMenuRemoveComp(CustAliases.get(_util, _cust, POPUP_MENU_REMOVE_COMP));
        setAliasTextFieldSetText(CustAliases.get(_util, _cust, TEXT_FIELD_SET_TEXT));
        setAliasCheckBoxSetSelected(CustAliases.get(_util, _cust, CHECK_BOX_SET_SELECTED));
        setAliasCheckBoxAddAction(CustAliases.get(_util, _cust, CHECK_BOX_ADD_ACTION));
        setAliasTextAreaSetSelectionEnd(CustAliases.get(_util, _cust, TEXT_AREA_SET_SELECTION_END));
        setAliasSpinnerGetValue(CustAliases.get(_util, _cust, SPINNER_GET_VALUE));
        setAliasSliderGetMax(CustAliases.get(_util, _cust, SLIDER_GET_MAX));
        setAliasTextAreaSelect(CustAliases.get(_util, _cust, TEXT_AREA_SELECT));
        setAliasTextAreaReplaceRange(CustAliases.get(_util, _cust, TEXT_AREA_REPLACE_RANGE));
        setAliasSpinnerSetStep(CustAliases.get(_util, _cust, SPINNER_SET_STEP));
        setAliasCheckBoxIsSelected(CustAliases.get(_util, _cust, CHECK_BOX_IS_SELECTED));
        setAliasTextAreaReplaceSelection(CustAliases.get(_util, _cust, TEXT_AREA_REPLACE_SELECTION));
        setAliasSpinnerSetValue(CustAliases.get(_util, _cust, SPINNER_SET_VALUE));
        setAliasSliderGetValue(CustAliases.get(_util, _cust, SLIDER_GET_VALUE));
        setAliasSliderSetValue(CustAliases.get(_util, _cust, SLIDER_SET_VALUE));
        setAliasSliderGetMin(CustAliases.get(_util, _cust, SLIDER_GET_MIN));
        setAliasSliderSetMin(CustAliases.get(_util, _cust, SLIDER_SET_MIN));
        setAliasTextAreaSetTabSize(CustAliases.get(_util, _cust, TEXT_AREA_SET_TAB_SIZE));
        setAliasSpinnerGetMin(CustAliases.get(_util, _cust, SPINNER_GET_MIN));
        setAliasCheckBoxSetText(CustAliases.get(_util, _cust, CHECK_BOX_SET_TEXT));
        setAliasCheckBoxGetText(CustAliases.get(_util, _cust, CHECK_BOX_GET_TEXT));
        setAliasTextAreaInsert(CustAliases.get(_util, _cust, TEXT_AREA_INSERT));
        setAliasTextAreaSelectAll(CustAliases.get(_util, _cust, TEXT_AREA_SELECT_ALL));
        setAliasTextAreaAppend(CustAliases.get(_util, _cust, TEXT_AREA_APPEND));
        setAliasSpinnerGetMax(CustAliases.get(_util, _cust, SPINNER_GET_MAX));
        setAliasSpinnerSetMax(CustAliases.get(_util, _cust, SPINNER_SET_MAX));
        setAliasTextAreaGetTabSize(CustAliases.get(_util, _cust, TEXT_AREA_GET_TAB_SIZE));
        setAliasTextAreaSetText(CustAliases.get(_util, _cust, TEXT_AREA_SET_TEXT));
        setAliasSpinnerSetMin(CustAliases.get(_util, _cust, SPINNER_SET_MIN));
        setAliasSpinnerGetStep(CustAliases.get(_util, _cust, SPINNER_GET_STEP));
        setAliasSpinnerSetRangeValue(CustAliases.get(_util, _cust, SPINNER_SET_RANGE_VALUE));
        setAliasTextAreaGetSelectedText(CustAliases.get(_util, _cust, TEXT_AREA_GET_SELECTED_TEXT));
        setAliasSliderSetMax(CustAliases.get(_util, _cust, SLIDER_SET_MAX));
        setAliasSpinnerSetRange(CustAliases.get(_util, _cust, SPINNER_SET_RANGE));
        setAliasMenuBarGet(CustAliases.get(_util, _cust, MENU_BAR_GET));
        setAliasMenuBarRemove(CustAliases.get(_util, _cust, MENU_BAR_REMOVE));
        setAliasAbsMenuGetParent(CustAliases.get(_util, _cust, ABS_MENU_GET_PARENT));
        setAliasAbsMenuIsEnabled(CustAliases.get(_util, _cust, ABS_MENU_IS_ENABLED));
        setAliasMenuBarAdd(CustAliases.get(_util, _cust, MENU_BAR_ADD));
        setAliasGetMenuBar(CustAliases.get(_util, _cust, GET_MENU_BAR));
        setAliasSliderGetOrientation(CustAliases.get(_util, _cust, SLIDER_GET_ORIENTATION));
        setAliasMenuBarNb(CustAliases.get(_util, _cust, MENU_BAR_NB));
        setAliasSetMenuBar(CustAliases.get(_util, _cust, SET_MENU_BAR));
        setAliasSliderSetOrientation(CustAliases.get(_util, _cust, SLIDER_SET_ORIENTATION));
        setAliasMenuBar(CustAliases.get(_util, _cust, MENU_BAR));
        setAliasMenuNb(CustAliases.get(_util, _cust, MENU_NB));
        setAliasMenuAdd(CustAliases.get(_util, _cust, MENU_ADD));
        setAliasMenu(CustAliases.get(_util, _cust, MENU));
        setAliasMenuItem(CustAliases.get(_util, _cust, MENU_ITEM));
        setAliasAbsMenu(CustAliases.get(_util, _cust, ABS_MENU));
        setAliasMenuGet(CustAliases.get(_util, _cust, MENU_GET));
    }
