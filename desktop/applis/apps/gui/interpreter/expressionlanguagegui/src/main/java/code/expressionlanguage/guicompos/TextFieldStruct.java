...
public final class TextFieldStruct extends InputStruct {
    ...
    protected TextFieldStruct(String _className, AbsCompoFactory _compo) {
        super(_className);
        textField = _compo.newTextField();
    }
    protected TextFieldStruct(String _className,Struct _txt, AbsCompoFactory _compo) {
        super(_className);
        textField = _compo.newTextField(getText(_txt));
    }
    protected TextFieldStruct(String _className,NumberStruct _cols, AbsCompoFactory _compo) {
        super(_className);
        textField = _compo.newTextField(_cols.intStruct());
    }
    protected TextFieldStruct(String _className,Struct _txt,Struct _cols, AbsCompoFactory _compo) {
        super(_className);
