...
public final class FctConfirmOk0 implements StdCaller {
    ...
    public ArgumentWrapper call(AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        return new ArgumentWrapper(guiEx.getAnswerOk(argumentWrappers_.get(0).getValue().getStruct(), argumentWrappers_.get(1).getValue().getStruct(), argumentWrappers_.get(2).getValue().getStruct(), argumentWrappers_.get(3).getValue().getStruct()));
    }
}
