...
public final class FctPanelFlow implements StdCaller {
    private final CustAliases custAliases;
    private final GuiExecutingBlocks guiExecutingBlocks;
    private final String aliasPanel;

    public FctPanelFlow(CustAliases _custAliases, GuiExecutingBlocks _guiEx, String _aliasPanel) {
    ...
    public ArgumentWrapper call(AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        return new ArgumentWrapper(PanelStruct.newFlow(aliasPanel,guiExecutingBlocks.getWindow().getCompoFactory()));
    }
}
