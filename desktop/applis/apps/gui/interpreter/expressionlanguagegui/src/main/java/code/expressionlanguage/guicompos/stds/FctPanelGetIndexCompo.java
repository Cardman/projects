...
public final class FctPanelGetIndexCompo implements StdCaller {
    ...
    public FctPanelGetIndexCompo(CustAliases _custAliases) {
    ...
    public ArgumentWrapper call(AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        return new ArgumentWrapper(strPan_.getComponent(((NumberStruct)_firstArgs.getArgumentWrappers().get(0).getValue().getStruct()).intStruct()));
    }
}
