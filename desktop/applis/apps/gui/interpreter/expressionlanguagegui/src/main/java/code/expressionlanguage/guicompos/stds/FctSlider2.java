...
public final class FctSlider2 extends FctCompoCtor {
    ...
    public ArgumentWrapper inst(GuiExecutingBlocks _guiEx, AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        return new ArgumentWrapper(new SliderStruct(aliasSlider, argumentWrappers_.get(0).getValue().getStruct(),argumentWrappers_.get(1).getValue().getStruct(),_guiEx.getWindow().getCompoFactory()));
    }
}
