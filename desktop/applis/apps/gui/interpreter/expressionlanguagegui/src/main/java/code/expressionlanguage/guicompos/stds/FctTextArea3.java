...
public final class FctTextArea3 extends FctCompoCtor {
    ...
    public ArgumentWrapper inst(GuiExecutingBlocks _guiEx, AbstractExiting _exit, ContextEl _cont, Struct _instance, ArgumentListCall _firstArgs, StackCall _stackCall) {
        ...
        return new ArgumentWrapper(new TextAreaStruct(aliasTextArea, argumentWrappers_.get(0).getValue().getStruct(), argumentWrappers_.get(1).getValue().getStruct(),argumentWrappers_.get(2).getValue().getStruct(),_guiEx.getCompoFactory()));
    }
}
