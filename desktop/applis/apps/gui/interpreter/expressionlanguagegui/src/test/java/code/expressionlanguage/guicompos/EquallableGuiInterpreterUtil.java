...
public abstract class EquallableGuiInterpreterUtil {

    public static TranslationsLg lg(MockProgramInfos _pr, String _key) {
        return _pr.lg(_key);
    }
    public static CreateMainWindowFull create(String..._args) {
    ...
    public static CreateMainWindowFull create(MockProgramInfos _pr,String..._args) {
        ...
        return new CreateMainWindowFull("",new StringList(_args),cdm_,_pr, new LanguagesButtonsPair(null,null,null));
    }
