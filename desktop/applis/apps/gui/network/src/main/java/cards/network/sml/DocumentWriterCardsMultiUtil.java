...
public final class DocumentWriterCardsMultiUtil {
    ...
    public static final String FIELD_ALLOWED_BELOTE_REBELOTE = "allowedBeloteRebelote";
    public static final String FIELD_ALLOWED_BIDS = "allowedBids";
    public static final String FIELD_ALLOWED_HANDFULS = "allowedHandfuls";
    public static final String FIELD_ALLOWED_MISERES = "allowedMiseres";
    public static final String FIELD_ARRIVING = "arriving";
    public static final String FIELD_BID = "bid";
    public static final String FIELD_BID_BELOTE = "bidBelote";
    public static final String FIELD_BIDS = "bids";
    public static final String FIELD_BUSY = "busy";
    public static final String FIELD_CALL_AFTER = "callAfter";
    public static final String FIELD_CALLABLE_CARDS = "callableCards";
    public static final String FIELD_CALLED_CARD = "calledCard";
    public static final String FIELD_CALLED_CARDS = "calledCards";
    public static final String FIELD_CARD = "card";
    public static final String FIELD_CARDS = "cards";
    public static final String FIELD_CHOOSEN_HANDFUL = "choosenHandful";
    ...
    public static final String FIELD_DECLARE = "declare";
    public static final String FIELD_DECLARING = "declaring";
    public static final String FIELD_DECLARING_BELOTE_REBELOTE = "declaringBeloteRebelote";
    public static final String FIELD_DECLARING_SLAM = "declaringSlam";
    public static final String FIELD_DISCARDED = "discarded";
    public static final String FIELD_DISCARDING = "discarding";
    public static final String FIELD_DOG = "dog";
    public static final String FIELD_ENABLED_PASS = "enabledPass";
    public static final String FIELD_ERROR = "error";
    public static final String FIELD_ERROR_MESSAGE = "errorMessage";
    public static final String FIELD_EXCLUDED_TRUMPS = "excludedTrumps";
    public static final String FIELD_FIRST = "first";
    public static final String FIELD_FIRST_ROUND_PLAYING = "firstRoundPlaying";
    ...
    public static final String FIELD_HANDFUL = "handful";
    public static final String FIELD_HUMAN_TAKER = "humanTaker";
    public static final String FIELD_IN_HAND = "inHand";
    public static final String FIELD_INDEX = "index";
    public static final String FIELD_LANGUAGE = "language";
    public static final String FIELD_LOCALE = "locale";
    public static final String FIELD_MAX_CARDS = "maxCards";
    public static final String FIELD_MISERES = "miseres";
    public static final String FIELD_NB_PLAYERS = "nbPlayers";
    public static final String FIELD_NEW_HAND = "newHand";
    public static final String FIELD_NEXT_PLAYER = "nextPlayer";
    public static final String FIELD_NICKNAMES = "nicknames";
    public static final String FIELD_PASS = "pass";
    public static final String FIELD_PASS_ISSUE = "passIssue";
    public static final String FIELD_PLACE = "place";
    public static final String FIELD_PLACES_PLAYERS = "placesPlayers";
    public static final String FIELD_PLAYED_CARD = "playedCard";
    public static final String FIELD_PLAYED_HAND = "playedHand";
    public static final String FIELD_POINTS = "points";
    public static final String FIELD_POSSIBLE_BELOTE_REBELOTE = "possibleBeloteRebelote";
    public static final String FIELD_PSEUDO = "pseudo";
    public static final String FIELD_PSEUDOS = "pseudos";
    public static final String FIELD_READY = "ready";
    public static final String FIELD_READY_PLAYERS = "readyPlayers";
    public static final String FIELD_REASON = "reason";
    public static final String FIELD_RECEIVED = "received";
    public static final String FIELD_RECEIVED_CARDS = "receivedCards";
    public static final String FIELD_REFRESHED_HAND = "refreshedHand";
    public static final String FIELD_REP = "rep";
    public static final String FIELD_REQUIRED_TRUMPS = "requiredTrumps";
    public static final String FIELD_REVERSED = "reversed";
    ...
    public static final String FIELD_TAKER = "taker";
    public static final String FIELD_TAKER_INDEX = "takerIndex";
    public static final String FIELD_TEAMS = "teams";
    public static final String FIELD_TRUMPS = "trumps";
