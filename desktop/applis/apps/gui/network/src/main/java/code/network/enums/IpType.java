...
public enum IpType {
    ...
    public String toString(String _locale) {
        String fichier_ = MessGuiNetGr.ms().getVal(StringUtil.concat(ResourcesAccess.NOM_DOSSIER,ResourceFiles.SEPARATEUR, _locale,ResourceFiles.SEPARATEUR, ResourcesAccess.NOM_FICHIER));
