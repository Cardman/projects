...
public abstract class InvokingOperationAdv extends MethodOperationAdv {
...
//                setRelativeOffsetPossibleLastPage(o.getIndexInEl(), _conf);
                ...
                if (argType_.isEmpty()) {
                    if (PrimitiveTypeUtilAdv.isPrimitive(name_, _conf)) {
            ...
            name_ = PrimitiveTypeUtilAdv.getPrettyArrayType(name_);
    ...
    static CustList<Argument> listArguments(CustList<OperationNode> _children, int _natVararg, String _lastType, CustList<Argument> _nodes, ContextEl _context) {
        if (!_children.isEmpty() && _children.first().isVararg()) {
            ...
            if (native_) {
                ...
                Object array_;
                array_ = InstanceOperationAdv.newClassicArray(_context, g_, g_, len_);
                Struct arr_ = new StdStruct(array_, PrimitiveTypeUtilAdv.getPrettyArrayType(g_));
                ...
                String clArr_ = PrimitiveTypeUtilAdv.getPrettyArrayType(g_);
