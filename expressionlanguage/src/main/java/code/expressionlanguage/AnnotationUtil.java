...
public final class AnnotationUtil {
    ...
    public static Argument tryToCalculate(ContextEl _conf, AnnotationExpressionLanguage _right, int _offset) {
    ...
    public static CustList<OperationNode> getAnalyzedOperations(String _el, ContextEl _conf, Calculation _calcul) {
        Delimiters d_ = AnnotationResolver.checkSyntax(_el, _conf, CustList.FIRST_INDEX);
        ...
        OperationsSequence opTwo_ = AnnotationResolver.getOperationsSequence(CustList.FIRST_INDEX, _el, _conf, d_);
    ...
    private static OperationNode createFirstChild(OperationNode _block, Analyzable _context, int _index) {
        ...
        OperationsSequence r_ = AnnotationResolver.getOperationsSequence(offset_, value_, _context, d_);
    ...
    static void calculate(IdMap<OperationNode,ArgumentsPair> _nodes, AnnotationExpressionLanguage _el, ContextEl _context, int _offset) {
