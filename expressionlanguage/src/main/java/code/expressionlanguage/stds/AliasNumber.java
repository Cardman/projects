...
public final class AliasNumber {
    ...
    public void build(LgNames _lgNames) {
        ...
        method_ = new StandardMethod(_lgNames.getAliasCharAt(), params_, aliasPrimChar_, false, MethodModifier.NORMAL, stdcl_);
        methods_.put(method_.getId(), method_);
        method_ = new StandardMethod(_lgNames.getAliasLength(), noTypes_, aliasPrimInteger_, false, MethodModifier.NORMAL, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(aliasPrimInteger_,aliasPrimInteger_);
        method_ = new StandardMethod(_lgNames.getAliasSubSequence(), params_, aliasCharacter, false, MethodModifier.NORMAL, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
    ...
    private void numbersAbsMethods(LgNames _lgNames,ObjectMap<MethodId, StandardMethod> _methods, String _owner, StandardType _type) {
        ...
        StandardMethod method_;
        params_ = new StringList();
        method_ = new StandardMethod(aliasByteValue, params_, aliasPrimByte_, false, MethodModifier.ABSTRACT, _type);
        _methods.put(new MethodId(MethodModifier.ABSTRACT, aliasByteValue, params_), method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasShortValue, params_, aliasPrimShort_, false, MethodModifier.ABSTRACT, _type);
        _methods.put(new MethodId(MethodModifier.ABSTRACT, aliasShortValue, params_), method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasIntValue, params_, aliasPrimInteger_, false, MethodModifier.ABSTRACT, _type);
        _methods.put(new MethodId(MethodModifier.ABSTRACT, aliasIntValue, params_), method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasLongValue, params_, aliasPrimLong_, false, MethodModifier.ABSTRACT, _type);
        _methods.put(new MethodId(MethodModifier.ABSTRACT, aliasLongValue, params_), method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasFloatValue, params_, aliasPrimFloat_, false, MethodModifier.ABSTRACT, _type);
        _methods.put(new MethodId(MethodModifier.ABSTRACT, aliasFloatValue, params_), method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasDoubleValue, params_, aliasPrimDouble_, false, MethodModifier.ABSTRACT, _type);
