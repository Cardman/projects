...
public final class PrimitiveType {
    ...
    private final String directUpperPrimitive;

    private final boolean nb;

    public PrimitiveType(String _name, String _wrapper,
            String _directUpperPrimitive, boolean _nb) {
        name = _name;
        wrapper = _wrapper;
        directUpperPrimitive = _directUpperPrimitive;
        nb = _nb;
    }
    ...
    public String getDirectUpperPrimitive() {
        return directUpperPrimitive;
    }
    public StringList getAllSuperType(Analyzable _cont) {
        ...
        while (!name_.isEmpty()) {
            ...
            name_ = prim_.getDirectUpperPrimitive();
        }
        if (nb) {
