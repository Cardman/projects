...
public final class FileResolverTest {
    ...
    public void parseFile1Test() {
        ...
        assertEq(-1, getFileTypes(context_,0).getLineReturns().get(0));
        assertEq(0, getFileTypes(context_,0).getLineReturns().get(1));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(2));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(3));
        assertEq(18, getFileTypes(context_,0).getLineReturns().get(4));
        assertEq(18, getFileTypes(context_,0).getLineReturns().get(5));
        assertEq(32, getFileTypes(context_,0).getLineReturns().get(6));
        assertEq(32, getFileTypes(context_,0).getLineReturns().get(7));
        assertEq(42, getFileTypes(context_,0).getLineReturns().get(8));
        assertEq(42, getFileTypes(context_,0).getLineReturns().get(9));
        assertEq(5, getFileTypes(context_,0).getLeftSpaces().size());
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(0));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(1));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(2));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(3));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(4));
    }
    @Test
    ...
    public void parseFile7Test() {
        ...
        assertEq(1, countFileTypes(context_));
        assertEq(14, getFileTypes(context_,0).getLineReturns().size());
        assertEq(-1, getFileTypes(context_,0).getLineReturns().get(0));
        assertEq(0, getFileTypes(context_,0).getLineReturns().get(1));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(2));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(3));
        ...
        assertEq(42, getFileTypes(context_,0).getLineReturns().get(8));
        assertEq(42, getFileTypes(context_,0).getLineReturns().get(9));
        assertEq(135, getFileTypes(context_,0).getLineReturns().get(10));
        assertEq(136, getFileTypes(context_,0).getLineReturns().get(11));
        assertEq(188, getFileTypes(context_,0).getLineReturns().get(12));
        assertEq(188, getFileTypes(context_,0).getLineReturns().get(13));
        assertEq(7, getFileTypes(context_,0).getLeftSpaces().size());
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(0));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(1));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(2));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(3));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(4));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(5));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(6));
    }
    @Test
    public void parseFile8Test() {
        ...
        assertEq(1, countFileTypes(context_));
        assertEq(42, getFileTypes(context_,0).getLineReturns().size());
        assertEq(-1, getFileTypes(context_,0).getLineReturns().get(0));
        assertEq(0, getFileTypes(context_,0).getLineReturns().get(1));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(2));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(3));
        ...
        assertEq(42, getFileTypes(context_,0).getLineReturns().get(8));
        assertEq(42, getFileTypes(context_,0).getLineReturns().get(9));
        assertEq(109, getFileTypes(context_,0).getLineReturns().get(10));
        assertEq(110, getFileTypes(context_,0).getLineReturns().get(11));
        assertEq(162, getFileTypes(context_,0).getLineReturns().get(12));
        assertEq(163, getFileTypes(context_,0).getLineReturns().get(13));
        assertEq(199, getFileTypes(context_,0).getLineReturns().get(14));
        assertEq(201, getFileTypes(context_,0).getLineReturns().get(15));
        assertEq(219, getFileTypes(context_,0).getLineReturns().get(16));
        assertEq(221, getFileTypes(context_,0).getLineReturns().get(17));
        assertEq(243, getFileTypes(context_,0).getLineReturns().get(18));
        assertEq(244, getFileTypes(context_,0).getLineReturns().get(19));
        assertEq(246, getFileTypes(context_,0).getLineReturns().get(20));
        assertEq(247, getFileTypes(context_,0).getLineReturns().get(21));
        assertEq(284, getFileTypes(context_,0).getLineReturns().get(22));
        assertEq(286, getFileTypes(context_,0).getLineReturns().get(23));
        assertEq(307, getFileTypes(context_,0).getLineReturns().get(24));
        assertEq(309, getFileTypes(context_,0).getLineReturns().get(25));
        assertEq(334, getFileTypes(context_,0).getLineReturns().get(26));
        assertEq(335, getFileTypes(context_,0).getLineReturns().get(27));
        assertEq(337, getFileTypes(context_,0).getLineReturns().get(28));
        assertEq(338, getFileTypes(context_,0).getLineReturns().get(29));
        assertEq(371, getFileTypes(context_,0).getLineReturns().get(30));
        assertEq(373, getFileTypes(context_,0).getLineReturns().get(31));
        assertEq(399, getFileTypes(context_,0).getLineReturns().get(32));
        assertEq(402, getFileTypes(context_,0).getLineReturns().get(33));
        assertEq(424, getFileTypes(context_,0).getLineReturns().get(34));
        assertEq(426, getFileTypes(context_,0).getLineReturns().get(35));
        assertEq(428, getFileTypes(context_,0).getLineReturns().get(36));
        assertEq(430, getFileTypes(context_,0).getLineReturns().get(37));
        assertEq(455, getFileTypes(context_,0).getLineReturns().get(38));
        assertEq(456, getFileTypes(context_,0).getLineReturns().get(39));
        assertEq(458, getFileTypes(context_,0).getLineReturns().get(40));
        assertEq(458, getFileTypes(context_,0).getLineReturns().get(41));
        assertEq(21, getFileTypes(context_,0).getLeftSpaces().size());
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(0));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(1));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(2));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(3));
        ...
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(7));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(8));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(9));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(10));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(11));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(12));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(13));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(14));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(15));
        assertEq(12, getFileTypes(context_,0).getLeftSpaces().get(16));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(17));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(18));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(19));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(20));
    }
    @Test
    public void parseFile9Test() {
        ...
        assertNull(instr_.getNextSibling());
        assertNull(method_.getNextSibling());
        assertEq(60, getFileTypes(context_,0).getLineReturns().size());
        assertEq(-1, getFileTypes(context_,0).getLineReturns().get(0));
        assertEq(0, getFileTypes(context_,0).getLineReturns().get(1));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(2));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(3));
        ...
        assertEq(42, getFileTypes(context_,0).getLineReturns().get(8));
        assertEq(42, getFileTypes(context_,0).getLineReturns().get(9));
        assertEq(100, getFileTypes(context_,0).getLineReturns().get(10));
        assertEq(101, getFileTypes(context_,0).getLineReturns().get(11));
        assertEq(106, getFileTypes(context_,0).getLineReturns().get(12));
        assertEq(107, getFileTypes(context_,0).getLineReturns().get(13));
        assertEq(124, getFileTypes(context_,0).getLineReturns().get(14));
        assertEq(125, getFileTypes(context_,0).getLineReturns().get(15));
        assertEq(135, getFileTypes(context_,0).getLineReturns().get(16));
        assertEq(135, getFileTypes(context_,0).getLineReturns().get(17));
        assertEq(140, getFileTypes(context_,0).getLineReturns().get(18));
        assertEq(141, getFileTypes(context_,0).getLineReturns().get(19));
        assertEq(147, getFileTypes(context_,0).getLineReturns().get(20));
        assertEq(148, getFileTypes(context_,0).getLineReturns().get(21));
        assertEq(200, getFileTypes(context_,0).getLineReturns().get(22));
        assertEq(201, getFileTypes(context_,0).getLineReturns().get(23));
        assertEq(203, getFileTypes(context_,0).getLineReturns().get(24));
        assertEq(205, getFileTypes(context_,0).getLineReturns().get(25));
        assertEq(223, getFileTypes(context_,0).getLineReturns().get(26));
        assertEq(224, getFileTypes(context_,0).getLineReturns().get(27));
        assertEq(226, getFileTypes(context_,0).getLineReturns().get(28));
        assertEq(227, getFileTypes(context_,0).getLineReturns().get(29));
        assertEq(261, getFileTypes(context_,0).getLineReturns().get(30));
        assertEq(263, getFileTypes(context_,0).getLineReturns().get(31));
        assertEq(282, getFileTypes(context_,0).getLineReturns().get(32));
        assertEq(284, getFileTypes(context_,0).getLineReturns().get(33));
        assertEq(306, getFileTypes(context_,0).getLineReturns().get(34));
        assertEq(307, getFileTypes(context_,0).getLineReturns().get(35));
        assertEq(309, getFileTypes(context_,0).getLineReturns().get(36));
        assertEq(310, getFileTypes(context_,0).getLineReturns().get(37));
        assertEq(352, getFileTypes(context_,0).getLineReturns().get(38));
        assertEq(353, getFileTypes(context_,0).getLineReturns().get(39));
        assertEq(362, getFileTypes(context_,0).getLineReturns().get(40));
        assertEq(364, getFileTypes(context_,0).getLineReturns().get(41));
        assertEq(386, getFileTypes(context_,0).getLineReturns().get(42));
        assertEq(388, getFileTypes(context_,0).getLineReturns().get(43));
        assertEq(413, getFileTypes(context_,0).getLineReturns().get(44));
        assertEq(414, getFileTypes(context_,0).getLineReturns().get(45));
        assertEq(416, getFileTypes(context_,0).getLineReturns().get(46));
        assertEq(417, getFileTypes(context_,0).getLineReturns().get(47));
        assertEq(454, getFileTypes(context_,0).getLineReturns().get(48));
        assertEq(456, getFileTypes(context_,0).getLineReturns().get(49));
        assertEq(481, getFileTypes(context_,0).getLineReturns().get(50));
        assertEq(484, getFileTypes(context_,0).getLineReturns().get(51));
        assertEq(509, getFileTypes(context_,0).getLineReturns().get(52));
        assertEq(511, getFileTypes(context_,0).getLineReturns().get(53));
        assertEq(513, getFileTypes(context_,0).getLineReturns().get(54));
        assertEq(515, getFileTypes(context_,0).getLineReturns().get(55));
        assertEq(537, getFileTypes(context_,0).getLineReturns().get(56));
        assertEq(538, getFileTypes(context_,0).getLineReturns().get(57));
        assertEq(540, getFileTypes(context_,0).getLineReturns().get(58));
        assertEq(540, getFileTypes(context_,0).getLineReturns().get(59));
        assertEq(30, getFileTypes(context_,0).getLeftSpaces().size());
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(0));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(1));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(2));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(3));
        ...
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(9));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(10));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(11));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(12));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(13));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(14));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(15));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(16));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(17));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(18));
        assertEq(1, getFileTypes(context_,0).getLeftSpaces().get(19));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(20));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(21));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(22));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(23));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(24));
        assertEq(12, getFileTypes(context_,0).getLeftSpaces().get(25));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(26));
        assertEq(8, getFileTypes(context_,0).getLeftSpaces().get(27));
    ...
    public void parseFile24Test() {
        ...
        assertTrue(instrWhile_ instanceof Line);
        assertEq("j;.--", ((Line)instrWhile_).getExpression());
        assertEq(80, ((Line) instrWhile_).getExpressionOffset());
        assertNull(instrWhile_.getNextSibling());
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof DoWhileCondition);
        assertEq(98, ((Condition) instr_).getConditionOffset());
    ...
    public void parseFile25Test() {
        ...
        assertEq(102, th_.getConditionOffset());
        instrCond_ = th_.getFirstChild();
        assertTrue(instrCond_ instanceof Line);
        assertEq("j;.++", ((Line)instrCond_).getExpression());
        assertEq(118, ((Line)instrCond_).getExpressionOffset());
        assertNull(instrCond_.getNextSibling());
        instr_ = instr_.getNextSibling();
        ...
        assertEq(140, ((Line)instrCond_).getExpressionOffset());
        assertNull(instrCond_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    }
    ...
    public void parseFile26Test() {
        ...
        assertEq(84, catch_.getClassNameOffset());
        assertEq(88, catch_.getVariableNameOffset());
        instrCond_ = catch_.getFirstChild();
        assertTrue(instrCond_ instanceof Line);
        assertEq("j;.++", ((Line)instrCond_).getExpression());
        assertEq(102, ((Line)instrCond_).getExpressionOffset());
        assertNull(instrCond_.getNextSibling());
        instr_ = instr_.getNextSibling();
        ...
        assertEq(115, catch_.getClassNameOffset());
        assertEq(122, catch_.getVariableNameOffset());
        assertNull(instr_.getFirstChild());
        instr_ = instr_.getNextSibling();
        ...
        assertTrue(instrCond_ instanceof Line);
        assertEq("k;.++", ((Line)instrCond_).getExpression());
        assertEq(151, ((Line)instrCond_).getExpressionOffset());
        assertNull(instrCond_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    }
    ...
    public void parseFile27Test() {
        ...
        assertTrue(instrWhile_ instanceof Line);
        assertEq("j;.--", ((Line)instrWhile_).getExpression());
        assertEq(100, ((Line)instrWhile_).getExpressionOffset());
        assertNull(instrWhile_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    }
    ...
    public void parseFile28Test() {
        ...
        assertTrue(instrWhile_ instanceof Line);
        assertEq("j;.--", ((Line)instrWhile_).getExpression());
        assertEq(148, ((Line)instrWhile_).getExpressionOffset());
        assertNull(instrWhile_.getNextSibling());
    ...
    public void parseFile29Test() {
        ...
        assertTrue(instrWhile_ instanceof Line);
        assertEq("j;.--", ((Line)instrWhile_).getExpression());
        assertEq(129, ((Line)instrWhile_).getExpressionOffset());
        instrWhile_ = instrWhile_.getNextSibling();
        assertTrue(instrWhile_ instanceof ContinueBlock);
        assertEq("", ((ContinueBlock)instrWhile_).getLabel());
        assertEq(149, ((ContinueBlock)instrWhile_).getLabelOffset());
        assertNull(instrWhile_.getNextSibling());
        assertNull(case_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    ...
    public void parseFile30Test() {
        ...
        assertNull(child_.getNextSibling());
        assertEq(1, countFileTypes(context_));
        assertEq(18, getFileTypes(context_,0).getLineReturns().size());
        assertEq(-1, getFileTypes(context_,0).getLineReturns().get(0));
        assertEq(0, getFileTypes(context_,0).getLineReturns().get(1));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(2));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(3));
        ...
        assertEq(42, getFileTypes(context_,0).getLineReturns().get(9));
        assertEq(135, getFileTypes(context_,0).getLineReturns().get(10));
        assertEq(135, getFileTypes(context_,0).getLineReturns().get(11));
        assertEq(136, getFileTypes(context_,0).getLineReturns().get(12));
        assertEq(137, getFileTypes(context_,0).getLineReturns().get(13));
        assertEq(138, getFileTypes(context_,0).getLineReturns().get(14));
        assertEq(139, getFileTypes(context_,0).getLineReturns().get(15));
        assertEq(191, getFileTypes(context_,0).getLineReturns().get(16));
        assertEq(191, getFileTypes(context_,0).getLineReturns().get(17));
        assertEq(9, getFileTypes(context_,0).getLeftSpaces().size());
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(0));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(1));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(2));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(3));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(4));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(5));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(6));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(7));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(8));
    }
    ...
    public void parseFile35Test() {
        ...
        assertTrue(instrCond_ instanceof Line);
        assertEq("j;.++", ((Line)instrCond_).getExpression());
        assertEq(94, ((Line)instrCond_).getExpressionOffset());
        assertNull(instrCond_.getNextSibling());
        instr_ = instr_.getNextSibling();
        ...
        assertTrue(instrCond_ instanceof Line);
        assertEq("k;.++", ((Line)instrCond_).getExpression());
        assertEq(132, ((Line)instrCond_).getExpressionOffset());
        assertNull(instrCond_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    }
    ...
    public void parseFile36Test() {
        ...
        assertTrue(instrWhile_ instanceof Line);
        assertEq("j;.--", ((Line)instrWhile_).getExpression());
        assertEq(134, ((Line)instrWhile_).getExpressionOffset());
        instrWhile_ = instrWhile_.getNextSibling();
        assertTrue(instrWhile_ instanceof ContinueBlock);
        assertNull(instrWhile_.getNextSibling());
        assertNull(case_.getNextSibling());
    ...
    public void parseFile37Test() {
        ...
        assertEq("condTwo;.",((Condition) instr_).getCondition());
        th_ = (Condition) instr_;
        assertEq(108, th_.getConditionOffset());
        instrCond_ = th_.getFirstChild();
        assertTrue(instrCond_ instanceof Line);
        assertEq("j;.++", ((Line)instrCond_).getExpression());
        assertEq(124, ((Line)instrCond_).getExpressionOffset());
        assertNull(instrCond_.getNextSibling());
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof ElseCondition);
        instrCond_ = instr_.getFirstChild();
        assertTrue(instrCond_ instanceof Line);
        assertEq("k;.++", ((Line)instrCond_).getExpression());
        assertEq(146, ((Line)instrCond_).getExpressionOffset());
        assertNull(instrCond_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    }
    ...
    public void parseFile38Test() {
        ...
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof DoWhileCondition);
        assertEq(103, ((Condition) instr_).getConditionOffset());
        assertEq("condition;.",((Condition) instr_).getCondition());
        assertNull(instr_.getFirstChild());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    ...
    public void parseFile39Test() {
        ...
        assertEq("$ex", catch_.getClassName());
        assertEq("e", catch_.getVariableName());
        assertEq(89, catch_.getClassNameOffset());
        assertEq(93, catch_.getVariableNameOffset());
        instrCond_ = catch_.getFirstChild();
        assertTrue(instrCond_ instanceof Line);
        assertEq("j;.++", ((Line)instrCond_).getExpression());
        assertEq(107, ((Line)instrCond_).getExpressionOffset());
        assertNull(instrCond_.getNextSibling());
        instr_ = instr_.getNextSibling();
        catch_ = (CatchEval) instr_;
        assertTrue(instr_ instanceof CatchEval);
        assertEq("$extwo", catch_.getClassName());
        assertEq("f", catch_.getVariableName());
        assertEq(120, catch_.getClassNameOffset());
        assertEq(127, catch_.getVariableNameOffset());
        assertNull(instr_.getFirstChild());
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof FinallyEval);
        instrCond_ = instr_.getFirstChild();
        assertTrue(instrCond_ instanceof Line);
        assertEq("k;.++", ((Line)instrCond_).getExpression());
        assertEq(156, ((Line)instrCond_).getExpressionOffset());
        assertNull(instrCond_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    }
    ...
    public void parseFile40Test() {
        ...
        assertTrue(case_ instanceof CaseCondition);
        assertEq("1",((CaseCondition)case_).getValue());
        assertEq(90,((CaseCondition)case_).getValueOffset());
        assertNull(case_.getFirstChild());
        case_ = case_.getNextSibling();
        assertTrue(case_ instanceof CaseCondition);
        assertEq("2",((CaseCondition)case_).getValue());
        assertEq(104,((CaseCondition)case_).getValueOffset());
        Block instrWhile_ = case_.getFirstChild();
        assertTrue(instrWhile_ instanceof Line);
        assertEq("i;.++", ((Line)instrWhile_).getExpression());
        assertEq(112, ((Line)instrWhile_).getExpressionOffset());
        instrWhile_ = instrWhile_.getNextSibling();
        assertTrue(instrWhile_ instanceof BreakBlock);
        assertNull(instrWhile_.getNextSibling());
        case_ = case_.getNextSibling();
        ...
        assertTrue(instrWhile_ instanceof Line);
        assertEq("j;.--", ((Line)instrWhile_).getExpression());
        assertEq(153, ((Line)instrWhile_).getExpressionOffset());
        assertNull(instrWhile_.getNextSibling());
        assertNull(case_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    ...
    public void parseFile41Test() {
        ...
        assertEq(371, getFileTypes(context_,0).getLineReturns().get(30));
        assertEq(373, getFileTypes(context_,0).getLineReturns().get(31));
        assertEq(404, getFileTypes(context_,0).getLineReturns().get(32));
        assertEq(407, getFileTypes(context_,0).getLineReturns().get(33));
        assertEq(429, getFileTypes(context_,0).getLineReturns().get(34));
        assertEq(431, getFileTypes(context_,0).getLineReturns().get(35));
        assertEq(433, getFileTypes(context_,0).getLineReturns().get(36));
        assertEq(435, getFileTypes(context_,0).getLineReturns().get(37));
        assertEq(460, getFileTypes(context_,0).getLineReturns().get(38));
        assertEq(461, getFileTypes(context_,0).getLineReturns().get(39));
        assertEq(463, getFileTypes(context_,0).getLineReturns().get(40));
        assertEq(463, getFileTypes(context_,0).getLineReturns().get(41));
        assertEq(21, getFileTypes(context_,0).getLeftSpaces().size());
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(0));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(1));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(2));
    ...
    public void parseFile43Test() {
        ...
        assertEq(125, ((BreakBlock)instrWhile_).getLabelOffset());
        assertNull(instrWhile_.getNextSibling());
        case_ = case_.getNextSibling();
        assertTrue(case_ instanceof DefaultCondition);
        instrWhile_ = case_.getFirstChild();
        assertTrue(instrWhile_ instanceof Line);
        assertEq("j;.--", ((Line)instrWhile_).getExpression());
        assertEq(154, ((Line)instrWhile_).getExpressionOffset());
        assertNull(instrWhile_.getNextSibling());
        assertNull(case_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    ...
    public void parseFile44Test() {
        ...
        assertEq(150, ((ContinueBlock)instrWhile_).getLabelOffset());
        assertNull(instrWhile_.getNextSibling());
        assertNull(case_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    ...
    public void parseFile46Test() {
        ...
        assertEq("$String", ((FieldBlock) child_).getClassName());
        assertEq(162, ((FieldBlock) child_).getValueOffset());
        assertEq("{INNER}", ((FieldBlock) child_).getValue());
        assertNull(child_.getNextSibling());
        assertEq(1, countFileTypes(context_));
        assertEq(14, getFileTypes(context_,0).getLineReturns().size());
        assertEq(-1, getFileTypes(context_,0).getLineReturns().get(0));
        ...
        assertEq(135, getFileTypes(context_,0).getLineReturns().get(10));
        assertEq(136, getFileTypes(context_,0).getLineReturns().get(11));
        assertEq(170, getFileTypes(context_,0).getLineReturns().get(12));
        assertEq(170, getFileTypes(context_,0).getLineReturns().get(13));
        assertEq(7, getFileTypes(context_,0).getLeftSpaces().size());
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(0));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(1));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(2));
    ...
    public void parseFile47Test() {
        ...
        assertEq("$String", ((FieldBlock) child_).getClassName());
        assertEq(162, ((FieldBlock) child_).getValueOffset());
        assertEq("$new pkg.Ex[]{INNER}", ((FieldBlock) child_).getValue());
        assertNull(child_.getNextSibling());
        assertEq(1, countFileTypes(context_));
        assertEq(14, getFileTypes(context_,0).getLineReturns().size());
        assertEq(-1, getFileTypes(context_,0).getLineReturns().get(0));
        ...
        assertEq(135, getFileTypes(context_,0).getLineReturns().get(10));
        assertEq(136, getFileTypes(context_,0).getLineReturns().get(11));
        assertEq(183, getFileTypes(context_,0).getLineReturns().get(12));
        assertEq(183, getFileTypes(context_,0).getLineReturns().get(13));
        assertEq(7, getFileTypes(context_,0).getLeftSpaces().size());
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(0));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(1));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(2));
    ...
    public void parseFile48Test() {
        ...
        assertEq(100, getFileTypes(context_,0).getLineReturns().get(10));
        assertEq(101, getFileTypes(context_,0).getLineReturns().get(11));
        assertEq(118, getFileTypes(context_,0).getLineReturns().get(12));
        assertEq(119, getFileTypes(context_,0).getLineReturns().get(13));
        assertEq(124, getFileTypes(context_,0).getLineReturns().get(14));
        assertEq(125, getFileTypes(context_,0).getLineReturns().get(15));
        assertEq(135, getFileTypes(context_,0).getLineReturns().get(16));
        assertEq(135, getFileTypes(context_,0).getLineReturns().get(17));
    ...
    public void parseFile52Test() {
        ...
        assertEq("$String", ((FieldBlock) child_).getClassName());
        assertEq(190, ((FieldBlock) child_).getValueOffset());
        assertEq("\"{IN_BRACE}(){}\"({INNER})", ((FieldBlock) child_).getValue());
        child_ = child_.getNextSibling();
        assertNull(child_);
        assertEq(24, getFileTypes(context_,0).getLineReturns().size());
        assertEq(-1, getFileTypes(context_,0).getLineReturns().get(0));
        assertEq(0, getFileTypes(context_,0).getLineReturns().get(1));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(2));
        assertEq(7, getFileTypes(context_,0).getLineReturns().get(3));
        ...
        assertEq(100, getFileTypes(context_,0).getLineReturns().get(10));
        assertEq(101, getFileTypes(context_,0).getLineReturns().get(11));
        assertEq(113, getFileTypes(context_,0).getLineReturns().get(12));
        assertEq(114, getFileTypes(context_,0).getLineReturns().get(13));
        assertEq(131, getFileTypes(context_,0).getLineReturns().get(14));
        assertEq(132, getFileTypes(context_,0).getLineReturns().get(15));
        assertEq(151, getFileTypes(context_,0).getLineReturns().get(16));
        assertEq(151, getFileTypes(context_,0).getLineReturns().get(17));
        assertEq(156, getFileTypes(context_,0).getLineReturns().get(18));
        assertEq(157, getFileTypes(context_,0).getLineReturns().get(19));
        assertEq(163, getFileTypes(context_,0).getLineReturns().get(20));
        assertEq(164, getFileTypes(context_,0).getLineReturns().get(21));
        assertEq(216, getFileTypes(context_,0).getLineReturns().get(22));
        assertEq(216, getFileTypes(context_,0).getLineReturns().get(23));
        assertEq(12, getFileTypes(context_,0).getLeftSpaces().size());
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(0));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(1));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(2));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(3));
        ...
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(9));
        assertEq(4, getFileTypes(context_,0).getLeftSpaces().get(10));
        assertEq(0, getFileTypes(context_,0).getLeftSpaces().get(11));
    }
    @Test
    ...
    public void parseFile55Test() {
        ...
        assertEq("$String", ((FieldBlock) child_).getClassName());
        assertEq(107, ((FieldBlock) child_).getValueOffset());
        assertEq("\"{IN_BRACE}(){}\"({INNER})", ((FieldBlock) child_).getValue());
        assertNull(child_.getNextSibling());
        assertEq(1, countFileTypes(context_));
    }
    ...
    public void parseFile89Test() {
        ...
        file_.append("\t}\n");
        file_.append("\t$private $normal $String loop(){\n");
        file_.append("\t\t$for(@A $int i:$new $int[]{})for{\n");
        file_.append("\t\t\t$return $unreachable:\n");
        file_.append("\t\t}\n");
        file_.append("\t\t$return $unreachablebis:\n");
        file_.append("\t}\n");
        ...
        assertEq("for",for_.getLabel());
        assertEq(379, for_.getClassIndexNameOffset());
        assertEq(382, for_.getClassNameOffset());
        assertEq(387, for_.getVariableNameOffset());
        assertEq(389, for_.getExpressionOffset());
        assertEq(403,for_.getLabelOffset());
        assertEq(1, for_.getAnnotations().size());
        assertEq(1, for_.getAnnotationsIndexes().size());
        assertEq("@A", for_.getAnnotations().get(0));
        assertEq(379, for_.getAnnotationsIndexes().get(0).intValue());
        Block grChild_ = instr_.getFirstChild();
        assertTrue(grChild_ instanceof ReturnMehod);
        ret_ = (ReturnMehod) grChild_;
        assertEq("$unreachable",ret_.getExpression());
        assertEq(419, ret_.getExpressionOffset());
        assertNull(grChild_.getNextSibling());
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof ReturnMehod);
        ret_ = (ReturnMehod) instr_;
        assertEq("$unreachablebis",ret_.getExpression());
        assertEq(447, ret_.getExpressionOffset());
        assertNull(instr_.getNextSibling());
        assertNull(method_.getNextSibling());
        assertEq(1, countFileTypes(context_));
    }
    ...
    public void parseFile90Test() {
        ...
        file_.append("\t}\n");
        file_.append("\t$private $normal $String loop(){\n");
        file_.append("\t\t$for($final @A $int i=0i:i<1:i++)for{\n");
        file_.append("\t\t\t$return $unreachable:\n");
        file_.append("\t\t}\n");
        file_.append("\t\t$return $unreachablebis:\n");
        file_.append("\t}\n");
        ...
        assertEq(379, for_.getClassIndexNameOffset());
        assertEq(379, for_.getFinalOffset());
        assertEq(389, for_.getClassNameOffset());
        assertEq(394, for_.getInitOffset());
        assertEq(399, for_.getExpressionOffset());
        assertEq(403, for_.getStepOffset());
        assertEq(407,for_.getLabelOffset());
        assertEq(1, for_.getAnnotations().size());
        assertEq(1, for_.getAnnotationsIndexes().size());
        assertEq("@A", for_.getAnnotations().get(0));
        assertEq(386, for_.getAnnotationsIndexes().get(0).intValue());
        Block grChild_ = instr_.getFirstChild();
        assertTrue(grChild_ instanceof ReturnMehod);
        ret_ = (ReturnMehod) grChild_;
        assertEq("$unreachable",ret_.getExpression());
        assertEq(423, ret_.getExpressionOffset());
        assertNull(grChild_.getNextSibling());
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof ReturnMehod);
        ret_ = (ReturnMehod) instr_;
        assertEq("$unreachablebis",ret_.getExpression());
        assertEq(451, ret_.getExpressionOffset());
        assertNull(instr_.getNextSibling());
        assertNull(method_.getNextSibling());
        assertEq(1, countFileTypes(context_));
    }
    ...
    public void parseFile91Test() {
        ...
        file_.append("\t}\n");
        file_.append("\t$private $normal $String loop(){\n");
        file_.append("\t\t$iter(@A $int i=0i:10i::1i){\n");
        file_.append("\t\t\t$return $unreachable:\n");
        file_.append("\t\t}\n");
        file_.append("\t\t$return $unreachablebis:\n");
        file_.append("\t}\n");
        ...
        assertTrue(for_.isEq());
        assertEq(380, for_.getClassIndexNameOffset());
        assertEq(383, for_.getClassNameOffset());
        assertEq(388, for_.getVariableNameOffset());
        assertEq(390, for_.getInitOffset());
        assertEq(393, for_.getExpressionOffset());
        assertEq(396, for_.getEqOffset());
        assertEq(398, for_.getStepOffset());
        assertEq(401,for_.getLabelOffset());
        assertEq(1, for_.getAnnotations().size());
        assertEq(1, for_.getAnnotationsIndexes().size());
        assertEq("@A", for_.getAnnotations().get(0));
        assertEq(380, for_.getAnnotationsIndexes().get(0).intValue());
    }
    @Test
    public void parseFile92Test() {
        ...
        assertEq(339, method_.getAccessOffset());
        assertEq(348, method_.getModifierOffset());
        assertEq(348, method_.getReturnTypeOffset());
        assertEq(356, method_.getNameOffset());
        assertEq(0, method_.getParametersTypesOffset().size());
        assertEq(0, method_.getParametersNamesOffset().size());
        instr_ = method_.getFirstChild();
        assertTrue(instr_ instanceof ForIterativeLoop);
        ...
        assertEq("",for_.getLabel());
        assertTrue(for_.isEq());
        assertEq(372, for_.getClassIndexNameOffset());
        assertEq(375, for_.getClassNameOffset());
        assertEq(380, for_.getVariableNameOffset());
        assertEq(382, for_.getInitOffset());
        assertEq(385, for_.getExpressionOffset());
        assertEq(388, for_.getEqOffset());
        assertEq(390, for_.getStepOffset());
        assertEq(393,for_.getLabelOffset());
        assertEq(1, for_.getAnnotations().size());
        assertEq(1, for_.getAnnotationsIndexes().size());
        assertEq("@A", for_.getAnnotations().get(0));
        assertEq(372, for_.getAnnotationsIndexes().get(0).intValue());
    }
    @Test
    public void parseFile93Test() {
        ...
        file_.append("\t\t$return $unreachablebis:\n");
        file_.append("\t}\n");
        file_.append("\t$static $String loop(){\n");
        file_.append("\t\t$iter(@A $int i=0i:10i::1i){\n");
        file_.append("\t\t\t$return $unreachable:\n");
        file_.append("\t\t}\n");
        file_.append("\t\t$return $unreachablebis:\n");
        ...
        assertEq(347, method_.getReturnTypeOffset());
        assertEq(355, method_.getNameOffset());
        assertEq(0, method_.getParametersTypesOffset().size());
        assertEq(0, method_.getParametersNamesOffset().size());
        instr_ = method_.getFirstChild();
        assertTrue(instr_ instanceof ForIterativeLoop);
        ...
        assertEq("",for_.getLabel());
        assertTrue(for_.isEq());
        assertEq(371, for_.getClassIndexNameOffset());
        assertEq(374, for_.getClassNameOffset());
        assertEq(379, for_.getVariableNameOffset());
        assertEq(381, for_.getInitOffset());
        assertEq(384, for_.getExpressionOffset());
        assertEq(387, for_.getEqOffset());
        assertEq(389, for_.getStepOffset());
        assertEq(392,for_.getLabelOffset());
        assertEq(1, for_.getAnnotations().size());
        assertEq(1, for_.getAnnotationsIndexes().size());
        assertEq("@A", for_.getAnnotations().get(0));
        assertEq(371, for_.getAnnotationsIndexes().get(0).intValue());
    }
    @Test
    public void parseFile94Test() {
        ...
        assertEq("",for_.getLabel());
        assertTrue(for_.isEq());
        assertEq(363, for_.getClassIndexNameOffset());
        assertEq(366, for_.getClassNameOffset());
        assertEq(371, for_.getVariableNameOffset());
        assertEq(373, for_.getInitOffset());
        assertEq(376, for_.getExpressionOffset());
        assertEq(379, for_.getEqOffset());
        assertEq(381, for_.getStepOffset());
        assertEq(384,for_.getLabelOffset());
        assertEq(1, for_.getAnnotations().size());
        assertEq(1, for_.getAnnotationsIndexes().size());
        assertEq("@A", for_.getAnnotations().get(0));
        assertEq(363, for_.getAnnotationsIndexes().get(0).intValue());
    }
    @Test
    ...
    public void parseFile98Test() {
        ...
        file_.append("\t}\n");
        file_.append("}");
        ContextEl context_ = simpleContext(VariableSuffix.NONE,true);
        FileResolver.parseFile("my_file",file_.toString(), false, context_);
        assertEq(1, countCustomTypes(context_));
        assertEq("pkgtwo.Toto", getCustomTypes(context_,0).getFullName());
        RootBlock r_ = context_.getClasses().getClassBody("pkgtwo.Toto");
