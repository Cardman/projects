...
public final class FileResolverTest {
    ...
    public void parseFile1Test() {
        ...
        assertEq(1, context_.getClasses().getFilesBodies().size());
        assertEq(10, context_.getClasses().getFilesBodies().values().first().getLineReturns().size());
        assertEq(-1, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(0));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(1));
        assertEq(7, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(2));
        assertEq(7, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(3));
        assertEq(18, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(4));
        assertEq(18, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(5));
        assertEq(32, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(6));
        assertEq(32, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(7));
        assertEq(42, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(8));
        assertEq(42, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(9));
        assertEq(5, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().size());
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(0));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(1));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(2));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(3));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(4));
    }
    @Test
    ...
    public void parseFile7Test() {
        ...
        assertEq(1, context_.getClasses().getFilesBodies().size());
        assertEq(14, context_.getClasses().getFilesBodies().values().first().getLineReturns().size());
        assertEq(-1, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(0));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(1));
        assertEq(7, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(2));
        assertEq(7, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(3));
        ...
        assertEq(42, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(8));
        assertEq(42, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(9));
        assertEq(135, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(10));
        assertEq(136, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(11));
        assertEq(188, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(12));
        assertEq(188, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(13));
        assertEq(7, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().size());
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(0));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(1));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(2));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(3));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(4));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(5));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(6));
    }
    @Test
    public void parseFile8Test() {
        ...
        assertEq(386, for_.getInitOffset());
        assertEq(389, for_.getExpressionOffset());
        assertEq(392, for_.getEqOffset());
        assertEq(394, for_.getStepOffset());
        Block grChild_ = instr_.getFirstChild();
        assertTrue(grChild_ instanceof ReturnMehod);
        ret_ = (ReturnMehod) grChild_;
        assertEq("$unreachable",ret_.getExpression());
        assertEq(410, ret_.getExpressionOffset());
        assertNull(grChild_.getNextSibling());
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof ReturnMehod);
        ret_ = (ReturnMehod) instr_;
        assertEq("$unreachablebis",ret_.getExpression());
        assertEq(438, ret_.getExpressionOffset());
        assertNull(instr_.getNextSibling());
        assertNull(method_.getNextSibling());
        assertEq(1, context_.getClasses().getFilesBodies().size());
        assertEq(42, context_.getClasses().getFilesBodies().values().first().getLineReturns().size());
        assertEq(-1, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(0));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(1));
        assertEq(7, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(2));
        assertEq(7, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(3));
        ...
        assertEq(42, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(8));
        assertEq(42, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(9));
        assertEq(109, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(10));
        assertEq(110, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(11));
        assertEq(162, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(12));
        assertEq(163, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(13));
        assertEq(199, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(14));
        assertEq(201, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(15));
        assertEq(219, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(16));
        assertEq(221, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(17));
        assertEq(243, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(18));
        assertEq(244, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(19));
        assertEq(246, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(20));
        assertEq(247, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(21));
        assertEq(284, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(22));
        assertEq(286, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(23));
        assertEq(307, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(24));
        assertEq(309, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(25));
        assertEq(334, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(26));
        assertEq(335, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(27));
        assertEq(337, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(28));
        assertEq(338, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(29));
        assertEq(371, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(30));
        assertEq(373, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(31));
        assertEq(398, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(32));
        assertEq(401, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(33));
        assertEq(423, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(34));
        assertEq(425, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(35));
        assertEq(427, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(36));
        assertEq(429, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(37));
        assertEq(454, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(38));
        assertEq(455, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(39));
        assertEq(457, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(40));
        assertEq(457, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(41));
        assertEq(21, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().size());
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(0));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(1));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(2));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(3));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(4));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(5));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(6));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(7));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(8));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(9));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(10));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(11));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(12));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(13));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(14));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(15));
        assertEq(12, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(16));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(17));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(18));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(19));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(20));
    }
    @Test
    public void parseFile9Test() {
        ...
        assertEq("i",for_.getVariableName());
        assertTrue(!for_.isEq());
        assertEq(462, for_.getClassIndexNameOffset());
        assertEq(462, for_.getClassNameOffset());
        assertEq(467, for_.getVariableNameOffset());
        assertEq(469, for_.getInitOffset());
        assertEq(472, for_.getExpressionOffset());
        assertEq(475, for_.getEqOffset());
        assertEq(476, for_.getStepOffset());
        Block grChild_ = instr_.getFirstChild();
        assertTrue(grChild_ instanceof ReturnMehod);
        ret_ = (ReturnMehod) grChild_;
        assertEq("$unreachablebis",ret_.getExpression());
        assertEq(492, ret_.getExpressionOffset());
        assertNull(grChild_.getNextSibling());
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof ReturnMehod);
        ret_ = (ReturnMehod) instr_;
        assertEq("$unreachable",ret_.getExpression());
        assertEq(523, ret_.getExpressionOffset());
        assertNull(instr_.getNextSibling());
        assertNull(method_.getNextSibling());
        assertEq(60, context_.getClasses().getFilesBodies().values().first().getLineReturns().size());
        assertEq(-1, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(0));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(1));
        assertEq(7, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(2));
        assertEq(7, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(3));
        ...
        assertEq(42, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(8));
        assertEq(42, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(9));
        assertEq(100, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(10));
        assertEq(101, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(11));
        assertEq(106, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(12));
        assertEq(107, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(13));
        assertEq(124, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(14));
        assertEq(125, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(15));
        assertEq(135, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(16));
        assertEq(135, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(17));
        assertEq(140, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(18));
        assertEq(141, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(19));
        assertEq(147, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(20));
        assertEq(148, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(21));
        assertEq(200, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(22));
        assertEq(201, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(23));
        assertEq(203, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(24));
        assertEq(205, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(25));
        assertEq(223, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(26));
        assertEq(224, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(27));
        assertEq(226, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(28));
        assertEq(227, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(29));
        assertEq(261, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(30));
        assertEq(263, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(31));
        assertEq(282, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(32));
        assertEq(284, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(33));
        assertEq(306, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(34));
        assertEq(307, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(35));
        assertEq(309, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(36));
        assertEq(310, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(37));
        assertEq(352, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(38));
        assertEq(353, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(39));
        assertEq(362, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(40));
        assertEq(364, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(41));
        assertEq(386, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(42));
        assertEq(388, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(43));
        assertEq(413, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(44));
        assertEq(414, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(45));
        assertEq(416, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(46));
        assertEq(417, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(47));
        assertEq(454, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(48));
        assertEq(456, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(49));
        assertEq(480, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(50));
        assertEq(483, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(51));
        assertEq(508, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(52));
        assertEq(510, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(53));
        assertEq(512, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(54));
        assertEq(514, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(55));
        assertEq(536, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(56));
        assertEq(537, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(57));
        assertEq(539, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(58));
        assertEq(539, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(59));
        assertEq(30, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().size());
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(0));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(1));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(2));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(3));
        ...
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(5));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(6));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(7));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(8));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(9));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(10));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(11));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(12));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(13));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(14));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(15));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(16));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(17));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(18));
        assertEq(1, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(19));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(20));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(21));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(22));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(23));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(24));
        assertEq(12, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(25));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(26));
        assertEq(8, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(27));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(28));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(29));
    }
    ...
    public void parseFile16Test() {
        ...
        assertEq(2, ctor_.getInterfacesOffest().size());
        assertEq(200, ctor_.getInterfacesOffest().first());
        assertEq(211, ctor_.getInterfacesOffest().last());
        assertEq(3, ctor_.getParametersTypesOffset().size());
        assertEq(226, ctor_.getParametersTypesOffset().first());
        assertEq(235, ctor_.getParametersTypesOffset().get(1));
        assertEq(246, ctor_.getParametersTypesOffset().last());
        assertEq(3, ctor_.getParametersNamesOffset().size());
        assertEq(229, ctor_.getParametersNamesOffset().first());
        assertEq(240, ctor_.getParametersNamesOffset().get(1));
        assertEq(258, ctor_.getParametersNamesOffset().last());
        child_ = child_.getNextSibling();
        assertTrue(child_ instanceof MethodBlock);
        MethodBlock method_ = (MethodBlock) child_;
        assertTrue(!method_.isStaticMethod());
        ...
        assertEq(0, method_.getParametersNames().size());
        assertEq(0, method_.getParametersTypes().size());
        assertEq(271, method_.getAccessOffset());
        assertEq(279, method_.getModifierOffset());
        assertEq(289, method_.getReturnTypeOffset());
        assertEq(297, method_.getNameOffset());
        assertEq(0, method_.getParametersTypesOffset().size());
        assertEq(0, method_.getParametersNamesOffset().size());
        assertNull(method_.getFirstChild());
        child_ = child_.getNextSibling();
        ...
        assertEq(0, method_.getParametersNames().size());
        assertEq(0, method_.getParametersTypes().size());
        assertEq(308, method_.getAccessOffset());
        assertEq(316, method_.getModifierOffset());
        assertEq(326, method_.getReturnTypeOffset());
        assertEq(334, method_.getNameOffset());
        assertEq(0, method_.getParametersTypesOffset().size());
        assertEq(0, method_.getParametersNamesOffset().size());
        assertNull(method_.getFirstChild());
        child_ = child_.getNextSibling();
        ...
        assertEq(0, method_.getParametersNames().size());
        assertEq(0, method_.getParametersTypes().size());
        assertEq(345, method_.getAccessOffset());
        assertEq(354, method_.getModifierOffset());
        assertEq(362, method_.getReturnTypeOffset());
        assertEq(370, method_.getNameOffset());
        assertEq(0, method_.getParametersTypesOffset().size());
        assertEq(0, method_.getParametersNamesOffset().size());
        instr_ = method_.getFirstChild();
        assertTrue(instr_ instanceof DeclareAffectVariable);
        ...
        th_ = (Throwing) instr_;
        assertEq("$badthrows",th_.getExpression());
        assertEq(411, th_.getExpressionOffset());
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof ReturnMehod);
        ReturnMehod ret_ = (ReturnMehod) instr_;
        assertEq("$unreachable",ret_.getExpression());
        assertEq(433, ret_.getExpressionOffset());
        assertNull(instr_.getNextSibling());
        assertNull(method_.getNextSibling());
    }
    @Test
    public void parseFile17Test() {
        ...
        assertEq(179, ctor_.getReturnTypeOffset());
        assertEq(179, ctor_.getNameOffset());
        assertEq(0, ctor_.getInterfacesOffest().size());
        assertEq(3, ctor_.getParametersTypesOffset().size());
    ...
    public void parseFile21Test() {
        ...
        Throwing th_ = (Throwing) instr_;
        assertEq("$badthrows",th_.getExpression());
        assertEq(159,th_.getExpressionOffset());
        assertNull(instr_.getNextSibling());
        child_ = child_.getNextSibling();
        assertTrue(child_ instanceof MethodBlock);
        MethodBlock method_ = (MethodBlock) child_;
        ...
        assertEq(183, method_.getModifierOffset());
        assertEq(193, method_.getReturnTypeOffset());
        assertEq(201, method_.getNameOffset());
        assertEq(0, method_.getParametersTypesOffset().size());
        assertEq(0, method_.getParametersNamesOffset().size());
        assertNull(method_.getFirstChild());
        child_ = child_.getNextSibling();
        ...
        assertEq(220, method_.getModifierOffset());
        assertEq(230, method_.getReturnTypeOffset());
        assertEq(238, method_.getNameOffset());
        assertEq(0, method_.getParametersTypesOffset().size());
        assertEq(0, method_.getParametersNamesOffset().size());
        assertNull(method_.getFirstChild());
        child_ = child_.getNextSibling();
        ...
        assertEq(258, method_.getModifierOffset());
        assertEq(266, method_.getReturnTypeOffset());
        assertEq(274, method_.getNameOffset());
        assertEq(0, method_.getParametersTypesOffset().size());
        assertEq(0, method_.getParametersNamesOffset().size());
        ...
        th_ = (Throwing) instr_;
        assertEq("$badthrows",th_.getExpression());
        assertEq(308, th_.getExpressionOffset());
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof ReturnMehod);
        ReturnMehod ret_ = (ReturnMehod) instr_;
        assertEq("$unreachable",ret_.getExpression());
        assertEq(330, ret_.getExpressionOffset());
        assertNull(instr_.getNextSibling());
        assertNull(method_.getNextSibling());
    }
    @Test
    public void parseFile22Test() {
        ...
        Throwing th_ = (Throwing) instr_;
        assertEq("$badthrows",th_.getExpression());
        assertEq(67,th_.getExpressionOffset());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    }
    @Test
    public void parseFile23Test() {
        ...
        assertEq(67, th_.getConditionOffset());
        Block instrWhile_ = th_.getFirstChild();
        assertTrue(instrWhile_ instanceof SemiAffectation);
        assertEq("i;.", ((SemiAffectation)instrWhile_).getLeftMember());
        assertEq("++", ((SemiAffectation)instrWhile_).getOper());
        assertEq(84, ((SemiAffectation)instrWhile_).getLeftMemberOffset());
        assertEq(87, ((SemiAffectation)instrWhile_).getOperOffset());
        instrWhile_ = instrWhile_.getNextSibling();
        assertTrue(instrWhile_ instanceof SemiAffectation);
        assertEq("j;.", ((SemiAffectation)instrWhile_).getLeftMember());
        assertEq("--", ((SemiAffectation)instrWhile_).getOper());
        assertEq(94, ((SemiAffectation)instrWhile_).getLeftMemberOffset());
        assertEq(97, ((SemiAffectation)instrWhile_).getOperOffset());
    ...
    public void parseFile24Test() {
        ...
        assertEq("i;.", ((SemiAffectation)instrWhile_).getLeftMember());
        assertEq("++", ((SemiAffectation)instrWhile_).getOper());
        assertEq(69, ((SemiAffectation) instrWhile_).getLeftMemberOffset());
        assertEq(72, ((SemiAffectation) instrWhile_).getOperOffset());
        instrWhile_ = instrWhile_.getNextSibling();
        assertTrue(instrWhile_ instanceof SemiAffectation);
        assertEq("j;.", ((SemiAffectation)instrWhile_).getLeftMember());
        assertEq("--", ((SemiAffectation)instrWhile_).getOper());
        assertEq(79, ((SemiAffectation) instrWhile_).getLeftMemberOffset());
        assertEq(82, ((SemiAffectation) instrWhile_).getOperOffset());
        assertNull(instrWhile_.getNextSibling());
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof WhileCondition);
    ...
    public void parseFile25Test() {
        ...
        assertEq(65, th_.getConditionOffset());
        ...
        assertEq("i;.", ((SemiAffectation)instrCond_).getLeftMember());
        assertEq("++", ((SemiAffectation)instrCond_).getOper());
        assertEq(81, ((SemiAffectation)instrCond_).getLeftMemberOffset());
        assertEq(84, ((SemiAffectation)instrCond_).getOperOffset());
        ...
        assertEq(101, th_.getConditionOffset());
        instrCond_ = th_.getFirstChild();
        assertTrue(instrCond_ instanceof SemiAffectation);
        assertEq("j;.", ((SemiAffectation)instrCond_).getLeftMember());
        assertEq("++", ((SemiAffectation)instrCond_).getOper());
        assertEq(117, ((SemiAffectation)instrCond_).getLeftMemberOffset());
        assertEq(120, ((SemiAffectation)instrCond_).getOperOffset());
        assertNull(instrCond_.getNextSibling());
        instr_ = instr_.getNextSibling();
        assertTrue(instr_ instanceof ElseCondition);
        instrCond_ = instr_.getFirstChild();
        assertTrue(instrCond_ instanceof SemiAffectation);
        assertEq("k;.", ((SemiAffectation)instrCond_).getLeftMember());
        assertEq("++", ((SemiAffectation)instrCond_).getOper());
        assertEq(139, ((SemiAffectation)instrCond_).getLeftMemberOffset());
        assertEq(142, ((SemiAffectation)instrCond_).getOperOffset());
        assertNull(instrCond_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    }
    ...
    public void parseFile26Test() {
        ...
        Block instrCond_ = instr_.getFirstChild();
        assertTrue(instrCond_ instanceof SemiAffectation);
        assertEq("i;.", ((SemiAffectation)instrCond_).getLeftMember());
        assertEq("++", ((SemiAffectation)instrCond_).getOper());
        assertEq(70, ((SemiAffectation)instrCond_).getLeftMemberOffset());
        assertEq(73, ((SemiAffectation)instrCond_).getOperOffset());
        assertNull(instrCond_.getNextSibling());
        instr_ = instr_.getNextSibling();
        ...
        assertEq(83, catch_.getClassNameOffset());
        assertEq(87, catch_.getVariableNameOffset());
        instrCond_ = catch_.getFirstChild();
        assertTrue(instrCond_ instanceof SemiAffectation);
        assertEq("j;.", ((SemiAffectation)instrCond_).getLeftMember());
        assertEq("++", ((SemiAffectation)instrCond_).getOper());
        assertEq(101, ((SemiAffectation)instrCond_).getLeftMemberOffset());
        assertEq(104, ((SemiAffectation)instrCond_).getOperOffset());
        assertNull(instrCond_.getNextSibling());
        instr_ = instr_.getNextSibling();
        ...
        assertEq(114, catch_.getClassNameOffset());
        assertEq(121, catch_.getVariableNameOffset());
        assertNull(instr_.getFirstChild());
        instr_ = instr_.getNextSibling();
        ...
        assertEq("k;.", ((SemiAffectation)instrCond_).getLeftMember());
        assertEq("++", ((SemiAffectation)instrCond_).getOper());
        assertEq(150, ((SemiAffectation)instrCond_).getLeftMemberOffset());
        assertEq(153, ((SemiAffectation)instrCond_).getOperOffset());
        assertNull(instrCond_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    }
    ...
    public void parseFile27Test() {
        ...
        assertEq(69, th_.getClassIndexNameOffset());
        assertEq(69, th_.getClassNameOffset());
        assertEq(74, th_.getVariableNameOffset());
        assertEq(77, th_.getExpressionOffset());
        Block instrWhile_ = th_.getFirstChild();
        assertTrue(instrWhile_ instanceof SemiAffectation);
        assertEq("i;.", ((SemiAffectation)instrWhile_).getLeftMember());
        assertEq("++", ((SemiAffectation)instrWhile_).getOper());
        assertEq(89, ((SemiAffectation)instrWhile_).getLeftMemberOffset());
        assertEq(92, ((SemiAffectation)instrWhile_).getOperOffset());
        instrWhile_ = instrWhile_.getNextSibling();
        assertTrue(instrWhile_ instanceof SemiAffectation);
        assertEq("j;.", ((SemiAffectation)instrWhile_).getLeftMember());
        assertEq("--", ((SemiAffectation)instrWhile_).getOper());
        assertEq(99, ((SemiAffectation)instrWhile_).getLeftMemberOffset());
        assertEq(102, ((SemiAffectation)instrWhile_).getOperOffset());
        assertNull(instrWhile_.getNextSibling());
        assertNull(instr_.getNextSibling());
        assertNull(child_.getNextSibling());
    }
    ...
    public void parseFile28Test() {
        ...
        assertEq(68,((SwitchBlock)instr_).getValueOffset());
        Block case_ = instr_.getFirstChild();
        assertTrue(case_ instanceof CaseCondition);
        assertEq("1",((CaseCondition)case_).getValue());
        assertEq(84,((CaseCondition)case_).getValueOffset());
        assertNull(case_.getFirstChild());
        case_ = case_.getNextSibling();
        assertTrue(case_ instanceof CaseCondition);
        assertEq("2",((CaseCondition)case_).getValue());
        assertEq(98,((CaseCondition)case_).getValueOffset());
        Block instrWhile_ = case_.getFirstChild();
        assertTrue(instrWhile_ instanceof SemiAffectation);
        assertEq("i;.", ((SemiAffectation)instrWhile_).getLeftMember());
        assertEq("++", ((SemiAffectation)instrWhile_).getOper());
        assertEq(106, ((SemiAffectation)instrWhile_).getLeftMemberOffset());
        assertEq(109, ((SemiAffectation)instrWhile_).getOperOffset());
        instrWhile_ = instrWhile_.getNextSibling();
        ...
        assertEq("j;.", ((SemiAffectation)instrWhile_).getLeftMember());
        assertEq("--", ((SemiAffectation)instrWhile_).getOper());
        assertEq(147, ((SemiAffectation)instrWhile_).getLeftMemberOffset());
        assertEq(150, ((SemiAffectation)instrWhile_).getOperOffset());
        assertNull(instrWhile_.getNextSibling());
    ...
    public void parseFile29Test() {
        ...
        assertEq(67,((WhileCondition)instr_).getConditionOffset());
        Block case_ = instr_.getFirstChild();
        assertTrue(case_ instanceof IfCondition);
        assertEq("b;.",((IfCondition)case_).getCondition());
        assertEq(81,((IfCondition)case_).getConditionOffset());
        Block instrIf_ = case_.getFirstChild();
        assertTrue(instrIf_ instanceof SemiAffectation);
        assertEq("i;.", ((SemiAffectation)instrIf_).getLeftMember());
        assertEq("++", ((SemiAffectation)instrIf_).getOper());
        assertEq(91, ((SemiAffectation)instrIf_).getLeftMemberOffset());
        assertEq(94, ((SemiAffectation)instrIf_).getOperOffset());
        instrIf_ = instrIf_.getNextSibling();
        assertTrue(instrIf_ instanceof ReturnMehod);
        assertEq("", ((ReturnMehod)instrIf_).getExpression());
        assertEq(109, ((ReturnMehod)instrIf_).getExpressionOffset());
        ...
        assertEq("j;.", ((SemiAffectation)instrWhile_).getLeftMember());
        assertEq("--", ((SemiAffectation)instrWhile_).getOper());
        assertEq(128, ((SemiAffectation)instrWhile_).getLeftMemberOffset());
        assertEq(131, ((SemiAffectation)instrWhile_).getOperOffset());
        instrWhile_ = instrWhile_.getNextSibling();
    ...
    public void parseFile30Test() {
        ...
        assertEq("$String", ((FieldBlock) child_).getClassName());
        assertEq(165, ((FieldBlock) child_).getValueOffset());
        assertEq("\"{IN_BRACE}(){}\"({INNER})", ((FieldBlock) child_).getValue());
        assertNull(child_.getNextSibling());
        assertEq(1, context_.getClasses().getFilesBodies().size());
        assertEq(18, context_.getClasses().getFilesBodies().values().first().getLineReturns().size());
        assertEq(-1, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(0));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(1));
        assertEq(7, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(2));
        assertEq(7, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(3));
        ...
        assertEq(42, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(9));
        assertEq(135, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(10));
        assertEq(135, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(11));
        assertEq(136, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(12));
        assertEq(137, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(13));
        assertEq(138, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(14));
        assertEq(139, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(15));
        assertEq(191, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(16));
        assertEq(191, context_.getClasses().getFilesBodies().values().first().getLineReturns().get(17));
        assertEq(9, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().size());
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(0));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(1));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(2));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(3));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(4));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(5));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(6));
        assertEq(4, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(7));
        assertEq(0, context_.getClasses().getFilesBodies().values().first().getLeftSpaces().get(8));
    }
