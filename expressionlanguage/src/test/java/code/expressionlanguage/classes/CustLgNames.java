...
public class CustLgNames extends LgNames {
    ...
    public void buildOther() {
        ...
        method_ = new StandardMethod(aliasAdd, params_, getAliasVoid(), false, MethodModifier.FINAL, aliasInts, stdcl_);
        ...
        method_ = new StandardMethod(aliasGetList, params_, aliasGeneObjects, false, MethodModifier.FINAL, aliasPickableList, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasPrimInteger());
        method_ = new StandardMethod(aliasRemoveAndExistAfter, params_, getAliasPrimBoolean(), false, MethodModifier.FINAL, aliasPickableList, stdcl_);
        methods_.put(method_.getId(), method_);
        std_ = stdcl_;
        ...
        method_ = new StandardMethod(aliasAdd, params_, getAliasVoid(), false, MethodModifier.FINAL, aliasGeneObjects, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasSize, params_, getAliasPrimInteger(), false, MethodModifier.FINAL, aliasGeneObjects, stdcl_);
        methods_.put(method_.getId(), method_);
...
//        methods_.put(method_.getId(), method_);
        ...
        params_ = new StringList(getAliasObject());
        method_ = new StandardMethod(aliasGetOverridenOne, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasObject());
        method_ = new StandardMethod(aliasGetOverridenTwo, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasGetOverridenTwo, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasPrimDouble());
        method_ = new StandardMethod(aliasGetOverridenThree, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasPrimLong());
        method_ = new StandardMethod(aliasGetOverridenFour, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasLong());
        method_ = new StandardMethod(aliasGetOverridenFour, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasPrimDouble());
        method_ = new StandardMethod(aliasGetOverridenFive, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasLong());
        method_ = new StandardMethod(aliasGetOverridenFive, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasDouble());
        method_ = new StandardMethod(aliasGetOverridenSix, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasPrimLong());
        method_ = new StandardMethod(aliasGetOverridenSix, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasPrimInteger());
        method_ = new StandardMethod(aliasSetPrivateInt, params_, getAliasVoid(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasGetPrivateInt, params_, getAliasPrimInteger(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasGetInteger, params_, getAliasPrimInteger(), false, MethodModifier.FINAL, aliasComposite, stdcl_);
        methods_.put(method_.getId(), method_);
        ...
        params_ = new StringList();
        method_ = new StandardMethod(aliasFail, params_, getAliasPrimInteger(), false, MethodModifier.STATIC, aliasFailMethods, stdcl_);
        methods_.put(method_.getId(), method_);
        std_ = stdcl_;
        ...
        params_ = new StringList();
        method_ = new StandardMethod(aliasFail, params_, getAliasPrimInteger(), false, MethodModifier.STATIC, aliasStrangeInit, stdcl_);
        methods_.put(method_.getId(), method_);
        ...
        params_ = new StringList();
        method_ = new StandardMethod(aliasGetArray, params_, PrimitiveTypeUtil.getPrettyArrayType(getAliasPrimInteger()), false, MethodModifier.NORMAL, aliasArrayBis, stdcl_);
        methods_.put(method_.getId(), method_);
        std_ = stdcl_;
        ...
        params_ = new StringList();
        method_ = new StandardMethod(aliasGetArray, params_, PrimitiveTypeUtil.getPrettyArrayType(getAliasPrimInteger()), false, MethodModifier.NORMAL, aliasArrayContainer,stdcl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasGetCompo, params_, PrimitiveTypeUtil.getPrettyArrayType(aliasArrayBis), false, MethodModifier.NORMAL, aliasArrayContainer,stdcl_);
        methods_.put(method_.getId(), method_);
        std_ = stdcl_;
