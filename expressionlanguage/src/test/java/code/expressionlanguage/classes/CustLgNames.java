...
//        methods_.put(method_.getId(), method_);
        ...
        methods_ = new ObjectMap<MethodId, StandardMethod>();
        params_ = new StringList(getAliasObject());
        method_ = new StandardMethod(aliasGetOverridenOne, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasObject());
        method_ = new StandardMethod(aliasGetOverridenTwo, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod(aliasGetOverridenTwo, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasPrimDouble());
        method_ = new StandardMethod(aliasGetOverridenThree, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasPrimLong());
        method_ = new StandardMethod(aliasGetOverridenFour, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasLong());
        method_ = new StandardMethod(aliasGetOverridenFour, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasPrimDouble());
        method_ = new StandardMethod(aliasGetOverridenFive, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasLong());
        method_ = new StandardMethod(aliasGetOverridenFive, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasDouble());
        method_ = new StandardMethod(aliasGetOverridenSix, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasPrimLong());
        method_ = new StandardMethod(aliasGetOverridenSix, params_, getAliasString(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasPrimInteger());
        method_ = new StandardMethod(aliasSetPrivateInt, params_, getAliasVoid(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasGetPrivateInt, params_, getAliasPrimInteger(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(aliasGetInteger, params_, getAliasPrimInteger(), false, MethodModifier.FINAL, aliasComposite);
        methods_.put(method_.getId(), method_);
        //aliasGetOverridenOne
        fields_ = new StringMap<StandardField>();
        field_ = new StandardField(aliasIntegerField, getAliasPrimInteger(), false, false);
        ...
        methods_ = new ObjectMap<MethodId, StandardMethod>();
        params_ = new StringList();
        method_ = new StandardMethod(aliasFail, params_, getAliasPrimInteger(), false, MethodModifier.STATIC, aliasFailMethods);
        methods_.put(method_.getId(), method_);
        fields_ = new StringMap<StandardField>();
        constructors_ = new CustList<StandardConstructor>();
        ...
        if (StringList.quickEq(_method.getClassName(), aliasComposite)) {
            if (StringList.quickEq(_method.getConstraints().getName(), aliasGetOverridenOne)) {
                if (StringList.quickEq(_method.getConstraints().getParametersTypes().first(), getAliasObject())) {
                    ...
                    res_.setResult(new StdStruct(resLoc_,getAliasString()));
                    return res_;
                }
