...
public final class NativeForEach extends AbstractForEachLoop {
    ...
    public ExpressionLanguage getEqIterator(Analyzable _an) {
        if (nativeCmp) {
            return new ExpressionLanguage(((CustLgNames) _an.getStandards()).getExpsIterator());
        }
    ...
    public ExpressionLanguage getEqHasNext(Analyzable _an) {
        if (nativeCmp) {
            return new ExpressionLanguage(((CustLgNames) _an.getStandards()).getExpsHasNext());
        }
    ...
    public ExpressionLanguage getEqNext(Analyzable _an) {
        if (nativeCmp) {
            return new ExpressionLanguage(((CustLgNames) _an.getStandards()).getExpsNext());
        }
    ...
    public String getIteratorVar(Analyzable _an) {
        if (nativeCmp) {
            return ((CustLgNames)_an.getStandards()).getIteratorVar();
        }
    ...
    public String getHasNextVar(Analyzable _an) {
        if (nativeCmp) {
            return ((CustLgNames)_an.getStandards()).getHasNextVar();
        }
    ...
    public String getNextVar(Analyzable _an) {
        if (nativeCmp) {
            return ((CustLgNames)_an.getStandards()).getNextVar();
        }
