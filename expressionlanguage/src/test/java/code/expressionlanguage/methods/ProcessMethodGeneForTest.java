...
public final class ProcessMethodGeneForTest extends ProcessMethodCommon {
    ...
    public void calculateArgument26Test() {
        ...
        Argument ret_;
        ret_ = calculateNormal("pkg.Ex", id_, args_, cont_);
        assertEq("4434324321", getString(ret_));
    }
    @Test
    ...
    public void calculateArgument38Test() {
        StringBuilder xml_ = new StringBuilder();
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $static Integer k;\n");
        xml_.append(" $public $static $int catching(){\n");
        xml_.append("  Integer k=Ex.k.intValue(),l=Ex.k.intValue();\n");
    ...
    public void calculateArgument39Test() {
        StringBuilder xml_ = new StringBuilder();
        xml_.append("$public $class pkg.Ex {\n");
        xml_.append(" $public $static Ex k;\n");
        xml_.append(" $public $static $int catching(){\n");
        xml_.append("  Object k=p.k;\n");
        xml_.append("  $return 0;\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        StringMap<String> files_ = new StringMap<String>();
