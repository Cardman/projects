...
public final class ProcessMethodInstanceInterfaceTest extends
    ...
    public void instanceArgument80Test() {
        ...
        xml_.append("  elt;;;=third;;;[0i][0i]:\n");
        xml_.append(" }\n");
        xml_.append(" $public $interfaces(pkg.Int3) (){\n");
        xml_.append("  sec;;;+=16i:\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        files_.put("pkg/ExTwo", xml_.toString());
    ...
    public void instanceArgument106Test() {
        ...
        xml_.append("  $this(1i):\n");
        xml_.append(" }\n");
        xml_.append(" $public $interfaces(pkg.Int3) ($int i){\n");
        xml_.append("  res;;;=i;.;:\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        files_.put("pkg/Ex", xml_.toString());
        ...
        assertEq(INTEGER, subField_.getClassName(cont_));
        assertEq(2, (Number)subField_.getInstance());
        subField_ = field_.getFields().getVal(new ClassField("pkg.Ex", "res"));
        assertEq(INTEGER, subField_.getClassName(cont_));
    ...
    public void instanceArgument107Test() {
        ...
        xml_.append(" }\n");
        xml_.append(" $public $interfaces(pkg.Int3) ($int i,$int j){\n");
        xml_.append("  res;;;=i;.;:\n");
        xml_.append("  res2;;;=j;.;:\n");
        xml_.append(" }\n");
        xml_.append("}\n");
        ...
        assertEq(INTEGER, subField_.getClassName(cont_));
        assertEq(5, (Number)subField_.getInstance());
        subField_ = field_.getFields().getVal(new ClassField("pkg.Ex", "res2"));
        assertEq(INTEGER, subField_.getClassName(cont_));
        ...
        subField_ = field_.getFields().getVal(new ClassField("pkg.Ex", "res2"));
        assertEq(INTEGER, subField_.getClassName(cont_));
        assertEq(4, (Number)subField_.getInstance());
    }
}
