...
public class ProcessXmlMethodTest {
    ...
    private static final String REAL_ARR_STRUCT = Struct[].class.getName();
    private static final String REAL_ARR_ARR_OBJECT = Struct[].class.getName();
    private static final String REAL_ARR_OBJECT = Struct[].class.getName();
    private static final String REAL_ARR_INTEGER = Struct[].class.getName();
    private static final String STRING = String.class.getName();
    private static final String CUST_BASE = CustBase.class.getName();
    private static final String CUST_ENUM = CustEnum.class.getName();
...
//        xml_ += "<line expression='t;.add(class(&quot;java.lang.Object&quot;,2i))'/>\n";
        ...
        xml_ += "<return expression='badMethod()'/>\n";
        xml_ += "</try>\n";
        xml_ += "<catch var='e' class='code.expressionlanguage.exceptions.BadIndexException'>\n";
        xml_ += "<affect left='t;.' oper='=' right='1i'/>\n";
        xml_ += "<throw expression='e;..'/>\n";
        xml_ += "</catch>\n";
        xml_ += "</try>\n";
...
//        xml_ += "<line expression='t;.add(class(&quot;java.lang.Object&quot;,2i))'/>\n";
    ...
    public void initializeClass3Test() {
        ...
        assertEq(CUST_ENUM, str_.getRealClassName(cont_));
    ...
    public void instanceArgument23Test() {
        ...
        assertEq(24, (Number)field_.getInstance());
        field_ = str_.getFields().getVal(new ClassField("pkg.ExTwo", "third"));
        assertEq(REAL_ARR_STRUCT, field_.getRealClassName(cont_));
...
//        assertEq(17, (Number)intern_.getInstance());
    ...
    public void instanceArgument33Test() {
        ...
        Struct field_;
        field_ = str_.getFields().getVal(new ClassField("pkg.Ex", "inst"));
        assertEq(CUST_ENUM, field_.getRealClassName(cont_));
    ...
    public void instanceArgument57Test() {
        ...
        assertEq(17, (Number)field_.getFields().getVal(new ClassField("pkg.ExThree", "ance")).getInstance());
        field_ = str_.getFields().getVal(new ClassField("pkg.ExTwo", "third"));
        assertEq(REAL_ARR_ARR_OBJECT, field_.getRealClassName(cont_));
...
//        xml_ += "</method>\n";
    ...
    public void instanceArgument95Test() {
        StringMap<String> files_ = new StringMap<String>();
        String xml_ = "<class access='"+PUBLIC_ACCESS+"' name='Ex' package='pkg'>\n";
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='array' class='"+ARR_OBJECT+"' value='$new "+ARR_OBJECT+"(1i)'/>\n";
        ...
        xml_ += "</method>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='final' name='getter' class='"+PrimitiveTypeUtil.PRIM_INT+"'>\n";
        xml_ += "<return expression='elt;;;'/>\n";
        xml_ += "</method>\n";
        xml_ += "</class>\n";
        files_.put("pkg/Ex."+Classes.EXT, xml_);
        ContextEl cont_ = contextEl();
    ...
    public void instanceArgument96Test() {
        ...
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='elt' class='"+PrimitiveTypeUtil.PRIM_INT+"' value='2i'/>\n";
        xml_ += "<instance>\n";
        xml_ += "<affect left='ref()[0i]' oper='=' right='getter($vararg(&quot;$int&quot;),$firstopt(8i),5i)'/>\n";
        xml_ += "</instance>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='final' name='ref' class='"+ARR_OBJECT+"'>\n";
        xml_ += "<return expression='array;;;'/>\n";
        xml_ += "</method>\n";
        ...
        Struct field_;
        field_ = str_.getFields().getVal(new ClassField("pkg.Ex", "array"));
        assertEq(REAL_ARR_INTEGER, field_.getRealClassName(cont_));
    ...
    public void instanceArgument97Test() {
        ...
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='elt' class='"+PrimitiveTypeUtil.PRIM_INT+"' value='2i'/>\n";
        xml_ += "<instance>\n";
        xml_ += "<affect left='ref()[0i]' oper='=' right='getter(8i,5i)'/>\n";
        xml_ += "</instance>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='final' name='ref' class='"+ARR_OBJECT+"'>\n";
        xml_ += "<return expression='array;;;'/>\n";
        xml_ += "</method>\n";
    ...
    public void instanceArgument98Test() {
        ...
        xml_ += "<return expression='elt;;;+t;.'/>\n";
        xml_ += "</method>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='final' name='getter' class='"+PrimitiveTypeUtil.PRIM_INT+"' var0='i' class0='$long...'>\n";
        xml_ += "<declare var='t' class='$int'/>\n";
        xml_ += "<foreach class='java.lang.Number' var='e' expression='i;.;'>\n";
        xml_ += "<affect left='t;.' oper='+=' right='e;intValue()*2i'/>\n";
        xml_ += "</foreach>\n";
        xml_ += "<return expression='elt;;;+t;.'/>\n";
        xml_ += "</method>\n";
        xml_ += "</class>\n";
    ...
    public void instanceArgument99Test() {
        ...
        xml_ += "<return expression='array;;;'/>\n";
        xml_ += "</method>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='final' name='getter' class='"+PrimitiveTypeUtil.PRIM_INT+"' var0='i' class0='$int' var1='j' class1='$int...'>\n";
        xml_ += "<declare var='t' class='$int'/>\n";
        xml_ += "<affect left='t;.' oper='=' right='i;.;'/>\n";
        xml_ += "<foreach class='java.lang.Number' var='e' expression='j;.;'>\n";
        xml_ += "<affect left='t;.' oper='+=' right='e;intValue()'/>\n";
        xml_ += "</foreach>\n";
        xml_ += "<return expression='elt;;;+t;.'/>\n";
        xml_ += "</method>\n";
    ...
    public void instanceArgument100Test() {
        ...
        xml_ += "<return expression='elt;;;+t;.'/>\n";
        xml_ += "</method>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='final' name='getter' class='"+PrimitiveTypeUtil.PRIM_INT+"' var0='i' class0='$int' var1='j' class1='$long...'>\n";
        xml_ += "<declare var='t' class='$int'/>\n";
        xml_ += "<affect left='t;.' oper='=' right='i;.;*2i'/>\n";
        xml_ += "<foreach class='java.lang.Number' var='e' expression='j;.;'>\n";
        xml_ += "<affect left='t;.' oper='+=' right='e;intValue()*2i'/>\n";
        xml_ += "</foreach>\n";
        xml_ += "<return expression='elt;;;+t;.'/>\n";
    ...
    public void instanceArgument101Test() {
        ...
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='elt' class='"+PrimitiveTypeUtil.PRIM_INT+"' value='2i'/>\n";
        xml_ += "<instance>\n";
        xml_ += "<affect left='ref()[0i]' oper='=' right='getter($new [$int[](8i,5i))'/>\n";
        xml_ += "</instance>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='final' name='ref' class='"+ARR_OBJECT+"'>\n";
        xml_ += "<return expression='array;;;'/>\n";
        xml_ += "</method>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='final' name='getter' class='"+PrimitiveTypeUtil.PRIM_INT+"' var0='j' class0='$int...'>\n";
        xml_ += "<declare var='t' class='$int'/>\n";
        xml_ += "<foreach class='java.lang.Number' var='e' expression='j;.;'>\n";
        xml_ += "<affect left='t;.' oper='+=' right='e;intValue()'/>\n";
        xml_ += "</foreach>\n";
    ...
    public void instanceArgument102Test() {
        ...
        files_.put("pkg/Ex."+Classes.EXT, xml_);
        xml_ = "<class access='"+PUBLIC_ACCESS+"' name='ExCont' package='pkg'>\n";
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='pre' class='$enum' value='$static$pkg$Ex.TWO;;;'/>\n";
    ...
    public void instanceArgument103Test() {
        ...
        xml_ = "<class access='"+PUBLIC_ACCESS+"' name='ExCont' package='pkg'>\n";
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='pre' class='$enum' value='$static$pkg$Ex.TWO;;;'/>\n";
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='inst' class='$int' value='pre;;;ordinal()'/>\n";
        xml_ += "</class>\n";
        files_.put("pkg/ExCont."+Classes.EXT, xml_);
        xml_ = "<interface access='"+PUBLIC_ACCESS+"' name='Int' package='pkg'>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='abstract' name='name' class='java.lang.String'/>\n";
    ...
    public void instanceArgument104Test() {
        ...
        files_.put("pkg/Ex."+Classes.EXT, xml_);
        xml_ = "<class access='"+PUBLIC_ACCESS+"' name='ExCont' package='pkg'>\n";
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='pre' class='pkg.Int' value='$static$pkg$Ex.TWO;;;'/>\n";
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='inst' class='java.lang.String' value='pre;;;name()'/>\n";
        xml_ += "</class>\n";
        files_.put("pkg/ExCont."+Classes.EXT, xml_);
        xml_ = "<interface access='"+PUBLIC_ACCESS+"' name='Int' package='pkg'>\n";
    ...
    public void instanceArgument112Test() {
        ...
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='inst' class='"+PrimitiveTypeUtil.PRIM_INT+"' value='8i'/>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='normal' name='superaccess' class='"+PrimitiveTypeUtil.PRIM_INT+"'>\n";
        xml_ += "<return expression='$super$inst;;;.intValue()'/>\n";
        xml_ += "</method>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='normal' name='getter' class='"+PrimitiveTypeUtil.PRIM_INT+"'>\n";
        xml_ += "<return expression='2i'/>\n";
        xml_ += "</method>\n";
        ...
        files_.put("pkg/Ex."+Classes.EXT, xml_);
        xml_ = "<class access='"+PUBLIC_ACCESS+"' name='ExTwo' package='pkg'>\n";
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='inst' class='java.lang.Integer' value='16i'/>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='normal' name='getter' class='"+PrimitiveTypeUtil.PRIM_INT+"'>\n";
        xml_ += "<return expression='5i'/>\n";
        xml_ += "</method>\n";
        xml_ += "</class>\n";
    ...
    public void instanceArgument113Test() {
        ...
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='inst' class='"+PrimitiveTypeUtil.PRIM_INT+"' value='8i'/>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='normal' name='superaccess' class='"+PrimitiveTypeUtil.PRIM_INT+"'>\n";
        xml_ += "<return expression='$super$inst;;;+0i'/>\n";
        xml_ += "</method>\n";
        xml_ += "<method access='"+PUBLIC_ACCESS+"' modifier='normal' name='getter' class='"+PrimitiveTypeUtil.PRIM_INT+"'>\n";
        xml_ += "<return expression='2i'/>\n";
        xml_ += "</method>\n";
    ...
    public void instanceArgument114Test() {
        ...
        files_.put("pkg/Ex."+Classes.EXT, xml_);
        xml_ = "<class access='"+PUBLIC_ACCESS+"' name='ExTwo' package='pkg'>\n";
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='ance' class='"+PrimitiveTypeUtil.PRIM_INT+"' value='$classchoice$pkg$Ex$$inst;;;+0i'/>\n";
        xml_ += "</class>\n";
        files_.put("pkg/ExTwo."+Classes.EXT, xml_);
        ContextEl cont_ = contextEl();
        Classes.validateAll(files_, cont_);
    ...
    public void instanceArgument115Test() {
        StringMap<String> files_ = new StringMap<String>();
        String xml_ = "<class access='"+PUBLIC_ACCESS+"' name='Ex' package='pkg'>\n";
        xml_ += "<field static='' access='"+PUBLIC_ACCESS+"' name='inst' class='java.lang.Integer' value='2i'/>\n";
        xml_ += "</class>\n";
        files_.put("pkg/Ex."+Classes.EXT, xml_);
        xml_ = "<class access='"+PUBLIC_ACCESS+"' name='ExTwo' package='pkg'>\n";
        xml_ += "<field access='"+PUBLIC_ACCESS+"' name='ance' class='"+PrimitiveTypeUtil.PRIM_INT+"' value='$classchoice$pkg$Ex$$inst;;;.intValue()'/>\n";
        xml_ += "</class>\n";
        files_.put("pkg/ExTwo."+Classes.EXT, xml_);
        ContextEl cont_ = contextEl();
        Classes.validateAll(files_, cont_);
