...
public final class PartTypeUtilTest {
    ...
    public void processDepends1Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("OuterTwo", 0, context_, root_, true);
        assertTrue(cl_.displayErrors(), context_.isEmptyErrors());
    ...
    public void processDepends2Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("OuterThree<OuterFour>",0, context_, root_, true);
        assertTrue(cl_.displayErrors(), context_.isEmptyErrors());
        assertEq(0, solved_.size());
    }
    @Test
    public void processDepends3Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("OuterThree<OuterFive<OuterFour>>", 0,context_, root_, true);
        assertTrue(cl_.displayErrors(), context_.isEmptyErrors());
        assertEq(0, solved_.size());
    }
    @Test
    public void processDepends4Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("OuterTwo..InnerThree",0,context_, root_, true);
        assertEq(0, solved_.size());
    }
    @Test
    public void processDepends5Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("Outer..InnerThree", 0,context_, root_, true);
        assertEq(1, solved_.size());
        assertTrue(contains(solved_, "pkg.Outer"));
    }
    @Test
    public void processDepends6Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("Outer..InnerThree..InnerInner", 0,context_, root_, true);
        assertEq(2, solved_.size());
        assertTrue(contains(solved_, "pkg.Outer"));
        assertTrue(contains(solved_, "pkgtwo.OuterTwo..InnerThree"));
    }
    @Test
    public void processDepends7Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("..InnerThree..InnerInner", 0,context_, root_, true);
        assertEq(2, solved_.size());
        assertTrue(contains(solved_, "pkg.Outer"));
        assertTrue(contains(solved_, "pkgtwo.OuterTwo..InnerThree"));
    }
    ...
    public void processDepends9Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("Outer<java.lang.Number>..InnerThree", 0,context_, root_, true);
        assertEq(1, solved_.size());
        assertTrue(contains(solved_, "pkg.Outer"));
    }
    @Test
    public void processDepends10Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("Outer<java.lang.Number>..InnerThree<java.lang.String>",0,context_, root_, true);
        assertEq(1, solved_.size());
        assertTrue(contains(solved_, "pkg.Outer"));
    }
    @Test
    public void processDepends11Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("..InnerThree<java.lang.String>", 0,context_, root_, true);
        assertEq(1, solved_.size());
        assertTrue(contains(solved_, "pkg.Outer"));
    }
    @Test
    public void processDepends12Test() {
        ...
        context_.getAvailableVariables().addEntry("H",0);
        context_.getAvailableVariables().addEntry("I",0);
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("Outer<#D>..InnerThree<#H>..InnerInner<#I>", 0,context_, root_, true);
        assertEq(2, solved_.size());
        assertTrue(contains(solved_, "pkg.Outer"));
        assertTrue(contains(solved_, "pkgtwo.OuterTwo..InnerThree"));
    }
    ...
    public void processDepends14Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("OuterTwo<java.lang.Number>[]", 0,context_, root_, true);
        assertTrue(cl_.displayErrors(), context_.isEmptyErrors());
        assertEq(0, solved_.size());
    }
    @Test
    ...
    public void processDepends16Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("java.lang.$Fct<$void>", 0,context_, root_, true);
        assertTrue(cl_.displayErrors(), context_.isEmptyErrors());
        assertEq(0, solved_.size());
    }
    @Test
    ...
    public void processDepends18Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("OuterThree<?>", 0,context_, root_, true);
        assertTrue(cl_.displayErrors(), context_.isEmptyErrors());
        assertEq(0, solved_.size());
    }
    @Test
    ...
    public void processDepends21Test() {
        ...
        EqList<ClassInheritsDeps> solved_ = PartTypeUtil.processAnalyzeDepends("..InnerThree<java.lang.Number>..InnerInner", 0,context_, root_, true);
        assertEq(2, solved_.size());
        assertTrue(contains(solved_, "pkg.Outer"));
        assertTrue(contains(solved_, "pkgtwo.OuterTwo..InnerThree"));
    }
    private static boolean contains(EqList<ClassInheritsDeps> _deps, String _v) {
        for (ClassInheritsDeps c: _deps) {
            if (StringList.quickEq(c.getClassField(),_v)) {
                return true;
            }
        }
        return false;
