...
public class BeanLgNames extends LgNames {
    ...
    public void buildBeans() {
        ...
        method_ = new StandardMethod("beforeDisplaying", params_, getAliasVoid(), false, MethodModifier.NORMAL, "code.bean.Bean", std_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod("getDataBase", params_, getAliasObject(), false, MethodModifier.NORMAL, "code.bean.Bean", std_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasObject());
        method_ = new StandardMethod("setDataBase", params_, getAliasVoid(), false, MethodModifier.NORMAL, "code.bean.Bean", std_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod("getScope", params_, getAliasString(), false, MethodModifier.NORMAL, "code.bean.Bean", std_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod("setScope", params_, getAliasVoid(), false, MethodModifier.NORMAL, "code.bean.Bean", std_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod("getLanguage", params_, getAliasString(), false, MethodModifier.NORMAL, "code.bean.Bean", std_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(getAliasString());
        method_ = new StandardMethod("setLanguage", params_, getAliasVoid(), false, MethodModifier.NORMAL, "code.bean.Bean", std_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod("getForms", params_, aliasStringMapObject, false, MethodModifier.NORMAL, "code.bean.Bean", std_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList(aliasStringMapObject);
        method_ = new StandardMethod("setForms", params_, getAliasVoid(), false, MethodModifier.NORMAL, "code.bean.Bean", std_);
        methods_.put(method_.getId(), method_);
        ...
        params_ = new StringList();
        method_ = new StandardMethod("entries", params_, getAliasSimpleIterableType(), false, MethodModifier.NORMAL, custEntries, cl_);
        methods_.put(method_.getId(), method_);
        cl_.getDirectInterfaces().add(getAliasCountable());
        ...
        params_ = new StringList();
        method_ = new StandardMethod("getKey", params_, getAliasObject(), false, MethodModifier.NORMAL, custEntry,cl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod("getValue", params_, getAliasObject(), false, MethodModifier.NORMAL, custEntry,cl_);
        methods_.put(method_.getId(), method_);
        ...
        params_ = new StringList();
        method_ = new StandardMethod("getNewValue", params_, getAliasObject(), false, MethodModifier.NORMAL, valueChangedEvent, cl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod("getOldValue", params_, getAliasObject(), false, MethodModifier.NORMAL, valueChangedEvent, cl_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod("getIndexes", params_, getCustList(), false, MethodModifier.NORMAL, valueChangedEvent, cl_);
        methods_.put(method_.getId(), method_);
        ...
        method_ = new StandardMethod("validate", params_, getAliasObject(), false, MethodModifier.NORMAL, validator, cl_);
        methods_.put(method_.getId(), method_);
