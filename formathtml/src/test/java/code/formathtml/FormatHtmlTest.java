...
public class FormatHtmlTest {
    ...
    @Ignore
    @Test
    public void getCurrentBean1Test() {
        String html_ = "<html c:bean=\"sample_bean\" xmlns:c='javahtml'><body>{composite.integer} and {composite.integer|trans}</body></html>";
        assertEq("sample_bean", FormatHtml.getCurrentBean(html_));
    }

    @Ignore
    @Test(expected=XmlParseException.class)
    public void getCurrentBean1FailTest() {
        String html_ = "<html xmlns:c='javahtml'><body>{composite.integer} & {composite.integer|trans}</body></html>";
        FormatHtml.getCurrentBean(html_);
    }

    /*@Test
    public void updateFormTags1Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateFormTags(1, doc_);
        assertEq(html_, XmlParser.toHtml(doc_));
    }

    @Test
    public void updateFormTags2Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form name=\"myName\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateFormTags(1, doc_);
        assertXMLEqualRuntime(html_, XmlParser.toHtml(doc_));
    }

    @Test
    public void updateFormTags3Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form name=\"myName()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateFormTags(1, doc_);
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><form name=\"myName(1)\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateFormTags4Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form name=\"myName(2,)\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateFormTags(1, doc_);
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><form name=\"myName(2,1)\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateFormTags5Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form name=\"myName(,)\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateFormTags(1, doc_);
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><form name=\"myName(1,)\"/></body></html>", XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateFormTags6Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form name=\"myName(3,,)\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateFormTags(1, doc_);
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><form name=\"myName(3,1,)\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateSelectTags1Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select default=\"ONE\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateSelectTags("list", "k", "v", "method", 6, doc_);
//        assertXMLEqualNoPrefix(html_, XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select default=\"ONE\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateSelectTags2Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select default=\"ONE\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateSelectTags("list", "e", "e", "method", 6, doc_);
//        assertXMLEqualNoPrefix(html_, XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select default=\"ONE\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateSelectTags3Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select default=\"$k;getter()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateSelectTags("list", "k", "v", "method", 6, doc_);
//        assertXMLEqualNoPrefix("<html><body><c:select default=\"$list[6]method!key.getter()\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select default=\"$list[6]method!key.getter()\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateSelectTags4Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select default=\"$e;getter()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateSelectTags("list", "e", "e", "method", 6, doc_);
//        assertXMLEqualNoPrefix("<html><body><c:select default=\"$list[6].getter()\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select default=\"$list[6].getter()\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateSelectTags5Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select default=\"$v;getter()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateSelectTags("list", "k", "v", "method", 6, doc_);
//        assertXMLEqualNoPrefix("<html><body><c:select default=\"$list[6]method!value.getter()\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select default=\"$list[6]method!value.getter()\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateNotEmptyAttributesMap1Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateNotEmptyAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix(html_, XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateNotEmptyAttributesMap2Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"$v;getter()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateNotEmptyAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
        FormatHtml.updateNotEmptyAttributesMap(doc_, 7, "c_select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"$list[7]method!value.getter()\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"$list[7]method!value.getter()\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateNotEmptyAttributesMap3Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"$k;getter()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateNotEmptyAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
        FormatHtml.updateNotEmptyAttributesMap(doc_, 7, "c_select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"$list[7]method!key.getter()\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"$list[7]method!key.getter()\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateNotEmptyAttributesMap4Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateNotEmptyAttributesMap(doc_, 7, "c:select", "name", "e", "e", "list", "method");
//        assertXMLEqualNoPrefix(html_, XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateNotEmptyAttributesMap5Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"$e;getter()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateNotEmptyAttributesMap(doc_, 7, "c:select", "name", "e", "e", "list", "method");
        FormatHtml.updateNotEmptyAttributesMap(doc_, 7, "c_select", "name", "e", "e", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"$list[7].getter()\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"$list[7].getter()\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateNotEmptyAttributesMap6Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateNotEmptyAttributesMap(doc_, 7, "c:select", "name", "e", "e", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateAllAttributesMap1Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"$v;getter()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
        FormatHtml.updateAllAttributesMap(doc_, 7, "c_select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"$list[7]method!value.getter()\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"$list[7]method!value.getter()\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateAllAttributesMap2Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"$k;getter()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
        FormatHtml.updateAllAttributesMap(doc_, 7, "c_select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"$list[7]method!key.getter()\"/></body></html>", XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateAllAttributesMap3Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"$e;getter()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "e", "e", "list", "method");
        FormatHtml.updateAllAttributesMap(doc_, 7, "c_select", "name", "e", "e", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"$list[7].getter()\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"$list[7].getter()\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateAllAttributesMap4Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"k;;\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
        FormatHtml.updateAllAttributesMap(doc_, 7, "c_select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"7\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"7\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateAllAttributesMap5Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"k;getter() v;getter()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
        FormatHtml.updateAllAttributesMap(doc_, 7, "c_select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"list[7]method!key.getter() list[7]method!value.getter()\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"list[7]method!key.getter() list[7]method!value.getter()\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateAllAttributesMap6Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"k\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"k\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"k\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateAllAttributesMap7Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"a;\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"a;\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"a;\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateAllAttributesMap8Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\";a\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\";a\"/></body></html>", XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateAllAttributesMap9Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"b;a\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"b;a\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"b;a\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateAllAttributesMap10Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"k;\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
        FormatHtml.updateAllAttributesMap(doc_, 7, "c_select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"list[7]method!key\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"list[7]method!key\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateAllAttributesMap11Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"k,\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
        FormatHtml.updateAllAttributesMap(doc_, 7, "c_select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"k,\"/></body></html>", XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateAllAttributesMap12Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\"k;k.\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
        FormatHtml.updateAllAttributesMap(doc_, 7, "c_select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\"list[7]method!keyk.\"/></body></html>", XmlParser.toHtml(doc_));
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_select name=\"list[7]method!keyk.\"/></body></html>", XmlParser.toHtml(doc_));
    }

    @Test
    public void updateAllAttributesMap13Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\" k;\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
        FormatHtml.updateAllAttributesMap(doc_, 7, "c_select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\" list[7]method!key\"/></body></html>", XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateAllAttributesMap14Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\" k,\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
//        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
        FormatHtml.updateAllAttributesMap(doc_, 7, "c_select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\" k,\"/></body></html>", XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateAllAttributesMap15Test() {
        String html_ = "<html xmlns:c='javahtml'><body><c:select name=\" k \"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAllAttributesMap(doc_, 7, "c:select", "name", "k", "v", "list", "method");
//        assertXMLEqualNoPrefix("<html><body><c:select name=\" k \"/></body></html>", XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateAttributesWithPrefix1Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAttributesWithPrefix(doc_, 1, "form", "name");
        assertXMLEqualRuntime(html_, XmlParser.toHtml(doc_));
    }

    @Test
    public void updateAttributesWithPrefix2Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form name=\"$myName\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAttributesWithPrefix(doc_, 1, "form", "name");
        assertXMLEqualRuntime(html_, XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateAttributesWithPrefix3Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form name=\"$myName()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAttributesWithPrefix(doc_, 1, "form", "name");
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><form name=\"$myName(1)\"/></body></html>", XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateAttributesWithPrefix4Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form name=\"$myName(2,)\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAttributesWithPrefix(doc_, 1, "form", "name");
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><form name=\"$myName(2,1)\"/></body></html>", XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateAttributesWithPrefix5Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form name=\"$myName(,)\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAttributesWithPrefix(doc_, 1, "form", "name");
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><form name=\"$myName(1,)\"/></body></html>", XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateAttributesWithPrefix6Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form name=\"$myName(3,,)\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAttributesWithPrefix(doc_, 1, "form", "name");
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><form name=\"$myName(3,1,)\"/></body></html>", XmlParser.toHtml(doc_));
    ...
    @Test
    public void updateAttributesWithPrefix7Test() {
        String html_ = "<html xmlns:c='javahtml'><body><form name=\"myName()\"/></body></html>";
        Document doc_ = XmlParser.parseSaxHtml(html_, false, true);
        FormatHtml.updateAttributesWithPrefix(doc_, 1, "form", "name");
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><form name=\"myName()\"/></body></html>", XmlParser.toHtml(doc_));
    }*/

    //updateNotEmptyAttributesMap
    @Test
...
//        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><c_tmp>ONE - <c_tmp>1;</c_tmp><br/></c_tmp><c_tmp>THREE - <c_tmp>4;</c_tmp><c_tmp>5;</c_tmp><c_tmp>6;</c_tmp><br/></c_tmp><c_tmp>TWO - <c_tmp>2;</c_tmp><c_tmp>3;</c_tmp><br/></c_tmp></body></html>", render_);
    ...
    public void processHtml81Test() {
        ...
        String relative_ = "sample/file";
        String content_ = "one=Description one\ntwo=Description two\nthree=desc &lt;{0}&gt;";
//        String html_ = "<html xmlns:c='javahtml'><body><c:set var=\"v\" expression='null' className='java.lang.Object'/><c:for key=\"k\" value=\"v\" map=\"numbers\" orderedKeys=\"sortedNumberKeys\" varClassName='util.List'><c:for var=\"w\" list=\"v;getReverse()\"><span id=\"numbers[`k;;`]sortedNumberKeys!value.getReverse()[`w;;`]\"/></c:for></c:for></body></html>";
//        String html_ = "<html xmlns:c='javahtml'><body><c:set var=\"v\" expression='null' className='java.lang.Object'/><c:for key=\"k\" value=\"v\" map=\"numbers\" varClassName='util.List'><c:for var=\"w\" list=\"v;getReverse()\"><span id=\"numbers[`k;;`]sortedNumberKeys!value.getReverse()[`w;;`]\"/></c:for></c:for></body></html>";
//        String html_ = "<html xmlns:c='javahtml'><body><c:set var=\"v\" expression='null' className='java.lang.Object'/><c:for key=\"k\" value=\"v\" map=\"numbers\" varClassName='util.ints.Listable'><c:for var=\"w\" list=\"v;getReverse()\"><span id=\"numbers[`k;;`]sortedNumberKeys!value.getReverse()[`w;;`]\"/></c:for></c:for></body></html>";
...
//        render_ = FormatHtml.processSpansErrors(render_);
    ...
    public void processHtmlJava1Test() {
        ...
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><a param0=\"$typedString\" title=\"desc &amp;lt;TITLE2&amp;gt;\" value=\"sample/file,three\">Content</a></body></html>", render_);
    ...
    public void processHtmlJava2Test() {
        ...
        conf_.getTranslators().put("trans", new MyTranslator());
        String render_ = FormatHtml.processHtmlJava(html_, conf_, locale_, files_);
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><a param0=\"TITLE\" title=\"desc &amp;lt;TITLE&amp;gt;\" value=\"sample/file,three\">Content</a></body></html>", render_);
    }*/
    ...
    public void processImports2Test() {
        ...
        conf_.getTranslators().put("trans", new MyTranslator());
        String render_ = FormatHtml.processImports(html_, conf_, locale_, files_);
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><a c:command=\"go\" href=\"\">Content</a></body></html>", render_);
    }
    ...
    public void processImports5Test() {
        ...
        conf_.getTranslators().put("trans", new MyTranslator());
        String render_ = FormatHtml.processImports(html_, conf_, locale_, files_);
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body><a c:command=\"go\" href=\"\">Test {0}2</a></body></html>", render_);
    ...
    public void processImports6Test() {
        ...
        conf_.getTranslators().put("trans", new MyTranslator());
        String render_ = FormatHtml.processImports(html_, conf_, locale_, files_);
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body>HEAD<a href=\"\"/> NEXT<a c:command=\"go\" href=\"\">4</a></body></html>", render_);
    }
    ...
    public void processImports7Test() {
        ...
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body> NEXT<form action=\"\" c:command=\"go\">0</form><form action=\"go\">0</form></body></html>", render_);
    }
...
//        assertEq("<html><body>HEAD<a href=\"\"/>HEAD<a href=\"\"/></body></html>", render_);
    ...
    public void processImports10Test() {
        ...
        String relative_ = "sample/file";
        String content_ = "one=Description one\ntwo=Description <a href=\"\">two</a>\nthree=desc &lt;{0}&gt;\nfour=''asp''";
        String html_ = "<html c:bean=\"bean_one\" xmlns:c='javahtml' xmlns='javahtml'><body><c:import page=\"page2.html\" keepfields=\"y\"><a/><c:package name=\"formathtml.classe\"><a/><c:class name=\"BeanTwo\"><a/><c:field name=\"typedString\" value=\"message\"><a/></c:field></c:class></c:package></c:import></body></html>";
        String htmlTwo_ = "<html c:bean=\"bean_two\" xmlns:c='javahtml' xmlns='javahtml'><body><a href=\"DELETE\" c:command=\"go\">{typedString}</a></body></html>";
        Map<String,String> files_ = new Map<String,String>();
        files_.put(folder_+"/"+locale_+"/"+relative_+".properties", content_);
        files_.put("page1.html", html_);
    ...
    public void processImports15Test() {
        ...
        String relative_ = "sample/file";
        String content_ = "one=Description one\ntwo=Description <a href=\"\">two</a>\nthree=desc &lt;{0}&gt;\nfour=''asp''";
        String html_ = "<html c:bean=\"bean_one\" xmlns:c='javahtml' xmlns='javahtml'><body>HEAD<a href=\"\"/><!--COMMENT--><c:import page=\"page2.html\"><a/><c:package name=\""+PKG+"\"><a/><c:class name=\"BeanTwo\"><a/><c:field method=\"setTypedInt\" name=\"typedInt\" value=\"4\" className='"+PrimitiveTypeUtil.PRIM_INT+"'><a/></c:field></c:class></c:package></c:import></body></html>";
        String htmlTwo_ = "<html c:bean=\"bean_two\" xmlns:c='javahtml' xmlns='javahtml'><body> NEXT<!--COMMENT--><a href=\"DELETE\" c:command=\"go\">{typedInt}</a></body></html>";
        Map<String,String> files_ = new Map<String,String>();
        files_.put(folder_+"/"+locale_+"/"+relative_+".properties", content_);
        files_.put("page1.html", html_);
...
//        assertEq("<html><body>HEAD<a href=\"\"/>HEAD<a href=\"\"/></body></html>", render_);
    ...
    public void processImports16Test() {
        ...
        conf_.getTranslators().put("trans", new MyTranslator());
        String render_ = FormatHtml.processImports(html_, conf_, locale_, files_);
        assertXMLEqualRuntime("<html xmlns:c='javahtml' xmlns='javahtml'><body>HEAD<a href=\"\"/><emb><ed>T</ed><ed>T</ed></emb> NEXT<a c:command=\"go\" href=\"\">4</a></body></html>", render_);
    }*/
...
//        assertEq("<html><body>HEAD<a href=\"\"/>HEAD<a href=\"\"/></body></html>", render_);
    ...
    public void processImports22Test() {
        ...
        String relative_ = "sample/file";
        String content_ = "one=Description one\ntwo=Description two\nthree=desc &lt;{0}&gt;";
        String html_ = "<html xmlns:c='javahtml'><body><c:set var=\"list\" expression=\"^new."+CUST_LIST+"()\" className='"+CUST_LIST+"'/>{list;.size()}</body></html>";
        StringMap<String> files_ = new StringMap<String>();
        files_.put(folder_+"/"+locale_+"/"+relative_+".properties", content_);
        files_.put("page1.html", html_);
        BeanOne bean_ = new BeanOne();
    ...
    public void processImports23Test() {
        ...
        String relative_ = "sample/file";
        String content_ = "one=Description one\ntwo=Description two\nthree=desc &lt;{0}&gt;";
        String html_ = "<html xmlns:c='javahtml'><body><c:set var=\"list\" expression=\"^new."+CUST_LIST+"()\" className=\""+CUST_LIST+"\"/><c:set var=\"listTwo\" expression=\"^new."+CUST_LIST+"(list;.)\" className=\""+CUST_LIST+"\"/>{listTwo;.size()}</body></html>";
        StringMap<String> files_ = new StringMap<String>();
        files_.put(folder_+"/"+locale_+"/"+relative_+".properties", content_);
        files_.put("page1.html", html_);
        BeanOne bean_ = new BeanOne();
    ...
    public void processImports25Test() {
        ...
        String relative_ = "sample/file";
        String content_ = "one=Description one\ntwo=Description two\nthree=desc &lt;{0}&gt;";
        String html_ = "<html xmlns:c='javahtml'><body><c:set var=\"elt\" expression=\"2\"/><c:set var=\"elt\" expression=\"elt;.\" className=\"java.lang.Object\"/><c:set var=\"list\" expression=\"^new."+CUST_LIST+"()\" className='"+CUST_LIST+"'/><c:set expression=\"list;.add(elt;.)\"/>{list;.size()}-{list;.get(0i)}</body></html>";
        StringMap<String> files_ = new StringMap<String>();
        files_.put(folder_+"/"+locale_+"/"+relative_+".properties", content_);
        files_.put("page1.html", html_);
        BeanOne bean_ = new BeanOne();
...
//        String html_ = "<html xmlns:c='javahtml'><body><c:set var=\"list\" expression=\"new.util.List()\" className=\"java.util.List\"/><c:set expression='list;.add(class(\"java.lang.Object\",1i))'/><c:set expression='list;.add(class(\"java.lang.Object\",2i))'/><c:set var=\"listTwo\" expression=\"new.util.List(list;.)\" className=\"util.List\"/>{listTwo;.size()}</body></html>";
        String html_ = "<html xmlns:c='javahtml'><body><c:set var=\"list\" expression=\"^new."+CUST_LIST+"()\" className=\""+CUST_LIST+"\"/><c:set expression='list;.add(^class(\"java.lang.Object\",1i))'/><c:set expression='list;.add(^class(\"java.lang.Object\",2i))'/><c:set var=\"listTwo\" expression=\"^new."+CUST_LIST+"(list;.)\" className=\""+CUST_LIST+"\"/>{listTwo;.size()}</body></html>";
        StringMap<String> files_ = new StringMap<String>();
        files_.put(folder_+"/"+locale_+"/"+relative_+".properties", content_);
        files_.put("page1.html", html_);
        BeanOne bean_ = new BeanOne();
...
//        assertEq(0, beanTwo_.getForms().size());
    ...
    public void processImports4FailTest() {
        ...
        String relative_ = "sample/file";
        String content_ = "one=Description one\ntwo=Description two\nthree=desc &lt;{0}&gt;";
        String html_ = "<html xmlns:c='javahtml'><body><c:set var=\"list\" expression=\"^new."+CUST_LIST+"()\" className=\"java.lang.Iterable\"/><c:set var=\"listTwo\" expression=\"^new."+CUST_LIST+"(list;.)\" className=\""+CUST_LIST+"\"/>{listTwo;.size()}</body></html>";
        StringMap<String> files_ = new StringMap<String>();
        files_.put(folder_+"/"+locale_+"/"+relative_+".properties", content_);
        files_.put("page1.html", html_);
        BeanOne bean_ = new BeanOne();
