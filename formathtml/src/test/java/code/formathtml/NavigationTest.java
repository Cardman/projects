...
//        assertXMLEqualNoPrefix("<html><head><title>desc &lt;My quoted title&gt;&amp;eacute;</title></head><body>HEAD<a c:command=\"$bean_one.goToPage(4)\" href=\"\"/></body></html>", nav_.getHtmlText());
        ...
        assertEq(0, conf_.getBeans().getVal("bean_two").getForms().size());
        assertNotSame(conf_.getBeans().getVal("bean_one").getForms(), conf_.getBeans().getVal("bean_two").getForms());
        assertEq("desc &lt;My quoted title&gt;"+(char)233,nav_.getTitle());
        assertEq("",nav_.getReferenceScroll());
        assertEq(0,nav_.getTooltips().size());
    }
    ...
    public void processAnchorRequest9Test() {
        ...
        assertEq(0, conf_.getBeans().getVal("bean_two").getForms().size());
        assertNotSame(conf_.getBeans().getVal("bean_one").getForms(), conf_.getBeans().getVal("bean_two").getForms());
        assertEq("Description one"+(char)233,nav_.getTitle());
        assertEq("",nav_.getReferenceScroll());
        assertEq(0,nav_.getTooltips().size());
    }
...
//        assertEq(8, map_.getVal("typedInt"));
    ...
    public void processFormRequest46Test() {
        ...
        assertEq(8, map_.size());
        assertTrue(!(Boolean)map_.getVal("checked"));
        assertEq((char)228+" %", (String)map_.getVal("typedString"));
        assertEq(EnumNumber.TWO, (EnumNumber) map_.getVal("chosenNumber"));
        assertEq(0,(Number) map_.getVal("typedInt"));
        assertTrue(map_.contains("rate"));
        assertNull( map_.getVal("rate"));
...
//        nav_.processFormRequest("bean_two.typedString=%u0178", "myform");
        ...
        ni_ = nc_.getNodeInformation();
        values_ = new StringList();
        values_.add(String.valueOf((char)376));
        ni_.setValue(values_);
        nav_.getHtmlPage().setUrl(0);
        nav_.processFormRequest();
        setupBeansAfter(conf_);
        ...
        assertEq(8, map_.size());
        assertTrue(!(Boolean)map_.getVal("checked"));
        assertEq(""+(char)376, (String)map_.getVal("typedString"));
        assertEq(EnumNumber.TWO, (EnumNumber) map_.getVal("chosenNumber"));
        assertEq(0, (Number)map_.getVal("typedInt"));
        assertTrue(map_.contains("rate"));
        assertNull( map_.getVal("rate"));
...
//        assertXMLEqualNoPrefix("<html bean=\"bean_seven\"><body><form n-f=\"0\" action=\"\" name=\"myform\" c:command=\"$bean_seven.validateMap\"><input n-i=\"0\" type=\"text\" name=\"bean_seven.getTree()[0]goto!key\" value=\"keyfour\" varValue=\"k;\" c:className=\"java.lang.String\"/><input n-i=\"1\" type=\"text\" name=\"bean_seven.getTree()[1]goto!key\" value=\"keythree\" varValue=\"k;\" c:className=\"java.lang.String\"/></form></body></html>", nav_.getHtmlText());
    ...
    public void processFormRequest86Test() {
        ...
        html_ += "<input type=\"radio\" c:className='$long' name='getRadioLong()' c:varValue='2' c:varMethod='setRadioLong'/>";
        html_ += "<input type=\"text\" c:className='java.lang.String' name='getTypedString()' c:varMethod='setTypedString'/>";
        html_ += "<input type=\"checkbox\" c:className='$boolean' name='isCheckBox()' c:varMethod='setCheckBox'/>";
        html_ += "<c:select className='code.formathtml.classes.EnumNumber' list='getCombobox()' name='getComboNumber()' varMethod='setComboNumber' varValue='getComboNumber()'/>";
        ...
        res_ += "<input c:className='$long' c:varMethod='setRadioLong' n-i='0' name='bean_seven.getRadioLong()' type='radio' value='2'/>";
        res_ += "<input type=\"text\" c:className='java.lang.String' n-i='1' name='bean_seven.getTypedString()' c:varMethod='setTypedString'/>";
        res_ += "<input type=\"checkbox\" c:className='$boolean' n-i='2' name='bean_seven.isCheckBox()' c:varMethod='setCheckBox'/>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumber' name='bean_seven.getComboNumber()' n-i='3' c:varMethod='setComboNumber'>";
        res_ += "<option value='ONE' selected='selected'>";
        res_ += "ONE";
        res_ += "</option>";
        res_ += "<option value='TWO'>";
        res_ += "TWO";
        res_ += "</option>";
        res_ += "<option value='THREE'>";
        res_ += "THREE";
        res_ += "</option>";
        res_ += "<option value='FOUR'>";
        res_ += "FOUR";
        res_ += "</option>";
        res_ += "<option value='FIVE'>";
        res_ += "FIVE";
        res_ += "</option>";
        res_ += "<option value='SIX'>";
        res_ += "SIX";
        res_ += "</option>";
        res_ += "</select>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumbers' multiple='multiple' name='bean_seven.getComboNumbers()' n-i='4' c:varMethod='setComboNumbers'>";
        res_ += "<option value='ONE' selected='selected'>";
        res_ += "ONE";
        res_ += "</option>";
        res_ += "<option value='TWO'>";
        ...
        res_ += "THREE";
        res_ += "</option>";
        res_ += "<option value='FOUR' selected='selected'>";
        res_ += "FOUR";
        res_ += "</option>";
        res_ += "<option value='FIVE'>";
        res_ += "FIVE";
        ...
        res_ += "</option>";
        res_ += "</select>";
        res_ += "<textarea c:className='java.lang.String' n-i='5' name='bean_seven.getTypedText()' c:varMethod='setTypedText'/>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumber' name='bean_seven.getComboNumberTwo()' n-i='6' c:varMethod='setComboNumberTwo'>";
        res_ += "<option value='ONE'>";
        res_ += "ONE";
        res_ += "</option>";
        res_ += "<option value='TWO'>";
        res_ += "TWO";
        res_ += "</option>";
        res_ += "<option value='THREE' selected='selected'>";
        res_ += "THREE";
        res_ += "</option>";
        res_ += "<option value='FOUR'>";
        res_ += "FOUR";
        ...
        res_ += "<form action='' c:command='$bean_seven.setup' n-f='0' name='myform'>";
        res_ += "<input c:className='$long' c:varMethod='setRadioLong' n-i='0' name='bean_seven.getRadioLong()' type='radio' value='1'/>";
        res_ += "<input c:className='$long' checked='checked' c:varMethod='setRadioLong' n-i='0' name='bean_seven.getRadioLong()' type='radio' value='2'/>";
        res_ += "<input type=\"text\" c:className='java.lang.String' n-i='1' name='bean_seven.getTypedString()' c:varMethod='setTypedString'/>";
        res_ += "<input type=\"checkbox\" c:className='$boolean' n-i='2' name='bean_seven.isCheckBox()' c:varMethod='setCheckBox'/>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumber' name='bean_seven.getComboNumber()' n-i='3' c:varMethod='setComboNumber'>";
        res_ += "<option value='ONE'>";
        res_ += "ONE";
        res_ += "</option>";
        res_ += "<option value='TWO' selected='selected'>";
        res_ += "TWO";
        res_ += "</option>";
        res_ += "<option value='THREE'>";
        res_ += "THREE";
    ...
    public void processFormRequest87Test() {
        ...
        html_ += "<input type=\"radio\" c:className='$long' name='c;getRadioLong()' c:varValue='1' c:varMethod='setRadioLong'/>";
        html_ += "<input type=\"radio\" c:className='$long' name='c;getRadioLong()' c:varValue='2' c:varMethod='setRadioLong'/>";
        html_ += "<input type=\"text\" c:className='java.lang.String' name='c;getTypedString()' c:varMethod='setTypedString'/>";
        html_ += "<input type=\"checkbox\" c:className='$boolean' name='c;isCheckBox()' c:varMethod='setCheckBox'/>";
        html_ += "<c:select className='code.formathtml.classes.EnumNumber' list='getCombobox()' name='c;getComboNumber()' varMethod='setComboNumber' varValue='c;getComboNumber()'/>";
        html_ += "<c:select className='code.formathtml.classes.EnumNumbers' list='getCombobox()' multiple='' name='c;getComboNumbers()' varMethod='setComboNumbers' varValue='c;getComboNumbers()'/>";
        html_ += "<textarea c:className='java.lang.String' name='c;getTypedText()' c:varMethod='setTypedText'/>";
        html_ += "<c:select className='code.formathtml.classes.EnumNumber' map='getComboboxMap()' name='c;getComboNumberTwo()' varMethod='setComboNumberTwo' varValue='c;getComboNumberTwo()'/>";
        html_ += "</c:for>";
        html_ += "</form>";
        html_ += "</body>";
        html_ += "</html>";
        ...
        res_ += "<input c:className='$long' c:varMethod='setRadioLong' n-i='0' name='bean_seven.c;getRadioLong()' type='radio' value='2'/>";
        res_ += "<input type=\"text\" c:className='java.lang.String' n-i='1' name='bean_seven.c;getTypedString()' c:varMethod='setTypedString'/>";
        res_ += "<input type=\"checkbox\" c:className='$boolean' n-i='2' name='bean_seven.c;isCheckBox()' c:varMethod='setCheckBox'/>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumber' name='bean_seven.c;getComboNumber()' n-i='3' c:varMethod='setComboNumber'>";
        res_ += "<option value='ONE' selected='selected'>";
        res_ += "ONE";
        res_ += "</option>";
        res_ += "<option value='TWO'>";
        ...
        res_ += "</option>";
        res_ += "</select>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumbers' multiple='multiple' name='bean_seven.c;getComboNumbers()' n-i='4' c:varMethod='setComboNumbers'>";
        res_ += "<option value='ONE' selected='selected'>";
        res_ += "ONE";
        res_ += "</option>";
        res_ += "<option value='TWO'>";
        ...
        res_ += "</option>";
        res_ += "</select>";
        res_ += "<textarea c:className='java.lang.String' n-i='5' name='bean_seven.c;getTypedText()' c:varMethod='setTypedText'/>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumber' name='bean_seven.c;getComboNumberTwo()' n-i='6' c:varMethod='setComboNumberTwo'>";
        res_ += "<option value='ONE'>";
        res_ += "ONE";
        res_ += "</option>";
        res_ += "<option value='TWO'>";
        ...
        res_ += "</option>";
        res_ += "</select>";
        res_ += "<input c:className='$long' c:varMethod='setRadioLong' n-i='7' name='bean_seven.c;getRadioLong()' type='radio' value='1'/>";
        res_ += "<input c:className='$long' c:varMethod='setRadioLong' n-i='7' name='bean_seven.c;getRadioLong()' type='radio' value='2'/>";
        res_ += "<input type=\"text\" c:className='java.lang.String' n-i='8' name='bean_seven.c;getTypedString()' c:varMethod='setTypedString'/>";
        res_ += "<input type=\"checkbox\" c:className='$boolean' n-i='9' name='bean_seven.c;isCheckBox()' c:varMethod='setCheckBox'/>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumber' name='bean_seven.c;getComboNumber()' n-i='10' c:varMethod='setComboNumber'>";
        res_ += "<option value='ONE' selected='selected'>";
        res_ += "ONE";
        res_ += "</option>";
        res_ += "<option value='TWO'>";
        ...
        res_ += "</option>";
        res_ += "</select>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumbers' multiple='multiple' name='bean_seven.c;getComboNumbers()' n-i='11' c:varMethod='setComboNumbers'>";
        res_ += "<option value='ONE' selected='selected'>";
        res_ += "ONE";
        res_ += "</option>";
        res_ += "<option value='TWO'>";
        ...
        res_ += "</option>";
        res_ += "</select>";
        res_ += "<textarea c:className='java.lang.String' n-i='12' name='bean_seven.c;getTypedText()' c:varMethod='setTypedText'/>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumber' name='bean_seven.c;getComboNumberTwo()' n-i='13' c:varMethod='setComboNumberTwo'>";
        res_ += "<option value='ONE'>";
        res_ += "ONE";
        res_ += "</option>";
        res_ += "<option value='TWO'>";
        ...
        res_ += "<form action='' c:command='$bean_seven.setup' n-f='0' name='myform'>";
        res_ += "<input c:className='$long' c:varMethod='setRadioLong' n-i='0' name='bean_seven.c;getRadioLong()' type='radio' value='1'/>";
        res_ += "<input c:className='$long' checked='checked' c:varMethod='setRadioLong' n-i='0' name='bean_seven.c;getRadioLong()' type='radio' value='2'/>";
        res_ += "<input type=\"text\" c:className='java.lang.String' n-i='1' name='bean_seven.c;getTypedString()' c:varMethod='setTypedString'/>";
        res_ += "<input type=\"checkbox\" c:className='$boolean' n-i='2' name='bean_seven.c;isCheckBox()' c:varMethod='setCheckBox'/>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumber' name='bean_seven.c;getComboNumber()' n-i='3' c:varMethod='setComboNumber'>";
        res_ += "<option value='ONE'>";
        ...
        res_ += "</option>";
        res_ += "</select>";
        res_ += "<input c:className='$long' checked='checked' c:varMethod='setRadioLong' n-i='7' name='bean_seven.c;getRadioLong()' type='radio' value='1'/>";
        res_ += "<input c:className='$long' c:varMethod='setRadioLong' n-i='7' name='bean_seven.c;getRadioLong()' type='radio' value='2'/>";
        res_ += "<input type=\"text\" c:className='java.lang.String' n-i='8' name='bean_seven.c;getTypedString()' c:varMethod='setTypedString'/>";
        res_ += "<input type=\"checkbox\" c:className='$boolean' n-i='9' name='bean_seven.c;isCheckBox()' c:varMethod='setCheckBox'/>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumber' name='bean_seven.c;getComboNumber()' n-i='10' c:varMethod='setComboNumber'>";
        ...
        res_ += "FIVE";
        res_ += "</option>";
        res_ += "<option value='SIX' selected='selected'>";
        res_ += "SIX";
        res_ += "</option>";
        res_ += "</select>";
        res_ += "<select c:className='code.formathtml.classes.EnumNumbers' multiple='multiple' name='bean_seven.c;getComboNumbers()' n-i='11' c:varMethod='setComboNumbers'>";
        ...
        res_ += "FOUR";
        res_ += "</option>";
        res_ += "<option value='FIVE' selected='selected'>";
        res_ += "FIVE";
        res_ += "</option>";
        res_ += "<option value='SIX'>";
        res_ += "SIX";
