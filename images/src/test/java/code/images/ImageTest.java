...
public class ImageTest {
    ...
    public void isValid1Test() {
        Image img_ = new Image(StringList.concat("0",String.valueOf(Image.SEPARATOR_CHAR),"1"));
    ...
    public void isValid3Test() {
        Image img_ = new Image(StringList.concat("1",String.valueOf(Image.SEPARATOR_CHAR),"1"));
        assertTrue(img_.isValid());
    }
    ...
    public void isValid5Test() {
        Image img_ = new Image(StringList.concat("3",String.valueOf(Image.SEPARATOR_CHAR),"4",String.valueOf(Image.SEPARATOR_CHAR),"5"));
        assertTrue(!img_.isValid());
    }
    ...
    public void toString2Test() {
        Image img_ = new Image(StringList.concat("1",String.valueOf(Image.SEPARATOR_CHAR),"2"));
        assertEq(StringList.concat("1",String.valueOf(Image.SEPARATOR_CHAR),"2"), img_.display());
    }
