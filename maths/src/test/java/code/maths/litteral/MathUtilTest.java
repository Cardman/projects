...
public class MathUtilTest {
    ...
    public void evaluateExp_1FailTest(){
        assertTrue(MathUtil.processEl("(2*1+1):0", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_2FailTest(){
        assertTrue(MathUtil.processEl("(2*1+1):0+1", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_3FailTest(){
        assertTrue(MathUtil.processEl("1+(2*1+1):0", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_4FailTest(){
        assertTrue(MathUtil.processEl("1+(2*1+1):0+8", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    ...
    public void evaluateExp_6FailTest(){
        assertTrue(MathUtil.processEl("(1:0)+4", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_7FailTest(){
        assertTrue(MathUtil.processEl("div(1,0)+4", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_8FailTest(){
        assertTrue(MathUtil.processEl("1:0+1", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    ...
    public void evaluateExp_10FailTest(){
        assertTrue(MathUtil.processEl("div(1,-0)+1", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_11FailTest(){
        assertTrue(MathUtil.processEl("1+2*5:0", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    ...
    public void evaluateExp_13FailTest(){
        assertTrue(MathUtil.processEl("1+3:0", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_14FailTest(){
        assertTrue(MathUtil.processEl("1+3+5:0", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    ...
    public void evaluateExp_17FailTest(){
        assertTrue(MathUtil.processEl("-3*5:0", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    ...
    public void evaluateExp_22FailTest(){
        assertTrue(MathUtil.processEl("quot(1,0)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    ...
    public void evaluateExp_24FailTest(){
        assertTrue(MathUtil.processEl("mod(1,0)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    ...
    public void evaluateExp_26FailTest(){
        assertTrue(MathUtil.processEl("modtaux(1,0)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    ...
    public void evaluateExp_28FailTest(){
        assertTrue(MathUtil.processEl("abs(1:0)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_29FailTest(){
        assertTrue(MathUtil.processEl("quot(1,1:0)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_30FailTest(){
        assertTrue(MathUtil.processEl("quot(1,1:0+1)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_31FailTest(){
        assertTrue(MathUtil.processEl("2*quot(1:0,1)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_32FailTest(){
        assertTrue(MathUtil.processEl("2*quot(1,1:0)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_33FailTest(){
        assertTrue(MathUtil.processEl("2*quot(1,0)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_34FailTest(){
        assertTrue(MathUtil.processEl("quot(1:0,1)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    public void evaluateExp_35FailTest(){
        assertTrue(MathUtil.processEl("quot(1:0+1,1)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    ...
    public void evaluateExp_37FailTest(){
        assertTrue(MathUtil.processEl("puis(0,-1)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    ...
    public void evaluateExp_39FailTest(){
        assertTrue(MathUtil.processEl("(-1:0+1)+1", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
    ...
    public void evaluateExp_unknownFct_1Fail(){
        assertTrue(MathUtil.processEl("string(0,-1)", false, new StringMap<String>()).getObject() instanceof ErrorStatus);
    }
    @Test
