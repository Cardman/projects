...
public final class PokemonStandards extends BeanNatLgNames {
    ...
    private static void buildActivityOfMove(BeanLgNames _std) {
        ...
        params_ = new StringList();
        method_ = new StandardMethod(IS_INCREMENT_COUNT,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_NB_TURN,params_,_std.getAliasPrimShort(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_ACTIVITY_OF_MOVE, type_);
    }
    private static void buildMoveTarget(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_TARGET,params_,PokemonStandards.TYPE_TARGET_COORDS, false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_MOVE_TARGET, type_);
    }
    private static void buildTargetCoords(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_TARGET_COORDS, type_);
    }
    private static void buildUsesOfMove(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_MAX,params_,_std.getAliasPrimShort(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_USES_OF_MOVE, type_);
    }
    private static void buildCopiedMove(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_PP,params_,_std.getAliasPrimShort(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_COPIED_MOVE, type_);
    }
    private static void buildMoveTeamPosition(BeanLgNames _std) {
        ...
        method_ = new StandardMethod(GET_MOVE,params_,_std.getAliasString(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_MOVE_TEAM_POSITION, type_);
    }
    private static void buildAffectedMove(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_ACTIVITY,params_,PokemonStandards.TYPE_ACTIVITY_OF_MOVE, false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_AFFECTED_MOVE, type_);
    }
    private static void buildStacksOfUses(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(IS_FIRST_STACKED,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(IS_LAST_STACKED,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_STACKS_OF_USES, type_);
    }
    private static void buildAnticipation(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(IS_INCREMENTING,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_NB_ROUNDS,params_,_std.getAliasPrimByte(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_ANTICIPATION, type_);
    }
    private static void buildRate(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(IS_ZERO_OR_GT,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(ABS_NB,params_,PokemonStandards.TYPE_RATE, false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_RATE, type_);
    }
    private static void buildTypeDamageBoost(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_TYPE_DAMAGE_BOOST, type_);
    }
    private static void buildEfficiencyRate(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_EFFICIENCY_RATE, type_);
    }
    private static void buildBoostHpRate(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_BOOST,params_,_std.getAliasPrimByte(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_BOOST_HP_RATE, type_);
    }
    ...
    private static void buildPokemon(BeanLgNames _std) {
        ...
        method_ = new StandardMethod(GET_ITEM,params_,_std.getAliasString(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_POKEMON, type_);
    }
    ...
    private static void buildWildPk(BeanLgNames _std) {
        ...
        method_ = new StandardMethod(GET_ITEM,params_,_std.getAliasString(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_WILD_PK, type_);
    }
    private static void buildPlace(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_PLACE, type_);
    }
    private static void buildTypesDuo(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_POKEMON_TYPE,params_,_std.getAliasString(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_TYPES_DUO, type_);
    }
    private static void buildCategoryMult(BeanLgNames _std) {
        ...
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_MULT,params_,_std.getAliasPrimShort(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_CATEGORY_MULT, type_);
    }
    private static void buildLevelMove(BeanLgNames _std) {
        ...
        method_ = new StandardMethod(GET_MOVE,params_,_std.getAliasString(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_LEVEL_MOVE, type_);
    }
    private static void buildPokemonPlayer(BeanLgNames _std) {
        ...
        params_ = new StringList();
        method_ = new StandardMethod(GET_WON_EXP_SINCE_LAST_LEVEL,params_,PokemonStandards.TYPE_RATE, false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_HAPPINESS,params_,_std.getAliasPrimShort(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_POKEMON_PLAYER, type_);
    }
    private static void buildEffectPartnerStatus(BeanLgNames _std) {
        ...
        params_ = new StringList();
        method_ = new StandardMethod(GET_RESTORED_HP_RATE_LOVED_ALLY,params_,PokemonStandards.TYPE_RATE, false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_WEDDING_ALLY,params_,_std.getAliasPrimBoolean(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_MULT_DAMAGE_AGAINST_FOE,params_,PokemonStandards.TYPE_RATE, false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_EFFECT_PARTNER_STATUS, type_);
    }
    private static void buildTrainerPlaceNames(BeanLgNames _std) {
        ...
        params_ = new StringList();
        method_ = new StandardMethod(GET_TRAINER,params_,_std.getAliasString(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        params_ = new StringList();
        method_ = new StandardMethod(GET_PLACE,params_,_std.getAliasString(), false, MethodModifier.NORMAL,type_);
        methods_.put(method_.getId(), method_);
        _std.getStandards().put(TYPE_TRAINER_PLACE_NAMES, type_);
    }
    ...
    private static void buildEffectWhileSending(BeanLgNames _std) {
        ...
        _std.getStandards().put(TYPE_EFFECT_WHILE_SENDING, type_);
    }
    private static void buildAlly(BeanLgNames _std) {
        ...
        _std.getStandards().put(TYPE_ALLY, type_);
    }
    private static void buildTempTrainer(BeanLgNames _std) {
        ...
        _std.getStandards().put(TYPE_TEMP_TRAINER, type_);
    }
    private static void buildTrainerOneFight(BeanLgNames _std) {
        ...
        _std.getStandards().put(TYPE_TRAINER_ONE_FIGHT, type_);
    }
    private static void buildTrainer(BeanLgNames _std) {
        ...
        _std.getStandards().put(TYPE_TRAINER, type_);
    }
    ...
    private String getOtherBeanStructClassName(Object _struct) {
        ...
        if (_struct instanceof LanguageElementKey) {
            return AikiBeansHelpStd.TYPE_LANGUAGE_ELEMENT_KEY;
        }
