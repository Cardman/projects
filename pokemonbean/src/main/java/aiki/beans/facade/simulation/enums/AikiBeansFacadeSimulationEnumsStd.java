...
public final class AikiBeansFacadeSimulationEnumsStd {
    ...
    public static final String TYPE_TEAM_CRUD = "aiki.beans.facade.simulation.enums.TeamCrud";
    ...
    private static void buildTeamCrud(BeanLgNames _std) {
        StandardClass type_;
        StringMap<StandardField> fields_;
        CustList<StandardConstructor> constructors_;
        ObjectMap<MethodId, StandardMethod> methods_;
        ...
        constructors_ = new CustList<StandardConstructor>();
        fields_ = new StringMap<StandardField>();
        type_ = new StandardClass(TYPE_TEAM_CRUD, fields_, constructors_, methods_, _std.getAliasObject(), MethodModifier.NORMAL);
        _std.getStandards().put(TYPE_TEAM_CRUD, type_);
    }
}
