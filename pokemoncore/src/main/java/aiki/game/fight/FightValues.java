...
final class FightValues {
    ...
    static StringMap<String> calculateValuesFighter(Fight _fight,TeamPosition _fighter,DataBase _import){
        ...
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_GENRE), creatureCbtLanceur_.getCurrentGender().name());
        for(String c:equipeLanceur_.getNbUsesMovesRound().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Team.NB_UTILI_ATT_EQ_TOUR,DataBase.SEP_BETWEEN_KEYS,c),Integer.toString(equipeLanceur_.getNbUsesMovesRound().getVal(c)));
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_PV_RESTANTS),creatureCbtLanceur_.getRemainingHp().toNumberString());
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_PV_MAX),creatureCbtLanceur_.pvMax().toNumberString());
        for(String c:creatureCbtLanceur_.getEnabledMoves().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_TOUR,DataBase.SEP_BETWEEN_KEYS,c),String.valueOf(creatureCbtLanceur_.getEnabledMoves().getVal(c).getNbTurn()));
        }
        for(String c:creatureCbtLanceur_.getEnabledMovesProt().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_TOUR,DataBase.SEP_BETWEEN_KEYS,c),String.valueOf(creatureCbtLanceur_.getEnabledMovesProt().getVal(c).getNbTurn()));
        }
        for(String c:creatureCbtLanceur_.getEnabledMovesUnprot().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_TOUR,DataBase.SEP_BETWEEN_KEYS,c),String.valueOf(creatureCbtLanceur_.getEnabledMovesUnprot().getVal(c).getNbTurn()));
        }
        for(String c:creatureCbtLanceur_.getEnabledMovesEndRound().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_TOUR,DataBase.SEP_BETWEEN_KEYS,c),String.valueOf(creatureCbtLanceur_.getEnabledMovesEndRound().getVal(c).getNbTurn()));
        }
        for(String c:creatureCbtLanceur_.getEnabledMovesConstChoices().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_TOUR,DataBase.SEP_BETWEEN_KEYS,c),String.valueOf(creatureCbtLanceur_.getEnabledMovesConstChoices().getVal(c).getNbTurn()));
        }
        for(String c:creatureCbtLanceur_.getNbUsesMoves().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fighter.FIGHTER_NB_UTILISATION,DataBase.SEP_BETWEEN_KEYS,c),Integer.toString(creatureCbtLanceur_.getNbUsesMoves().getVal(c)));
        }
        for(Statistic c:creatureCbtLanceur_.getStatisBase().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_STATIS,DataBase.SEP_BETWEEN_KEYS,c.name()),creatureCbtLanceur_.getStatisBase().getVal(c).toNumberString());
        }
        ...
        for(Statistic c:creatureCbtLanceur_.getStatisBoost().getKeys()){
            ...
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_BOOST,DataBase.SEP_BETWEEN_KEYS,c.name()),Integer.toString(boost_));
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.SOMME_BOOST_POS_FIGHTER),sommeLanceurBoostsPositifs_.toNumberString());
        ...
        for(String c:creatureCbtLanceur_.getDamageSufferedCateg().getKeys()){
            ...
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_DEGATS_RECUS,DataBase.SEP_BETWEEN_KEYS,c),deg_.toNumberString());
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_DEGATS_RECUS_TOTAL),sommeLanceurDegatsSubis_.toNumberString());
        ...
        for(String c:creatureCbtLanceur_.getDamageSufferedCategRound().getKeys()){
            ...
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_DEGATS_RECUS_TOUR,DataBase.SEP_BETWEEN_KEYS,c),deg_.toNumberString());
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_DEGATS_RECUS_TOTAL_TOUR),sommeLanceurDegatsSubisTour_.toNumberString());

        if(creatureCbtLanceur_.isDisappeared()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_DISPARAIT),Fight.ONE);
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_DISPARAIT),Fight.ZERO);
        }
        if(creatureCbtLanceur_.isActed()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_JOUE),Fight.ONE);
        }else{
        ...
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_OBJET),creatureCbtLanceur_.getItem());
        ...
        for(String c:attaquesPp_){
            if(!StringList.contains(creatureCbtLanceur_.attaquesUtilisables(), c)){
                ...
                variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_PP,DataBase.SEP_BETWEEN_KEYS,c),Integer.toString(ppActuel_));
            }
        }
        for(String c:equipeLanceur_.getNbUsesMoves().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Team.EQUIPE_NB_UTILISATION,DataBase.SEP_BETWEEN_KEYS,c),Integer.toString(equipeLanceur_.getNbUsesMoves().getVal(c)));
        }
        ...
        for(String c:equipeAdvLanceur_.getNbUsesMoves().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Team.EQUIPE_ADV_NB_UTILISATION,DataBase.SEP_BETWEEN_KEYS,c),Integer.toString(equipeAdvLanceur_.getNbUsesMoves().getVal(c)));
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LIEU_COMBAT),_fight.getEnvType().name());
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_NIVEAU),Integer.toString(creatureCbtLanceur_.getLevel()));
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.FIGHTER_BONHEUR),Integer.toString(creatureCbtLanceur_.getHappiness()));
        ...
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_COMBATTANTS_TERRAIN),Integer.toString(nbCombattantsTerrain_));
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_KO_EQUIPE_FIGHTER),Integer.toString(equipeLanceur_.getNbKoRound()+equipeLanceur_.getNbKoPreviousRound()));
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_KO_EQUIPE_ADV_FIGHTER),Integer.toString(equipeAdvLanceur_.getNbKoRound()+equipeAdvLanceur_.getNbKoPreviousRound()));
        ...
        for(String e:coeffTypes_){
            ...
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.COEFF_EFF_BASE_TYPES_FIGHTER,DataBase.SEP_BETWEEN_KEYS,e),coeffLanceur_.toNumberString());
        }
    ...
    static StringMap<String> calculateValues(Fight _fight,TeamPosition _lanceur,TeamPosition _cible,DataBase _import){
        ...
        StringMap<String> variables_ = new StringMap<String>();
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_GENRE), creatureCbtCible_.getCurrentGender().name());
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_PV_RESTANTS),creatureCbtCible_.getRemainingHp().toNumberString());
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_PV_MAX),creatureCbtCible_.pvMax().toNumberString());
        for(String c:creatureCbtCible_.getNbUsesMoves().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fighter.CIBLE_NB_UTILISATION,DataBase.SEP_BETWEEN_KEYS,c),Integer.toString(creatureCbtCible_.getNbUsesMoves().getVal(c)));
        }
        for(Statistic c:creatureCbtCible_.getStatisBase().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_STATIS,DataBase.SEP_BETWEEN_KEYS,c.name()),creatureCbtCible_.getStatisBase().getVal(c).toNumberString());
        }
        ...
        for(Statistic c:creatureCbtCible_.getStatisBoost().getKeys()){
            ...
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_BOOST,DataBase.SEP_BETWEEN_KEYS,c.name()),Integer.toString(boost_));
        }
        ...
        for(String c:creatureCbtCible_.getDamageSufferedCateg().getKeys()){
            ...
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_DEGATS_RECUS,DataBase.SEP_BETWEEN_KEYS,c),deg_.toNumberString());
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_DEGATS_RECUS_TOTAL),sommeCibleDegatsSubis_.toNumberString());
        ...
        for(String c:creatureCbtCible_.getDamageSufferedCategRound().getKeys()){
            ...
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_DEGATS_RECUS_TOUR,DataBase.SEP_BETWEEN_KEYS,c),deg_.toNumberString());
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_DEGATS_RECUS_TOTAL_TOUR),sommeCibleDegatsSubisTour_.toNumberString());
        if(creatureCbtCible_.isDisappeared()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_DISPARAIT),Fight.ONE);
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_DISPARAIT),Fight.ZERO);
        }
        if(creatureCbtCible_.isActed()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_JOUE),Fight.ONE);
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_JOUE),Fight.ZERO);
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_MASSE),creatureCbtCible_.getWeight().toNumberString());
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_TAILLE),creatureCbtCible_.getHeight().toNumberString());
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_CAPACITE),creatureCbtCible_.getCurrentAbility());
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_OBJET),creatureCbtCible_.getItem());
        ...
        for(String c:attaquesPp_){
            if(!StringList.contains(creatureCbtCible_.attaquesUtilisables(), c)){
                ...
                variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_PP,DataBase.SEP_BETWEEN_KEYS,c),Integer.toString(ppActuel_));
            }
        }
        Team equipeAdvCible_=_fight.getTeams().getVal(Fight.foe(_cible.getTeam()));
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_NIVEAU),Integer.toString(creatureCbtCible_.getLevel()));
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_KO_EQUIPE_CIBLE),Integer.toString(equipeCible_.getNbKoRound()+equipeCible_.getNbKoPreviousRound()));
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_KO_EQUIPE_ADV_CIBLE),Integer.toString(equipeAdvCible_.getNbKoRound()+equipeAdvCible_.getNbKoPreviousRound()));
        ...
        for(String e:coeffTypes_){
            ...
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.COEFF_EFF_BASE_TYPES_CIBLE,DataBase.SEP_BETWEEN_KEYS,e),coeffCible_.toNumberString());
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_GENRE), creatureCbtLanceur_.getCurrentGender().name());
        for(String c:equipeLanceur_.getNbUsesMovesRound().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Team.NB_UTILI_ATT_EQ_TOUR,DataBase.SEP_BETWEEN_KEYS,c),Integer.toString(equipeLanceur_.getNbUsesMovesRound().getVal(c)));
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_PV_RESTANTS),creatureCbtLanceur_.getRemainingHp().toNumberString());
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_PV_MAX),creatureCbtLanceur_.pvMax().toNumberString());
        for(String c:creatureCbtLanceur_.getEnabledMoves().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_TOUR,DataBase.SEP_BETWEEN_KEYS,c),String.valueOf(creatureCbtLanceur_.getEnabledMoves().getVal(c).getNbTurn()));
        }
        for(String c:creatureCbtLanceur_.getEnabledMovesProt().getKeys()){
        ...
        for(String c:creatureCbtLanceur_.getNbUsesMoves().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fighter.LANCEUR_NB_UTILISATION,DataBase.SEP_BETWEEN_KEYS,c),Integer.toString(creatureCbtLanceur_.getNbUsesMoves().getVal(c)));
        }
        for(Statistic c:creatureCbtLanceur_.getStatisBase().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_STATIS,DataBase.SEP_BETWEEN_KEYS,c.name()),creatureCbtLanceur_.getStatisBase().getVal(c).toNumberString());
        }
        Rate sommeLanceurBoostsPositifs_=Rate.zero();
        for(Statistic c:creatureCbtLanceur_.getStatisBoost().getKeys()){
            byte boost_=creatureCbtLanceur_.getStatisBoost().getVal(c);
            ...
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_BOOST,DataBase.SEP_BETWEEN_KEYS,c.name()),Integer.toString(boost_));
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.SOMME_BOOST_POS_LANCEUR),sommeLanceurBoostsPositifs_.toNumberString());
        StringList attaquesGlobales_ = _import.getVarParamsMove(Fight.NB_TOUR_GLOBAL);
        for(String c:attaquesGlobales_){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_TOUR_GLOBAL,DataBase.SEP_BETWEEN_KEYS,c),String.valueOf(_fight.getEnabledMoves().getVal(c).getNbTurn()));
        }
        ...
        for(String c:creatureCbtLanceur_.getDamageSufferedCateg().getKeys()){
            Rate deg_=creatureCbtLanceur_.getDamageSufferedCateg().getVal(c);
            sommeLanceurDegatsSubis_.addNb(deg_);
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_DEGATS_RECUS,DataBase.SEP_BETWEEN_KEYS,c),deg_.toNumberString());
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_DEGATS_RECUS_TOTAL),sommeLanceurDegatsSubis_.toNumberString());
        Rate sommeLanceurDegatsSubisTour_=Rate.zero();
        for(String c:creatureCbtLanceur_.getDamageSufferedCategRound().getKeys()){
            Rate deg_=creatureCbtLanceur_.getDamageSufferedCategRound().getVal(c);
            sommeLanceurDegatsSubisTour_.addNb(deg_);
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_DEGATS_RECUS_TOUR,DataBase.SEP_BETWEEN_KEYS,c),deg_.toNumberString());
        }
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_DEGATS_RECUS_TOTAL_TOUR),sommeLanceurDegatsSubisTour_.toNumberString());

        if(creatureCbtLanceur_.isDisappeared()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_DISPARAIT),Fight.ONE);
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_DISPARAIT),Fight.ZERO);
        }
        if(creatureCbtLanceur_.isActed()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_JOUE),Fight.ONE);
        }else{
        ...
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_OBJET),creatureCbtLanceur_.getItem());
        StringList statutsLanceur_ = new StringList();
        for(String c:creatureCbtLanceur_.getStatusSet()){
        ...
        for(String c:attaquesPp_){
            if(!StringList.contains(creatureCbtLanceur_.attaquesUtilisables(), c)){
                ...
                short ppActuel_=creatureCbtLanceur_.powerPointsMove(c);
                variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_PP,DataBase.SEP_BETWEEN_KEYS,c),Integer.toString(ppActuel_));
            }
        }
        for(String c:equipeLanceur_.getNbUsesMoves().getKeys()){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Team.EQUIPE_NB_UTILISATION,DataBase.SEP_BETWEEN_KEYS,c),Integer.toString(equipeLanceur_.getNbUsesMoves().getVal(c)));
        ...
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LIEU_COMBAT),_fight.getEnvType().name());
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_NIVEAU),Integer.toString(creatureCbtLanceur_.getLevel()));
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_BONHEUR),Integer.toString(creatureCbtLanceur_.getHappiness()));
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.TEMPS_TOUR),_fight.getNbRounds().toNumberString());
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.RATE_EFF_MOVE_AGAINST_TARGET),FightSuccess.rateEffAgainstTargetMove(_fight,_lanceur, _cible, _import).toNumberString());
        int nbCombattantsTerrain_=0;
        for(byte c:_fight.getTeams().getKeys()){
            for(byte c2_:_fight.getTeams().getVal(c).getMembers().getKeys()){
                Fighter cbtEquipe_=_fight.getTeams().getVal(c).getMembers().getVal(c2_);
        ...
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_COMBATTANTS_TERRAIN),Integer.toString(nbCombattantsTerrain_));
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_KO_EQUIPE_LANCEUR),Integer.toString(equipeLanceur_.getNbKoRound()+equipeLanceur_.getNbKoPreviousRound()));
        variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.NB_KO_EQUIPE_ADV_LANCEUR),Integer.toString(equipeAdvLanceur_.getNbKoRound()+equipeAdvLanceur_.getNbKoPreviousRound()));
        ...
        for(String e:coeffTypes_){
            ...
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.COEFF_EFF_BASE_TYPES_LANCEUR,DataBase.SEP_BETWEEN_KEYS,e),coeffLanceur_.toNumberString());
        }
        _fight.setEnabledMessages(true);
        return variables_;
    }
    ...
    static StringMap<String> calculateBooleanValues(
        ...
        if(effet_ instanceof EffectTeamWhileSendFoe){
            for(String e:immuTypesIndiv_){
                if(FightSuccess.isProtectedAgainstMoveType(_fight,_lanceur,_cible,e,_import)){
                    //protected against
                    variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.IMMU_TYPE_ATT_COMBATTANT_ENTRANT,DataBase.SEP_BETWEEN_KEYS,e),_import.getTrueString());
                }else{
                    variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.IMMU_TYPE_ATT_COMBATTANT_ENTRANT,DataBase.SEP_BETWEEN_KEYS,e),_import.getFalseString());
                }
            }
        }
        if(effet_ instanceof EffectInvoke){
            ...
            if(attaquesInvocables_.isEmpty()){
                //invoke of attacks
                variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_ATTAQUE_INVOC),_import.getTrueString());
            }else{
                variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_ATTAQUE_INVOC),_import.getFalseString());
            }
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_ATTAQUE_INVOC),_import.getFalseString());
        }
        if(effet_ instanceof EffectCopyMove){
            ...
            if(FightInvoke.copiableMoves(_fight, _lanceur,_cible, effetCopieAtt_, _import).isEmpty()){
                //copy moves
                variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_ATTAQUES_COPIABLES),_import.getTrueString());
            }else{
                variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_ATTAQUES_COPIABLES),_import.getFalseString());
            }
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_ATTAQUES_COPIABLES),_import.getFalseString());
        }
    ...
    static StringMap<String> calculateBasicBooleanValues(
        ...
        for (String m: enabled_.getKeys()) {
            if(enabled_.getVal(m)){
                ...
                variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_POSSEDE_STATUT_RELATION,DataBase.SEP_BETWEEN_KEYS,m),_import.getTrueString());
            }else{
                variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_POSSEDE_STATUT_RELATION,DataBase.SEP_BETWEEN_KEYS,m),_import.getFalseString());
            }
        }
        ...
        */
        for(String c:effetsIndiv_){
            if (creatureCbtCible_.getEnabledMoves().contains(c)) {
                if(creatureCbtCible_.getEnabledMoves().getVal(c).isEnabled()){
                    //enabled effect
                    variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_EFFET,DataBase.SEP_BETWEEN_KEYS,c),_import.getTrueString());
                }else{
                    variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.CIBLE_EFFET,DataBase.SEP_BETWEEN_KEYS,c),_import.getFalseString());
                }
                continue;
            }
        ...
        if(creatureCbtCible_.noPowerPointForLastUsedMove()){
            //without pp
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_PP_ATTAQUE_CIBLE),_import.getTrueString());
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_PP_ATTAQUE_CIBLE),_import.getFalseString());
        }
        ...
        if(pasUtiliseAttaqueCible_){
            //without use of pp
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_UTILIS_ATTAQUE_CIBLE),_import.getTrueString());
        }else{
        ...
        for(String e:immuTypesIndiv_){
            if(FightSuccess.isProtectedAgainstMoveType(_fight,_lanceur,_cible,e,_import)){
                //protected against
                variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.IMMU_TYPE_ATT_CIBLE,DataBase.SEP_BETWEEN_KEYS,e),_import.getTrueString());
            }else{
                variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.IMMU_TYPE_ATT_CIBLE,DataBase.SEP_BETWEEN_KEYS,e),_import.getFalseString());
            }
        }
        ...
        if(aucunBoostPossible_){
            //no possible boost
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.AUCUN_BOOST_POSSIBLE),_import.getTrueString());
        }else{
        ...
        for(String c:effetsIndiv_){
            if (creatureCbtLanceur_.getEnabledMoves().contains(c)) {
                if(creatureCbtLanceur_.getEnabledMoves().getVal(c).isEnabled()){
                    //enabled effect
                    variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_EFFET,DataBase.SEP_BETWEEN_KEYS,c),_import.getTrueString());
                }else{
                    variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.LANCEUR_EFFET,DataBase.SEP_BETWEEN_KEYS,c),_import.getFalseString());
                }
                continue;
            }
        ...
        if (!creatureCbtLanceur_.resistingTypes(_import).isEmpty()) {
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.TYPES_ATTAQUES_RES_VIDE),_import.getFalseString());
        } else {
            //types of moves
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.TYPES_ATTAQUES_RES_VIDE),_import.getTrueString());
        }
        ...
        if(nbPartenaires_==0){
            //not partner
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_PARTENAIRE),_import.getTrueString());
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_PARTENAIRE),_import.getFalseString());
        }
        if(nbPartenairesArriere_==0){
            //not back partner
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_PARTENAIRE_ARRIERE),_import.getTrueString());
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_PARTENAIRE_ARRIERE),_import.getFalseString());
        }
        if(nbPartenairesTerrain_==0){
            //not front partner
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_PARTENAIRE_TERRAIN),_import.getTrueString());
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_PARTENAIRE_TERRAIN),_import.getFalseString());
        }
        if(creatureCbtLanceur_.getNbRounds().isZero()){
            //back
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_TOUR_TERRAIN),_import.getTrueString());
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.PAS_TOUR_TERRAIN),_import.getFalseString());
        }
        if(creatureCbtLanceur_.estAssexue()||creatureCbtCible_.estAssexue()){
            //opposite genders
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.EXISTE_GENRE_ASSEXUE),_import.getTrueString());
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.EXISTE_GENRE_ASSEXUE),_import.getFalseString());
        }
        if(creatureCbtLanceur_.getCurrentGender()==creatureCbtCible_.getCurrentGender()){
            //same genders
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.GENRES_EGAUX),_import.getTrueString());
        }else{
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.GENRES_EGAUX),_import.getFalseString());
        }
        _fight.setEnabledMessages(true);
        return variables_;
    }
    ...
    static StringMap<String> calculateSendingVariables(
        ...
        for(String e:coeffTypes_){
            ...
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.COEFF_EFF_BASE_TYPES_COMBATTANT_ENTRANT,DataBase.SEP_BETWEEN_KEYS,e),coeffEnvoye_.toNumberString());
        }
        StringList nbUtAdv_=_import.getVarParamsMove(Fight.EQUIPE_ADV_COMBATTANT_ENTRANT_NB_UTILISATION);
        for(String e:nbUtAdv_){
            variables_.put(StringList.concat(DataBase.VAR_PREFIX,Fight.EQUIPE_ADV_COMBATTANT_ENTRANT_NB_UTILISATION,DataBase.SEP_BETWEEN_KEYS,e),nbUtilisationsEntreeAdv_.getVal(e).toNumberString());
        }
        _fight.setEnabledMessages(true);
        return variables_;
    }
