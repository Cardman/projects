...
public class GameInitializeFightTest extends InitializationDataBase {
    ...
    public void lawCopy1Test() {
        ...
        assertTrue(law_.getLaw().contains(wildOne_));
        assertTrue(law_.getLaw().contains(wildTwo_));
    ...
    public void lawCopy4Test() {
        ...
        PokemonPlayer lasPk_ = new PokemonPlayer(pokemonDonne_, _data_);
        lasPk_.initIv(diff_);
    ...
    public void lawCopy5Test() {
        ...
        pokemonDonne_.setAbility(STATIK);
        pokemonDonne_.setGender(Gender.NO_GENDER);
        lasPk_ = new PokemonPlayer(pokemonDonne_, _data_);
        lasPk_.initIv(diff_);
        lasPk_.initPvRestants(_data_);
    ...
    public void initTrainerFight12Test() {
        Game game_ = new Game(_data_);
        game_.initUtilisateur(NICKNAME, null, game_.getDifficulty(), _data_);
