...
public class GameProgressionTest extends InitializationDataBase {
    ...
    public void new_GameProgression_DataBase_Game_1Test() {
        ...
        assertTrue(gameProgression_.getUnBeatenImportantTrainers().containsObj(new TrainerPlaceNames(DUAL_TWO_TR_ONE+SEPARATOR_TRAINERS+DUAL_TWO_TR_TWO,R_2)));
        assertTrue(gameProgression_.getUnBeatenImportantTrainers().containsObj(new TrainerPlaceNames(GYM_TR_TWO,CITY_TWO)));
        assertTrue(gameProgression_.getUnBeatenImportantTrainers().containsObj(new TrainerPlaceNames(DUAL_THREE_TR_ONE+SEPARATOR_TRAINERS+DUAL_THREE_TR_TWO,CAVE)));
        assertTrue(gameProgression_.getUnBeatenImportantTrainers().containsObj(new TrainerPlaceNames(LEAGUE_TR_TWO,LIGUE)));
        assertTrue(gameProgression_.getUnBeatenImportantTrainers().containsObj(new TrainerPlaceNames(DUAL_ONE_TR_ONE+SEPARATOR_TRAINERS+DUAL_ONE_TR_TWO,R_2)));
    ...
    public void new_GameProgression_DataBase_Game_11Test() {
        ...
        assertTrue(gameProgression_.getBeatenImportantTrainers().containsObj(new TrainerPlaceNames(DUAL_TWO_TR_ONE+SEPARATOR_TRAINERS+DUAL_TWO_TR_TWO,R_2)));
        assertTrue(gameProgression_.getBeatenImportantTrainers().containsObj(new TrainerPlaceNames(GYM_TR_TWO,CITY_TWO)));
        assertTrue(gameProgression_.getBeatenImportantTrainers().containsObj(new TrainerPlaceNames(DUAL_THREE_TR_ONE+SEPARATOR_TRAINERS+DUAL_THREE_TR_TWO,CAVE)));
        assertTrue(gameProgression_.getBeatenImportantTrainers().containsObj(new TrainerPlaceNames(LEAGUE_TR_TWO,LIGUE)));
        assertTrue(gameProgression_.getBeatenImportantTrainers().containsObj(new TrainerPlaceNames(DUAL_ONE_TR_ONE+SEPARATOR_TRAINERS+DUAL_ONE_TR_TWO,R_2)));
        assertTrue(gameProgression_.getBeatenImportantTrainers().containsObj(new TrainerPlaceNames(GYM_TR_ONE,CITY)));
