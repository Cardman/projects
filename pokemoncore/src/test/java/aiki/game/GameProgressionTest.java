...
public class GameProgressionTest extends InitializationDataBase {
    ...
    public void new_GameProgression_DataBase_Game_1Test() {
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(PIKACHU).get(0), PIKACHU));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(CARAPUCE).get(0), CARAPUCE));
        assertEq(1, gameProgression_.getNotAtAllFamiliesBase().getVal(CARAPUCE).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(CARAPUCE).get(1), CARABAFFE));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(TARINOR).get(0), TARINOR));
        assertEq(1, gameProgression_.getNotAtAllFamiliesBase().getVal(TARINOR).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(TARINOR).get(1), TARINORME));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(NUCLEOS).get(0), NUCLEOS));
        assertEq(1, gameProgression_.getNotAtAllFamiliesBase().getVal(NUCLEOS).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(NUCLEOS).get(1), MEIOS));
        assertEq(1, gameProgression_.getNotAtAllFamiliesBase().getVal(NUCLEOS).get(2).size());
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(NUCLEOS).get(2), SYMBIOS));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(CHENITI).get(0), CHENITI));
        assertEq(2, gameProgression_.getNotAtAllFamiliesBase().getVal(CHENITI).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(CHENITI).get(1), CHENISELLE));
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(CHENITI).get(1), PAPILORD));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(LIMAGMA_F).get(0), LIMAGMA_F));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(LIMAGMA_M).get(0), LIMAGMA_M));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(LIMAGMA).get(0), LIMAGMA));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(NINGALE).get(0), NINGALE));
        assertEq(2, gameProgression_.getNotAtAllFamiliesBase().getVal(NINGALE).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(NINGALE).get(1), MUNJA));
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(NINGALE).get(1), NINJASK));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(MELOFEE).get(0), MELOFEE));
        assertEq(2, gameProgression_.getNotAtAllFamiliesBase().getVal(MELOFEE).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(MELOFEE).get(1), MELODELFE_2));
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(MELOFEE).get(1), MELODELFE));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(PTITARD).get(0), PTITARD));
        assertEq(1, gameProgression_.getNotAtAllFamiliesBase().getVal(PTITARD).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(PTITARD).get(1), TETARTE));
        assertEq(2, gameProgression_.getNotAtAllFamiliesBase().getVal(PTITARD).get(2).size());
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(PTITARD).get(2), TARPAUD));
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(PTITARD).get(2), TARTARD));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(BABIMANTA).get(0), BABIMANTA));
        assertEq(1, gameProgression_.getNotAtAllFamiliesBase().getVal(BABIMANTA).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(BABIMANTA).get(1), DEMANTA));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(YANMA).get(0), YANMA));
        assertEq(1, gameProgression_.getNotAtAllFamiliesBase().getVal(YANMA).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(YANMA).get(1), YANMEGA));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(PICHU).get(0), PICHU));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(REMORAID).get(0), REMORAID));
        ...
        assertTrue(StringList.contains(gameProgression_.getNotAtAllFamiliesBase().getVal(MEW).get(0), MEW));
        ...
        assertTrue(StringList.contains(gameProgression_.getVisitedPlaces(), CITY_TWO));
        assertEq(2, gameProgression_.getUnVisitedPlaces().size());
        assertTrue(StringList.contains(gameProgression_.getUnVisitedPlaces(), CITY_7));
        assertTrue(StringList.contains(gameProgression_.getUnVisitedPlaces(), CITY_8));
    ...
    public void new_GameProgression_DataBase_Game_2Test() {
        ...
        assertTrue(StringList.contains(gameProgression_.getPartialFamiliesBaseCaught().getVal(PTITARD).get(0), PTITARD));
        ...
        assertTrue(StringList.contains(gameProgression_.getPartialFamiliesBaseNotCaught().getVal(PTITARD).get(1), TETARTE));
        assertEq(2, gameProgression_.getPartialFamiliesBaseNotCaught().getVal(PTITARD).get(2).size());
        assertTrue(StringList.contains(gameProgression_.getPartialFamiliesBaseNotCaught().getVal(PTITARD).get(2), TARPAUD));
        assertTrue(StringList.contains(gameProgression_.getPartialFamiliesBaseNotCaught().getVal(PTITARD).get(2), TARTARD));
        assertEq(1, gameProgression_.getFullFamiliesBase().size());
        assertEq(1, gameProgression_.getFullFamiliesBase().getVal(PIKACHU).size());
        assertEq(1, gameProgression_.getFullFamiliesBase().getVal(PIKACHU).get(0).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(PIKACHU).get(0), PIKACHU));
    ...
    public void new_GameProgression_DataBase_Game_11Test() {
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(PTITARD).get(0), PTITARD));
        assertEq(1, gameProgression_.getFullFamiliesBase().getVal(PTITARD).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(PTITARD).get(1), TETARTE));
        assertEq(2, gameProgression_.getFullFamiliesBase().getVal(PTITARD).get(2).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(PTITARD).get(2), TARPAUD));
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(PTITARD).get(2), TARTARD));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(CARAPUCE).get(0), CARAPUCE));
        assertEq(1, gameProgression_.getFullFamiliesBase().getVal(CARAPUCE).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(CARAPUCE).get(1), CARABAFFE));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(TARINOR).get(0), TARINOR));
        assertEq(1, gameProgression_.getFullFamiliesBase().getVal(TARINOR).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(TARINOR).get(1), TARINORME));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(NUCLEOS).get(0), NUCLEOS));
        assertEq(1, gameProgression_.getFullFamiliesBase().getVal(NUCLEOS).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(NUCLEOS).get(1), MEIOS));
        assertEq(1, gameProgression_.getFullFamiliesBase().getVal(NUCLEOS).get(2).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(NUCLEOS).get(2), SYMBIOS));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(CHENITI).get(0), CHENITI));
        assertEq(2, gameProgression_.getFullFamiliesBase().getVal(CHENITI).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(CHENITI).get(1), CHENISELLE));
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(CHENITI).get(1), PAPILORD));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(LIMAGMA_F).get(0), LIMAGMA_F));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(LIMAGMA_M).get(0), LIMAGMA_M));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(LIMAGMA).get(0), LIMAGMA));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(NINGALE).get(0), NINGALE));
        assertEq(2, gameProgression_.getFullFamiliesBase().getVal(NINGALE).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(NINGALE).get(1), MUNJA));
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(NINGALE).get(1), NINJASK));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(MELOFEE).get(0), MELOFEE));
        assertEq(2, gameProgression_.getFullFamiliesBase().getVal(MELOFEE).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(MELOFEE).get(1), MELODELFE_2));
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(MELOFEE).get(1), MELODELFE));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(BABIMANTA).get(0), BABIMANTA));
        assertEq(1, gameProgression_.getFullFamiliesBase().getVal(BABIMANTA).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(BABIMANTA).get(1), DEMANTA));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(YANMA).get(0), YANMA));
        assertEq(1, gameProgression_.getFullFamiliesBase().getVal(YANMA).get(1).size());
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(YANMA).get(1), YANMEGA));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(PICHU).get(0), PICHU));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(REMORAID).get(0), REMORAID));
        ...
        assertTrue(StringList.contains(gameProgression_.getFullFamiliesBase().getVal(MEW).get(0), MEW));
        ...
        assertTrue(StringList.contains(gameProgression_.getVisitedPlaces(), CITY));
        assertTrue(StringList.contains(gameProgression_.getVisitedPlaces(), CITY_TWO));
        assertTrue(StringList.contains(gameProgression_.getVisitedPlaces(), CITY_7));
        assertTrue(StringList.contains(gameProgression_.getVisitedPlaces(), CITY_8));
