...
public class FightFacadeSimulationTest extends InitializationDataBase {
    ...
    public void simulate1Test() {
        ...
        CustList<NumberMap<Byte,ChoiceOfEvolutionAndMoves>> evolutions_ = new CustList<NumberMap<Byte,ChoiceOfEvolutionAndMoves>>();
        NumberMap<Byte,ChoiceOfEvolutionAndMoves> evos_;
        evos_ = new NumberMap<Byte,ChoiceOfEvolutionAndMoves>();
        ...
        FightFacade.simulate(fight_, actionsRound_, actionsSubstitutingFront_, actionsSubstitutingBack_, evolutions_, player_, diff_, _data_);
...
//        fightSimulation_.validateMovesOneFight(1, data);
        ...
        fightSimulation_.validateMovesOneFight(0, _data_);
...
//        fightSimulation_.validateMovesOneFight(2, data);
    ...
    public void simulateFight2Test() {
        ...
        pokemon_.setGender(Gender.NO_GENDER);
        fightSimulation_.addPokemonPlayer(pokemon_, new StringList(CHARGE), (byte) 70, Rate.zero(), _data_);
        fightSimulation_.validateTeam(_data_);
        fightSimulation_.setFirstEvolutions(_data_);
        fightSimulation_.initializeFrontFighters();
        fightSimulation_.getFrontFighters().first().first().put((byte)0, (byte)0);
        fightSimulation_.getFrontFighters().first().first().put((byte)1, Fighter.BACK);
...
//        fightSimulation_.addMoveBetweenFights(1, 0, TORGNOLES);
        ...
        fightSimulation_.chooseMove(0, 1, 0, CHARGE, POKEMON_FOE_TARGET_ZERO, _data_);
...
//        fightSimulation_.chooseMove(1, 1, 2, CHARGE, POKEMON_FOE_TARGET_ZERO);
    ...
    public void simulateFight10Test() {
        ...
        fightSimulation_.validateTeam(_data_);
        fightSimulation_.setFirstEvolutions(_data_);
        fightSimulation_.setNextEvolutions(0, TETARTE, (short) 55, _data_);
        fightSimulation_.initializeFrontFighters();
        fightSimulation_.getFrontFighters().first().first().put((byte)0, (byte)0);
        fightSimulation_.getFrontFighters().first().first().put((byte)1, Fighter.BACK);
        fightSimulation_.getFrontFighters().first().first().put((byte)2, Fighter.BACK);
        ...
        fightSimulation_.validateMovesOneFight(1, _data_);
        fightSimulation_.validateMovesOneFight(2, _data_);
        fightSimulation_.keepMoves(0, new StringList(BROUHAHA), _data_);
        fightSimulation_.setAbilityWhileFight(0, 0, 1, ABSORB_EAU);
        fightSimulation_.keepMoves(0, new StringList(BROUHAHA, BULLES_D_O, PLAQUAGE, PISTOLET_A_O), _data_);
        fightSimulation_.validateAllMoves(_data_);
        fightSimulation_.chooseMove(0, 0, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.chooseMove(0, 1, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.simulateFight(_data_);
...
//        assertTrue(!fightSimulation_.getProbleme());
    ...
    public void simulateFight11Test() {
        ...
        pokemon_.setItem(NULL_REF);
        pokemon_.setGender(Gender.NO_GENDER);
        fightSimulation_.addPokemonPlayer(pokemon_, new StringList(BROUHAHA, BULLES_D_O, PLAQUAGE, PISTOLET_A_O), (byte) 70, Rate.zero(), _data_);
        pokemon_ = new WildPk();
        pokemon_.setLevel((short) 100);
        pokemon_.setName(TETARTE);
        pokemon_.setAbility(ABSORB_EAU);
        ...
        fightSimulation_.keepMoves(0, new StringList(BROUHAHA, BULLES_D_O, PLAQUAGE, PISTOLET_A_O), _data_);
        fightSimulation_.setAbilityWhileFight(0, 0, 1, ABSORB_EAU);
        fightSimulation_.keepMoves(0, new StringList(BROUHAHA, BULLES_D_O, PLAQUAGE), _data_);
        fightSimulation_.validateAllMoves(_data_);
        fightSimulation_.chooseMove(0, 0, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.chooseMove(0, 1, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.simulateFight(_data_);
...
//        fightSimulation_.chooseMove(1, 1, 2, CHARGE, POKEMON_FOE_TARGET_ZERO);
        fightSimulation_.simulateFight(_data_);
        assertTrue(!fightSimulation_.getProbleme());
        assertTrue(fightSimulation_.hasNextFight(_data_));
    }
    ...
    public void hasNextFight2Test() {
        Difficulty diff_ = new Difficulty();
        FightSimulation fightSimulation_ = new FightSimulation(diff_, _data_);
        fightSimulation_.initializeFight(newCoords(6, 1, 4, 8), CustList.INDEX_NOT_FOUND_ELT, _data_);
        WildPk pokemon_ = new WildPk();
        pokemon_.setLevel((short) 100);
        pokemon_.setName(TETARTE);
        pokemon_.setAbility(ABSORB_EAU);
...
//        fightSimulation_.chooseMove(0, 0, 1, BROUHAHA, POKEMON_FOE_TARGET_ZERO);
        fightSimulation_.chooseMove(0, 0, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.chooseMove(0, 1, 2, CHARGE, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.simulateFight(_data_);
        assertTrue(!fightSimulation_.getProbleme());
    }
    ...
    public void simulateFights2Test() {
        ...
        fightSimulation_.chooseMove(0, 0, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.chooseMove(0, 1, 0, BROUHAHA, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.chooseMove(1, 0, 1, BROUHAHA, POKEMON_FOE_TARGET_ZERO, _data_);
    ...
    public void simulateFights7Test() {
        ...
        fightSimulation_.chooseMove(0, 0, 0, CHARGE, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.chooseMove(0, 1, 0, CHARGE, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.chooseMove(1, 0, 1, CHARGE, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.chooseMove(1, 1, 2, CHARGE, POKEMON_FOE_TARGET_ZERO, _data_);
        fightSimulation_.simulateFights(_data_);
        assertTrue(!fightSimulation_.getProbleme());
        assertEq(2, fightSimulation_.getKoFoes().size());
