...
public class FightRoundTest extends InitializationDataBase {
    ...
    public void initRound1Test() {
        ...
        assertEq(0, userTeam_.getNbUsesMovesRound().getVal(AIRE_DE_FEU).intValue());
        assertEq(0, userTeam_.getNbUsesMovesRound().getVal(AIRE_D_EAU).intValue());
        assertEq(0, userTeam_.getNbUsesMovesRound().getVal(AIRE_D_HERBE).intValue());
        ...
        assertEq(0, trainerTeam_.getNbUsesMovesRound().getVal(AIRE_DE_FEU).intValue());
        assertEq(0, trainerTeam_.getNbUsesMovesRound().getVal(AIRE_D_EAU).intValue());
        assertEq(0, trainerTeam_.getNbUsesMovesRound().getVal(AIRE_D_HERBE).intValue());
    ...
    private static Fight autoDamage(Difficulty _diff) {
    ...
    public void autoDamage1Test() {
        ...
        FightRound.autoDamage(fight_,POKEMON_PLAYER_FIGHTER_ZERO, new Rate("1"), Statistic.ATTACK, Statistic.DEFENSE, diff_, _data_);
    ...
    public void autoDamage2Test() {
        Difficulty diff_ = new Difficulty();
        Fight fight_ = autoDamage(diff_);
        FightRound.autoDamage(fight_,POKEMON_PLAYER_FIGHTER_ZERO, new Rate("1000"), Statistic.ATTACK, Statistic.DEFENSE, diff_, _data_);
    ...
    private static Fight disableRandomlyStatus(Difficulty _diff) {
        Player player_ = new Player(NICKNAME,null,_diff,false,_data_);
        Pokemon pokemon_ = new WildPk();
        pokemon_.setName(YANMA);
        pokemon_.setItem(NULL_REF);
    ...
    public void disableRandomlyStatus1Test() {
        ...
        law_.addEvent(true, LgInt.one());
        FightRound.disableRandomlyStatus(fight_,law_, POKEMON_PLAYER_FIGHTER_ZERO, POISON_GRAVE, true, _data_);
        assertEq(1, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(POISON_GRAVE).intValue());
        FightRound.disableRandomlyStatus(fight_,law_, POKEMON_PLAYER_FIGHTER_ZERO, POISON_GRAVE, false, _data_);
        assertEq(0, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(POISON_GRAVE).intValue());
    }
    ...
    public void disableRandomlyStatus2SimulationTest() {
        ...
        law_.addEvent(true, LgInt.one());
        law_.addEvent(false, LgInt.one());
        FightRound.disableRandomlyStatus(fight_,law_, POKEMON_FOE_FIGHTER_ZERO, POISON_GRAVE, false, _data_);
        assertEq(0, fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getStatusNbRound(POISON_GRAVE).intValue());
    }

    private static Fight effectBeginRoundAttack(Difficulty _diff) {
        Player player_ = new Player(NICKNAME,null,_diff,false,_data_);
        Pokemon pokemon_ = new WildPk();
        pokemon_.setName(YANMA);
        pokemon_.setItem(NULL_REF);
    ...
    public void effectBeginRoundAttack1Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, TROUILLE, diff_, _data_);
        assertTrue(!fight_.getLettingUserAttackWithStatus());
        assertEq(1, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(TROUILLE).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack2Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, PEUR, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertEq(0, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(TROUILLE).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack3Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, LONGUE_CONFUSION_SANS_DOMMAGE, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(LONGUE_CONFUSION_SANS_DOMMAGE).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack4Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, LONGUE_CONFUSION_DOMMAGE, diff_, _data_);
        assertTrue(!fight_.getLettingUserAttackWithStatus());
        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(LONGUE_CONFUSION_DOMMAGE).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack5Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, LONGUE_CONFUSION_DOMMAGE, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertEq(0, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(LONGUE_CONFUSION_DOMMAGE).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack6Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, AMOUR_FOU, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertEq(1, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusRelatNbRound(new MoveTeamPosition(AMOUR_FOU, POKEMON_FOE_FIGHTER_ZERO)).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack7Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, PEUR, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(PEUR).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack9Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, ERE_GEL, diff_, _data_);
        assertTrue(!fight_.getLettingUserAttackWithStatus());
        assertEq(1, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(ERE_GEL).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack10Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, FEU_GEL, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertEq(0, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(FEU_GEL).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack11Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, AMOUR_MOU, diff_, _data_);
        assertTrue(!fight_.getLettingUserAttackWithStatus());
        assertEq(1, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusRelatNbRound(new MoveTeamPosition(AMOUR_MOU, POKEMON_FOE_FIGHTER_ZERO)).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack12Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, PARALYSIE, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(PARALYSIE).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack15Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, ERE_GEL, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertEq(0, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(ERE_GEL).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack16Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, PARALYSIE_FORTE, diff_, _data_);
        assertTrue(!fight_.getLettingUserAttackWithStatus());
        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(PARALYSIE_FORTE).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack19Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, SOMMEIL, diff_, _data_);
        assertTrue(!fight_.getLettingUserAttackWithStatus());
        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack21Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, SOMMEIL, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertEq(0, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack22Test() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_FOE_FIGHTER_ZERO, LONGUE_CONFUSION_DOMMAGE, diff_, _data_);
...
//        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
    ...
    public void effectBeginRoundAttack23Test() {
        ...
        //fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).affecterStatut(SOMMEIL);
        fight_.setKeepStatus(true);
        FightRound.effectBeginRoundAttack(fight_,POKEMON_FOE_FIGHTER_ZERO, PRISE_DE_TETE, diff_, _data_);
        assertEq(2, fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getStatusRelatNbRound(new MoveTeamPosition(PRISE_DE_TETE, POKEMON_PLAYER_FIGHTER_ZERO)).intValue());
        assertTrue(!FightKo.endedFight(fight_, diff_));
...
//        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
    ...
    public void effectBeginRoundAttack24Test() {
        ...
        fight_.setKeepStatus(true);
        FightRound.effectBeginRoundAttack(fight_,POKEMON_FOE_FIGHTER_ZERO, PRISE_DE_TETE, diff_, _data_);
        assertEq(0, fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getStatusRelatNbRound(new MoveTeamPosition(PRISE_DE_TETE, POKEMON_PLAYER_FIGHTER_ZERO)).intValue());
        assertTrue(!FightKo.endedFight(fight_, diff_));
        assertEq(new Rate("42756/2675"), fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getRemainingHp());
//        assertTrue(!fight_.isKeepStatus());
//        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
...
//        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
    ...
    public void effectBeginRoundAttack1SimulationTest() {
        ...
        //fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).affecterStatut(SOMMEIL);
        fight_.setKeepStatus(true);
        FightRound.effectBeginRoundAttack(fight_,POKEMON_FOE_FIGHTER_ZERO, COUP_DE_BEC, diff_, _data_);
        assertEq(0, fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getStatusRelatNbRound(new MoveTeamPosition(COUP_DE_BEC, POKEMON_PLAYER_FIGHTER_ZERO)).intValue());
        assertTrue(!FightKo.endedFight(fight_, diff_));
        assertEq(new Rate("92/5"), fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getRemainingHp());
//        assertTrue(!fight_.isKeepStatus());
//        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
...
//        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusRelat().put(new MoveTeamPosition(COUP_DE_BEC, POKEMON_FOE_FIGHTER_ZERO), (short)3);
        ...
        //fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).affecterStatut(SOMMEIL);
        fight_.setKeepStatus(true);
        FightRound.effectBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, COUP_DE_BEC, diff_, _data_);
        assertEq(4, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusRelatNbRound(new MoveTeamPosition(COUP_DE_BEC, POKEMON_FOE_FIGHTER_ZERO)).intValue());
        assertTrue(!FightKo.endedFight(fight_, diff_));
...
//        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
    ...
    public void effectBeginRoundAttack5SimulationTest() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_FOE_FIGHTER_ZERO, LONGUE_CONFUSION_SANS_DOMMAGE, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertTrue(fight_.getAcceptableChoices());
        assertEq(0, fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getStatusNbRound(LONGUE_CONFUSION_SANS_DOMMAGE).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectBeginRoundAttack7SimulationTest() {
        ...
        FightRound.effectBeginRoundAttack(fight_,POKEMON_FOE_FIGHTER_ZERO, AMOUR_FOU, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertEq(1, fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getStatusRelatNbRound(new MoveTeamPosition(AMOUR_FOU, POKEMON_PLAYER_FIGHTER_ZERO)).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
...
//        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
    ...
    private static Fight statusBeginRoundAttack(Difficulty _diff) {
        Player player_ = new Player(NICKNAME,null,_diff,false,_data_);
        Pokemon pokemon_ = new WildPk();
        pokemon_.setName(YANMA);
        pokemon_.setItem(NULL_REF);
    ...
    public void statusBeginRoundAttack1Test() {
        ...
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).affecterStatut(SOMMEIL);
        fight_.setKeepStatus(true);
        FightRound.statusBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, SOMMEIL, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertTrue(fight_.isKeepStatus());
        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
        assertTrue(fight_.getAcceptableChoices());
    ...
    public void statusBeginRoundAttack2Test() {
        ...
        fight_.setKeepStatus(true);
        FightRound.statusBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, BRULURE, diff_, _data_);
        assertTrue(fight_.getLettingUserAttackWithStatus());
        assertTrue(fight_.isKeepStatus());
        assertEq(1, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(BRULURE).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void statusBeginRoundAttack3Test() {
        ...
        fight_.setKeepStatus(true);
        FightRound.statusBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, SOMMEIL_REPOS, diff_, _data_);
        assertTrue(!fight_.getLettingUserAttackWithStatus());
        assertTrue(!fight_.isKeepStatus());
        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL_REPOS).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void statusBeginRoundAttack4Test() {
        ...
        //fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).affecterStatut(SOMMEIL);
        fight_.setKeepStatus(true);
        FightRound.statusBeginRoundAttack(fight_,POKEMON_FOE_FIGHTER_ZERO, LONGUE_CONFUSION_DOMMAGE, diff_, _data_);
        assertTrue(FightKo.endedFight(fight_, diff_));
        assertTrue(fight_.getAcceptableChoices());
//        assertTrue(!fight_.isKeepStatus());
//        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
    ...
    public void statusBeginRoundAttack1SimulationTest() {
        ...
        //fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).affecterStatut(SOMMEIL);
        fight_.setKeepStatus(true);
        FightRound.statusBeginRoundAttack(fight_,POKEMON_PLAYER_FIGHTER_ZERO, LONGUE_CONFUSION_DOMMAGE, diff_, _data_);
        assertTrue(!FightKo.endedFight(fight_, diff_));
        assertTrue(!fight_.getAcceptableChoices());
//        assertTrue(!fight_.isKeepStatus());
//        assertEq(2, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatusNbRound(SOMMEIL).intValue());
    ...
    public void takers1Test() {
        ...
        FightRound.initRound(fight_);
        EqList<TeamPosition> takers_ = FightRound.takers(fight_,POKEMON_PLAYER_FIGHTER_ZERO, _data_);
    ...
    private static Fight pressure(Difficulty _diff) {
        Player player_ = new Player(NICKNAME,null,_diff,false,_data_);
        Pokemon pokemon_ = new WildPk();
        pokemon_.setName(ARTIKODIN);
        pokemon_.setItem(PLAQUE_DRACO);
    ...
    public void pressure1Test() {
        ...
        FightRound.initRound(fight_);
        FightRound.pressure(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, SEISME, diff_, _data_);
    ...
    public void pressure2Test() {
        ...
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(SEISME);
        FightRound.initRound(fight_);
        FightRound.pressure(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, SEISME, diff_, _data_);
        assertEq(10, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).powerPointsMove(SEISME));
    }
    ...
    public void pressure3Test() {
        ...
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).setFirstChosenMove(SEISME);
        FightRound.initRound(fight_);
        FightRound.pressure(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ONE, SEISME, diff_, _data_);
        assertEq(10, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).powerPointsMove(SEISME));
    }
    ...
    private static Fight effectWhileFail(Difficulty _diff) {
    ...
    public void effectWhileFail1Test() {
        ...
        FightRound.effectWhileFail(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, TONNERRE, diff_, _data_);
        assertEq(1, fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getStatisBoost().getVal(Statistic.SPECIAL_ATTACK).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectWhileFail2Test() {
        ...
        assertEq(0, fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getStatisBoost().getVal(Statistic.SPECIAL_ATTACK).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectWhileFail3Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setCurrentAbility(ABRI_CAPE);
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).setRemainedHp(new Rate("46/5"));
        FightRound.effectWhileFail(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, BROUHAHA, diff_, _data_);
        assertEq(new Rate("46/5"), fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getRemainingHp());
        assertEq(0, fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).getStatisBoost().getVal(Statistic.SPECIAL_ATTACK).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void effectWhileFail8Test() {
        ...
        FightRound.effectWhileFail(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, ROUE_DE_FEU, diff_, _data_);
    ...
    public void effectWhileFail9Test() {
        ...
        fight_.getFighter(POKEMON_FOE_FIGHTER_ZERO).successUsingMove();
        FightRound.effectWhileFail(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, COMBO_GRIFFE, diff_, _data_);
        assertEq(-1, fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).getStatisBoost().getVal(Statistic.ATTACK).intValue());
    ...
    public void effectWhileFail14Test() {
        ...
        FightRound.effectWhileFail(fight_,POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ONE, ROUE_DE_FEU, diff_, _data_);
    ...
    private static Fight healPartner() {
        Difficulty diff_= new Difficulty();
    ...
    public void useBoostForAccuracy1Test() {
        ...
        FightRound.useBoostForAccuracy(fight_, thrower_, target_, NULL_REF, false, false, false, _data_);
    ...
    public void useBoostForAccuracy2Test() {
        ...
        fighter_.setUsingItem(false);
        fighter_.getIncrUserAccuracy().put(new MoveTeamPosition(LIRE_ESPRIT, target_), true);
        FightRound.useBoostForAccuracy(fight_, thrower_, target_, NULL_REF, false, false, true, _data_);
        assertTrue(!fighter_.isUsingItem());
        assertTrue(fighter_.getIncrUserAccuracy().getVal(new MoveTeamPosition(LIRE_ESPRIT, target_)));
    }
    ...
    public void useBoostForAccuracy3Test() {
        ...
        fighter_.setUsingItem(false);
        fighter_.getIncrUserAccuracy().put(new MoveTeamPosition(LIRE_ESPRIT, target_), true);
        FightRound.useBoostForAccuracy(fight_, thrower_, target_, NULL_REF, false, true, true, _data_);
        assertTrue(fighter_.isUsingItem());
        assertTrue(fighter_.getIncrUserAccuracy().getVal(new MoveTeamPosition(LIRE_ESPRIT, target_)));
    }
    ...
    public void useBoostForAccuracy4Test() {
        ...
        fighter_.setUsingItem(false);
        fighter_.getIncrUserAccuracy().put(new MoveTeamPosition(LIRE_ESPRIT, target_), true);
        FightRound.useBoostForAccuracy(fight_, thrower_, target_, LIRE_ESPRIT, true, false, true, _data_);
        assertTrue(!fighter_.isUsingItem());
        assertTrue(!fighter_.getIncrUserAccuracy().getVal(new MoveTeamPosition(LIRE_ESPRIT, target_)));
    }
    ...
    public void useBoostForAccuracy5Test() {
        ...
        fighter_.setUsingItem(false);
        fighter_.getIncrUserAccuracy().put(new MoveTeamPosition(LIRE_ESPRIT, target_), true);
        FightRound.useBoostForAccuracy(fight_, thrower_, target_, LIRE_ESPRIT, true, true, true, _data_);
        assertTrue(!fighter_.isUsingItem());
        assertTrue(!fighter_.getIncrUserAccuracy().getVal(new MoveTeamPosition(LIRE_ESPRIT, target_)));
    }

    private static Fight processAccurracy() {
        Difficulty diff_= new Difficulty();
        diff_.setEnabledClosing(true);
        Player player_ = new Player(NICKNAME,null,diff_,false,_data_);
        Pokemon pokemon_ = new WildPk();
    ...
    public void processAccurracy1Test() {
        ...
        FightRound.processAccurracy(fight_,ABIME, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, _data_);
    ...
    public void processAccurracy2Test() {
        Fight fight_ = processAccurracy();
        FightRound.processAccurracy(fight_,TONNERRE, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, _data_);
        assertTrue(fight_.isSuccessfulUse());
    ...
    public void processAccurracy3Test() {
        ...
        FightRound.processAccurracy(fight_,BERCEUSE, POKEMON_PLAYER_FIGHTER_ZERO, POKEMON_FOE_FIGHTER_ZERO, _data_);
        assertTrue(fight_.isSuccessfulUse());
        assertTrue(fight_.getFighter(POKEMON_PLAYER_FIGHTER_ZERO).isUsingItem());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void processAccurracy2SimulationTest() {
        Fight fight_ = processAccurracy();
        fight_.setSimulation(true);
        FightRound.processAccurracy(fight_,BERCEUSE, POKEMON_FOE_FIGHTER_ZERO, POKEMON_PLAYER_FIGHTER_ZERO, _data_);
        assertTrue(fight_.isSuccessfulUse());
        assertTrue(!fight_.getAcceptableChoices());
    }

    private static Fight processEffectTargets(
    ...
    public void processEffectTargets1Test() {
        ...
        FightRound.initRound(fight_);
        FightRound.processEffectTargets(fight_, thrower_, thrower_, true, CustList.FIRST_INDEX, new Numbers<Integer>(), diff_, _data_);
    ...
    public void processEffectTargets14Test() {
        ...
        FightRound.initRound(fight_);
        FightRound.processEffectTargets(fight_, target_, target_, true, CustList.FIRST_INDEX, new Numbers<Integer>(), diff_, _data_);
        assertTrue(fighter_.isSuccessfulMove());
        fight_.getSuccessfulEffects().clear();
        EqList<TeamPosition> list_ = FightRound.takers(fight_,thrower_, _data_);
        assertEq(1, list_.size());
        assertTrue(list_.containsObj(target_));
        FightRound.processEffectTargets(fight_, thrower_, thrower_, true, CustList.FIRST_INDEX, new Numbers<Integer>(), diff_, _data_);
        assertEq(2, fighter_.getStatisBoost().getVal(Statistic.DEFENSE).intValue());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void processEffectTargets15Test() {
        ...
        FightRound.processEffectTargets(fight_, thrower_, target_, true, CustList.FIRST_INDEX, new Numbers<Integer>(), diff_, _data_);
    ...
    public void processEffectTargets17Test() {
        ...
        assertTrue(fighter_.isSuccessfulMove());
        fight_.getSuccessfulEffects().clear();
        assertEq(PointViewChangementType.MIRROR_AGAINST_THROWER, FightOrder.getPointViewChangementType(moveTarget_, _data_));
        FightRound.processEffectTargets(fight_, thrower_, thrower_, true, CustList.FIRST_INDEX, new Numbers<Integer>(), diff_, _data_);
    ...
    public void processEffectTargets21Test() {
        ...
        assertTrue(fobiddenMoves_.containsObj(PAR_ICI));
        assertTrue(fobiddenMoves_.containsObj(JACKPOT));
    ...
    private static Fight endRoundThrower(
            CustList<LevelMoves> _userMoves,
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Difficulty _diff) {
    ...
    public void endRoundThrower1Test() {
        ...
        FightRound.initRound(fight_);
        FightRound.processEffectTargets(fight_, thrower_, thrower_, true, CustList.FIRST_INDEX, new Numbers<Integer>(), diff_, _data_);
        FightRound.endRoundThrower(fight_, thrower_, move_, false, _data_);
        StringList successfulMoves_ = fight_.getUserTeam().getSuccessfulMovesRound();
        assertEq(1, successfulMoves_.size());
        assertTrue(successfulMoves_.containsObj(move_));
        assertEq(0,fight_.getDamageByCurrentUser().size());
    ...
    public void endRoundThrower2Test() {
        ...
        FightRound.initRound(fight_);
        FightRound.processEffectTargets(fight_, thrower_, thrower_, true, CustList.FIRST_INDEX, new Numbers<Integer>(), diff_, _data_);
        FightRound.endRoundThrower(fight_, thrower_, move_, true, _data_);
        StringList successfulMoves_ = fight_.getUserTeam().getSuccessfulMovesRound();
        assertEq(1, successfulMoves_.size());
        assertTrue(successfulMoves_.containsObj(move_));
        assertEq(0,fight_.getDamageByCurrentUser().size());
    ...
    public void endRoundThrower3Test() {
        ...
        FightRound.processEffectTargets(fight_, thrower_, thrower_, true, CustList.FIRST_INDEX, new Numbers<Integer>(), diff_, _data_);
        FightRound.endRoundThrower(fight_, thrower_, move_, false, _data_);
        assertEq(1, fighter_.getNbUsesMoves().getVal(move_).intValue());
        StringList successfulMoves_ = fight_.getUserTeam().getSuccessfulMovesRound();
        assertEq(1, successfulMoves_.size());
        assertTrue(successfulMoves_.containsObj(move_));
        assertEq(0,fight_.getDamageByCurrentUser().size());
    ...
    public void endRoundThrower4Test() {
        ...
        FightRound.processEffectTargets(fight_, thrower_, thrower_, true, CustList.FIRST_INDEX, new Numbers<Integer>(), diff_, _data_);
        FightRound.endRoundThrower(fight_, thrower_, move_, false, _data_);
        assertEq(1, fight_.getUserTeam().getNbUsesMovesRound().getVal(move_).intValue());
        StringList successfulMoves_ = fight_.getUserTeam().getSuccessfulMovesRound();
        assertEq(1, successfulMoves_.size());
        assertTrue(successfulMoves_.containsObj(move_));
        assertEq(0,fight_.getDamageByCurrentUser().size());
    ...
    public void endRoundThrower7Test() {
        ...
        fighter_.usePowerPointsByMove(diff_, move_, (short) 1);
        FightRound.processEffectTargets(fight_, thrower_, thrower_, true, CustList.FIRST_INDEX, new Numbers<Integer>(), diff_, _data_);
        FightKo.setKoMoveTeams(fight_, thrower_, diff_, _data_);
        FightRound.endRoundThrower(fight_, thrower_, move_, true, _data_);
        StringList successfulMoves_ = fight_.getUserTeam().getSuccessfulMovesRound();
        assertEq(1, successfulMoves_.size());
        assertTrue(successfulMoves_.containsObj(move_));
    ...
    private static Fight roundThrowerMove(
            CustList<LevelMoves> _userMoves,
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Difficulty _diff) {
    ...
    public void roundThrowerMove1Test() {
        ...
        assertEq(1, fighter_.getStatusNbRound(ERE_GEL).intValue());
        assertTrue(!fight_.isKeepStatus());
        assertTrue(!fighter_.isSuccessfulMove());
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    public void roundThrowerMove2Test() {
        ...
        assertEq(0, fighter_.getStatusNbRound(FEU_GEL).intValue());
        assertTrue(fight_.isKeepStatus());
        assertTrue(fighter_.isSuccessfulMove());
        fighter_ = fight_.getFighter(thrower_);
        assertEq(0, fighter_.getStatisBoost().getVal(Statistic.ATTACK).intValue());
    ...
    public void roundThrowerMove13Test() {
        ...
        fighter_.setFirstChosenMove(move_);
        FightRound.initRound(fight_);
        FightRound.roundThrowerMove(fight_, target_, diff_, _data_);
        fighter_ = fight_.getFighter(target_);
        assertTrue(fighter_.isSuccessfulMove());
        FightRound.roundThrowerMove(fight_, thrower_, diff_, _data_);
        assertTrue(!fight_.isInvokedMove());
    ...
    public void roundThrowerMove15Test() {
        ...
        fighter_ = fight_.getFighter(target_);
        assertEq(new Rate("238956/13375"),fighter_.getRemainingHp());
        assertEq(1, fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR, thrower_)).intValue());
        assertTrue(!fight_.isInvokedMove());
        assertTrue(fight_.isSuccessfulInvokation());
        assertTrue(fight_.isKeepStatus());
        fighter_ = fight_.getFighter(thrower_);
    ...
    public void roundThrowerMove16Test() {
        ...
        fighter_ = fight_.getFighter(target_);
        assertEq(new Rate("238956/13375"),fighter_.getRemainingHp());
        assertEq(0, fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR, thrower_)).intValue());
        assertTrue(!fight_.isInvokedMove());
        assertTrue(fight_.isSuccessfulInvokation());
        assertTrue(fight_.isKeepStatus());
        fighter_ = fight_.getFighter(thrower_);
    ...
    public void roundThrowerMove2SimulationTest() {
        ...
        FightRound.initRound(fight_);
        FightRound.roundThrowerMove(fight_, thrower_, diff_, _data_);
        assertEq(0, fighter_.getStatusNbRound(ERE_GEL).intValue());
        assertTrue(fight_.isKeepStatus());
        assertTrue(fighter_.isSuccessfulMove());
        assertTrue(!fight_.getAcceptableChoices());
    }
    ...
    private static Fight roundThrowerHealing(
            CustList<LevelMoves> _userMoves,
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Difficulty _diff) {
    ...
    public void roundThrowerHealing1Test() {
        ...
        FightKo.setKoMoveTeams(fight_, f_, diff_, _data_);
        Fighter fighter_ = fight_.getFighter(f_);
        String obj_ = CENDRESACREE;
        fighter_.setChosenHealingObject(obj_, _data_);
        FightRound.initRound(fight_);
        FightRound.roundThrowerHealing(fight_, f_, diff_, _data_);
        assertEq(new Rate("1873/100"), fighter_.getRemainingHp());
        assertEq(1, fight_.getUsedItemsWhileRound().getVal(obj_).intValue());
    ...
    public void roundThrowerHealing17Test() {
        ...
        FightRound.roundThrowerHealing(fight_, f_, diff_, _data_);
        assertEq(new Rate("1"), fighter_.getRemainingHp());
        assertEq(2, fight_.getUsedItemsWhileRound().getVal(obj_).intValue());
        assertEq(72, fighter_.getHappiness());
        assertEq(0, fighter_.getStatusNbRound(PARALYSIE).intValue());
        assertEq(1, fight_.getEffects().size());
        AnimationHealing animation_ = (AnimationHealing) fight_.getEffects().first();
    ...
    public void roundThrowerHealing20Test() {
        ...
        FightKo.setKoMoveTeams(fight_, p_, diff_, _data_);
        fight_.setState(FightState.SWITCH_WHILE_KO_USER);
    ...
    private static Fight roundThrowerSwitch(
            CustList<LevelMoves> _userMoves,
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Difficulty _diff) {
    ...
    public void roundThrowerSwitch1Test() {
        ...
        FightRound.initRound(fight_);
        FightRound.roundThrowerSwitch(fight_, exiting_, diff_, _data_);
        assertEq(3, fight_.getFirstPositPlayerFighters().size());
    ...
    private static Fight substituingAfterRoundThrowerMove(
            CustList<LevelMoves> _userMoves,
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Difficulty _diff) {
    ...
    public void substituingAfterRoundThrowerMove1Test() {
        ...
        fighter_ = fight_.getFighter(thrower_);
        assertTrue(!fighter_.isSuccessfulMove());
        assertTrue(!FightRound.substituingAfterRoundThrowerMove(fight_, thrower_, diff_, _data_));
        assertTrue(!fighter_.isSuccessfulMove());
        assertEq(FightState.ATTAQUES, fight_.getState());
    }
    ...
    private static Fight selectTargetHavingToPlayAfterThrower(
            CustList<LevelMoves> _userMoves,
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Difficulty _diff) {
    ...
    public void selectTargetHavingToPlayAfterThrower1Test() {
        ...
        FightRound.initRound(fight_);
        assertEq(0, FightRound.selectTargetHavingToPlayAfterThrower(fight_, POKEMON_PLAYER_FIGHTER_ONE, _data_).size());
    }
    ...
    public void selectTargetHavingToPlayAfterThrower2Test() {
        ...
        FightRound.initRound(fight_);
        assertEq(0, FightRound.selectTargetHavingToPlayAfterThrower(fight_, thrower_, _data_).size());
    }
    ...
    public void selectTargetHavingToPlayAfterThrower5Test() {
        ...
        fighter_.setSubstitute((byte) 3);
        FightRound.initRound(fight_);
        FightRound.roundThrowerSwitch(fight_, target_, diff_, _data_);
        fighter_ = fight_.getFighter(POKEMON_PLAYER_FIGHTER_THREE);
        assertEq(1, fighter_.getGroundPlace());
        assertEq(1, fighter_.getGroundPlaceSubst());
        fighter_ = fight_.getFighter(target_);
        ...
        fighter_ = fight_.getFighter(thrower_);
        assertTrue(fighter_.isSuccessfulMove());
        EqList<TeamPosition> targets_ = FightRound.selectTargetHavingToPlayAfterThrower(fight_, thrower_, _data_);
    ...
    private static Fight calculateCatchingRate(
            CustList<LevelMoves> _userMoves,
            String _name,
            short _level,
            Difficulty _diff) {
    ...
    public void calculateCatchingRate1Test() {
        ...
        assertEq(new Rate("1"),FightRound.calculateCatchingRate(fight_, HYPER_BALL, false, diff_, _data_));
        assertEq(new Rate("1"),FightRound.calculateCatchingRate(fight_, HYPER_BALL, true, diff_, _data_));
    ...
    public void calculateCatchingRate4Test() {
        ...
        Fight fight_ = calculateCatchingRate(userMoves_, PIKACHU, (short) 3, diff_);
        fight_.wildPokemon().affecterStatut(SOMMEIL);
        assertEq(new Rate("0"),FightRound.calculateCatchingRate(fight_, HYPER_BALL, false, diff_, _data_));
    }
    ...
    public void calculateCatchingRate5Test() {
        ...
        userMoves_.add(new LevelMoves((short)4,moves_));
        Fight fight_ = calculateCatchingRate(userMoves_, PIKACHU, (short) 3, diff_);
        assertEq(new Rate("1"),FightRound.calculateCatchingRate(fight_, MASTER_BALL, false, diff_, _data_));
    }
    ...
    public void calculateCatchingRate7Test() {
        ...
        userMoves_.add(new LevelMoves((short)4,moves_));
        Fight fight_ = calculateCatchingRate(userMoves_, TETARTE, (short) 3, diff_);
        assertEq(new Rate("1"),FightRound.calculateCatchingRate(fight_, PAS_DE_BALL, false, diff_, _data_));
    }

    private static Fight calculateFleeingRate(
            CustList<LevelMoves> _userMoves,
            String _name,
            short _level,
            Difficulty _diff) {
    ...
    public void calculateFleeingRate1Test() {
        ...
        assertEq(new Rate("1"),FightRound.calculateFleeingRate(fight_, diff_, _data_));
    }
    ...
    public void calculateFleeingRate3Test() {
        ...
        assertEq(new Rate("0"),FightRound.calculateFleeingRate(fight_, diff_, _data_));
    }
    ...
    private static Fight nextFighters(
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Player _user,
            Difficulty _diff,
    ...
    public void nextFighters1Test(){
        ...
        FightRound.initRound(fight_);
        NextUsers p_;
        p_ = FightRound.nextFighters(fight_, new EqList<TeamPosition>(), _data_);
    ...
    public void nextFighters2Test(){
        ...
        FightRound.initRound(fight_);
        NextUsers p_;
        p_ = FightRound.nextFighters(fight_, new EqList<TeamPosition>(userPk_), _data_);
        assertEq(1, p_.getNextFighters().size());
    ...
    public void nextFighters1SimulationTest(){
        ...
        fighter_.setFirstChosenMoveTarget(BULLES_D_O, POKEMON_PLAYER_TARGET_ONE);
        FightRound.initRound(fight_);
        FightRound.nextFighters(fight_, new EqList<TeamPosition>(), _data_);
        assertTrue(!fight_.getAcceptableChoices());
    }

    private static Fight endRoundShowActions(
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Player _user,
            Difficulty _diff,
...
//        assertEq(FightState.ATTAQUES, fight_.getState());
    ...
    private static Fight calculateNextFighters(
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Player _user,
            Difficulty _diff,
    ...
    public void calculateNextFighters1Test() {
        ...
        FightRound.initRound(fight_);
        FightRound.calculateNextFighters(fight_, new EqList<TeamPosition>(), player_, diff_, _data_, true);
    ...
    public void calculateNextFighters5Test() {
        ...
        FightRound.calculateNextFighters(fight_, new EqList<TeamPosition>(), player_, diff_, _data_, false);
        assertEq(1, fight_.getRemainingFighters().size());
        assertTrue(fight_.getRemainingFighters().containsObj(POKEMON_PLAYER_FIGHTER_ZERO));
        assertEq(POKEMON_PLAYER_FIGHTER_ZERO,fight_.getCurrentUser());
        assertTrue(fight_.getAcceptableChoices());
    ...
    private static Fight setAllyChoices(
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Player _user,
            Difficulty _diff,
    ...
    public void setAllyChoices1Test() {
        ...
        FightRound.setAllyChoices(fight_, _data_);
        FightRound.initRound(fight_);
    ...
    private static Fight roundUser(
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Player _user,
            Difficulty _diff,
    ...
    public void roundUser1Test() {
        ...
        FightRound.calculateNextFighters(fight_, new EqList<TeamPosition>(), player_, diff_, _data_, false);
        fight_.setKeepRound(true);
        FightRound.roundUser(fight_, diff_, player_, _data_);
        assertTrue(FightKo.endedFight(fight_, diff_));
        assertTrue(fight_.getAcceptableChoices());
        assertTrue(!fight_.isKeepRound());
    }
    ...
    public void roundUser4Test() {
        ...
        FightRound.roundThrowerSwitch(fight_, currentUser_, diff_, _data_);
        fight_.setState(FightState.ATTAQUES);
        EqList<TeamPosition> cbts_=FightRound.selectTargetHavingToPlayAfterThrower(fight_,currentUser_,_data_);
        fight_.getOrderedFighters().clear();
        fight_.getOrderedFighters().addAllElts(cbts_);
        FightOrder.sortFightersUsingMoveAmongList(fight_,_data_);
        cbts_ = fight_.getOrderedFighters();
        FightRound.calculateNextFighters(fight_, cbts_, player_, diff_, _data_, false);
        fight_.setKeepRound(true);
        FightRound.roundUser(fight_, diff_, player_, _data_);
        assertEq(POKEMON_PLAYER_FIGHTER_TWO, fight_.getCurrentUser());
        fighter_ = fight_.getFighter(userPk_);
    ...
    private static Fight endRoundFight(
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Player _user,
            Difficulty _diff,
    ...
    public void endRoundFight1Test() {
        ...
        FightRound.beginRound(fight_, player_, diff_, _data_);
        FightRound.roundUser(fight_, diff_, player_, _data_);
        FightRound.endRoundFight(fight_, diff_, player_, _data_);
        assertTrue(FightKo.endedFight(fight_, diff_));
        assertTrue(fight_.getAcceptableChoices());
    }
    ...
    private static Fight roundAllThrowers(
            CustList<LevelMoves> _partnerMoves,
            CustList<LevelMoves> _foeMoves,
            Player _user,
            Difficulty _diff,
    ...
    public void roundAllThrowers8Test() {
        ...
        fight_.getFighter(userPk_).setChosenHealingObject(EAU_FRAICHE, _data_);
        fight_.getFighter(POKEMON_PLAYER_FIGHTER_ONE).setChosenHealingObject(EAU_FRAICHE, _data_);
        fight_.getFighter(foePk_).setChosenHealingObject(EAU_FRAICHE, _data_);
        FightRound.roundAllThrowers(fight_, diff_, player_, _data_);
        fighter_ = fight_.getFighter(userPk_);
        assertEq(new Rate("4587/100"), fighter_.getRemainingHp());
        assertEq(new Rate("4587/100"), fighter_.pvMax());
