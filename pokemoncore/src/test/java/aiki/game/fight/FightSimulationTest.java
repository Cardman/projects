...
//        assertEq(3, fightSimulation_.getCurrentFights().getKeys((byte) 0).size());
    ...
    public void addMove1Test() {
        ...
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte)0).getVal(new KeyFightRound((byte)0,(byte)0)).containsObj(PLAQUAGE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte)0).getVal(new KeyFightRound((byte)0,(byte)0)).containsObj(CHARGE));
    }
    ...
    public void keepMoves1Test() {
        ...
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)0)).containsObj(CHARGE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)0)).containsObj(PLAQUAGE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)0)).containsObj(BULLES_D_O));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)0)).containsObj(PISTOLET_A_O));
        assertEq(4, fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).size());
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(CHARGE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(PLAQUAGE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(BULLES_D_O));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(PISTOLET_A_O));
        assertEq(0, fightSimulation_.getAvailableMoves().getVal((byte) 0).getKey().getFight());
    ...
    public void keepMoves2Test() {
        ...
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)0)).containsObj(PISTOLET_A_O));
        assertEq(4, fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).size());
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(TORGNOLES));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(PLAQUAGE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(BULLES_D_O));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(PISTOLET_A_O));
        assertEq(0, fightSimulation_.getAvailableMoves().getVal((byte) 0).getKey().getFight());
...
//        assertTrue(fightSimulation_.getAvailableMoves().getVal((byte) 0).getSecond().getVal(PISTOLET_A_O));
    ...
    public void cancelMovesOneFight2Test() {
        ...
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)0)).containsObj(CHARGE));
        assertEq(4, fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).size());
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(ECUME));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(PLAQUAGE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(BULLES_D_O));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(PISTOLET_A_O));
        assertEq(4, fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)2)).size());
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)2)).containsObj(ECUME));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)2)).containsObj(PLAQUAGE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)2)).containsObj(BULLES_D_O));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)2)).containsObj(PISTOLET_A_O));
        fightSimulation_.cancelMovesOneFight(0, _data_);
        assertEq(3, fightSimulation_.getKeptMoves().getVal((byte) 0).size());
        assertEq(1, fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)0)).size());
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)0,(byte)0)).containsObj(CHARGE));
    ...
    public void validateMoves2Test() {
        ...
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)1,(byte)0)).containsObj(MEGAPHONE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)1,(byte)0)).containsObj(PLAQUAGE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)1,(byte)0)).containsObj(BULLES_D_O));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 0).getVal(new KeyFightRound((byte)1,(byte)0)).containsObj(PISTOLET_A_O));
    }
    ...
    public void validateMoves3Test() {
        ...
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 1).getVal(new KeyFightRound((byte)0,(byte)1)).containsObj(CHARGE));
    }
    ...
    public void validateMoves5Test() {
        ...
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 1).getVal(new KeyFightRound((byte)1,(byte)0)).containsObj(CHARGE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 1).getVal(new KeyFightRound((byte)1,(byte)0)).containsObj(BULLES_D_O));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 1).getVal(new KeyFightRound((byte)1,(byte)0)).containsObj(SACRIFICE));
        assertTrue(fightSimulation_.getKeptMoves().getVal((byte) 1).getVal(new KeyFightRound((byte)1,(byte)0)).containsObj(TORGNOLES));
        assertEq(2, fightSimulation_.getKeptMovesBetweenFights().getVal((byte) 1).size());
        assertEq(1, fightSimulation_.getKeptMovesBetweenFights().getVal((byte) 1).first().size());
