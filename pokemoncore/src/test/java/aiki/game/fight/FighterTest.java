...
//        assertEq(1, fighter_.getStatus().getKeys((short) 1).size());
        ...
        assertEq(new Short("1"), fighter_.getStatusNbRound(GEL));
...
//        assertEq(16, fighter_.getStatus().getKeys((short) 0).size());
        ...
        assertEq(new Short("0"), fighter_.getStatusNbRound(POISON_ST));
        assertEq(new Short("0"), fighter_.getStatusNbRound(POISON_GRAVE));
        assertEq(new Short("0"), fighter_.getStatusNbRound(SOMMEIL));
        assertEq(new Short("0"), fighter_.getStatusNbRound(SOMMEIL_REPOS));
        assertEq(new Short("0"), fighter_.getStatusNbRound(PEUR));
        assertEq(new Short("0"), fighter_.getStatusNbRound(BRULURE));
        assertEq(new Short("0"), fighter_.getStatusNbRound(CONFUSION));
        assertEq(new Short("0"), fighter_.getStatusNbRound(CRAME));
        assertEq(new Short("0"), fighter_.getStatusNbRound(CRAME_BIS));
        assertEq(new Short("0"), fighter_.getStatusNbRound(PARALYSIE));
        assertEq(new Short("0"), fighter_.getStatusNbRound(PARALYSIE_FORTE));
        assertEq(new Short("0"), fighter_.getStatusNbRound(ERE_GEL));
        assertEq(new Short("0"), fighter_.getStatusNbRound(FEU_GEL));
        assertEq(new Short("0"), fighter_.getStatusNbRound(TROUILLE));
        assertEq(new Short("0"), fighter_.getStatusNbRound(LONGUE_CONFUSION_SANS_DOMMAGE));
        assertEq(new Short("0"), fighter_.getStatusNbRound(LONGUE_CONFUSION_DOMMAGE));
        assertEq(0, fighter_.getStatusRelat().size());
        assertEq(0, fighter_.getIncrUserAccuracy().size());
        assertEq(0, fighter_.getTrackingMoves().size());
        assertEq(0, fighter_.getPrivateMoves().size());
...
//        assertEq(17, fighter_.getStatus().getKeys((short) 0).size());
        ...
        assertEq(new Short("0"), fighter_.getStatusNbRound(GEL));
        assertEq(new Short("0"), fighter_.getStatusNbRound(CRAME));
        assertEq(new Short("0"), fighter_.getStatusNbRound(CRAME_BIS));
        assertEq(new Short("0"), fighter_.getStatusNbRound(POISON_ST));
        assertEq(new Short("0"), fighter_.getStatusNbRound(POISON_GRAVE));
...
//        assertEq(11, fighter_.getStatusRelat().getKeys((short) 0).size());
        ...
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(VAMPIGRAINE,fighterCoords_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR,fighterCoords_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR_FOU,fighterCoords_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR_MOU,fighterCoords_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(CAUCHEMAR,fighterCoords_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(COUP_DE_BEC,fighterCoords_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(NUIT_BLANCHE,fighterCoords_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(NUIT_BLANCHE_BIS,fighterCoords_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(NUIT_NOIRE,fighterCoords_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(PRISE_DE_TETE,fighterCoords_)));
...
//        assertEq(22, fighter_.getStatusRelat().getKeys((short) 0).size());
        ...
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(VAMPIGRAINE,fighterCoordsOne_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR,fighterCoordsOne_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR_MOU,fighterCoordsOne_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR_TRES_MOU,fighterCoordsOne_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR_FOU,fighterCoordsOne_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(CAUCHEMAR,fighterCoordsOne_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(PRISE_DE_TETE,fighterCoordsOne_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(COUP_DE_BEC,fighterCoordsOne_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(NUIT_BLANCHE,fighterCoordsOne_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(NUIT_BLANCHE_BIS,fighterCoordsOne_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(NUIT_NOIRE,fighterCoordsOne_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(VAMPIGRAINE,fighterCoordsTwo_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR,fighterCoordsTwo_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR_MOU,fighterCoordsTwo_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR_TRES_MOU,fighterCoordsTwo_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(AMOUR_FOU,fighterCoordsTwo_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(CAUCHEMAR,fighterCoordsTwo_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(PRISE_DE_TETE,fighterCoordsTwo_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(COUP_DE_BEC,fighterCoordsTwo_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(NUIT_BLANCHE,fighterCoordsTwo_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(NUIT_BLANCHE_BIS,fighterCoordsTwo_)));
        assertEq(new Short("0"), fighter_.getStatusRelatNbRound(new MoveTeamPosition(NUIT_NOIRE,fighterCoordsTwo_)));
