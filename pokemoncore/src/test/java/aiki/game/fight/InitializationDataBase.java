...
//        _data.addConstNotNumTest(DataBase.DEFAULT_EGG_GROUP, "METAMORPH");
    ...
    protected static void initTranslations(DataBase _data) {
        ...
        litteral_.addEntry("CIBLE_EFFET",StringList.concat(MOVE_FORMULA,TAB,"targ_eff__{0}",TAB,"The target is under the effect of the move {0}"));
        litteral_.addEntry("GENRES_EGAUX",StringList.concat(MOVE_FORMULA,TAB,"gr_eg",TAB,"The genders equal to themselves."));
        litteral_.addEntry("PK_SAUVAGE_GENRE",StringList.concat("item",TAB,"wild_pk_gr",TAB,"Gender of the wild pokemon"));
        litteral_.addEntry("LANCEUR_GENRE",StringList.concat(MOVE_FORMULA,TAB,"user_gr",TAB,"Genre of the user"));
        litteral_.addEntry("LANCEUR_PV_MAX",StringList.concat(MOVE_FORMULA,TAB,"usr_max_hp",TAB,"Full health points of the user"));
        litteral_.addEntry("EXISTE_GENRE_ASSEXUE",StringList.concat(MOVE_FORMULA,TAB,"exist_no_gr",TAB,"It exists a no-sexual gender."));
        litteral_.addEntry("LANCEUR_EFFET",StringList.concat(MOVE_FORMULA,TAB,"usr_eff__{0}",TAB,"The user is under the effect of the move {0}"));
        litteral_.addEntry("CIBLE_STATUTS",StringList.concat(MOVE_FORMULA,TAB,"targ_status",TAB,"status of the target"));
        litteral_.addEntry("CIBLE_TAILLE",StringList.concat(MOVE_FORMULA,TAB,"targ_height",TAB,"Height of the target"));
        litteral_.addEntry("CIBLE_OBJET",StringList.concat(MOVE_FORMULA,TAB,"targ_it",TAB,"Item of the target"));
        litteral_.addEntry("IMMU_TYPE_ATT_COMBATTANT_ENTRANT",StringList.concat(TYPE_FORMULA,TAB,"immu_move_type_fighter__{0}",TAB,"The sent fighter is protected against the moves of type {0}"));
        litteral_.addEntry("LANCEUR_DEGATS_RECUS_TOTAL_TOUR",StringList.concat(MOVE_FORMULA,TAB,"usr_suffered_damg_rd",TAB,"Suffered damage against the user while the round"));
        litteral_.addEntry("DEJA_CAPTURE",StringList.concat("item",TAB,"already_caught",TAB,"Already caught pokemon"));
        litteral_.addEntry("CIBLE_TYPES",StringList.concat(MOVE_FORMULA,TAB,"targ_t",TAB,"types of the targets"));
        litteral_.addEntry("COMBATTANT_ENTRANT_TYPES",StringList.concat(MOVE_FORMULA,TAB,"sent_fighter_type",TAB,"Types of the sent fighter"));
        litteral_.addEntry("LANCEUR_STATUTS",StringList.concat(MOVE_FORMULA,TAB,"usr_status",TAB,"status of the user"));
        litteral_.addEntry("PAS_PP_ATTAQUE_CIBLE",StringList.concat(MOVE_FORMULA,TAB,"no_pp_target",TAB,"The target has no power point for the move that the target owns"));
        litteral_.addEntry("SOMME_BOOST_POS_CIBLE",StringList.concat(MOVE_FORMULA,TAB,"sum_boost_pos_tar",TAB,"Sum of the positive boosts of the target"));
        litteral_.addEntry("ATTAQUE_NOM",StringList.concat(MOVE_FORMULA,TAB,"move_name",TAB,"Name of the move"));
        litteral_.addEntry("LANCEUR_BOOST",StringList.concat(STATIS_FORMULA,TAB,"usr_boost__{0}",TAB,"{0} of terms of boost of the user"));
        litteral_.addEntry("ATTACK",StringList.concat(MOVE_FORMULA,TAB,"att",TAB,"Value of the move of the user"));
        litteral_.addEntry("CIBLE_PV_RESTANTS",StringList.concat(MOVE_FORMULA,TAB,"targ_left_hp",TAB,"Remaining health points of the target"));
        litteral_.addEntry("CIBLE_POSSEDE_STATUT_RELATION",StringList.concat(STATUS_FORMULA,TAB,"target_pseudo_st__{0}",TAB,"The target is victim of the pseudo status {0}"));
        litteral_.addEntry("ATTAQUE_TYPES",StringList.concat(MOVE_FORMULA,TAB,"move_types",TAB,"Types of the move"));
        litteral_.addEntry("FIGHTER_OBJET",StringList.concat("item",TAB,"fighter_it",TAB,"Item of the owner"));
        litteral_.addEntry("LANCEUR_CLONE",StringList.concat(MOVE_FORMULA,TAB,"usr_clone",TAB,"PV of the clone of the user"));
        litteral_.addEntry("POWER",StringList.concat(MOVE_FORMULA,TAB,"pow",TAB,"Value of the power of the move of the user"));
        litteral_.addEntry("PUISSANCE_BASE",StringList.concat("item",TAB,"power_base",TAB,"Power of base of the move of the owner"));
        litteral_.addEntry("MASSE_MOYENNE_PK",StringList.concat("item",TAB,"avg_pk_weight",TAB,"Average weight of the pokemon"));
        litteral_.addEntry("LANCEUR_ATTAQUES_TYPES",StringList.concat(MOVE_FORMULA,TAB,"usr_moves_types",TAB,"Types of the moves of the user"));
        litteral_.addEntry("PK_UT_NIVEAU",StringList.concat("item",TAB,"pk_player_lev",TAB,"Level of the pokemon of the player"));
        litteral_.addEntry("DEFENSE",StringList.concat(MOVE_FORMULA,TAB,"def",TAB,"Value of the defence of the user"));
        litteral_.addEntry("PK_SAUVAGE_TYPES_BASE",StringList.concat("item",TAB,"wild_pk_types",TAB,"Types de base of the wild pokemon"));
        litteral_.addEntry("LANCEUR_CAPACITE",StringList.concat(MOVE_FORMULA,TAB,"usr_ab",TAB,"Current ability of the user"));
        litteral_.addEntry("FIGHTER_NOM",StringList.concat("item",TAB,"fighter_nom",TAB,"Name of the owner"));
        litteral_.addEntry("NB_UTILISATION_CONSECUTIF",StringList.concat("item",TAB,"nb_uses_cons",TAB,"Number of consecutive uses of the move."));
        litteral_.addEntry("FIGHTER_DER_JOUE",StringList.concat("item",TAB,"fighter_last_acted",TAB,"The owner has played the last one"));
        litteral_.addEntry("TEMPS_TOUR",StringList.concat("item",TAB,"tps_rd",TAB,"Time of round"));
        litteral_.addEntry("LANCEUR_ATTAQUES",StringList.concat(MOVE_FORMULA,TAB,"usr_att",TAB,"Moves of the user"));
        litteral_.addEntry("LANCEUR_BONHEUR",StringList.concat(MOVE_FORMULA,TAB,"usr_hap",TAB,"Happiness of the user"));
        litteral_.addEntry("PK_SAUVAGE_PIERRES_EVOS",StringList.concat("item",TAB,"wild_pk_ev",TAB,"Evolution stones of the wild pokemon"));
        litteral_.addEntry("CIBLE_BOOST",StringList.concat(STATIS_FORMULA,TAB,"targ_boost__{0}",TAB,"{0} in terms of boost of the target"));
        litteral_.addEntry("PAS_PARTENAIRE_ARRIERE",StringList.concat(MOVE_FORMULA,TAB,"no_back_part",TAB,"No back partner"));
        litteral_.addEntry("LANCEUR_DISPARAIT",StringList.concat(MOVE_FORMULA,TAB,"usr_disap",TAB,"The user disappears while the round"));
        litteral_.addEntry("LANCEUR_JOUE",StringList.concat(MOVE_FORMULA,TAB,"usr_acted",TAB,"The user has acted"));
        litteral_.addEntry("LANCEUR_DEGATS_RECUS_TOTAL",StringList.concat(MOVE_FORMULA,TAB,"usr_amt_suff_damg",TAB,"Full suffered damage against the user"));
        litteral_.addEntry("LANCEUR_NB_UTILISATION",StringList.concat(MOVE_FORMULA,TAB,"usr_nb_uses__{0}",TAB,"Number of uses of the move {0} of the user"));
        litteral_.addEntry("CIBLE_STATIS",StringList.concat(STATIS_FORMULA,TAB,"targ_statis__{0}",TAB,"{0} in terms of base of statistic of the target"));
        litteral_.addEntry("NB_UTILI_ATT_EQ_TOUR",StringList.concat(MOVE_FORMULA,TAB,"nb_uses_team_move_rd__{0}",TAB,"Number of uses of the move {0} by the team"));
        litteral_.addEntry("NIVEAU",StringList.concat("level",TAB,"l",TAB,"The level of the Pokemon"));
        litteral_.addEntry("EV",StringList.concat("ev",TAB,"ev",TAB,"The ev of a statistic of the pokemon"));
        litteral_.addEntry("IV",StringList.concat("iv",TAB,"iv",TAB,"The iv of a statistic of the pokemon"));
        litteral_.addEntry("BASE",StringList.concat("base",TAB,"base",TAB,"The base value of a statistic of the pokemon"));
        litteral_.addEntry("LANCEUR_TAILLE",StringList.concat(MOVE_FORMULA,TAB,"usr_height",TAB,"height of the user"));
        litteral_.addEntry("LIEU_COMBAT",StringList.concat("item",TAB,"fight_env",TAB,"Fight environment"));
        litteral_.addEntry("CIBLE_GENRE",StringList.concat(MOVE_FORMULA,TAB,"targ_gr",TAB,"Genre of the target"));
        litteral_.addEntry("CIBLE_ATTAQUE_CHOISIE",StringList.concat(MOVE_FORMULA,TAB,"targ_chosen_move",TAB,"Chosen move of the target"));
        litteral_.addEntry("CIBLE_NB_UTILISATION",StringList.concat(MOVE_FORMULA,TAB,"targ_nb_uses__{0}",TAB,"Number of uses of the move {0} of the target"));
        litteral_.addEntry("IMMU_TYPE_ATT_CIBLE",StringList.concat(TYPE_FORMULA,TAB,"immu_move_type_targ__{0}",TAB,"The target is protected against the moves of type {0}"));
        litteral_.addEntry("CLIMATS",StringList.concat(MOVE_FORMULA,TAB,"weathers",TAB,"Enabled weathers"));
        litteral_.addEntry("CIBLE_CLONE",StringList.concat(MOVE_FORMULA,TAB,"targ_clone",TAB,"PV of the clone of the target"));
        litteral_.addEntry("CIBLE_ATTAQUES",StringList.concat(MOVE_FORMULA,TAB,"targ_moves",TAB,"Moves of the target"));
        litteral_.addEntry("CIBLE_PV_MAX",StringList.concat(MOVE_FORMULA,TAB,"targ_max_hp",TAB,"Full health points of the target"));
        litteral_.addEntry("LANCEUR_TYPES",StringList.concat(MOVE_FORMULA,TAB,"usr_t",TAB,"types of the user"));
        litteral_.addEntry("FIGHTER_TYPES",StringList.concat(STATUS_FORMULA,TAB,"fighter_types",TAB,"Types of the fighter"));
        litteral_.addEntry("PAS_UTILIS_ATTAQUE_CIBLE",StringList.concat(MOVE_FORMULA,TAB,"no_use_tar",TAB,"No used move by the target"));
        litteral_.addEntry("ATTAQUE_CATEGORIE",StringList.concat(MOVE_FORMULA,TAB,"move_cat",TAB,"Category of the move of the owner"));
        litteral_.addEntry("NB_KO_EQUIPE_LANCEUR",StringList.concat(MOVE_FORMULA,TAB,"nb_ko_user",TAB,"Number of ko pokemon of the team of the user"));
        litteral_.addEntry("CIBLE_CAPACITE",StringList.concat(MOVE_FORMULA,TAB,"targ_ab",TAB,"Current ability of the target"));
        litteral_.addEntry("CIBLE_DEGATS_RECUS_TOTAL_TOUR",StringList.concat(MOVE_FORMULA,TAB,"targ_suffered_damg_rd",TAB,"Suffered damage against the target while the round"));
        litteral_.addEntry("FIGHTER_PP",StringList.concat(MOVE_FORMULA,TAB,"usr_pp__{0}",TAB,"Remaining power points of the move {0} of the user"));
        litteral_.addEntry("LANCEUR_PP",StringList.concat(MOVE_FORMULA,TAB,"usr_pp__{0}",TAB,"Remaining power points of the move {0} of the user"));
        litteral_.addEntry("CIBLE_PP",StringList.concat(MOVE_FORMULA,TAB,"usr_pp__{0}",TAB,"Remaining power points of the move {0} of the user"));
        litteral_.addEntry("PAS_TOUR_TERRAIN",StringList.concat(MOVE_FORMULA,TAB,"no_rd",TAB,"Has just been sent on the ground."));
        litteral_.addEntry("FIGHTER_CLONE",StringList.concat(STATUS_FORMULA,TAB,"fighter_clone",TAB,"PV of the clone of the fighter"));
        litteral_.addEntry("CIBLE_NIVEAU",StringList.concat(MOVE_FORMULA,TAB,"targ_lev",TAB,"Level of the target"));
        litteral_.addEntry("FIGHTER_STATUTS",StringList.concat("item",TAB,"fighter_st",TAB,"Status of the owner"));
        litteral_.addEntry("PK_SAUVAGE_MASSE",StringList.concat("item",TAB,"wild_pk_wt",TAB,"Weight of wild pokemon"));
        litteral_.addEntry("TYPES_ATTAQUES_RES_VIDE",StringList.concat(MOVE_FORMULA,TAB,"res_types_move_empty",TAB,"No resisting type against the last suffered move."));
        litteral_.addEntry("LANCEUR_STATIS",StringList.concat(STATIS_FORMULA,TAB,"usr_statis__{0}",TAB,"{0} in terms of base of statistic of the user"));
        litteral_.addEntry("CIBLE_DISPARAIT",StringList.concat(MOVE_FORMULA,TAB,"targ_disap",TAB,"The target disappears while the round"));
        litteral_.addEntry("LANCEUR_DEGATS_RECUS_TOUR",StringList.concat(CAT_FORMULA,TAB,"usr_suffered_damg_rd__{0}",TAB,"Suffered damage against the user by moves of category {0}."));
        litteral_.addEntry("LANCEUR_MASSE",StringList.concat(MOVE_FORMULA,TAB,"usr_weight",TAB,"Weight of the user"));
        litteral_.addEntry("COEFF_EFF_BASE_TYPES_COMBATTANT_ENTRANT",StringList.concat(TYPE_FORMULA,TAB,"eff_base_sent_fighter__{0}",TAB,"Rate of efficiency of the type {0} against the types of the sent fighter"));
        litteral_.addEntry("COEFF_EFF_BASE_TYPES_FIGHTER",StringList.concat(TYPE_FORMULA,TAB,"eff_base_sent_fighter__{0}",TAB,"Rate of efficiency of the type {0} against the types of the sent fighter"));
        litteral_.addEntry("COEFF_EFF_BASE_TYPES_CIBLE",StringList.concat(TYPE_FORMULA,TAB,"eff_base_sent_fighter__{0}",TAB,"Rate of efficiency of the type {0} against the types of the sent fighter"));
        litteral_.addEntry("COEFF_EFF_BASE_TYPES_LANCEUR",StringList.concat(TYPE_FORMULA,TAB,"eff_base_sent_fighter__{0}",TAB,"Rate of efficiency of the type {0} against the types of the sent fighter"));
        litteral_.addEntry("LANCEUR_NOM",StringList.concat(MOVE_FORMULA,TAB,"user_name",TAB,"Name of the user"));
        litteral_.addEntry("PK_UT_GENRE",StringList.concat("item",TAB,"pk_player_gr",TAB,"Gender of the pokemon of the player"));
        litteral_.addEntry("FIGHTER_NB_UTILISATION",StringList.concat(MOVE_FORMULA,TAB,"cbt_nb_uses__{0}",TAB,"Number of uses of the move {0} of the fighter"));
        litteral_.addEntry("EQUIPE_NB_UTILISATION",StringList.concat(MOVE_FORMULA,TAB,"cbt_nb_uses__{0}",TAB,"Number of uses of the move {0} of the fighter"));
        litteral_.addEntry("NB_TOUR",StringList.concat(MOVE_FORMULA,TAB,"nb_rd__{0}",TAB,"number of round of the move {0}"));
        litteral_.addEntry("PAS_ATTAQUE_INVOC",StringList.concat(MOVE_FORMULA,TAB,"no_invok_move",TAB,"No invokable move"));
        litteral_.addEntry("CIBLE_JOUE",StringList.concat(MOVE_FORMULA,TAB,"targ_acted",TAB,"The target has acted"));
        litteral_.addEntry("CIBLE_MASSE",StringList.concat(MOVE_FORMULA,TAB,"targ_weight",TAB,"Weight of the target"));
        litteral_.addEntry("EQUIPE_ADV_COMBATTANT_ENTRANT_NB_UTILISATION",StringList.concat(MOVE_FORMULA,TAB,"sent_foe_team_nb_uses__{0}",TAB,"Number of uses of the move {0} by the members of the foe team of the sent fighter."));
        litteral_.addEntry("LANCEUR_OBJET",StringList.concat(MOVE_FORMULA,TAB,"usr_obj",TAB,"Item of the user"));
        litteral_.addEntry("LANCEUR_ATTAQUE_CHOISIE",StringList.concat(MOVE_FORMULA,TAB,"usr_chosen_move",TAB,"Chosen move of the user"));
        litteral_.addEntry("PK_SAUVAGE_VITESSE",StringList.concat("item",TAB,"wild_pk_speed",TAB,"Base speed of the wild pokemon"));
        litteral_.addEntry("PAS_ATTAQUES_COPIABLES",StringList.concat(MOVE_FORMULA,TAB,"no_copy_moves",TAB,"No move can be copied"));
        litteral_.addEntry("NB_COMBATTANTS_TERRAIN",StringList.concat(MOVE_FORMULA,TAB,"nb_fighters",TAB,"Number of fighters on the ground"));
        litteral_.addEntry("PK_SAUVAGE_NIVEAU",StringList.concat("item",TAB,"wild_pk_lev",TAB,"Level of the wild pokemon"));
        litteral_.addEntry("LANCEUR_PV_RESTANTS",StringList.concat(MOVE_FORMULA,TAB,"usr_left_hp",TAB,"Remaining points de vie of the user"));
        litteral_.addEntry("LANCEUR_NIVEAU",StringList.concat(MOVE_FORMULA,TAB,"usr_lev",TAB,"Level of the user"));
        litteral_.addEntry("COEFF_EFF",StringList.concat("item",TAB,"rate_eff",TAB,"Rate of efficiency of the move of the owner"));
        litteral_.addEntry("LANCEUR_POSSEDE_STATUT_RELATION",StringList.concat(STATUS_FORMULA,TAB,"target_pseudo_st__{0}",TAB,"The user suffers of the pseudo status {0}"));
        litteral_.addEntry("NB_TOUR_GLOBAL",StringList.concat(MOVE_FORMULA,TAB,"nb_gl_move__{0}",TAB,"Number of tour of the move {0}"));
        litteral_.addEntry("SOMME_BOOST_POS_LANCEUR",StringList.concat(MOVE_FORMULA,TAB,"sum_boost_pos_user",TAB,"Sum of the positive boosts of the user"));
        litteral_.addEntry("PAS_PARTENAIRE_TERRAIN",StringList.concat(MOVE_FORMULA,TAB,"no_part",TAB,"No partner on the ground"));
        litteral_.addEntry("COMBATTANT_ENTRANT_CLONE",StringList.concat(MOVE_FORMULA,TAB,"sent_fighter_clone",TAB,"Remaining health points of the clone of the sent fighter"));
        litteral_.addEntry("AUCUN_BOOST_POSSIBLE",StringList.concat(MOVE_FORMULA,TAB,"no_boost",TAB,"No boost is possible pour the target"));
        litteral_.addEntry("BASE_CAPT_PK",StringList.concat(MOVE_FORMULA,TAB,"catch_base",TAB,"Base catching rate of the wild pokemon"));
        litteral_.addEntry("RATE_BALL_STATUS",StringList.concat(MOVE_FORMULA,TAB,"ball_status_rate",TAB,"Product between catching rate of the ball and rates of the status of the wild pokemon."));
        litteral_.addEntry("FOE_PK_MAX_HP",StringList.concat(MOVE_FORMULA,TAB,"full_hp",TAB,"Full health points of the wild pokemon."));
        litteral_.addEntry("FOE_PK_REMOTE_HP",StringList.concat(MOVE_FORMULA,TAB,"rem_hp",TAB,"Remaining health points of the wild pokemon."));
        litteral_.addEntry("PK_UT_VITESSE",StringList.concat(MOVE_FORMULA,TAB,"pk_pl_speed",TAB,"Speed of the first pokemon of the player."));
        litteral_.addEntry("PK_SAUVAGE_VITESSE",StringList.concat(MOVE_FORMULA,TAB,"pk_foe_speed",TAB,"Speed of the wild pokemon."));
        litteral_.addEntry("NB_FLEES",StringList.concat(MOVE_FORMULA,TAB,"nb_flees",TAB,"Number of attempts of flee."));
        litteral_.addEntry("LEVEL_WINNER",StringList.concat(MOVE_FORMULA,TAB,"lvl_l",TAB,"Level of the KO fighter"));
        litteral_.addEntry("LEVEL_LOOSER",StringList.concat(MOVE_FORMULA,TAB,"lvl_w",TAB,"Level of the player fighter which wins points"));
