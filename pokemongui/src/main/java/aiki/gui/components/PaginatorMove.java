...
public final class PaginatorMove extends Paginator {
    ...
    private JTextField types = new JTextField(16);

    private JTextField minPriority = new JTextField(16);

    private JTextField maxPriority = new JTextField(16);
...
//        });
        ...
        search_.add(new JLabel(getMessages().getVal(TYPES)));
        search_.add(types);
        search_.add(modeTypes);
        search_.add(new JLabel(getMessages().getVal(PRIORITY)));
        ...
        search_.add(new JLabel(getMessages().getVal(DAMAGING)));
        search_.add(damaging);
        search_.add(new JLabel(DataBase.EMPTY_STRING));
        search_.add(new JLabel(getMessages().getVal(TARGETS)));
        search_.add(targets);
        search_.add(new JLabel(DataBase.EMPTY_STRING));
        add(search_);
        Panel sorting_;
        ...
        sorting_.add(new JLabel(getMessages().getVal(PRIORITY)));
        ...
        sorting_.add(new JLabel(getMessages().getVal(DAMAGING)));
        sorting_.add(cmpDamagingSorting);
        sorting_.add(cmpDamagingPrio);
        sorting_.add(new JLabel(getMessages().getVal(TARGETS)));
