...
public class GameTarotCallingCardThreeTest extends CommonTarotGame {
    ...
    public void setCarteAppelee_callKingInHand1Test() {
        ...
        assertTrue(game.getAppele().containsObj((byte)4));
        ...
        assertTrue(!game.confiance((byte)2,(byte)0));
        assertTrue(!game.confiance((byte)2,(byte)1));
        assertTrue(!game.confiance((byte)2,(byte)3));
        assertTrue(!game.confiance((byte)2,(byte)4));
    ...
    public void setCarteAppelee_callKingFoundInDog2Test() {
        ...
        game.setCarteAppelee(cartesAppeler_);
        game.initConfianceAppele();
        assertEq( 0, game.getAppele().size());
        assertTrue(game.confiance((byte)0,(byte)1));
        assertTrue(game.confiance((byte)0,(byte)2));
        assertTrue(game.confiance((byte)0,(byte)3));
        assertTrue(game.confiance((byte)1,(byte)0));
