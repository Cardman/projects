...
public final class GameTarotTrickHypothesisTest extends CommonGameTarot {
    ...
    public void hypothesesRepartitionsJoueurs1Test() {
        ...
        EnumMap<Suit, CustList<HandTarot>> poss_ = info_.cartesPossibles(curHand_);
        EnumMap<Hypothesis, EnumMap<Suit, CustList<HandTarot>>> hypos_ = info_.cartesCertaines(poss_);
        poss_ = hypos_.getVal(Hypothesis.POSSIBLE);
        EnumMap<Suit, CustList<HandTarot>> sure_ = hypos_.getVal(Hypothesis.SURE);
